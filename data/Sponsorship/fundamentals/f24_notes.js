...
<div class="note-doc">
  ...
  <div class="n-crit"><span class="icon">💡</span><div class="body"><strong>Say the numbers this way, not as a memorised list.</strong> The duration scales with how long it realistically takes to either fix the problem or get everyone off safely. A cargo ship's duration gives the crew time to restore main power or reach a safe port. A passenger ship's is built around a much larger, more vulnerable population needing a longer window for evacuation and rescue, which is why its duration is roughly double.</p></div></div>
  ...
  <div class="n-steps">
    ...
    <p class="n-p">2. <strong>Frequency matching.</strong> A ship running 60 Hz calling at a 50 Hz port (or vice versa) needs the shore connection routed through a frequency converter, otherwise motors, governors and frequency sensitive equipment onboard see the wrong frequency.</p>
  ...
  Covered fully in F13: the boundary is 1000 V AC under IEC 60092. Higher voltage delivers the same power at proportionally lower current, giving smaller, lighter cables and, since resistive loss scales with current squared, a disproportionately large cut in cable losses, worth the extra safety and cost only on vessels with genuinely large loads.</p>
