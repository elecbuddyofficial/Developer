...
<div class="note-doc">
  ...
  <div class="note-anchors">
    ...
    <button class="anc-btn" onclick="jumpTo('s-analyzers')">O2/Salinometer</button>
    <button class="anc-btn" onclick="jumpTo('s-proximity')">Proximity</button>
    <button class="anc-btn" onclick="jumpTo('s-modbus')">Modbus</button>
    <button class="anc-btn" onclick="jumpTo('s-megger')">IR Test</button>
    <button class="anc-btn" onclick="jumpTo('s-ums')">UMS Alarms</button>
