window.loadQuizzes("T03_Motors", [
  {
    ...
    "opts": ["Lenz's Law", "Faraday's Law of Electromagnetic Induction", "Ampere's Circuital Law", "Fleming's Left Hand Rule"],
  ...
  },
  {
    ...
    "opts": ["90 electrical degrees", "180 electrical degrees", "120 electrical degrees", "360 electrical degrees"],
  ...
  },
  {
    ...
    "a": "Ns = 120f / P",
    "opts": ["Ns = 120P / f", "Ns = 60f / P", "Ns = 120f / P", "Ns = f / 120P"],
  ...
  },
  {
    ...
    "a": "3600 RPM",
    "opts": ["3000 RPM", "3600 RPM", "1800 RPM", "1500 RPM"],
  ...
  },
  {
    ...
    "opts": ["To prevent high voltage buildup", "To allow the induced EMF to drive a current, which then interacts with the RMF to produce torque", "To provide physical strength to the rotor", "To eliminate the need for brushes"],
  ...
  },
  {
    ...
    "opts": ["Because it induces a high power factor", "Because rotor current is not supplied directly, but is induced electromagnetically by the stator field", "Because it uses inductors in the stator", "Because it runs at synchronous speed"],
  ...
  },
  {
    ...
    "opts": ["The frequency of the supply", "The number of poles in the stator", "The phase sequence of the 3-phase supply", "The resistance of the rotor"],
  ...
  },
  {
    ...
    "opts": ["The space inside the terminal box", "The microscopic radial clearance between the stator bore and the rotor outer diameter", "The cooling vents in the frame", "The distance between bearing rollers"],
  ...
  },
  {
    ...
    "opts": ["Motor speed increases", "Efficiency improves due to better cooling", "Unbalanced magnetic pull occurs, causing severe vibration and potential rotor rub", "Slip becomes zero"],
  ...
  },
  {
    ...
    "opts": ["Cutting deeper slots to hold more copper", "Arranging the rotor bars at a slight angle to the shaft axis rather than parallel to it", "Using zigzag shapes for stator windings", "Removing every third rotor bar"],
  ...
  },
  {
    ...
    "opts": ["Magnetic locking of the rotor and stator teeth causing failure to start", "High speed vibration caused by bearing failure", "The slow crawling of the motor at 1/7th speed", "Excessive slipping of the rotor under load"],
  ...
  },
  {
    ...
    "opts": ["Solid Iron", "Die-cast Aluminium", "Tungsten", "Carbon fiber"],
  ...
  },
  {
    ...
    "opts": ["It requires less maintenance", "External resistance can be added to the rotor circuit to increase starting torque and lower starting current", "It operates at zero slip", "It is smaller and lighter"],
  ...
  },
  {
    ...
    "opts": ["Friction of the air against the rotor", "Magnetostriction of the core laminations and magnetic forces in the air gap", "Sparking at the slip rings", "Vibration of the cooling fan"],
  ...
  },
  {
    ...
    "opts": ["Unity (1.0)", "Very high and lagging (0.9)", "Very low and lagging (e.g., 0.15 to 0.3)", "Leading (0.8)"],
  ...
  },
  {
    ...
    "opts": ["Unity (1.0)", "High and lagging (e.g., 0.8 to 0.9)", "Low and leading (0.2)", "Zero"],
  ...
  },
  {
    ...
    "opts": ["It draws less current and runs cooler", "It stops instantly", "It speeds up", "It slows down slightly, slip increases, and it draws MORE current to maintain the required power"],
  ...
  },
  {
    ...
    "opts": ["The voltage of the supply alone", "The point where the motor's torque-speed curve intersects the load's torque-speed curve", "The resistance of the stator", "The size of the cooling fan"],
  ...
  },
  {
    ...
    "opts": ["The torque at exact synchronous speed", "The maximum absolute torque the motor can develop before it stalls", "The torque required to remove the rotor", "The torque during a star-delta transition"],
  ...
  },
  {
    ...
    "opts": ["To make the motor lighter", "To minimise eddy current losses in the rotor core", "To improve the power factor", "To increase the slip"],
  ...
  },
  {
    ...
    "opts": ["It equals \u03a6m", "It equals 3 * \u03a6m", "It is constant and equals 1.5 * \u03a6m", "It pulsates between zero and \u03a6m"],
  ...
  },
  {
    ...
    "opts": ["To balance the rotor dynamically", "To electrically short-circuit all the rotor bars together, allowing current to circulate", "To provide attachment points for the bearings", "To cool the stator windings"],
  ...
  },
  {
    ...
    "opts": ["V = I * R", "F = B * I * L (Lorentz Force Law)", "P = V * I", "E = m * c^2"],
  ...
  },
  {
    ...
    "a": "Faraday's Law of Electromagnetic Induction",
    "opts": ["Faraday's Law of Electromagnetic Induction", "Lenz's Law", "Fleming's Left Hand Rule", "Ampere's Circuital Law"],
    "exp": "Faraday's Law states that an EMF is induced in a conductor when there is a relative change in magnetic flux linkage, which occurs when the RMF cuts the stationary rotor bars.",
    "cat": "Principle",
    "id": "T03M_024"
  },
  {
    ...
    "a": "120 electrical degrees",
    "opts": ["360 electrical degrees", "90 electrical degrees", "180 electrical degrees", "120 electrical degrees"],
    "exp": "The stator has three distinct windings spaced exactly 120 electrical degrees apart to create a uniform Rotating Magnetic Field (RMF) when fed by a 3-phase supply.",
    "cat": "Principle",
    "id": "T03M_025"
  },
  {
    ...
    "a": "Ns = 120f / P",
    "opts": ["Ns = f / 120P", "Ns = 60f / P", "Ns = 120f / P", "Ns = 120P / f"],
    "exp": "Ns is directly proportional to frequency (f) and inversely proportional to the number of poles (P).",
    "cat": "Principle",
    "id": "T03M_026"
  },
  {
    ...
    "a": "3600 RPM",
    "opts": ["3000 RPM", "1800 RPM", "1500 RPM", "3600 RPM"],
    "exp": "Ns = 120 * 60 / 2 = 3600 RPM.",
    "cat": "Principle",
    "id": "T03M_027"
  },
  {
    ...
    "a": "To allow the induced EMF to drive a current, which then interacts with the RMF to produce torque",
    "opts": ["To eliminate the need for brushes", "To prevent high voltage buildup", "To provide physical strength to the rotor", "To allow the induced EMF to drive a current, which then interacts with the RMF to produce torque"],
    "exp": "Without a closed circuit, the induced EMF cannot produce a current. Torque (F=BIL) requires a current-carrying conductor in a magnetic field.",
    "cat": "Principle",
    "id": "T03M_028"
  },
  {
    ...
    "a": "Because rotor current is not supplied directly, but is induced electromagnetically by the stator field",
    "opts": ["Because rotor current is not supplied directly, but is induced electromagnetically by the stator field", "Because it uses inductors in the stator", "Because it induces a high power factor", "Because it runs at synchronous speed"],
    "exp": "Unlike DC motors with commutators or sync motors with slip rings, the standard squirrel cage rotor has no electrical connection to the supply.",
    "cat": "Principle",
    "id": "T03M_029"
  },
  {
    ...
    "a": "The phase sequence of the 3-phase supply",
    "opts": ["The number of poles in the stator", "The frequency of the supply", "The phase sequence of the 3-phase supply", "The resistance of the rotor"],
    "exp": "Swapping any two phases changes the phase sequence (e.g., RYB to YRB), which reverses the direction the RMF spins.",
    "cat": "Principle",
    "id": "T03M_030"
  },
  {
    ...
    "opts": ["The motor operates at maximum efficiency", "Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero", "The motor draws infinite current", "The motor reverses direction"],
  ...
  },
  {
    ...
    "a": "s = (Ns - N) / Ns",
    "opts": ["s = (Ns - N) / N", "s = (N - Ns) / Ns", "s = (Ns - N) / Ns", "s = Ns / (Ns - N)"],
  ...
  },
  {
    ...
    "a": "1 (or 100%)",
    "opts": ["0 (or 0%)", "1 (or 100%)", "0.05 (or 5%)", "Infinity"],
  ...
  },
  {
    ...
    "a": "3% to 8%",
    "opts": ["0.1% to 0.5%", "3% to 8%", "10% to 15%", "0%"],
  ...
  },
  {
    ...
    "opts": ["Slip decreases, causing less rotor current", "Slip remains constant, but stator voltage increases", "Slip increases, causing more flux cutting, which increases rotor EMF, rotor current, and torque", "Slip increases, but rotor current decreases"],
  ...
  },
  {
    ...
    "a": "fr = s * f",
    "opts": ["fr = f / s", "fr = s * f", "fr = Ns / f", "fr = f - s"],
  ...
  },
  {
    ...
    "a": "Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero",
    "opts": ["The motor reverses direction", "Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero", "The motor draws infinite current", "The motor operates at maximum efficiency"],
    "exp": "The rotor must always lag the RMF (slip) to ensure flux lines are continuously cut to induce the current required for torque.",
    "cat": "Slip",
    "id": "T03M_038"
  },
  {
    ...
    "a": "s = (Ns - N) / Ns",
    "opts": ["s = (N - Ns) / Ns", "s = (Ns - N) / Ns", "s = (Ns - N) / N", "s = Ns / (Ns - N)"],
    "exp": "Slip is the difference between synchronous speed (Ns) and actual rotor speed (N), expressed as a fraction of synchronous speed.",
    "cat": "Slip",
    "id": "T03M_039"
  },
  {
    ...
    "a": "1 (or 100%)",
    "opts": ["Infinity", "0.05 (or 5%)", "1 (or 100%)", "0 (or 0%)"],
    "exp": "At standstill, rotor speed (N) is zero. Therefore, slip = (Ns - 0) / Ns = 1.",
    "cat": "Slip",
    "id": "T03M_040"
  },
  {
    ...
    "a": "3% to 8%",
    "opts": ["0.1% to 0.5%", "0%", "10% to 15%", "3% to 8%"],
    "exp": "At full load, the rotor must slow down by 3-8% relative to the RMF to induce enough current to match the mechanical load torque.",
    "cat": "Slip",
    "id": "T03M_041"
  },
  {
    ...
    "a": "Slip increases, causing more flux cutting, which increases rotor EMF, rotor current, and torque",
    "opts": ["Slip increases, but rotor current decreases", "Slip increases, causing more flux cutting, which increases rotor EMF, rotor current, and torque", "Slip decreases, causing less rotor current", "Slip remains constant, but stator voltage increases"],
    "exp": "To pull a heavier load, the motor must develop more torque. It does this by slowing down slightly (increasing slip), which induces more rotor current.",
    "cat": "Slip",
    "id": "T03M_042"
  },
  {
    ...
    "a": "fr = s * f",
    "opts": ["fr = f - s", "fr = s * f", "fr = f / s", "fr = Ns / f"],
    "exp": "Rotor frequency depends on the relative speed (slip). At standstill (s=1), fr = f. At normal running (e.g., s=0.04), fr is very low (e.g., 2Hz).",
    "cat": "Slip",
    "id": "T03M_043"
  },
  ...
  },
  {
    ...
    "a": "Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero",
    "opts": ["The motor operates at maximum efficiency", "The motor reverses direction", "The motor draws infinite current", "Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero"],
    "exp": "The rotor must always lag the RMF (slip) to ensure flux lines are continuously cut to induce the current required for torque.",
    "cat": "Slip",
    "id": "T03M_045"
  },
  {
    ...
    "a": "s = (Ns - N) / Ns",
    "opts": ["s = (N - Ns) / Ns", "s = Ns / (Ns - N)", "s = (Ns - N) / Ns", "s = (Ns - N) / N"],
    "exp": "Slip is the difference between synchronous speed (Ns) and actual rotor speed (N), expressed as a fraction of synchronous speed.",
    "cat": "Slip",
    "id": "T03M_046"
  },
  {
    ...
    "a": "1 (or 100%)",
    "opts": ["0 (or 0%)", "1 (or 100%)", "Infinity", "0.05 (or 5%)"],
    "exp": "At standstill, rotor speed (N) is zero. Therefore, slip = (Ns - 0) / Ns = 1.",
    "cat": "Slip",
    "id": "T03M_047"
  },
  {
    ...
    "a": "3% to 8%",
    "opts": ["10% to 15%", "3% to 8%", "0%", "0.1% to 0.5%"],
    "exp": "At full load, the rotor must slow down by 3-8% relative to the RMF to induce enough current to match the mechanical load torque.",
    "cat": "Slip",
    "id": "T03M_048"
  },
  {
    ...
    "a": "Slip increases, causing more flux cutting, which increases rotor EMF, rotor current, and torque",
    "opts": ["Slip increases, but rotor current decreases", "Slip decreases, causing less rotor current", "Slip increases, causing more flux cutting, which increases rotor EMF, rotor current, and torque", "Slip remains constant, but stator voltage increases"],
    "exp": "To pull a heavier load, the motor must develop more torque. It does this by slowing down slightly (increasing slip), which induces more rotor current.",
    "cat": "Slip",
    "id": "T03M_049"
  },
  {
    ...
    "a": "fr = s * f",
    "opts": ["fr = s * f", "fr = f - s", "fr = Ns / f", "fr = f / s"],
    "exp": "Rotor frequency depends on the relative speed (slip). At standstill (s=1), fr = f. At normal running (e.g., s=0.04), fr is very low (e.g., 2Hz).",
    "cat": "Slip",
    "id": "T03M_050"
  },
  ...
  },
  {
    ...
    "a": "Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero",
    "opts": ["Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero", "The motor operates at maximum efficiency", "The motor draws infinite current", "The motor reverses direction"],
    "exp": "The rotor must always lag the RMF (slip) to ensure flux lines are continuously cut to induce the current required for torque.",
    "cat": "Slip",
    "id": "T03M_052"
  },
  {
    ...
    "a": "s = (Ns - N) / Ns",
    "opts": ["s = (Ns - N) / N", "s = (Ns - N) / Ns", "s = (N - Ns) / Ns", "s = Ns / (Ns - N)"],
    "exp": "Slip is the difference between synchronous speed (Ns) and actual rotor speed (N), expressed as a fraction of synchronous speed.",
    "cat": "Slip",
    "id": "T03M_053"
  },
  {
    ...
    "a": "1 (or 100%)",
    "opts": ["0 (or 0%)", "Infinity", "0.05 (or 5%)", "1 (or 100%)"],
    "exp": "At standstill, rotor speed (N) is zero. Therefore, slip = (Ns - 0) / Ns = 1.",
    "cat": "Slip",
    "id": "T03M_054"
  },
  {
    ...
    "a": "3% to 8%",
    "opts": ["3% to 8%", "0.1% to 0.5%", "10% to 15%", "0%"],
    "exp": "At full load, the rotor must slow down by 3-8% relative to the RMF to induce enough current to match the mechanical load torque.",
    "cat": "Slip",
    "id": "T03M_055"
  },
  {
    ...
    "a": "Slip increases, causing more flux cutting, which increases rotor EMF, rotor current, and torque",
    "opts": ["Slip decreases, causing less rotor current", "Slip increases, causing more flux cutting, which increases rotor EMF, rotor current, and torque", "Slip remains constant, but stator voltage increases", "Slip increases, but rotor current decreases"],
    "exp": "To pull a heavier load, the motor must develop more torque. It does this by slowing down slightly (increasing slip), which induces more rotor current.",
    "cat": "Slip",
    "id": "T03M_056"
  },
  {
    ...
    "a": "fr = s * f",
    "opts": ["fr = s * f", "fr = f - s", "fr = f / s", "fr = Ns / f"],
    "exp": "Rotor frequency depends on the relative speed (slip). At standstill (s=1), fr = f. At normal running (e.g., s=0.04), fr is very low (e.g., 2Hz).",
    "cat": "Slip",
    "id": "T03M_057"
  },
  ...
  },
  {
    ...
    "a": "Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero",
    "opts": ["The motor draws infinite current", "The motor reverses direction", "The motor operates at maximum efficiency", "Relative motion becomes zero, no EMF is induced, rotor current drops to zero, and torque becomes zero"],
    "exp": "The rotor must always lag the RMF (slip) to ensure flux lines are continuously cut to induce the current required for torque.",
    "cat": "Slip",
    "id": "T03M_059"
  },
  {
    ...
    "a": "s = (Ns - N) / Ns",
    "opts": ["s = (N - Ns) / Ns", "s = (Ns - N) / Ns", "s = Ns / (Ns - N)", "s = (Ns - N) / N"],
    "exp": "Slip is the difference between synchronous speed (Ns) and actual rotor speed (N), expressed as a fraction of synchronous speed.",
    "cat": "Slip",
    "id": "T03M_060"
  },
  {
    ...
    "opts": ["1 to 2 times the rated current", "5 to 8 times the rated full-load current", "10 to 15 times the rated current", "Equal to the rated current"],
  ...
  },
  {
    ...
    "opts": ["Because the supply voltage drops", "As speed increases, slip decreases, reducing the rate of flux cutting and the induced rotor EMF", "Because the stator winding heats up and increases resistance", "Because the overload relay begins to actuate"],
  ...
  },
  {
    ...
    "opts": ["Star-Delta", "Auto-transformer (65% tap)", "Soft Starter", "Direct-On-Line (DOL)"],
  ...
  },
  {
    ...
    "opts": ["It takes too long to start", "It causes a severe voltage dip on the ship's busbar, affecting other equipment", "It reduces the motor's running efficiency", "It requires complex electronics"],
  ...
  },
  {
    ...
    "opts": ["1/2 of DOL", "1/\u221a3 of DOL", "1/3 of the DOL line current", "1/4 of DOL"],
  ...
  },
  {
    ...
    "opts": ["Torque remains the same", "Torque is reduced to 1/\u221a3", "Torque is reduced to 1/3 of the DOL starting torque", "Torque is increased by 3 times"],
  ...
  },
  {
    ...
    "opts": ["3 terminals", "6 terminals (both ends of all three phase windings must be accessible)", "4 terminals", "9 terminals"],
  ...
  },
  {
    ...
    "opts": ["Main (KM) and Delta (KD)", "Star (KY) and Delta (KD)", "Main contactor (KM) and Star contactor (KY)", "Only Star (KY)"],
  ...
  },
  {
    ...
    "opts": ["The thermal overload relay", "Mechanical and electrical interlocks", "The main fuse", "The motor's back EMF"],
  ...
  },
  {
    ...
    "opts": ["To let the motor cool down", "To allow the motor's residual magnetic field to decay and prevent a massive out-of-phase transient current when Delta closes", "To allow the timer relay to reset", "To ensure the mechanical brake is released"],
  ...
  },
  {
    ...
    "opts": ["The motor stalls completely", "The motor hasn't reached sufficient speed, causing a massive current surge when Delta closes", "The motor runs backwards", "The star contactor burns out instantly"],
  ...
  },
  {
    ...
    "opts": ["The motor explodes", "The motor stops accelerating at a lower speed (due to 1/3 torque) and just sits there drawing star current until transition", "The motor exceeds synchronous speed", "The delta contactor will refuse to close"],
  ...
  },
  {
    ...
    "opts": ["Yes, it is the standard for cranes", "No, because starting torque is reduced to 1/3, it will fail to lift the load", "Yes, but only if the timer is set very long", "No, because cranes require DC power"],
  ...
  },
  {
    ...
    "opts": ["By adding resistors in series with the stator", "By using a transformer with multiple tapping points (e.g., 65%, 80%) to step down the supply voltage", "By altering the supply frequency", "By switching from star to delta"],
  ...
  },
  {
    ...
    "opts": ["It is much cheaper", "The starting voltage/torque can be adjusted (via taps) to suit the load, and transition is closed-circuit without current spikes", "It provides full speed control", "It uses only two contactors"],
  ...
  },
  {
    ...
    "opts": ["IGBTs", "Diodes", "Thyristors (SCRs) connected in anti-parallel pairs for each phase", "Capacitors"],
  ...
  },
  {
    ...
    "opts": ["Yes, it lowers frequency to start", "No, it only alters the RMS voltage", "Yes, it changes frequency and voltage together", "Yes, it converts AC to pure DC"],
  ...
  },
  {
    ...
    "opts": ["The thyristors switch to frequency control mode", "A bypass contactor closes to route power around the thyristors", "The motor automatically switches to delta", "The soft starter disconnects completely"],
  ...
  },
  {
    ...
    "opts": ["It applies a DC brake instantly", "It gradually ramps down the voltage to slowly decelerate the motor, preventing 'water hammer' in pump systems", "It disconnects the motor mechanically", "It reverses the phase sequence"],
  ...
  },
  {
    ...
    "opts": ["In the stator circuit", "In the main busbar supply", "In the rotor circuit via the slip rings and brushes", "In the thermal overload relay"],
  ...
  },
  {
    ...
    "opts": ["It increases the total current drawn from the supply", "It improves the rotor power factor at standstill, bringing rotor current more into phase with the magnetic flux", "It increases the synchronous speed", "It lowers the supply voltage"],
  ...
  },
  {
    ...
    "opts": ["Yes, by modifying the stator", "No, because the squirrel cage rotor has no external electrical connections", "Yes, if it is a double cage motor", "Yes, if used with a VFD"],
  ...
  },
  {
    ...
    "opts": ["The motor stops instantly", "The motor continues to run on two phases (single phasing), drawing heavy current and overheating rapidly", "The motor reverses direction", "The motor speed doubles"],
  ...
  },
  {
    ...
    "opts": ["It restricts the running current of the motor", "It limits the maximum speed of the motor", "It halts the voltage ramp-up if the starting current hits a preset limit (e.g., 350% FLC)", "It acts as a short circuit fuse"],
  ...
  },
  {
    ...
    "opts": ["DOL", "Star-Delta", "Soft Starter", "VFD (Variable Frequency Drive)"],
  ...
  },
  {
    ...
    "opts": ["To increase starting torque", "To cool the compressor cylinders", "To allow the motor to start against zero mechanical load, reducing starting duration and thermal stress", "To prevent the star contactor from opening"],
  ...
  },
  {
    ...
    "opts": ["It connects the third phase to the motor", "It trips the motor during overload", "It bypasses the start button, keeping the contactor coil energised after the button is released", "It prevents single phasing"],
  ...
  },
  {
    ...
    "opts": ["Because it has a special UV relay", "If supply voltage drops too low, the contactor coil loses magnetic pull and drops out, disconnecting the motor", "Because the motor's back EMF shuts it off", "Because the thermal overload strip cools down"],
  ...
  },
  {
    ...
    "opts": ["Nothing, it starts automatically", "You must physically press the start button again, as the retaining contact opened when power was lost", "Replace the contactor coil", "Reset the overload relay"],
  ...
  },
  {
    ...
    "opts": ["Restarting engines one by one", "A timer-based system that automatically restarts critical pumps in a staggered sequence to prevent generator overload", "Starting the star contactor before delta", "Restarting the VFD frequency slowly"],
  ...
  },
  {
    ...
    "opts": ["It uses transformers to step down voltage", "It converts incoming AC to DC, then inverts it back to a synthetic AC waveform with variable voltage and frequency", "It adds resistors to the stator winding", "It mechanically changes the number of motor poles"],
  ...
  },
  {
    ...
    "opts": ["To increase the motor speed beyond sync speed", "To maintain a constant magnetic flux in the air gap and prevent core saturation", "To eliminate the need for a cooling fan", "To convert the motor into a generator"],
  ...
  },
  {
    ...
    "opts": ["Analog amplification", "Pulse Width Modulation (PWM) using IGBTs", "Mechanical commutation", "Rheostatic control"],
  ...
  },
  {
    ...
    "opts": ["By injecting 440V instantly", "By supplying a very low frequency (e.g. 1 Hz) and proportionally low voltage, operating the motor at optimal slip", "By bypassing the inverter section", "By adding DC injection"],
  ...
  },
  {
    ...
    "opts": ["They are very inefficient", "They can only run the motor at one speed", "They generate high-frequency electrical harmonics that can distort the ship's power supply", "They require DC motors"],
  ...
  },
  {
    ...
    "opts": ["They make the bearings run too cold", "High-frequency PWM switching induces shaft voltages that can arc through the bearing grease, causing fluting", "They spin the bearings backwards", "They melt the grease through radiation"],
  ...
  },
  {
    ...
    "opts": ["Use insulated cables", "Install a shaft grounding ring (e.g., AEGIS ring) to safely conduct shaft currents to earth", "Grease the bearings more often", "Lower the supply voltage"],
  ...
  },
  {
    ...
    "opts": ["Because VFDs generate heat in the surrounding air", "Because running the motor at low speeds drastically reduces the cooling efficiency of the shaft-mounted fan", "To blow away harmonics", "To cool the VFD panel"],
  ...
  },
  {
    ...
    "opts": ["Components that physically brake the shaft", "Components used to dissipate regenerated energy as heat when decelerating a high-inertia load", "Filters to remove harmonics", "Devices to stop single-phasing"],
  ...
  },
  {
    ...
    "opts": ["A mechanical disc brake", "An Active Front End (AFE) VFD which feeds the regenerated power back into the ship's grid", "A larger capacitor bank", "A diode rectifier"],
  ...
  },
  {
    ...
    "opts": ["No, the motor will explode", "No, it is physically impossible", "Yes, by increasing the frequency above the baseline (e.g., to 60Hz or higher), operating in the field-weakening region", "Yes, but only if voltage is increased to 1000V"],
  ...
  },
  {
    ...
    "a": "It converts incoming AC to DC, then inverts it back to a synthetic AC waveform with variable voltage and frequency",
    "opts": ["It converts incoming AC to DC, then inverts it back to a synthetic AC waveform with variable voltage and frequency", "It uses transformers to step down voltage", "It mechanically changes the number of motor poles", "It adds resistors to the stator winding"],
    "exp": "The VFD consists of a Rectifier (AC to DC), a DC Link (filters the DC), and an Inverter (DC back to AC using PWM).",
    "cat": "VFD",
    "id": "T03M_102"
  },
  {
    ...
    "a": "To maintain a constant magnetic flux in the air gap and prevent core saturation",
    "opts": ["To maintain a constant magnetic flux in the air gap and prevent core saturation", "To convert the motor into a generator", "To eliminate the need for a cooling fan", "To increase the motor speed beyond sync speed"],
    "exp": "Magnetic flux (\u03a6) is proportional to V/f. If you lower frequency to slow the motor but keep voltage high, flux becomes massive, saturating the iron core and burning out the stator.",
    "cat": "VFD",
    "id": "T03M_103"
  },
  {
    ...
    "a": "Pulse Width Modulation (PWM) using IGBTs",
    "opts": ["Rheostatic control", "Mechanical commutation", "Pulse Width Modulation (PWM) using IGBTs", "Analog amplification"],
    "exp": "Insulated Gate Bipolar Transistors (IGBTs) switch the DC voltage on and off thousands of times per second. Varying the pulse width creates an RMS current that looks like a sine wave to the motor.",
    "cat": "VFD",
    "id": "T03M_104"
  },
  {
    ...
    "a": "By supplying a very low frequency (e.g. 1 Hz) and proportionally low voltage, operating the motor at optimal slip",
    "opts": ["By injecting 440V instantly", "By bypassing the inverter section", "By adding DC injection", "By supplying a very low frequency (e.g. 1 Hz) and proportionally low voltage, operating the motor at optimal slip"],
    "exp": "At 1Hz, the RMF spins very slowly. The rotor can easily slip slightly behind this slow RMF, producing massive torque without demanding high current.",
    "cat": "VFD",
    "id": "T03M_105"
  },
  {
    ...
    "a": "They generate high-frequency electrical harmonics that can distort the ship's power supply",
    "opts": ["They require DC motors", "They can only run the motor at one speed", "They generate high-frequency electrical harmonics that can distort the ship's power supply", "They are very inefficient"],
    "exp": "The non-linear switching of the rectifier draws current in pulses, creating 5th, 7th, 11th, etc., harmonics. These must be mitigated using active or passive harmonic filters.",
    "cat": "VFD",
    "id": "T03M_106"
  },
  {
    ...
    "a": "High-frequency PWM switching induces shaft voltages that can arc through the bearing grease, causing fluting",
    "opts": ["They spin the bearings backwards", "High-frequency PWM switching induces shaft voltages that can arc through the bearing grease, causing fluting", "They make the bearings run too cold", "They melt the grease through radiation"],
    "exp": "Common-mode voltage from PWM induces a voltage on the rotor. If it exceeds the dielectric breakdown of the grease film, it arcs, leaving washboard-like pits (fluting) on the bearing races.",
    "cat": "VFD",
    "id": "T03M_107"
  },
  {
    ...
    "a": "Install a shaft grounding ring (e.g., AEGIS ring) to safely conduct shaft currents to earth",
    "opts": ["Grease the bearings more often", "Install a shaft grounding ring (e.g., AEGIS ring) to safely conduct shaft currents to earth", "Lower the supply voltage", "Use insulated cables"],
    "exp": "A shaft grounding ring uses carbon microfibers riding on the shaft to provide a low-impedance path to ground, bypassing the bearings entirely.",
    "cat": "VFD",
    "id": "T03M_108"
  },
  {
    ...
    "a": "Because running the motor at low speeds drastically reduces the cooling efficiency of the shaft-mounted fan",
    "opts": ["To cool the VFD panel", "Because VFDs generate heat in the surrounding air", "To blow away harmonics", "Because running the motor at low speeds drastically reduces the cooling efficiency of the shaft-mounted fan"],
    "exp": "A motor running at 20% speed has 1/5th the cooling airflow. But if it's still producing high torque, it generates full heat. An independent fan ensures cooling regardless of motor speed.",
    "cat": "VFD",
    "id": "T03M_109"
  },
  {
    ...
    "a": "Components used to dissipate regenerated energy as heat when decelerating a high-inertia load",
    "opts": ["Filters to remove harmonics", "Components used to dissipate regenerated energy as heat when decelerating a high-inertia load", "Components that physically brake the shaft", "Devices to stop single-phasing"],
    "exp": "When a crane lowers a load, the motor acts as a generator. The VFD's DC link voltage spikes. The chopper switches this excess DC voltage to a large resistor bank to burn it off.",
    "cat": "VFD",
    "id": "T03M_110"
  },
  {
    ...
    "a": "An Active Front End (AFE) VFD which feeds the regenerated power back into the ship's grid",
    "opts": ["A diode rectifier", "An Active Front End (AFE) VFD which feeds the regenerated power back into the ship's grid", "A larger capacitor bank", "A mechanical disc brake"],
    "exp": "AFE drives use IGBTs in the rectifier section instead of diodes, allowing bidirectional power flow, saving massive amounts of energy during cargo operations.",
    "cat": "VFD",
    "id": "T03M_111"
  },
  {
    ...
    "a": "Yes, by increasing the frequency above the baseline (e.g., to 60Hz or higher), operating in the field-weakening region",
    "opts": ["Yes, but only if voltage is increased to 1000V", "No, the motor will explode", "Yes, by increasing the frequency above the baseline (e.g., to 60Hz or higher), operating in the field-weakening region", "No, it is physically impossible"],
    "exp": "Above 50Hz, the VFD cannot increase voltage further (limited to mains). Thus, V/f ratio drops (field weakening). Torque decreases, but power remains constant.",
    "cat": "VFD",
    "id": "T03M_112"
  },
  {
    ...
    "a": "It converts incoming AC to DC, then inverts it back to a synthetic AC waveform with variable voltage and frequency",
    "opts": ["It uses transformers to step down voltage", "It mechanically changes the number of motor poles", "It adds resistors to the stator winding", "It converts incoming AC to DC, then inverts it back to a synthetic AC waveform with variable voltage and frequency"],
    "exp": "The VFD consists of a Rectifier (AC to DC), a DC Link (filters the DC), and an Inverter (DC back to AC using PWM).",
    "cat": "VFD",
    "id": "T03M_113"
  },
  {
    ...
    "a": "To maintain a constant magnetic flux in the air gap and prevent core saturation",
    "opts": ["To convert the motor into a generator", "To eliminate the need for a cooling fan", "To maintain a constant magnetic flux in the air gap and prevent core saturation", "To increase the motor speed beyond sync speed"],
    "exp": "Magnetic flux (\u03a6) is proportional to V/f. If you lower frequency to slow the motor but keep voltage high, flux becomes massive, saturating the iron core and burning out the stator.",
    "cat": "VFD",
    "id": "T03M_114"
  },
  {
    ...
    "a": "Pulse Width Modulation (PWM) using IGBTs",
    "opts": ["Rheostatic control", "Mechanical commutation", "Analog amplification", "Pulse Width Modulation (PWM) using IGBTs"],
    "exp": "Insulated Gate Bipolar Transistors (IGBTs) switch the DC voltage on and off thousands of times per second. Varying the pulse width creates an RMS current that looks like a sine wave to the motor.",
    "cat": "VFD",
    "id": "T03M_115"
  },
  {
    ...
    "a": "By supplying a very low frequency (e.g. 1 Hz) and proportionally low voltage, operating the motor at optimal slip",
    "opts": ["By bypassing the inverter section", "By adding DC injection", "By supplying a very low frequency (e.g. 1 Hz) and proportionally low voltage, operating the motor at optimal slip", "By injecting 440V instantly"],
    "exp": "At 1Hz, the RMF spins very slowly. The rotor can easily slip slightly behind this slow RMF, producing massive torque without demanding high current.",
    "cat": "VFD",
    "id": "T03M_116"
  },
  {
    ...
    "a": "They generate high-frequency electrical harmonics that can distort the ship's power supply",
    "opts": ["They generate high-frequency electrical harmonics that can distort the ship's power supply", "They require DC motors", "They can only run the motor at one speed", "They are very inefficient"],
    "exp": "The non-linear switching of the rectifier draws current in pulses, creating 5th, 7th, 11th, etc., harmonics. These must be mitigated using active or passive harmonic filters.",
    "cat": "VFD",
    "id": "T03M_117"
  },
  {
    ...
    "a": "High-frequency PWM switching induces shaft voltages that can arc through the bearing grease, causing fluting",
    "opts": ["High-frequency PWM switching induces shaft voltages that can arc through the bearing grease, causing fluting", "They spin the bearings backwards", "They make the bearings run too cold", "They melt the grease through radiation"],
    "exp": "Common-mode voltage from PWM induces a voltage on the rotor. If it exceeds the dielectric breakdown of the grease film, it arcs, leaving washboard-like pits (fluting) on the bearing races.",
    "cat": "VFD",
    "id": "T03M_118"
  },
  {
    ...
    "a": "Install a shaft grounding ring (e.g., AEGIS ring) to safely conduct shaft currents to earth",
    "opts": ["Lower the supply voltage", "Grease the bearings more often", "Install a shaft grounding ring (e.g., AEGIS ring) to safely conduct shaft currents to earth", "Use insulated cables"],
    "exp": "A shaft grounding ring uses carbon microfibers riding on the shaft to provide a low-impedance path to ground, bypassing the bearings entirely.",
    "cat": "VFD",
    "id": "T03M_119"
  },
  {
    ...
    "a": "Because running the motor at low speeds drastically reduces the cooling efficiency of the shaft-mounted fan",
    "opts": ["To blow away harmonics", "Because VFDs generate heat in the surrounding air", "To cool the VFD panel", "Because running the motor at low speeds drastically reduces the cooling efficiency of the shaft-mounted fan"],
    "exp": "A motor running at 20% speed has 1/5th the cooling airflow. But if it's still producing high torque, it generates full heat. An independent fan ensures cooling regardless of motor speed.",
    "cat": "VFD",
    "id": "T03M_120"
  },
  {
    ...
    "opts": ["Physically replacing the rotor", "A method of changing the stator winding connections to alter the number of magnetic poles, providing 2 or 3 fixed speeds", "Changing the supply frequency using a transformer", "Adding resistance to the stator"],
  ...
  },
  {
    ...
    "opts": ["Starting squirrel cage motors", "Very smooth, precise, and reversible speed control of a DC drive motor by varying the field of a dedicated DC generator", "Filtering out VFD harmonics", "Synchronizing alternators"],
  ...
  },
  {
    ...
    "opts": ["It stops instantly", "Back EMF drops to zero, armature current spikes, and the motor runs away to a dangerously high speed (if unloaded)", "It reverses direction", "Nothing, it runs normally"],
  ...
  },
  {
    ...
    "opts": ["To increase the main magnetic field", "To neutralize armature reaction in the commutating zone, preventing brush sparking", "To hold the stator in place", "To provide cooling to the armature"],
  ...
  },
  {
    ...
    "opts": ["Using brake pads to stop the motor", "Operating the motor as a generator to convert kinetic energy back into electrical energy, slowing the load", "Injecting AC into a DC motor", "Reversing the phases instantly"],
  ...
  },
  {
    ...
    "opts": ["Dynamic braking uses mechanical friction", "In Dynamic Braking, the generated energy is dumped into a resistor bank as heat; in Regenerative, it returns to the supply grid", "Dynamic braking is only for AC motors", "They are exactly the same thing"],
  ...
  },
  {
    ...
    "opts": ["Injecting DC into the rotor", "Disconnecting the AC supply and injecting a DC current into the stator to create a stationary magnetic field", "Applying a DC-powered mechanical brake", "Using a DC motor to slow the AC motor"],
  ...
  },
  {
    ...
    "opts": ["It causes severe mechanical wear", "The braking torque decreases rapidly as the motor slows down, and it cannot hold a load at standstill", "It requires a separate generator", "It makes the motor run backwards"],
  ...
  },
  {
    ...
    "opts": ["Unplugging the motor from the wall", "Instantly reversing two phases of the supply while the motor is running to create massive opposing torque", "Injecting DC current", "Using a VFD to slow down"],
  ...
  },
  {
    ...
    "opts": ["Short-time duty (e.g., 30 mins)", "Continuous running duty (can run indefinitely at rated load without exceeding temperature limits)", "Intermittent periodic duty", "Starting duty only"],
  ...
  },
  {
    ...
    "opts": ["The motor is fireproof", "The winding insulation can withstand a maximum hotspot temperature of 155\u00b0C", "It uses fiberglass insulation", "It is for freezing environments"],
  ...
  },
  {
    ...
    "a": "Very smooth, precise, and reversible speed control of a DC drive motor by varying the field of a dedicated DC generator",
    "opts": ["Synchronizing alternators", "Very smooth, precise, and reversible speed control of a DC drive motor by varying the field of a dedicated DC generator", "Filtering out VFD harmonics", "Starting squirrel cage motors"],
    "exp": "Before VFDs, this was the gold standard for cranes and steering gear. An AC motor spins a DC generator, which feeds a DC motor. Controlling the tiny generator field dictates the massive DC motor output.",
    "cat": "Speed",
    "id": "T03M_133"
  },
  {
    ...
    "a": "Back EMF drops to zero, armature current spikes, and the motor runs away to a dangerously high speed (if unloaded)",
    "opts": ["It stops instantly", "Back EMF drops to zero, armature current spikes, and the motor runs away to a dangerously high speed (if unloaded)", "Nothing, it runs normally", "It reverses direction"],
    "exp": "Speed is inversely proportional to flux (N \u221d V / \u03a6). If flux (\u03a6) drops to near zero, speed approaches infinity, potentially destroying the armature via centrifugal force.",
    "cat": "Speed",
    "id": "T03M_134"
  },
  {
    ...
    "a": "To neutralize armature reaction in the commutating zone, preventing brush sparking",
    "opts": ["To provide cooling to the armature", "To hold the stator in place", "To neutralize armature reaction in the commutating zone, preventing brush sparking", "To increase the main magnetic field"],
    "exp": "Armature reaction shifts the magnetic neutral axis. Interpoles (wired in series with the armature) create a localized opposing flux to keep the neutral axis stable, ensuring spark-free commutation.",
    "cat": "Speed",
    "id": "T03M_135"
  },
  {
    ...
    "a": "Operating the motor as a generator to convert kinetic energy back into electrical energy, slowing the load",
    "opts": ["Using brake pads to stop the motor", "Reversing the phases instantly", "Injecting AC into a DC motor", "Operating the motor as a generator to convert kinetic energy back into electrical energy, slowing the load"],
    "exp": "When the load tries to drive the motor faster than the electrical synchronous speed (or field setting), the motor pushes power back into the supply, causing a strong braking effect.",
    "cat": "Speed",
    "id": "T03M_136"
  },
  {
    ...
    "a": "In Dynamic Braking, the generated energy is dumped into a resistor bank as heat; in Regenerative, it returns to the supply grid",
    "opts": ["They are exactly the same thing", "Dynamic braking is only for AC motors", "Dynamic braking uses mechanical friction", "In Dynamic Braking, the generated energy is dumped into a resistor bank as heat; in Regenerative, it returns to the supply grid"],
    "exp": "Dynamic braking is cheaper because it doesn't require an Active Front End, just a chopper circuit and a large resistor bank.",
    "cat": "Speed",
    "id": "T03M_137"
  },
  {
    ...
    "a": "Disconnecting the AC supply and injecting a DC current into the stator to create a stationary magnetic field",
    "opts": ["Using a DC motor to slow the AC motor", "Injecting DC into the rotor", "Applying a DC-powered mechanical brake", "Disconnecting the AC supply and injecting a DC current into the stator to create a stationary magnetic field"],
    "exp": "The spinning rotor cuts the stationary DC magnetic field, inducing rotor currents that create a magnetic torque opposing the rotation. Provides rapid, wear-free braking.",
    "cat": "Speed",
    "id": "T03M_138"
  },
  {
    ...
    "a": "The braking torque decreases rapidly as the motor slows down, and it cannot hold a load at standstill",
    "opts": ["It causes severe mechanical wear", "It makes the motor run backwards", "It requires a separate generator", "The braking torque decreases rapidly as the motor slows down, and it cannot hold a load at standstill"],
    "exp": "Since braking torque depends on relative motion (speed), as speed approaches zero, braking force approaches zero. A mechanical holding brake is still required for cranes.",
    "cat": "Speed",
    "id": "T03M_139"
  },
  {
    ...
    "a": "Instantly reversing two phases of the supply while the motor is running to create massive opposing torque",
    "opts": ["Unplugging the motor from the wall", "Injecting DC current", "Using a VFD to slow down", "Instantly reversing two phases of the supply while the motor is running to create massive opposing torque"],
    "exp": "This reverses the RMF direction. The motor is suddenly operating at a slip of almost 200%. It causes violent braking and huge electrical/mechanical stress. Rarely used on modern ships.",
    "cat": "Speed",
    "id": "T03M_140"
  },
  {
    ...
    "a": "Continuous running duty (can run indefinitely at rated load without exceeding temperature limits)",
    "opts": ["Continuous running duty (can run indefinitely at rated load without exceeding temperature limits)", "Starting duty only", "Intermittent periodic duty", "Short-time duty (e.g., 30 mins)"],
    "exp": "Pumps and fans are S1. A windlass motor might be S2 (30 min short-time duty), meaning it will overheat if run continuously for hours.",
    "cat": "Speed",
    "id": "T03M_141"
  },
  {
    ...
    "a": "The winding insulation can withstand a maximum hotspot temperature of 155\u00b0C",
    "opts": ["The motor is fireproof", "It is for freezing environments", "The winding insulation can withstand a maximum hotspot temperature of 155\u00b0C", "It uses fiberglass insulation"],
    "exp": "Class B = 130\u00b0C, F = 155\u00b0C, H = 180\u00b0C. Marine motors are often built to Class F but operated at Class B limits for a safety margin.",
    "cat": "Speed",
    "id": "T03M_142"
  },
  {
    ...
    "a": "A method of changing the stator winding connections to alter the number of magnetic poles, providing 2 or 3 fixed speeds",
    "opts": ["A method of changing the stator winding connections to alter the number of magnetic poles, providing 2 or 3 fixed speeds", "Physically replacing the rotor", "Adding resistance to the stator", "Changing the supply frequency using a transformer"],
    "exp": "By switching contactors, a winding can be reconfigured from 4-pole (1500 RPM) to 8-pole (750 RPM). Commonly used on older cranes and two-speed fans.",
    "cat": "Speed",
    "id": "T03M_143"
  },
  {
    ...
    "a": "Very smooth, precise, and reversible speed control of a DC drive motor by varying the field of a dedicated DC generator",
    "opts": ["Synchronizing alternators", "Filtering out VFD harmonics", "Starting squirrel cage motors", "Very smooth, precise, and reversible speed control of a DC drive motor by varying the field of a dedicated DC generator"],
    "exp": "Before VFDs, this was the gold standard for cranes and steering gear. An AC motor spins a DC generator, which feeds a DC motor. Controlling the tiny generator field dictates the massive DC motor output.",
    "cat": "Speed",
    "id": "T03M_144"
  },
  {
    ...
    "a": "Back EMF drops to zero, armature current spikes, and the motor runs away to a dangerously high speed (if unloaded)",
    "opts": ["Back EMF drops to zero, armature current spikes, and the motor runs away to a dangerously high speed (if unloaded)", "Nothing, it runs normally", "It reverses direction", "It stops instantly"],
    "exp": "Speed is inversely proportional to flux (N \u221d V / \u03a6). If flux (\u03a6) drops to near zero, speed approaches infinity, potentially destroying the armature via centrifugal force.",
    "cat": "Speed",
    "id": "T03M_145"
  },
  {
    ...
    "a": "To neutralize armature reaction in the commutating zone, preventing brush sparking",
    "opts": ["To provide cooling to the armature", "To increase the main magnetic field", "To hold the stator in place", "To neutralize armature reaction in the commutating zone, preventing brush sparking"],
    "exp": "Armature reaction shifts the magnetic neutral axis. Interpoles (wired in series with the armature) create a localized opposing flux to keep the neutral axis stable, ensuring spark-free commutation.",
    "cat": "Speed",
    "id": "T03M_146"
  },
  {
    ...
    "a": "Operating the motor as a generator to convert kinetic energy back into electrical energy, slowing the load",
    "opts": ["Injecting AC into a DC motor", "Operating the motor as a generator to convert kinetic energy back into electrical energy, slowing the load", "Reversing the phases instantly", "Using brake pads to stop the motor"],
    "exp": "When the load tries to drive the motor faster than the electrical synchronous speed (or field setting), the motor pushes power back into the supply, causing a strong braking effect.",
    "cat": "Speed",
    "id": "T03M_147"
  },
  {
    ...
    "a": "In Dynamic Braking, the generated energy is dumped into a resistor bank as heat; in Regenerative, it returns to the supply grid",
    "opts": ["Dynamic braking is only for AC motors", "Dynamic braking uses mechanical friction", "In Dynamic Braking, the generated energy is dumped into a resistor bank as heat; in Regenerative, it returns to the supply grid", "They are exactly the same thing"],
    "exp": "Dynamic braking is cheaper because it doesn't require an Active Front End, just a chopper circuit and a large resistor bank.",
    "cat": "Speed",
    "id": "T03M_148"
  },
  {
    ...
    "a": "Disconnecting the AC supply and injecting a DC current into the stator to create a stationary magnetic field",
    "opts": ["Using a DC motor to slow the AC motor", "Injecting DC into the rotor", "Disconnecting the AC supply and injecting a DC current into the stator to create a stationary magnetic field", "Applying a DC-powered mechanical brake"],
    "exp": "The spinning rotor cuts the stationary DC magnetic field, inducing rotor currents that create a magnetic torque opposing the rotation. Provides rapid, wear-free braking.",
    "cat": "Speed",
    "id": "T03M_149"
  },
  {
    ...
    "a": "The braking torque decreases rapidly as the motor slows down, and it cannot hold a load at standstill",
    "opts": ["It makes the motor run backwards", "The braking torque decreases rapidly as the motor slows down, and it cannot hold a load at standstill", "It requires a separate generator", "It causes severe mechanical wear"],
    "exp": "Since braking torque depends on relative motion (speed), as speed approaches zero, braking force approaches zero. A mechanical holding brake is still required for cranes.",
    "cat": "Speed",
    "id": "T03M_150"
  },
  {
    ...
    "opts": ["It defines the voltage", "It defines the physical mounting dimensions, primarily the shaft centreline height (160mm) and bolt hole spacing", "It indicates the weight", "It specifies the IP rating"],
  ...
  },
  {
    ...
    "opts": ["Using rubber vibration dampers", "When all four feet of the motor do not sit flat on the base, causing the motor frame to twist when bolted tight", "A loose bearing", "The magnetic pull on the rotor"],
  ...
  },
  {
    ...
    "opts": ["Parallel offset", "Angular misalignment (the flanges are not parallel)", "Axial end play", "Shaft runout"],
  ...
  },
  {
    ...
    "opts": ["It makes the motor run too fast", "The grease cannot expand, causing churning, severe overheating, blown seals, and grease entering the stator windings", "It causes electrical short circuits in the rotor", "It washes away the old grease"],
  ...
  },
  {
    ...
    "opts": ["It is a high-speed bearing", "The bearing has metal shields on both sides to retain grease and keep out large dust", "It has rubber seals", "It is self-aligning"],
  ...
  },
  {
    ...
    "opts": ["It is a Class 3 bearing", "The internal radial clearance is greater than standard, used for motors operating at high temperatures", "It has 3 rows of balls", "It is made of ceramic"],
  ...
  },
  {
    ...
    "opts": ["By hammering the outer race", "By heating it evenly (e.g., induction heater or oil bath) to expand the inner race before sliding it onto the shaft", "By cooling the bearing in a freezer", "By using a hydraulic press on the outer ring"],
  ...
  },
  {
    ...
    "opts": ["Vibration analysis", "Insulation Resistance (IR) test (Megger test) between phases and to earth", "High voltage AC withstand test", "Load test at 150% capacity"],
  ...
  },
  {
    ...
    "a": "It defines the physical mounting dimensions, primarily the shaft centreline height (160mm) and bolt hole spacing",
    "opts": ["It indicates the weight", "It defines the voltage", "It specifies the IP rating", "It defines the physical mounting dimensions, primarily the shaft centreline height (160mm) and bolt hole spacing"],
    "exp": "If you order a different frame size, the shaft won't align with the pump, and the feet won't align with the foundation bedplate.",
    "cat": "Maint",
    "id": "T03M_159"
  },
  {
    ...
    "a": "When all four feet of the motor do not sit flat on the base, causing the motor frame to twist when bolted tight",
    "opts": ["Using rubber vibration dampers", "The magnetic pull on the rotor", "A loose bearing", "When all four feet of the motor do not sit flat on the base, causing the motor frame to twist when bolted tight"],
    "exp": "Tightening a soft foot distorts the stator frame, creating an uneven air gap and destroying the alignment. It must be corrected with shims before final alignment.",
    "cat": "Maint",
    "id": "T03M_160"
  },
  {
    ...
    "a": "Angular misalignment (the flanges are not parallel)",
    "opts": ["Axial end play", "Shaft runout", "Parallel offset", "Angular misalignment (the flanges are not parallel)"],
    "exp": "The dial indicator sweeps the face of the coupling half. If the reading changes, the shafts are pointing at an angle to each other.",
    "cat": "Maint",
    "id": "T03M_161"
  },
  {
    ...
    "a": "The grease cannot expand, causing churning, severe overheating, blown seals, and grease entering the stator windings",
    "opts": ["The grease cannot expand, causing churning, severe overheating, blown seals, and grease entering the stator windings", "It washes away the old grease", "It makes the motor run too fast", "It causes electrical short circuits in the rotor"],
    "exp": "A bearing housing should only be 30-50% full. Over-packing it causes immense fluid friction. Always leave the bottom relief plug open during greasing.",
    "cat": "Maint",
    "id": "T03M_162"
  },
  {
    ...
    "a": "The bearing has metal shields on both sides to retain grease and keep out large dust",
    "opts": ["It is a high-speed bearing", "It is self-aligning", "The bearing has metal shields on both sides to retain grease and keep out large dust", "It has rubber seals"],
    "exp": "ZZ = double metal shield (non-contact). 2RS = double rubber seal (contact). Shields are better for high speeds, seals are better for dirty environments.",
    "cat": "Maint",
    "id": "T03M_163"
  },
  {
    ...
    "a": "The internal radial clearance is greater than standard, used for motors operating at high temperatures",
    "opts": ["It is made of ceramic", "It is a Class 3 bearing", "The internal radial clearance is greater than standard, used for motors operating at high temperatures", "It has 3 rows of balls"],
    "exp": "As the motor heats up, the inner ring on the hot shaft expands faster than the outer ring. A C3 clearance prevents the bearing from seizing due to thermal expansion.",
    "cat": "Maint",
    "id": "T03M_164"
  },
  {
    ...
    "a": "By heating it evenly (e.g., induction heater or oil bath) to expand the inner race before sliding it onto the shaft",
    "opts": ["By heating it evenly (e.g., induction heater or oil bath) to expand the inner race before sliding it onto the shaft", "By cooling the bearing in a freezer", "By hammering the outer race", "By using a hydraulic press on the outer ring"],
    "exp": "Never hammer a bearing, especially not on the outer race, as the force transmits through the balls and damages the raceways (brinelling). Heat to ~100\u00b0C max.",
    "cat": "Maint",
    "id": "T03M_165"
  },
  {
    ...
    "a": "Insulation Resistance (IR) test (Megger test) between phases and to earth",
    "opts": ["High voltage AC withstand test", "Insulation Resistance (IR) test (Megger test) between phases and to earth", "Vibration analysis", "Load test at 150% capacity"],
    "exp": "A megger test verifies the integrity of the new varnish/insulation. A reading of >1 M\u03a9 (minimum, ideally >100 M\u03a9) is required before applying 440V to prevent immediate short circuits.",
    "cat": "Maint",
    "id": "T03M_166"
  },
  ...
  },
  {
    ...
    "a": "When all four feet of the motor do not sit flat on the base, causing the motor frame to twist when bolted tight",
    "opts": ["The magnetic pull on the rotor", "A loose bearing", "Using rubber vibration dampers", "When all four feet of the motor do not sit flat on the base, causing the motor frame to twist when bolted tight"],
    "exp": "Tightening a soft foot distorts the stator frame, creating an uneven air gap and destroying the alignment. It must be corrected with shims before final alignment.",
    "cat": "Maint",
    "id": "T03M_168"
  },
  {
    ...
    "a": "Angular misalignment (the flanges are not parallel)",
    "opts": ["Parallel offset", "Shaft runout", "Axial end play", "Angular misalignment (the flanges are not parallel)"],
    "exp": "The dial indicator sweeps the face of the coupling half. If the reading changes, the shafts are pointing at an angle to each other.",
    "cat": "Maint",
    "id": "T03M_169"
  },
  {
    ...
    "a": "The grease cannot expand, causing churning, severe overheating, blown seals, and grease entering the stator windings",
    "opts": ["It washes away the old grease", "The grease cannot expand, causing churning, severe overheating, blown seals, and grease entering the stator windings", "It causes electrical short circuits in the rotor", "It makes the motor run too fast"],
    "exp": "A bearing housing should only be 30-50% full. Over-packing it causes immense fluid friction. Always leave the bottom relief plug open during greasing.",
    "cat": "Maint",
    "id": "T03M_170"
  },
  {
    ...
    "a": "The bearing has metal shields on both sides to retain grease and keep out large dust",
    "opts": ["It is self-aligning", "It is a high-speed bearing", "The bearing has metal shields on both sides to retain grease and keep out large dust", "It has rubber seals"],
    "exp": "ZZ = double metal shield (non-contact). 2RS = double rubber seal (contact). Shields are better for high speeds, seals are better for dirty environments.",
    "cat": "Maint",
    "id": "T03M_171"
  },
  {
    ...
    "a": "The internal radial clearance is greater than standard, used for motors operating at high temperatures",
    "opts": ["It is a Class 3 bearing", "The internal radial clearance is greater than standard, used for motors operating at high temperatures", "It is made of ceramic", "It has 3 rows of balls"],
    "exp": "As the motor heats up, the inner ring on the hot shaft expands faster than the outer ring. A C3 clearance prevents the bearing from seizing due to thermal expansion.",
    "cat": "Maint",
    "id": "T03M_172"
  },
  {
    ...
    "a": "By heating it evenly (e.g., induction heater or oil bath) to expand the inner race before sliding it onto the shaft",
    "opts": ["By cooling the bearing in a freezer", "By hammering the outer race", "By heating it evenly (e.g., induction heater or oil bath) to expand the inner race before sliding it onto the shaft", "By using a hydraulic press on the outer ring"],
    "exp": "Never hammer a bearing, especially not on the outer race, as the force transmits through the balls and damages the raceways (brinelling). Heat to ~100\u00b0C max.",
    "cat": "Maint",
    "id": "T03M_173"
  },
  {
    ...
    "a": "Insulation Resistance (IR) test (Megger test) between phases and to earth",
    "opts": ["Vibration analysis", "Load test at 150% capacity", "High voltage AC withstand test", "Insulation Resistance (IR) test (Megger test) between phases and to earth"],
    "exp": "A megger test verifies the integrity of the new varnish/insulation. A reading of >1 M\u03a9 (minimum, ideally >100 M\u03a9) is required before applying 440V to prevent immediate short circuits.",
    "cat": "Maint",
    "id": "T03M_174"
  },
  {
    ...
    "a": "It defines the physical mounting dimensions, primarily the shaft centreline height (160mm) and bolt hole spacing",
    "opts": ["It defines the physical mounting dimensions, primarily the shaft centreline height (160mm) and bolt hole spacing", "It indicates the weight", "It specifies the IP rating", "It defines the voltage"],
    "exp": "If you order a different frame size, the shaft won't align with the pump, and the feet won't align with the foundation bedplate.",
    "cat": "Maint",
    "id": "T03M_175"
  },
  {
    ...
    "a": "When all four feet of the motor do not sit flat on the base, causing the motor frame to twist when bolted tight",
    "opts": ["When all four feet of the motor do not sit flat on the base, causing the motor frame to twist when bolted tight", "Using rubber vibration dampers", "A loose bearing", "The magnetic pull on the rotor"],
    "exp": "Tightening a soft foot distorts the stator frame, creating an uneven air gap and destroying the alignment. It must be corrected with shims before final alignment.",
    "cat": "Maint",
    "id": "T03M_176"
  },
  {
    ...
    "a": "Angular misalignment (the flanges are not parallel)",
    "opts": ["Axial end play", "Parallel offset", "Angular misalignment (the flanges are not parallel)", "Shaft runout"],
    "exp": "The dial indicator sweeps the face of the coupling half. If the reading changes, the shafts are pointing at an angle to each other.",
    "cat": "Maint",
    "id": "T03M_177"
  },
  {
    ...
    "a": "The grease cannot expand, causing churning, severe overheating, blown seals, and grease entering the stator windings",
    "opts": ["It makes the motor run too fast", "It causes electrical short circuits in the rotor", "The grease cannot expand, causing churning, severe overheating, blown seals, and grease entering the stator windings", "It washes away the old grease"],
    "exp": "A bearing housing should only be 30-50% full. Over-packing it causes immense fluid friction. Always leave the bottom relief plug open during greasing.",
    "cat": "Maint",
    "id": "T03M_178"
  },
  {
    ...
    "a": "The bearing has metal shields on both sides to retain grease and keep out large dust",
    "opts": ["It is a high-speed bearing", "It is self-aligning", "It has rubber seals", "The bearing has metal shields on both sides to retain grease and keep out large dust"],
    "exp": "ZZ = double metal shield (non-contact). 2RS = double rubber seal (contact). Shields are better for high speeds, seals are better for dirty environments.",
    "cat": "Maint",
    "id": "T03M_179"
  },
  {
    ...
    "a": "The internal radial clearance is greater than standard, used for motors operating at high temperatures",
    "opts": ["The internal radial clearance is greater than standard, used for motors operating at high temperatures", "It is made of ceramic", "It is a Class 3 bearing", "It has 3 rows of balls"],
    "exp": "As the motor heats up, the inner ring on the hot shaft expands faster than the outer ring. A C3 clearance prevents the bearing from seizing due to thermal expansion.",
    "cat": "Maint",
    "id": "T03M_180"
  },
  {
    ...
    "opts": ["To protect against short circuits", "To protect against sustained overcurrents (overheating) using a bimetallic strip", "To protect against voltage drops", "To monitor bearing temperature"],
  ...
  },
  {
    ...
    "opts": ["It is not connected to the main power lines", "It responds too slowly (thermal time delay); short circuits require instantaneous clearing", "It only measures voltage", "It cannot handle high voltages"],
  ...
  },
  {
    ...
    "opts": ["Rewirable fuses", "HRC (High Rupturing Capacity) Fuses", "Glass cartridge fuses", "Automotive blade fuses"],
  ...
  },
  {
    ...
    "opts": ["Exactly equal to the FLC", "1.5 to 2.5 times the motor FLC", "5 to 8 times the FLC", "Half the FLC"],
  ...
  },
  {
    ...
    "opts": ["It measures the phase voltage directly", "It uses a differential mechanism that trips much faster if one bimetallic strip cools down while the others heat up", "It has a built in fuse for each phase", "It communicates with the AVR"],
  ...
  },
  {
    ...
    "opts": ["It will start normally but run slowly", "The motor will hum loudly but will not rotate, and will quickly burn out if not tripped", "It will run in reverse", "It will generate high voltage"],
  ...
  },
  {
    ...
    "opts": ["The motor spinning backwards", "The unbalanced voltage creates a counter-rotating magnetic field that induces high frequency currents in the rotor", "The VFD injecting DC", "The earth fault relay"],
  ...
  },
  {
    ...
    "opts": ["Earth fault relay", "Phase Failure / Phase Sequence Relay", "Reverse power relay", "Under-voltage relay"],
  ...
  },
  {
    ...
    "opts": ["To keep the windings warm", "To provide direct thermal protection by measuring actual winding temperature, regardless of current draw", "To measure ambient air temperature", "To control the speed of the VFD"],
  ...
  },
  {
    ...
    "opts": ["It pre-heats the bearings before starting", "It turns on automatically when the motor STOPS, keeping windings warm to prevent moisture condensation", "It warms the fuel oil for the pump", "It provides braking torque"],
  ...
  },
  {
    ...
    "opts": ["From the motor's back EMF", "Usually from an independent 220V supply, interlocked via a normally-closed (NC) contact of the main contactor", "From a built in battery", "From the 440V main busbar directly"],
  ...
  },
  {
    ...
    "opts": ["It measures voltage to the hull", "It wraps around all 3 phase cables; if no leakage exists, the vector sum of currents is zero", "It measures the resistance of the earth cable", "It detects smoke in the terminal box"],
  ...
  },
  {
    ...
    "a": "To protect against sustained overcurrents (overheating) using a bimetallic strip",
    "opts": ["To protect against voltage drops", "To protect against sustained overcurrents (overheating) using a bimetallic strip", "To protect against short circuits", "To monitor bearing temperature"],
    "exp": "The OLR mimics the thermal characteristic of the motor. High current bends a bimetallic strip, eventually tripping the control circuit. It has an IDMT (Inverse Definite Minimum Time) characteristic.",
    "cat": "Protect",
    "id": "T03M_193"
  },
  {
    ...
    "a": "It responds too slowly (thermal time delay); short circuits require instantaneous clearing",
    "opts": ["It responds too slowly (thermal time delay); short circuits require instantaneous clearing", "It cannot handle high voltages", "It is not connected to the main power lines", "It only measures voltage"],
    "exp": "An OLR takes seconds or minutes to trip. A short circuit (thousands of amps) will melt the wires before the bimetallic strip bends. Short circuits are cleared by Fuses or Magnetic MCBs.",
    "cat": "Protect",
    "id": "T03M_194"
  },
  {
    ...
    "a": "HRC (High Rupturing Capacity) Fuses",
    "opts": ["Rewirable fuses", "HRC (High Rupturing Capacity) Fuses", "Automotive blade fuses", "Glass cartridge fuses"],
    "exp": "HRC fuses can safely interrupt massive fault currents (e.g., 80kA) without exploding, thanks to the arc-quenching silica sand inside.",
    "cat": "Protect",
    "id": "T03M_195"
  },
  {
    ...
    "a": "1.5 to 2.5 times the motor FLC",
    "opts": ["1.5 to 2.5 times the motor FLC", "Half the FLC", "Exactly equal to the FLC", "5 to 8 times the FLC"],
    "exp": "The fuse must NOT blow during the massive 6x DOL starting current surge. Therefore, they are rated higher than FLC. The OLR handles the slight overloads.",
    "cat": "Protect",
    "id": "T03M_196"
  },
  {
    ...
    "a": "It uses a differential mechanism that trips much faster if one bimetallic strip cools down while the others heat up",
    "opts": ["It uses a differential mechanism that trips much faster if one bimetallic strip cools down while the others heat up", "It measures the phase voltage directly", "It communicates with the AVR", "It has a built in fuse for each phase"],
    "exp": "If one phase is lost, its strip cools and straightens. The other two carry 2x current and bend aggressively. A mechanical slide bar detects this differential and trips rapidly.",
    "cat": "Protect",
    "id": "T03M_197"
  },
  {
    ...
    "a": "The motor will hum loudly but will not rotate, and will quickly burn out if not tripped",
    "opts": ["It will start normally but run slowly", "It will run in reverse", "It will generate high voltage", "The motor will hum loudly but will not rotate, and will quickly burn out if not tripped"],
    "exp": "Two phases cannot create a Rotating Magnetic Field, only a pulsating field. Starting torque is strictly zero.",
    "cat": "Protect",
    "id": "T03M_198"
  },
  {
    ...
    "a": "The unbalanced voltage creates a counter-rotating magnetic field that induces high frequency currents in the rotor",
    "opts": ["The motor spinning backwards", "The VFD injecting DC", "The earth fault relay", "The unbalanced voltage creates a counter-rotating magnetic field that induces high frequency currents in the rotor"],
    "exp": "The pulsating field can be mathematically split into a forward RMF and a backward RMF. The backward RMF spins at 2x slip frequency relative to the rotor, causing immense localized heating.",
    "cat": "Protect",
    "id": "T03M_199"
  },
  {
    ...
    "a": "Phase Failure / Phase Sequence Relay",
    "opts": ["Earth fault relay", "Under-voltage relay", "Phase Failure / Phase Sequence Relay", "Reverse power relay"],
    "exp": "This relay directly monitors the 3-phase voltage waveform. If a phase drops, or if the sequence is reversed (which would run the pump backwards), it instantly opens the control circuit.",
    "cat": "Protect",
    "id": "T03M_200"
  },
  {
    ...
    "a": "To provide direct thermal protection by measuring actual winding temperature, regardless of current draw",
    "opts": ["To measure ambient air temperature", "To control the speed of the VFD", "To keep the windings warm", "To provide direct thermal protection by measuring actual winding temperature, regardless of current draw"],
    "exp": "If the motor cooling fan fails, or filter is blocked, the motor will overheat even if drawing normal current. The OLR won't see this, but the thermistors will spike in resistance and trip the motor.",
    "cat": "Protect",
    "id": "T03M_201"
  },
  {
    ...
    "a": "It turns on automatically when the motor STOPS, keeping windings warm to prevent moisture condensation",
    "opts": ["It warms the fuel oil for the pump", "It pre-heats the bearings before starting", "It turns on automatically when the motor STOPS, keeping windings warm to prevent moisture condensation", "It provides braking torque"],
    "exp": "When a hot motor stops, cooling draws in humid ER air. If it cools below the dew point, water condenses on the windings, ruining insulation. The heater prevents this.",
    "cat": "Protect",
    "id": "T03M_202"
  },
  {
    ...
    "a": "Usually from an independent 220V supply, interlocked via a normally-closed (NC) contact of the main contactor",
    "opts": ["Usually from an independent 220V supply, interlocked via a normally-closed (NC) contact of the main contactor", "From the motor's back EMF", "From a built in battery", "From the 440V main busbar directly"],
    "exp": "When KM is open (motor off), the NC auxiliary contact is closed, feeding 220V to the heater. \ud83d\udd34 DANGER: This means 220V is LIVE inside the terminal box even when the 440V breaker is off!",
    "cat": "Protect",
    "id": "T03M_203"
  },
  {
    ...
    "a": "It wraps around all 3 phase cables; if no leakage exists, the vector sum of currents is zero",
    "opts": ["It measures voltage to the hull", "It detects smoke in the terminal box", "It measures the resistance of the earth cable", "It wraps around all 3 phase cables; if no leakage exists, the vector sum of currents is zero"],
    "exp": "Normally, whatever current goes down R and Y returns via B. The net magnetic field is zero. If current leaks to the hull (earth), the sum is no longer zero, inducing a signal in the CBCT.",
    "cat": "Protect",
    "id": "T03M_204"
  },
  {
    ...
    "a": "To protect against sustained overcurrents (overheating) using a bimetallic strip",
    "opts": ["To protect against voltage drops", "To monitor bearing temperature", "To protect against short circuits", "To protect against sustained overcurrents (overheating) using a bimetallic strip"],
    "exp": "The OLR mimics the thermal characteristic of the motor. High current bends a bimetallic strip, eventually tripping the control circuit. It has an IDMT (Inverse Definite Minimum Time) characteristic.",
    "cat": "Protect",
    "id": "T03M_205"
  },
  {
    ...
    "a": "It responds too slowly (thermal time delay); short circuits require instantaneous clearing",
    "opts": ["It responds too slowly (thermal time delay); short circuits require instantaneous clearing", "It only measures voltage", "It is not connected to the main power lines", "It cannot handle high voltages"],
    "exp": "An OLR takes seconds or minutes to trip. A short circuit (thousands of amps) will melt the wires before the bimetallic strip bends. Short circuits are cleared by Fuses or Magnetic MCBs.",
    "cat": "Protect",
    "id": "T03M_206"
  },
  {
    ...
    "a": "HRC (High Rupturing Capacity) Fuses",
    "opts": ["HRC (High Rupturing Capacity) Fuses", "Automotive blade fuses", "Glass cartridge fuses", "Rewirable fuses"],
    "exp": "HRC fuses can safely interrupt massive fault currents (e.g., 80kA) without exploding, thanks to the arc-quenching silica sand inside.",
    "cat": "Protect",
    "id": "T03M_207"
  },
  {
    ...
    "a": "1.5 to 2.5 times the motor FLC",
    "opts": ["1.5 to 2.5 times the motor FLC", "Exactly equal to the FLC", "5 to 8 times the FLC", "Half the FLC"],
    "exp": "The fuse must NOT blow during the massive 6x DOL starting current surge. Therefore, they are rated higher than FLC. The OLR handles the slight overloads.",
    "cat": "Protect",
    "id": "T03M_208"
  },
  {
    ...
    "a": "It uses a differential mechanism that trips much faster if one bimetallic strip cools down while the others heat up",
    "opts": ["It measures the phase voltage directly", "It communicates with the AVR", "It uses a differential mechanism that trips much faster if one bimetallic strip cools down while the others heat up", "It has a built in fuse for each phase"],
    "exp": "If one phase is lost, its strip cools and straightens. The other two carry 2x current and bend aggressively. A mechanical slide bar detects this differential and trips rapidly.",
    "cat": "Protect",
    "id": "T03M_209"
  },
  {
    ...
    "a": "The motor will hum loudly but will not rotate, and will quickly burn out if not tripped",
    "opts": ["The motor will hum loudly but will not rotate, and will quickly burn out if not tripped", "It will start normally but run slowly", "It will run in reverse", "It will generate high voltage"],
    "exp": "Two phases cannot create a Rotating Magnetic Field, only a pulsating field. Starting torque is strictly zero.",
    "cat": "Protect",
    "id": "T03M_210"
  },
  {
    ...
    "opts": ["A motor with two stators", "A motor with two sets of rotor bars: an outer high-resistance cage and an inner low-resistance cage", "A motor with physical safety guards", "A slip ring motor without brushes"],
  ...
  },
  {
    ...
    "opts": ["Because the inner cage is disconnected by a switch", "At start, rotor frequency is 50Hz. High frequency pushes current to the surface (skin effect) into the high-resistance outer bars", "Because the outer cage has less resistance", "Because of centrifugal force"],
  ...
  },
  {
    ...
    "opts": ["For continuous running pumps", "For machinery requiring High Starting Torque without complex starters: Windlass, Mooring Winches, Bow Thrusters", "For small ventilation fans", "For the main propulsion"],
  ...
  },
  {
    ...
    "opts": ["Bearing failure", "The 7th harmonic in the air-gap flux creates a forward-rotating field at 1/7th synchronous speed, forming a reluctance torque dip", "Low supply voltage", "Single phasing"],
  ...
  },
  {
    ...
    "opts": ["By making the air gap larger", "By skewing the rotor slots and properly chording the stator windings to eliminate the 7th harmonic", "By using a VFD", "By greasing the bearings heavily"],
  ...
  },
  {
    ...
    "opts": ["kW and Voltage only", "kW, Voltage, Hz, Poles/RPM, Frame Size, IP Rating, Insulation Class, Mounting type (B3/B5)", "Weight and color", "Horsepower and brand name"],
  ...
  },
  {
    ...
    "opts": ["B3 is vertical; B5 is horizontal", "B3 is Foot-mounted; B5 is Flange-mounted", "B3 is waterproof; B5 is not", "B3 requires a VFD; B5 is DOL"],
  ...
  },
  {
    ...
    "opts": ["Connect it to 440V and run it", "Insulation Resistance test (Megger) between all phases and earth", "Check the bearing grease", "Paint the casing"],
  ...
  },
  {
    ...
    "opts": ["To check if the motor is a squirrel cage", "To ensure Resistance Balance; all phases must be equal within 2% to prevent unbalanced magnetic pull and heating", "To calculate the power factor", "To check the insulation"],
  ...
  },
  {
    ...
    "opts": ["A Megger", "A Phase Rotation Meter", "An Oscilloscope", "A Hydrometer"],
  ...
  },
  {
    ...
    "opts": ["Splash proof", "Dust tight (6) and suitable for continuous submersion in water (8)", "Explosion proof", "Ventilated enclosure"],
  ...
  },
  {
    ...
    "opts": ["180\u00b0C", "Class B temperature limits (130\u00b0C) to provide a 25\u00b0C safety margin for reliability", "45\u00b0C ambient only", "155\u00b0C continuously"],
  ...
  },
  {
    ...
    "opts": ["Intrinsically safe", "Flameproof enclosure: it can withstand an internal explosion without igniting the outside atmosphere", "Increased safety", "Non-sparking"],
  ...
  },
  {
    ...
    "a": "A motor with two sets of rotor bars: an outer high-resistance cage and an inner low-resistance cage",
    "opts": ["A motor with two sets of rotor bars: an outer high-resistance cage and an inner low-resistance cage", "A motor with two stators", "A slip ring motor without brushes", "A motor with physical safety guards"],
    "exp": "This clever design uses the 'skin effect' to automatically provide high torque during starting (outer cage) and high efficiency during running (inner cage) without external starters.",
    "cat": "Gap",
    "id": "T03M_224"
  },
  {
    ...
    "a": "At start, rotor frequency is 50Hz. High frequency pushes current to the surface (skin effect) into the high-resistance outer bars",
    "opts": ["Because the outer cage has less resistance", "At start, rotor frequency is 50Hz. High frequency pushes current to the surface (skin effect) into the high-resistance outer bars", "Because of centrifugal force", "Because the inner cage is disconnected by a switch"],
    "exp": "The inner cage is deeply buried, giving it massive inductive reactance (XL = 2\u03c0fL) at 50Hz. Current takes the path of least impedance: the outer cage.",
    "cat": "Gap",
    "id": "T03M_225"
  },
  {
    ...
    "a": "For machinery requiring High Starting Torque without complex starters: Windlass, Mooring Winches, Bow Thrusters",
    "opts": ["For machinery requiring High Starting Torque without complex starters: Windlass, Mooring Winches, Bow Thrusters", "For continuous running pumps", "For the main propulsion", "For small ventilation fans"],
    "exp": "A windlass must start against massive chain tension. A double cage gives excellent DOL starting torque without the need for delicate slip rings.",
    "cat": "Gap",
    "id": "T03M_226"
  },
  {
    ...
    "a": "The 7th harmonic in the air-gap flux creates a forward-rotating field at 1/7th synchronous speed, forming a reluctance torque dip",
    "opts": ["Low supply voltage", "The 7th harmonic in the air-gap flux creates a forward-rotating field at 1/7th synchronous speed, forming a reluctance torque dip", "Bearing failure", "Single phasing"],
    "exp": "If the mechanical load torque is higher than this 'dip' in the motor's torque curve, the motor gets stuck at 1/7th speed (e.g., 200 RPM instead of 1450 RPM).",
    "cat": "Gap",
    "id": "T03M_227"
  },
  {
    ...
    "a": "By skewing the rotor slots and properly chording the stator windings to eliminate the 7th harmonic",
    "opts": ["By skewing the rotor slots and properly chording the stator windings to eliminate the 7th harmonic", "By using a VFD", "By greasing the bearings heavily", "By making the air gap larger"],
    "exp": "Skewing breaks up the harmonic alignment. Chording (short-pitching) the stator coils cancels out specific spatial harmonics in the flux.",
    "cat": "Gap",
    "id": "T03M_228"
  },
  {
    ...
    "a": "kW, Voltage, Hz, Poles/RPM, Frame Size, IP Rating, Insulation Class, Mounting type (B3/B5)",
    "opts": ["kW and Voltage only", "Horsepower and brand name", "kW, Voltage, Hz, Poles/RPM, Frame Size, IP Rating, Insulation Class, Mounting type (B3/B5)", "Weight and color"],
    "exp": "A motor cannot be replaced unless the physical dimensions (Frame, Mounting) and environmental limits (IP, Class) match, alongside the electrical specs.",
    "cat": "Gap",
    "id": "T03M_229"
  },
  {
    ...
    "a": "B3 is Foot-mounted; B5 is Flange-mounted",
    "opts": ["B3 is vertical; B5 is horizontal", "B3 is waterproof; B5 is not", "B3 requires a VFD; B5 is DOL", "B3 is Foot-mounted; B5 is Flange-mounted"],
    "exp": "B3 has feet to bolt onto a bedplate. B5 has a circular flange on the drive end to bolt directly onto a pump casing (no feet). B35 has both.",
    "cat": "Gap",
    "id": "T03M_230"
  },
  {
    ...
    "a": "Insulation Resistance test (Megger) between all phases and earth",
    "opts": ["Check the bearing grease", "Paint the casing", "Connect it to 440V and run it", "Insulation Resistance test (Megger) between all phases and earth"],
    "exp": "You must verify the shore workshop did not damage the insulation or leave moisture in the windings before applying main power.",
    "cat": "Gap",
    "id": "T03M_231"
  },
  {
    ...
    "a": "To ensure Resistance Balance; all phases must be equal within 2% to prevent unbalanced magnetic pull and heating",
    "opts": ["To check if the motor is a squirrel cage", "To ensure Resistance Balance; all phases must be equal within 2% to prevent unbalanced magnetic pull and heating", "To check the insulation", "To calculate the power factor"],
    "exp": "If the winder used the wrong wire gauge or fewer turns on one phase, the resistance will differ, causing severe issues under load.",
    "cat": "Gap",
    "id": "T03M_232"
  },
  {
    ...
    "a": "A Phase Rotation Meter",
    "opts": ["A Hydrometer", "A Phase Rotation Meter", "An Oscilloscope", "A Megger"],
    "exp": "Running a pump backwards can unscrew the impeller or destroy the mechanical seal instantly. You must verify the supply phase sequence matches the motor's intended rotation.",
    "cat": "Gap",
    "id": "T03M_233"
  },
  {
    ...
    "a": "Dust tight (6) and suitable for continuous submersion in water (8)",
    "opts": ["Dust tight (6) and suitable for continuous submersion in water (8)", "Splash proof", "Ventilated enclosure", "Explosion proof"],
    "exp": "A standard engine room motor is IP44. An exposed deck motor is IP55/56. Only IP68 guarantees survival if fully submerged in the bilges.",
    "cat": "Gap",
    "id": "T03M_234"
  },
  {
    ...
    "a": "Class B temperature limits (130\u00b0C) to provide a 25\u00b0C safety margin for reliability",
    "opts": ["155\u00b0C continuously", "Class B temperature limits (130\u00b0C) to provide a 25\u00b0C safety margin for reliability", "45\u00b0C ambient only", "180\u00b0C"],
    "exp": "Marine classification societies prefer 'Class F insulated, Class B rise'. This thermal buffer ensures long life in harsh, high-ambient engine rooms.",
    "cat": "Gap",
    "id": "T03M_235"
  },
  {
    ...
    "a": "Flameproof enclosure: it can withstand an internal explosion without igniting the outside atmosphere",
    "opts": ["Non-sparking", "Flameproof enclosure: it can withstand an internal explosion without igniting the outside atmosphere", "Increased safety", "Intrinsically safe"],
    "exp": "The heavy cast iron casing contains the blast, and the machined flanges cool the escaping gases below the ignition temperature of the surrounding explosive gas (e.g., in a pump room).",
    "cat": "Gap",
    "id": "T03M_236"
  },
  {
    ...
    "a": "A motor with two sets of rotor bars: an outer high-resistance cage and an inner low-resistance cage",
    "opts": ["A slip ring motor without brushes", "A motor with two stators", "A motor with physical safety guards", "A motor with two sets of rotor bars: an outer high-resistance cage and an inner low-resistance cage"],
    "exp": "This clever design uses the 'skin effect' to automatically provide high torque during starting (outer cage) and high efficiency during running (inner cage) without external starters.",
    "cat": "Gap",
    "id": "T03M_237"
  },
  {
    ...
    "a": "At start, rotor frequency is 50Hz. High frequency pushes current to the surface (skin effect) into the high-resistance outer bars",
    "opts": ["At start, rotor frequency is 50Hz. High frequency pushes current to the surface (skin effect) into the high-resistance outer bars", "Because the outer cage has less resistance", "Because the inner cage is disconnected by a switch", "Because of centrifugal force"],
    "exp": "The inner cage is deeply buried, giving it massive inductive reactance (XL = 2\u03c0fL) at 50Hz. Current takes the path of least impedance: the outer cage.",
    "cat": "Gap",
    "id": "T03M_238"
  },
  {
    ...
    "a": "For machinery requiring High Starting Torque without complex starters: Windlass, Mooring Winches, Bow Thrusters",
    "opts": ["For the main propulsion", "For machinery requiring High Starting Torque without complex starters: Windlass, Mooring Winches, Bow Thrusters", "For small ventilation fans", "For continuous running pumps"],
    "exp": "A windlass must start against massive chain tension. A double cage gives excellent DOL starting torque without the need for delicate slip rings.",
    "cat": "Gap",
    "id": "T03M_239"
  },
  {
    ...
    "a": "The 7th harmonic in the air-gap flux creates a forward-rotating field at 1/7th synchronous speed, forming a reluctance torque dip",
    "opts": ["The 7th harmonic in the air-gap flux creates a forward-rotating field at 1/7th synchronous speed, forming a reluctance torque dip", "Single phasing", "Low supply voltage", "Bearing failure"],
    "exp": "If the mechanical load torque is higher than this 'dip' in the motor's torque curve, the motor gets stuck at 1/7th speed (e.g., 200 RPM instead of 1450 RPM).",
    "cat": "Gap",
    "id": "T03M_240"
  },
  {
    ...
    "opts": ["A synchronous motor uses only single-phase power", "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)", "An induction motor has a commutator", "A synchronous motor cannot be reversed"],
  ...
  },
  {
    ...
    "opts": ["Because it lacks a stator", "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM", "Because it uses DC power only", "Because the slip rings add too much friction"],
  ...
  },
  {
    ...
    "opts": ["By turning it by hand", "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor", "By applying 1000V DC instantly", "By using a Ward-Leonard set"],
  ...
  },
  {
    ...
    "opts": ["It speeds up to infinity", "It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip", "It reverses direction", "It generates power into the grid"],
  ...
  },
  {
    ...
    "opts": ["A motor that generates its own DC field", "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links", "A VFD controlled pump", "An automatic steering system"],
  ...
  },
  {
    ...
    "a": "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)",
    "opts": ["An induction motor has a commutator", "A synchronous motor uses only single-phase power", "A synchronous motor cannot be reversed", "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)"],
    "exp": "By feeding DC into the rotor (via slip rings), a distinct North-South magnetic field is created on the rotor which physically locks onto the rotating stator field.",
    "cat": "Sync",
    "id": "T03M_246"
  },
  {
    ...
    "a": "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM",
    "opts": ["The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM", "Because the slip rings add too much friction", "Because it uses DC power only", "Because it lacks a stator"],
    "exp": "The RMF flashes past the stationary rotor poles 50 times a second, creating rapid alternating torque that averages to zero.",
    "cat": "Sync",
    "id": "T03M_247"
  },
  {
    ...
    "a": "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor",
    "opts": ["By using a Ward-Leonard set", "By applying 1000V DC instantly", "By turning it by hand", "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor"],
    "exp": "The damper winding (Amortisseur winding) allows it to accelerate to ~95% speed like a standard induction motor. Then, DC excitation is switched on to 'pull' it into synchronism.",
    "cat": "Sync",
    "id": "T03M_248"
  },
  {
    ...
    "a": "It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip",
    "opts": ["It generates power into the grid", "It speeds up to infinity", "It reverses direction", "It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip"],
    "exp": "Without the strong DC field lock, the load forces the rotor to slip. The damper winding acts as a squirrel cage, but it's not rated for continuous duty and will overheat quickly.",
    "cat": "Sync",
    "id": "T03M_249"
  },
  {
    ...
    "a": "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links",
    "opts": ["An automatic steering system", "A VFD controlled pump", "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links", "A motor that generates its own DC field"],
    "exp": "Used for rudder angle indicators and engine telegraphs. The 3-phase stators are wired together. When the transmitter rotor is turned, induced currents force the receiver rotor to perfectly mirror its angle.",
    "cat": "Sync",
    "id": "T03M_250"
  },
  {
    ...
    "a": "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)",
    "opts": ["A synchronous motor uses only single-phase power", "An induction motor has a commutator", "A synchronous motor cannot be reversed", "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)"],
    "exp": "By feeding DC into the rotor (via slip rings), a distinct North-South magnetic field is created on the rotor which physically locks onto the rotating stator field.",
    "cat": "Sync",
    "id": "T03M_251"
  },
  {
    ...
    "a": "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM",
    "opts": ["The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM", "Because it lacks a stator", "Because the slip rings add too much friction", "Because it uses DC power only"],
    "exp": "The RMF flashes past the stationary rotor poles 50 times a second, creating rapid alternating torque that averages to zero.",
    "cat": "Sync",
    "id": "T03M_252"
  },
  {
    ...
    "a": "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor",
    "opts": ["By using a Ward-Leonard set", "By applying 1000V DC instantly", "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor", "By turning it by hand"],
    "exp": "The damper winding (Amortisseur winding) allows it to accelerate to ~95% speed like a standard induction motor. Then, DC excitation is switched on to 'pull' it into synchronism.",
    "cat": "Sync",
    "id": "T03M_253"
  },
  {
    ...
    "a": "It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip",
    "opts": ["It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip", "It reverses direction", "It speeds up to infinity", "It generates power into the grid"],
    "exp": "Without the strong DC field lock, the load forces the rotor to slip. The damper winding acts as a squirrel cage, but it's not rated for continuous duty and will overheat quickly.",
    "cat": "Sync",
    "id": "T03M_254"
  },
  {
    ...
    "a": "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links",
    "opts": ["An automatic steering system", "A motor that generates its own DC field", "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links", "A VFD controlled pump"],
    "exp": "Used for rudder angle indicators and engine telegraphs. The 3-phase stators are wired together. When the transmitter rotor is turned, induced currents force the receiver rotor to perfectly mirror its angle.",
    "cat": "Sync",
    "id": "T03M_255"
  },
  {
    ...
    "a": "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)",
    "opts": ["An induction motor has a commutator", "A synchronous motor uses only single-phase power", "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)", "A synchronous motor cannot be reversed"],
    "exp": "By feeding DC into the rotor (via slip rings), a distinct North-South magnetic field is created on the rotor which physically locks onto the rotating stator field.",
    "cat": "Sync",
    "id": "T03M_256"
  },
  {
    ...
    "a": "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM",
    "opts": ["Because the slip rings add too much friction", "Because it lacks a stator", "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM", "Because it uses DC power only"],
    "exp": "The RMF flashes past the stationary rotor poles 50 times a second, creating rapid alternating torque that averages to zero.",
    "cat": "Sync",
    "id": "T03M_257"
  },
  {
    ...
    "a": "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor",
    "opts": ["By using a Ward-Leonard set", "By turning it by hand", "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor", "By applying 1000V DC instantly"],
    "exp": "The damper winding (Amortisseur winding) allows it to accelerate to ~95% speed like a standard induction motor. Then, DC excitation is switched on to 'pull' it into synchronism.",
    "cat": "Sync",
    "id": "T03M_258"
  },
  {
    ...
    "a": "It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip",
    "opts": ["It reverses direction", "It speeds up to infinity", "It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip", "It generates power into the grid"],
    "exp": "Without the strong DC field lock, the load forces the rotor to slip. The damper winding acts as a squirrel cage, but it's not rated for continuous duty and will overheat quickly.",
    "cat": "Sync",
    "id": "T03M_259"
  },
  {
    ...
    "a": "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links",
    "opts": ["A VFD controlled pump", "A motor that generates its own DC field", "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links", "An automatic steering system"],
    "exp": "Used for rudder angle indicators and engine telegraphs. The 3-phase stators are wired together. When the transmitter rotor is turned, induced currents force the receiver rotor to perfectly mirror its angle.",
    "cat": "Sync",
    "id": "T03M_260"
  },
  ...
  },
  {
    ...
    "a": "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM",
    "opts": ["Because it uses DC power only", "Because it lacks a stator", "Because the slip rings add too much friction", "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM"],
    "exp": "The RMF flashes past the stationary rotor poles 50 times a second, creating rapid alternating torque that averages to zero.",
    "cat": "Sync",
    "id": "T03M_262"
  },
  ...
  },
  {
    "q": "Recall: What is the primary difference between a Synchronous Motor and an Induction Motor?",
    "a": "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)",
    "opts": ["A synchronous motor uses only single-phase power", "A synchronous motor cannot be reversed", "An induction motor has a commutator", "A synchronous motor has a DC-excited rotor and runs exactly at Ns (zero slip)"],
    "exp": "By feeding DC into the rotor (via slip rings), a distinct North-South magnetic field is created on the rotor which physically locks onto the rotating stator field.",
    "cat": "Sync",
    "id": "T03M_266"
  },
  {
    "q": "Recall: Why is a pure Synchronous Motor NOT self-starting?",
    "a": "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM",
    "opts": ["Because it uses DC power only", "The massive rotor inertia prevents it from instantly locking onto a field spinning at 1500 RPM", "Because it lacks a stator", "Because the slip rings add too much friction"],
    "exp": "The RMF flashes past the stationary rotor poles 50 times a second, creating rapid alternating torque that averages to zero.",
    "cat": "Sync",
    "id": "T03M_267"
  },
  {
    "q": "Recall: How is a Synchronous Motor typically started?",
    "a": "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor",
    "opts": ["By using a Ward-Leonard set", "By turning it by hand", "By applying 1000V DC instantly", "Using a squirrel-cage 'damper winding' embedded in the rotor poles to start it as an induction motor"],
    "exp": "The damper winding (Amortisseur winding) allows it to accelerate to ~95% speed like a standard induction motor. Then, DC excitation is switched on to 'pull' it into synchronism.",
    "cat": "Sync",
    "id": "T03M_268"
  },
  {
    "q": "Recall: What happens if a Synchronous Motor loses its DC field excitation while running?",
    "a": "It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip",
    "opts": ["It generates power into the grid", "It reverses direction", "It speeds up to infinity", "It falls out of synchronism, runs as an induction motor on its damper windings, draws heavy current, and may trip"],
    "exp": "Without the strong DC field lock, the load forces the rotor to slip. The damper winding acts as a squirrel cage, but it's not rated for continuous duty and will overheat quickly.",
    "cat": "Sync",
    "id": "T03M_269"
  },
  {
    "q": "Recall: What is a 'Self-Synchronous' (Selsyn) motor system?",
    "a": "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links",
    "opts": ["A motor that generates its own DC field", "A transmitter-receiver pair used to transmit exact angular position remotely without mechanical links", "An automatic steering system", "A VFD controlled pump"],
    "exp": "Used for rudder angle indicators and engine telegraphs. The 3-phase stators are wired together. When the transmitter rotor is turned, induced currents force the receiver rotor to perfectly mirror its angle.",
    "cat": "Sync",
    "id": "T03M_270"
  },
  {
    ...
    "opts": ["The motor's cooling fan is blocked", "A high resistance contact in one of the starter contactors, causing an unbalanced phase voltage", "The motor's insulation resistance is 2 Megohms", "The supply frequency has dropped to 49Hz"],
  ...
  },
  {
    ...
    "opts": ["An OLR trip is instantaneous", "An OLR trip can be reset after a few minutes of cooling; a short-circuit trip usually throws an MCB or blows an HRC fuse", "A short circuit trip will reset automatically", "An OLR trip destroys the motor"],
  ...
  },
  {
    ...
    "opts": ["The motor was single-phasing", "The transition timer was set too short, so the motor had not reached sufficient speed, causing a massive DOL-like current surge in Delta", "The delta contactor is wired in reverse", "The star contactor failed to open"],
  ...
  },
  {
    ...
    "opts": ["The motor runs smoothly without interruption", "The residual back-EMF of the motor may clash out-of-phase with the supply voltage, creating a devastating transient current", "The motor reverses direction", "The supply voltage doubles"],
  ...
  },
  {
    ...
    "opts": ["Measure the resistance between U1 and earth", "Measure the resistance across U1-U2, V1-V2, and W1-W2; one phase will show infinite resistance", "Apply 440V and check the current", "Check the voltage at the terminal box"],
  ...
  },
  {
    ...
    "opts": ["The contactors will fuse together", "The copper windings are already extremely hot; a starting current surge of 6x FLC will likely melt the insulation and destroy the motor", "The motor will run backwards", "The power factor will drop to zero"],
  ...
  },
  {
    ...
    "opts": ["The Megger will not read accurately", "The 500V DC injected by the Megger will destroy the sensitive IGBTs and diodes in the VFD's inverter and rectifier sections", "The motor windings will overheat", "The VFD will absorb the DC and charge its capacitors"],
  ...
  },
  {
    ...
    "opts": ["Bearing failure", "Single phasing or severe voltage imbalance causing a negative sequence counter-rotating magnetic field", "Low frequency from the generator", "Over-greased bearings"],
  ...
  },
  {
    ...
    "opts": ["Energize it immediately to heat it up", "Do not energize it; place it in a dry, warm place or apply low DC voltage to bake out the absorbed moisture until IR exceeds 1 M\u03a9", "Replace the bearings", "Increase the supply voltage by 10%"],
  ...
  },
  {
    ...
    "opts": ["Check the main switchboard voltage", "Check if the cooling fan cowl is blocked by dirt, or if the external cooling fins are caked in grease/paint", "Check the slip ring brushes", "Check the VFD parameters"],
  ...
  },
  {
    ...
    "opts": ["It stops smoothly", "It undergoes 'Plugging' \u2014 brutal deceleration as it tries to reverse instantly, drawing massive current and potentially shearing the shaft", "It continues running normally", "It trips the earth fault relay"],
  ...
  },
  {
    ...
    "opts": ["To check for dust accumulation", "To ensure the rotor is perfectly centralized within the stator; an uneven gap causes Unbalanced Magnetic Pull (UMP) and destroys bearings", "To measure the thickness of the insulation", "To ensure the cooling air can flow freely"],
  ...
  },
  {
    ...
    "opts": ["It shuts off the motor if it spins too fast", "It disconnects the high-resistance starting winding once the motor reaches about 75% of synchronous speed", "It engages the mechanical brake", "It switches the motor to delta connection"],
  ...
  },
  {
    ...
    "opts": ["Under-greasing", "Over-greasing. The bearing cavity is fully packed, causing extreme fluid friction (churning) which overheats and separates the grease", "Single phasing", "Harmonic distortion"],
  ...
  },
  {
    ...
    "opts": ["It will run 20% slower", "The motor will run 20% faster, potentially overloading the driven pump/fan due to the cube law of power", "It will draw less current", "It will run perfectly normally"],
  ...
  },
  {
    ...
    "opts": ["It uses mechanical brakes", "It uses IGBTs in the rectifier to push regenerated AC power back into the ship's grid, instead of burning it in a resistor", "It applies a DC injection to stop the motor", "It increases the frequency to brake"],
  ...
  },
  {
    ...
    "opts": ["To save copper wire", "To eliminate specific spatial harmonics (like the 5th and 7th) from the magnetic flux, preventing crawling and reducing losses", "To increase starting torque", "To allow the motor to run on DC power"],
  ...
  },
  {
    ...
    "opts": ["It makes the rotor lighter", "It reduces magnetic humming (noise) and eliminates 'cogging' (magnetic locking of stator and rotor teeth)", "It increases the maximum RPM", "It eliminates slip"],
  ...
  },
  {
    ...
    "opts": ["The voltage is too low", "The phase sequence is reversed, causing the motor and impeller to run backwards", "The motor is single-phasing", "The slip is too high"],
  ...
  },
  {
    ...
    "opts": ["Dry it with compressed air and start it immediately", "Wash thoroughly with fresh water to remove salt, bake in an oven at 80-100\u00b0C for hours/days until IR >1M\u03a9, then re-varnish", "Wash with diesel and megger it", "Throw it away, it is unrecoverable"],
  ...
  },
  {
    ...
    "opts": ["It will run faster than synchronous speed", "It will draw a lagging reactive current from the AC supply, acting like an inductor", "It will draw a leading current", "It will switch to generating mode"],
  ...
  },
  {
    ...
    "opts": ["The motor will run at synchronous speed", "The motor will run at high slip (lower speed), and massive I\u00b2R heat will be generated in the resistors, wasting energy", "The starting torque will drop to zero", "The power factor will improve to unity"],
  ...
  },
  {
    ...
    "opts": ["To conduct static electricity", "To absorb slight misalignments and prevent transmission of torsional shocks and vibrations between the shafts", "To increase the torque output", "To act as a heat sink"],
  ...
  },
  {
    ...
    "opts": ["The measure of magnetic poles", "The ratio of the Megger reading at 10 minutes to the reading at 1 minute; it indicates the dryness and cleanliness of the insulation", "The phase angle between voltage and current", "The ratio of starting current to running current"],
  ...
  },
  {
    ...
    "opts": ["It will stop the motor", "It will induce a lethally high voltage across the open secondary terminals and destroy the CT insulation", "It will cause the motor to overspeed", "It will blow the main fuses"],
  ...
  },
  {
    ...
    "opts": ["By adding physical resistors", "It delays the firing pulse to the thyristor gate, only allowing a small portion of each AC half-wave to pass to the motor", "By lowering the frequency", "By dropping a phase"],
  ...
  },
  {
    ...
    "opts": ["It requires 15% more maintenance", "The motor can operate continuously at 15% over its rated horsepower without catastrophic failure", "It will run 15% faster than nominal speed", "It draws 15% less current"],
  ...
  },
  {
    ...
    "opts": ["The cable will act as an antenna and transmit radio signals", "Reflected waves (voltage spikes) can exceed the motor's insulation rating, causing the winding insulation to break down and short", "The motor will run backwards", "The VFD will lose its programming"],
  ...
  },
  {
    ...
    "opts": ["Because Class B is cheaper", "To provide a massive thermal safety margin, greatly increasing the operational lifespan and reliability of the motor in hot engine rooms", "To make it waterproof", "Because Class F requires DC power"],
  ...
  },
  {
    ...
    "opts": ["To balance the rotor dynamically", "To short-circuit all the copper/aluminium rotor bars together, allowing the induced currents to circulate in closed loops", "To attach the cooling fan", "To prevent axial movement of the shaft"],
  ...
  },
  {
    ...
    "opts": ["It continues running but draws heavily increased current on the remaining two phases", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
  ...
  },
  {
    ...
    "opts": ["A rotating magnetic field cannot be established with only one phase, producing zero starting torque", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_302"
  },
  {
    ...
    "opts": ["To allow external resistance to be added to the rotor circuit for starting torque control", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_303"
  },
  {
    ...
    "opts": ["Typically 5 to 7 times the full load current", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_304"
  },
  {
    ...
    "opts": ["It connects the stator in Star, reducing the phase voltage by \u221a3, which reduces starting current by 1/3", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_305"
  },
  {
    ...
    "opts": ["The difference between the synchronous speed of the magnetic field and the actual rotor speed", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_306"
  },
  {
    ...
    "opts": ["If it ran at synchronous speed, there would be no relative motion, no induced rotor current, and zero torque", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_307"
  },
  {
    ...
    "opts": ["Synchronous motors run at exact synchronous speed; induction motors have slip", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_308"
  },
  {
    ...
    "opts": ["Poor ventilation, blocked cooling fins, or high ambient temperature", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_309"
  },
  {
    ...
    "opts": ["A dead short circuit to earth or between phases", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_310"
  },
  {
    ...
    "opts": ["Measure IR at 1 minute and 10 minutes; PI = IR(10min) / IR(1min)", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_311"
  },
  {
    ...
    "opts": ["VFD can control speed continuously; Soft Starter only controls voltage during run-up", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_312"
  },
  {
    ...
    "opts": ["To prevent moisture from condensing on the windings when the motor is offline", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_313"
  },
  {
    ...
    "opts": ["The motor will overheat and the thermal overload relay will eventually trip", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_314"
  },
  {
    ...
    "opts": ["It uses a bimetallic strip that bends under sustained overcurrent to trip the contactor", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_315"
  },
  {
    ...
    "opts": ["Insulation rated to withstand a maximum operating temperature of 155\u00b0C", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_316"
  },
  {
    ...
    "opts": ["Usually 105\u00b0C temperature rise above a 40\u00b0C ambient", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_317"
  },
  {
    ...
    "opts": ["By monitoring vibration levels and listening for abnormal acoustic noise", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_318"
  },
  {
    ...
    "opts": ["The loss of one of the three phases supplying the motor", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_319"
  },
  {
    ...
    "opts": ["Phase failure relay or a sensitive thermal overload relay with phase unbalance protection", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_320"
  },
  {
    ...
    "opts": ["Speed is directly proportional to frequency (N = 120f / p)", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_321"
  },
  {
    ...
    "opts": ["It will run 17% slower and may overheat due to reduced cooling fan speed", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_322"
  },
  {
    ...
    "opts": ["Moisture creates a conductive path; testing while wet could cause a short circuit or damage", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_323"
  },
  {
    ...
    "opts": ["A rotor made of solid conducting bars short-circuited by end rings, resembling a cage", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_324"
  },
  {
    ...
    "opts": ["By swapping any two of the three supply phases", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_325"
  },
  {
    ...
    "opts": ["To ensure any earth fault blows the fuse or trips the breaker, protecting personnel from shock", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_326"
  },
  {
    ...
    "opts": ["The rotor teeth align with stator teeth and the motor refuses to start", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_327"
  },
  {
    ...
    "opts": ["The motor runs stably at a fraction (e.g., 1/7th) of its synchronous speed due to harmonics", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_328"
  },
  {
    ...
    "opts": ["CO2 (Carbon Dioxide) or Dry Chemical Powder", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_329"
  },
  {
    ...
    "opts": ["The percentage of overload the motor can handle continuously without damage (e.g., 1.15 = 15%)", "Incorrect answer A", "Incorrect answer B", "Incorrect answer C"],
    "exp": "Surveyor specific motor question.",
    "cat": "Surveyor Questions",
    "id": "T03M_330"
  },
  {
    ...
    "opts": ["DC excitation in the rotor interacts with the stator's alternating magnetic field to produce torque", "Permanent magnets on the stator repel the electromagnetic field generated by the rotor", "The commutator physically reverses the current direction to maintain a continuous rotational torque", "Three-phase AC creates a Rotating Magnetic Field (RMF) that induces EMF and current in the short-circuited rotor, producing rotational force (F=BIL)"],
  ...
  },
  {
    ...
    "opts": ["Slip is the difference between synchronous speed and actual rotor speed; without slip, there is no relative motion, no induced EMF, and no torque", "Slip is the intentional delay built into the star-delta starter to prevent high inrush currents", "Slip is the mechanical friction loss in the bearings; it must be minimised to prevent the motor from stalling", "Slip is the phase angle difference between voltage and current, which determines the power factor of the motor"],
  ...
  },
  {
    ...
    "a": "1000 RPM",
    "opts": ["3000 RPM", "1500 RPM", "1000 RPM", "750 RPM"],
  ...
  },
  {
    ...
    "opts": ["The motor's cooling fan requires extra torque to overcome initial static inertia", "The stator winding insulation requires massive current to magnetize the iron core from a cold state", "At standstill (slip=1), the RMF cuts the short-circuited, low-impedance rotor at full frequency, inducing maximum EMF and massive current", "The power factor is extremely high at startup, forcing the generator to push maximum current"],
  ...
  },
  {
    ...
    "opts": ["Current is reduced by 1/\u221a3 (approx 58%), torque remains the same", "Current is reduced to 1/2, torque is reduced to 1/4", "Both starting current and starting torque are reduced to exactly 1/3 of their DOL values", "Current is reduced to 1/3, but torque increases by a factor of \u221a3"],
  ...
  },
  {
    ...
    "opts": ["It ensures the motor completely stops before reversing direction", "It allows the contactor coils to demagnetize so they don't weld together", "It gives the thermal overload relay time to cool down before full load is applied", "It allows the motor's back-EMF to decay, preventing a massive, out-of-phase transient current surge that could cause severe mechanical shock"],
  ...
  },
  {
    ...
    "opts": ["Auto-Transformer Starter", "Soft Starter", "Variable Frequency Drive (VFD)", "Star-Delta Starter"],
  ...
  },
  {
    ...
    "opts": ["There is no difference; they both provide identical running speed control, but VFDs are used for larger motors", "A Soft Starter provides continuous speed control via thyristors, while a VFD only provides discrete speed steps", "A Soft Starter controls frequency to ramp up speed, while a VFD only controls voltage", "A Soft Starter only controls voltage during ramp up/down and provides NO speed control during running; a VFD controls both voltage and frequency for full speed control"],
  ...
  },
  {
    ...
    "opts": ["Adding external resistance to the rotor circuit", "Using a Ward-Leonard generator system", "Varying the supply voltage using a thyristor soft starter", "Varying the supply frequency using a Variable Frequency Drive (VFD)"],
  ...
  },
  {
    ...
    "opts": ["It alters the number of active poles in the stator winding, allowing smooth transitions between high and low speeds", "It uses back-to-back thyristors to chop the AC waveform, smoothly reducing the RMS voltage to an induction motor", "An AC motor drives a DC generator; varying the generator's field current changes its DC output voltage, which proportionally controls the speed of the final DC drive motor", "It uses a mechanical variable-pitch pulley system driven by a constant-speed synchronous motor"],
  ...
  },
  {
    ...
    "opts": ["The height of the shaft centreline from the motor base/feet in millimeters", "The physical weight of the motor in kilograms", "The diameter of the cooling fan casing in millimeters", "The maximum horsepower the motor can safely output continuously"],
  ...
  },
  {
    ...
    "opts": ["Rim reading shows angular misalignment; Face reading shows axial thrust play", "Rim reading shows bearing wear; Face reading shows shaft bowing", "Rim reading shows parallel offset misalignment; Face reading shows angular misalignment", "Rim reading shows thermal expansion; Face reading shows soft foot"],
  ...
  },
  {
    ...
    "opts": ["It is the physical kickback of the armature during starting, causing excessive wear on the drive coupling", "It is the chemical breakdown of the commutator copper due to high DC current, causing a green patina to form", "It is the distortion of the main magnetic field by the armature's own magnetic field, causing the neutral axis to shift and resulting in severe brush sparking", "It is the sudden reversal of rotation when the field current drops below a critical threshold"],
  ...
  },
  {
    ...
    "opts": ["The motor is momentarily switched into reverse (plugging), and DC is used to hold the contactors closed", "The VFD dumps the kinetic energy into a massive DC resistor bank until the motor halts", "AC is disconnected and DC is injected into the stator, creating a static magnetic field. The spinning rotor cuts this static field, inducing currents that create an opposing braking force", "DC is applied directly to the squirrel cage rotor via slip rings, turning it into an electromagnet that locks onto the stator"],
  ...
  },
  {
    ...
    "opts": ["It instantly stops and refuses to turn, acting as a dynamic brake", "It reverses direction immediately due to the loss of the rotating magnetic field", "It continues to run on two phases, but draws approx 200-250% current in the remaining phases, leading to rapid, severe overheating and insulation failure", "It safely reduces its torque and speed by 33%, allowing operations to continue until maintenance can be scheduled"],
  ...
  },
  {
    ...
    "opts": ["Thermistors automatically reset the motor controller if a single-phasing event occurs", "Thermistors measure actual physical winding temperature, protecting against overheating caused by blocked ventilation or high ambient heat, which an OLR cannot detect", "Thermistors limit the starting current inrush directly by increasing their resistance", "Thermistors act faster to clear dead short circuits than HRC fuses"],
  ...
  },
  {
    ...
    "opts": ["The motor automatically acts as an induction generator to support the busbar voltage", "Motor torque drops drastically to ~40% (since torque \u221d V\u00b2), potentially causing the motor to stall and draw massive current to compensate", "Motor torque remains identical, but the speed drops proportionally by 36%", "The motor will draw significantly less current to protect its windings from the low voltage"],
  ...
  },
  {
    ...
    "opts": ["Used for remote position indication (e.g., Rudder Angle Indicators, Engine Telegraphs) because the receiver rotor electrically locks to the exact angular position of the transmitter rotor without mechanical linkage", "Used as dynamic braking resistors for large deck cranes", "Used exclusively to drive the emergency fire pumps because they can self-start without a starter panel", "Used as the main propulsion motors on diesel-electric vessels because they offer perfect 100% efficiency without slip"],
  ...
  },
  {
    ...
    "opts": ["It prevents the motor from generating harmful 5th and 7th harmonics into the ship's busbar", "It steps down the 440V supply to a safe DC voltage for the main field", "It forces the motor to immediately trip if the power factor becomes too leading", "It acts like a squirrel cage to allow the motor to self-start asynchronously, and dampens oscillations (hunting) during load changes"],
  ...
  },
  {
    ...
    "opts": ["Spherical roller bearing (6), Heavy series (20), 50mm bore, with Two Retaining Springs (2RS)", "Deep groove ball bearing (6), Light series (2), 25mm bore diameter (05x5), with Double Rubber Seals (2RS)", "Angular contact bearing (62), 5 inch diameter, with Two Radial Shields (2RS)", "Cylindrical roller (6), 205mm outer diameter, Rating Standard 2"],
  ...
  },
  {
    ...
    "opts": ["G = 0.05 x D x B, where D is the shaft diameter (mm) and B is the bearing width (mm)", "G = 0.005 x D x B, where D is the bearing outer diameter (mm) and B is the bearing width (mm)", "Pump continuously until clean grease exits the relief plug, regardless of quantity", "It is always a fixed 50 grams for motors under 10 kW, and 100 grams for larger motors"],
  ...
  },
  {
    ...
    "a": "Less than 0.05 mm",
    "opts": ["Zero tolerance (0.00 mm) is strictly required", "Less than 0.50 mm", "Less than 1.00 mm", "Less than 0.05 mm"],
  ...
  },
  {
    ...
    "opts": ["The motor produces a maximum torque of 132 Newton-meters", "The motor has a maximum outer casing diameter of 132 mm", "The distance between the front and rear mounting bolts is 132 mm", "The shaft centreline is exactly 132 mm above the mounting base/feet"],
  ...
  },
  {
    ...
    "opts": ["Because it requires a continuous inductive magnetizing current from the supply to establish and maintain the Rotating Magnetic Field (RMF) across the air gap", "Because the rotor resistance is naturally higher than the stator resistance", "Because the mechanical friction of the bearings creates a delay between voltage and current", "Because the squirrel cage bars act as tiny capacitors, causing the current to lag the voltage"],
  ...
  },
  {
    ...
    "opts": ["To allow the motor to act as a synchronous condenser during low load conditions", "To minimize the magnetic reluctance of the circuit, which reduces the required magnetizing current and significantly improves the motor's power factor", "To prevent cooling air from bypassing the rotor cooling fins", "To increase the resistance of the rotor, thereby increasing starting torque"],
  ...
  },
  {
    ...
    "opts": ["It automatically physically changes the motor winding connections from Star to Delta", "It adds physical resistance into the rotor circuit via slip rings to restrict current flow", "It uses internal transformer tappings (typically 65% or 80%) to supply a reduced voltage to the motor during initial acceleration, before bypassing to full line voltage", "It electronically chops the AC waveform using thyristors to limit RMS voltage"],
  ...
  },
  {
    ...
    "opts": ["It remains at 100% of the DOL starting torque", "It is reduced to 64% of the DOL starting torque (because torque is proportional to voltage squared)", "It is reduced to 80% of the DOL starting torque", "It is reduced to 33% of the DOL starting torque, identical to a Star-Delta starter"],
  ...
  },
  {
    ...
    "opts": ["The 2nd and 3rd harmonics", "The 10th and 12th harmonics", "The 50th and 60th harmonics", "The 5th and 7th harmonics"],
  ...
  },
  {
    ...
    "opts": ["The VFD increases the power factor to 1.0, which legally exempts the ship from the CII rating system", "The VFD automatically converts the pump to run on zero-emission shore power", "By utilizing the Affinity Laws, a 20% reduction in motor speed yields a massive ~50% reduction in power drawn, significantly cutting generator HFO consumption and CO2 emissions", "The VFD actively scrubs exhaust gases in the engine room by reversing the pump flow"],
  ...
  },
  {
    ...
    "opts": ["It dictates that the induced rotor currents create a magnetic field opposing the relative motion between the rotor and the stator's rotating magnetic field, forcing the rotor to turn", "It ensures that the back-EMF of the motor is exactly equal and opposite to the applied supply voltage at all times", "It describes how the stator automatically switches from Star to Delta to oppose the incoming transient currents", "It explains why the motor draws high starting current when the slip is at exactly zero percent"],
  ...
  },
  {
    ...
    "opts": ["IP22 for the deck; IP44 for the bilge", "IP44 (splash proof) for the deck; IP56 (heavy seas) for the bilge", "IP68 for both locations to ensure absolute SOLAS compliance", "IP55 (dust tight and protected against water jets) for the deck; IP68 (protected against continuous submersion) for the bilge"],
  ...
  },
  {
    ...
    "opts": ["Power (kW), Weight (kg), Paint Color, Bearing Manufacturer, and Governor Droop setting", "Power (kW), Voltage, Frequency, IEC Frame Size, Insulation Class, IP Rating, and Mounting Arrangement (e.g., B3 Foot mount)", "Voltage, Slip percentage, Armature Resistance, and Starting Torque limit", "Synchronous Speed, Number of Rotor Bars, VFD harmonic limits, and Magnetic Reluctance"],
  ...
  },
  {
    ...
    "opts": ["It occurs when the mechanical load exceeds the maximum synchronizing torque, causing the rotor to break magnetic lock with the stator field and the motor to stall", "It occurs when the Variable Frequency Drive supplies too many harmonics, causing the bearings to slip in their housings", "It occurs when the DC excitation is too high, forcing the rotor to spin faster than the synchronous speed and act as a generator", "It is a normal starting process where the damper windings slowly align the rotor poles to the stator poles"],
  ...
  },
  {
    ...
    "opts": ["Over-exciting the field increases the motor's physical RPM, causing it to draw less active power from the bus", "Under-exciting the field causes a lagging power factor (absorbing reactive power), while over-exciting the field causes a leading power factor (supplying reactive power like a capacitor)", "Under-exciting the field causes a leading power factor (acting as a capacitor), while over-exciting the field causes a lagging power factor", "Excitation strictly controls mechanical torque; it has no effect on the electrical power factor"],
  ...
  },
  {
    ...
    "opts": ["Series motors maintain a constant speed at all times; Shunt motors are used purely for dynamic braking", "Series motors provide massive starting torque but can dangerously overspeed at no load; Shunt motors provide steady, constant speed regardless of load variations", "Series motors are virtually maintenance-free; Shunt motors require constant brush replacement due to armature reaction", "Series motors can operate on both AC and DC power; Shunt motors run strictly on batteries"],
  ...
  },
  {
    ...
    "opts": ["By mechanically adjusting the slip rings on the generator shaft to alter the output frequency", "By adding physical resistance banks directly into the hoist motor's armature circuit to burn off excess speed", "By using an AC soft starter to limit the voltage going to the primary induction motor", "By varying the small DC field excitation current of the intermediate generator, which proportionally changes the high-power armature voltage sent to the hoist motor"],
  ...
  },
  {
    ...
    "opts": ["It operates at two distinct speeds by mechanically shifting the rotor between two separate stator housings", "It provides redundant operation; if one cage fails, the second cage automatically takes over to prevent a blackout", "It provides very high starting torque with reduced inrush current by utilizing a high-resistance outer cage for starting and a low-resistance inner cage for running; used for windlasses, mooring winches, and bow thrusters", "It acts as both a motor and a generator simultaneously, making it ideal for regenerative crane hoists"],
  ...
  },
  {
    ...
    "a": "Crawling",
    "opts": ["Slip-locking", "Hunting", "Single-Phasing", "Crawling"],
  ...
  },
  {
    ...
    "opts": ["By 'skewing' the rotor slots so they are slightly angled rather than perfectly parallel to the shaft", "By installing a mechanical dashpot on the rotor shaft to dampen harmonic vibrations", "By forcing the VFD to skip the 7th harmonic frequency block", "By installing double-shielded bearings to prevent magnetic flux leakage"],
  ...
  },
  {
    ...
    "opts": ["They are stray currents on the surface of the slip rings; minimized by using softer carbon brushes", "They are transient currents caused by Star-Delta switching; minimized by the 50ms dead time timer", "They are useless circulating currents induced in the iron core by changing magnetic flux; they are minimized by building the core out of thin, insulated, laminated silicon steel sheets", "They are reactive currents bouncing between the motor and generator; minimized by installing capacitor banks"],
  ...
  },
  {
    ...
    "opts": ["Perform a dead-short test across the main terminals to verify the HRC fuses will blow", "Measure the capacitance of the windings to ensure the VFD harmonic filters will function correctly", "Measure the DC resistance of all three phases using a low-resistance bridge meter; they must be equal within 2%", "Apply 110V DC to the stator to verify the magnetic polarity is exactly North-South-North"],
  ...
  },
  {
    ...
    "opts": ["A thermal bimetallic fuse, which resets automatically after cooling down", "A rewirable copper wire fuse, rated at 5 times the FLC to prevent blowing during start", "HRC (High Rupturing Capacity) fuse, rated at 1.5 to 2.5 times the motor's Full Load Current (FLC)", "A fast-acting glass cartridge fuse, rated exactly at 100% of the motor's FLC"],
  ...
  },
  {
    ...
    "opts": ["The motor's internal thermistors will instantly act as the third phase to balance the load", "The motor will start in the reverse direction", "The motor will start normally but only run at 33% of its rated speed", "The motor will completely fail to start, but will sit there humming loudly and drawing massive locked-rotor current until it trips or burns out"],
  ...
  },
  {
    ...
    "opts": ["It is the residual voltage left in the capacitors after the motor is shut down", "It is the dangerous high-voltage spike created when the motor contactor opens, which destroys sensitive VFD electronics", "It is the voltage that bleeds through the air gap to magnetize the motor casing", "It is the voltage generated internally by the spinning motor that directly opposes the incoming supply voltage, limiting the current drawn by the motor as it speeds up"],
  ...
  },
  {
    ...
    "opts": ["To provide a massive thermal safety margin, dramatically increasing the operational lifespan and reliability of the motor in the harsh marine environment", "Because the copper windings lose their magnetic properties completely at 140\u00b0C", "Because running a Class F motor at 155\u00b0C violates MARPOL environmental heat emission standards", "Because the PT100 sensors melt if exposed to temperatures above 135\u00b0C"],
  ...
  },
  {
    ...
    "opts": ["A single-element OLR cannot monitor voltage drops; it only monitors frequency", "A single-element OLR cannot be reset manually; it requires a complete replacement every time it trips", "A single-element OLR is physically too small to handle the 440V arc flash", "A single-element OLR cannot reliably detect a single-phasing condition; a modern '3-element' phase-sensitive OLR is required to protect against phase loss"],
  ...
  },
  {
    ...
    "opts": ["Because heavy loads cause the Star contactor to weld shut due to excessive back-EMF", "Because the motor starts in Star, producing only 1/3 of its normal starting torque, which may be insufficient to accelerate a heavy load", "Because the transition from Star to Delta requires the load to be completely stationary", "Because it generates severe harmonic distortion that damages the load's mechanical coupling"],
  ...
  },
  {
    ...
    "opts": ["It uses a single, solid-state electronic drive to control multiple AC induction motors simultaneously", "It completely eliminates the need for carbon brushes and commutators, making it ideal for hazardous areas", "It provides excellent, smooth, and precise speed control over a wide range (including reversing), and inherently allows for efficient regenerative braking", "It operates at a 1.0 power factor and draws exactly zero starting current"],
