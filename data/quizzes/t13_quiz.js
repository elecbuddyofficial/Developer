window.loadQuizzes("T13_BridgeEquip1", [
  {
    ...
    "opts": ["X-band: 3 GHz (10 cm), S-band: 9 GHz (3 cm)", "X-band: 9 GHz (3 cm wavelength), S-band: 3 GHz (10 cm wavelength)", "X-band: 518 kHz, S-band: 406 MHz", "X-band: 406 MHz, S-band: 121.5 MHz"],
  ...
  },
  {
    ...
    "opts": ["Protects sensitive receiver from transmit pulses (that is the T/R cell)", "Converts echo signals to intermediate frequencies", "Rotates scanner antenna using synchronous AC motor", "High-power vacuum tube oscillator - generates microwave energy pulses"],
  ...
  },
  {
    ...
    "opts": ["Amplifies returning echo signals", "Generates high-voltage DC for the magnetron", "Provides heading data from gyrocompass for stabilisation", "Electronic switch - disconnects receiver during high-power transmission to prevent damage"],
  ...
  },
  {
    ...
    "opts": ["Scanner rotates too fast to catch close echoes", "S-band wavelength too long to resolve close targets", "Sea clutter filter deletes targets near ship centre", "Magnetron is still transmitting when the echo from a close target returns - receiver is blocked by T/R cell"],
  ...
  },
  {
    ...
    "opts": ["One X-band RADAR with ARPA + one backup magnetic compass", "Two independent RADARs - second must be S-band or dual-band", "Two X-band RADARs sharing a single display", "Single S-band RADAR with AIS overlay"],
  ...
  },
  {
    ...
    "opts": ["Channel 16 (156.800 MHz)", "Channel 70 (156.525 MHz)", "Channel 06 (156.300 MHz)", "Channel 13 (156.650 MHz)"],
  ...
  },
  {
    ...
    "opts": ["All ships must now carry two EPIRBs", "EPIRBs must transmit on 9 GHz to work with SART radar", "EPIRBs no longer require HRUs if mounted on bridge", "VHF-EPIRBs no longer accepted in any sea area - all ships must carry 406 MHz satellite EPIRB"],
  ...
  },
  {
    ...
    "opts": ["518 kHz and 490 kHz", "406 MHz (global satellite alerting) and 121.5 MHz (local aircraft homing)", "9 GHz and 156.525 MHz", "161.975 MHz and 3 GHz"],
  ...
  },
  {
    ...
    "a": "1 to 4 metres",
    "opts": ["5 to 10 metres", "1 to 4 metres", "10 to 15 metres", "Immediately on water contact"],
  ...
  },
  {
    ...
    "opts": ["48 hours continuous transmission", "96 hours standby + 8 hours transmitting", "6 hours without ship power", "12 hours at minimum signal strength"],
  ...
  },
  {
    ...
    "opts": ["9 GHz (X-band RADAR frequency)", "3 GHz (S-band RADAR)", "406 MHz (EPIRB frequency)", "156.525 MHz (VHF Ch 70)"],
  ...
  },
  {
    ...
    "opts": ["Flashing red cross on ECDIS chart", "Solid continuous circle on radar screen", "AIS target with MMSI and coordinates", "12 dots in a radial line extending outward from the SART's position"],
  ...
  },
  {
    ...
    "opts": ["15 nm ship, 30 nm aircraft", "~5 nm (ship radar at ~15m height) and ~10 nm (aircraft at ~3000 ft)", "1 nm ship, 5 nm aircraft", "Global range via satellite for both"],
  ...
  },
  {
    ...
    "opts": ["48 hours continuous transmission", "96 hours standby + 8 hours continuous transmission when activated", "6 hours continuous transmission, no standby", "12 hours standby + 48 hours transmission"],
  ...
  },
  {
    ...
    "opts": ["2182 kHz and 2187.5 kHz", "156.525 MHz and 161.975 MHz", "518 kHz (international English) and 490 kHz (national language)", "406 MHz and 121.5 MHz"],
  ...
  },
  {
    ...
    "opts": ["6 hours (international voyage without UPS)", "1 hour", "18 hours", "48 hours"],
  ...
  },
  {
    ...
    "opts": ["VHF with DSC on Channel 70", "NAVTEX receiver 518 kHz", "406 MHz float-free EPIRB", "RMSS terminal (e.g. Inmarsat-C or Iridium satellite comms)"],
  ...
  },
  {
    ...
    "opts": ["Now strictly mandatory for Sea Area A1", "Replaced Inmarsat-C for all distress communications", "Must now operate on 518 kHz NAVTEX frequency", "No longer mandatory in any sea area - removed from GMDSS carriage requirements"],
  ...
  },
  {
    ...
    "opts": ["Short circuit through 250 ohm resistor and measure current drop", "Measure specific gravity of sealed battery with hydrometer while charger runs", "Activate EPIRB and SART simultaneously to verify battery holds 24V", "Isolate charger - connect full GMDSS load - verify voltage stays above minimum for 6-hour (or 1-hour with UPS) duration"],
  ...
  },
  {
    ...
    "opts": ["Satellite-based global distress alerting system - unlimited range", "Two-way VHF communication device - 30 nm range", "Underwater acoustic transponder detecting submerged hazards - 5 nm", "Automated direct-printing receiver for Maritime Safety Information (MSI) - range ~200-400 nm from coast station"],
  ...
  },
  {
    ...
    "opts": [">100 GT: 1 RADAR; >1000 GT: ARPA; >5000 GT: dual band", "Any ship with AIS is exempt from ARPA requirement", "All vessels require 2 RADARs regardless of tonnage", ">300 GT: 1 RADAR + ARPA; >500 GT: 2 independent RADARs; >10,000 GT: 2 RADARs, second must be S-band"],
  ...
  },
  {
    ...
    "a": "518 kHz",
    "opts": ["2187.5 kHz", "490 kHz", "4209.5 kHz", "518 kHz"],
  ...
  },
  {
    ...
    "a": "490 kHz",
    "opts": ["490 kHz", "156.8 MHz", "518 kHz", "4209.5 kHz"],
  ...
  },
  {
    ...
    "a": "4209.5 kHz",
    "opts": ["4209.5 kHz", "8414.5 kHz", "2182 kHz", "490 kHz"],
  ...
  },
  {
    ...
    "opts": ["The Urgency level of the message", "The Subject of the message", "The Transmitter Coverage Area (The specific coast station broadcasting the message)", "The Message serial number"],
  ...
  },
  {
    ...
    "opts": ["The Message serial number", "The Subject Indicator (The type of message, such as Weather or Navigational Warning)", "The Transmitter ID", "The Language of the broadcast"],
  ...
  },
  {
    ...
    "opts": ["The Error correction code", "The Time of transmission", "The Message Serial Number (00 to 99)", "The Transmitter coordinates"],
  ...
  },
  {
    ...
    "opts": ["It means the memory is full and must be cleared", "It is a vital Distress or Search and Rescue (SAR) message, and the receiver is forced to print/display it regardless of any user rejection settings", "The message contains zero errors", "It is a test message to verify receiver operation"],
  ...
  },
  {
    ...
    "a": "A, B, D, and L",
    "opts": ["A, B, D, and L", "X, Y, and Z", "A, C, E, and Z", "C, E, F, and G"],
  ...
  },
  {
    ...
    "opts": ["Navigational Warnings", "Automatic Distress", "Anchorages", "Area Forecasts"],
  ...
  },
  {
    ...
    "opts": ["Meteorological Warnings", "Berthing information", "Buoy status", "Broadcast schedule"],
  ...
  },
  {
    ...
    "opts": ["Search and Rescue (SAR) Information and Pirate Attacks", "Departure schedules", "Data transmission", "Depth soundings"],
  ...
  },
  {
    ...
    "opts": ["200 to 400 nautical miles offshore", "1000 to 1500 nautical miles", "10 to 20 nautical miles", "Global coverage"],
  ...
  },
  {
    ...
    "opts": ["By altering their antenna polarization", "By Time-Sharing; each station is allocated a specific 10-minute transmission slot every 4 hours", "By broadcasting at slightly different voltage levels", "By using different digital encryption keys"],
  ...
  },
  {
    ...
    "opts": ["An active whip antenna or an active dipole antenna with a built-in pre-amplifier", "A submerged acoustic transducer", "A massive parabolic radar dish", "A directional Yagi antenna"],
  ...
  },
  {
    ...
    "a": "An asterisk (*)",
    "opts": ["A question mark (?)", "The letter X", "An asterisk (*)", "A blank space"],
  ...
  },
  {
    ...
    "opts": ["It sounds the ship's general distress alarm", "It rejects the message and does not store its serial number, ensuring the machine will attempt to receive and print it again during the next broadcast", "It prints a blank piece of paper", "It switches to 490 kHz automatically"],
  ...
  },
  {
    ...
    "opts": ["They must have internal non-volatile memory capable of storing at least 200 messages, retaining them for at least 72 hours", "They must store up to 10,000 messages permanently", "They must delete messages after 24 hours to save memory", "They must upload all messages to the cloud immediately"],
  ...
  },
  {
    ...
    "opts": ["It is powered by the ship's emergency fire pump generator", "It has an internal hand-crank dynamo", "It shuts down safely and reboots when AC returns", "It is connected to the 24V DC GMDSS Reserve Source of Energy (Radio Battery Bank)"],
  ...
  },
  {
    ...
    "opts": ["The active antenna on the monkey island has a severed coax cable, a corroded connection, or has lost its 12V/24V DC supply voltage from the main unit", "The main switchboard has a ground fault", "The B1 station was set to 'Z'", "The paper roll is installed backwards"],
  ...
  },
  {
    ...
    "opts": ["By using a satellite to double-check the spelling", "By transmitting in both English and French simultaneously", "Each character is transmitted twice, with the second transmission slightly delayed; the receiver compares them to ensure accuracy", "By requiring the ship to transmit an acknowledgment back"],
  ...
  },
  {
    ...
    "opts": ["Activate the built-in self-test function which checks the ROM, RAM, display, and printer/alarm buzzer, logging the result", "Unplug the antenna to see if the error light turns on", "Change the operating frequency to 156.8 MHz", "Transmit a test message to the Coast Guard"],
  ...
  },
  {
    ...
    "opts": ["Change the frequency to 490 kHz", "Turn off the NAVTEX and use INMARSAT exclusively", "Update the NAVTEX receiver to select the specific B1 station letters corresponding to the coast stations in NAVAREA III", "Nothing; 'A' is a universal global setting"],
  ...
  },
  {
    ...
    "opts": ["To prevent vibration from shattering the fiberglass", "To stop the antenna from rusting", "To prevent lightning strikes", "To prevent the metal hull from grounding out the antenna element, which would short-circuit the received RF signal to earth before it reaches the amplifier"],
  ...
  },
  {
    ...
    "opts": ["It stops receiving new messages and sounds an alarm", "It uploads the memory to the VDR", "It overwrites the oldest messages first (First-In, First-Out), EXCEPT for uncleared SAR/Distress messages which are protected", "It automatically prints all 200 messages and clears the memory"],
  ...
  },
  {
    ...
    "opts": ["Navigation and Weather Transmission", "Nautical Vessel Tracking Exchange", "Navigational Telex", "Naval Text Service"],
  ...
  },
  {
    ...
    "opts": ["Only in Sea Areas A3 and A4", "It is mandatory in ALL Sea Areas (A1, A2, A3, and A4) provided NAVTEX service is provided in those areas", "It is optional if an INMARSAT-C is carried", "Only in Sea Area A1"],
  ...
  },
  {
    ...
    "opts": ["No, a VHF antenna is tuned for 156 MHz and has no internal amplifier; it will be completely deaf to the 518 kHz MF signal", "No, because the VHF antenna will transmit and destroy the NAVTEX", "Yes, any wire can act as an antenna", "Yes, provided it is mounted higher than the radar"],
  ...
  },
  {
    ...
    "opts": ["To wake the crew for their watch", "To signal that the ship has crossed into a new NAVAREA", "To indicate that the paper roll is empty", "To instantly alert the navigating officer that a vital Search and Rescue (SAR) or Gale Warning (Subject D or B) message has just been received"],
  ...
  },
  {
    ...
    "opts": ["9 GHz and 3 GHz", "156.8 MHz and 518 kHz", "406 MHz (for satellite detection) and 121.5 MHz (for aircraft/vessel homing)", "2187.5 kHz and 156.525 MHz"],
  ...
  },
  {
    ...
    "a": "Cospas-Sarsat",
    "opts": ["INMARSAT", "Galileo", "Cospas-Sarsat", "Iridium"],
  ...
  },
  {
    ...
    "opts": ["VHF-EPIRBs (operating on CH 70) are no longer accepted for ANY sea area; all ships must carry a 406 MHz satellite EPIRB", "EPIRBs must now transmit video feeds", "EPIRBs must be painted fluorescent green", "EPIRBs are now optional if the ship has AIS"],
  ...
  },
  {
    ...
    "opts": ["If the ship sinks, water pressure triggers a knife at a specific depth, cutting the plastic securing bolt and allowing the buoyant EPIRB to float to the surface", "It physically launches the EPIRB into the air using a spring", "It measures the depth of the water to calculate GPS coordinates", "It turns on the EPIRB's strobe light"],
  ...
  },
  {
    ...
    "opts": ["At exactly 0.5 meters", "Between 1.5 and 4.0 meters underwater", "Between 10 and 15 meters underwater", "Below 50 meters"],
  ...
  },
  {
    ...
    "opts": ["It contains 'Sea Contacts' (water switches) on the bottom; when it floats in conductive seawater, the circuit completes and the beacon turns ON", "It is turned on by the hydrostatic knife slicing a wire", "It turns on when sunlight hits its solar panel", "It starts transmitting when it loses the Bluetooth signal from the bridge"],
  ...
  },
  {
    ...
    "opts": ["The bracket is completely watertight", "The bracket contains a built-in magnet that interacts with a reed switch inside the EPIRB, keeping the unit physically disabled as long as it is seated in the housing", "Rainwater is not conductive enough to complete the circuit", "The EPIRB only works upside down"],
  ...
  },
  {
    ...
    "opts": ["The lanyard must be tied tightly to the bridge railing to prevent theft", "The lanyard must be tied to the HRU knife", "The lanyard must be cut off entirely", "The lanyard MUST be neatly coiled and NEVER tied to the ship's structure; if tied, the sinking ship will drag the floating EPIRB down with it"],
  ...
  },
  {
    ...
    "opts": ["A continuous analog SOS tone", "The 15-character Hexadecimal ID (which links to a database showing the ship's name, MMSI, and emergency contacts) and, if GPS-equipped, its exact coordinates", "The ship's current fuel level and heading", "A voice recording of the Captain's distress message"],
  ...
  },
  {
    ...
    "opts": ["It must be capable of transmitting continuously for at least 48 hours at -20\u00b0C", "It must transmit indefinitely via solar power", "It must transmit for 96 hours", "It must transmit for 8 hours"],
  ...
  },
  {
    ...
    "opts": ["It is never tested to preserve battery life", "Tested annually by pressing the main 'ON' button for 5 seconds", "Tested daily by dropping it in a bucket of seawater", "Tested monthly using the built-in 'TEST' switch; this fires a brief, restricted self-test burst to verify battery and transmitter health without triggering a live distress alert"],
  ...
  },
  {
    ...
    "opts": ["Every 10 years", "Every 1 year", "Only when the battery expires", "It must be sent ashore to an approved facility at intervals not exceeding 5 years for a complete teardown, battery replacement, and RF emission check"],
  ...
  },
  {
    ...
    "opts": ["5 years", "It never expires", "10 years", "Typically 2 years from the date of installation (which must be clearly punched/marked on the unit)"],
  ...
  },
  {
    ...
    "opts": ["Put it back in its bracket and pretend nothing happened", "Wrap it in aluminum foil and throw it overboard", "Remove it from the water, manually switch it OFF, and immediately contact the nearest Rescue Coordination Centre (RCC) to cancel the false distress alert", "Smash it with a hammer to stop the signal"],
  ...
  },
  {
    ...
    "opts": ["LEOSAR is for VHF; GEOSAR is for MF", "LEOSAR (Low Earth Orbit) satellites fly over the poles and use Doppler shift to calculate position; GEOSAR (Geostationary) satellites sit high over the equator and relay alerts instantly but cannot calculate position without GPS", "LEOSAR is for military; GEOSAR is civilian", "They are two competing companies that sell EPIRBs"],
  ...
  },
  {
    ...
    "opts": ["So the Captain can use it to navigate if the bridge radars fail", "It calculates the speed at which the ship sank", "It allows the EPIRB to broadcast its exact coordinates instantly to the GEOSAR satellites, reducing the search radius to 50 meters immediately without waiting for a LEOSAR satellite to fly over", "It syncs the EPIRB clock with the ship's clock"],
  ...
  },
  {
    ...
    "opts": ["No, opening the casing breaks the hermetic seal; batteries must only be replaced by a certified shore-based facility to guarantee watertight integrity and proper programming", "Yes, provided the Captain supervises", "Yes, as long as they use marine-grade batteries", "No, the EPIRB is nuclear powered"],
  ...
  },
  {
    ...
    "opts": ["A flare gun attached to the side", "A steady green LED", "A red laser pointer", "A high-intensity white flashing strobe light that activates automatically when the unit is transmitting"],
  ...
  },
  {
    ...
    "opts": ["Inside the bridge to protect it from the weather", "Inside the enclosed lifeboat", "In a clear, unobstructed location (usually high on the bridge wing) where it can float absolutely free vertically without getting trapped under railings or antennas if the ship sinks", "Deep inside the engine room next to the emergency generator"],
  ...
  },
  {
    ...
    "opts": ["Class 1 floats; Class 2 sinks", "Class 1 requires manual activation; Class 2 is automatic", "Class 1 has a 96-hour battery; Class 2 has a 48-hour battery", "Class 1 is designed to operate in extreme cold (-40\u00b0C), while Class 2 is standard (-20\u00b0C)"],
  ...
  },
  {
    ...
    "opts": ["Either throw it into the sea (water contacts activate it), or manually slide the switch on the unit to the 'ON' position", "Pull the pin like a hand grenade", "It activates automatically as soon as it leaves the bracket", "Hit it firmly against the side of the life raft"],
  ...
  },
  {
    ...
    "opts": ["Maritime Mobile Service Identity; a unique 9-digit number programmed into the EPIRB, DSC, and AIS that acts as the ship's global digital phone number", "Maximum Movement Speed Indicator", "Master's Maritime Safety Index", "Marine Measurement System Indicator"],
  ...
  },
  {
    ...
    "opts": ["Paint blocks the 121.5 MHz homing signal", "Paint can cover the metal sea contacts (preventing automatic activation), obscure the expiration dates, and block the GPS receiver antenna", "Paint makes it too heavy to float", "Paint chemically reacts with the plastic casing to form a bomb"],
  ...
  },
  {
    ...
    "opts": ["EPIRBs only work in the ocean; PLBs only work on land", "EPIRBs use 406 MHz; PLBs use VHF", "There is no difference; they are exactly the same device", "An EPIRB is registered to a SHIP and is designed to float upright automatically; a PLB is registered to a PERSON, requires manual activation, and does not float in an upright transmitting position without assistance"],
  ...
  },
  {
    ...
    "opts": ["The Manufacture Date, the Purchase Date, and the Warranty Date", "The Battery Expiry Date, the HRU Expiry Date, and the Shore-Based Maintenance (SBM) Due Date", "The Antenna Expiry Date, the Magnet Expiry Date, and the Strobe Expiry Date", "The Ship's Delivery Date, the Drydock Date, and the Captain's Birthday"],
  ...
  },
  {
    ...
    "opts": ["Yes, but only with geostationary satellites", "No, it is used to communicate with passing submarines", "No, it is a low-power, analog, local line-of-sight signal used purely by Search and Rescue aircraft or ships to 'home in' on the beacon using directional antennas", "Yes, it is the primary satellite uplink frequency"],
  ...
  },
  {
    ...
    "opts": ["Yes, 406 MHz can penetrate solid steel easily", "No, the steel hull acts as a Faraday cage, blocking the 406 MHz RF signal from reaching the satellites", "No, it requires sunlight to operate", "Yes, it will automatically switch to sonar to escape the ship"],
  ...
  },
  {
    ...
    "opts": ["It transmits once an hour for 5 minutes", "It transmits a powerful 5-Watt half-second digital burst every 50 seconds, rather than a continuous stream", "It only transmits when a satellite pings it", "It transmits continuously for exactly 48 hours"],
  ...
  },
  {
    ...
    "opts": ["It is highly buoyant, brightly colored (usually orange or yellow), and typically weighs 1 to 2 kg, making it easy to carry into a liferaft", "It weighs 50 kg to ensure it survives rough seas", "It is painted ocean-blue to camouflage it from pirates", "It is the size of a standard briefcase"],
  ...
  },
  {
    ...
    "opts": ["Yes, provided the Captain notes it in the logbook", "Yes, provided the SART is functioning", "Yes, if the ship stays within 12 nm of land", "No, a ship must NEVER sail without a functional, registered EPIRB onboard; a temporary 'loaner' EPIRB must be provided by the service station and registered to the ship"],
  ...
  },
  {
    ...
    "opts": ["Search and Rescue Radar Transponder", "Ship Alert and Rescue Tracker", "Satellite Alarm and Radio Transmitter", "Submersible Acoustic Ranging Tool"],
  ...
  },
  {
    ...
    "opts": ["406 MHz", "156.8 MHz (VHF Channel 16)", "The 9 GHz X-band (3 cm wavelength)", "The 3 GHz S-band (10 cm wavelength)"],
  ...
  },
  {
    ...
    "opts": ["Yes, but it will drain the battery twice as fast", "Yes, but the dots will appear smaller", "Yes, it responds to all radar bands", "No, it is completely deaf to S-band frequencies"],
  ...
  },
  {
    ...
    "opts": ["As a straight line of 12 dots extending outward from the SART's position toward the edge of the screen", "As a flashing SOS text message", "As a massive solid red circle", "As 8 concentric circles"],
  ...
  },
  {
    ...
    "opts": ["The dots begin to flash rapidly", "The dots widen into wide arcs, and eventually turn into complete concentric circles filling the center of the screen", "The dots disappear completely", "The dots turn into a straight line pointing left"],
  ...
  },
  {
    ...
    "opts": ["It has no battery; it uses solar panels", "48 hours of continuous transmission", "It must be capable of sitting in standby mode for 96 hours, PLUS continuously transmitting for an additional 8 hours after that", "12 hours standby, 1 hour transmit"],
  ...
  },
  {
    ...
    "opts": ["A SART that uses satellite imagery", "A radar SART that also flashes a bright light", "A SART designed specifically for airplanes", "An alternative to the traditional radar SART; it transmits GPS position data and a distress alert over AIS VHF frequencies instead of responding to X-band radar"],
  ...
  },
  {
    ...
    "opts": ["As a red circle with a cross inside it, accompanied by a text alert reading 'SART ACTIVE'", "As a flashing triangle", "As a straight line of 12 dots", "As a standard green ship icon"],
  ...
  },
  {
    ...
    "opts": ["2187.5 kHz", "VHF Channels AIS 1 (161.975 MHz) and AIS 2 (162.025 MHz)", "9 GHz", "406 MHz"],
  ...
  },
  {
    ...
    "opts": ["Inside the liferaft on the floor", "Exactly 5 meters above sea level", "At least 1 meter above sea level", "Floating directly in the water"],
  ...
  },
  {
    ...
    "opts": ["It launches a small parachute", "It heats up to melt the ice around it", "It provides a visual indication (e.g., a flashing light) and an audible beep, comforting the survivors by proving a ship is nearby and looking for them", "It automatically turns off to save power"],
  ...
  },
  {
    ...
    "opts": ["At least two (2) SARTs", "Three (3)", "Only one (1)", "Four (4)"],
  ...
  },
  {
    ...
    "opts": ["One of the two required SARTs must be permanently stowed inside the free-fall lifeboat", "Both SARTs must be kept on the bridge", "SARTs are not required if a free-fall lifeboat is fitted", "The SART must be strapped to the outside of the lifeboat hull"],
  ...
  },
  {
    ...
    "opts": ["Call the coast guard via VHF to ask for a radio check", "Turn on the ship's 3cm X-band radar, switch the SART to 'TEST' mode briefly, verify the 12 dots appear on the radar screen, and verify the SART beeps/flashes", "Submerge the SART in a bucket of seawater", "Use a multimeter to measure the battery voltage"],
  ...
  },
  {
    ...
    "opts": ["It corresponds to the sweep time of the SART's transmitter across the 9GHz band; the 12 dots will cover approximately 8 nautical miles on the radar screen", "It is a random distance caused by ocean waves", "It represents the depth of the water", "It tells the rescuing ship how many people are in the raft"],
  ...
  },
  {
    ...
    "opts": ["Switch to S-band radar", "Reduce the Sea Clutter (Anti-Clutter Sea / STC) setting to minimum, and use a range scale of 6 or 12 nm", "Use the 96 nm range scale", "Turn Sea Clutter to maximum to filter out the waves"],
  ...
  },
  {
    ...
    "opts": ["5 nautical miles", "Global coverage", "200 nautical miles", "Approximately 30 to 40 nautical miles"],
  ...
  },
  {
    ...
    "opts": ["1 nautical mile", "Approximately 5 to 8 nautical miles", "30 nautical miles", "100 nautical miles"],
  ...
  },
  {
    ...
    "opts": ["Generally no; the battery pack must be replaced by an authorized shore service agent before its expiry date to maintain waterproof integrity and certification", "Yes, provided it is done in the engine room", "Yes, it uses standard D-cell batteries", "No, the SART is a single-use disposable item"],
  ...
  },
  {
    ...
    "opts": ["Usually a bright yellow or orange cylinder, highly buoyant, with a lanyard and a telescopic mounting pole attached", "A flat black square box", "A small green wearable watch", "A large red satellite dish"],
  ...
  },
  {
    ...
    "opts": ["Yes, it uses Galileo satellites", "No, a traditional Radar SART only transmits a generic radar pulse; it has no GPS capability. Only an AIS-SART transmits coordinates", "Yes, directly to the Cospas-Sarsat network", "Yes, but only when asked by the rescue ship"],
  ...
  },
  {
    ...
    "opts": ["Magnetic polarization", "Circular polarization", "Horizontal polarization", "Vertical polarization"],
  ...
  },
  {
    ...
    "opts": ["The metal will drain the SART's battery magnetically", "The SART needs direct sunlight to charge", "The metal canopy acts as a radar reflector/blocker; the SART must be mounted outside, as high as possible, to ensure a clear 360-degree line of sight", "The metal canopy will cause the SART to overheat"],
  ...
  },
  {
    ...
    "opts": ["Fast sweep is for ships, slow sweep is for aircraft", "When triggered, it sweeps across the 9GHz band; the fast forward sweep creates the 12 dots, while the slow return sweep creates weaker background noise", "Slow sweep is used to calculate the water temperature", "Fast sweep uses more battery power"],
  ...
  },
  {
    ...
    "opts": ["It sends an email via INMARSAT", "It bounces a radar beam back to the ship", "It uses an internal GPS to find its location, then broadcasts AIS Message 1 (Position) and Message 14 (Safety Text: 'SART ACTIVE') every minute", "It broadcasts an SOS voice recording on VHF Ch 16"],
  ...
  },
  {
    ...
    "opts": ["It should be tested using the built-in test facility, which transmits a special test message that appears on the ship's AIS display as 'SART TEST'", "It must be tested by turning on the X-band radar", "It cannot be tested without notifying the Coast Guard", "It must be submerged in water to test"],
  ...
  },
  {
    ...
    "opts": ["No, it is strictly an emergency device; leaving it on will drain the battery, and it will respond to passing ships' radars, causing massive confusion", "Yes, to ensure it is always ready", "Yes, it acts as a secondary radar reflector", "No, because it emits dangerous radiation"],
  ...
  },
  {
    ...
    "opts": ["A SART is green, a RACON is red", "A SART displays a series of 12 equal dots; a RACON displays a specific Morse Code character (dots and dashes) to identify a navigational hazard like a buoy", "A SART shows a circle, a RACON shows a square", "They look exactly the same on radar"],
  ...
  },
  {
    ...
    "opts": ["The middle dot represents the SART", "The dots circle the SART", "The first dot represents the actual physical location of the SART; the other 11 dots trail out behind it away from the rescuing ship", "The last dot represents the SART"],
  ...
  },
  {
    ...
    "opts": ["To tie it to the EPIRB", "To tie the SART securely to the liferaft so it doesn't float away and get lost in heavy seas", "To tie it to the sinking ship", "To use it as a fishing line"],
  ...
  },
  {
    ...
    "opts": ["It rotates the scanner antenna", "It receives the weak echoes bouncing back from targets", "It displays the image on the screen", "It is a high-power vacuum tube that generates the intense bursts of microwave radio frequencies (RF pulses) required for radar transmission"],
  ...
  },
  {
    ...
    "opts": ["It generates the text on the radar screen", "It acts as an ultra-fast electronic switch; it blocks the massive transmission pulse from blowing up the delicate receiver, then instantly opens to allow the weak returning echo to reach the receiver", "It controls the speed of the antenna motor", "It translates X-band into S-band"],
  ...
  },
  {
    ...
    "opts": ["Frequency of 9 GHz, Wavelength of 3 cm. It provides excellent high-resolution target imaging but is highly susceptible to interference from heavy rain and sea clutter", "Frequency of 156 MHz. Used for voice comms", "Frequency of 3 GHz, Wavelength of 10 cm. Good in rain", "Frequency of 406 MHz. Used for satellites"],
  ...
  },
  {
    ...
    "opts": ["Frequency of 9 GHz, Wavelength of 3 cm", "It requires a much smaller antenna than X-band", "It only detects other ships equipped with AIS", "Frequency of 3 GHz, Wavelength of 10 cm. It has lower resolution but easily punches through heavy rain, fog, and snow without getting cluttered"],
  ...
  },
  {
    ...
    "a": "X-Band (9 GHz / 3 cm)",
    "opts": ["S-Band (3 GHz / 10 cm)", "L-Band", "Ku-Band", "X-Band (9 GHz / 3 cm)"],
  ...
  },
  {
    ...
    "opts": ["An X-band antenna is relatively small (typically 4 to 8 feet wide); an S-band antenna is massive (typically 12 feet wide) because it must broadcast a much larger 10cm wavelength", "There is no physical difference", "X-band antennas are parabolic dishes; S-band are simple wires", "X-band is massive; S-band is small"],
  ...
  },
  {
    ...
    "opts": ["The motor that turns the antenna", "A hollow, rectangular copper or brass pipe used to transmit the raw microwave energy from the magnetron up to the scanner antenna with minimal power loss", "A software program that plots the ship's course", "A thick rubber wire carrying 24V DC"],
  ...
  },
  {
    ...
    "opts": ["The radar picture becomes much clearer", "The water absorbs and scatters the microwave energy, drastically reducing the radar's range, degrading the picture, and potentially causing internal arcing that destroys the magnetron", "The radar switches from X-band to S-band automatically", "The antenna spins twice as fast"],
  ...
  },
  {
    ...
    "opts": ["It monitors the physical speed of the antenna motor", "It tracks the working hours of the crew", "It is an electronic test facility that actively checks both the Transmitter power output and the Receiver sensitivity, proving the radar hasn't quietly gone 'deaf' or 'weak' over time", "It records the fuel consumption of the ship"],
  ...
  },
  {
    ...
    "opts": ["The antenna motor has stopped turning", "The TR Cell (Duplexer) failed and stayed open during transmission, allowing the massive blast from the magnetron to enter and instantly burn out the delicate receiver crystal/diode", "The magnetron is completely dead", "The display monitor has a broken backlight"],
  ...
  },
  {
    ...
    "opts": ["Rain clutter interference", "A fault in the synchronization between the spinning antenna and the display, often caused by a dirty optical encoder, a failing heading marker microswitch, or a loose data cable", "A dying magnetron", "A burned-out receiver crystal"],
  ...
  },
  {
    ...
    "opts": ["It paints a solid line on the screen directly from the center to the edge, indicating the exact physical direction the ship's bow is pointing", "It highlights the most dangerous target on the screen", "It shows the direction of the wind", "It marks the location of the nearest port"],
  ...
  },
  {
    ...
    "opts": ["Acoustic Ranging and Pulse Analyzer", "Advanced Radar Power Amplifier", "Automated Radio Positioning Array", "Automatic Radar Plotting Aid; a computer system that automatically tracks multiple radar targets, calculates their speed/course, and predicts their Closest Point of Approach (CPA) to warn of collisions"],
  ...
  },
  {
    ...
    "opts": ["Depth from the Echo Sounder, and Wind from the Anemometer", "Time from the atomic clock, and Draft from the load computer", "Heading from the Gyrocompass, and Speed from the Doppler Log/GPS", "VHF radio signals, and AIS data"],
  ...
  },
  {
    ...
    "opts": ["An electronic failure in the magnetron", "A software glitch in the ARPA system", "An area on the screen where no targets can be seen; caused by physical obstructions on the ship (like the funnel, massive cranes, or the main mast) blocking the radar beam", "An area blocked by heavy rain"],
  ...
  },
  {
    ...
    "opts": ["1 million hours", "100 hours; replaced every voyage", "Typically 5,000 to 10,000 transmit hours; the ETO must track the hours, perform Performance Monitor checks, and proactively replace the magnetron before it degrades completely", "It lasts the lifetime of the ship (25 years)"],
  ...
  },
  {
    ...
    "opts": ["Never use insulated tools", "Never use magnetic tools (like magnetic-tipped screwdrivers) near the magnetron, and keep it away from steel bulkheads, as altering its powerful internal permanent magnets will destroy its frequency tuning", "Tools must be heated to 100\u00b0C before touching it", "Only use tools made of solid gold"],
  ...
  },
  {
    ...
    "opts": ["To silence the ship's horn", "To stop the ship from moving", "To prevent birds from attacking", "To ensure power is locked off; the spinning antenna could knock you off the mast, and standing directly in front of an active transmitting magnetron causes severe microwave radiation burns (cooking internal organs)"],
  ...
  },
  {
    ...
    "opts": ["It temporarily reduces the receiver's sensitivity for echoes bouncing back from targets very close to the ship (like waves), preventing the center of the screen from becoming a solid blob of noise", "It increases the power of the magnetron", "It slows down the antenna motor", "It filters out rain clouds"],
  ...
  },
  {
    ...
    "opts": ["It switches the radar from X-band to S-band", "It physically tilts the antenna to look under the clouds", "It turns on the windshield wipers on the bridge", "It electronically shortens the echo pulses on the screen, breaking up the massive solid blob of a rain cloud so that the hard echo of a ship hiding inside the rain becomes visible"],
  ...
  },
  {
    ...
    "opts": ["Short pulse is only used for S-band", "Long pulse is used for short range, Short pulse for long range", "Pulse length only dictates the color of the screen", "A 'Short Pulse' provides excellent target resolution and crisp pictures at close range; a 'Long Pulse' pumps more total energy into the sky, sacrificing crispness to detect targets much further away"],
  ...
  },
  {
    ...
    "opts": ["The number of radar pulses transmitted every second (e.g., 1000 to 3000 Hz)", "The refresh rate of the LCD monitor", "The speed the antenna spins (24 RPM)", "The frequency of the microwave (9 GHz)"],
  ...
  },
  {
    ...
    "opts": ["Pulse length dictates voltage, PRF dictates current", "They are inversely related; a Long Pulse requires the radar to listen for a longer time for distant echoes, so the PRF must automatically drop (fewer pulses per second)", "They are directly proportional; Long pulse means high PRF", "They have no relationship whatsoever"],
  ...
  },
  {
    ...
    "opts": ["It physically vibrates the antenna to shake off ice", "It generates a steady internal frequency that is mixed with the incoming 9GHz echo to produce a much lower, manageable Intermediate Frequency (IF) (e.g., 60 MHz) that the electronics can easily amplify", "It controls the tuning of the ship's VHF radio", "It generates the 440V AC power for the magnetron"],
  ...
  },
  {
    ...
    "opts": ["Radar is optional if ECDIS is installed", "They must carry two totally independent radar installations; at least one MUST be a 9 GHz (X-band) radar", "They must carry two S-band radars", "Only one X-band radar is required"],
  ...
  },
  {
    ...
    "opts": ["Reboot the ARPA software", "Check the operating hours on the Magnetron; if it exceeds 5000-8000 hours, it is likely depleted and must be replaced", "Check the ship's battery voltage", "Scrub the radar screen with alcohol"],
  ...
  },
  {
    ...
    "opts": ["100 to 120 RPM", "24 to 28 RPM (Revolutions Per Minute)", "1 to 5 RPM", "3000 RPM"],
  ...
  },
  {
    ...
    "opts": ["The scanner stops, the screen stops painting a circle, and usually paints a single bright line representing the last heading; the transceiver is usually interlocked to shut down to prevent burning out the stationary waveguide", "The screen goes completely black", "The magnetron explodes", "The radar switches to an internal backup motor"],
  ...
  },
  {
    ...
    "opts": ["To calculate the depth of the water", "To provide 'North Up' or 'True Motion' stabilization; without it, the radar only knows 'Head Up' (relative to the ship's bow), making tracking landmasses and other ships highly disorienting when the ship turns", "To align the magnetron frequencies", "To power the display screen"],
  ...
  },
  {
    ...
    "opts": ["A modern radar that eliminates the magnetron vacuum tube entirely, using solid-state transistors to emit a continuous, low-power frequency-sweeping signal; it requires far less maintenance and has no radiation hazard", "A radar that only detects solid landmasses, ignoring ships", "A radar built entirely out of a single block of steel", "A radar that relies on solid wire instead of waveguides"],
  ...
  },
  {
    ...
    "opts": ["To track the exact amount of cargo loaded onboard", "To automate the steering of the ship", "To guarantee that a ship in distress can rapidly and automatically alert shore-based Rescue Coordination Centres (RCCs) and nearby vessels, ensuring no ship sinks in silence", "To provide high-speed internet to the crew"],
  ...
  },
  {
    ...
    "opts": ["By the Gross Tonnage (GT) of the ship", "It is dictated entirely by the 'Sea Area' (A1, A2, A3, A4) the ship operates in, NOT by the size or tonnage of the ship", "By the number of crew members onboard", "By the flag state of the vessel"],
  ...
  },
  {
    ...
    "opts": ["Global satellite coverage", "Coverage provided by Medium Frequency (MF) stations", "An area within the radiotelephone coverage of at least one VHF coast station in which continuous DSC alerting is available (typically 20-30 nautical miles offshore)", "Any port or harbor limits"],
  ...
  },
  {
    ...
    "opts": ["Any area beyond 200 nautical miles", "The polar regions above 70 degrees North", "Any area covered by INMARSAT satellites", "An area, excluding Area A1, within the radiotelephone coverage of at least one Medium Frequency (MF) coast station providing continuous DSC alerting (typically up to 100-150 nm offshore)"],
  ...
  },
  {
    ...
    "opts": ["An area, excluding Areas A1 and A2, within the coverage of a Recognized Mobile Satellite Service (RMSS) like INMARSAT, providing continuous alerting (roughly 70\u00b0N to 70\u00b0S)", "Any area within High Frequency (HF) radio range", "The area strictly covering the North and South Poles", "An area covering only the Atlantic Ocean"],
  ...
  },
  {
    ...
    "opts": ["The polar regions; any area outside of A1, A2, and A3 (typically above 70\u00b0 North or South), requiring High Frequency (HF) radio with DSC for long-range communication", "The Panama and Suez Canals", "Any area requiring armed piracy guards", "The Mediterranean Sea"],
  ...
  },
  {
    ...
    "opts": ["A paging system that automates distress alerting; pressing a button sends a digital burst containing the ship's MMSI and GPS position to all stations, ringing loud alarms on their bridges", "A voice-scrambling technology for secure comms", "A satellite video broadcasting system", "A system that prints weather charts"],
  ...
  },
  {
    ...
    "opts": ["406 MHz", "VHF Channel 16 (156.800 MHz)", "2182 kHz", "VHF Channel 70 (156.525 MHz)"],
  ...
  },
  {
    ...
    "a": "2187.5 kHz",
    "opts": ["2182.0 kHz", "4209.5 kHz", "518.0 kHz", "2187.5 kHz"],
  ...
  },
  {
    ...
    "opts": ["Minimum of 15 Minutes", "Minimum of 6 Hours", "Minimum of 24 Hours", "Minimum of 1 Hour"],
  ...
  },
  {
    ...
    "opts": ["It must be an automatic charger, capable of recharging completely depleted batteries to minimum capacity within 10 hours", "It must charge the batteries in under 1 hour", "It must run exclusively on solar power", "It must be a manual trickle charger"],
  ...
  },
  {
    ...
    "opts": ["It dials the ship owner's phone number directly", "An un-formatted distress alert (containing MMSI and GPS position) is instantly transmitted to a Rescue Coordination Centre (RCC) via satellite", "It erases all data on the voyage data recorder", "It sounds the ship's general fire alarm"],
  ...
  },
  {
    ...
    "opts": ["Check the battery voltage on load/off load, and perform an internal self-test on the VHF DSC without transmitting", "Climb the mast to grease the radar antenna", "Replace the EPIRB battery", "Transmit a live distress call to shore"],
  ...
  },
  {
    ...
    "opts": ["A live DSC test call must be made to a coast radio station (via MF/HF) to prove the transmitter can physically reach the shore", "A complete discharge of the battery bank", "Firing a distress flare", "Testing the lifeboat engines"],
  ...
  },
  {
    ...
    "opts": ["Replace the acid with fresh seawater", "Short circuit the terminals to burn off corrosion", "Check the electrolyte levels, clean the terminals, and measure the specific gravity of the acid in every single cell using a hydrometer", "Paint the batteries red"],
  ...
  },
  {
    ...
    "opts": ["It is now the primary mode of distress communication", "It is no longer a mandatory carriage requirement; ships are no longer forced to use or maintain HF Telex machines for GMDSS certification", "It must be upgraded to color printers", "It is mandatory only in Sea Area A1"],
  ...
  },
  {
    ...
    "opts": ["The ship must carry two EPIRBs", "The ship must carry a spare battery for every radio", "The ship must have two radars", "To ensure absolute reliability without a dedicated radio officer, the ship must carry TWO complete sets of long-range equipment (e.g., Two INMARSAT-C terminals, or One INMARSAT and One full MF/HF DSC setup)"],
  ...
  },
  {
    ...
    "opts": ["Must transmit on 406 MHz", "Must be permanently mounted inside the liferafts", "Cargo ships >500 GT must carry at least 3 portable VHFs, kept fully charged and stored in a prominent place (usually the bridge) ready to be grabbed during abandon ship", "Must carry 1 radio per crew member"],
  ...
  },
  {
    ...
    "opts": ["They must have a bright, unbroken factory seal (often yellow or orange) and a clear expiry date; they MUST NEVER be used for routine onboard work, ensuring 100% capacity for an actual emergency", "They can be used for cargo operations if the main radios break", "They must be recharged every Friday", "They must be kept in the refrigerator"],
  ...
  },
  {
    ...
    "opts": ["Severe RF (Radio Frequency) burns and electric shock; the transmitter pushes massive voltage (up to 1000V) into the antenna wire", "The ship will blackout", "The antenna will instantly rust", "The radio will lose its MMSI programming"],
  ...
  },
  {
    ...
    "opts": ["To prevent lightning from striking both at once", "Because they operate on completely different voltages", "To satisfy aesthetic symmetry rules", "To prevent the massive 500W transmission pulse from feeding directly into the highly sensitive receiving antenna and instantly burning out the receiver circuits"],
  ...
  },
  {
    ...
    "opts": ["They must be painted with thick lead paint", "They must be greased with heavy marine lube", "They must be regularly washed with fresh water to remove thick salt and soot deposits, which would otherwise act as a conductor, short-circuiting the radio signal directly into the steel deck", "They must be replaced every 6 months"],
  ...
  },
  {
    ...
    "opts": ["The console shuts down and reboots in battery mode", "It uses a hand-crank dynamo on the side of the desk", "The console power supply unit features an automatic changeover relay; when 220V AC drops, it instantly clicks over, drawing 24V DC directly from the dedicated radio battery bank", "The ETO must manually run up to the bridge and flip a switch"],
  ...
  },
  {
    ...
    "opts": ["It points the antenna towards the nearest satellite", "It automatically adjusts internal capacitors and inductors to match the electrical impedance of the antenna to the specific frequency being transmitted, ensuring maximum power transfer and preventing reflected waves (high SWR)", "It filters out static noise from thunderstorms", "It translates digital DSC data into analog voice"],
  ...
  },
  {
    ...
    "opts": ["A satellite-based service (via INMARSAT-C) that broadcasts maritime safety information (weather, nav warnings) to ships outside the range of coastal NAVTEX stations", "A distress beacon attached to the lifebuoy", "A system that groups all the alarms onto one screen", "A VHF channel used for inter-ship chatting"],
  ...
  },
  {
    ...
    "opts": ["Instantly switch off the transmitter to abort further transmissions, tune the radio to the associated voice distress channel (e.g., Ch 16), and broadcast an 'ALL STATIONS' message explicitly canceling the false alert", "Pull the fire alarm to justify the call", "Turn off the ship's main power and hide", "Wait for the coast guard to call and apologize"],
  ...
  },
  {
    ...
    "opts": ["Inside the Captain's cabin", "In the engine room next to the main switchboard", "In the forward bow thruster room", "In the highest part of the ship (usually above the bridge deck) to remain above the waterline as long as possible if the ship sinks, allowing final distress calls to be made"],
  ...
  },
  {
    ...
    "opts": ["Lead-acid batteries emit highly explosive Hydrogen gas while being charged; without ventilation, the gas accumulates at the ceiling and can be ignited by a single spark", "The acid evaporates and rusts the steel deck", "Batteries overheat and melt the plastic cases", "Batteries emit toxic chlorine gas"],
  ...
  },
  {
    ...
    "opts": ["It scrambles the voice for privacy", "It automatically changes the channel to 16", "It boosts the transmission power to 25 Watts", "It sets an electronic threshold that mutes the continuous, annoying background static noise, only opening the audio speaker when a strong, genuine radio transmission breaks the threshold"],
  ...
  },
  {
    ...
    "opts": ["To see how much fuel the emergency generator used", "To check the captain's handwriting", "It is a statutory legal document; it proves that the ETO and Deck Officers are actually maintaining the equipment and conducting the daily/weekly tests required to ensure the ship's safety lifeline is functional", "To check for spelling errors"],
