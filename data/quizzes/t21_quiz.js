window.loadQuizzes("T21_LSA", [
  {
    ...
    "opts": ["EPIRB transmits voice on VHF Ch 16; SART broadcasts AIS on 161.975 MHz", "EPIRB guides helicopters locally on 9 GHz; SART sends satellite texts via Inmarsat-C", "Both transmit 12 dots on rescuing ship's 3 GHz S-band radar \u2014 no difference", "EPIRB: global distress alert to satellites on 406 MHz; SART: local homing for rescue vessels responding to X-band radar pulses on 9 GHz"],
  ...
  },
  {
    ...
    "opts": ["Run engine 4 hours while powering searchlight", "3 cold starts and VHF standby for 96 hours", "Provide 100 Ah to run emergency bilge pump indefinitely", "Sufficient for 6 consecutive cold engine starts (30-second intervals) plus 30 minutes power for all electrical consumers"],
  ...
  },
  {
    ...
    "opts": ["CCA = Continuous Charge Acceptance for fast trickle charging", "CCA = Constant Current Application for running 50W searchlight", "CCA = Cathodic Corrosion Allowance for saltwater terminal resistance", "CCA = maximum current deliverable for 30 seconds at -18\u00b0C while maintaining minimum voltage \u2014 ensures cold-weather engine starting"],
  ...
  },
  {
    ...
    "opts": ["30 minutes for firefighting in small electrical fires", "60 minutes for enclosed space routine inspections", "15 minutes for two persons to share during freon leak", "10 minutes of breathable air for emergency ESCAPE ONLY \u2014 not for firefighting or enclosed space entry"],
  ...
  },
  {
    ...
    "opts": ["Cools UPS inverters generating heat during blackout", "Prevents Freon accumulation from nearby AC compressors", "Reduces humidity to maintain battery CCA rating", "Lead-acid and Ni-Cd batteries generate highly explosive hydrogen gas during final charging stages \u2014 must be ventilated"],
  ...
  },
  {
    ...
    "opts": ["CCA is the maximum current a battery can deliver for 30 seconds at -18 degrees C while maintaining at least 1.2V per cell \u2014 critical because lifeboat engines must start reliably in Arctic conditions", "CCA is the maximum continuous charging current a battery can accept without exceeding its thermal limit", "CCA is the total amp-hour capacity at a 20-hour discharge rate at 25 degrees C \u2014 used only for UPS battery sizing", "CCA is the cable current rating of the starter motor cable \u2014 unrelated to the battery itself"],
  ...
  },
  {
    ...
    "opts": ["Immediately connect the battery to the lifeboat starter motor and perform a cold crank test", "Check all documentation and certificates, verify voltage and Ah capacity match the lifeboat engine manufacturer's specification, and inspect physical condition for transit damage", "Paint the battery terminals with copper grease and measure internal resistance with a standard multimeter", "Charge the battery at maximum rated current for 24 hours before any testing"],
  ...
  },
  {
    ...
    "opts": ["The sequence does not matter as long as both connections are made within 5 seconds of each other", "Connect the POSITIVE terminal first, then the NEGATIVE terminal \u2014 disconnect in reverse order (negative first) when removing", "Connect both terminals simultaneously using insulated tools to avoid any voltage differential", "Connect the NEGATIVE terminal first to establish earth continuity, then the POSITIVE terminal"],
  ...
  },
  {
    ...
    "opts": ["2 consecutive cold starts \u2014 sufficient to demonstrate starting reliability", "6 consecutive cold starts within 2 minutes at an ambient temperature down to -15 degrees C", "10 consecutive cold starts \u2014 the more demanding IACS unified requirement", "The engine must start within 30 seconds on the first attempt \u2014 subsequent attempts are not counted"],
  ...
  },
  {
    ...
    "opts": ["Engines are required to stop automatically when the lifeboat inclines beyond 20 degrees to prevent flooding through the exhaust", "The engine must be capable of running in the inverted position \u2014 ensuring the lifeboat can self-right and restore engine operation after capsizing", "The lifeboat is not required to operate when inverted \u2014 evacuation into a life raft is required if the lifeboat capsizes", "The engine must be shut down before the lifeboat can be inverted \u2014 a separate hand-cranked generator provides power during righting"],
  ...
  },
  {
    ...
    "opts": ["4 parachute rocket flares, 6 hand flares, and 2 buoyant smoke signals per lifeboat", "6 parachute rocket flares, 4 hand flares, and 6 buoyant smoke signals per lifeboat", "2 parachute rocket flares, 2 hand flares, and 4 buoyant smoke signals per lifeboat", "12 parachute rocket flares, 4 hand flares, and 2 buoyant smoke signals per lifeboat"],
  ...
  },
  {
    ...
    "opts": ["Pyrotechnics have no expiry \u2014 they are replaced only if the primer or ignition cord shows visible damage", "5 years from the date of manufacture \u2014 identical to the liferaft service interval", "3 years from the date of manufacture stamped on the device", "10 years if stored in a cool dry location below 20 degrees C"],
  ...
  },
  {
    ...
    "opts": ["Burns for minimum 5 minutes at a minimum altitude of 500 metres", "Burns for minimum 40 seconds at a minimum altitude of 300 metres", "Burns for minimum 60 seconds at a minimum altitude of 100 metres", "Burns for minimum 20 seconds at a minimum altitude of 1000 metres"],
  ...
  },
  {
    ...
    "opts": ["A minimum of 100W searchlight providing 500 metres visibility for 1 hour", "A minimum of 10W LED light providing 50 metres visibility for 24 hours", "A minimum of 55W searchlight providing 180 metres visibility for a minimum of 3 hours", "The searchlight specification is not mandated by SOLAS \u2014 it is determined by the shipyard at time of construction"],
  ...
  },
  {
    ...
    "opts": ["Ventilation must run continuously during charging and for at least 30 minutes AFTER charging is complete to clear residual hydrogen gas", "Ventilation is only required during the initial 15-minute charging peak current phase", "Battery room ventilation must run at maximum capacity for 24 hours before any hot work in adjacent spaces", "Ventilation only needs to be activated manually when battery SG exceeds 1.250"],
  ...
  },
  {
    ...
    "opts": ["Must be wired in parallel with a dedicated battery room circuit breaker rated at twice the total lamp wattage", "Must be Ex-rated (Ex d or Ex e) for Gas Group IIC (hydrogen) and the switch must be located OUTSIDE the battery room", "Must use LED technology with a minimum 50,000-hour rated lifespan and be sealed to IP65", "Must be connected to the emergency switchboard and have a local isolation switch inside the room"],
  ...
  },
  {
    ...
    "opts": ["2 air changes per hour \u2014 sufficient to dilute any H2 below 1% LEL", "30 air changes per hour \u2014 the same standard as a cargo pump room", "Minimum 6 air changes per hour with exhaust taken from the highest point (ceiling) of the battery room", "Air changes are not specified \u2014 only a continuous air flow across the battery top surface is required"],
  ...
  },
  {
    ...
    "opts": ["Maximum 0.5 metres per second \u2014 a significant reduction to allow crew to board during lowering", "Maximum 1.3 metres per second (78 metres per minute) to prevent hard water impacts and accidental hook release", "No maximum speed is specified \u2014 speed is determined by the ship's maintenance officer based on sea conditions", "Maximum 3.0 metres per second \u2014 the original SOLAS speed limit unchanged by 2026 amendments"],
  ...
  },
  {
    ...
    "opts": ["Single-fall hooks must be coated with a radar-reflective paint to improve recovery operations", "Single-fall hooks must now incorporate a secondary manual pin lock requiring tool removal before any release", "Single-fall hooks must be engineered so they cannot support the craft's weight unless the locking mechanism is 100% correctly reset \u2014 preventing accidental drops from partial hook engagement", "Single-fall hooks must be replaced with double-fall hook systems on all vessels to prevent single-point failure"],
  ...
  },
  {
    ...
    "opts": ["Minimum 275 Newtons buoyancy (offshore specification) regardless of vessel type", "Buoyancy testing requirements have not changed \u2014 the 2026 amendment only covers lifeboat hook design", "Minimum 100 Newtons buoyancy and self-righting within 30 seconds", "Minimum 150 Newtons buoyancy, 24-hour immersion retention, and self-righting of an unconscious person within 5 seconds"],
  ...
  },
  {
    ...
    "opts": ["Minimum 2 cubic metres per hour per person \u2014 sufficient to maintain safe O2 levels for 24 hours", "Minimum 5 cubic metres per hour per person, powered independently of the main propulsion engine", "Minimum 20 air changes per hour \u2014 identical to the cargo pump room standard", "No independent ventilation is required \u2014 the engine room ventilation system is integrated into the lifeboat"],
  ...
  },
  {
    ...
    "opts": ["The HRU maintains the inflation pressure inside the life raft canister during storage in tropical conditions", "The HRU automatically releases and inflates the life raft when the ship sinks to a depth of 2-4 metres \u2014 ensuring the life raft floats free even if crew cannot deploy it manually", "The HRU connects the life raft lanyard to the ship's guardrail, preventing it from being lost overboard in rough weather", "The HRU is a hydrostatic test device used at the annual service to verify the canister pressure is within limits"],
  ...
  },
  {
    ...
    "opts": ["Every 5 years \u2014 the same interval as the lifeboat annual survey", "Every 12 months \u2014 or within 5 years of the manufactured date on first service", "Every 3 years \u2014 the same interval as pyrotechnic replacement", "Every 2 years if stored below deck in a controlled temperature environment"],
  ...
  },
  {
    ...
    "opts": ["It is a high-visibility suit for helicopter rescue \u2014 no thermal protection is required by SOLAS", "It provides flame protection only \u2014 designed to allow survival for 30 minutes in burning fuel on the water surface", "It must maintain core temperature above 37 degrees C for 24 hours in water at 20 degrees C", "It provides thermal and buoyancy protection \u2014 must maintain core body temperature above 35 degrees C after 6 hours in water at 0-2 degrees C"],
  ...
  },
  {
    ...
    "opts": ["Activates automatically when temperature drops below 0 degrees C \u2014 indicating immersion in polar waters", "Activates automatically when submerged to 1-4 metres depth via hydrostatic release \u2014 transmits on 406 MHz to COSPAS-SARSAT", "Activates only when manually triggered by a crew member from the bridge GMDSS panel", "Activates automatically when the vessel's roll exceeds 45 degrees for more than 10 consecutive seconds"],
  ...
  },
  {
    ...
    "a": "24V DC",
    "opts": ["24V DC", "220V AC", "110V AC", "12V DC"],
  ...
  },
  {
    ...
    "opts": ["Hydrostatic pressure switch", "Capacitive level sensor", "Ultrasonic distance sensor", "Inductive proximity sensor"],
  ...
  },
  {
    ...
    "opts": ["0.5 metres per second", "1.3 metres per second", "2.0 metres per second", "1.0 metres per second"],
  ...
  },
  {
    ...
    "opts": ["A dedicated ventilation system providing 5 cubic metres of fresh air per hour per person, independent of the engine", "Passive ventilation louvres that open automatically upon water entry", "Compressed air cylinders capable of providing 10 minutes of breathing air", "An air conditioning unit powered by the emergency generator"],
  ...
  },
  {
    ...
    "opts": ["To wash away chemical contaminants after launching", "To provide a continuous water film over the hull to allow the lifeboat to survive passing through burning oil on the sea surface", "To cool the internal cabin temperature in tropical climates", "To act as an internal fire suppression system in case of an engine fire"],
  ...
  },
  {
    ...
    "opts": ["On-load requires the boat to be completely out of the water; off-load is used only when submerged", "On-load is activated automatically by hydrostatic pressure; off-load is strictly manual", "On-load is used for lowering the boat; off-load is used for hoisting", "On-load releases the hooks while the boat is waterborne with full weight on them; off-load requires deliberate secondary action and is used for resetting or emergency in-air release"],
  ...
  },
  {
    ...
    "opts": ["Being operated by a single crew member", "Releasing automatically upon hitting the water without manual input", "Supporting any load unless the hook is completely and correctly reset in the closed/locked position", "Being tested while the vessel is underway"],
  ...
  },
  {
    ...
    "opts": ["Open Circuit Voltage (OCV)", "CCA (Cold Cranking Amps)", "Specific Gravity (SG)", "Ampere-hour (Ah) capacity"],
  ...
  },
  {
    ...
    "a": "1.265\u20131.280",
    "opts": ["1.120\u20131.150", "1.350\u20131.400", "1.265\u20131.280", "1.190\u20131.210"],
  ...
  },
  {
    ...
    "opts": ["By running the lifeboat engine for 10 minutes every day", "By a shore-connected trickle charger providing a continuous float voltage (typically 27.6V)", "By a dedicated solar panel mounted on the davit", "By manually charging it once a month using a portable generator"],
  ...
  },
  {
    ...
    "opts": ["Lead sulphate converts back to lead dioxide, making the electrolyte more dense", "Hydrogen gas is released, increasing the concentration of lead in the acid", "Both the lead dioxide and spongy lead plates react with sulphuric acid to form lead sulphate, producing water and diluting the electrolyte", "Sulphuric acid evaporates from the battery cells"],
  ...
  },
  {
    ...
    "opts": ["Dilute bicarbonate solution", "Sulphuric acid", "Distilled water only", "Tap water"],
  ...
  },
  {
    ...
    "opts": ["To keep the ambient temperature below 10\u00b0C", "To supply oxygen for the chemical reactions inside the battery", "To prevent the accumulation of toxic carbon monoxide", "To remove highly flammable hydrogen gas produced during battery charging"],
  ...
  },
  {
    ...
    "opts": ["Standard commercial LED fittings", "Explosion-protected (Ex e or Ex d rated) luminaires certified for a hydrogen atmosphere (Gas Group IIC)", "Battery-operated portable lanterns only", "Low-voltage halogen lamps"],
  ...
  },
  {
    ...
    "opts": ["A rubber vibration-damping mat", "A corrosion-resistant acid drip tray large enough to contain a full electrolyte spill", "A wooden pallet to insulate the batteries from the steel deck", "A grounded copper mesh pad to discharge static electricity"],
  ...
  },
  {
    ...
    "opts": ["Manually trigger the CO2 inflation cylinder when a crew member pulls the lanyard", "Automatically detach the liferaft from the ship if the wind speed exceeds 50 knots", "Activate via water pressure at 1.5-4m depth to cut the lashing strap, allowing the raft to float free and inflate", "Release dye markers into the water to attract rescue aircraft"],
  ...
  },
  {
    ...
    "opts": ["Pack A deploys automatically; Pack B deploys manually", "Pack A is for passenger ships; Pack B is for cargo ships", "Pack A is the comprehensive offshore pack for international voyages; Pack B is a reduced coastal pack", "Pack A contains inflatable rafts; Pack B contains rigid rafts"],
  ...
  },
  {
    ...
    "opts": ["2 years from installation", "It has no expiry as long as it passes annual inspection", "5 years from installation", "1 year from installation"],
  ...
  },
  {
    ...
    "opts": ["2 flares, burning white for 30 seconds", "6 flares, burning red for 1 minute", "12 flares, reaching 100m height", "4 flares, capable of reaching 300m height and burning bright red for 40 seconds"],
  ...
  },
  {
    ...
    "opts": ["For daytime position marking and to indicate wind direction to approaching rescue helicopters", "For nighttime illumination of the survival craft", "To create a thermal signature for satellite detection", "To repel sharks and marine predators"],
  ...
  },
  {
    ...
    "opts": ["They expire 5 years from manufacture and can be thrown overboard", "They do not expire if kept in watertight containers", "They expire 2 years from manufacture and must be tested annually", "They expire 3 years from manufacture and must be disposed of via approved shore facilities, never discharged at sea"],
  ...
  },
  {
    ...
    "opts": ["For fighting minor fires in the engine room", "Strictly for short-duration escape from a space filled with smoke or toxic gases", "For entering enclosed spaces to rescue an unconscious crew member", "To provide supplementary oxygen during high-altitude helicopter evacuations"],
  ...
  },
  {
    ...
    "a": "10 minutes",
    "opts": ["30 minutes", "5 minutes", "60 minutes", "10 minutes"],
  ...
  },
  {
    ...
    "opts": ["Minimum 2 sets onboard, used for firefighting, providing at least 30 minutes of air", "Minimum 1 set per crew member, providing 60 minutes of air", "Minimum 2 sets located only on the bridge, providing 15 minutes of air", "Minimum 4 sets onboard, used for escape only, providing 10 minutes of air"],
  ...
  },
  {
    ...
    "opts": ["A rescue boat must maintain at least 6 knots; an FRB must maintain at least 8 knots and have higher manoeuvrability", "A rescue boat is manually rowed; an FRB uses an outboard motor", "A rescue boat is inflatable; an FRB is always rigid GRP", "A rescue boat holds 6 people; an FRB holds 15 people"],
  ...
  },
  {
    ...
    "a": "5 minutes",
    "opts": ["10 minutes", "15 minutes", "2 minutes", "5 minutes"],
  ...
  },
  {
    ...
    "opts": ["Embarkation stations must be illuminated by emergency lighting that lights the ladder, lifeboat, and sea surface", "Lighting must only operate manually via a switch inside the lifeboat", "Lighting is only required if the ship operates in Arctic waters", "Embarkation stations must be lit by red LEDs to preserve night vision"],
  ...
  },
  {
    ...
    "opts": ["Automatically by a hydrostatic pressure switch at 2 meters depth", "By pulling a ripcord attached to the zipper", "Automatically when the suit enters the water via a saltwater-activated galvanic cell battery", "Manually by pressing a switch on the chest"],
  ...
  },
  {
    ...
    "opts": ["A dye-marker deployment test and a whistle volume test", "A 24-hour buoyancy retention test and a 5-second self-righting stability test", "A fire resistance test and a high-altitude drop test", "A thermal insulation test in 0\u00b0C water for 6 hours"],
  ...
  },
  {
    ...
    "a": "24V DC",
    "opts": ["24V DC", "220V AC", "110V AC", "12V DC"],
    "exp": "Lifeboat equipment operates on 24V DC, supplied by the onboard battery.",
    "cat": "Lifeboat",
    "id": "T21_056"
  },
  {
    ...
    "opts": ["10 continuous minutes of cranking", "3 consecutive cold starts with 10-second intervals", "6 consecutive cold starting attempts with 30-second intervals", "1 cold start at -20\u00b0C"],
  ...
  },
  {
    ...
    "opts": ["6 hours continuous operation, visible at 200m", "3 hours continuous operation, visible at 180m", "12 hours intermittent operation, visible at 50m", "1 hour continuous operation, visible at 100m"],
  ...
  },
  {
    ...
    "a": "9 GHz (X-band)",
    "opts": ["406 MHz", "3 GHz (S-band)", "9 GHz (X-band)", "156 MHz"],
  ...
  },
  {
    ...
    "a": "Inductive proximity sensor",
    "opts": ["Hydrostatic pressure switch", "Ultrasonic sensor", "Optical laser sensor", "Inductive proximity sensor"],
  ...
  },
  {
    ...
    "opts": ["Monitors drinking water tank levels", "Detects water pressure at 1-4m depth to activate the automatic release mechanism", "Controls the lifeboat bilge pump", "Measures the depth of the sea floor"],
  ...
  },
  {
    ...
    "opts": ["It releases the hooks while the full weight of the lifeboat is still on them", "It automatically lowers the lifeboat to the water", "It releases only when the boat is completely dry", "It releases only the forward hook"],
  ...
  },
  {
    ...
    "opts": ["Dropping the boat from 10 meters", "Normal launching from the davit head", "Resetting the hooks or emergency release requiring deliberate secondary action", "Releasing the painter line"],
  ...
  },
  {
    ...
    "a": "1.3 metres per second",
    "opts": ["1.3 metres per second", "0.5 metres per second", "1.0 metres per second", "2.5 metres per second"],
  ...
  },
  {
    ...
    "opts": ["The hook must release automatically at 5 meters", "The hook cannot support any load unless it is completely and correctly reset", "The hook must hold twice the lifeboat weight", "The hook must be made of titanium"],
  ...
  },
  {
    ...
    "opts": ["Natural ventilation louvres only", "An oxygen cylinder system", "Dedicated ventilation providing 5 m\u00b3/hr/person, independent of the engine", "Air conditioning maintaining 20\u00b0C"],
  ...
  },
  {
    ...
    "opts": ["To wash away chemical spills", "To cool the crew during hot weather", "To extinguish internal engine fires", "To allow the lifeboat to survive passing through burning oil on the sea surface"],
  ...
  },
  {
    ...
    "opts": ["Directly from the lifeboat engine crankshaft", "By a dedicated 24V electric motor", "By a compressed air bottle", "By a hand pump operated by the crew"],
  ...
  },
  {
    ...
    "opts": ["When the coxswain manually opens it after the boat is waterborne", "When the painter is pulled", "When internal temperature exceeds 50\u00b0C", "Automatically when the davit is lowered"],
  ...
  },
  {
    ...
    "opts": ["Drain and replace the engine oil", "Overhaul the fuel injectors", "Run the engine for 1 hour", "Start and run the engine for a minimum of 3 minutes"],
  ...
  },
  {
    ...
    "opts": ["Every 10 years regardless of condition", "If more than 5% of wires in any strand are broken or heavily corroded", "Only when it completely snaps", "After every lifeboat launch"],
  ...
  },
  {
    ...
    "opts": ["The charger plug must be disconnected", "It must be switched to 'boost' mode", "The voltage must be increased to 30V", "The battery must be removed"],
  ...
  },
  {
    ...
    "opts": ["The main engine alternator", "Solar panels on the boat deck", "The emergency source of electrical power (emergency switchboard)", "The lifeboat's internal 24V battery"],
  ...
  },
  {
    ...
    "opts": ["A GPS chartplotter", "No compass is required", "An illuminated magnetic compass", "A gyrocompass connected to the ship"],
  ...
  },
  {
    ...
    "opts": ["50 litres per square metre", "3-5 litres per square metre per minute", "0.1 litres per square metre", "100 gallons per minute total"],
  ...
  },
  {
    ...
    "opts": ["Maintain the electric fan motor, battery backup, and verify it operates independently", "Replace the CO2 scrubbers", "Design the ducting system", "Operate it continuously during normal voyages"],
  ...
  },
  {
    ...
    "opts": ["A hydraulic submersible pump", "A centrifugal ballast pump", "An electric or manual bilge pump", "An ejector pump driven by fire main"],
  ...
  },
  {
    ...
    "opts": ["A thermal overload relay", "A centrifugal governor", "A hydrostatic interlock", "An anemometer interlock"],
  ...
  },
  {
    ...
    "a": "Annually",
    "opts": ["Weekly", "Monthly", "Annually", "Every 5 years"],
  ...
  },
  {
    ...
    "opts": ["The boat must wait for shore assistance", "The lifeboat cannot be deployed", "The davit wire must be cut with a grinder", "The off-load release can be used as an emergency secondary release"],
  ...
  },
  {
    ...
    "opts": ["All nozzles spraying uniformly with no blockages", "The fresh water tank level", "The foam expansion ratio", "The fire alarm panel on the bridge"],
  ...
  },
  {
    ...
    "opts": ["The 24V DC lifeboat battery", "Dry cell AA batteries", "A wind-up generator", "The ship's 220V AC grid"],
  ...
  },
  {
    ...
    "opts": ["A full 10-hour capacity discharge test", "The specific gravity of all cells", "Trickle charger connection and correct charging status", "The on-load release mechanism"],
  ...
  },
  {
    ...
    "a": "CCA (Cold Cranking Amps)",
    "opts": ["Ah capacity", "Shelf life", "CCA (Cold Cranking Amps)", "Physical dimensions"],
  ...
  },
  {
    ...
    "opts": ["Cold Cranking Amps; amps delivered for 30 seconds at -18\u00b0C maintaining min 14.4V", "Capacity Charge Amps; maximum charging current", "Constant Current Amperes; continuous load at 25\u00b0C", "Cold Climate Application; operates at 0\u00b0C"],
  ...
  },
  {
    ...
    "a": "1.265\u20131.280",
    "opts": ["1.350\u20131.400", "1.120\u20131.150", "1.265\u20131.280", "1.190\u20131.210"],
  ...
  },
  {
    ...
    "a": "25.6\u201326.4V",
    "opts": ["24.0V exactly", "25.6\u201326.4V", "28.5\u201330.0V", "22.0\u201323.5V"],
  ...
  },
  {
    ...
    "opts": ["Connect positive first, then negative", "Sequence does not matter", "Connect negative first, then positive", "Connect both simultaneously"],
  ...
  },
  {
    ...
    "opts": ["By wind generators", "By solar panels", "By a continuously connected 24V trickle charger", "By daily engine runs"],
  ...
  },
  {
    ...
    "opts": ["Sulphuric acid", "Lead dioxide", "Lead sulphate (PbSO4)", "Spongy lead"],
  ...
  },
  {
    ...
    "opts": ["Hydrogen gas bubbles lower the density", "Acid evaporates", "Lead dissolves into the liquid", "Sulphuric acid is consumed and water is produced, diluting the electrolyte"],
  ...
  },
  {
    ...
    "a": "Hydrogen (H2)",
    "opts": ["Nitrogen Dioxide (NO2)", "Hydrogen (H2)", "Methane (CH4)", "Carbon Monoxide (CO)"],
  ...
  },
  {
    ...
    "a": "Distilled water only",
    "opts": ["Distilled water only", "Brine solution", "Sulphuric acid", "Tap water"],
  ...
  },
  {
    ...
    "opts": ["By performing a controlled discharge (load test) and timing it", "By checking open circuit voltage", "By reading the manufacturer label", "By measuring specific gravity"],
  ...
  },
  {
    ...
    "opts": ["Add sulphuric acid", "Install it immediately", "Discard the battery", "Perform an initial charge before installation"],
  ...
  },
  {
    ...
    "opts": ["Better cold weather performance and longer service life", "Produces no hydrogen gas", "Lighter weight", "Cheaper initial cost"],
  ...
  },
  {
    ...
    "opts": ["Boiling of the electrolyte", "Irreversible sulphation of the plates", "Thermal runaway", "Excessive hydrogen generation"],
  ...
  },
  {
    ...
    "opts": ["10 Amps", "5 Amps", "Less than 0.5A (trickle level)", "Zero Amps exactly"],
  ...
  },
  {
    ...
    "opts": ["100% strictly", "75% of its rated working pressure", "50% of its rated working pressure", "90% of its rated working pressure"],
  ...
  },
  {
    ...
    "opts": ["Industrial compressed air", "Breathing quality air (Class E)", "Nitrogen", "Pure oxygen"],
  ...
  },
  {
    ...
    "opts": ["Annually", "Every 2 years", "Typically every 5 years", "Every 10 years"],
  ...
  },
  {
    ...
    "a": "Within 3-6 months",
    "opts": ["Within 5 years", "Within 3-6 months", "Within 2 years", "Within 1 week"],
  ...
  },
  {
    ...
    "opts": ["10 minutes", "3 hours", "Minimum 30 minutes", "12 hours"],
  ...
  },
  {
    ...
    "opts": ["By diluting the acid", "By heating the battery to 25\u00b0C", "Using a correction formula (add or subtract 0.0007 per \u00b0C deviation from 25\u00b0C)", "It is not corrected"],
  ...
  },
  {
    ...
    "opts": ["It will cause an immediate explosion", "Minerals and chlorides will contaminate the electrolyte and destroy the plates", "It will increase the voltage too high", "It dissolves the plastic casing"],
  ...
  },
  {
    ...
    "a": "Hydrometer",
    "opts": ["Hydrometer", "Barometer", "Multimeter", "Megger"],
  ...
  },
  {
    ...
    "opts": ["WD-40", "Sulphuric acid", "Terminal grease or petroleum jelly", "Paint"],
  ...
  },
  {
    ...
    "opts": ["It reverses polarity", "It drops to zero", "It remains completely unaffected", "It increases significantly, reducing available current"],
  ...
  },
  {
    ...
    "opts": ["Failing an annual capacity test or voltage dropping below 10.5V during cranking", "A dusty casing", "A fully charged SG of 1.270", "Being older than 1 year"],
  ...
  },
  {
    ...
    "opts": ["To verify the color of the plastic", "To check for transit damage like cracked cases or electrolyte leaks", "To ensure the manual is included", "To check the brand logo"],
  ...
  },
  {
    ...
    "opts": ["Float mode / battery fully charged", "No battery connected", "Boost charging in progress", "Fault condition"],
  ...
  },
  {
    ...
    "opts": ["They are cheaper", "They are sealed, maintenance-free, and pose no electrolyte spill risk", "They use salt water instead of acid", "They last 50 years"],
  ...
  },
  {
    ...
    "opts": ["Radioactive emissions", "Toxic carbon monoxide", "High voltage AC shock", "Explosive hydrogen gas generation"],
  ...
  },
  {
    ...
    "a": "4% to 74% by volume",
    "opts": ["1% to 2%", "It is not explosive", "80% to 90%", "4% to 74% by volume"],
  ...
  },
  {
    ...
    "opts": ["Pressurized air supply", "Natural ventilation via portholes", "Continuous mechanical extraction ventilation exhausted directly to atmosphere", "Air conditioning recycling the air"],
  ...
  },
  {
    ...
    "opts": ["30 per hour", "60 per hour", "Minimum 6 (some classes require 12)", "1 per hour"],
  ...
  },
  {
    ...
    "opts": ["Inlet low, exhaust high", "Both on the floor", "Both on the ceiling", "Inlet high, exhaust low"],
  ...
  },
  {
    ...
    "opts": ["Open incandescent bulbs", "Battery-operated flashlights only", "Standard fluorescent tubes", "Explosion-protected (Ex e or Ex d) rated for Gas Group IIC"],
  ...
  },
  {
    ...
    "opts": ["To prevent pockets of hydrogen from becoming trapped", "To reduce fan noise", "To prevent water ingress", "To increase air speed"],
  ...
  },
  {
    ...
    "opts": ["A grounded steel plate", "A wooden pallet", "A corrosion-resistant acid drip tray", "A rubber shock absorber"],
  ...
  },
  {
    ...
    "a": "10\u00b0C to 30\u00b0C",
    "opts": ["10\u00b0C to 30\u00b0C", "0\u00b0C to 10\u00b0C", "40\u00b0C to 50\u00b0C", "-10\u00b0C to 0\u00b0C"],
  ...
  },
  {
    ...
    "opts": ["Rubber gloves, acid-resistant apron, and safety goggles", "Fall arrest harness", "Thermal immersion suit", "Welding mask and leather gloves"],
  ...
  },
  {
    ...
    "opts": ["A defibrillator", "A stretcher", "An eye-wash station or fresh water supply", "An oxygen resuscitator"],
  ...
  },
  {
    ...
    "opts": ["In the lowest part of the engine room", "Inside the main switchboard room", "Outside the main machinery space, above the bulkhead deck", "In the cargo hold"],
  ...
  },
  {
    ...
    "opts": ["The bilge high level alarm", "The ship's insulation monitoring system", "The fire alarm panel", "The Voyage Data Recorder"],
  ...
  },
  {
    ...
    "opts": ["They produce UV light that damages batteries", "They interfere with insulation monitoring", "They are not explosion-protected and can ignite hydrogen gas", "They draw too much power"],
  ...
  },
  {
    ...
    "opts": ["To ensure they are installed alphabetically", "To indicate the voltage rating", "To track individual cell voltage and specific gravity history in the maintenance log", "To identify the manufacturer"],
  ...
  },
  {
    ...
    "opts": ["It opens the door automatically", "It stops the charger from operating if the exhaust fan fails", "It increases fan speed when voltage drops", "It sounds a fire alarm"],
  ...
  },
  {
    ...
    "opts": ["Allowed in the designated corner", "Strictly no smoking and no naked flames", "Allowed only if the fan is on", "Allowed only for e-cigarettes"],
  ...
  },
  {
    ...
    "opts": ["Sparks from dropping the tool can ignite hydrogen gas", "They drain the battery voltage", "They rust quickly due to acid fumes", "They magnetize the battery plates"],
  ...
  },
  {
    ...
    "opts": ["The batteries will freeze", "Loss of battery capacity", "Accumulation of hydrogen gas to explosive levels", "Acid evaporation"],
  ...
  },
  {
    ...
    "a": "Water",
    "opts": ["Clean Agent", "Dry Powder", "CO2", "Water"],
  ...
  },
  {
    ...
    "opts": ["To record the ship's position", "To log crew working hours", "To inventory spare parts", "To record SG, OCV, and temperature to track battery health over time"],
  ...
  },
  {
    ...
    "opts": ["The acid turns to solid", "Its service life is drastically reduced", "It stops producing hydrogen", "Its capacity doubles"],
  ...
  },
  {
    ...
    "opts": ["It is the heaviest gas", "It only burns in pure oxygen", "It requires the lowest ignition energy of common flammable gases", "It is non-flammable"],
  ...
  },
  {
    ...
    "opts": ["Yes, if painted red", "No, it must run directly to the open atmosphere", "Yes, if fitted with filters", "Yes, to provide heating"],
  ...
  },
  {
    ...
    "opts": ["Ignite it to burn off", "Leave it to evaporate", "Wash it down the deck drain", "Neutralize with bicarbonate of soda and clean it up safely"],
  ...
  },
  {
    ...
    "opts": ["It emits much less gas under normal charging, but still requires ventilation", "It emits zero gas even when overcharged", "It requires no ventilation at all", "It absorbs oxygen from the room"],
  ...
  },
  {
    ...
    "opts": ["The copper terminals", "The electrolysis of water in the electrolyte during the final stages of charging", "The breakdown of the plastic casing", "The melting of the lead plates"],
  ...
  },
  {
    ...
    "opts": ["CE mark only", "Ex e or Ex d certification markings", "IP65 waterproof rating", "220V label"],
  ...
  },
  {
    ...
    "opts": ["Filling it with water", "Visual inspection for cracks or chemical degradation", "Painting it annually", "Measuring its resistance"],
  ...
  },
  {
    ...
    "opts": ["The number of crew onboard", "The color of the paint", "The ship's tonnage", "The volume and rate of hydrogen generation calculated for the space"],
  ...
  },
  {
    ...
    "opts": ["To transport cargo to shore", "To store extra lifejackets", "To serve as an inflatable survival craft when a lifeboat cannot be launched", "To act as a fender during mooring"],
  ...
  },
  {
    ...
    "opts": ["Shoot it from a designated cannon", "Inflate it on deck with a compressor, then lower it", "Lower it using the lifeboat davit", "Throw the canister overboard and pull the painter line to activate inflation"],
  ...
  },
  {
    ...
    "opts": ["Hull Rupture Unit", "Hydraulic Rescue Utility", "High Range UHF", "Hydrostatic Release Unit"],
  ...
  },
  {
    ...
    "a": "1.5 to 4 metres",
    "opts": ["50 metres", "0.1 to 0.5 metres", "10 to 15 metres", "1.5 to 4 metres"],
  ...
  },
  {
    ...
    "opts": ["The HRU knife directly punctures the cylinder", "An electronic timer goes off", "The sinking ship pulls the painter line taut, activating the CO2 cylinder", "Water entering the canister causes a chemical reaction"],
  ...
  },
  {
    ...
    "opts": ["The HRU re-attaches the strap", "The painter line breaks at a designed weak link, allowing the raft to float free", "The liferaft sinks with the ship", "The CO2 cylinder explodes"],
  ...
  },
  {
    ...
    "a": "2 years",
    "opts": ["10 years", "2 years", "1 year", "5 years"],
  ...
  },
  {
    ...
    "opts": ["Pack A is rigid; Pack B is inflatable", "Pack A is automatic; Pack B is manual", "Pack A is for ocean voyages (full equipment); Pack B is for coastal voyages (reduced equipment)", "Pack A holds 10 people; Pack B holds 20 people"],
  ...
  },
  {
    ...
    "a": "SOLAS Pack A",
    "opts": ["SOLAS Pack C", "SOLAS Pack B", "SOLAS Pack A", "No pack is required"],
  ...
  },
  {
    ...
    "opts": ["5.0 litres per person", "0.5 litres per person", "3.0 litres per person", "1.5 litres per person"],
  ...
  },
  {
    ...
    "opts": ["Drink it only if mixed with fresh water", "Drink it only after boiling", "Do not drink seawater under any circumstances", "Drink it freely to stay hydrated"],
  ...
  },
  {
    ...
    "opts": ["Sufficient for 10% of the persons the liferaft is permitted to accommodate, or 2, whichever is greater", "None are required", "Five total", "One for every person"],
  ...
  },
  {
    ...
    "a": "Annually",
    "opts": ["Every 6 months", "Every 2 years", "Every 5 years", "Annually"],
  ...
  },
  {
    ...
    "opts": ["To inflate the raft manually", "To remove water that enters the liferaft", "To pump drinking water from the sea", "To spray water on the canopy for cooling"],
  ...
  },
  {
    ...
    "opts": ["The fwd raft has Pack B, aft has Pack A", "The fwd raft is smaller", "They have the same SOLAS specifications, but the fwd raft provides escape for crew trapped far from the bridge", "The fwd raft does not have an HRU"],
  ...
  },
  {
    ...
    "opts": ["A manual hand pump", "A high-pressure CO2 and Nitrogen cylinder", "Chemical oxygen generators", "An electric air compressor"],
  ...
  },
  {
    ...
    "a": "30 seconds",
    "opts": ["5 seconds", "10 minutes", "5 minutes", "30 seconds"],
  ...
  },
  {
    ...
    "opts": ["50% of the crew on each side", "150% of the crew total", "Capable of accommodating 100% of the total persons onboard on EACH side of the ship", "Exactly 10 persons"],
  ...
  },
  {
    ...
    "opts": ["To provide stability and prevent the liferaft from capsizing in high winds", "To collect rainwater", "To store drinking water", "To act as an anchor"],
  ...
  },
  {
    ...
    "opts": ["Use the righting strap on the underside to flip it over", "Wait for the wind to flip it", "Abandon it and find another raft", "Puncture it to sink it"],
  ...
  },
  {
    ...
    "opts": ["It is stored below deck in a locker", "It is housed in a rigid, watertight GRP (Glass Reinforced Plastic) container", "It is wrapped in a canvas tarp", "It is kept in a vacuum-sealed plastic bag"],
  ...
  },
  {
    ...
    "opts": ["10,000 kJ per person", "1,000 kJ per person", "5,000 kJ per person", "50,000 kJ per person"],
  ...
  },
  {
    ...
    "opts": ["Yes, but only using a manual air pump", "Yes, during monthly drills", "Yes, annually", "No, it must only be activated during an emergency or by an approved service station"],
  ...
  },
  {
    ...
    "opts": ["2 meters", "Exactly 5 meters", "100 meters minimum", "Sufficient to reach the waterline at the ship's lightest seagoing condition plus 10 meters, minimum 15m total"],
  ...
  },
  {
    ...
    "opts": ["To puncture the raft if captured", "For self-defense", "To cut the painter line once passengers are boarded and the ship is sinking", "To open food cans"],
  ...
  },
  {
    ...
    "opts": ["The expiry date punched on the HRU casing has passed", "The painter line becomes frayed", "The pressure gauge shows low", "It starts leaking water"],
  ...
  },
  {
    ...
    "opts": ["Rain water cannot be collected", "Using plastic buckets", "By ringing out wet clothes", "Using the rainwater collection tubes on the canopy"],
  ...
  },
  {
    ...
    "opts": ["A sea anchor (drogue)", "The painter line", "The ballast bags", "A heavy metal anchor"],
  ...
  },
  {
    ...
    "a": "300 metres",
    "opts": ["300 metres", "1000 metres", "100 metres", "50 metres"],
  ...
  },
  {
    ...
    "opts": ["3 minutes", "40 seconds", "10 seconds", "1 minute"],
  ...
  },
  {
    ...
    "a": "1 minute",
    "opts": ["5 minutes", "3 minutes", "30 seconds", "1 minute"],
  ...
  },
  {
    ...
    "a": "Dense orange",
    "opts": ["White", "Red", "Black", "Dense orange"],
  ...
  },
  {
    ...
    "a": "3 minutes",
    "opts": ["5 minutes", "3 minutes", "1 minute", "10 minutes"],
  ...
  },
  {
    ...
    "opts": ["5 years", "3 years from the date of manufacture", "10 years", "1 year"],
  ...
  },
  {
    ...
    "opts": ["Collected by authorized shore-based disposal facilities", "Incinerated in the ship's incinerator", "Fired off during New Year celebrations", "Thrown overboard at sea"],
  ...
  },
  {
    ...
    "opts": ["It wastes valuable equipment", "The smoke pollutes the air", "They might fail to ignite", "It constitutes a false distress signal (Mayday) and triggers a search and rescue response"],
  ...
  },
  {
    ...
    "opts": ["Loose under the seats", "Attached to the outside of the hull", "Inside the first aid kit", "In a watertight container in the designated pyrotechnic locker"],
  ...
  },
  {
    ...
    "opts": ["To act as a harpoon", "To measure water depth", "To shoot down flares", "To shoot a rocket-propelled line to establish a physical connection with a rescuing vessel"],
  ...
  },
  {
    ...
    "opts": ["When a rescuing vessel or aircraft is in visual range", "To signal other crew members inside the ship", "As soon as the ship sinks", "Only during daytime"],
  ...
  },
  {
    ...
    "opts": ["Pointing at the rescuing ship", "At arm's length downwind", "Above the head upwind", "Inside the lifeboat canopy"],
  ...
  },
  {
    ...
    "opts": ["The water depth", "The wind direction and speed at the surface", "The number of survivors", "The location of the sinking ship"],
  ...
  },
  {
    ...
    "opts": ["Yes, they glow in the dark", "Yes, they emit a loud siren", "No, they are for daytime distress signaling", "Yes, they emit infrared heat"],
  ...
  },
  {
    ...
    "opts": ["Repainting the casing", "Weighing each flare", "Test firing one flare", "Inventory quantities and the expiry dates"],
  ...
  },
  {
    ...
    "opts": ["It can be kept as a spare", "It can be used for training", "It must be replaced immediately", "It is valid for 1 more year"],
  ...
  },
  {
    ...
    "a": "Up to 40 km",
    "opts": ["100 km", "5 km", "Up to 40 km", "15 km"],
  ...
  },
  {
    ...
    "opts": ["Buoyant orange smoke signal", "Line-throwing rocket", "Parachute flare", "Hand flare"],
  ...
  },
  {
    ...
    "a": "MARPOL Annex V",
    "opts": ["MARPOL Annex IV", "MARPOL Annex I", "MARPOL Annex V", "MARPOL Annex VI"],
  ...
  },
  {
    ...
    "a": "Bright red",
    "opts": ["Bright white", "Bright orange", "Bright red", "Bright yellow"],
  ...
  },
  {
    ...
    "opts": ["Open the casing to fix it", "Throw it into the lifeboat immediately", "Try to relight it with a lighter", "Hold it outboard over the water for at least 30 seconds before discarding"],
  ...
  },
  {
    ...
    "opts": ["To make them heavier", "To keep them from floating away", "To protect them from UV light only", "To protect the chemical compositions from moisture degradation"],
  ...
  },
  {
    ...
    "opts": ["No, they are only in Pack A", "Yes, but fewer than in a Pack A", "Yes, they only have smoke signals", "Yes, exactly the same amount as Pack A"],
  ...
  },
  {
    ...
    "opts": ["Directly at the water", "Slightly downwind, nearly vertical (e.g. 15 degrees off vertical)", "45 degrees upwind", "Horizontally towards the rescuer"],
  ...
  },
  {
    ...
    "opts": ["Hand flares", "White collision warning flares", "Parachute flares", "Buoyant smoke signals"],
  ...
  },
  {
    ...
    "opts": ["External Engine Breathing Duct", "Enclosed Entry Breathing Demand", "Emergency Escape Breathing Device", "Electronic Escape Beacon Device"],
  ...
  },
  {
    ...
    "opts": ["Underwater repairs", "Enclosed space entry for inspection", "Firefighting operations", "Escape from a space filled with smoke or toxic gases"],
  ...
  },
  {
    ...
    "a": "10 minutes",
    "opts": ["30 minutes", "5 minutes", "60 minutes", "10 minutes"],
    "exp": "SOLAS requires a minimum of 10 minutes of breathable air to traverse escape routes.",
    "cat": "EEBD/SCBA",
    "id": "T21_208"
  },
  {
    ...
    "a": "One person only",
    "opts": ["One person only", "Two people sharing the hood", "Depends on cylinder size", "Up to five people sequentially"],
  ...
  },
  {
    ...
    "opts": ["None are required in the engine room", "1 near the engine control room", "At least 2 in the space, plus 2 near the entry/exit points", "1 for every crew member"],
  ...
  },
  {
    ...
    "opts": ["Self-Contained Breathing Apparatus", "Standard Capacity Breathing Air", "Shipboard Casualty Breathing Aid", "Safety Control Breathing Air"],
  ...
  },
  {
    ...
    "a": "Minimum 30 minutes",
    "opts": ["15 minutes", "4 hours", "Minimum 30 minutes", "10 minutes"],
  ...
  },
  {
    ...
    "opts": ["Pressure must be at least 90% of rated working pressure", "The color of the cylinder", "The weight of the mask", "The temperature of the air"],
  ...
  },
  {
    ...
    "opts": ["At 100 bar", "When the cylinder is completely empty", "At 200 bar", "At approximately 50-55 bar (leaving roughly 5-10 minutes of air)"],
  ...
  },
  {
    ...
    "opts": ["EEBD is for firefighting; SCBA is for escape", "EEBD is for escape only (10 min); SCBA is for firefighting/rescue (30+ min)", "EEBD uses oxygen; SCBA uses nitrogen", "There is no difference"],
  ...
  },
  {
    ...
    "opts": ["An oxygen generator", "A dedicated breathing air compressor (Class E air)", "The main engine starting air compressor", "A standard workshop compressor"],
  ...
  },
  {
    ...
    "a": "Typically every 5 years",
    "opts": ["Every 2 years", "Annually", "Typically every 5 years", "Never"],
  ...
  },
  {
    ...
    "opts": ["To cool the wearer's face", "To make breathing harder", "To inflate the protective suit", "To ensure any leak in the mask pushes air out, preventing toxic gases from entering"],
  ...
  },
  {
    ...
    "opts": ["At least 2 escape routes, one of which must be a vertical trunk or ladder to the open deck", "1 route through the control room", "No specific requirement", "3 routes leading to the cargo hold"],
  ...
  },
  {
    ...
    "opts": ["Check the pressure gauge is in the green zone and the expiry date is valid", "Test breathing from the hood", "Wash the hood with soap", "Refill the cylinder"],
  ...
  },
  {
    ...
    "opts": ["5 minutes", "10 seconds", "Within approximately 30 seconds", "2 minutes"],
  ...
  },
  {
    ...
    "opts": ["It is completely opaque", "It is made of steel", "It has a built-in radio", "It is made of fire-resistant, transparent material to protect the face from radiant heat"],
  ...
  },
  {
    ...
    "opts": ["No, they are filled directly from a hose", "Yes, each SCBA set must have a spare cylinder", "No, cylinders are single-use", "Only if the ship has no compressor"],
  ...
  },
  {
    ...
    "opts": ["Yes, if the trip is shorter than 5 minutes", "No, they are strictly for emergency escape only", "Yes, for any enclosed space entry", "Yes, but only if two people go together"],
  ...
  },
  {
    ...
    "opts": ["The pressure gauge reads typically 200 to 300 bar", "A green light turns on", "The cylinder is warm", "The pressure gauge reads 10 bar"],
  ...
  },
  {
    ...
    "opts": ["Only the officers", "Only the engineering crew", "All seafarers onboard as part of safety familiarization", "Only the rescue boat crew"],
  ...
  },
  {
    ...
    "opts": ["By pressing an electronic test button", "By entering a smoke-filled room", "By listening to it constantly", "By closing the cylinder valve and venting the air until the whistle sounds"],
  ...
  },
  {
    ...
    "opts": ["Leave it on deck to air out", "Throw away the mask", "Put it back in the locker exactly as is", "Clean the mask, replace the cylinder with a full spare, and log the use"],
  ...
  },
  {
    ...
    "opts": ["The whistle sounds continuously", "The mask will not form a proper seal, compromising the positive pressure", "The cylinder drains twice as fast", "Nothing, it works perfectly"],
  ...
  },
  {
    ...
    "opts": ["Usually automatically when the hood is pulled from the bag or manually by a pin/valve", "By speaking loudly into the hood", "Only by a remote control on the bridge", "By blowing into a tube"],
  ...
  },
  {
    ...
    "opts": ["To drain condensation", "To recalibrate the gauge needle", "To ensure the cylinder has not leaked over time and remains full for an emergency", "To change the air inside"],
  ...
  },
  {
    ...
    "opts": ["Keep the hood on and hold breath", "Stop moving and wait for rescue", "Remove the hood to prevent suffocation and continue escaping", "Connect it to another EEBD"],
  ...
  },
  {
    ...
    "opts": ["Refilling the air only", "Repainting the cylinders", "Annual inspection, calibration of demand valves, and hydrostatic cylinder testing", "Washing the harness straps"],
  ...
  },
  {
    ...
    "a": "6 knots",
    "opts": ["15 knots", "3 knots", "6 knots", "8 knots"],
  ...
  },
  {
    ...
    "a": "8 knots",
    "opts": ["6 knots", "20 knots", "35 knots", "8 knots"],
  ...
  },
  {
    ...
    "a": "Maximum 5 minutes",
    "opts": ["2 minutes", "10 minutes", "Maximum 5 minutes", "30 minutes"],
  ...
  },
  {
    ...
    "opts": ["To protect against hypothermia in cold water", "To act as a diving suit", "To protect against fire", "To prevent shark attacks"],
  ...
  },
  {
    ...
    "a": "Within 2 minutes",
    "opts": ["Within 2 minutes", "30 seconds", "1 minute", "5 minutes"],
  ...
  {
    "q": "How is the survivor location light on an immersion suit activated?",
    "a": "Automatically via a saltwater-activated galvanic cell",
    "opts": ["Automatically via a saltwater-activated galvanic cell", "By voice command", "By pulling a ripcord", "By a manual switch"],
    "exp": "Seawater acts as an electrolyte, completing the circuit to turn on the light.",
    "cat": "Rescue Boat",
    "id": "T21_241"
  },
  {
    ...
    "opts": ["No standard exists", "Core temp stays > 30\u00b0C for 1 hour", "Core temperature must not drop more than 2\u00b0C (stay > 34\u00b0C) after 6 hours in 0-2\u00b0C water", "No temperature drop after 24 hours"],
  ...
  },
  {
    ...
    "opts": ["100-meter drop test", "Fire resistance test", "Acid resistance test", "24-hour buoyancy retention and 5-second self-righting stability test"],
  ...
  {
    "q": "What is the SOLAS regulation regarding embarkation ladder lighting?",
    "a": "Must be powered by the emergency switchboard and illuminate the ladder, boat, and sea",
    "opts": ["Must be powered by the emergency switchboard and illuminate the ladder, boat, and sea", "Only battery-operated flashlights allowed", "Lighting is optional", "Must be powered by solar panels"],
    "exp": "SOLAS III/11.7 ensures safe boarding during a blackout by mandating emergency lighting.",
    "cat": "Rescue Boat",
    "id": "T21_244"
  },
  {
  ...
  },
  {
    ...
    "opts": ["1 (Category I, float-free)", "2", "One in each lifeboat", "4"],
  ...
  },
  {
    ...
    "a": "48 hours",
    "opts": ["48 hours", "12 hours", "96 hours", "24 hours"],
  ...
  },
  {
    ...
    "opts": ["3", "1", "Minimum 2 (one per side)", "4"],
  ...
  },
  {
    ...
    "opts": ["12 hours total", "48 hours standby only", "96 hours in standby mode plus 8 hours continuous transmission", "24 hours transmit"],
  ...
  },
  {
    ...
    "opts": ["Passenger ships and some offshore vessels", "Bulk carriers", "Oil tankers", "Container ships"],
  ...
  },
  {
    ...
    "opts": ["10-20 flashes per minute", "50-70 flashes per minute", "100-120 flashes per minute", "Continuous beam (no flash)"],
  ...
  },
  {
    ...
    "opts": ["Never", "Monthly", "Typically every 3 years", "Annually"],
  ...
  },
  {
    ...
    "opts": ["Parachute flares only", "Sonar and radar", "Engine, painter line, bailer, and first aid kit", "Water desalination plant"],
  ...
  },
  {
    ...
    "opts": ["Conduct the 24-hour buoyancy test onboard", "Verify with the supplier that replacement lifejackets ordered are type-approved to the new standard", "Modify old lifejackets to meet the standard", "Throw away all pre-2026 lifejackets immediately"],
  ...
  },
  {
    ...
    "opts": ["5 nautical miles", "1 nautical mile", "0.5 nautical miles", "Minimum 2 nautical miles in clear dark conditions"],
  ...
  },
  {
    ...
    "opts": ["2 seated persons", "20 standing persons", "10 seated persons", "At least 5 seated persons and 1 lying down"],
  ...
  },
  {
    ...
    "a": "Within 5 minutes",
    "opts": ["Within 5 minutes", "Immediately via free-fall", "There is no time limit", "Within 15 minutes"],
  ...
  },
  {
    ...
    "opts": ["Gravity free-fall only", "3.0 m/s", "Capped at 1.3 metres per second", "0.5 m/s"],
  ...
  },
  {
    ...
    "opts": ["The whole body except the face", "Legs and arms only", "Only the torso", "The head only"],
  ...
  },
  {
    ...
    "opts": ["Yes, if the wearer can swim", "Only if the suit itself provides the required buoyancy (150 N) and is approved as a combined suit", "Yes, always", "No, never"],
  ...
  },
  {
    ...
    "a": "Typically 2 years",
    "opts": ["1 year", "5 years", "Typically 2 years", "10 years"],
  ...
  },
  {
    ...
    "opts": ["9 GHz radar band", "UHF Band", "Medium Frequency (MF)", "VHF Marine Band (156-174 MHz), particularly Channel 16"],
  ...
  },
  {
    ...
    "opts": ["150% of the passenger limit", "Only enough for the bridge crew", "One for every person onboard, plus additional for watchkeepers and remotely located persons", "Exactly 10 per ship"],
  ...
  },
  {
    ...
    "opts": ["By leaving it on continuously", "Using the self-test switch which briefly interacts with the ship's 9GHz radar", "By submerging it in water", "By dropping it from the bridge"],
  ...
  },
  {
    ...
    "opts": ["Solar panels", "The Emergency Generator or Transitional Battery Source", "The main engine", "The lifeboat batteries"],
