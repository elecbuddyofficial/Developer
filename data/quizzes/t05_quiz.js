window.loadQuizzes('T05_Transformers', [
  ...
  {
    "q": "If a surveyor asks 'Why is the core laminated?', what is the best technical answer?",
  ...
  {
    "q": "If a surveyor asks 'What happens internally when I switch on a load?', you say:",
  ...
  {
    "q": "If a surveyor asks 'Why not use an auto-transformer everywhere to save cost?', you reply:",
  ...
  {
    "q": "If a surveyor asks 'What happens if the wire to the ammeter breaks?', you answer:",
  ...
  {
    "q": "If a surveyor asks 'What protects an oil transformer from internal faults?', what is the primary answer?",
    "a": "Buchholz relay",
    "opts": [
      "Buchholz relay",
  ...
  {
    "q": "If a surveyor asks 'Why did the transformer oil fail the BDV test?', you say:",
  ...
  {
    "q": "If a surveyor asks 'What are the 4 main conditions for paralleling?', you say:",
