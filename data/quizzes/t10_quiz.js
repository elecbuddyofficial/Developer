window.loadQuizzes("T10_ICCP", [
  {
    ...
    "opts": ["High-voltage AC field repels corrosive ions in seawater", "External DC source makes hull cathodic by supplying electrons - prevents anodic corrosion dissolution", "Reactive zinc blocks dissolve sacrificially to protect hull", "Copper ions injected into seawater prevent biological attack"],
  ...
  },
  {
    ...
    "a": "-850 mV",
    "opts": ["-800 mV", "-850 mV", "-1100 mV", "+222 mV"],
  ...
  },
  {
    ...
    "a": "-800 mV (vs Ag/AgCl)",
    "opts": ["-750 mV", "-800 mV (vs Ag/AgCl)", "-850 mV", "-1050 mV"],
  ...
  },
  {
    ...
    "opts": ["MMO/Ti anodes rapidly dissolve and disintegrate", "Reference electrode reverses polarity - system shuts down", "Hydrogen evolution \u2192 paint cathodic disbondment + hydrogen embrittlement of high-strength steel", "Stray AC currents interfere with echo sounder and Doppler log"],
  ...
  },
  {
    ...
    "opts": ["MMO/Ti - supplies protective DC current to seawater", "Pure Zinc - sacrificial backup if main ICCP fails", "Ag/AgCl - measures hull-to-seawater electrochemical potential - feedback for automatic control", "Platinum - measures seawater temperature and salinity"],
  ...
  },
  {
    ...
    "opts": ["High DC voltage electrocutes dock workers on mooring wires", "Port authorities require minimum electrical load at berth", "Stray current flows through mooring wires into jetty steel - exits into seawater causing rapid jetty corrosion", "Marine growth accumulates faster with ICCP running in port"],
  ...
  },
  {
    ...
    "opts": ["Increases - warm seawater dilutes salt concentration", "Decreases - warm seawater has higher conductivity (lower resistance needs less voltage for same current)", "Drops to zero - corrosion stops naturally in warm water", "Reference electrode flips positive due to thermal inversion"],
  ...
  },
  {
    ...
    "opts": ["Reference electrodes failing and sending erratic signals", "Seawater temperature has dropped significantly", "MMO anodes physically shrinking", "Hull paint progressively abraded - more bare steel exposed - higher current needed to maintain -850 mV"],
  ...
  },
  {
    ...
    "opts": ["Replace all MMO/Ti anodes - fully consumed after 5 years", "Refill controller transformer-rectifier oil tank", "Replace Ag/AgCl reference electrodes - internal gel electrolyte depletes causing drift over ~2.5 years", "Repaint MMO anodes with anti-fouling coating"],
  ...
  },
  {
    ...
    "opts": ["Dry dock blocks crush anodes causing MSB short circuit", "ICCP drains emergency batteries while generators are off", "Without seawater electrolyte, energised anodes in air cause high-voltage arcing near flammable paint and solvents", "Reference electrodes shatter when exposed to dry air"],
  ...
  },
  {
    ...
    "opts": ["ICCP protects internal pipes; MGPS protects external hull from barnacles", "ICCP uses sacrificial copper anodes; MGPS uses permanent titanium anodes", "ICCP prevents external hull corrosion; MGPS prevents biological fouling inside internal seawater pipes and sea chests", "ICCP at 0.5V; MGPS at 50V to kill marine life"],
  ...
  },
  {
    ...
    "opts": ["MMO/Ti - inert, same as ICCP anodes", "Silver/Silver Chloride - measures biological concentration", "Copper (releases Cu2+ biocidal ions ~2 ppb) + Aluminium (protective coating on internal pipes)", "Zinc and Magnesium - alter seawater pH"],
  ...
  },
  {
    ...
    "opts": ["Acts as reference electrode measuring propeller voltage", "Scrapes marine growth from intermediate shaft", "Low-resistance bond shaft to hull (<1 \u03a9) - prevents bearing pitting from stray current arc discharge through oil film", "Discharges lightning strikes from main engine to seawater"],
  ...
  },
  {
    ...
    "opts": ["Bonding needs 440V supply; earthing is passive", "Bonding for HV only; earthing for LV only", "Bonding protects personnel from shock; earthing protects hull from rust", "Bonding equalises potential between metallic parts (prevents galvanic corrosion); earthing provides fault current path to trip protection"],
  ...
  },
  {
    ...
    "opts": ["Short circuit - anode touching hull directly", "Ship sailing through highly conductive tropical water", "Open circuit - severed cable, corroded junction box, or anode physically detached from hull", "Reference electrode depleted sending 0 mV signal"],
  ...
  },
  {
    ...
    "opts": ["Shut down entire ICCP to prevent hull explosion", "Send diver to replace electrode while underway", "Switch to manual mode - set conservative fixed current based on historical logbook values until drydock", "Bridge electrode terminals to force maximum voltage output"],
  ...
  },
  {
    ...
    "opts": ["Focuses current downward into seabed", "Protects titanium substrate from ice and tugboats", "Electrically isolates anode from hull steel - forces current through seawater path instead of direct short-circuit", "Acts as sacrificial barrier dissolving instead of anode"],
  ...
  },
  {
    ...
    "opts": ["In series - same current through every anode for uniform distribution", "Sequential timer circuit pulsing each anode individually to save power", "In parallel - failure of one anode/cable leaves all others operational", "Directly to 440V MSB through simple fuses without controller"],
  ...
  },
  {
    ...
    "opts": ["Required by SOLAS as grounding points during drydock welding", "Generate AC field scaring marine life from propeller", "Provide lubrication to rudder pintle bearings as they dissolve", "Passive backup for areas electrically shadowed from ICCP anodes, and when ICCP is switched off in port"],
  ...
  },
  {
    ...
    "a": "+0.222 V",
    "opts": ["+0.316 V (Cu/CuSO4)", "0 V (SHE by definition)", "+0.222 V", "-0.76 V (Zinc)"],
  ...
  },
  {
    ...
    "opts": ["0.5 to 1 mA/m\u00b2 for a painted hull, and 2 to 5 mA/m\u00b2 for bare steel", "5 to 10 mA/m\u00b2 for a painted hull, and 10 to 50 mA/m\u00b2 for bare steel", "50 to 100 mA/m\u00b2 for a painted hull, and exactly 50 mA/m\u00b2 for bare steel", "100 to 150 mA/m\u00b2 for a painted hull, and 500 to 1000 mA/m\u00b2 for bare steel"],
  ...
  },
  {
    ...
    "opts": ["-1100 mV relative to an Ag/AgCl reference electrode", "+222 mV relative to an Ag/AgCl reference electrode", "-850 mV relative to an Ag/AgCl reference electrode", "-500 mV relative to an Ag/AgCl reference electrode"],
  ...
  },
  {
    ...
    "opts": ["Pure electrolytic Copper and Aluminium", "High-purity Aluminium-Zinc-Indium alloy", "Carbon steel heavily coated with silver chloride gel", "Mixed Metal Oxide coated on a Titanium substrate (MMO/Ti) or Platinised Titanium"],
  ...
  },
  {
    ...
    "opts": ["0.5 to 4 Volts DC and 0.5 to 4 Amperes DC", "6 to 25 Volts DC and 5 to 100 Amperes DC", "50 to 100 Volts DC and 500 to 1000 Amperes DC", "110 to 220 Volts AC and 50 to 100 Amperes AC"],
  ...
  },
  {
    ...
    "opts": ["When they reach 25% consumption", "When they are more than 50% to 60% consumed", "Only when they are 100% completely dissolved", "When they are exactly 10% consumed"],
  ...
  },
  {
    ...
    "opts": ["To prevent aggressive stray current corrosion damage to the metal lock gates and canal infrastructure", "To prevent the high-voltage DC from interfering with the canal's electronic vessel tracking sensors", "Because the fresh water in the canals will cause the reference electrodes to permanently decalibrate", "Because the shallow water creates a short circuit that will immediately blow the ICCP controller fuses"],
  ...
  },
  {
    ...
    "opts": ["The output voltage will increase drastically to overcome the high resistance of warm water", "The output voltage will decrease because warmer seawater has higher electrical conductivity", "The reference electrode setpoint will automatically change from -850mV to -1100mV", "The output current will drop to zero because warm water requires no cathodic protection"],
  ...
  },
  {
    ...
    "opts": ["The DC current flows through unintended paths and causes accelerated anodic dissolution at the exact point where the current exits the jetty back into the seawater", "The current causes massive hydrogen embrittlement which shatters the jetty's concrete foundations", "The ICCP anodes emit chlorine gas which travels through the water and chemically attacks the jetty piles", "The current reverses the polarity of the ship's hull, turning the entire jetty into a massive protective cathode"],
  ...
  },
  {
    ...
    "opts": ["The system has been left ON; lack of seawater has broken the ionic circuit, creating an open circuit and arcing hazard", "The hull is experiencing severe over-protection and hydrogen evolution", "The reference electrodes have successfully and completely polarized the hull", "The transformer-rectifier has a short-circuited thyristor"],
  ...
  },
  {
    ...
    "opts": ["The Baltic Sea has higher salinity which coats the anodes in a highly resistive layer of salt crystals", "The Baltic Sea has significantly lower salinity (~8 ppt) than the North Sea (~35 ppt), resulting in higher seawater resistance", "The Baltic Sea contains high levels of dissolved oxygen which chemically neutralizes the ICCP current", "The North Sea's intense wave action mechanically assists the flow of electrons requiring less voltage"],
  ...
  },
  {
    ...
    "opts": ["Copper (most noble), Mild Steel (intermediate), Zinc (most active)", "Copper (most noble), Zinc (intermediate), Mild Steel (most active)", "Mild Steel (most noble), Zinc (intermediate), Copper (most active)", "Zinc (most noble), Copper (intermediate), Mild Steel (most active)"],
  ...
  },
  {
    ...
    "opts": ["To ensure the rotating bronze propeller receives ICCP protection current AND to safely shunt static spark discharges away from the main engine bearings", "To step down the high voltage from the alternator to a safe level before it reaches the propeller", "To measure the exact RPM of the shaft for the bridge wrong-way alarm system", "To act as a sacrificial anode that dissolves instead of the bronze propeller blades"],
  ...
  },
  {
    ...
    "opts": ["The MMO/Titanium anodes are dissolving and rapidly losing their surface area", "The reference electrodes are failing and falsely commanding maximum output", "The local seawater temperature is steadily dropping, causing permanent damage to the transformer", "The hull's protective paint coating is progressively breaking down, exposing more bare steel that demands more protective current"],
  ...
  },
  {
    ...
    "opts": ["Immediate melting of the MMO/Titanium impressed current anodes", "Boiling of the surrounding seawater which creates a cavitation vacuum around the propeller", "Rapid dissolution of the ship's steel hull into iron oxide", "Hydrogen gas evolution at the hull surface, causing blistering and disbondment of hull paint and hydrogen embrittlement of high-strength steel"],
  ...
  },
  {
    ...
    "opts": ["Friction from the water moving against the hull", "Marine organisms eating the steel", "The formation of a natural electrochemical galvanic cell", "The high pressure of deep ocean water"],
  ...
  },
  {
    ...
    "opts": ["It has a more positive potential and is protected", "It attracts oxygen and forms a protective barrier", "It neutralizes the saltwater", "It has a more negative potential and corrodes (iron dissolves)"],
  ...
  },
  {
    ...
    "opts": ["It has a more positive potential and is protected from corrosion", "It generates a high voltage shock", "It dissolves iron into the surrounding water", "It has a more negative potential and corrodes"],
  ...
  },
  {
    ...
    "a": "Fe \u2192 Fe\u00b2\u207a + 2e\u207b",
    "opts": ["O\u2082 + 2H\u2082O + 4e\u207b \u2192 4OH\u207b", "Cu \u2192 Cu\u00b2\u207a + 2e\u207b", "Fe \u2192 Fe\u00b2\u207a + 2e\u207b", "2H\u207a + 2e\u207b \u2192 H\u2082"],
  ...
  },
  {
    ...
    "a": "O\u2082 + 2H\u2082O + 4e\u207b \u2192 4OH\u207b",
    "opts": ["2H\u207a + 2e\u207b \u2192 H\u2082", "O\u2082 + 2H\u2082O + 4e\u207b \u2192 4OH\u207b", "Fe \u2192 Fe\u00b2\u207a + 2e\u207b", "Al \u2192 Al\u00b3\u207a + 3e\u207b"],
  ...
  },
  {
    ...
    "a": "~50 mS/cm",
    "opts": ["~50 mS/cm", "~500 mS/cm", "~1000 mS/cm", "~5 mS/cm"],
  ...
  },
  {
    ...
    "opts": ["The corrosion rate doubles for every 10\u00b0C rise in temperature", "Corrosion stops completely above 30\u00b0C", "The corrosion rate halves for every 10\u00b0C rise in temperature", "Temperature has no effect on corrosion"],
  ...
  },
  {
    ...
    "opts": ["The ICCP system", "Sacrificial anodes", "The hull paint coating", "The shaft earthing brush"],
  ...
  },
  {
    ...
    "opts": ["It drives the cathodic reaction; well-oxygenated surface waters are more corrosive", "It slows down corrosion by forming rust", "It breaks down the hull paint directly", "It neutralizes the saltwater electrolyte"],
  ...
  },
  {
    ...
    "opts": ["Coating the hull with an insulating layer of plastic", "Making the hull act as a massive anode", "Supplying electrons externally to force the entire hull to act as a cathode", "Heating the hull to evaporate seawater"],
  ...
  },
  {
    ...
    "opts": ["Stainless steel and Cast iron", "Copper and Brass", "Zinc alloy or Aluminium alloy", "Titanium and Platinum"],
  ...
  },
  {
    ...
    "opts": ["It uses very low voltages", "It requires no external power source or active controller to function", "It relies on the ship's AC generators", "It only works when the ship is stopped"],
  ...
  },
  {
    ...
    "opts": ["It dissolves (is consumed) into the seawater", "It transforms into pure titanium", "It absorbs oxygen and expands", "It becomes harder and stronger"],
  ...
  },
  {
    ...
    "opts": ["\u2013800 mV to \u20131000 mV (Ag/AgCl)", "\u20131500 mV to \u20132000 mV", "+500 mV to +800 mV", "0 mV to \u2013100 mV"],
  ...
  },
  {
    ...
    "opts": ["Every dry dock interval (approx. 2.5 to 5 years)", "Every 6 months", "They never need replacement", "Every month"],
  ...
  },
  {
    ...
    "opts": ["When it is 10% consumed", "When it is 50\u201370% consumed", "Only when it is 100% gone", "When it changes color to white"],
  ...
  },
  {
    ...
    "opts": ["It only works in fresh water", "It has no automatic control and its output cannot adjust to changing hull conditions", "It causes hydrogen embrittlement constantly", "It requires a massive transformer"],
  ...
  },
  {
    ...
    "opts": ["Very large crude carriers (VLCCs)", "Small vessels and confined areas (like thruster tunnels) inaccessible to ICCP current", "Vessels with massive AC power reserves", "Ships sailing exclusively in Arctic ice"],
  ...
  },
  {
    ...
    "opts": ["It is made of bronze/brass (noble) while the hull is steel (active), creating a strong galvanic cell", "It spins very fast, creating friction", "It runs at high AC voltage", "It is not painted, attracting marine growth"],
  ...
  },
  {
    ...
    "opts": ["It generates hydrogen gas under the paint", "It becomes electrically isolated from the seawater and stops providing protection", "It lasts longer and works better", "It dissolves the paint instantly"],
  ...
  },
  {
    ...
    "opts": ["No cost at all", "High capital cost initially, zero recurring costs", "High electricity costs for operation", "Low capital cost initially, but high recurring costs for anode replacement"],
  ...
  },
  {
    ...
    "opts": ["ICCP uses an external power supply and inert anodes; sacrificial uses galvanic potential and consumable anodes", "ICCP uses zinc; sacrificial uses titanium", "ICCP only works in port; sacrificial works at sea", "ICCP is passive; sacrificial is active"],
  ...
  },
  {
    ...
    "opts": ["No, they conflict and destroy the ICCP controller", "No, class rules forbid mixing both systems", "Yes, they are often used as supplementary protection in critical or shielded areas", "Yes, but only inside the engine room"],
  ...
  },
  {
    ...
    "opts": ["Zinc is harder than steel", "Zinc is more negative (more active) than steel, so it forces the steel to be the cathode", "Zinc is more positive (more noble) than steel", "Zinc is an electrical insulator"],
  ...
  },
  {
    ...
    "opts": ["Through the marine growth", "Through the air", "Through the seawater", "Through the metallic hull of the ship"],
  ...
  },
  {
    ...
    "opts": ["Through the seawater electrolyte", "Through the ship's AC wiring", "Through the rubber seals", "Through the steel hull"],
  ...
  },
  {
    ...
    "opts": ["It turns the seawater into fresh water", "It completely prevents corrosion", "It acts as a sacrificial anode", "It creates local potential differences on the surface, setting up micro-galvanic cells"],
  ...
  },
  {
    ...
    "opts": ["An external DC power supply", "An Electrolyte", "An Anode", "A Cathode"],
  ...
  },
  {
    ...
    "opts": ["Perfectly smooth and shiny", "Transformed into solid rust", "Pitted, reduced in size, and partially dissolved", "Covered in thick black soot"],
  ...
  },
  {
    ...
    "opts": ["No, because the electrolyte would be completely isolated from the steel", "No, because the paint acts as an anode", "Yes, because paint conducts electricity", "Yes, because oxygen permeates through solid paint"],
  ...
  },
  {
    ...
    "opts": ["A large battery bank", "A transformer-rectifier that converts AC to adjustable DC", "A set of high-voltage capacitors", "An AC frequency inverter"],
  ...
  },
  {
    ...
    "opts": ["0\u20135V DC and 0\u201310A", "220V AC and 50A", "440V DC and 1000A", "0\u201350V DC and 0\u2013100A"],
  ...
  },
  {
    ...
    "opts": ["High-carbon steel", "Pure Zinc", "Aluminium-Indium alloy", "Mixed Metal Oxide on a Titanium substrate (MMO/Ti)"],
  ...
  },
  {
    ...
    "opts": ["6 months", "5 years", "1-2 years", "20\u201325 years (virtually non-consumable)"],
  ...
  },
  {
    ...
    "opts": ["Flush with the hull, but electrically isolated using a fibreglass or HDPE housing", "Welded directly to the bare steel", "Hanging loosely on wires from the deck", "Inside the engine room bilge"],
  ...
  },
  {
    ...
    "opts": ["In series, to the positive DC terminal", "In series, to the AC supply", "In parallel, to the positive DC terminal", "In parallel, to the negative DC terminal"],
  ...
  },
  {
    ...
    "opts": ["The ship's steel hull", "The shore power earth", "The MMO/Ti anodes", "The reference electrode"],
  ...
  },
  {
    ...
    "opts": ["It automatically increases the DC output current", "It automatically decreases the DC output current", "It shuts down the system", "It sounds an over-protection alarm"],
  ...
  },
  {
    ...
    "opts": ["It reverses the polarity of the hull", "It increases the AC input voltage", "It automatically increases the DC output current", "It automatically decreases the DC output current"],
  ...
  },
  {
    ...
    "opts": ["It drops to zero", "It increases, because warm water causes more corrosion", "It remains exactly the same", "It decreases, because warm water has higher conductivity (lower resistance)"],
  ...
  },
  {
    ...
    "opts": ["It increases, because cold water has lower conductivity (higher resistance)", "It decreases, because cold water conducts better", "It reverses polarity", "It shuts down completely"],
  ...
  },
  {
    ...
    "opts": ["The anodes are dissolving", "The seawater is becoming saltier globally", "The hull paint gradually deteriorates, exposing more bare steel that requires more current to protect", "The controller transformer is wearing out"],
  ...
  },
  {
    ...
    "opts": ["A short circuit between anode and hull", "A failed reference electrode", "The hull is heavily over-protected", "An open circuit in the anode cable or junction box"],
  ...
  },
  {
    ...
    "opts": ["It must be completely switched off and isolated", "The reference electrode must be shorted", "The polarity must be reversed", "It must be turned up to maximum output"],
  ...
  },
  {
    ...
    "opts": ["A load capacity test at 100A", "A polarity reversal test", "A high-frequency AC impedance test", "A megger (insulation resistance) test; > 1 M\u03a9 is acceptable"],
  ...
  },
  {
    ...
    "opts": ["Switch on in manual mode at minimum output, verify readings, then switch to auto", "Reverse the polarity to clear the anodes", "Megger the live circuit", "Switch directly to auto mode at maximum output"],
  ...
  },
  {
    ...
    "opts": ["The percentage of bare steel exposed vs. painted surface", "The size of the main engine", "The age of the ICCP controller", "The number of reference electrodes"],
  ...
  },
  {
    ...
    "a": "4 to 8 anodes",
    "opts": ["4 to 8 anodes", "Over 100 anodes", "20 to 30 anodes", "1 or 2 anodes"],
  ...
  },
  {
    ...
    "opts": ["The system will trigger an under-protection alarm", "The anodes will short out", "The ICCP current output will be extremely high", "The ICCP current output will be unusually low because the fresh paint provides near-perfect coverage"],
  ...
  },
  {
    ...
    "opts": ["The transformer-rectifier design and internal current-limiting software", "The sacrificial anodes burning out", "The melting of the hull", "The size of the ship's generators"],
  ...
  },
  {
    ...
    "opts": ["The anode will fall off the ship", "The anode may short-circuit to the hull, drawing maximum current but providing no overall protection", "The hull will immediately dissolve", "The controller will switch to AC output"],
  ...
  },
  {
    ...
    "opts": ["The MMO/Ti anodes are dissolving", "A loose connection in the reference electrode circuit causing erratic feedback", "The ship is moving too fast", "The seawater temperature is fluctuating"],
  ...
  },
  {
    ...
    "opts": ["Salinity has absolutely no effect", "High salinity shuts down the system", "Low salinity (like the Baltic Sea) reduces conductivity, requiring higher output voltage", "Low salinity increases current demand"],
  ...
  },
  {
    ...
    "opts": ["Hull-to-seawater potential (in millivolts)", "Seawater temperature", "Ship speed", "Output current (in Amps)"],
  ...
  },
  {
    ...
    "opts": ["To avoid anchor damage", "To protect the ship's wake", "Because the water is colder there", "Because the bronze propeller and rudder create a massive current demand in this area"],
  ...
  },
  {
    ...
    "opts": ["The AC power has failed", "The hull is heavily corroded", "The measured potential is completely out of bounds, indicating a severed cable or dry electrode", "The ship is in fresh water"],
  ...
  },
  {
    ...
    "opts": ["Switch off the system entirely until dry dock", "Switch to manual mode and set a fixed output current based on historical logs", "Reverse the anode and cathode connections", "Bypass the reference electrode with a wire"],
  ...
  },
  {
    ...
    "opts": ["It prevents marine growth on the anode", "It forces the protective current to spread out evenly over the hull instead of concentrating locally", "It absorbs hydrogen gas", "It acts as a secondary sacrificial anode"],
  ...
  },
  {
    ...
    "opts": ["Yes, it is designed for battery operation", "No, it requires massive power from the main AC switchboard (220V/440V)", "Yes, but only in manual mode", "Yes, but it will drain the battery in 5 minutes"],
  ...
  },
  {
    ...
    "opts": ["The hull potential drops to \u20131500mV", "The controller explodes", "Output current spikes to maximum", "Output current drops to zero or near zero for that specific zone"],
  ...
  },
  {
    ...
    "opts": ["Metallic Grounding Protection Scheme", "Main Generator Power Supply", "Marine Growth Prevention System", "Marine Galvanic Protection System"],
  ...
  },
  {
    ...
    "opts": ["To prevent biological fouling (barnacles, mussels) inside sea chests and seawater pipes", "To purify drinking water", "To prevent corrosion on the external hull", "To filter solid debris from the ballast water"],
  ...
  },
  {
    ...
    "opts": ["Yes, it replaces the ICCP system", "Yes, but only the bow area", "No, it only protects internal seawater systems; ICCP protects the external hull", "Yes, by emitting copper into the surrounding ocean"],
  ...
  },
  {
    ...
    "a": "Copper",
    "opts": ["Zinc", "Copper", "Titanium", "Mixed Metal Oxide"],
  ...
  },
  {
    ...
    "opts": ["10% by volume", "Zero", "Approximately 2 parts per million (ppm)", "Approximately 2 parts per billion (ppb)"],
  ...
  },
  {
    ...
    "a": "Aluminium",
    "opts": ["Lead", "Aluminium", "Graphite", "Silver"],
  ...
  },
  {
    ...
    "a": "0.5\u20134V DC",
    "opts": ["110\u2013220V AC", "400\u2013600V DC", "24\u201350V DC", "0.5\u20134V DC"],
  ...
  },
  {
    ...
    "a": "0.5\u20134A",
    "opts": ["50\u2013100A", "0.5\u20134A", "200\u2013500A", "Microamps (\u00b5A)"],
  ...
  },
  {
    ...
    "opts": ["Lifetime of the vessel", "1 month", "20 to 25 years (non-consumable)", "1 to 3 years (it is consumable)"],
  ...
  },
  {
    ...
    "opts": ["Inside the main engine block", "Inside sea chests or cooling water inlet strainers", "Flush-mounted on the external hull", "On the propeller shaft"],
  ...
  },
  {
    ...
    "opts": ["MGPS does not use a reference electrode; it runs on a fixed or timer-based current", "MGPS requires much higher voltages", "MGPS must be switched off at sea", "MGPS runs on AC power"],
  ...
  },
  {
    ...
    "opts": ["The shore power earth", "The external hull", "The surrounding seawater pipework and sea chest casing", "The copper anode"],
  ...
  },
  {
    ...
    "opts": ["The ICCP system shuts down", "Bio-fouling blocks the pipes and heat exchangers, leading to overheating of the main engine and auxiliaries", "The propeller falls off", "The hull rusts immediately"],
  ...
  },
  {
    ...
    "opts": ["It kills all marine growth", "It has no effect", "It increases the risk significantly, as biological growth is much faster in warm water", "It decreases the risk"],
  ...
  },
  {
    ...
    "opts": ["Yes, they share the same control board", "Yes, they run in series with ICCP anodes", "No, MGPS runs directly off the 440V busbar without a controller", "No, MGPS has its own entirely separate controller panel"],
  ...
  },
  {
    ...
    "opts": ["Yes, it is highly toxic to all fish", "No, it is well below IMO environmental limits for discharge and dissipates rapidly", "Yes, it causes red tide", "No, because copper is actually a nutrient for barnacles"],
  ...
  },
  {
    ...
    "opts": ["After they form a hard shell", "The adult stage", "The egg stage", "The larval (microscopic) stage before they attach to surfaces"],
  ...
  },
  {
    ...
    "opts": ["Marine growth will accelerate", "The ICCP system will trip", "The copper anodes will be consumed far too rapidly and may fail before the next dry dock", "The pipes will melt"],
  ...
  },
  {
    ...
    "opts": ["Because it acts as an earth bond", "Because shallow, warm port waters have the highest concentration of bio-fouling organisms", "Because port state control requires it", "Because the main engine relies on it to stay warm"],
  ...
  },
  {
    ...
    "opts": ["No, because it requires the main engine to run", "No, powering the anodes in dry air causes overheating; only electrical continuity can be checked", "Yes, by spraying water on them", "Yes, it works better in air"],
  ...
  },
  {
    ...
    "a": "Kingstones",
    "opts": ["Butterfly chests", "Globe intakes", "Kingstones", "Gate valves"],
  ...
  },
  {
    ...
    "opts": ["By manually setting the current output on the panel based on the number of seawater pumps running", "By altering the AC voltage", "By turning valves in the engine room", "By changing the reference electrode setpoint"],
  ...
  },
  {
    ...
    "opts": ["The sea chest will flood", "Voltage will spike to maximum and current will drop to zero (open circuit)", "Current will spike to maximum", "The system will switch to the aluminium anode automatically"],
  ...
  },
  {
    ...
    "opts": ["They dissolve barnacle shells", "They increase seawater conductivity", "They create an anti-corrosion film on the inside of the steel/copper-nickel pipes", "They are highly toxic to sharks"],
  ...
  },
  {
    ...
    "opts": ["The anodes will freeze and shatter", "Bio-fouling is minimal, so the MGPS current can be set to a minimum to save anode life", "The system must run at maximum to stop ice forming", "The voltage must be doubled"],
  ...
  },
  {
    ...
    "opts": ["ICCP anodes are green, MGPS are red", "ICCP anodes are inside the engine, MGPS are on the hull", "They look exactly the same", "ICCP anodes are large plates mounted on the hull; MGPS anodes are cylindrical rods mounted inside pipes"],
  ...
  },
  {
    ...
    "opts": ["Visually inspects consumption and replaces the copper/aluminium rods", "Recharges them with a high-voltage pulse", "Paints them with anti-fouling paint", "Welds them permanently to the hull"],
  ...
  },
  {
    ...
    "opts": ["No, the voltage and current are internally contained and far too low to cause external stray currents", "Yes, it corrodes the jetty instantly", "Yes, it is even more dangerous", "Yes, if the sea chest is open"],
  ...
  },
  {
    ...
    "opts": ["Static electricity", "Pulsed high-frequency AC", "AC power directly", "DC power (rectified from the ship's AC supply)"],
  ...
  },
  {
    ...
    "opts": ["It causes an immediate explosion", "It makes the system work twice as well", "It protects the anode and extends its life", "It electrically isolates the anode, preventing it from dissolving and failing the system"],
  ...
  },
  {
    ...
    "opts": ["To connect the ship to the shore power earth", "To ensure all metallic parts are at the same potential, preventing bimetallic corrosion and ensuring uniform ICCP protection", "To act as a radio antenna", "To provide a path for lightning strikes"],
  ...
  },
  {
    ...
    "opts": ["Bonding is for AC, earthing is for DC", "Bonding has high resistance, earthing has low resistance", "There is no difference", "Bonding ensures equipotential for corrosion prevention (no normal current); Earthing provides safety for fault currents"],
  ...
  },
  {
    ...
    "a": "< 1 \u03a9",
    "opts": ["< 0.5 \u03a9", "Zero exactly", "> 1 M\u03a9", "< 1 \u03a9"],
  ...
  },
  {
    ...
    "opts": ["To act as a brake", "To measure shaft RPM", "To power the propeller", "To electrically bond the rotating propeller shaft to the hull, integrating the propeller into the ICCP circuit"],
  ...
  },
  {
    ...
    "opts": ["The ICCP system shorts out", "The shaft starts spinning in reverse", "The ship's engine stops", "The propeller becomes cathodically isolated and may suffer rapid galvanic corrosion"],
  ...
  },
  {
    ...
    "opts": ["By painting them the same color", "Using a flexible copper jumper cable connecting the rudder stock to the hull structure", "Through the hydraulic fluid", "It does not need bonding"],
  ...
  },
  {
    ...
    "opts": ["It must be turned up to maximum", "It must only protect the bow", "It must be switched to AC mode", "The ICCP must be switched OFF"],
  ...
  },
  {
    ...
    "opts": ["Accelerated metal dissolution caused by DC current leaking through unintended paths (like mooring lines to a jetty)", "Rusting of the anchor chain", "Corrosion caused by static electricity", "Corrosion from sea spray on deck"],
  ...
  },
  {
    ...
    "opts": ["1 Amp dissolves 1 gram per year", "It has no measurable effect", "10 Amps of stray DC current dissolves approximately 10 kg of steel per year", "100 Amps dissolves 1 kg per year"],
  ...
  },
  {
    ...
    "opts": ["Plastic water hoses", "The ship's radar beam", "VHF radio waves", "Mooring wire ropes, steel gangways, and shore power earth cables"],
  ...
  },
  {
    ...
    "opts": ["By fitting an insulating flange or galvanic isolator in the shore earth conductor", "By running it through a transformer", "By cutting the earth wire entirely", "By using wireless power transfer"],
  ...
  },
  {
    ...
    "opts": ["The anchor chain absorbs all the current", "There are no adjacent metallic structures or shore connections to create a stray current path", "The water is deeper", "The engine is stopped"],
  ...
  },
  {
    ...
    "opts": ["The ICCP controller will explode", "Port Authority claims against the ship owner for severe corrosion damage to the jetty and nearby vessels", "The ship will become magnetized", "The ship's battery will drain"],
  ...
  },
  {
    ...
    "opts": ["Logging the voltage every 5 minutes", "Logging the fuel consumed by ICCP", "Logging the exact time the ICCP was switched off on arrival and on after departure", "Logging the name of the port authority"],
  ...
  },
  {
    ...
    "opts": ["It has no restrictions", "It is switched to AC mode", "Consult class/manufacturer, but it is usually switched OFF due to close proximity to lock gates and structures", "It must be run at 200% capacity"],
  ...
  },
  {
    ...
    "opts": ["Supplementary sacrificial anodes mounted near the stern and the residual polarization of the hull", "The ship's generators", "The shore power supply", "Nothing, it rusts immediately"],
  ...
  },
  {
    ...
    "opts": ["Lubricate it heavily with heavy gear oil", "Remove it completely", "Paint it with anti-fouling paint", "Keep it clean, unpainted, and free of oil or grease to maintain < 1 \u03a9 resistance"],
  ...
  },
  {
    ...
    "opts": ["Wood", "Pure steel", "Teflon", "Silver-graphite or high-copper carbon for extremely low resistance"],
  ...
  },
  {
    ...
    "opts": ["The thruster motor will run backward", "The ICCP voltage will drop to zero", "The tunnel will fill with hydrogen", "The thruster casing may corrode rapidly despite the ICCP system running"],
  ...
  },
  {
    ...
    "opts": ["The presence of zinc", "The natural electrochemical potential difference between two dissimilar metals in an electrolyte", "High temperatures", "Friction between two metals"],
  ...
  },
  {
    ...
    "opts": ["Yes, it causes loud buzzing noises", "Yes, it turns the water red", "No, it often goes unnoticed until severe structural pitting or failure occurs", "Yes, it glows in the dark"],
  ...
  },
  {
    ...
    "opts": ["At the point where current enters the metal", "At the point where the positive DC current leaves the metal structure to enter the seawater", "Inside the ICCP controller", "On the shore power plug"],
  ...
  },
  {
    ...
    "opts": ["The color of the paint", "Brush length, spring tension, and slip ring cleanliness", "The software version of the controller", "Water pressure and temperature"],
  ...
  },
  {
    ...
    "opts": ["Bonding handles tiny millivolt currents to eliminate potential differences; earthing handles massive fault currents requiring lower resistance", "Bonding is for AC, earthing is for DC", "They are actually the same thing", "Bonding uses thinner wires"],
  ...
  },
  {
    ...
    "opts": ["The ship will turn in circles", "The rudder pintles and stock will suffer accelerated galvanic corrosion", "The steering gear motor will burn out", "The rudder will fall off immediately"],
  ...
  },
  {
    ...
    "opts": ["It cuts the wire with a switch", "It uses a transformer to step up voltage", "It uses back-to-back diodes to block low-voltage DC (stray current) while allowing high-voltage AC fault currents to pass", "It replaces the earth with a plastic rod"],
  ...
  },
  {
    ...
    "opts": ["The propeller dissolves instantly", "The ICCP system shuts down", "The propeller also drops to \u2013850 mV naturally", "The propeller potential remains positive (e.g. +300 mV), creating an 1150 mV battery that destroys nearby steel"],
  ...
  },
  {
    ...
    "opts": ["Yes, it electrocutes barnacles", "Yes, by heating the hull", "No, bonding actually encourages growth", "No, bonding only prevents galvanic corrosion; MGPS prevents biological growth"],
  ...
  },
  {
    ...
    "opts": ["The rudder moves constantly; a solid bar would snap from metal fatigue", "Solid bars are illegal", "Flexible cable conducts better", "Flexible cable is cheaper"],
  ...
  },
  {
    ...
    "opts": ["To continuously measure the electrochemical potential between the hull and seawater for controller feedback", "To kill marine growth", "To ground the ship to the ocean", "To supply the 100A protection current"],
  ...
  },
  {
    ...
    "opts": ["Mixed Metal Oxide", "Lead-Acid", "Pure Copper", "Ag/AgCl (Silver / Silver Chloride)"],
  ...
  },
  {
    ...
    "a": "+0.222 V",
    "opts": ["\u2013850 mV", "0.0 V", "\u20130.76 V", "+0.222 V"],
  ...
  },
  {
    ...
    "a": "Zinc (Zn)",
    "opts": ["Aluminium", "Zinc (Zn)", "Titanium", "Carbon"],
  ...
  },
  {
    ...
    "opts": ["It generates more current", "It is more stable, accurate, and has a longer life without drifting", "It kills barnacles", "It is much cheaper"],
  ...
  },
  {
    ...
    "opts": ["6 months", "10 years", "Approximately 2.5 years (replaced every dry dock)", "20 to 25 years"],
  ...
  },
  {
    ...
    "opts": ["Class rules forbid reusing them", "They get painted over inevitably", "The gel electrolyte depletes, causing potential drift that leads to incorrect controller output", "They melt in dry air"],
  ...
  },
  {
    ...
    "a": "\u2013800 mV (vs Ag/AgCl)",
    "opts": ["\u20131100 mV", "0 mV", "\u2013800 mV (vs Ag/AgCl)", "\u2013500 mV"],
  ...
  },
  {
    ...
    "a": "\u2013850 mV (vs Ag/AgCl)",
    "opts": ["\u2013850 mV (vs Ag/AgCl)", "\u20131100 mV", "\u2013500 mV", "0 mV"],
  ...
  },
  {
    ...
    "opts": ["Any negative number", "Exactly \u2013850 mV", "More negative than \u20131100 mV", "More positive than \u2013800 mV (e.g., \u2013700 mV)"],
  ...
  },
  {
    ...
    "opts": ["The reference electrode burns out", "Paint peeling off", "Hydrogen gas evolution", "Hull pitting and continuous anodic dissolution (corrosion)"],
  ...
  },
  {
    ...
    "opts": ["More negative than \u20131100 mV (e.g., \u20131200 mV)", "0 mV", "Exactly \u2013850 mV", "More positive than \u2013800 mV"],
  ...
  },
  {
    ...
    "opts": ["Oxygen gas evolution", "Hydrogen gas evolution at the hull surface (2H\u207a + 2e\u207b \u2192 H\u2082)", "Instant rust formation", "The controller fuse blows"],
  ...
  },
  {
    ...
    "opts": ["It makes the steel too heavy", "It melts the steel", "It causes barnacles to grow faster", "Hydrogen embrittlement of high-strength steel (propeller shafts, fasteners)"],
  ...
  },
  {
    ...
    "opts": ["The paint dissolves into the water", "The paint becomes harder and thicker", "The paint changes color to white", "Cathodic disbondment: alkaline conditions and gas bubbles destroy paint adhesion, causing blistering"],
  ...
  },
  {
    ...
    "opts": ["It decreases the DC output current", "It increases the DC output current to drive the hull more negative", "It shuts down immediately", "It reverses polarity"],
  ...
  },
  {
    ...
    "opts": ["It increases the DC output current", "It adds more salt to the water", "It decreases the DC output current to let the hull become more positive", "It triggers a fire alarm"],
  ...
  },
  {
    ...
    "opts": ["The controller exploding", "A sudden jump to +500 mV", "Output current dropping to absolute zero instantly", "A slow, gradual drift in potential readings over several months without hull changes"],
  ...
  },
  {
    ...
    "opts": ["A severed reference electrode cable or a physically smashed electrode", "The anodes need replacing", "Normal operation in fresh water", "The ship is moving too fast"],
  ...
  },
  {
    ...
    "opts": ["By meggering the electrode at 1000V", "By dropping a portable Ag/AgCl 'dive electrode' over the side and comparing its reading to the panel", "By diving under the ship and looking at it", "By smelling the water"],
  ...
  },
  {
    ...
    "opts": ["2 to 4 (e.g., port/stbd forward, port/stbd aft)", "One on every single anode", "10 to 20", "Only 1"],
  ...
  },
  {
    ...
    "opts": ["Above the waterline on the deck", "Inside the ballast tanks", "Below the waterline, flush-mounted in insulating housings, far enough away from anodes to avoid false readings", "Attached directly to the propeller blades"],
  ...
  },
  {
    ...
    "opts": ["It generates its own power", "It works perfectly", "It cannot contact the seawater electrolyte, reads 0 mV, and the system fails", "It reads \u20132000 mV and burns out the controller"],
  ...
  },
  {
    ...
    "opts": ["Reverse the polarity", "Switch the controller to Manual mode and set a conservative fixed current based on historical logs", "Switch off the ICCP completely", "Send a diver down immediately"],
  ...
  },
  {
    ...
    "opts": ["Because Zinc conducts AC current", "Because Zinc sits at a different base potential on the galvanic scale (\u20130.76V vs SHE)", "Because Zinc is heavier", "It doesn't; they use exactly the same setpoint"],
  ...
  },
  {
    ...
    "opts": ["Approximately +250 mV vs Zinc (or \u2013950 mV depending on meter calibration)", "\u20132000 mV", "0 mV", "\u2013850 mV exactly"],
  ...
  },
  {
    ...
    "opts": ["It turns into pure salt", "It becomes highly acidic (pH 1 to 2)", "It becomes highly alkaline (pH 12 to 14), which acts as a paint stripper", "It becomes perfectly neutral (pH 7)"],
  ...
  },
  {
    ...
    "opts": ["No, it requires dry dock or a specialist underwater diver operation to replace the hull penetration", "Yes, by resetting the software", "Yes, by welding a new one inside the engine room", "Yes, by pouring acid down the cable"],
  ...
  },
  {
    ...
    "opts": ["Its potential does not change or drift when small measuring currents flow through it", "It cannot be frozen", "It only works in fresh water", "It has no magnetic field"],
  ...
  },
  {
    ...
    "opts": ["The system would output maximum current", "The ship would become totally rust-proof", "The reference electrode would explode", "The controller would reduce output to near zero, causing severe under-protection and rapid hull corrosion"],
