window.loadQuizzes("T07_Control_PLC", [
  {
    ...
    "opts": ["Automatic Voltage Regulator (AVR)", "Autopilot heading control", "A timer-controlled fixed-speed pump", "Boiler steam pressure controller"],
  ...
  },
  {
    ...
    "opts": ["The output has no effect on the control action", "The output is continuously measured and fed back to minimize error (SP \u2212 PV)", "It operates on a fixed timed sequence without sensors", "It uses positive feedback to amplify deviation"],
  ...
  },
  {
    ...
    "opts": ["SP = Signal Pressure, PV = Proportional Value, MV = Measured Variable", "SP = Setpoint (desired value), PV = Process Variable (actual measured), MV = Manipulated Variable (controller output)", "SP = System Parameter, PV = Plant Value, MV = Maximum Voltage", "SP = Speed, PV = Pressure Variable, MV = Motor Voltage"],
  ...
  },
  {
    ...
    "opts": ["The rate at which error changes over time", "The accumulated error causing overshoot", "The permanent residual error that remains when the process stabilises", "The initial deviation of PV from SP at startup"],
  ...
  },
  {
    ...
    "a": "Integral (I) action",
    "opts": ["Proportional (P) action", "Integral (I) action", "Derivative (D) action", "Feedforward action"],
  ...
  },
  {
    ...
    "opts": ["D action cannot eliminate steady-state offset", "Temperature changes slowly and D action amplifies noise causing erratic valve hunting", "D action causes integral windup when valve is saturated", "D action reacts too slowly to temperature changes"],
  ...
  },
  {
    ...
    "opts": ["Proportional band too narrow causing rapid oscillations", "The integral term accumulates while output is saturated, causing massive overshoot when the limit is removed", "Derivative term freezes controller response due to noise", "Controller loses setpoint memory on power failure"],
  ...
  },
  {
    ...
    "opts": ["The time required for the integral to cancel offset", "The output change per unit time when error is constant", "The range of error over which controller output changes from 0% to 100%", "The gain multiplied by the error to give output"],
  ...
  },
  {
    ...
    "opts": ["Integral action is eliminating offset too slowly", "The setpoint has been set higher than system capacity", "Proportional gain too high (PB too narrow) or insufficient derivative damping", "The I/P converter is stuck at one pressure"],
  ...
  },
  {
    ...
    "opts": ["The outer (primary) controller", "The inner (secondary) controller", "Both controllers share valve control simultaneously", "A feedforward controller overrides both"],
  ...
  },
  {
    ...
    "opts": ["Outer: steam flow controller. Inner: HFO temperature controller", "Outer: steam pressure controller. Inner: fuel viscosity controller", "Outer: HFO temperature controller. Inner: steam flow controller", "Outer: fuel pump speed. Inner: HFO temperature controller"],
  ...
  },
  {
    ...
    "opts": ["Excessive offset from P-only drum level control", "Integral windup during low load conditions", "The swell and shrink effect where sudden steam demand makes drum level appear wrong", "Thermal shock on boiler tubes during cold start"],
  ...
  },
  {
    ...
    "opts": ["Steam pressure, fuel flow, and feedwater temperature", "Drum pressure, steam flow, and feedwater pump speed", "Steam flow (feedforward), feedwater flow (feedforward confirmation), drum water level (feedback trim)", "Drum level, steam temperature, and exhaust gas temperature"],
  ...
  },
  {
    ...
    "opts": ["Program execution \u2192 Input scan \u2192 Output scan", "Input scan \u2192 Output scan \u2192 Program execution", "Input scan \u2192 Program execution \u2192 Output scan \u2192 Housekeeping", "Housekeeping \u2192 Program execution \u2192 Input scan"],
  ...
  },
  {
    ...
    "opts": ["Tracks cumulative motor running hours for maintenance", "Forces the PLC to a safe/fault state if the scan cycle hangs or exceeds maximum time", "Delays output startup to prevent current surges", "Synchronizes PLC clock with the ship GPS time server"],
  ...
  },
  {
    ...
    "opts": ["EEPROM", "Flash memory", "RAM (Random Access Memory)", "ROM (Read-Only Memory)"],
  ...
  },
  {
    ...
    "opts": ["Passes power when its memory bit is 1 (TRUE)", "Passes power (logical continuity) when its memory bit is 0 (FALSE)", "Physically closes a hardware relay when rung goes TRUE", "Latches the output coil so it stays ON permanently"],
  ...
  },
  {
    ...
    "opts": ["TON (On-Delay Timer)", "TOF (Off-Delay Timer)", "RTO (Retentive On-Delay Timer)", "TP (Pulse Timer)"],
  ...
  },
  {
    ...
    "opts": ["Activates only while input rung is TRUE, turns off when FALSE", "Activates and stays ON even if the input rung goes FALSE - requires a separate RESET coil to deactivate", "Sets the timer preset value for the next scan cycle", "Forces all other coils in the same network to turn OFF"],
  ...
  },
  {
    ...
    "opts": ["Any device initiates communication at any time (Peer-to-Peer)", "Master/Slave architecture - slaves only respond when addressed by the Master", "Uses 4-20mA signals superimposed with digital frequencies (HART)", "Every device broadcasts its status continuously to all others"],
  ...
  },
  {
    ...
    "opts": ["Converts 3-15 psi pneumatic to 4-20 mA feedback (P/I converter)", "Isolates the PLC digital input from the analog transmitter", "Converts a 4-20 mA electronic signal into a 3-15 psi pneumatic signal", "Converts integral action into proportional action during transients"],
  ...
  },
  {
    ...
    "opts": ["They require less instrument air pressure than fail-open valves", "On loss of instrument air or signal, the spring closes the valve - stops fuel flow and prevents fire risk", "They open fully on signal loss to prevent engine fuel starvation", "They provide better linear flow for viscous HFO"],
  ...
  },
  {
    ...
    "opts": ["They cause only localised crew inconvenience", "Their failure causes performance degradation but no immediate safety hazard", "Their failure poses an immediate risk to human life, ship safety, or the environment", "They are exempt from cybersecurity compliance"],
  ...
  },
  {
    ...
    "opts": ["Connect directly using the OEM default password for fastest troubleshooting", "Temporarily disable the firewall to allow full administrative access", "Malware scan the laptop/USB, then provide explicit physical authorization (key-switch) before allowing connection", "Allow remote access over ship Wi-Fi to avoid physical port security issues"],
  ...
  },
  {
    ...
    "opts": ["Assess, Isolate, Defend, Mitigate, Restore", "Plan, Do, Check, Act, Improve", "Identify, Protect, Detect, Respond, Recover", "Prevent, Monitor, Alert, Isolate, Patch"],
  ...
  },
  {
    ...
    "opts": ["Handles only engine room alarms without control capabilities", "Combines alarm monitoring, process control, performance monitoring, and remote control in one networked system", "Strictly isolates cargo from propulsion control systems", "Serves as backup power supply for navigation equipment"],
  ...
  },
  {
    ...
    "opts": ["Automatically deploys firefighting foam if a sensor fails", "Overrides the VDR during blackouts", "Transmits prioritised alarms to bridge, ECR, and duty engineer's cabin automatically", "Physically bypasses manual valves on cooling systems"],
  ...
  },
  {
    ...
    "opts": ["FF uses strict master-slave architecture where slaves cannot initiate communication", "FF superimposes digital signal over a 4-20mA analog loop", "FF is a fully digital multi-drop network supporting peer-to-peer communication directly between devices", "FF operates exclusively on fiber optic cables"],
  ...
  },
  {
    ...
    "opts": ["To limit maximum loop current to 20mA preventing transmitter damage", "To filter electromagnetic interference from VFDs", "To convert the FSK current signal into minimum 1V voltage drop so the HART communicator can decode it", "To act as galvanic isolator between safe area and hazardous area"],
  ...
  },
  {
    ...
    "opts": ["Relay logic uses software contact representations", "Relay logic requires physical rewiring to change behaviour; ladder logic is modified through software only", "Relay logic is immune to mechanical wear unlike ladder logic", "Ladder logic requires physical relays for every contact"],
  ...
  },
  {
    ...
    "opts": ["Drives valve to OPEN stop and records 100% position", "Drives valve to CLOSED stop and records this as 0% (4mA) position", "Determines friction and hysteresis of the actuator", "Measures full travel time from closed to open"],
  ...
  },
  {
    ...
    "opts": ["Clears debris from valve seat", "Verifies 4-20mA signal matches DCS output", "Friction and hysteresis characteristics of the valve and actuator", "Tests the fail-safe spring return mechanism"],
  ...
  },
  {
    ...
    "opts": ["Single-wire RS-232 with common ground", "Two-wire differential RS-485 bus with 120-ohm termination resistors", "Cat6 Ethernet with PoE", "Coaxial BNC cables"],
  ...
  },
  {
    ...
    "opts": ["Executes real-time PLC logic for main engine", "Manages firewall between IT and OT networks", "Stores historical process data for trending, performance analysis, and incident investigation", "Translates Modbus RTU signals into Foundation Fieldbus protocol"],
  ...
  },
  {
    ...
    "opts": ["Every week as part of routine planned maintenance", "After replacing valve packing or servicing the actuator", "Whenever the ship changes from HFO to MGO", "Only when the 4-20mA control signal is lost"],
  ...
  },
  {
    ...
    "opts": ["The output has no effect on the control action and there is no feedback", "The output continuously corrects the input error", "It relies on negative feedback to remain stable", "It calculates the exact error between SP and PV"],
  ...
  },
  {
    ...
    "opts": ["An Automatic Voltage Regulator (AVR)", "A fixed-speed timer-controlled pump", "An autopilot heading controller", "A boiler pressure controller"],
  ...
  },
  {
    ...
    "opts": ["It ignores the setpoint and only monitors the manipulated variable", "It requires human intervention to close the loop", "The output is continuously measured and fed back to the controller to minimise error", "It operates strictly on time-based schedules"],
  ...
  },
  {
    ...
    "opts": ["Error = SP (Setpoint) - PV (Process Variable)", "Error = MV (Manipulated Variable) + SP (Setpoint)", "Error = SP (Setpoint) / PV (Process Variable)", "Error = PV (Process Variable) - MV (Manipulated Variable)"],
  ...
  },
  {
    ...
    "opts": ["Standard Pressure", "Setpoint (the desired target value)", "Static Position", "System Parameter"],
  ...
  },
  {
    ...
    "opts": ["Process Variable (the actual measured value)", "Pneumatic Volume", "Pressure Valve", "Proportional Value"],
  ...
  },
  {
    ...
    "opts": ["Manual Valve", "Measured Voltage", "Maximum Velocity", "Manipulated Variable (the controller's output adjustment)"],
  ...
  },
  {
    ...
    "a": "Negative feedback",
    "opts": ["Infinite feedback", "Positive feedback", "Neutral feedback", "Negative feedback"],
  ...
  },
  {
    ...
    "opts": ["It forces the error to zero too quickly", "It is only used for pneumatic valves", "It amplifies the deviation, making the system unstable", "It requires too much electrical power"],
  ...
  },
  {
    ...
    "opts": ["A timed deck light switch", "A manual sounding tape", "An Automatic Voltage Regulator (AVR)", "A fixed-pitch ventilation fan"],
  ...
  },
  {
    ...
    "opts": ["Closed loop control", "Manual override", "Open loop control", "Sequential logic"],
  ...
  },
  {
    ...
    "a": "Open loop control",
    "opts": ["PID control", "Open loop control", "Cascade control", "Closed loop control"],
  ...
  },
  {
    ...
    "opts": ["The MV increases to add more heat and reduce the error", "The MV decreases to cool the system", "The MV drops to zero instantly", "The MV remains constant"],
  ...
  },
  {
    ...
    "a": "Zero",
    "opts": ["Zero", "Equal to the Manipulated Variable", "Equal to the Setpoint", "100%"],
  ...
  },
  {
    ...
    "opts": ["It can automatically correct for unexpected process disturbances", "It operates much slower", "It is much cheaper to build", "It does not require any sensors"],
  ...
  },
  {
    ...
    "opts": ["It is more complex, expensive, and can potentially become unstable (oscillate)", "It uses less electrical power", "It requires a human operator at all times", "It cannot handle temperature control"],
  ...
  },
  {
    ...
    "opts": ["The Control Valve", "The Actuator", "The Setpoint Dial", "The Sensor / Transmitter"],
  ...
  },
  {
    ...
    "opts": ["The Display Screen", "The Feedback wire", "The Actuator / Control Valve", "The Sensor"],
  ...
  },
  {
    ...
    "opts": ["No, because it does not measure the output or use feedback", "Yes, to provide negative feedback", "Yes, but only for temperature", "Yes, to measure the exact error"],
  ...
  },
  {
    ...
    "opts": ["It compares the set heading (SP) against the gyrocompass reading (PV) and adjusts the rudder (MV)", "It locks the rudder at a fixed angle regardless of wind", "It steers the ship based on a timer", "It ignores the gyrocompass to save power"],
  ...
  },
  {
    ...
    "a": "Open loop control",
    "opts": ["PID control", "Closed loop control", "Cascade control", "Open loop control"],
  ...
  },
  {
    ...
    "opts": ["The actual steam pressure inside the boiler drum", "The desired 10 bar setpoint", "The fuel valve position", "The boiler water level"],
  ...
  },
  {
    ...
    "opts": ["The outside air temperature", "The cabin thermometer reading", "The passenger's thermostat dial setting", "The chilled water or steam valve position"],
  ...
  },
  {
    ...
    "opts": ["Yes, it uses negative feedback", "No, it will continue to output its fixed command", "Yes, if it has a PT100 sensor", "Yes, by opening the valve fully"],
  ...
  },
  {
    ...
    "opts": ["It creates a perfectly clear sound", "It mutes all background noise", "It acts as a low-pass filter", "It creates a loud, unstable screeching sound (oscillation)"],
  ...
  },
  {
    ...
    "opts": ["It uses a PID controller", "It has negative feedback", "It applies heat constantly regardless of the exact water temperature", "It measures the water level"],
  ...
  },
  {
    ...
    "opts": ["The controller loses the PV, assumes massive error, and usually drives the output to a dangerous extreme", "The setpoint drops to zero", "The valve locks in its exact current position", "The system automatically switches to open loop safely"],
  ...
  },
  {
    ...
    "opts": ["The pipe carrying the fluid", "The physical valve that opens and closes", "The logic unit that calculates the error and dictates the necessary corrective action", "The sensor that measures the fluid"],
  ...
  },
  {
    ...
    "opts": ["Because humans are machines", "Because manual valves have sensors built in", "Because the human operator provides the feedback, not the control system itself", "Because manual control is strictly negative feedback"],
  ...
  },
  {
    ...
    "opts": ["The future predicted error", "The accumulated past error", "The current magnitude of the error", "The rate of change of the error"],
  ...
  },
  {
    ...
    "opts": ["It is too slow to react", "It causes massive oscillations constantly", "It is overly sensitive to high-frequency noise", "It always leaves a steady-state offset (residual error)"],
  ...
  },
  {
    ...
    "opts": ["The time it takes for a valve to open", "The maximum overshoot of the system", "The noise generated by the derivative filter", "The permanent residual error that remains when a P-only controller stabilizes"],
  ...
  },
  {
    ...
    "opts": ["It divides the setpoint by the process variable", "It multiplies the error by a fixed constant", "It produces an output proportional to the accumulated sum of the error over time", "It measures the slope of the error curve"],
  ...
  },
  {
    ...
    "opts": ["It slows the system down to a halt", "It amplifies sensor noise", "It leaves a large offset", "It causes the system to overshoot the setpoint and oscillate"],
  ...
  },
  {
    ...
    "opts": ["When the controller runs out of memory", "When a process is limited (e.g., valve 100% open), the integral term keeps accumulating error, causing massive overshoot when the limit is removed", "When the derivative term amplifies noise", "When the proportional band is too wide"],
  ...
  },
  {
    ...
    "opts": ["By using anti-windup logic that clamps or pauses the integral accumulation when the output reaches 100% or 0%", "By lowering the setpoint to zero", "By removing the integral term completely", "By increasing the proportional gain"],
  ...
  },
  {
    ...
    "opts": ["The absolute value of the setpoint", "The rate of change of the error", "The accumulated sum of the error", "The magnitude of the error"],
  ...
  },
  {
    ...
    "opts": ["To speed up the integral windup", "To eliminate steady-state offset", "To provide damping and anticipate trends, reducing overshoot", "To increase the proportional band"],
  ...
  },
  {
    ...
    "opts": ["It slows down the initial response", "It is highly sensitive to high-frequency sensor noise, causing erratic output spikes", "It requires a massive amount of PLC memory", "It causes steady-state offset"],
  ...
  },
  {
    ...
    "opts": ["Derivative action cools the oil", "Temperature changes slowly naturally, so D action is unnecessary and would only amplify sensor noise", "Temperature changes too fast for D action", "Temperature has no rate of change"],
  ...
  },
  {
    ...
    "opts": ["PB is the square root of Kp", "There is no relationship between them", "They are inversely related: PB = (1 / Kp) x 100%", "They are directly proportional: PB = Kp"],
  ...
  },
  {
    ...
    "opts": ["The integral windup stops", "The controller reacts sluggishly to large errors", "The steady-state offset increases", "The controller reacts aggressively; a small error causes a massive output change, risking oscillation"],
  ...
  },
  {
    ...
    "a": "Zero",
    "opts": ["Equal to the Proportional term", "Increasing continuously", "Zero", "100%"],
  ...
  },
  {
    ...
    "opts": ["PD (Proportional + Derivative)", "I-only", "PI (Proportional + Integral)", "P-only"],
  ...
  },
  {
    ...
    "a": "Integral action",
    "opts": ["Integral action", "Feedforward action", "Proportional action", "Derivative action"],
  ...
  },
  {
    ...
    "opts": ["The maximum limit of the valve", "The random noise from the sensor", "The integral windup limit", "The manual reset or steady-state base output of the controller when error is zero"],
  ...
  },
  {
    ...
    "opts": ["Slow integral action; it takes a long time to eliminate the offset", "High derivative action", "Fast integral action; risks overshoot", "High proportional gain"],
  ...
  },
  {
    ...
    "opts": ["Low proportional gain", "Zero derivative action", "Fast, aggressive integral action; quickly eliminates offset but risks severe overshoot", "Slow integral action"],
  ...
  },
  {
    ...
    "opts": ["To increase the offset", "To prevent massive output spikes when the operator suddenly changes the Setpoint (SP)", "To stop the integral windup", "To make the valve open faster"],
  ...
  },
  {
    ...
    "a": "Integral (I)",
    "opts": ["Bias", "Derivative (D)", "Proportional (P)", "Integral (I)"],
  ...
  },
  {
    ...
    "a": "Proportional (P)",
    "opts": ["Proportional (P)", "Bias", "Derivative (D)", "Integral (I)"],
  ...
  },
  {
    ...
    "a": "Derivative (D)",
    "opts": ["Bias", "Integral (I)", "Derivative (D)", "Proportional (P)"],
  ...
  },
  {
    ...
    "a": "PI control",
    "opts": ["Derivative control only", "P control only", "PD control", "PI control"],
  ...
  },
  {
    ...
    "opts": ["It reverses direction", "The Integral output stops increasing and holds its current value to keep the valve in the correct position", "It continues to climb infinitely", "It drops immediately to zero"],
  ...
  },
  {
    ...
    "opts": ["The Proportional output drops to zero", "It holds its maximum value", "It locks at 50%", "It turns into derivative action"],
  ...
  },
  {
    ...
    "opts": ["It ignores the setpoint completely", "It reacts too aggressively to noise", "It leaves too much offset", "It responds too slowly to sudden changes and causes continuous oscillation"],
  ...
  },
  {
    ...
    "opts": ["Changing the physical size of the control valve", "Adjusting the Kp, Ki, and Kd gain values until the desired response is achieved", "Adding more sensors to the pipe", "Increasing the 24V supply voltage"],
  ...
  },
  {
    ...
    "opts": ["It removes oil from the fuel", "It removes high-frequency noise from the sensor signal before it hits the derivative math, preventing massive output spikes", "It stops the integral from winding up", "It increases the steady-state offset"],
  ...
  },
  {
    ...
    "opts": ["One controller operating two valves simultaneously", "Using two sensors averaged together for one controller", "Two controllers where the output of the primary (outer) controller acts as the setpoint for the secondary (inner) controller", "A backup controller taking over if the first one fails"],
  ...
  },
  {
    ...
    "opts": ["It is much cheaper and requires fewer sensors", "It works purely on open-loop principles", "It eliminates the need for PID tuning", "It corrects inner loop disturbances much faster, before they can affect the primary outer variable"],
  ...
  },
  {
    ...
    "opts": ["The manual override loop", "Both loops must operate at the exact same speed", "The primary (outer) loop", "The secondary (inner) loop"],
  ...
  },
  {
    ...
    "opts": ["The intermediate variable (e.g., Steam flow)", "The exact position of the valve stem", "The main process variable that ultimately needs to be controlled (e.g., Temperature)", "The ambient room pressure"],
  ...
  },
  {
    ...
    "opts": ["The main process sensor", "The setpoint of the outer controller", "The final control element (e.g., the control valve)", "The master PID gains"],
  ...
  },
  {
    ...
    "a": "Steam Temperature",
    "opts": ["Steam Flow", "Steam Temperature", "Feedwater Flow", "Fuel Pressure"],
  ...
  },
  {
    ...
    "opts": ["Steam Flow or Cooling Water Flow (Attemperator)", "Drum Level", "Exhaust Gas Oxygen", "Furnace Temperature"],
  ...
  },
  {
    ...
    "opts": ["The inner steam flow controller immediately opens the valve further to maintain flow, so the HFO temperature barely changes", "The system shuts down on low pressure", "The fuel flow is reversed", "The outer temperature controller closes the valve"],
  ...
  },
  {
    ...
    "opts": ["Two sensors, one controller, two valves", "One sensor, one controller, two valves", "Two sensors, two controllers, one valve", "One sensor, two controllers, one valve"],
  ...
  },
  {
    ...
    "opts": ["Pump Flow (or Pump Speed)", "Valve Position only", "Pump Temperature", "Ullage soundings"],
  ...
  },
  {
    ...
    "opts": ["It reacts too quickly and causes oscillations", "It must wait for the actual temperature to drop before it even knows there is a problem, causing a sluggish response", "It cannot control pneumatic valves", "It ignores the setpoint"],
  ...
  },
  {
    ...
    "opts": ["The system crashes immediately", "The primary controller takes direct control of the valve", "The secondary controller automatically resets", "The primary (outer) controller's output is ignored, and the operator directly controls the valve"],
  ...
  },
  {
    ...
    "opts": ["The process temperature", "The Setpoint (SP) of the Secondary (Inner) controller", "The physical control valve", "The instrument air supply"],
  ...
  },
  {
    ...
    "opts": ["The outer controller's setpoint", "The boiler feed pump", "The main process sensor", "The physical control valve or actuator"],
  ...
  },
  {
    ...
    "a": "Master",
    "opts": ["Actuator", "Slave", "Master", "Feedforward"],
  ...
  },
  {
    ...
    "a": "Slave",
    "opts": ["Primary", "Master", "Slave", "Integrator"],
  ...
  },
  {
    ...
    "opts": ["Neither, it is sequential logic", "Open loop for the master, closed loop for the slave", "Open loop", "Closed loop (it consists of two nested closed loops)"],
  ...
  },
  {
    ...
    "a": "The secondary (inner) loop",
    "opts": ["The secondary (inner) loop", "The primary (outer) loop", "It does not matter", "Both simultaneously"],
  ...
  },
  {
    ...
    "opts": ["Slow-changing variables like Temperature", "Chemical composition", "Massive variables like Ship Speed", "Fast-changing variables like Flow or Pressure"],
  ...
  },
  {
    ...
    "opts": ["Electrical current", "Slow-changing variables with high inertia, like Temperature or Level", "Valve position", "Fast-changing variables like Flow"],
  ...
  },
  {
    ...
    "opts": ["The valve locks fully open", "The outer loop takes over direct control automatically", "The inner controller ignores it", "The entire cascade loop fails and must be dropped to manual or single-loop mode"],
  ...
  },
  {
    ...
    "opts": ["The inner flow controller adjusts the valve as needed to achieve the exact flow requested, ignoring valve friction or non-linear flow curves", "It adds a physical spring to the valve", "It replaces pneumatic valves with electric ones", "It forces the valve to move strictly in 10% steps"],
  ...
  },
  {
    ...
    "opts": ["The outer loop must be 10 times faster", "The inner loop should be at least 3 to 5 times faster than the outer loop", "The inner loop is usually slower", "They must be exactly identical in speed"],
  ...
  },
  {
    ...
    "opts": ["The inner controller", "The final control valve", "The human operator or supervisory computer", "A random number generator"],
  ...
  },
  {
    ...
    "opts": ["To minimise the deviation of the main product quality (like temperature) from its target", "To increase the pressure drop", "To make the valve open faster", "To save electricity in the PLC"],
  ...
  },
  {
    ...
    "opts": ["The sensor gets confused by the pressure", "Less steam flows through the same valve opening, providing less heat transfer until the controller eventually notices the temp drop", "The HFO flow triples", "The valve automatically closes"],
  ...
  },
  {
    ...
    "opts": ["Yes, but only in open-loop mode", "No, PLCs only have enough memory for two", "Yes, complex processes can have three or more nested loops, though two is most common", "No, physics prohibits more than two"],
  ...
  },
  {
    ...
    "opts": ["The actual process temperature", "The PLC scan time", "The setpoint given by the operator", "Non-linearities, friction, and supply disturbances associated with the actuator and control medium"],
  ...
  },
  {
    ...
    "opts": ["Yes, but only for 10 minutes", "Yes, the outer loop will just control the valve directly", "No, PLCs force both to be manual simultaneously", "No, if the inner loop is in Manual, it ignores the outer loop's commands, breaking the cascade"],
  ...
  },
  {
    ...
    "opts": ["To ensure that switching between Manual and Cascade modes does not cause a sudden, violent jump in valve position", "To transfer fuel without spills", "To switch between 50Hz and 60Hz smoothly", "To prevent physical bumps against the valve"],
  ...
  },
  {
    ...
    "opts": ["Program Execution", "Input Scan: Read all physical inputs and store them in the Input Image Register", "Output Scan", "Housekeeping"],
  ...
  },
  {
    ...
    "opts": ["To the ROM", "To the Output Image Register in memory", "Directly to the physical relays in the field", "To the Watchdog Timer"],
  ...
  },
  {
    ...
    "opts": ["The PLC writes the values from the Output Image Register to the physical output modules", "It saves the program to a USB drive", "It resets the input register", "It reads the sensors again"],
  ...
  },
  {
    ...
    "opts": ["1 microsecond strictly", "1 to 5 seconds", "1 to 50 milliseconds", "10 to 20 minutes"],
  ...
  },
  {
    ...
    "opts": ["It counts the running hours of the main engine", "It delays the start of the program", "It monitors the battery voltage", "It forces the PLC into a safe state if the scan cycle hangs or crashes, preventing unknown output behavior"],
  ...
  },
  {
    ...
    "opts": ["RAM", "ROM (Read Only Memory)", "EEPROM", "SD Card"],
  ...
  },
  {
    ...
    "a": "RAM (Random Access Memory)",
    "opts": ["ROM", "EEPROM", "RAM (Random Access Memory)", "Flash memory"],
  ...
  },
  {
    ...
    "opts": ["To maintain power to the RAM during ship blackouts, preventing the loss of user programs and retentive data", "To power the screen display", "To keep the cooling fan running", "To power the output relays"],
  ...
  },
  {
    ...
    "opts": ["The PLC automatically rewrites the program from ROM", "Only the clock stops working", "The PLC runs on solar power", "The PLC loses its user program and process data, causing a total system failure upon reboot"],
  ...
  },
  {
    ...
    "opts": ["Cache memory", "Standard ROM", "EEPROM or Flash Memory", "Volatile RAM"],
  ...
  },
  {
    ...
    "opts": ["It drives heavy contactors directly", "It reads ON/OFF field signals (like switches) and provides electrical isolation (via optocouplers) to the CPU", "It converts 4-20mA to numbers", "It controls VFD speeds"],
  ...
  },
  {
    ...
    "opts": ["It reads ON/OFF limits", "It sends 0-10V to control valves", "It converts continuous field signals (like 4-20mA from pressure sensors) into digital numbers via an ADC", "It acts as a watchdog timer"],
  ...
  },
  {
    ...
    "opts": ["Digital Output (DO) module", "Communication module", "Analogue Output (AO) module", "Digital Input (DI) module"],
  ...
  },
  {
    ...
    "opts": ["It converts 220V to 24V", "It cools the other modules", "It executes the user program, handles memory, and manages the system clock and communications", "It connects directly to the ship's MSB"],
  ...
  },
  {
    ...
    "a": "24V DC",
    "opts": ["220V AC", "24V DC", "5V DC", "12V AC"],
  ...
  },
  {
    ...
    "opts": ["A Zener diode", "A heavy transformer", "A fast-acting fuse", "An Optocoupler on the I/O card"],
  ...
  },
  {
    ...
    "opts": ["Rebooting the CPU", "Writing to EEPROM", "Housekeeping (updating communications, kicking the watchdog, internal diagnostics)", "Closing the main breaker"],
  ...
  },
  {
    ...
    "opts": ["The physical switch physically moves to ON", "The PLC ignores the force and reads the real wire", "The entire rack reboots", "The PLC uses a '1' in the input image table for that address, regardless of the physical switch's actual state"],
  ...
  },
  {
    ...
    "opts": ["To double the voltage to 48V", "To ensure the PLC continues running seamlessly even if one power supply module fails", "To provide AC and DC power simultaneously", "To run the cooling fans faster"],
  ...
  },
  {
    ...
    "opts": ["Randomly based on interrupt priority", "Bottom to top, right to left", "Top to bottom, left to right", "All rungs simultaneously"],
  ...
  },
  {
    ...
    "opts": ["The PLC speeds up the processor clock", "The I/O cards catch on fire", "It skips the output scan entirely", "The watchdog timer times out, throwing a hardware fault and failing the PLC to a safe state"],
  ...
  },
  {
    ...
    "opts": ["Relay outputs are purely for high frequency PWM", "Transistor outputs wear out faster", "Relay outputs can handle higher currents and AC/DC voltages, but switch slower and wear out mechanically", "Relay outputs switch much faster"],
  ...
  },
  {
    ...
    "opts": ["To power the input cards", "To store the user program", "To exchange data with other PLCs, VFDs, or SCADA servers via fieldbus networks like Modbus or Profibus", "To connect directly to analog sensors"],
  ...
  },
  {
    ...
    "opts": ["A printed wiring diagram of the cabinet", "A block of RAM where the instantaneous 1 or 0 state of every physical input and output is stored for the scan cycle", "A graphical display on the HMI screen", "The ROM memory holding the firmware"],
  ...
  },
  {
    ...
    "opts": ["No, because the logic is using the frozen state from the Input Image Table captured during the Input Scan", "Yes, the output will chatter instantly", "No, because PLCs ignore limit switches", "Yes, the logic will immediately crash"],
  ...
  },
  {
    ...
    "opts": ["The program is erased from EEPROM", "Program execution halts and all outputs are forced to their default safe state (usually OFF)", "All outputs are forced ON", "The PLC continues running but ignores inputs"],
  ...
  },
  {
    ...
    "opts": ["A red 'SF' (System Fault) or 'ERR' LED lights up, and the 'RUN' LED goes out", "The 24V power supply sparks", "All green LEDs blink simultaneously", "The PLC emits a loud siren"],
  ...
  },
  {
    ...
    "opts": ["An IP address", "A single Boolean 1 or 0", "A string of text characters", "A 12-bit integer representing a 4-20mA pressure signal"],
  ...
  },
  {
    ...
    "opts": ["It is illegal to turn off the PLC", "The new battery won't charge otherwise", "If you remove the battery while power is OFF, the RAM immediately wipes and the program is lost", "The battery will explode if not under load"],
  ...
  },
  {
    ...
    "opts": ["It changes AC power to DC power", "It converts the CPU's internal digital numbers into continuous 4-20mA or 0-10V signals for an Analog Output module", "It converts 4-20mA signals into numbers", "It translates ladder logic into C++"],
  ...
  },
  {
    ...
    "opts": ["A graphical PLC programming language that visually resembles hardwired electrical relay logic diagrams", "A mechanical drawing of the ship's ladders", "A list of assembly-level instructions", "A text-based language using IF/THEN statements"],
  ...
  },
  {
    ...
    "opts": ["The physical walls of the panel", "The start and end of the scan cycle", "The input and output modules", "The power supply rails (Live and Neutral / 24V and 0V)"],
  ...
  },
  {
    ...
    "a": "A Rung",
    "opts": ["A Branch", "A Rail", "A Rung", "A Node"],
  ...
  },
  {
    ...
    "opts": ["It blocks power when its bit is 1", "It physically moves a switch in the field", "It is always closed", "It passes power (is TRUE) only when its corresponding memory bit is 1"],
  ...
  },
  {
    ...
    "opts": ["It passes power (is TRUE) only when its corresponding memory bit is 0", "It acts as a final output", "It randomly inverts signals", "It passes power when its bit is 1"],
  ...
  },
  {
    ...
    "opts": ["It stores integer values", "It counts the number of times it is activated", "It turns ON (bit=1) when the rung conditions preceding it are all TRUE, and turns OFF when they become FALSE", "It permanently latches ON until a reset command is given"],
  ...
  },
  {
    ...
    "opts": ["It turns ON when the rung is TRUE, and STAYS ON permanently even if the rung goes FALSE", "It turns off immediately", "It reverses the logic of the entire program", "It flashes on and off"],
  ...
  },
  {
    ...
    "opts": ["By pressing the emergency stop", "By turning the SET coil on again", "By rebooting the PLC", "By activating a corresponding RESET (Unlatch) coil linked to the same address"],
  ...
  },
  {
    ...
    "a": "AND Gate",
    "opts": ["XOR Gate", "NOT Gate", "OR Gate", "AND Gate"],
  ...
  },
  {
    ...
    "a": "OR Gate",
    "opts": ["OR Gate", "NAND Gate", "NOR Gate", "AND Gate"],
  ...
  },
  {
    ...
    "opts": ["Any one of the three conditions being TRUE will start the motor", "Only the Start Button needs to be pressed", "All three conditions must be TRUE simultaneously", "The inlet valve must be closed"],
  ...
  },
  {
    ...
    "opts": ["It runs faster than C++", "It takes up less memory", "It looks exactly like physical relay wiring diagrams, making it easy for marine electricians to read and troubleshoot", "It is the only language allowed by SOLAS"],
  ...
  },
  {
    ...
    "opts": ["Ladder Diagram (LD)", "Instruction List (IL)", "Function Block Diagram (FBD)", "Structured Text (ST)"],
  ...
  },
  {
    ...
    "opts": ["Sequential Function Chart (SFC)", "Structured Text (ST)", "Function Block Diagram (FBD)", "Ladder Diagram (LD)"],
  ...
  },
  {
    ...
    "opts": ["Ladder Diagram (LD)", "Sequential Function Chart (SFC)", "Structured Text (ST)", "Instruction List (IL)"],
  ...
  },
  {
    ...
    "opts": ["It requires constant software updates", "It is susceptible to viruses", "It cannot handle 24V DC", "To change the logic behaviour, you must physically rewire the panel and add new components"],
  ...
  },
  {
    ...
    "opts": ["The screen prints out error codes", "The program stops running to allow viewing", "Contacts and coils highlight/change color in real-time when power passes through them, allowing instant fault finding", "The screen shows a 3D model of the ship"],
  ...
  },
  {
    ...
    "opts": ["A SET coil", "A RESET coil", "Normally Open [ ] contact (because the physical NC switch provides continuous 24V = bit 1 = contact closes)", "Normally Closed [ / ] contact"],
  ...
  },
  {
    ...
    "opts": ["By using the 'Force' function to override the input bit to a '1' in the logic", "By hitting the reset button on the CPU", "By physically shorting the 220V bus", "By rewriting the whole program in C++"],
  ...
  },
  {
    ...
    "opts": ["It acts as an OR gate automatically", "Double-coil syndrome: The PLC will only execute the state of the LAST rung scanned, causing erratic behaviour", "The PLC compiles faster", "The voltage doubles at the physical output"],
  ...
  },
  {
    ...
    "opts": ["The rules for emergency generator starting", "The international standard for programmable logic controller programming languages", "The standard for marine ethernet cables", "The required voltage for marine switchboards"],
  ...
  },
  {
    ...
    "opts": ["It passes power for exactly one scan cycle when the input transitions from FALSE to TRUE", "It measures the temperature of the CPU", "It permanently latches the output", "It delays the output by 1 second"],
  ...
  },
  {
    ...
    "opts": ["It delays turning ON an output until the input has been continuously TRUE for the preset time", "It accumulates running hours across multiple starts", "It keeps an output ON for exactly 5 seconds", "It delays turning OFF an output"],
  ...
  },
  {
    ...
    "opts": ["The timer pauses and holds its value", "The timer resets its accumulated time to zero immediately, and the output stays OFF", "The output turns ON instantly", "The timer continues counting in the background"],
  ...
  },
  {
    ...
    "opts": ["Keeping a cooling fan running after the engine stops", "Ensuring an engine room ventilation fan runs for 5 minutes BEFORE allowing the lube oil pump to start", "Triggering a quick 2-second purge blast", "Counting the total running hours of a pump"],
  ...
  },
  {
    ...
    "opts": ["It delays turning the output ON", "It turns the output ON immediately with the input, but delays turning it OFF until after the input is removed", "It latches the output permanently OFF", "It counts downwards from 100 to 0"],
  ...
  },
  {
    ...
    "opts": ["At the exact moment the input signal transitions from ON to OFF", "When the input signal transitions from OFF to ON", "When the PLC is powered on", "When the output reaches its limit"],
  ...
  },
  {
    ...
    "opts": ["The timer ignores the input and finishes counting", "The timer resets its accumulated time to zero, and the output remains ON continuously", "The PLC throws a fault code", "The output immediately turns OFF"],
  ...
  },
  {
    ...
    "opts": ["Flashing a warning beacon", "Keeping an auxiliary cooling fan running for 10 minutes AFTER the main engine is stopped to dissipate residual heat", "Delaying the start of a heavy motor", "Tracking the maintenance schedule"],
  ...
  },
  {
    ...
    "opts": ["A timer that always resets to zero", "A timer that pulses continuously", "A timer that runs backwards", "A timer that accumulates time when the input is ON, and holds (retains) its value when the input goes OFF"],
  ...
  },
  {
    ...
    "opts": ["It resets automatically when the input drops", "It resets when the count reaches 100", "It must be cleared using a separate, specific RESET instruction triggered by another logic condition", "By removing the PLC battery"],
  ...
  },
  {
    ...
    "opts": ["Tracking the cumulative running hours of machinery for the Planned Maintenance System (PMS)", "Sounding a short alarm horn", "Delaying a motor start", "Pulsing a solenoid valve"],
  ...
  },
  {
    ...
    "opts": ["It counts the number of times a button is pressed", "It delays the output indefinitely", "It pulses the output ON and OFF continuously", "When triggered, it turns its output ON for an exact, fixed preset time, regardless of how long the input stays ON"],
  ...
  },
  {
    ...
    "opts": ["The timer freezes at 1 second", "The output remains ON for the full 5 seconds and then turns OFF", "The output turns OFF after 1 second", "The output latches permanently ON"],
  ...
  },
  {
    ...
    "opts": ["Count-Down: It decreases its value", "Current-Transformer-Unit: It measures amps", "Count-Time-Unit: It measures seconds", "Count-Up: It increments its accumulated value by 1 every time its input transitions from OFF to ON"],
  ...
  },
  {
    ...
    "opts": ["Constant-Time-Delay: It pauses logic", "Continuous-Track-Data: It records values", "Count-Up-Double: It counts by twos", "Count-Down: It decreases its value by 1 on each input pulse, usually activating an output when it hits zero"],
  ...
  },
  {
    ...
    "a": "CTU (Count Up)",
    "opts": ["TON (On-Delay Timer)", "CTU (Count Up)", "RTO (Retentive Timer)", "PID block"],
  ...
  },
  {
    ...
    "opts": ["It automatically counts up to 10 and then back to 0", "It counts time instead of events", "It multiplies the count by two", "It has two separate inputs: one increments the count and the other decrements the count"],
  ...
  },
  {
    ...
    "opts": ["The timer saves its value permanently to ROM", "The timer's accumulated value is lost, and it starts from zero on reboot", "The timer finishes its count on battery power", "The PLC explodes"],
  ...
  },
  {
    ...
    "opts": ["The duration of each 'tick' it counts (e.g., 0.1 seconds, 0.01 seconds)", "The maximum limit of the timer", "The physical battery powering the clock", "The time it takes to scan the ladder rung"],
  ...
  },
  {
    ...
    "opts": ["It is severely affected by the Swell/Shrink effect during rapid load changes, causing incorrect valve responses", "It cannot handle high pressures", "It requires too many sensors", "It uses too much electrical power"],
  ...
  },
  {
    ...
    "opts": ["When the feed pump injects too much water", "When steam demand suddenly increases, pressure drops, causing steam bubbles to expand rapidly and making the drum level APPEAR to rise", "When cold water causes the drum to physically expand", "When fuel combustion creates a shockwave"],
  ...
  },
  {
    ...
    "opts": ["When the feed valve closes entirely", "When the boiler cools down overnight", "When the hull contracts in cold water", "When steam demand drops, pressure rises, crushing steam bubbles and causing the drum level to instantly collapse, despite no water being lost"],
  ...
  },
  {
    ...
    "opts": ["Fuel Flow, Steam Pressure, and Exhaust Temp", "Steam Flow, Fuel Flow, and Air Flow", "Drum Level, Feed Pump RPM, and Feed Pressure", "Steam Flow, Feedwater Flow, and Drum Level"],
  ...
  },
  {
    ...
    "a": "Steam Flow",
    "opts": ["Feedwater Flow", "Steam Temperature", "Steam Flow", "Drum Level"],
  ...
  },
  {
    ...
    "opts": ["It acts as the primary feedback loop", "It is a feedforward confirmation signal, ensuring the amount of water entering exactly matches the steam leaving", "It prevents fuel overheating", "It trims the boiler pressure"],
  ...
  },
  {
    ...
    "opts": ["It is completely ignored", "It is the fastest acting element", "It acts as a slow feedback trim to correct any minor drift or inaccuracies over time", "It directly controls the feed pump speed"],
  ...
  },
  {
    ...
    "opts": ["It uses stronger metal in the drum", "It disables the feed pump completely", "The controller prioritizes the Steam Flow demand signal over the misleading Level signal during rapid load changes", "It injects chemicals to destroy the bubbles"],
  ...
  },
  {
    ...
    "opts": ["Ambient temperature", "200\u00b0C to 250\u00b0C", "120\u00b0C to 150\u00b0C (depending on fuel viscosity)", "50\u00b0C to 70\u00b0C"],
  ...
  },
  {
    ...
    "opts": ["PD (Proportional + Derivative)", "P-only", "Open Loop", "PI (Proportional + Integral)"],
  ...
  },
  {
    ...
    "opts": ["Fail Close (Air to Open - ATO)", "Fail Last Position", "Fail Open (Air to Close - ATC)", "Fail at 50%"],
  ...
  },
  {
    ...
    "opts": ["Fuel Flow", "Viscosity directly", "Cooling Water Flow", "Steam Flow (or steam pressure to the heater)"],
  ...
  },
  {
    ...
    "opts": ["Float switch", "PT100 RTD or Type K Thermocouple", "Capacitive probe", "Optical encoder"],
  ...
  },
  {
    ...
    "opts": ["A hydraulic ram", "An electric servo motor", "A variable frequency drive", "An I/P (Current to Pressure) converter controlling instrument air"],
  ...
  },
  {
    ...
    "opts": ["Auto-Start: It automatically starts a standby generator, synchronizes it, and connects it to share the load", "It slows down the main engine", "It trips the main breaker instantly", "It injects more fuel into the running generator"],
  ...
  },
  {
    ...
    "opts": ["Auto-Stop: It unloads and disconnects one generator, stopping it to save fuel and reduce engine wear", "It trips all non-essential loads", "It forces thrusters to run to consume power", "It lowers the bus voltage"],
  ...
  },
  {
    ...
    "opts": ["It starts the emergency generator", "Load Shedding: It instantly trips non-essential loads (like A/C and Galley) to protect the remaining generator from blacking out", "It increases the AVR voltage", "It trips all safety loads (Steering, Nav lights)"],
  ...
  },
  {
    ...
    "opts": ["Cargo pumps and winches", "Essential safety and navigation loads (Steering gear, Nav lights, GMDSS, Fire pump)", "Air conditioning and refrigeration", "Galley ovens and water heaters"],
  ...
  },
  {
    ...
    "opts": ["It shuts down the main engine to provide power", "It starts the thruster using battery power", "It limits the thruster to 10% speed permanently", "Heavy Consumer Interlock: It blocks the thruster start command, auto-starts another generator, and allows the start only when enough power is available"],
  ...
  },
  {
    ...
    "opts": ["10% to 20%", "95% to 100%", "70% to 80% of rated capacity", "40% to 50%"],
  ...
  },
  {
    ...
    "opts": ["Automatically restarting essential motors one-by-one with time delays to prevent overlapping starting currents from causing another blackout", "Sequentially restoring lights before pumps", "Running the emergency generator until shore power arrives", "Manually turning on every breaker simultaneously"],
  ...
  },
  {
    ...
    "opts": ["Air conditioning compressors", "Galley ventilation fans", "Seawater cooling pumps (to prevent the recovering main engine/auxiliaries from overheating)", "Fuel oil purifiers"],
  ...
  },
  {
    ...
    "opts": ["10 to 15 minutes", "1 hour", "30 seconds to 2 minutes", "0.1 to 1 second"],
  ...
  },
  {
    ...
    "opts": ["Main engines automatically reverse", "Main bus dies, Emergency Generator auto-starts and connects to the emergency bus within 45 seconds", "Ship transmits a continuous Mayday automatically", "PMS immediately restarts all cargo pumps"],
  ...
  },
  {
    ...
    "opts": ["Interlocked Actuator System", "Independent Action Sequence", "Internal Alarm Switch", "Integrated Automation System"],
  ...
  },
  {
    ...
    "opts": ["Installing cameras inside the cylinders", "Removing all engineers from the ship's crew", "Replacing diesel engines with electric batteries", "The ability to route critical engineering alarms directly to the bridge and duty engineer's cabin when the ECR is unmanned"],
  ...
  },
  {
    ...
    "opts": ["Translates instrument air into mechanical rotation", "Converts hydraulic pressure into electrical current", "Translates a 4-20mA electrical signal from a PLC into a proportional 3-15 psi pneumatic air signal to drive a valve", "Converts 220V AC into 24V DC"],
  ...
  },
  {
    ...
    "opts": ["0 psi", "100 psi", "3 psi (or 0.2 bar) - Minimum output", "15 psi (or 1.0 bar)"],
  ...
  },
  {
    ...
    "opts": ["100 psi", "15 psi (or 1.0 bar) - Maximum output", "3 psi", "0 psi"],
  ...
  },
  {
    ...
    "opts": ["It manually locks the valve in place during maintenance", "It compares the demanded 4-20mA position with the actual mechanical stem position, applying extra air as needed to overcome friction/hysteresis", "It filters oil out of the instrument air", "It acts as a silencer for exhaust air"],
  ...
  },
  {
    ...
    "opts": ["Air pressure is required to close the valve", "The valve locks in its last position on failure", "Air pressure is required to open the valve; if the air supply or electrical signal fails, a mechanical spring snaps the valve fully closed", "The valve opens 100% on failure"],
  ...
  },
  {
    ...
    "opts": ["Air pressure holds the valve closed; upon air/signal failure, a spring pushes the valve 100% open", "The valve must be manually turned to open", "The valve closes tightly to stop leaks", "Air pressure pushes the valve open"],
  ...
  },
  {
    ...
    "opts": ["By matching the color of the pipes", "Fail Close is mandated by law for every valve on a ship", "By checking which is cheaper to purchase", "By conducting a risk assessment to determine which physical position is safer for the overall ship process during a total power/air failure"],
  ...
  },
  {
    ...
    "opts": ["A type of 3-phase bridge rectifier", "A software program for drafting ladder logic", "A brand of main engine governor", "A highly advanced, intelligent electro-pneumatic valve positioner made by Siemens, incorporating digital calibration and HART/Profibus communication"],
  ...
  },
  {
    ...
    "opts": ["It tests the HART communication", "It measures the friction coefficient", "It checks for air leaks", "Initialization: The positioner fully opens and closes the valve to measure total mechanical travel/stroke"],
  ...
  },
  {
    ...
    "opts": ["Static friction", "Leakage rate", "Total stroke length", "Response Time: It measures how fast the valve physically moves up and down"],
  ...
  },
  {
    ...
    "opts": ["Disconnect the HART cable", "Ensure the internal transmission ratio switch is set to 90\u00b0 (or 33\u00b0 for short stroke)", "Fill the positioner with oil", "Change the voltage to 220V"],
  ...
  },
  {
    ...
    "opts": ["The built-in reverse polarity protection diode blocks current, the unit outputs 0 psi, and the valve drives to its fail-safe position", "It outputs 15 psi constantly", "The valve operates exactly in reverse", "The I/P coil burns out instantly"],
  ...
  },
  {
    ...
    "opts": ["A device that converts AC power to DC power", "A mechanical switch for turning on pumps", "A chip that translates a continuous analog signal (e.g., 4-20mA voltage drop) into a discrete digital number (e.g., 0 to 4095) for the PLC CPU", "A tool for converting pressure to current"],
  ...
  },
  {
    ...
    "a": "4096 steps (2^12)",
    "opts": ["256 steps", "4096 steps (2^12)", "65536 steps", "1024 steps"],
  ...
  },
  {
    ...
    "opts": ["Analog signals cannot be sampled digitally", "The sampling rate must be at least twice the highest frequency of the signal being measured to accurately recreate it", "The voltage must be halved before sampling", "The scan time must be exactly 10ms"],
  ...
  },
  {
    ...
    "opts": ["A fiber optic network for radar", "A single analog 4-20mA wire", "A wireless Bluetooth protocol", "A fully digital, two-wire, multi-drop network where devices receive power and communicate peer-to-peer at 31.25 kbps"],
  ...
  },
  {
    ...
    "opts": ["It uses wireless infrared beams", "It communicates via the ship's 440V power lines", "It superimposes a high-frequency (1.2/2.2 kHz) digital AC wave on top of standard analog 4-20mA DC wiring", "It requires a dedicated 6-core ethernet cable"],
  ...
  },
  {
    ...
    "opts": ["To act as an antenna for the signal", "To convert 4-20mA into 0-10mA", "It converts the tiny current fluctuations of the HART AC signal into a measurable 1-5V voltage drop that the handheld tool can read", "To limit the 24V supply and prevent fires"],
  ...
  },
  {
    ...
    "opts": ["A protocol for transmitting live video", "A peer-to-peer digital network for fast control", "An analog 4-20mA standard", "A simple, robust Master-Slave serial communication protocol widely used over RS485 wiring (9600-115200 bps)"],
  ...
  },
  {
    ...
    "opts": ["Modbus is wireless; FF requires cables", "Modbus is faster than FF", "FF only works on 440V AC", "Modbus is strictly Master-Slave (no direct sensor-to-sensor talk); FF allows Peer-to-Peer communication without a master"],
  ...
  },
  {
    ...
    "opts": ["A circuit where a momentary start signal pulls in a contactor, and an auxiliary NO contact on that contactor parallels the start button to keep it energized", "A physical padlock on a switchboard", "A timer that delays shutoff", "A circuit that reverses motor direction"],
  ...
  },
  {
    ...
    "opts": ["By pressing the START button a second time", "It automatically turns off after 10 minutes", "By pressing a Normally Closed (NC) STOP button wired in series, which breaks the power flow to the coil and drops the auxiliary contact", "By cutting power at the MSB"],
  ...
  },
  {
    ...
    "opts": ["To save battery power during a blackout", "To make the alarm bell ring louder", "To ensure a momentary puff of smoke or gas triggers an inescapable alarm that must be formally acknowledged and manually reset by an operator", "To automatically extinguish the fire"],
  ...
  },
  {
    ...
    "opts": ["It changes ship's 440V AC to 24V DC", "It translates Modbus into Ethernet", "It powers the I/P converter", "It converts a 4-20mA analog sensor current into a 1-5V DC voltage drop for input cards that only read voltage"],
