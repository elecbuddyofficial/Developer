window.loadQuizzes("T08_Electronics", [
  {
    ...
    "a": "0.5\u20130.7V",
    "opts": ["0V in both directions", "0.5\u20130.7V", "OL (Open Loop)", "1.2\u20131.5V"],
  ...
  },
  {
    ...
    "opts": ["Amplifies low-level sensor signals", "Operates in reverse breakdown to maintain a stable reference voltage", "Converts AC to DC through high-frequency switching", "Isolates PLC logic from high-voltage surges using light"],
  ...
  },
  {
    ...
    "opts": ["Adding trivalent impurity atoms like boron \u2014 creates holes", "Adding pentavalent impurity atoms (e.g. phosphorus) to pure silicon \u2014 provides free electrons", "Removing all impurities to create perfectly crystalline silicon", "Heating silicon until covalent bonds break and release holes"],
  ...
  },
  {
    ...
    "opts": ["Near 0V in both forward and reverse bias", "0.6V forward, OL reverse (normal healthy reading)", "OL in both directions (open circuit)", "Exactly 3.3V in reverse bias only"],
  ...
  },
  {
    ...
    "opts": ["BJT handles higher frequencies than MOSFET", "BJT is immune to secondary breakdown; MOSFET is susceptible", "BJT uses an insulated gate drawing zero current", "BJT is current-controlled (needs base current); MOSFET is voltage-controlled (no gate current)"],
  ...
  },
  {
    ...
    "a": "Saturation region",
    "opts": ["Saturation region", "Cutoff region", "Active (linear) region", "Avalanche region"],
  ...
  },
  {
    ...
    "opts": ["SCRs switch faster than IGBTs at high frequencies", "IGBTs can be turned OFF by removing gate voltage; SCRs latch ON and require current to drop to zero", "SCRs have lower on-state losses than IGBTs", "IGBTs cannot handle the high voltages in VFD applications"],
  ...
  },
  {
    ...
    "opts": ["It stays ON only while gate pulse is applied", "It latches ON completely \u2014 the gate loses all control until main current drops below holding current", "It turns OFF if gate voltage is reversed to negative", "It oscillates to convert DC to AC output"],
  ...
  },
  {
    ...
    "opts": ["Accelerates turn-on \u2014 gives higher average voltage", "Increases output AC frequency without changing voltage", "Delays turn-on in the AC cycle \u2014 decreases average output voltage and reduces motor starting torque", "Reverses phase sequence to brake the motor"],
  ...
  },
  {
    ...
    "opts": ["A reverse voltage pulse from a capacitor turns it off (forced commutation)", "Removing the gate signal turns it off", "The AC supply current crosses zero each half-cycle, dropping below holding current and turning off the SCR", "The SCR has an insulated gate to cleanly chop AC waveform"],
  ...
  },
  {
    ...
    "a": "4 diodes",
    "opts": ["1 diode", "2 diodes", "4 diodes", "6 diodes"],
  ...
  },
  {
    ...
    "opts": ["Half-wave single-phase \u2014 121% ripple", "Single-phase full-wave bridge \u2014 48% ripple", "3-phase bridge rectifier with 6 diodes \u2014 ripple factor ~4.2%", "Centre-tap with 2 diodes \u2014 48% ripple"],
  ...
  },
  {
    ...
    "opts": ["Burns excess voltage as heat using series-pass transistor \u2014 no transformer needed", "Uses heavy 50Hz iron-core transformers to filter EMI naturally", "Switches DC at high frequencies (20kHz\u20131MHz) allowing tiny high-frequency transformer instead of large 50Hz transformer", "Uses mechanical commutators to chop 440V AC into 24V DC"],
  ...
  },
  {
    ...
    "opts": ["Amplifies gate signal to increase switching speed", "Filters 50Hz AC ripple from the DC supply", "Provides a current path for the collapsing magnetic field energy when the switch opens \u2014 prevents voltage spike", "Acts as a short circuit to test relay coil integrity"],
  ...
  },
  {
    ...
    "opts": ["0mA at 0% and 20mA at 100%", "4mA at 0% (live zero) and 20mA at 100% of range", "0mA at 0% and 24mA at 100%", "2mA at 0% and 22mA at 100%"],
  ...
  },
  {
    ...
    "opts": ["Process variable has dropped to below minimum range", "Open circuit \u2014 broken wire or failed transmitter \u2014 not a valid process reading", "Signal is being amplified by the I/P converter in the panel", "Zener barrier has clamped the signal to zero for safety"],
  ...
  },
  {
    ...
    "opts": ["10V \u00f7 8 steps = 1.25V per step", "10V \u00f7 256 steps = 39.06mV per step", "10V \u00f7 1024 steps = 9.77mV per step", "10V \u00f7 16 steps = 625mV per step"],
  ...
  },
  {
    ...
    "opts": ["To amplify the input signal to full ADC range", "To remove DC offset from the sensor signal", "To remove frequency components above the Nyquist frequency that would cause false readings", "To convert the sensor signal from current to voltage before digitising"],
  ...
  },
  {
    ...
    "opts": ["Directly converts 440V AC input to variable frequency AC in one step", "Steps up the DC bus voltage before it reaches the motor", "Varies the on/off time ratio of the inverter IGBTs to synthesise a variable-frequency AC output from DC", "Filters harmonic currents back into the supply grid"],
  ...
  },
  {
    ...
    "opts": ["The half-controlled bridge produces lower harmonic distortion", "It can generate higher output voltages than a fully-controlled bridge", "The half-controlled bridge allows faster braking by allowing freewheeling, reducing firing circuit complexity", "It provides regenerative braking capability back to the supply"],
  ...
  },
  {
    ...
    "opts": ["It converts AC ripple from the rectifier into pure DC by filtering high-frequency harmonics", "It limits the maximum forward current through the motor armature during starting", "It provides a path for the collapsing magnetic field's reverse EMF when the coil is de-energised, preventing the high voltage spike from destroying switching transistors or contactors", "It blocks reverse polarity connection of the DC motor in case the battery terminals are reversed"],
  ...
  },
  {
    ...
    "opts": ["12 diodes in a full-wave bridge. Output ripple = 12 times the supply frequency (600 Hz)", "4 diodes in a standard bridge. Output ripple = 2 times the supply frequency (100 Hz)", "3 diodes in a half-wave configuration. Output ripple = 3 times the supply frequency (150 Hz)", "6 diodes arranged in two rows of three. Output ripple frequency = 6 times the supply frequency (300 Hz for 50 Hz supply)"],
  ...
  },
  {
    ...
    "opts": ["BJT operates only with AC signals; MOSFET operates only with DC signals", "BJT has three terminals called Source, Gate, Drain; MOSFET has terminals called Base, Emitter, Collector", "BJT is used exclusively for high-power applications above 6.6 kV; MOSFET is limited to 24V control circuits", "BJT is current-controlled (base current drives switching); MOSFET is voltage-controlled (gate voltage drives switching with near-zero gate current)"],
  ...
  },
  {
    ...
    "opts": ["IGBTs combine the high input impedance voltage control of MOSFETs with the low saturation voltage (high current capacity) of BJTs \u2014 making them ideal for high-power, high-frequency switching in motor drives", "IGBTs are the only semiconductor that can withstand the high humidity and salt atmosphere of the engine room without derating", "IGBTs generate less heat than MOSFETs because they use a magnetic field rather than current flow to switch power", "IGBTs are chosen because they can operate bidirectionally without any additional circuit components"],
  ...
  },
  {
    ...
    "opts": ["4V to 20V output \u2014 directly equal to the milliamp signal multiplied by 1000", "0.4V to 2.0V output \u2014 the op-amp divides the current by a factor of 10", "1V to 5V output (4mA x 250 ohm = 1V minimum; 20mA x 250 ohm = 5V maximum)", "0V to 10V output \u2014 the standard industrial signal range for all 4-20mA sensors"],
  ...
  },
  {
    ...
    "opts": ["'ia' means the instrument remains safe under TWO simultaneous faults; 'ib' means safe under ONE fault \u2014 making 'ia' suitable for Zone 0 and 'ib' for Zone 1 only", "'ia' indicates the instrument is immersion-proof to 1 metre; 'ib' indicates resistance to high-pressure washdown", "'ia' and 'ib' are interchangeable designations \u2014 there is no functional difference between them", "'ia' indicates the instrument uses an internal battery; 'ib' indicates it is powered from the ship's 24V DC system"],
  ...
  },
  {
    ...
    "opts": ["Peak voltage = 440 x 2 = 880V \u2014 double the RMS value due to the full-wave rectification effect", "Peak voltage = 440 x root 2 = approximately 622V \u2014 important because capacitors, insulation, and surge suppressors must be rated above this peak value, not just the 440V RMS value", "Peak voltage = 440 / root 2 = 311V \u2014 the RMS is always higher than the peak in AC systems", "Peak voltage = 440V \u2014 the RMS and peak values are identical for AC systems"],
  ...
  },
  {
    ...
    "opts": ["T = R / C seconds \u2014 the time constant is the resistance divided by the capacitance", "T = R x C / 1000 milliseconds \u2014 the standard formula for all timer ICs regardless of configuration", "T = 1.1 x R x C seconds (for a monostable pulse width); astable period T = 0.693 x C x (R1 + 2R2)", "T = 2 x pi x R x C seconds \u2014 the same formula used for an RC filter's cutoff frequency"],
  ...
  },
  {
    ...
    "opts": ["Xc = 10x10^-6 x 50 = 0.0005 ohms \u2014 the reactance equals capacitance times frequency", "Xc = 1 / (2 x pi x 50 x 10x10^-6) = approximately 318 ohms \u2014 at this frequency, the capacitor presents 318 ohms impedance to AC but blocks DC completely", "Xc = 50 / (10x10^-6) = 5,000,000 ohms \u2014 capacitors are essentially open circuits at power frequencies", "Xc = 2 x pi x 50 x 10x10^-6 = approximately 0.00314 ohms \u2014 capacitors are near-short-circuits at 50 Hz"],
  ...
  },
  {
    ...
    "opts": ["The output voltage of the sensor when the process is at its maximum design value (20mA output)", "The maximum voltage that can appear at the hazardous area terminals of the barrier under open circuit conditions \u2014 must be kept below the ignition voltage for the specific gas group", "The voltage drop across the barrier when the circuit is operating at maximum sensor current (20mA)", "The minimum supply voltage required for the barrier to regulate correctly and protect the sensor circuit"],
  ...
  },
  {
    ...
    "opts": ["It converts the 440V AC supply directly to 3.3V DC for LED operation without any transformer", "It maintains constant current through the LED regardless of supply voltage fluctuations or temperature changes \u2014 preventing under-brightness or premature LED failure from over-current", "It stores energy during the day cycle and uses it to keep the LED lit during the night cycle", "It provides surge protection to prevent lightning strikes from destroying the CCTV camera module"],
  ...
  },
  {
    ...
    "a": "0.6-0.7V",
    "opts": ["0.2-0.3V", "2.0-2.5V", "0.6-0.7V", "1.0-1.2V"],
  ...
  },
  {
    ...
    "a": "0.2-0.3V",
    "opts": ["1.5-1.8V", "0.6-0.7V", "0.2-0.3V", "1.0-1.2V"],
  ...
  },
  {
    ...
    "opts": ["Anode to positive, Cathode to negative", "Both to negative", "Both to positive", "Anode to negative, Cathode to positive"],
  ...
  },
  {
    ...
    "opts": ["It collapses, allowing current to flow freely", "It reverses polarity", "It widens, blocking current", "It turns into an insulator"],
  ...
  },
  {
    ...
    "opts": ["It widens, blocking current flow", "It emits light", "It generates a high voltage pulse", "It collapses completely"],
  ...
  },
  {
    ...
    "opts": ["Peak Inverse Voltage", "Phase Isolation Voltage", "Pulse Inverter Voltage", "Positive Internal Value"],
  ...
  },
  {
    ...
    "a": "0.5-0.7V",
    "opts": ["OL (Open Loop)", "1.2-1.5V", "0.5-0.7V", "0V"],
  ...
  },
  {
    ...
    "opts": ["5V", "0.6V", "OL (Open Loop / Open Circuit)", "0V"],
  ...
  },
  {
    ...
    "opts": ["0.6V forward, OL reverse", "OL in both directions", "0.6V in both directions", "Near 0V in both forward and reverse directions"],
  ...
  },
  {
    ...
    "opts": ["OL (Open Loop) in both forward and reverse directions", "0V in both directions", "1.2V in both directions", "0.6V forward, OL reverse"],
  ...
  },
  {
    ...
    "opts": ["Run the alternator at rated speed", "Apply DC voltage to the stator", "Short circuit the main terminals", "Stop the alternator and disconnect the diodes from the circuit"],
  ...
  },
  {
    ...
    "opts": ["Operate safely in reverse breakdown to maintain a constant voltage", "Block all reverse current permanently", "Emit infrared light", "Amplify AC signals"],
  ...
  },
  {
    ...
    "opts": ["In series with the load without a resistor", "In parallel with the AC input", "In reverse bias with a series resistor", "In forward bias with a series resistor"],
  ...
  },
  {
    ...
    "opts": ["Zener current increases, but output voltage stays fixed at Vz", "The series resistor decreases its resistance", "Zener diode turns off", "Output voltage increases proportionally"],
  ...
  },
  {
    ...
    "opts": ["To rectify the main AC output", "To cool the heat sinks", "To drive the main field directly", "To provide a stable reference voltage for comparison"],
  ...
  },
  {
    ...
    "opts": ["To make the relay open faster", "To convert AC to DC for the relay", "Connected across a relay coil to suppress high-voltage back-EMF spikes", "To increase the coil's magnetic field"],
  ...
  },
  {
    ...
    "opts": ["Cooling the semiconductor to absolute zero", "Adding impurity atoms to pure silicon/germanium to change its conductivity", "Exposing the material to UV light", "Cleaning the semiconductor surface"],
  ...
  },
  {
    ...
    "opts": ["Carbon atoms", "Pentavalent atoms (like phosphorus or arsenic)", "Noble gases", "Trivalent atoms (like boron)"],
  ...
  },
  {
    ...
    "opts": ["Trivalent atoms (like boron)", "Silicon atoms", "Pentavalent atoms (like phosphorus)", "Copper atoms"],
  ...
  },
  {
    ...
    "a": "Electrons",
    "opts": ["Electrons", "Holes", "Neutrons", "Protons"],
  ...
  },
  {
    ...
    "a": "Holes",
    "opts": ["Electrons", "Photons", "Holes", "Protons"],
  ...
  },
  {
    ...
    "opts": ["Standard diodes use germanium instead of silicon", "Zener diodes are specially doped to handle the power dissipation safely", "Zener diodes have a built-in fan", "Zener diodes have thicker wires"],
  ...
  },
  {
    ...
    "opts": ["Generating radio frequencies", "Reverse polarity protection in DC control circuits", "Stepping up AC voltage", "Measuring high temperatures"],
  ...
  },
  {
    ...
    "opts": ["To limit voltage to intrinsically safe levels in hazardous areas", "To amplify the HART signal", "To prevent ground loops", "To convert 4-20mA to digital"],
  ...
  },
  {
    ...
    "opts": ["Zener current increases", "Zener current decreases to compensate, maintaining output voltage", "The Zener burns out", "Output voltage drops to zero"],
  ...
  },
  {
    ...
    "opts": ["Friction between layers", "Magnetic fields", "External batteries", "Recombination of electrons and holes at the junction forming ions"],
  ...
  },
  {
    ...
    "opts": ["It changes direction", "It increases significantly", "It drops to zero", "It remains completely constant"],
  ...
  },
  {
    ...
    "opts": ["Silicon has a lower forward voltage drop", "Germanium is too heavy", "Germanium is highly radioactive", "Silicon can withstand much higher temperatures and has lower leakage current"],
  ...
  },
  {
    ...
    "a": "1.21 (121%)",
    "opts": ["0.482 (48.2%)", "1.21 (121%)", "0.10 (10%)", "0.042 (4.2%)"],
  ...
  },
  {
    ...
    "a": "0.482 (48.2%)",
    "opts": ["0.001 (0.1%)", "0.042 (4.2%)", "0.482 (48.2%)", "1.21 (121%)"],
  ...
  },
  {
    ...
    "opts": ["It requires 4 diodes", "It cannot be smoothed with capacitors", "It requires a specialized center-tapped transformer", "It has higher ripple"],
  ...
  },
  {
    ...
    "a": "0.042 (4.2%)",
    "opts": ["0.10 (10%)", "0.042 (4.2%)", "1.21 (121%)", "0.482 (48.2%)"],
  ...
  },
  {
    ...
    "opts": ["It generates higher AC voltage", "It produces very smooth DC, requiring a much smaller smoothing capacitor", "It uses fewer diodes", "It isolates the motor from ground"],
  ...
  },
  {
    ...
    "a": "D1 and D3",
    "opts": ["D3 and D4", "D1 and D2", "D2 and D4", "D1 and D3"],
  ...
  },
  {
    ...
    "opts": ["Current flows directly to ground", "In the same direction as the positive half cycle", "Current does not flow", "In the reverse direction"],
  ...
  },
  {
    ...
    "opts": ["Average DC output / Peak AC input", "Supply frequency / Output frequency", "RMS ripple voltage / Average DC output voltage", "Peak voltage / RMS voltage"],
  ...
  },
  {
    ...
    "opts": ["A Zener diode in forward bias", "A large electrolytic capacitor in parallel with the load", "A transformer in parallel", "A resistor in series"],
  ...
  },
  {
    ...
    "a": "0.9 x Vrms",
    "opts": ["1.414 x Vrms", "2.0 x Vrms", "0.45 x Vrms", "0.9 x Vrms"],
  ...
  },
  {
    ...
    "opts": ["Cycloconverter", "Class D amplifier", "Half-wave rectifier", "Single-phase full-wave bridge rectifier"],
  ...
  },
  {
    ...
    "opts": ["Output becomes half-wave rectified", "The circuit continues working normally", "It causes a direct AC short circuit on one half-cycle, blowing the fuse", "Output voltage doubles"],
  ...
  },
  {
    ...
    "opts": ["Output voltage drops to zero", "Output frequency doubles", "The fuse blows immediately", "The circuit becomes a half-wave rectifier, increasing ripple drastically"],
  ...
  },
  {
    ...
    "opts": ["Lower rectifier efficiency", "Smoother DC output requiring less filtering", "Need for a larger transformer", "Higher AC interference"],
  ...
  },
  {
    ...
    "opts": ["It produces 300Hz interference", "It requires too many diodes", "It causes reverse polarity", "High ripple (121%) and low efficiency (40.6%)"],
  ...
  },
  {
    ...
    "opts": ["Ripple voltage divided by DC voltage", "DC power output divided by AC power input", "Peak voltage divided by RMS voltage", "AC power output divided by DC power input"],
  ...
  },
  {
    ...
    "opts": ["Greater than the peak supply voltage (Vpeak)", "Half of Vrms", "Equal to average DC output", "Exactly 230V"],
  ...
  },
  {
    ...
    "opts": ["Another name for a 3-phase bridge rectifier", "A cycloconverter", "A single-phase rectifier at 300Hz", "A bridge with 6 filter capacitors"],
  ...
  },
  {
    ...
    "a": "325V DC",
    "opts": ["325V DC", "460V DC", "207V DC", "230V DC"],
  ...
  },
  {
    ...
    "opts": ["3-phase power has no peak voltage", "The 6 overlapping pulses create a naturally smooth DC wave with only 4.2% ripple", "They use inductors exclusively", "They operate at lower voltages"],
  ...
  },
  {
    ...
    "opts": ["Inductors increase the ripple", "Inductors are heavy, bulky, and expensive", "Inductors cause short circuits", "Inductors block DC current"],
  ...
  },
  {
    ...
    "opts": ["The capacitor stops charging", "The ripple voltage increases because the capacitor discharges faster", "The DC output voltage rises", "The ripple voltage decreases"],
  ...
  },
  {
    ...
    "opts": ["Emitter, Receiver, Ground", "Base, Collector, Emitter", "Gate, Drain, Source", "Anode, Cathode, Gate"],
  ...
  },
  {
    ...
    "opts": ["Frequency-controlled", "Temperature-controlled", "It is current-controlled (Base current controls Collector current)", "Voltage-controlled"],
  ...
  },
  {
    ...
    "a": "IC = hFE x IB",
    "opts": ["IE = IC / hFE", "IC = hFE x IB", "IC = VBE x IB", "IB = IC x IE"],
  ...
  },
  {
    ...
    "a": "Cutoff region",
    "opts": ["Breakdown region", "Cutoff region", "Saturation region", "Active region"],
  ...
  },
  {
    ...
    "a": "Active region",
    "opts": ["Ohmic region", "Saturation region", "Cutoff region", "Active region"],
  ...
  },
  {
    ...
    "a": "Saturation region",
    "opts": ["Saturation region", "Active region", "Linear region", "Cutoff region"],
  ...
  },
  {
    ...
    "a": "NPN and PNP",
    "opts": ["NPN and PNP", "SCR and TRIAC", "JFET and MOSFET", "N-channel and P-channel"],
  ...
  },
  {
    ...
    "a": "OL (Open Loop)",
    "opts": ["OL (Open Loop)", "0V", "1.2V", "0.6V"],
  ...
  },
  {
    ...
    "opts": ["Forward voltage drop", "Gate capacitance", "DC current gain of a BJT", "Leakage current"],
  ...
  },
  {
    ...
    "a": "Gate, Drain, Source",
    "opts": ["Input, Output, Ground", "Anode, Cathode, Gate", "Base, Collector, Emitter", "Gate, Drain, Source"],
  ...
  },
  {
    ...
    "opts": ["Light-controlled", "Current-controlled", "Resistance-controlled", "It is voltage-controlled (Gate voltage controls Drain current)"],
  ...
  },
  {
    ...
    "opts": ["Proportional to hFE", "Zero (extremely high input impedance)", "1-2 Amps", "Equal to Drain current"],
  ...
  },
  {
    ...
    "opts": ["Drain must be connected to Source", "VGS must be negative", "Base current must exceed 1A", "Gate-to-Source voltage (VGS) must exceed the threshold voltage (typically 2-4V)"],
  ...
  },
  {
    ...
    "opts": ["It requires large base currents", "Higher voltage capacity", "It is totally immune to static electricity", "Much faster switching speeds and no continuous gate current loading"],
  ...
  },
  {
    ...
    "a": "MOSFET",
    "opts": ["BJT", "TRIAC", "MOSFET", "Thyristor (SCR)"],
  ...
  },
  {
    ...
    "opts": ["Vibration failure", "Static discharge", "Overvoltage breakdown", "Secondary breakdown (thermal runaway in hot spots)"],
  ...
  },
  {
    ...
    "opts": ["They have identical hFE", "They draw zero voltage", "They have a positive temperature coefficient (RDS(on) rises with heat), ensuring natural current sharing", "They don't need heatsinks"],
  ...
  },
  {
    ...
    "opts": ["By removing the base current", "By shorting Collector to Base", "By waiting for AC zero crossing", "By applying a massive gate voltage"],
  ...
  },
  {
    ...
    "opts": ["By waiting for natural commutation", "By removing the gate voltage (discharging the gate capacitance)", "By applying base current", "By heating the device"],
  ...
  },
  {
    ...
    "opts": ["A vacuum gap", "A P-N junction", "A thin layer of silicon dioxide (metal-oxide)", "A rubber gasket"],
  ...
  },
  {
    ...
    "opts": ["It melts at room temperature", "It rusts in marine environments", "It conducts AC current", "Extremely sensitive to destruction by static electricity (ESD)"],
  ...
  },
  {
    ...
    "opts": ["3-phase rectifiers", "Low-power switching, relay drivers, and linear amplifier circuits", "Main propulsion VFDs", "High frequency radar transmitters"],
  ...
  },
  {
    ...
    "opts": ["Completely shorted (destroyed)", "Open circuit", "Fully healthy", "In active mode"],
  ...
  },
  {
    ...
    "opts": ["Rated DC Supply", "Rapid Drain Switching", "Reverse Diode Surge", "Resistance between Drain and Source when fully turned ON"],
  ...
  },
  {
    ...
    "opts": ["Because both electrons and holes participate in current conduction", "Because it can be NPN or PNP", "Because it has two poles", "Because it uses AC power"],
  ...
  },
  {
    ...
    "opts": ["Because only majority carriers (either electrons OR holes) conduct current", "Because it has one terminal", "Because it cannot amplify", "Because it only uses positive voltage"],
  ...
  },
  {
    ...
    "opts": ["To increase the voltage limit", "To prevent static shock", "To supply the necessary continuous base current", "To cool the BJT"],
  ...
  },
  {
    ...
    "opts": ["To rapidly charge and discharge the gate capacitance for fast switching", "To provide continuous gate current", "To measure the drain voltage", "To convert AC to DC"],
  ...
  },
  {
    ...
    "opts": ["Approximately 0.2V", "5V", "0.7V", "0V"],
  ...
  },
  {
    ...
    "opts": ["Static Capacitor Relay", "Synchronous Current Regulator", "Source Commutated Resistor", "Silicon Controlled Rectifier"],
  ...
  },
  {
    ...
    "a": "4 layers (PNPN)",
    "opts": ["3 layers (NPN)", "4 layers (PNPN)", "5 layers", "2 layers (PN)"],
  ...
  },
  {
    ...
    "opts": ["Gate, Drain, Source", "Input, Output, Commutator", "Anode, Cathode, Gate", "Base, Collector, Emitter"],
  ...
  },
  {
    ...
    "opts": ["It burns out", "It fires (turns ON) and begins conducting", "It blocks current completely", "It reverses polarity"],
  ...
  },
  {
    ...
    "opts": ["The Anode and Cathode weld together", "The gate physically locks in place", "It locks out external voltages", "The Thyristor stays ON even after the gate pulse is removed"],
  ...
  },
  {
    ...
    "opts": ["The temperature must drop", "Anode current must drop below the holding current (IH)", "Gate voltage must exceed 15V", "A negative gate pulse must be applied"],
  ...
  },
  {
    ...
    "opts": ["Turning it off manually", "Cooling it with forced air", "Using a capacitor to force it off", "The Thyristor turns off automatically when AC supply voltage crosses zero"],
  ...
  },
  {
    ...
    "opts": ["DC circuits have no ground", "To increase switching speed", "DC current is too high", "DC current never naturally crosses zero, so external circuits must force the current below IH"],
  ...
  },
  {
    ...
    "opts": ["The angle in the AC cycle at which the gate pulse triggers the Thyristor", "The physical mounting angle on the heatsink", "The phase shift between voltage and current", "The temperature at which it burns"],
  ...
  },
  {
    ...
    "opts": ["Maximum output (conducts the full half-cycle)", "Half output", "Reverse output", "Zero output"],
  ...
  },
  {
    ...
    "opts": ["Minimum/Zero output (does not conduct)", "Maximum output", "Half output", "Constant DC"],
  ...
  },
  {
    ...
    "opts": ["Changing 3-phase to single-phase", "Matching grid frequency", "Correcting power factor", "Varying the firing angle (alpha) to smoothly control average output power"],
  ...
  },
  {
    ...
    "opts": ["It switches between 50Hz and 60Hz", "It drops voltage across internal resistors", "It converts AC to DC", "It decreases the firing angle from 180 to 0 degrees, smoothly ramping up voltage"],
  ...
  },
  {
    ...
    "opts": ["It controls the amount of DC current supplied to the alternator exciter field", "It converts mechanical energy to electrical", "It protects against reverse power", "It measures the main bus frequency"],
  ...
  },
  {
    ...
    "opts": ["They are too fast", "They overheat too quickly", "They cannot handle high voltages", "Because they latch ON in DC circuits and require bulky, complex forced commutation circuits to turn OFF"],
  ...
  },
  {
    ...
    "opts": ["No, it conducts in reverse", "Yes, it blocks reverse voltage similar to a normal diode", "Only if the gate is pulsed negatively", "Only at high frequencies"],
  ...
  },
  {
    ...
    "opts": ["They are exactly the same", "Thyristors switch at MHz frequencies", "Thyristors are much faster", "Thyristors are much slower (line frequency 50/60Hz), while IGBTs switch at high frequencies (up to 20kHz)"],
  ...
  },
  {
    ...
    "opts": ["They generate microwave frequencies", "They cool the elements", "They convert heat back to electricity", "They pulse power to heating elements by adjusting the conduction angle"],
  ...
  },
  {
    ...
    "opts": ["A diode bridge with a fan", "A rectifier with a manual switch", "A rectifier circuit using Thyristors instead of diodes to control the average DC output voltage", "A rectifier that produces pure AC"],
  ...
  },
  {
    ...
    "opts": ["To provide forced commutation", "To double the voltage rating", "Because one SCR handles the positive half-cycle and the other handles the negative half-cycle", "For redundancy in case one fails"],
  ...
  },
  {
    ...
    "opts": ["The minimum anode current required to maintain conduction once the gate pulse is removed", "The leakage current in reverse bias", "The current required at the gate", "The maximum current before burnout"],
  ...
  },
  {
    ...
    "opts": ["Yes, by exceeding its forward breakover voltage or by a rapid rate of voltage rise (dv/dt)", "Yes, by removing the anode connection", "Yes, by dropping the temperature", "No, strictly by gate pulse only"],
  ...
  },
  {
    ...
    "opts": ["To protect against high dv/dt (rapid voltage rise) that could falsely trigger the SCR", "To amplify the gate pulse", "To increase firing speed", "To reduce the holding current"],
  ...
  },
  {
    ...
    "opts": ["It reverses the magnetic field directly", "It controls the average armature voltage, thereby controlling motor speed", "It controls the number of poles", "It controls the motor frequency"],
  ...
  },
  {
    ...
    "opts": ["There is no difference", "An SCR is voltage controlled; a TRIAC is current controlled", "An SCR is faster than a TRIAC", "An SCR conducts in one direction; a TRIAC conducts in both directions"],
  ...
  },
  {
    ...
    "opts": ["SCRs are bi-directional", "SCRs do not need a heatsink", "TRIACs are illegal on ships", "SCRs handle much higher currents and voltages more reliably than TRIACs"],
  ...
  },
  {
    ...
    "opts": ["It will not turn ON", "It turns ON normally, but it wastes gate power and generates unnecessary heat", "It oscillates ON and OFF", "It forces commutation"],
  ...
  },
  {
    ...
    "a": "6 Thyristors",
    "opts": ["4 Thyristors", "12 Thyristors", "6 Thyristors", "3 Thyristors"],
  ...
  },
  {
    ...
    "opts": ["A bridge controlled by relays", "A bridge that only works at 50Hz", "A bridge using half Thyristors and half standard diodes", "A bridge with 2 diodes"],
  ...
  },
  {
    ...
    "opts": ["It acts as a controlled rectifier to regulate the charging current based on battery state", "It converts the battery DC back to AC", "It measures the specific gravity", "It prevents hydrogen gas buildup"],
  ...
  },
  {
    ...
    "opts": ["Isolated Ground Bi-directional Terminal", "Internal Grid Base Transistor", "Integrated Gate Bipolar Thyristor", "Insulated Gate Bipolar Transistor"],
  ...
  },
  {
    ...
    "opts": ["Thyristor latching and Diode blocking", "MOSFET voltage-controlled input and BJT high-current, low-loss output", "BJT current control and MOSFET high resistance", "Zener regulation and TRIAC AC switching"],
  ...
  },
  {
    ...
    "opts": ["Gate, Drain, Source", "Base, Collector, Emitter", "Anode, Cathode, Gate", "Gate, Collector, Emitter"],
  ...
  },
  {
    ...
    "opts": ["By a short positive pulse that latches it", "By exceeding breakover voltage", "By injecting current into the Base", "By applying a positive voltage (typically +15V) to the Gate relative to the Emitter"],
  ...
  },
  {
    ...
    "opts": ["By reducing Collector current below holding current", "By shorting Collector to Emitter", "By removing the Gate voltage (or applying a negative voltage)", "By waiting for AC zero crossing"],
  ...
  },
  {
    ...
    "opts": ["IGBTs can be turned off by the gate without forced commutation circuits and switch much faster", "IGBTs can handle higher voltages than SCRs", "IGBTs are cheaper", "IGBTs don't require heatsinks"],
  ...
  },
  {
    ...
    "a": "2 kHz to 20 kHz",
    "opts": ["50 to 60 Hz", "100 to 500 Hz", "1 MHz to 5 MHz", "2 kHz to 20 kHz"],
  ...
  },
  {
    ...
    "opts": ["It creates a smoother sine wave current and reduces acoustic motor noise (whine)", "It prevents bearing currents", "It increases motor torque by 50%", "It removes the need for motor cooling"],
  ...
  },
  {
    ...
    "a": "1.5V to 3.0V",
    "opts": ["10V to 15V", "0.6V to 0.7V", "1.5V to 3.0V", "0.1V to 0.2V"],
  ...
  },
  {
    ...
    "opts": ["To safely translate the 5V logic control signal into the +15V/-8V power needed to drive the IGBT gate", "To measure the motor speed", "To cool the IGBT", "To convert AC to DC"],
  ...
  },
  {
    ...
    "opts": ["To reverse the motor direction", "To save energy", "To cool the junction", "To prevent false turn-on caused by 'Miller capacitance' during high dv/dt switching events"],
  ...
  },
  {
    ...
    "opts": ["A temperature sensor", "An over-voltage clamp", "A circuit that detects a short circuit by sensing if VCE rises abnormally high while the IGBT is commanded ON", "A circuit preventing moisture buildup"],
  ...
  },
  {
    ...
    "opts": ["1 second", "10 microseconds", "10 milliseconds", "5 minutes"],
  ...
  },
  {
    ...
    "opts": ["A filtering capacitor", "A Zener diode", "A freewheeling diode", "A small SCR"],
  ...
  },
  {
    ...
    "opts": ["By reducing the DC link voltage", "By using Pulse Width Modulation (PWM) to vary both the voltage and frequency (V/Hz control)", "By changing the resistance of the stator", "By adjusting the firing angle alpha"],
  ...
  },
  {
    ...
    "opts": ["They must be submerged in oil", "They require no cooling", "They must be kept in a freezer", "They require large heatsinks and thermal compound to dissipate conduction and switching losses"],
  ...
  },
  {
    ...
    "opts": ["Peak Width Measurement", "Power Watt Multiplier", "Pulse Width Modulation", "Phase Wave Magnitude"],
  ...
  },
  {
    ...
    "opts": ["IGBTs generate too much ripple", "Standard rectifiers use diodes for cheap, simple AC-DC conversion without needing control logic", "IGBTs are too slow", "IGBTs cannot handle AC voltage"],
  ...
  },
  {
    ...
    "opts": ["The GTO (Gate Turn-Off Thyristor)", "The BJT", "The Cycloconverter", "The mechanical commutator"],
  ...
  },
  {
    ...
    "opts": ["It operates in the linear region, dissipating massive heat and likely burning out", "It switches twice as fast", "It works normally but draws more current", "It triggers the desat alarm but stays cool"],
  ...
  },
  {
    ...
    "opts": ["To measure gate current", "To consume excess power", "To control the switching speed (dv/dt), balancing switching losses against EMI generation", "To step down the voltage to 5V"],
  ...
  },
  {
    ...
    "opts": ["Yes, if the gate is negative", "Yes, it is bi-directional like a TRIAC", "No, it only conducts Emitter to Collector", "No, it only conducts from Collector to Emitter"],
  ...
  },
  {
    ...
    "opts": ["The time to charge the DC link", "The delay in the PLC network", "A tiny delay inserted to ensure the top IGBT turns fully OFF before the bottom IGBT turns ON", "The time the motor is stopped"],
  ...
  },
  {
    ...
    "opts": ["Marine VFD inverters", "High power UPS systems", "Active Front End rectifiers", "Low voltage (e.g. 5V), high-frequency computer processors"],
  ...
  },
  {
    ...
    "opts": ["The brief periods during turn-on and turn-off where voltage and current overlap", "The constant 15V gate signal", "The resistance of the heatsink", "The DC link capacitor leakage"],
  ...
  },
  {
    ...
    "opts": ["A device that converts AC to DC", "A power electronic device that converts AC power at one frequency DIRECTLY to AC power at a lower frequency", "A type of UPS", "A rotary frequency converter"],
  ...
  },
  {
    ...
    "opts": ["A VFD is only for DC motors", "A Cycloconverter has no intermediate DC link; a VFD uses a DC link between rectifier and inverter", "A Cycloconverter can increase frequency", "A Cycloconverter uses IGBTs only"],
  ...
  },
  {
    ...
    "a": "Thyristors (SCRs)",
    "opts": ["Diodes", "Transformers", "Thyristors (SCRs)", "Capacitors"],
  ...
  },
  {
    ...
    "opts": ["Unlimited", "Approximately 1/3 of the input frequency", "Double the input frequency", "Equal to the input frequency"],
  ...
  },
  {
    ...
    "opts": ["Steering gear hydraulic pumps", "Driving large, very low-speed synchronous motors for main propulsion (e.g., LNG carriers, icebreakers)", "Emergency generator starting", "Engine room ventilation fans"],
  ...
  },
  {
    ...
    "opts": ["It warms the ice", "It runs on 24V DC", "It increases propeller RPM massively", "It provides full, massive torque from zero speed without needing a reduction gearbox"],
  ...
  },
  {
    ...
    "opts": ["VFDs are too heavy", "Thyristors in a Cycloconverter have very low conduction losses and natural commutation at low frequencies", "VFDs cannot reverse direction", "Cycloconverters produce zero harmonics"],
  ...
  },
  {
    ...
    "opts": ["Yes, to increase the speed", "Yes, a massive reduction gearbox is needed", "Only on smaller vessels", "No, it is used for direct-drive propulsion"],
  ...
  },
  {
    ...
    "opts": ["Only if DC link capacitors are added", "Yes, it can naturally return energy from the motor to the supply grid", "No, it burns excess energy in resistors", "Only at high speeds"],
  ...
  },
  {
    ...
    "opts": ["It drops the grid voltage to zero", "It generates RF interference that breaks radar", "It causes high frequency whistling", "It produces severe harmonic distortion in the supply grid, requiring heavy harmonic filters"],
  ...
  },
  {
    ...
    "opts": ["6 Thyristors", "18 or 36 Thyristors", "4 Thyristors", "3 Thyristors"],
  ...
  },
  {
    ...
    "opts": ["No, Cycloconverters rely on the main supply grid for natural commutation of the SCRs", "Yes, it has internal batteries", "Yes, by manually overriding the SCRs", "Yes, it requires very little power"],
  ...
  },
  {
    ...
    "opts": ["By slowly changing the firing angle pattern of the Thyristors over successive supply cycles", "By speeding up a rotary motor", "By changing the DC link voltage", "By adding more capacitors"],
  ...
  },
  {
    ...
    "opts": ["It will automatically switch to a VFD mode", "It will work perfectly", "It is impossible; the output waveform will distort and fail", "It will draw less current"],
  ...
  },
  {
    ...
    "opts": ["Relays", "Diodes", "BJT transistors", "IGBTs (allowing forced commutation and higher output frequencies)"],
  ...
  },
  {
    ...
    "a": "Synchronous motor",
    "opts": ["DC series motor", "Stepper motor", "Squirrel cage induction motor", "Synchronous motor"],
  ...
  },
  {
    ...
    "opts": ["Because the DC link capacitor is huge", "Because SCRs must be spaced 1 meter apart", "It requires dozens of high-power SCRs, massive isolation transformers, and heavy harmonic filter banks", "It requires an internal diesel engine"],
  ...
  },
  {
    ...
    "opts": ["A clean high-frequency square wave", "A perfectly smooth sine wave", "A jagged envelope made of chopped pieces of the input AC sine waves", "A pure flat DC line"],
  ...
  },
  {
    ...
    "opts": ["It generates the positive half-cycle of the low-frequency output wave", "It charges the battery", "It generates the DC link voltage", "It absorbs harmonic noise"],
  ...
  },
  {
    ...
    "opts": ["A mechanical relay", "A fiber optic cable connector", "A visual alarm indicator", "A component that transfers electrical signals between two isolated circuits using light"],
  ...
  },
  {
    ...
    "opts": ["A Zener diode and a resistor", "A laser and a mirror", "A microchip and an antenna", "An LED (Light Emitting Diode) and a Phototransistor"],
  ...
  },
  {
    ...
    "opts": ["It amplifies power", "Complete electrical isolation between high-voltage/noisy field circuits and low-voltage logic circuits", "It converts AC to DC", "It provides physical illumination"],
  ...
  },
  {
    ...
    "opts": ["By reversing the polarity", "By grounding both sides heavily", "By ensuring there is no direct electrical connection or common ground between input and output", "By using a transformer"],
  ...
  },
  {
    ...
    "opts": ["In the hydraulic steering lines", "In the 440V Main Switchboard busbars", "Inside the main propulsion gearbox", "On PLC digital input and output cards"],
  ...
  },
  {
    ...
    "opts": ["Explosion Ignited", "Intrinsically Safe", "Extra Insulated", "Exhaust Isolated"],
  ...
  },
  {
    ...
    "opts": ["It provides ground fault detection", "It limits voltage and current entering the hazardous area to non-incendive levels", "It boosts the signal for long cables", "It physically blocks gas from the safe area"],
  ...
  },
  {
    ...
    "opts": ["Capacitor, Inductor, Transistor", "LED, Photodiode, Relay", "Transformer, Bridge, Choke", "Zener diodes (voltage limit), Resistors (current limit), and a Fuse (protection)"],
  ...
  },
  {
    ...
    "opts": ["Ex d is for water, Ex i is for gas", "Ex d uses plastic, Ex i uses metal", "There is no difference", "Ex d contains the internal explosion; Ex i prevents the ignition spark from occurring entirely"],
  ...
  },
  {
    ...
    "opts": ["Increased Safety (prevents ignition by robust design, tighter terminals, and better seals)", "Extra Energy", "Electronic Excitation", "Explosion Exhaust"],
  ...
  },
  {
    ...
    "opts": ["A type of transistor", "A mechanical switch on the rotor that maintains consistent torque direction by reversing coil current", "A device that measures speed", "The cooling fan"],
  ...
  },
  {
    ...
    "a": "Carbon brushes",
    "opts": ["Copper slip rings", "Steel ball bearings", "Teflon pads", "Carbon brushes"],
  ...
  },
  {
    ...
    "opts": ["To increase the voltage limit", "To change the motor direction", "To allow oil lubrication", "To prevent the harder mica from protruding and lifting the brushes as the copper wears down"],
  ...
  },
  {
    ...
    "opts": ["The grounding requirement", "The physical shape of the enclosure", "Matching the barrier's max output parameters (Uo, Io) against the sensor's max input limits (Ui, Ii)", "The legal ownership of the barrier"],
  ...
  },
  {
    ...
    "opts": ["Submerged in the cargo tank", "Directly on the main engine", "In the Safe Area (or an Ex d enclosure), never unprotected in the Hazardous Area", "At the mast top"],
  ...
  },
  {
    ...
    "opts": ["It transfers power instead of signal", "The output will be inverted", "It will explode", "The LED will not light up, and no signal will transfer (it blocks reverse current)"],
  ...
  },
  {
    ...
    "a": "Class B",
    "opts": ["Class B", "Class C", "Class AB", "Class A"],
  ...
  },
  {
    ...
    "opts": ["Distortion caused by crossed wires", "Overheating of the speaker", "A dead zone at the zero-crossing where both transistors are briefly OFF", "High frequency screeching"],
  ...
  },
  {
    ...
    "opts": ["By using transformers", "By switching to digital PWM", "By applying a small forward bias to keep both transistors slightly ON at all times", "By adding a large capacitor"],
  ...
  },
  {
    ...
    "a": "Class C",
    "opts": ["Class A", "Class D", "Class B", "Class C"],
  ...
  },
  {
    ...
    "a": "Class D",
    "opts": ["Class C", "Class B", "Class D", "Class A"],
  ...
  },
  {
    ...
    "opts": ["A high-gain, DC-coupled differential amplifier IC with high input and low output impedance", "A type of radio antenna", "A mechanical relay", "A motor speed controller"],
  ...
  },
  {
    ...
    "a": "Gain = -(Rf / Rin)",
    "opts": ["Gain = -(Rf / Rin)", "Gain = Rin / Rf", "Gain = Rf x Rin", "Gain = 1 + (Rf / Rin)"],
  ...
  },
  {
    ...
    "a": "Gain = 1 + (Rf / Rin)",
    "opts": ["Gain = 0", "Gain = -(Rf / Rin)", "Gain = 1 + (Rf / Rin)", "Gain = Rf - Rin"],
  ...
  },
  {
    ...
    "opts": ["It amplifies the sum of two voltages", "It integrates the signal over time", "It compares two voltages and outputs HIGH or LOW depending on which is higher", "It converts AC to DC"],
  ...
  },
  {
    ...
    "opts": ["It provides Proportional (P) gain only", "It provides the Integral (I) action by accumulating the error signal over time", "It provides Derivative (D) action", "It converts 4-20mA to digital"],
  ...
  },
  {
    ...
    "opts": ["The heater filament voltage", "The main AC supply", "A fixed DC voltage applied to the control grid to set the operating point of the tube", "The ground connection"],
  ...
  },
  {
    ...
    "opts": ["Converts 4-20mA sensor signals into 1-5V signals for analog input cards", "Measures battery capacity", "Converts AC current to DC voltage", "Converts 220V to 24V"],
  ...
  },
  {
    ...
    "opts": ["It is a high-power motor driver", "It is a 3-phase rectifier", "It is a highly versatile chip used for timing, pulse generation, and oscillator applications", "It is an optical isolator"],
  ...
  },
  {
    ...
    "opts": ["It acts as an oscillator, continuously toggling the output HIGH and LOW (square wave)", "It latches the output permanently", "It waits for a manual trigger", "It acts as a microphone amplifier"],
  ...
  },
  {
    ...
    "opts": ["Creating an alarm timer delay to avoid nuisance alarms (one-shot pulse)", "Running the main propulsion", "Generating VHF radio waves", "Rectifying AC power"],
  ...
  },
  {
    ...
    "a": "AND Gate",
    "opts": ["AND Gate", "NOT Gate", "OR Gate", "XOR Gate"],
  ...
  },
  {
    ...
    "a": "OR Gate",
    "opts": ["NOR Gate", "OR Gate", "XOR Gate", "AND Gate"],
  ...
  },
  {
    ...
    "a": "NOT Gate (Inverter)",
    "opts": ["AND Gate", "NOT Gate (Inverter)", "OR Gate", "NAND Gate"],
  ...
  },
  {
    ...
    "a": "NAND Gate",
    "opts": ["XOR Gate", "NOR Gate", "OR Gate", "NAND Gate"],
  ...
  },
  {
    ...
    "opts": ["Because they are used everywhere on ships", "Because any logic function or gate can be built using only NAND or only NOR gates", "Because they work in both analog and digital", "Because they run on universal AC power"],
  ...
  },
  {
    ...
    "opts": ["XOR Gate (Exclusive OR)", "NAND Gate", "XNOR Gate", "AND Gate"],
  ...
  },
  {
    ...
    "opts": ["As an XOR gate", "As an AND gate (Lube oil OK AND cooling OK AND start pressed)", "As an OR gate", "As a NOT gate"],
  ...
  },
  {
    ...
    "opts": ["As a Flip-Flop", "As a NAND gate", "As an AND gate", "As an OR gate (Sensor 1 OR Sensor 2 OR Sensor 3 triggers alarm)"],
  ...
  },
  {
    ...
    "a": "8 bits",
    "opts": ["8 bits", "4 bits", "32 bits", "16 bits"],
  ...
  },
  {
    ...
    "a": "16 bits",
    "opts": ["64 bits", "16 bits", "32 bits", "8 bits"],
  ...
  },
  {
    ...
    "a": "24V DC",
    "opts": ["12V DC", "24V DC", "220V AC", "5V DC"],
  ...
  },
  {
    ...
    "opts": ["Linear is highly efficient, SMPS wastes heat", "Linear uses AC, SMPS uses DC", "Linear drops excess voltage as heat; SMPS chops voltage at high frequency for efficiency", "There is no difference"],
  ...
  },
  {
    ...
    "opts": ["It is waterproof", "It is completely silent", "It requires no capacitors", "It is much smaller and lighter because it uses a tiny high-frequency transformer instead of a heavy 50Hz transformer"],
  ...
  },
  {
    ...
    "opts": ["It cannot charge batteries", "It generates high-frequency switching noise (EMI) that can interfere with sensitive equipment", "It generates excessive heat", "It only works on 110V"],
  ...
  },
  {
    ...
    "opts": ["It acts as an open circuit, blocking DC current flow", "It reverses the current", "It continuously consumes power", "It acts as a short circuit"],
  ...
  },
  {
    ...
    "opts": ["Current LEADS voltage by 90 degrees (CIVIL)", "Current and voltage are IN PHASE", "Current LAGS voltage by 90 degrees", "Voltage LEADS by 180 degrees"],
  ...
  },
  {
    ...
    "opts": ["It decreases (allows more AC current to flow)", "It drops to exactly zero", "It remains constant", "It increases"],
  ...
  },
  {
    ...
    "opts": ["Wait for discharge time and verify it is completely discharged with a voltmeter", "Remove the fuses while running", "Ground it with your hand", "Turn off the lights"],
  ...
  },
  {
    ...
    "opts": ["EMF only applies to motors", "They are identical", "EMF is the open-circuit voltage; Terminal voltage drops under load due to internal resistance", "EMF is AC, PD is DC"],
  ...
  },
  {
    ...
    "opts": ["The average of a full sine wave (zero)", "The equivalent DC value that would produce the same heating effect (I\u00b2R)", "The absolute maximum peak", "The frequency of the wave"],
  ...
  },
  {
    ...
    "a": "622 Volts",
    "opts": ["622 Volts", "311 Volts", "880 Volts", "440 Volts"],
  ...
  },
  {
    ...
    "opts": ["It clamps transient over-voltages to a safe level, diverting the excess energy to earth", "It stores power like a battery", "It smooths rectifier ripple", "It increases voltage during brownouts"],
  ...
  },
  {
    ...
    "opts": ["A type of silicon dopant", "A cooling gas", "A magnetic steel alloy", "Hard, vulcanized rubber used as an electrical insulator"],
  ...
  },
  {
    ...
    "opts": ["To generate stable DC", "To power the ship's radar", "To produce high-voltage, short-duration pulses (simulating lightning) for insulation testing", "To run the main propulsion"],
  ...
  },
  {
    ...
    "opts": ["The input rectifier", "The switching MOSFET", "The high-frequency transformer", "The output filter capacitor"],
  ...
  },
  {
    ...
    "opts": ["By shutting off briefly", "By using a feedback loop to adjust the PWM duty cycle of the switching transistor", "By changing the transformer turns ratio physically", "By adding more resistance"],
