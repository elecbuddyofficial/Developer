...
<div class="note-doc">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-cascade-control.webp" alt="Cascade control block diagram — primary (outer) controller sets SP for secondary (inner) controller, inner loop manipulates final element" loading="lazy" decoding="async" data-blur="data:image/webp;base64,UklGRlgAAABXRUJQVlA4IEwAAABQAwCdASocAA4APu1iqU2ppaQiMAgBMB2JaWHgADc3CnQEAAD+8H3lgDZXDXkPPaPY3ug4ffCmbg6gsOGkawfL5O9d4J5nbMr9QwAA">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-three-element-boiler.webp" alt="3-element boiler feedwater control — steam flow (FF), feedwater flow (FF), drum level (FB), feedwater control valve" loading="lazy" decoding="async" data-blur="data:image/webp;base64,UklGRmIAAABXRUJQVlA4IFYAAADQAwCdASocABEAPu1mqk2ppaQiMAgBMB2JaQAAW+jKzYdoffpETHgA/vHQl68JIYrRpGQHbqmxADuTr3ClAedNhhcjUGzVA6nLgblcPdVzv9/IAAAAAA==">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-master-slave-arch.webp" alt="Master-slave IAS architecture — master PLC/DCS server communicates with distributed slave PLC nodes over redundant network" loading="lazy" decoding="async" data-blur="data:image/webp;base64,UklGRl4AAABXRUJQVlA4IFIAAADQAwCdASocABEAPu1sq08ppiOiMBgIATAdiWkAADp3CVymTkzUrAAA/vBJKvEbjxmnh2Q6k9TgZpsJ6MmGm9iuQq8XOfgsVw+fhwE0+5jsAAAA">
