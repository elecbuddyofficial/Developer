...
<div class="note-doc">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-open-closed-loop.webp" alt="Open loop vs closed loop control block diagrams — open loop without feedback, closed loop with feedback path and error signal" loading="lazy" decoding="async">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-cascade-control.webp" alt="Cascade control block diagram — primary (outer) controller sets SP for secondary (inner) controller, inner loop manipulates final element" loading="lazy" decoding="async">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-plc-scan-cycle.webp" alt="PLC scan cycle — input scan, program execution, output scan, housekeeping, watchdog timer" loading="lazy" decoding="async">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-plc-ladder-logic.webp" alt="PLC ladder logic diagram — rungs with NO/NC contacts, output coils, motor start-stop interlock example" loading="lazy" decoding="async">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-three-element-boiler.webp" alt="3-element boiler feedwater control — steam flow (FF), feedwater flow (FF), drum level (FB), feedwater control valve" loading="lazy" decoding="async">
  ...
  <div class="note-diagram-wrap">
    <img src="../data/diagrams/t07-master-slave-arch.webp" alt="Master-slave IAS architecture — master PLC/DCS server communicates with distributed slave PLC nodes over redundant network" loading="lazy" decoding="async">
