...
<div class="note-doc">
  ...
  <div class="n-info"><div class="icon">📖</div><div class="body"><strong>Superheterodyne receiver (heterodyne principle):</strong> the weak returning echo (RF) is <strong>mixed</strong> with a steady signal from a <strong>local oscillator</strong>. Mixing two frequencies produces a lower <strong>beat / intermediate frequency (IF)</strong> equal to their difference, which is easy to amplify and filter with high, stable gain. This "heterodyning" is the basis of the RADAR receiver and of MF/HF and VHF radio receivers - the incoming signal is always down-converted to a fixed IF before detection.</div></div>
  ...
  <div class="n-h2">SONAR - Sound Navigation and Ranging</div>
  <div class="n-info"><div class="icon">📖</div><div class="body">SONAR uses the <strong>same echo-ranging principle</strong> as the echo sounder, but a steerable transducer sends the acoustic pulse <strong>horizontally / all round</strong> instead of just straight down. A hydrophone times the returning echo; range = ½ × sound speed × travel time, and the bearing is taken from the beam direction. Used to detect underwater objects, shoals, submarines and fish shoals. <strong>Active SONAR</strong> transmits and listens for the echo; <strong>passive SONAR</strong> only listens to the noise radiated by a target.</div></div>
  ...
  <strong>12 mandatory inputs:</strong> (1) Date/Time UTC, (2) GPS Position, (3) STW (Speed Through Water), (4) SOG (Speed Over Ground), (5) Gyro Heading, (6) Bridge Audio (microphone), (7) VHF Radio Audio, (8) RADAR Display image, (9) AIS Data, (10) ECDIS Display, (11) Rudder Order and Response, (12) Engine Telegraph Order and Response.<br><br>
  <strong>Storage / retention:</strong> the protected capsule keeps a rolling record of at least the last <span class="n-val">48 hours</span> (older units <span class="n-val">12 hours</span>). Modern VDRs (IMO MSC.333(90)) also keep a long-term recording on an internal medium for at least <span class="n-val">30 days</span> - older data is continuously overwritten.</div></div>
