window.loadQuizzes("T15_FireFighting", [
  {
    ...
    "opts": [
      "CO2 reacts with cooking oil producing toxic cyanide gas",
      "CO2 conducts electricity at high galley temperatures",
  ...
  },
  {
    ...
    "opts": [
      "DCP - chemically reacts with burning copper",
      "AFFF foam - non-conductive blanket over cables",
      "Water mist - fine droplets don't conduct electricity",
      "CO2 - non-conductive and leaves no residue on electrical components"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Expansion 1:200; minimum 15% concentration",
      "Expansion 1:450; minimum 34% concentration by volume",
  ...
  },
  {
    ...
    "opts": [
      "Main valve opened first; pilot controls exact expansion ratio",
      "Pilot valve only used for annual survey testing without releasing cylinders",
  ...
  },
  {
    ...
    "opts": [
      "1 hour - CO2 dissipates through funnel",
      "10 minutes - high-pressure CO2 instantly freezes fire source",
  ...
  },
  {
    ...
    "opts": [
      "Low expansion for electrical fires only; high expansion specifically for galley Class F",
      "Low expansion cools structural steel; high expansion smothers cargo holds",
      "No functional difference - low expansion is older technology",
      "Low expansion (up to 20:1) blankets liquid surface fires (tanker decks); high expansion (200:1 to 1000:1) floods enclosed spaces (RoRo decks)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "1 January 2020 - same as SOx global cap",
      "1 January 2026 - immediate ban with no grace period",
      "First scheduled survey on or after 1 January 2026 - PFOS foam must be replaced with PFOS-free alternatives",
      "1 January 2030 - aligned with IMO 2030 decarbonisation target"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Use radioactive isotope neutralising toxic gases from cooking oil",
      "Only trigger on open flames - ignore all smoke and steam",
  ...
  },
  {
    ...
    "opts": [
      "Lighter flame produces no UV radiation so detector appears broken",
      "Lighter instantly activates local water mist nozzles flooding electrical panels",
      "Lighter causes Am-241 to leak alpha particles into engine room",
      "Naked flame in machinery space = severe explosion risk near fuel sources; heat can permanently damage sensitive UV sensor lens"
    ],
  ...
  },
  {
    ...
    "opts": [
      "0.1 MPa (1 bar)",
      "0.3 MPa (3 bar) simultaneously supplying two jets of water at any hydrant",
      "1.0 MPa (10 bar)",
      "0.7 MPa (7 bar)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Primary active ingredient interrupting free radical chain reaction",
      "Provides propellant pressure to empty cylinder when heated",
      "Reacts with cooking oil to form soapy non-flammable foam",
      "Anti-caking agent - keeps powder particles free-flowing and water-repellent despite ship vibration"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Surge protector preventing 220V AC from entering 24V DC alarm panel",
      "Amplifies weak Am-241 signal for long cable runs to bridge",
      "Converts analogue smoke density to digital Modbus signal for IAS",
      "Allows panel to distinguish three states: normal monitoring / short-circuit fire alarm / open-circuit wire fault"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Open MSB cabinet and discharge foam directly onto busbars",
      "Connect fire hose and apply solid water jet to cool burning copper",
  ...
  },
  {
    ...
    "opts": [
      "Turns to steam and blows hatch covers off the vessel",
      "Violates MARPOL Annex V by creating oily water",
  ...
  },
  {
    ...
    "opts": [
      "Stores compressed air for automatic pipe blow-out every 24 hours",
      "Safely collects radioactive alpha particles leaking from ionisation sensors",
  ...
  },
  {
    ...
    "opts": [
      "Combustible material, Carbon Dioxide, and Spark",
      "Fuel, Nitrogen, and Heat",
      "Carbon, Oxygen, and Ignition",
  ...
  },
  {
    ...
    "opts": [
      "Lowering the temperature below the ignition point",
      "Interrupting the chemical chain reaction",
      "Removing or displacing the Oxygen supply from the fire",
      "Isolating the fuel supply valve"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Displacing oxygen using an inert gas",
      "Removing the combustible fuel source from the fire",
  ...
  },
  {
    ...
    "opts": [
      ...
      "Solid carbonaceous materials like wood, paper, rope, fabric, and plastics",
  ...
  },
  {
    ...
    "opts": [
      "Cooking fats and deep fryer oils",
      "Solid plastics and rubber",
      "Electrical switchboards",
      "Flammable liquids and gases like fuel oil, petrol, paint thinner, and LPG"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water evaporates too quickly to cool the oil",
      "Water is heavier than oil; it sinks and violently scatters the burning liquid, rapidly spreading the fire",
      "Water conducts the heat directly back to the operator",
      "Water chemically reacts with oil to create explosive hydrogen"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Flammable gases under pressure (e.g., LPG, acetylene, hydrogen)",
      "Combustible metals",
      "Cooking oils",
  ...
  },
  {
    ...
    "opts": [
      "Spray a solid water jet directly into the flame",
      "Isolate the gas supply valve to starve the fire",
      "Flood the area with high-expansion foam",
      "Use CO2 to freeze the gas pipe"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Special Dry Powder (e.g., graphite powder, sodium chloride base)",
      "Water mist",
      "Standard CO2",
      "AFFF Foam"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The metal absorbs the water and turns into a heavy slag",
      "A violent, exothermic, and explosive chemical reaction occurs, generating highly explosive hydrogen gas",
      "The water creates a harmless steam cloud that smothers the fire",
      "The water instantly freezes the metal"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Combustible engine room liquids",
      "Exhaust gas economizer soot",
      "Galley exhaust ducts",
      "Energized electrical equipment (e.g., switchboards, motors, live wiring)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water and Low-Expansion Foam",
      "CO2, Dry Chemical Powder (DCP), or FM-200",
      "Wet Chemical and Sand",
      "AFFF Foam and Water Mist"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They cause the copper wiring to catch fire",
      "They are highly conductive and create a lethal risk of electrocuting the firefighter holding the extinguisher",
      "They create toxic chlorine gas when exposed to 440V",
      "They short-circuit the ship's main battery bank"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Heavy fuel oil in the engine room",
      "Electrical switchboards",
      "Cooking oils and animal fats (e.g., deep fat fryers in the galley)",
      "Combustible metals"
    ],
  ...
  },
  {
    ...
    "opts": [
      "High Expansion Foam",
      "Dry Chemical Powder",
      "Wet Chemical (potassium acetate or potassium citrate solution)",
      "CO2"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The water instantly boils, causing a violent steam explosion that splatters burning oil all over the galley and the operator",
      "The water dissolves into the oil, making it burn hotter",
  ...
  },
  {
    ...
    "opts": [
      "CO2 is highly toxic when mixed with cooking oil",
      "CO2 freezes the oil into a solid, explosive block",
      "The high-pressure discharge can violently scatter the burning oil, and CO2 lacks the cooling capacity to prevent the super-heated oil from instantly re-igniting",
      "CO2 reacts with the oil to form lethal carbon monoxide"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A dry chemical powder duster",
      "A CO2 total flooding nozzle",
      "An automatic Wet Chemical suppression system (e.g., Ansul R-102)",
  ...
  },
  {
    ...
    "opts": [
      "Spray dry chemical powder immediately",
      "Connect the grounding strap to the extinguisher",
      "Isolate the electrical power supply to the panel if it is safe to do so",
      "Open the panel doors fully to ventilate the smoke"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It violently sinks to the bottom and cools the tank floor",
      "It dissolves the oil, turning it into non-flammable water",
      "It forms a continuous, unbroken physical blanket over the liquid surface, smothering the oxygen supply and sealing in the flammable vapors",
      "It interrupts the chemical chain reaction of the flame"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Automatic Fire-Fighting Fluid",
      "Aerated Flammable Fluid Foam",
      "Asynchronous Fire Fighting Formula",
  ...
  },
  {
    ...
    "opts": [
      "Foam that expands only when exposed to extreme freezing temperatures",
      "Foam with an expansion ratio of up to 20:1, creating a dense, wet blanket",
      "Foam with an expansion ratio of 200:1 to 1000:1",
      "Foam designed strictly for use inside electrical panels"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inside the galley deep fat fryers",
      "Inside the main switchboard",
      "Flooding entire large Ro-Ro vehicle decks",
      "In deck foam monitors on oil tankers to protect cargo deck surfaces, and in pump room foam boxes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Foam that expands only in a complete vacuum",
      "Foam that chemically expands to destroy electrical wiring",
      "Foam with an expansion ratio between 200:1 and 1000:1, creating massive volumes of light, dry bubbles",
      "Foam with an expansion ratio of up to 20:1"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inside portable 9-liter fire extinguishers",
      "Inside the fresh water generator",
      "On open weather decks to fight crude oil spills",
      "To rapidly flood and suffocate fires in large enclosed spaces like Ro-Ro vehicle decks and large machinery spaces"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It chemically reacts the liquid with magnesium stearate",
      "It uses a powerful blower fan to force ambient air through a mesh net that is continuously saturated with foam solution",
      "It uses high-pressure CO2 to violently whip the liquid",
      "It boils the liquid into steam bubbles using an electric heater"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Phosphorus Flame Output Suppressor",
      "Primary Fire Operating Sub-system",
      "Perfluorooctane Sulfonate",
      "Poly-Foam Oxidizing System"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It severely corrodes stainless steel piping",
      "It is a Persistent Organic Pollutant (POP) that does not break down in nature, accumulates in the food chain, and causes severe cancer and reproductive harm",
      "It reacts with seawater to form toxic chlorine gas",
      "It randomly explodes when stored in hot engine rooms"
    ],
  ...
  },
  {
    ...
    "opts": [
      "PFOS must be securely locked in the hazardous materials locker",
      "PFOS foam may only be used if mixed with 50% fresh water",
      "The use, storage, and carriage of PFOS-containing firefighting foam is strictly PROHIBITED; existing stocks must be removed to shore facilities by the first scheduled survey after this date",
      "PFOS foam is banned for training, but allowed in actual emergencies"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is perfectly acceptable if reported in the logbook",
      "It is a severe MARPOL violation, resulting in heavy fines and port state detention",
      "The foam dissolves harmlessly, requiring no further action",
      "It is only a violation if within 12 nautical miles of land"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "High-Sulfur Protein Foam",
      "Halon 1301",
      "C6 AFFF (shorter-chain fluorochemicals) or FFF (Fluorine-Free Foams)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Taste the foam slightly to detect fluorochemicals",
      "Check the manufacturer's Material Safety Data Sheet (MSDS/SDS) to explicitly verify the chemical composition contains 0% PFOS",
      "Check the electrical continuity of the foam tank grounding strap",
      "Measure the pH of the foam using a salinometer"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Foam is primarily composed of water; it is highly conductive and will electrocute the operator holding the hose/extinguisher",
      "Foam destroys the plastic insulation on the cables",
      "Foam reacts with copper wiring to form explosive gases",
      "Foam lacks the cooling capacity to stop electrical arcing"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Typically 1% to 6% concentrate mixed with 94% to 99% water",
      "Typically 50% concentrate mixed with 50% water",
      "100% pure concentrate sprayed directly from the nozzle",
      "Typically 20% concentrate mixed with 80% water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Fast Flowing Fire Protection",
      "Film-Forming Fluoroprotein Foam",
      "Fire Fighting Foam Powder",
      "Fluorine-Free Foam Product"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The foam will become twice as effective at cooling",
      "They may be chemically incompatible, turning into a thick, solid gel that permanently blocks the proportioning pumps and pipes",
      "The mixture will spontaneously combust",
      "The mixture will rapidly evaporate out of the tank vent"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It has a black panel and a long plastic horn",
      "It has a red body with a CREAM colored panel above the operating instructions",
      "It has a completely yellow body",
      "It has a blue panel and a pressure gauge"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A military-grade high-expansion foam banned on civilian ships",
      "A radioactive isotope used in smoke detectors",
      "A dry chemical powder specifically for Class D metal fires",
      "An Encapsulator Agent; a PFOS-free firefighting chemical that wraps around fuel molecules at a microscopic level, rendering them non-flammable and rapidly cooling the fire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The foam chemically expands the moment it touches light",
      "The nozzle contains an air-aspirating branchpipe (tiny holes); as the pressurized liquid shoots past the holes, it sucks in ambient air to agitate and aerate the mixture into foam",
      "The cylinder is pre-filled with compressed air bubbles",
      "The nozzle contains a small electric turbine to whip the liquid"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The entire cargo tank deck area and the cargo manifolds",
      "The fresh water ballast tanks",
      "The main engine room bilges",
      "The ship's funnel and exhaust stack"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The magnetic field strength; high gauss levels separate the proteins",
      "The humidity level; too much humidity will cause the foam to pre-expand in the tank",
      "The lighting level; UV light from fluorescent bulbs destroys PFOS",
      "The storage temperature; if the room freezes, the concentrate can separate, degrade, or freeze solid, destroying its firefighting capabilities"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The water will instantly turn into high-expansion foam",
      "The water jet will physically blast holes in the fragile foam blanket, destroying the seal, letting oxygen back in, and allowing the flammable oil vapors to instantly re-ignite",
      "The water will help the foam expand further",
      "The foam will freeze solid and act as a hard shield"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By using liquid nitrogen to freeze the fuel surface",
      "By creating a massive vacuum that sucks the flames out",
      "By relying heavily on dense, stable bubble structures (often protein or hydrocarbon-based) that physically block vapors, though they generally lack the ultra-fast 'film-forming' speed of old AFFF",
      "By reacting with the fuel to turn it into solid plastic"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Sweep the nozzle rapidly back and forth under the surface of the oil",
      "Shoot the foam forcefully directly into the center of the burning pool",
      "Aim the nozzle at a vertical surface behind the fire, or lob it gently so the foam falls lightly onto the liquid; NEVER shoot it directly down into the liquid, which would cause splashing",
      "Spray the foam into the air and let it drift down like rain"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the foam concentrate is stored at 200 bar and must be matched",
      "Because the fire pump uses the foam to lubricate its own bearings",
      "Because the venturi effect requires high-velocity water (typically 5 to 7 bar) to create enough suction vacuum to draw the thick, heavy foam concentrate out of its storage tank",
      "Because low pressure will cause the foam to explode inside the pipe"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An electronic sensor that detects the presence of foam",
      "A storage locker containing spare 9-liter foam extinguishers",
      "A machine that converts CO2 directly into solid foam blocks",
      "A fixed foam discharge unit permanently mounted above the bilges designed to gently pour a thick blanket of low-expansion foam over any leaked cargo oil pooling on the floor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The fire panel commands all sprinkler heads in the zone to open simultaneously",
      "The plastic nozzle melts completely away, opening the pipe",
      "A heat-sensitive glass bulb shatters (or a fusible link melts) when the ambient temperature reaches its rated limit, releasing a plug and allowing pressurized water to spray against a deflector plate",
      "An electronic smoke detector sends a 24V signal to open a solenoid valve on the head"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Sprinkler heads activate individually and locally only where heat shatters the bulb; Total Flooding dumps the entire suppression agent simultaneously into the entire space via open nozzles",
      "Sprinkler heads are operated manually by the bridge; CO2 is fully automatic",
      "Sprinkler heads only activate if smoke is detected; CO2 requires intense heat",
      "Sprinkler heads activate all at once to flood the ship; CO2 is only released from one small nozzle"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Bi-directional Loop Integrity Sensor",
      "Bridge Local Indicator Switch",
      "Bulk Line Isolation Stop (or Blank Line Indication System)",
      "Basic Liquid Injection System"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It measures the chemical purity of the sprinkler water",
      "It turns on the emergency generator if the sprinkler pump fails",
      "It triggers a supervisory alarm on the fire panel immediately if anyone accidentally or deliberately turns the main sprinkler isolation valve towards the 'Closed' position",
      "It detects if the glass bulbs on the sprinkler heads have been painted over"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By electrically shorting the flow switch at the section valve",
      "By opening the 'End-of-Line Test Valve' (Test Cock) located at the furthest point of the zone piping; this simulates a popped head by flowing water into a drain",
      "By over-pressurizing the system until the relief valve lifts",
      "By using a blowtorch to gently warm the glass bulb until the alarm rings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An acoustic sensor that listens for the sound of shattering glass",
      "A tiny microchip embedded in each glass bulb",
      "A 'Paddle-type Water Flow Switch' installed in the branch pipe serving that specific zone; moving water physically pushes the paddle and closes an electrical contact",
      "A temperature sensor mounted next to the main pump"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They provide a massive total surface area compared to large droplets, allowing them to instantly absorb colossal amounts of heat from the fire by rapidly flashing into steam",
      "They electrically conduct the heat straight into the ship's hull",
      "They chemically bind with the carbon to form a solid crust",
      "They are heavier than air and crush the flames physically"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The water chemically strips oxygen molecules out of the air",
      "When the micro-droplets boil, the water expands approximately 1700 times in volume into steam, creating a dense localized steam cloud that forcefully pushes oxygen away from the base of the fire",
      "The system pumps pure nitrogen gas alongside the water",
      "The fog droplets are so heavy they sink and compress the oxygen into the bilge"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water mist makes the floor less slippery for escaping crew",
      "Water mist completely eliminates the risk of electrocution",
      "Water mist is non-toxic and completely breathable; it can be activated instantly while crew members are still inside the engine room, unlike CO2 which requires a full, time-consuming evacuation",
      "Water mist actively produces breathable oxygen for the crew"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes; but only if the water is mixed with 50% foam concentrate",
      "No; any form of water will always scatter oil fires violently",
      "Yes; because the droplets are microscopic and light, they do not crash into and scatter the burning liquid like a heavy, solid jet of water would",
      "No; the water mist chemically accelerates petroleum combustion"
    ],
  ...
  },
  {
    ...
    "opts": [
      "All ships, including small fishing vessels and tugboats",
      "Only vessels carrying dangerous chemicals",
      "Only Passenger ships over 10,000 GT",
      "All Passenger ships, and all Cargo ships over 200 GT"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Pressurized air, which must vent before water can enter",
      "High-pressure CO2 gas",
      "A dry chemical powder mixture",
      "Pressurized fresh water, ready to discharge the exact millisecond the bulb shatters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The massive 100kW main fire pump runs continuously 24/7",
      "Compressed air from the starting air receivers",
      "A small 'Jockey Pump' (or pressure maintenance pump) connected to a hydro-pneumatic pressure tank",
      "Gravity from a tank located on the highest mast"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Main Sprinkler Pump starts, then hands over to the Jockey Pump",
      "The small Jockey Pump starts first; if it cannot keep up and pressure continues to drop below a set limit, the massive Main Sprinkler Pump automatically starts to deluge the fire",
      "The Emergency Fire Pump starts immediately, bypassing the main pumps",
      "The main sea water cooling pumps divert to the sprinkler system"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "A coloured glycerine-based liquid with a small, carefully calculated air bubble inside",
      "Liquid nitrogen"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It completely eliminates the risk of electrical short circuits",
      "It is safer for crew (no asphyxiation risk), causes no environmental harm (zero global warming/ozone potential), and does not require extensive pre-release sealing of the engine room",
      "It requires absolutely no maintenance or electrical power to operate",
      "It is significantly cheaper to install and requires smaller pipes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Larger droplets generate static electricity that disrupts the flame",
      "Smaller droplets sink to the bottom of the fire faster",
      "Larger droplets carry more momentum, crushing the fire physically",
      "Smaller droplets have a drastically higher surface-area-to-volume ratio, allowing them to absorb heat and vaporize into steam exponentially faster than large droplets"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The pipes are kept completely empty and unpressurized until a button is pushed",
      "The pipes carry dry chemical powder instead of water; used in the main switchboard room",
      "The system only discharges steam; used in the engine room",
      "The pipes are filled with pressurized air instead of water to prevent freezing; used in unheated areas like Ro-Ro decks or open weather decks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The panel will show a yellow 'Fault' light but no water will flow",
      "Only a local buzzer will sound inside the cabin",
      "Water will immediately flood the cabin, and the resulting water flow will trigger the zone's flow switch, sounding a full Fire Alarm on the bridge",
      "The system will recognize it as an accident and isolate the cabin automatically"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It can only be powered by shore power",
      "It must be powered entirely by 24V DC batteries",
      "It must be mechanically connected directly to the main propeller shaft",
      "It must be capable of being supplied by BOTH the main source of electrical power and the emergency source of electrical power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses high-pressure CO2 instead of water",
      "It is completely submerged underwater at all times",
      "All sprinkler heads are 'open' (no glass bulbs); the system is dry until a separate fire detection system opens a main deluge valve, simultaneously flooding the entire protected area",
      "It only operates if manually activated by the master's key"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By slightly opening a test drain valve on the main header to drop the system pressure; the jockey pump will start first, followed by the main pump as pressure continues to fall",
      "By pressing the 'Test' button on the pump's VFD screen",
      "By short-circuiting the pressure switch with a jumper wire",
      "By closing the main suction valve to create a vacuum"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Checking the chemical expiration date of the water",
      "Ensuring the glass bulbs are painted red",
      "Ensuring the microscopic nozzle orifices are not clogged by dirt, scale, or painted over, which would ruin the atomization pattern",
      "Greasing the swivel joints so they can spin"
    ],
  ...
  },
  {
    ...
    "opts": [
      "At the lowest possible point in the main engine room bilges",
      "In a dedicated space OUTSIDE the main machinery space (typically in the forward peak or steering flat), ensuring a fire in the engine room cannot disable it",
      "Next to the main switchboard for easy access",
  ...
  },
  {
    ...
    "opts": [
      "It can be powered from the main switchboard provided the cables are fireproof",
      "It must be mechanically belted to the main propeller shaft",
      "It must be independently powered; typically driven by its own dedicated diesel engine, or by an electric motor fed strictly from the Emergency Generator",
      "It must run entirely on 24V DC batteries"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Not less than 15.0 MPa (approx. 150 bar)",
      "Not less than 0.3 MPa (approx. 3.0 bar)",
      "Not less than 0.1 MPa (approx. 1.0 bar)",
      "Not less than 1.0 MPa (approx. 10.0 bar)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be capable of filling the swimming pool in 10 minutes",
      "It must be able to flood the entire engine room in 5 minutes",
      "It must be capable of supplying two fire hose jets simultaneously with adequate pressure",
      "It must supply 10 hoses simultaneously"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be manually flooded with drinking water before every use",
      "It must have a heavy lead weight attached to the impeller",
      "It must be self-priming (e.g., using a built-in liquid ring, gear pump, or exhaust-gas ejector system) to suck water up an empty pipe",
      "It must use a high-pressure air compressor to blow water up"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It measures the depth of the water under the ship",
      "It filters out large fish and seaweed from entering the pump",
      "It allows the pump to be operated by a foot pedal in an emergency",
      "It is a non-return (check) valve located at the very bottom of the suction pipe in the sea; it prevents water from draining out of the pipe when the pump stops, maintaining the prime"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Run the pump with all valves closed and check the pressure gauge",
      "Measure the electrical resistance of the motor windings",
      "Start the pump (auto or manual), open two fire hydrants on the highest deck, and physically verify visually that two strong jets of water are produced",
      "Just look at the green 'Running' light on the starter panel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The primary valve used by the Oily Water Separator",
      "A massive isolation valve that connects the suction side of the Main Sea Water Cooling pump directly to the engine room bilge, used strictly for emergency dewatering during catastrophic flooding",
      "A valve that routes clean seawater into the bilge to wash it",
      "A small valve used to inject chemicals into the bilge water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To satisfy aesthetic class society rules",
      "To prevent the valve handle from vibrating loose",
      "To prevent accidental opening; using it illegally dumps completely unfiltered, oily bilge water straight into the ocean, bypassing the OWS, causing a massive MARPOL violation",
      "Because the valve is fragile and breaks easily"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Open them fully to maximize flow",
      "Remove them completely from the pipework",
      "Bypass them using the fresh water generator",
      "Close the sea chest suction valve to stop seawater from entering, and close the discharge valve to the engine coolers to prevent oily bilge sludge from clogging the heat exchangers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A standardized electrical plug for shore power",
      "A satellite radio system for calling the coast guard",
      "A universal coupling for pumping sewage ashore",
      "A universally standardized steel flange adapter carried on all ships that allows any shore-based fire brigade anywhere in the world to connect their fire hoses to the ship's fire main"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Outside Diameter: 178 mm. Inner Bore Diameter: 64 mm",
      "Outside Diameter: 150 mm. Inner Bore Diameter: 75 mm",
      "Outside Diameter: 100 mm. Inner Bore Diameter: 50 mm",
      "Outside Diameter: 200 mm. Inner Bore Diameter: 100 mm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Pitch Circle Diameter: 132 mm. Number of bolts: 4",
      "Pitch Circle Diameter: 150 mm. Number of bolts: 6",
      "Pitch Circle Diameter: 100 mm. Number of bolts: 8",
      "Pitch Circle Diameter: 120 mm. Number of bolts: 2"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Bolt diameter: 12 mm. Flange thickness: Minimum 10.0 mm",
      "Bolt diameter: 20 mm. Flange thickness: Minimum 20.0 mm",
      "Bolt diameter: 16 mm. Flange thickness: Minimum 14.5 mm",
      "Bolt diameter: 10 mm. Flange thickness: 5.0 mm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must contain fuel for 1 hour of operation",
      "It must have 24 hours of fuel in a single day tank",
      "It must contain sufficient fuel to run the pump on full load for at least 3 hours, with reserve fuel stored safely outside the main machinery space for an additional 15 hours",
      "It must be connected directly to the ship's main heavy fuel bunker"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The sprinkler system activates automatically",
      "A pressure switch on the fire main detects the drop and automatically starts the Main Fire Pump (or Emergency Fire Pump on some setups) to restore pressure instantly",
      "The ship's general alarm sounds",
      "The main engine slows down"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent seawater from entering the engine room during normal sailing",
      "To act as a pressure relief valve for the entire system",
      "To route the fire water directly into the cargo holds",
      "To separate the engine room fire main section from the deck fire main section; if the engine room piping ruptures in a fire, closing this valve ensures the deck hoses still have pressure from the emergency pump"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The short circuit fuses",
      "The phase failure relay",
      "The under-voltage release coil",
      "The Thermal Overload Relay (OLR) trip function is often bypassed or set to 'Alarm Only'; in a fire, it is better to let the motor burn itself out pumping water than to have it safely trip and let the ship burn"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It injects foam concentrate directly into the water stream",
      "It relieves trapped air to help the pump prime faster",
      "It drains the water to prevent freezing in winter",
      "It prevents the pump from building up extreme, pipe-bursting pressure if it is run while all the fire hydrants are closed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By isolating the power at the starter panel and using a 500V DC Megger to measure the resistance between the motor phases and the hull ground; it should be > 1 Mega-Ohm",
      "By using a standard digital multimeter set to AC volts",
      "By turning the pump on and measuring the running amps",
      "By touching the casing to see if it is electrically 'hot'"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The bilge will fill with pressurized seawater",
      "The ship will immediately sink due to back-flooding",
      "The main switchboard will short circuit",
      "The main cooling pump will suck air or oily sludge from the bilge instead of clean seawater, causing the main engine coolers to starve of water and the engine to overheat drastically"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To allow the crew to completely drain the water out of the exposed pipes during winter/arctic sailing, preventing the water from freezing, expanding, and splitting the heavy steel pipes open",
      "To provide drinking water to the crew during lifeboat musters",
      "To bleed off excessive water pressure created by the main pump",
      "To sample the water for salt content"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A small 220V heating coil that turns ON when the motor is OFF, keeping the internal copper windings warm and dry to prevent salty moisture from destroying the insulation resistance",
      "A heater that pre-warms the diesel fuel for easier starting",
      "A thermal relay that trips the motor if it gets too hot",
      "A heater that warms the seawater to prevent the pump from cracking"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Verify the functionality of the engine block jacket water heater and the condition of the starting batteries, as cold temperatures severely reduce battery cranking amps and make diesel hard to ignite",
      "Run the pump continuously 24/7 to keep the water moving",
      "Drain all the diesel fuel to prevent it from freezing"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is positioned deep underwater below the ship's keel",
      "It requires a crew member to pour a bucket of water into it",
      "It possesses an integrated priming mechanism (like a liquid ring vacuum pump or exhaust gas ejector) that actively sucks air out of the suction pipe until solid water reaches the impeller",
      "It is painted a specific shade of bright yellow"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The pump will run significantly faster and more efficiently",
      "The fire main will instantly over-pressurize and burst",
      "When the pump stops, all the water in the suction pipe will drain back into the sea; the pump will lose its prime and may fail to deliver water quickly upon the next restart",
      "The seaweed will chemically react with the bronze impeller"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To cap off broken fire hoses during an emergency",
      "To act as a spare part for the main fire pump casing",
      "To seal the ship's side of the ISC connection point when it is not in use, ensuring the ship's fire main maintains pressure and doesn't leak water onto the deck",
      "To block the engine exhaust pipe from taking in water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A brief operational test is typically conducted weekly, with a full-pressure test (proving two jets of water on deck) conducted monthly",
      "Once a year during drydock",
      "Only when a port state control inspector requests it",
      "Daily, before the master signs the logbook"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The bronze impeller will violently explode",
      "The mechanical shaft seals rely on water for lubrication and cooling; running dry will cause them to overheat, melt, and shatter, destroying the pump's watertight integrity",
      "Nothing; centrifugal pumps are designed to run on air indefinitely",
      "The motor will draw excessive current and trip the breaker"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are mechanically driven by belts from the main engine shaft",
      "They are driven by small independent steam turbines",
      "They are powered directly from the Main Switchboard (440V AC), utilizing large induction motors",
      "They run exclusively on 24V DC battery banks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It acts as a flashing LED to show the detector is working",
      "It provides a stable reverse-bias voltage drop, allowing the fire panel to distinguish exactly between a normal 'Healthy' state, a 'Fire Alarm' (short circuit), and a 'Fault' (open circuit)",
      "It amplifies the smoke signal so it can travel longer distances",
      "It generates a high-voltage spark to burn off dust inside the detector"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It boosts the voltage to push the signal back to the bridge",
      "It absorbs excess smoke particles to prevent false alarms",
      "It acts as a lightning arrestor for the final detector",
      "It allows a tiny, continuous monitoring current to flow through the entire length of the zone wiring; if the wire breaks anywhere, the current stops, and the panel instantly flags a 'Line Fault'"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are identical; the crew must figure it out by reading the manual",
      "A Fire is flashing green; a Fault is solid green",
      "A Fire is indicated by a RED LED and a loud, continuous alarm tone; a Fault is indicated by an AMBER/YELLOW LED and a distinct, intermittent buzzer tone",
      "A Fire rings the ship's whistle; a Fault drops the ship's anchor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The panel will turn off completely to prevent electrocution",
      "The panel will indicate 'High Humidity' and start the AC fans",
      "The water can bridge the electrical contacts, creating a partial or full short circuit that the panel interprets as a genuine 'Fire Alarm'",
      "The panel will display a 'Low Battery' warning"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It stores spare Americium-241 radioactive isotopes",
      "It filters out toxic chemicals from the smoke",
      "It mixes fresh air with the smoke to cool it down",
      "It collects and safely drains liquid condensation that forms inside the sampling pipes due to temperature differences, preventing water from being sucked into the sensitive optical laser chamber"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Spray the switchboard with a water hose",
      "Raise the fire alarm and inform the Bridge and Chief Engineer immediately",
      "Open all the panel doors to ventilate the smoke",
      "Hit the emergency stop on the main engine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water and Foam (AFFF); they are highly conductive and will electrocute the operator and cause massive short circuits",
      "CO2 and Dry Chemical Powder",
      "Sand and FM-200",
      "Halon and Novec 1230"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Isolate the power to that specific section (trip the feeder or tie-breaker) using insulated tools/PPE, then attack the flames using a portable CO2 extinguisher",
      "Flood the entire engine room with the fixed CO2 system",
      "Initiate a total ship blackout immediately without looking",
      "Throw a fire blanket completely over the switchboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Initiate a total ship BLACKOUT by hitting the remote emergency stops for all running generators, completely de-energizing the massive electrical energy feeding the arc fire",
      "Open the sea chests to flood the bottom of the engine room",
      "Run away and seal the engine room doors forever",
      "Start all standby generators to increase power to the sprinklers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "All watertight doors will spring open",
      "The ship's main engine will automatically go to Full Ahead",
      "The CO2 total flooding system will auto-release",
      "The Emergency Generator will auto-start (within 45 seconds) and power the Emergency Switchboard, restoring critical lighting, steering, and the Emergency Fire Pump"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Burning electrical insulation (PVC and rubber) produces extremely toxic and corrosive gases, such as Hydrogen Chloride and Carbon Monoxide, which are lethal to inhale",
      "To blow the CO2 gas back into the fire extinguishers",
      "To dry out the water used to fight the fire",
      "To cool the copper busbars so they don't melt"
    ],
  ...
  },
  {
    ...
    "opts": [
      "DCP freezes the copper wires, causing them to shatter",
      "DCP leaves a thick, corrosive, and abrasive dust coating over everything; it will permanently destroy delicate relays and contactors, requiring a massive, expensive cleanup effort before power can be restored",
      "DCP is highly electrically conductive and will shock the user",
      "DCP chemically reacts with copper to create explosive gas"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Each detector has its own dedicated copper wire running all the way back to the bridge",
      "The panel uses GPS to locate the smoke",
      "The panel measures the exact length of the wire using voltage drop",
      "Each detector has a unique microchip with a digital address (e.g., ID: 142); it communicates via data packets on the loop, telling the panel exactly 'Who' and 'Where' it is"
    ],
  ...
  },
  {
    ...
    "opts": [
      "If the cable is accidentally cut in one place, the panel can still communicate with all detectors by sending signals down both the 'forward' and 'return' sides of the broken loop",
      "It doubles the electrical voltage, making alarms louder",
      "It prevents static electricity from building up on the wires",
      "It allows the detectors to power themselves without a battery"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A smart switch that detects a dead short-circuit on the wiring and instantly disconnects the broken section, preventing the short from dragging down the voltage of the entire loop",
      "A module that isolates the panel from lightning strikes",
      "A switch that mutes the alarm bell",
      "A device that separates smoke signals from heat signals"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By blowing cigar smoke into it",
      "By using an approved aerosol 'Test Smoke' spray (simulated smoke particles) directed into the sensing chamber; NEVER use a real candle or naked flame",
      "By using a blowtorch to simulate real fire conditions",
      "By spraying high-pressure water mist at the ceiling"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By short-circuiting the wires with a screwdriver",
      "By pouring boiling water over the sensor casing",
      "By wrapping the sensor in a heated blanket for 24 hours",
      "By using an approved portable heat gun or specialized hot-air blower held near the sensor until it triggers; again, NEVER use an open flame"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It shuts down the main engine directly",
      "It acts identically to an automatic detector triggering; it creates a short circuit (or sends an active digital signal) that instantly sounds the fire alarm for that zone on the bridge panel",
      "It releases the CO2 total flooding system automatically",
      "It calls the nearest shore-based fire department via satellite"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is powered by a hand-cranked generator",
      "It must be powered entirely by solar panels",
      "It must be powered by the main AC source AND have a dedicated automatic switchover to a backup 24V DC battery supply capable of running the system during a total blackout",
      "It relies solely on the Emergency Diesel Generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A mechanical fan that blows smoke out of the window",
      "A detector that sniffs the air for specific toxic chemicals",
      "An ultra-sensitive system that uses a vacuum fan to actively suck air samples from the room through a pipe network into a central, highly precise laser detection chamber",
      "A detector that sprays chemical aerosols into the air to neutralize smoke"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Check the internal air filter (replace if clogged), ensure the vacuum aspirator fan is running, and physically inspect the sampling pipe network for blockages or crushed pipes",
      "Adjust the Zener diode voltage on the main board",
      "Increase the voltage to the laser diode",
      "Pour water down the sampling pipe to clean it"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It requires TWO independent detectors in the same area to trigger simultaneously before dumping the water; this prevents a single faulty sensor from accidentally flooding the running machinery",
      "It requires the fire to cross over a painted line on the deck",
      "It ensures the alarm rings in both the Port and Starboard alleyways",
      "It links the fire alarm to the ship's main steering gear"
    ],
  ...
  },
  {
    ...
    "opts": [
      "That the ship is running aground in shallow water",
      "That the batteries are fully charged and resting on the deck",
      "That the main switchboard is perfectly grounded",
      "That the bare copper of the fire alarm wiring is touching the ship's steel hull somewhere; this must be traced and fixed, as a second earth fault could short out the system and cause false alarms or dead zones"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It isolates the main engine from the propeller shaft",
      "It shuts all the watertight doors on the ship",
      "It permanently deletes the detector from the ship's memory",
      "It allows the ETO to temporarily mute or ignore a specific broken detector or zone while repairs are made or dusty work (like welding) is performed, preventing continuous false alarms"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because SOLAS noise regulations limit alarms to 5 seconds",
      "To signal to the firefighters that the bridge has abandoned ship",
      "Because the noise drains the backup battery too quickly",
      "To allow the navigating officers to communicate clearly on radios and phones during the emergency; however, the flashing RED light will remain on until the physical fire is actually extinguished and reset"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A timer automatically dumps the gas every Friday at noon",
      "The heat detector inside the locker triggers an automatic solenoid to dump the gas",
      "It is completely manual; an operator must physically go to the release station outside the locker and pull the handle. CO2 is never set to automatic release on ships due to the lethal asphyxiation hazard",
      "The bridge pushes a digital button on the radar screen"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It sends a massive high-voltage shock to burn the soot out of the detectors",
      "It calls the engine room to ask for permission to reset",
      "It formats the hard drive and deletes all historical fire records",
      "The panel momentarily drops the 24V power supply to the entire detector loop (for about 3 seconds), forcing all activated smoke and heat detectors to unlatch and clear their memory"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The panel's microprocessor crashed and rebooted",
      "A massive explosion destroyed the detector instantly",
      "The CO2 system automatically put the fire out in 5 seconds",
      "A transient issue; perhaps a puff of steam, a heavy vibration, or a loose wire momentarily triggered the sensor before clearing naturally"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Deep-seated electrical fires producing large chunks of soot",
      "Slow-smouldering fires producing thick, heavy smoke",
      "Chemical fires producing invisible, odorless toxic gases",
      "Fast-flaming fires producing very small, invisible combustion particles"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An LED (Light Emitting Diode) and a photodetector arranged in a dark chamber",
      "A bimetallic strip and a microswitch",
      "An Americium source and two charged electrodes",
      "A laser and a moving mirror assembly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Explosive gas flashes",
      "Slow-smouldering fires that produce large, visible smoke particles",
      "High-heat alcohol fires with no visible smoke",
      "Metal fires (Class D)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is less prone to false alarms caused by cooking steam or high humidity",
      "It is completely waterproof and IP68 rated",
      "It operates much faster in high-heat environments",
      "It can detect the chemical signature of burning cooking fat"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A bimetallic strip or a fusible metal link",
      "A vibrating piezoelectric crystal",
      "A mercury tilt switch",
      "An expanding gas bladder"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It detects rapidly developing fires much earlier, long before the absolute room temperature reaches the fixed limit",
      "It can be installed directly inside a boiler exhaust stack",
  ...
  },
  {
    ...
    "opts": [
      "A detector that features both Rate-of-Rise and Fixed-Temperature sensing, triggering an alarm if either condition is met",
      "A unit that sprays water while simultaneously detecting heat",
  ...
  },
  {
    ...
    "opts": [
      "A tube pumps continuous air; a fire blocks the flow, triggering an alarm",
      "A tube filled with water boils, sending steam to a sensor",
      "A long, sealed tube is run along the deckhead; fire heats the trapped air inside, which expands and pushes a diaphragm to actuate a pressure switch",
      "A plastic tube melts, dropping air pressure to trigger an alarm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It pinpoints the exact millimeter where the fire started",
      "It is simple, robust, requires no electrical wiring along the deckhead, and is ideal for very large, harsh machinery spaces",
      "It automatically repairs itself after the fire is extinguished",
      "It reacts in milliseconds to tiny puffs of smoke"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The physical heat of the flames touching the sensor",
      "The sudden drop in oxygen concentration in the room",
      "Ultraviolet (UV) or Infrared (IR) electromagnetic radiation emitted directly by the combustion process",
      "The exact sound frequency of a roaring fire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Thick black smoke and steam",
      "High ambient engine room temperatures",
      "Direct sunlight, arc welding, lightning, and certain types of unshielded fluorescent lights",
      "Loud noises and severe engine vibration"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By aiming a specially calibrated, manufacturer-supplied UV Test Lamp at the detector window from a prescribed distance",
      "By lighting a piece of paper on fire under the sensor",
      "By using a standard high-power LED flashlight",
      "By short-circuiting the sensor terminals with a jumper wire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It causes the fire alarm panel to permanently lock up",
      "It creates a massive, genuine fire risk near fuel/vapors, and the excessive heat can permanently damage or destroy the delicate sensor housing",
      "The flame is not hot enough to trigger marine-grade sensors",
      "It drains the ship's oxygen supply"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To ensure the glass doesn't shatter from thermal shock",
      "An invisible film of engine oil or dust heavily attenuates (blocks) UV light, blinding the sensor to a real fire",
      "To allow the internal laser to escape the housing",
      "To prevent static electricity from building up on the glass"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By covering the detector with a dark cloth for 10 seconds",
      "By blowing cigarette smoke into the detector",
      "By spraying an approved, synthetic 'Test Smoke' aerosol directly into the detector's sensing chamber",
      "By burning a specialized smoke pellet on the floor below"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Candles generate a magnetic field that disrupts the electronics",
      "The soot and tar permanently contaminate the sensing chamber, and can coat the radioactive Am-241 source, ruining its calibration and safety",
      "Real smoke contains too much oxygen to trigger the alarm",
      "The heat of the candle will melt the radioactive isotope"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Using a standard industrial blowtorch held 10cm away",
      "By shorting the internal thermistor wires",
  ...
  },
  {
    ...
    "opts": [
      "A high-efficiency fan actively draws air samples continuously through a pipe network into a highly sensitive, centralized laser detection chamber",
      "It uses underwater sonar technology adapted for dense smoke",
      "It sprays a chemical mist that reacts audibly when touching smoke",
      "It blasts ultrasonic sound waves across the ceiling to listen for the crackle of fire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By removing the main laser and cleaning it",
      "By introducing approved synthetic test smoke aerosol directly into the furthest sampling hole of the pipe network to ensure the pump draws it back to the panel",
      "By spraying water into the pipes to clear dust",
      "By blocking all the holes to test the vacuum pressure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The system automatically switches to a backup optical sensor",
      "The system triggers a full fire alarm to evacuate the space",
      "The airflow drops below limits, and the panel triggers a 'Low Flow Fault' alarm, indicating the room is no longer being actively sampled",
      "The vacuum fan reverses direction to blow the filter clean"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because UV sensors do not require any electrical power",
      "Because the hot refractory bricks inside the furnace glow bright orange/red, which would fool a visible/IR sensor, but they emit virtually zero UV radiation",
      "Because heavy fuel oil smoke completely blocks all infrared light",
      "Because UV light can bend around corners in the furnace"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The emergency generator room and the steering flat",
      "Engine room bilges, purifier rooms, boiler fronts, and tanker pump rooms where highly flammable liquids could cause instantaneous explosive fires",
      "Passenger cabins, mess rooms, and the bridge",
      "Paint lockers, dry provision stores, and the funnel uptake"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inside the main switchboard panels",
      "In the cargo control room and radio room",
      "In galleys, laundries, and engine room workshop areas where normal steam, dust, or welding fumes would cause constant false alarms for smoke detectors",
      "In the hospital and accommodation corridors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, it emits only low-energy alpha particles which cannot penetrate the plastic casing or human skin; it is entirely safe unless the detector is broken open and the source is ingested or inhaled",
      "No, because the radiation naturally expires completely every 2 years",
      "Yes, the ETO must wear a lead-lined apron when changing the detector",
      "Yes, it emits high-level gamma radiation that ruins mobile phones"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "1:1700",
      "1:200",
      "1:450 (One liter of liquid expands to 450 liters of gas)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Minimum 10% CO2 by volume",
      "Minimum 50% CO2 by volume",
      "Minimum 34% CO2 by volume",
      "Minimum 85% CO2 by volume"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Daily; by checking the main control panel for fault lights",
      "Annually; they must be physically weighed, or checked with an approved liquid level indicator",
      "Every 5 years; by discharging a test cylinder",
      "Monthly; by reading the pressure gauges on each cylinder"
    ],
  ...
  },
  {
    ...
    "opts": [
      "If its weight shows a loss of more than 10% of its original stamped charge weight",
      "If it loses more than 50% of its weight",
      "If it loses more than 1% of its weight",
      "If the pressure drops below 50 bar"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Exhaust Valve and the Intake Valve",
      "The High Pressure Valve and the Low Pressure Valve",
      "The Red Valve and the Green Valve",
      "The Pilot Valve (which opens the pilot gas lines and sounds the alarm) and the Main Valve (which opens the manifold to flood the space)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The ship's main engine instantly shuts down",
      "A distinct, loud pre-discharge alarm sounds in the protected space, and a time delay (usually 20-30 seconds) begins before the gas can release",
      "The main cylinder bank immediately empties into the engine room",
      "All the watertight doors spring open"
    ],
  ...
  },
  {
    ...
    "opts": [
      "CO2 is a lethal, asphyxiating gas; the delay provides the only chance for any remaining crew members to evacuate the engine room before it floods",
      "It allows the fire to grow large enough for the CO2 to work effectively",
      "It gives the main engine time to cool down slowly",
  ...
  },
  {
    ...
    "opts": [
      "Check the level of the heavy fuel oil tanks",
      "Email the company technical superintendent for permission",
      "Perform a physical headcount to ensure EVERY single crew member is accounted for and safely outside the protected space",
      "Test the CO2 alarm panel using the lamp-test button"
    ],
  ...
  },
  {
    ...
    "opts": [
      "All exhaust fans must be run at maximum speed to pull the CO2 in",
      "All fans must be stopped, and all fire dampers, skylights, and louvers must be tightly closed to perfectly seal the space",
      "The skylights must be opened fully to let the smoke out",
      "The air conditioning must be switched to recirculate mode"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the fuel pumps run on CO2 pressure",
      "To stop feeding combustible fuel to the fire; starvation is the first step before smothering",
      "To protect the ship's fuel reserve for the rest of the voyage",
      "To prevent the CO2 from freezing the fuel in the pipes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Pull the Main Valve lever immediately",
      "Wait 24 hours for the fire to cool",
      "Shut off the lights in the CO2 room",
      "Break the glass, open the cabinet door, and verify the 'Selector Valve' is pointing to the correct space (e.g., Engine Room vs. Cargo Hold 2)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It physically locks the engine room doors to prevent escape",
      "It releases gas from 1 or 2 small pilot cylinders, which travels down pneumatic lines to physically push open the heavy brass valves on the 100+ main cylinders simultaneously",
      "It ignites a small flare to burn off excess oxygen",
      "It measures the exact weight of the gas being deployed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "1 hour",
      "They can enter immediately if they hold their breath",
      "15 minutes",
  ...
  },
  {
    ...
    "opts": [
      "Just a dust mask and a flashlight",
      "Nothing, provided they leave the door open for 5 minutes first",
      "Full Self-Contained Breathing Apparatus (SCBA) sets and a lifeline, as the engine room will still be completely filled with lethal CO2 gas",
      "A 15-minute EEBD hood"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It ensures the CO2 gas is routed only into the specific space that is on fire (e.g., Hold 3), preventing it from being wasted in healthy compartments",
      "It selects whether to use CO2, foam, or water mist",
      "It switches the power supply to the emergency generator",
      "It allows the crew to select the exact percentage of CO2 required"
    ],
  ...
  },
  {
    ...
    "opts": [
      "On the main navigation bridge only",
      "Inside the paint locker next to the exhaust fan",
      "Outside the paint locker, typically at the access door, so it can be operated safely without entering the burning space",
      "Deep inside the main engine room bilges"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It physically scrubs the soot off the copper busbars",
      "It is the cheapest fire extinguishing agent to manufacture",
      "It leaves absolutely no residue, powder, or water damage, allowing delicate electronic equipment to survive the extinguishment process",
      "It converts the toxic smoke into pure oxygen"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses an optical strobe light that absorbs ambient heat to flash",
      "It relies on the ship's 440V main busbar exclusively",
      "It uses a hand-cranked siren operated by the Chief Engineer",
      "It is typically a loud pneumatic horn powered directly by the pressurized CO2 gas from the pilot cylinder, requiring zero electricity to operate"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The door must slide vertically on hydraulic tracks",
      "The door must be padlocked from the outside with no internal handle",
      "The door MUST open outwards (away from the room), preventing the crew from being trapped inside if the pressure rises or cylinders leak",
      "The door must open inwards to trap the CO2 gas inside the room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They must be removed from the ship, emptied, and subjected to a strict Hydrostatic Pressure Test to prove the steel casing hasn't weakened",
      "They must be thrown overboard as artificial reefs",
      "They must be weighed twice in one day",
      "They must be painted a bright neon yellow"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To allow the Chief Engineer to sleep closer to the controls",
      "To save space on the bottom platform for fuel purifiers",
      "So that an engine room fire cannot cut off access to the release controls or overheat the cylinders and cause them to explode",
      "Because the main switchboard magnetic field interferes with the cylinders"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A specialized tool or lever is provided to allow an engineer to physically, manually actuate the master cylinder valves to bypass the pneumatic pilot system",
      "The engineer must cut the pipes with a hacksaw to let the gas out",
      "There is a secondary, identical CO2 room on the opposite side of the ship",
      "The system automatically drops the anchor to signal for help"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A red cylinder with a CREAM colored panel above the operating instructions",
      "A yellow cylinder with a red handle",
      "A completely solid blue cylinder",
      "A red cylinder with a BLACK colored panel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A black cylinder with a red panel",
      "A green cylinder with a metal nozzle",
  ...
  },
  {
    ...
    "opts": [
      "A blue cylinder with a white handle",
      "A completely white cylinder",
      "A red cylinder with a BLUE colored panel",
      "A red cylinder with a CREAM colored panel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A red cylinder with a YELLOW colored panel",
      "A completely silver cylinder",
      "A yellow cylinder with a black panel",
      "A red cylinder with a GREEN panel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Grip the widest part of the plastic horn to aim it precisely at the top of the flames",
      "Hold it upside down and spray it over the top of the fire like rain",
      "Hold it by the insulated handle or grip, aim the horn at the BASE of the flames, and sweep side-to-side",
      "Rest the horn directly against the burning material"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Sodium Bicarbonate or Potassium Bicarbonate powder, mixed with Magnesium Stearate and pressurized by Nitrogen gas",
      "Crushed glass and aluminum oxide",
      "Calcium carbonate pressurized with pure Oxygen",
      "Pure carbon dust mixed with liquid water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It makes the powder burn hotter, destroying the fire faster",
      "It acts as a water-repellent, anti-caking 'flow agent' that prevents the powder from compacting into a solid brick due to engine room vibration and humidity",
      "It dissolves the oil in a Class B fire into harmless water",
      "It provides the blue color to the powder for visibility"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Invert the cylinder and tap or shake it firmly to agitate the powder, ensuring it remains free-flowing and hasn't settled at the bottom",
      "Paint the cylinder red to prevent rusting",
      "Spray a small amount of powder out to test the nozzle",
      "Top up the pressure with the ship's compressed air line"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water mixed with a small percentage of AFFF (Aqueous Film-Forming Foam) concentrate, pressurized by a gas cartridge or stored pressure",
      "Pure liquid CO2 mixed with soap",
      "High-pressure steam and detergents",
      "Dry chemical powder mixed with expanding polyurethane"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It forms a light, continuous physical blanket floating on top of the oil, smothering the oxygen supply and sealing the hot, flammable vapors inside the liquid",
      "It freezes the oil into a solid plastic block",
      "It sinks to the bottom of the tank and cools the metal from below",
      "It chemically reacts with the oil to turn it into CO2 gas"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Pure distilled water and baking soda",
      "An alkaline solution of Potassium Acetate or Potassium Citrate",
  ...
  },
  {
    ...
    "opts": [
      "Through 'Saponification'; the chemical reacts with the hot fat to instantly create a thick, soapy, non-flammable crust over the surface, while the water content provides rapid cooling",
      "Through 'Oxidation'; it burns up all the fat instantly",
      "By freezing the deep fryer to absolute zero",
      "By starving the fire of oxygen using a heavy cloud of CO2"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water; to provide maximum cooling to the steel plates",
      "CO2; it is electrically non-conductive, smothers the fire, and leaves absolutely no residue to damage the surviving electronics",
      "Foam; because the bilges are oily",
      "Wet Chemical; to saponify the melting plastic cables"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Although it safely extinguishes the fire without electrocuting the user, the powder residue is highly abrasive and corrosive, often permanently destroying the delicate contacts and circuit boards",
      "The powder is highly flammable when mixed with burning copper",
      "It freezes the wires, causing them to shatter like glass",
      "It conducts electricity if the voltage is above 220V"
    ],
  ...
  },
  {
    ...
    "opts": [
      "CO2 ruins the food, which violates maritime catering laws",
      "CO2 is highly flammable when mixed with vegetable oil",
      "The high-pressure blast scatters the burning oil, and CO2 lacks the cooling capacity to drop the oil below its auto-ignition point, causing it to instantly re-ignite when the gas clears",
      "CO2 freezes the oil into a solid, explosive block"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water shorts out the fuses, preventing the alarms from sounding",
      "Water dissolves the plastic insulation into explosive hydrogen gas",
      "Water is highly electrically conductive; spraying a solid jet onto a live 440V panel provides a direct path for the current to travel up the hose and electrocute the firefighter",
      "Water causes the copper busbars to rust instantly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By replacing the oxygen in the room with hydrogen",
      "By creating a soapy crust over the wood",
      "By massive Heat Extraction; water absorbs huge amounts of heat as it turns to steam, cooling the fuel well below its ignition temperature while soaking the deep-seated embers",
      "By chemical chain reaction interruption"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Submerge the entire bottle in a barrel of seawater",
      "Smother the bottle with a heavy fire blanket",
      "Do NOT extinguish the flame directly; use water spray to cool the bottle, and carefully close the supply valve to starve the fire. If you extinguish the flame without stopping the leak, the room will fill with explosive gas and detonate",
      "Blast the flame with CO2 to freeze the leak shut"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Aim it blindly from outside the room",
      "Keep a minimum distance of 1 meter to avoid accidental static discharge or arc flash to the metal horn",
      "Press the horn firmly against the panel door",
      "Stand exactly 5 meters away"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Directly at the BASE of the fire, where the fuel is vaporizing, sweeping side-to-side",
      "At the highest tip of the flames to push them down",
      "At the ceiling above the fire to create a falling cloud",
      "Directly at the smoke plume"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A main switchboard circuit breaker violently arcing",
      "A deep fat fryer boiling over in the galley",
      "A leaking diesel pipe spraying onto the turbocharger",
      "A pile of cardboard boxes, wooden pallets, and cotton rags burning in the dry provision store"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A magnesium casting igniting in the workshop",
      "A 440V motor terminal box catching fire",
      "A ruptured lubricating oil pipe spraying onto the hot exhaust manifold of an auxiliary generator",
      "A trash can full of paper towels burning in a cabin"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A pressurized Acetylene welding hose rupturing and igniting",
      "A deep fat fryer burning",
      "A pile of rope smouldering",
      "A pool of spilled paint thinner catching fire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A pool of heavy fuel oil catching fire",
      "A cotton mattress smouldering from a cigarette",
      "A pile of magnesium or titanium shavings igniting from a grinder spark in the engine room workshop",
      "A 220V lighting transformer burning out"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Completely bury the burning metal in totally dry sand to cut off the oxygen supply",
      "Spray it with AFFF foam",
      "Throw a bucket of seawater on it",
      "Blast it with a standard CO2 extinguisher"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is a fire that can only be fought using high-pressure water mist",
      "It only occurs in explosive gas environments",
      "It is a fire that burns in an oxygen-depleted atmosphere",
  ...
  },
  {
    ...
    "opts": [
      "Run and grab a CO2 extinguisher and start spraying blindly",
      "Open the switchboard doors fully to let the smoke out",
      "Hit the emergency blackout button to drop all power",
      "Raise the fire alarm by smashing the manual call point and inform the Bridge and Chief Engineer immediately"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Impure water and seawater act as excellent conductors, completing a circuit between the live busbars and the grounded human operator holding the hose",
      "Water creates an explosive gas when it touches copper",
      "Water reacts with PVC to create deadly mustard gas",
      "Water drastically lowers the ambient temperature, causing the breakers to freeze"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Using insulated tools and PPE, trip the specific feeder breaker to isolate power to that section, then snuff the flames with a portable CO2 extinguisher",
      "Initiate a total ship blackout immediately",
  ...
  },
  {
    ...
    "a": "Initiate a total ship BLACKOUT by hitting the remote emergency stops for all running generators, completely de-energizing the massive electrical energy feeding the arc fire",
    "opts": [
      "Open the sea chests to deliberately flood the bottom platform",
      "Start all standby generators to pump more power into the fire pumps",
      "Initiate a total ship BLACKOUT by hitting the remote emergency stops for all running generators, completely de-energizing the massive electrical energy feeding the arc fire",
      "Seal the engine room and abandon the ship immediately"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because it automatically triggers the CO2 room alarms",
      "Because the fire pumps run better on the emergency generator",
      "Because SOLAS prohibits fighting fires with the lights on",
      "Because the electrical arc acts as a continuous, massive ignition source; removing the voltage stops the arc, downgrading the emergency to a standard material fire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By ordering the bridge to drop the anchor",
      "By closing the main fuel valves manually on the bottom platform",
      "By manually tripping each ACB on the burning switchboard using a broom handle",
      "By pressing the hardwired 'Remote Emergency Stop' buttons for the prime movers (diesel generators) located outside the engine room or on the ECR console"
    ],
  ...
  },
  {
    ...
    "opts": [
      "All watertight doors will spring open to vent the smoke",
      "The ship's main engine will automatically go to Full Ahead",
      "The Emergency Generator will auto-start within 45 seconds, powering the Emergency Switchboard to restore critical lighting, steering, and the Emergency Fire Pump",
      "The CO2 total flooding system will auto-release into the engine room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To cool the copper busbars so they don't melt the deck",
      "To dry out the water used to fight the fire",
      "To blow the used CO2 gas back into the fire extinguishers",
      "Burning electrical insulation (PVC, rubber) produces extremely toxic, highly corrosive, and lethal gases such as Hydrogen Chloride and Carbon Monoxide"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Pure nitrogen",
      "Methane",
      "Hydrogen Chloride gas, which turns into highly corrosive hydrochloric acid when inhaled into the moist lungs"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A standard boiler suit and safety glasses",
      "A lifejacket and an immersion suit",
      "A fully enclosed chemical splash suit",
      "High-voltage insulated rubber gloves (with leather protectors) and a flash-rated face shield to protect against electrical shock and arc flash burns"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, water will always explode when touching copper",
      "Yes, provided you use a fine mist setting",
      "Yes, if the voltage is below 220V",
      "NEVER use water while the equipment is energized; it is only acceptable as a last resort AFTER the equipment is completely isolated and visually confirmed dead, to cool deep-seated embers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By touching the outer casing to see if it vibrates",
      "By pressing the lamp-test button on the synchroscope",
      "Visually verify that all generator ACBs are tripped open, and check that all panel voltmeters read exactly 0 Volts",
      "By checking if the emergency generator is running"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Emergency lighting, steering gear, GMDSS radio communications, fire detection panels, and the Emergency Fire Pump",
      "Main engine cooling pumps and purifiers",
      "The bow thruster and cargo cranes",
      "Air conditioning and galley ovens"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It provides a chemical crust that permanently fireproofs the cables",
      "It is the only extinguisher that can cool copper below its melting point",
      "It is significantly lighter and easier to carry than DCP",
      "It is electrically non-conductive and a 'clean agent', meaning it puts the fire out by smothering it and then dissipates entirely, leaving no damaging chemical residue on the delicate electronics"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Thoroughly investigate, identify, and permanently rectify the root cause of the fault (e.g., replace the burnt cable or tighten the loose busbar joint) to prevent an immediate re-ignition",
      "Bypass the preferential trip relay",
      "Turn the AVR voltage up to 120% to burn off the carbon",
      "Spray the entire board with a water hose to wash away the soot"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is the process of updating the software on the power management system",
      "It is the physical movement of the busbars due to thermal expansion",
      "It is the formation of a conductive path across the surface of an insulator due to dirt, moisture, or carbon dust; this allows high-voltage current to leak across, generating intense heat and eventually causing a flashover arc",
      "It is the magnetic alignment of the copper atoms in the wires"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes, but only if mixed with 50% water first",
      "No, they chemically react with copper to form explosive gases",
      "No, they are highly conductive liquids that will cause electrocution",
      "Yes, they are electrically non-conductive, highly effective 'clean agents' that interrupt the chemical chain reaction without leaving any residue, making them excellent replacements for Halon"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, they are purposefully made of thick plastic, rubber, or composite materials to prevent them from conducting electricity back to the operator if they accidentally touch a live wire",
      "Yes, they contain a copper grounding wire inside the plastic",
      "No, they are made of pure glass",
      "Yes, they are made of solid brass to withstand the extreme cold"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because Foam is primarily composed of water (approx. 94-97%), making it an excellent conductor of electricity and a lethal hazard to the operator",
      "Because Foam is lighter than air and will float away from the panel",
      "Because Foam freezes instantly when it touches copper",
      "Because Foam generates massive static electricity charges"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Ignore it until smoke detectors activate",
      "Dump the fixed CO2 system into the engine room",
      "Initiate a total ship blackout immediately to be safe",
      "Open the feeder breaker for that specific section to remove the power source, stand by with a CO2 extinguisher, and investigate; a full blackout is likely unnecessary for an incipient arc"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The main engines will automatically run at full speed uncontrollably",
      "The ship's hull will become highly magnetized, ruining the compass",
      "The fire will travel up the cables and ignite the bridge radar",
      "Total loss of ship's propulsion, steering, and automated control, leaving the vessel completely dead in the water and highly vulnerable to sinking or collision"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Always; SOLAS requires every cubicle to have its own sprinkler head",
      "Yes, they are constantly purged with inert Nitrogen gas",
      "Rarely; because they are heavily ventilated, localized gas systems are ineffective. They rely on the Engine Room's overall total flooding system (CO2/Hi-Fog) or manual intervention",
      "Yes, they all use automatic dry chemical powder dusters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Soot is extremely acidic and will dissolve the steel casing",
      "Carbon soot is highly electrically conductive; if it settles on healthy insulators or circuit boards, it can create thousands of micro-shorts and trigger a secondary flashover when power is restored",
      "Soot acts as a thermal insulator, preventing the breakers from cooling",
      "Soot absorbs oxygen from the air, causing asphyxiation"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Run and grab the nearest fire hose and use a solid jet of water",
      "Evacuate all personnel, seal the doors and ventilation to the room, initiate a full blackout, and prepare to release the fixed CO2 Total Flooding system",
      "Abandon the ship immediately",
      "Open all the doors to let the heat escape into the engine room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To avoid breathing in the ozone generated by the contacts",
      "To prevent your shadow from blocking the indicator lights",
  ...
  },
  {
    ...
    "opts": [
      "Inside the Master's private office",
      "At the ship's gangway or accommodation entrance, usually in a prominently marked, weatherproof enclosure",
      "Deep inside the main engine control room",
      "Only in digital format on the ECDIS screen"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Location of all A-class and B-class fire divisions, fire detectors, manual call points, fixed suppression systems, portable extinguishers, fire pumps, dampers, and escape routes",
      "The electrical wiring diagrams for the main switchboard",
      "The daily work schedules of the engineering crew",
      "The maintenance history of the emergency generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "External Evacuation Boat Davit",
      "Electrical Enclosure Blanket Dispenser",
      "Engine Environmental Breathing Dome"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To provide short-duration breathing air solely for the purpose of ESCAPING from a smoke-filled or toxic space",
      "To be used as a diving apparatus for underwater hull inspections",
      "To allow firefighters to enter a burning room and extinguish the fire",
      "To provide oxygen to unconscious victims like a medical ventilator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes, it is the primary piece of equipment for the ship's fire party",
      "Yes, but only for fires smaller than 1 square meter",
      "NO; it is strictly prohibited. It lacks the duration, demand-valve performance, and thermal protection required for firefighting",
  ...
  },
  {
    ...
    "opts": [
      "Smoke Control and Blower Assembly",
      "Survival Cylinder for Breathable Atmosphere",
      "Self-Contained Breathing Apparatus",
      "Shipboard Chemical Breathing Air"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To provide full respiratory and facial protection for trained personnel ENTERING a hazardous atmosphere to fight a fire or perform a rescue",
      "To spray a cooling mist of water over the firefighter's face",
      "To filter toxic smoke particles out of the ambient room air",
      "To provide 10 minutes of air for emergency escape only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "8 bolts, 10 mm in diameter",
      "6 bolts, 20 mm in diameter",
      "2 bolts, 25 mm in diameter",
      "4 bolts, 16 mm in diameter"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Close all hold ventilation flaps, fans, and trunking to starve the fire of oxygen",
      "Open the massive cargo hatches to let the smoke escape",
      "Send a team with SCBAs down the ladders to open the container doors",
      "Pump seawater continuously into the hold until the container is submerged"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the smoke will damage the bridge windows",
      "Because the heat will melt the hatch cover rubber seals",
      "Allowing a massive rush of fresh oxygen into a semi-suffocated, super-heated space will cause an explosive re-ignition known as a backdraft",
      "Because it violates MARPOL air pollution regulations"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the water will instantly freeze due to the endothermic reaction",
      "It dilutes the CO2 gas, reacts explosively with certain dangerous goods, and adds massive free-surface weight that can capsize the ship",
      "Because it ruins the paint on the containers",
      "Because saltwater accelerates the burning of cardboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The use, storage, and carriage of firefighting foam containing PFOS (Perfluorooctane Sulfonate) is strictly PROHIBITED",
      "The use of high-expansion foam in engine rooms is prohibited",
      "The use of seawater mixed with foam is prohibited",
      "The use of dry powder extinguishers in galleys is prohibited"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It dissolves the rubber seals in firefighting hoses",
      "It is a Persistent Organic Pollutant (POP); it never breaks down in nature, accumulates in the food chain, and is highly toxic and carcinogenic",
      "It spontaneously combusts when exposed to sunlight",
      "It emits high levels of gamma radiation over time"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They must rely entirely on manual patrols by the crew",
      "They must be fitted with Combined Smoke AND Heat detectors (or linear heat detectors) instead of relying solely on smoke detectors",
      "They must use only flame detectors",
      "They must use acoustic sensors that listen for exploding tires"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Robotic drones that fly over the cars every 10 minutes",
      "Motion sensors that trigger floodlights",
      "Infrared laser tripwires crossing every vehicle lane",
      "Continuous CCTV video monitoring covering all areas of the vehicle deck, with a minimum 24-hour recorded playback capability"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Fixed water-based fire-extinguishing monitors (water cannons) to provide immediate high-volume remote suppression",
      "Automated foam sprinkler heads embedded in the deck plates",
      "Massive CO2 total flooding nozzles",
      "Dry chemical powder drop-bags attached to the mast"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Mechanical extraction ventilation with the extraction point located at the BOTTOM of the space, because heavy paint and solvent vapors sink to the floor",
      "Natural ventilation only, using open louvers on the doors",
      "No ventilation is allowed; the room must be hermetically sealed",
      "Positive pressure ventilation pumping fresh air into the top of the room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A fixed smothering system (usually CO2) capable of achieving a 40% concentration by volume, with the release handle located OUTSIDE the space",
      "A standard water sprinkler system",
      "A wet chemical system identical to the galley hood",
      "A portable 9kg DCP extinguisher mounted near the door"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To power the pneumatic lowering winches on the davits",
      "To spray firefighting foam out of the lifeboat's exhaust pipe",
      "To provide positive-pressure breathable air for the occupants and the engine for at least 10 minutes, allowing the boat to safely motor through a surface oil fire",
      "To inflate the self-righting airbags if the boat capsizes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "100 liters per minute, per person",
      "500 liters total for the entire boat",
      "10 liters per minute, per person",
      "40 liters per minute, per person"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It sprays highly expanded foam over the water to extinguish the path ahead",
      "It sprays water internally to cool the occupants",
      "An engine-driven centrifugal pump draws seawater through the hull and sprays a continuous film of water over the entire outer canopy, absorbing the intense radiant heat of the flames",
      "It releases CO2 gas over the exterior to smother the flames touching the boat"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Class E compressors chemically generate pure oxygen",
      "Standard industrial compressors use oil lubrication which vaporizes into the air; breathing this oil mist or carbon monoxide inside a sealed lifeboat is lethal",
      "Standard compressors remove too much humidity, causing static sparks",
      "Standard compressors cannot reach pressures above 10 bar"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An Emergency Fire Pump must be installed outside that space, powered by an independent source, ensuring firefighting capability survives an engine room fire",
      "The space must be protected by a triple-layer A-60 bulkhead",
      "The main fire pump must be encased in a watertight submarine vault",
      "A second main fire pump must be stacked on top of it"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is an extremely potent Ozone Depleting Substance (ODS) and a potent greenhouse gas, leading to its ban under the Montreal Protocol",
      "It is highly corrosive and instantly destroys electrical switchboards",
