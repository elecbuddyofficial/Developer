window.loadQuizzes("T18_ElecSurvey", [
  {
    ...
    "opts": ["Hot work permits, garbage record books, and the Chief Cook's inventory logs", "Original equipment purchase invoices, cargo manifests, and crew rest hour logs", "Safety Equipment Certificate (SEC), PMS records, IR test records, battery logs, emergency generator test logs, and approved single-line diagrams", "VDR manual, engine room daily sounding logs, and heavy weather checklists"],
  ...
  },
  {
    ...
    "opts": ["10% per year over a 10-year rolling cycle", "50% per year over a 2-year rolling cycle", "33% per year over a 3-year rolling cycle", "Approximately 20% per year over a 5-year rolling cycle"],
  ...
  },
  {
    ...
    "opts": ["SOLAS Chapter II-1, Part D", "SOLAS Chapter IV, Part C", "SOLAS Chapter V, Part B", "SOLAS Chapter II-2, Part A"],
  ...
  },
  {
    ...
    "opts": ["By manually starting the generator locally and running it off-load for 10 minutes", "By verifying its 18-hour fuel tank capacity and checking the battery specific gravity only", "By starting it from the bridge panel and connecting a dummy load bank for 15 minutes", "By simulating a full blackout, causing the generator to auto-start and connect to the emergency switchboard within 45 seconds"],
  ...
  },
  {
    ...
    "opts": ["A panel that automatically isolates all internal power if the ambient temperature exceeds 60 degrees C", "A switchboard section that has been permanently decommissioned and disconnected from the busbars", "A switchboard where no live electrical conductors or uninsulated parts are accessible from the front face during normal operation", "A control panel that operates exclusively on 24V DC for instrumentation purposes"],
  ...
  },
  {
    ...
    "opts": ["3 times the rated voltage exactly", "1.5 times the rated voltage plus 500V", "10 times the rated voltage divided by 2", "2 times the rated voltage plus 1000V AC"],
  ...
  },
  {
    ...
    "opts": ["Negative phase sequence relay", "Differential protection relay", "Reverse power relay", "Preferential trip relay"],
  ...
  },
  {
    ...
    "opts": ["Workshop machinery and provision room refrigeration compressors", "Accommodation ventilation fans and deck cranes", "Galley ovens, water heaters, and laundry equipment", "Steering gear, navigation equipment, fire pumps, and emergency bilge pumps"],
  ...
  },
  {
    ...
    "opts": ["Using an infrared thermal imaging camera during normal live operation", "Spraying contact cleaner on the joints and watching for rapid evaporation", "Performing a 500V DC megger test between phases", "Racking out the ACBs and performing a secondary injection test"],
  ...
  },
  {
    ...
    "opts": ["Disconnect the under-voltage trip coil and verify the breaker opens via the mechanical push button", "Short circuit the busbars momentarily to simulate a fault while monitoring the trip time", "Run the generator at 150% load until the bimetallic thermal relay physically bends and trips the breaker", "Rack the ACB to the TEST position and use a secondary injection test set to inject current into the relay via the CT secondary terminals"],
  ...
  },
  {
    ...
    "opts": ["1000%, 2000%, and 5000% of the rated current", "150%, 200%, and 600% of the rated current", "10%, 25%, and 50% of the rated current", "80%, 90%, and 100% of the rated current"],
  ...
  },
  {
    ...
    "opts": ["A cooling fan blows cold engine room air across the main contacts", "A blast of highly pressurized SF6 gas blows out the arc instantly", "Magnetic forces drive the arc into arc chutes where splitter plates divide it into multiple shorter arcs, raising total arc voltage above the supply voltage", "The arc is drawn into a pure vacuum chamber where lack of oxygen prevents it from sustaining"],
  ...
  },
  {
    ...
    "opts": ["95-100% of the rated generator voltage", "10-20% of the rated generator voltage", "110-115% of the rated generator voltage", "70-80% of the rated generator voltage"],
  ...
  },
  {
    ...
    "opts": ["50-60% of rated generator kW with a 10-15 second time delay", "5-15% of rated generator kW with a 3-5 second time delay", "100-110% of rated generator kW with a 1-minute time delay", "1-2% of rated generator kW with an instantaneous trip (0 seconds)"],
  ...
  },
  {
    ...
    "opts": ["Manually turn the generator rotor backwards by hand until the relay trips", "Using a secondary injection test kit, inject current phase-shifted 180 degrees out of phase with the voltage reference to simulate reverse power", "Apply a resistive dummy load exceeding 110% rating until power direction reverses", "Temporarily parallel two generators and reduce fuel to one until the relay activates"],
  ...
  },
  {
    ...
    "opts": ["IR (Mohm) >= Rated Voltage (kV) + 1", "IR (Mohm) >= Rated Voltage (V) / 100", "IR (Mohm) >= Rated Current (A) + 10", "IR (kohm) >= Rated Voltage (kV) x 1000"],
  ...
  },
  {
    ...
    "opts": ["The AVR's internal capacitors will absorb the test current, giving a false zero reading", "The AVR will falsely read the megger's output and attempt to start the emergency generator", "The megger's high DC test voltage (500V-1000V) will irreversibly damage the AVR's sensitive low-voltage semiconductor components", "The megger's voltage will demagnetize the alternator's residual magnetism, requiring flashing"],
  ...
  },
  {
    ...
    "opts": ["A perfectly normal reading for a Class H insulated steering gear motor", "Excellent, dry insulation that is completely safe to energize", "A recently rewound motor that has not yet completed its thermal break-in period", "Very poor insulation heavily contaminated by moisture or carbon, where steady conductive leakage current dominates"],
  ...
  },
  {
    ...
    "a": "5000V DC",
    "opts": ["5000V DC", "1000V AC", "500V DC", "10,000V DC"],
  ...
  },
  {
    ...
    "opts": ["1000V DC \u2014 to guarantee proper stress-testing of the insulation", "500V DC \u2014 same as for 440V motors", "No testing required \u2014 circuit boards are pre-tested at the factory and exempt from IR testing", "50-100V DC only \u2014 standard 500V megger will destroy semiconductor junctions"],
  ...
  },
  {
    ...
    "opts": ["It limits earth fault current to a safe level (typically 5-10A) to prevent severe equipment damage while providing a defined earth reference", "It intentionally increases the fault current to thousands of amperes to guarantee the circuit breaker trips instantaneously", "It regulates the high voltage busbar frequency during transient load changes", "It completely isolates the neutral from the hull, ensuring the ship continues to run on the first earth fault without alarming"],
  ...
  },
  {
    ...
    "opts": ["R = (6600 / root 3) / 5 = approximately 762 Ohms", "R = 6600 / 5 = 1320 Ohms", "R = (6600 / 5) x root 3 = 2286 Ohms", "R = (6600 x root 3) / 5 = 2286 Ohms"],
  ...
  },
  {
    ...
    "opts": ["Standard leather rigger gloves as long as the system is confirmed dead", "Class 2 (Yellow) rubber gloves rated for 17,000V AC maximum use voltage", "Class 0 (Red) rubber gloves rated for 1,000V AC maximum use voltage", "Class 00 (Beige) rubber gloves rated for 500V AC maximum use voltage"],
  ...
  },
  {
    ...
    "opts": ["To lock the engine telegraph in the Stop position until the HV busbars are fully synchronized", "To encrypt the digital HART communication signals between the MSB and the Engine Control Room", "To bypass the Under-Voltage Trip coil manually during a blackout start", "To enforce a strict sequence of operations \u2014 ensuring an earth switch cannot be closed until the circuit breaker is racked out and locked"],
  ...
  },
  {
    ...
    "opts": ["To convert the shore's 50 Hz frequency to the ship's 60 Hz system", "To step down the high voltage grid power to 24V DC for the emergency switchboard", "To break the galvanic path between the solidly earthed shore supply and the ship's unearthed IT system, preventing severe stray current hull corrosion", "To filter out harmonic distortion caused by the shore facility's variable frequency drives"],
  ...
  },
  {
    ...
    "opts": ["Check the voltage between Phase L1 and Neutral \u2014 if it is 220V, the sequence is correct", "Connect shore power at minimal load and briefly start a small 3-phase motor to observe if its direction of rotation is correct", "Measure the resistance between the three phase conductors using a standard multimeter", "Connect shore power fully and rely on the Main Engine's Wrong Way Alarm to warn of sequence errors"],
  ...
  },
  {
    ...
    "opts": ["A normally-closed auxiliary contact from each generator ACB is wired in series with the shore breaker's closing coil, preventing it from energizing if any generator ACB is closed", "A PLC program monitors the phase angle and physically locks the shore box door if generators are running", "The reverse power relay of the shore connection box automatically trips the generators if shore power is detected", "A mechanical Castell key must be manually removed from the running generator and inserted into the shore panel"],
  ...
  },
  {
    ...
    "opts": ["Both certificates valid indefinitely as long as the ship does not change flag states", "DOC valid for 1 year; SMC valid for 10 years", "DOC valid for 2.5 years; SMC valid for 1 year", "DOC valid for 5 years with annual verification; SMC valid for 5 years with one intermediate verification at 2.5 years"],
  ...
  },
  {
    ...
    "opts": ["A single burnt-out indicator lamp on the preferential trip panel", "A minor clerical error in the engine room logbook that was corrected before the auditor noticed", "The delayed submission of the monthly spare parts inventory to the company's purchasing department", "An identifiable deviation that poses a serious threat to personnel or ship safety, or a serious risk to the environment, requiring immediate corrective action"],
  ...
  },
  {
    ...
    "opts": ["SOLAS Chapter IV \u2014 Radiocommunications", "SOLAS Chapter II-1 \u2014 Construction, Structure, Subdivision and Stability", "SOLAS Chapter IX \u2014 Management for the Safe Operation of Ships", "SOLAS Chapter XI-2 \u2014 Special measures to enhance maritime security"],
  ...
  },
  {
    ...
    "opts": ["Minimum 8 hours of continuous rest in any 24-hour period with no exceptions", "Minimum 6 hours of rest in any 24-hour period provided the weekly total exceeds 40 hours", "Minimum 10 hours of rest in any 24-hour period, which may be divided into no more than two periods, one of which must be at least 6 hours", "Minimum 12 hours of rest in any 24-hour period divided into exactly three 4-hour periods"],
  ...
  },
  {
    ...
    "opts": ["Enclosed Space Entry Permit", "Hot Work Permit", "Cold Work Permit", "Electrical Isolation Permit (EIP)"],
  ...
  },
  {
    ...
    "opts": ["15.5% oxygen by volume", "20.9% oxygen by volume", "23.5% oxygen by volume", "19.5% oxygen by volume"],
  ...
  },
  {
    ...
    "opts": ["0 seconds \u2014 earth clamps must be applied instantly to short out any incoming faults", "30 seconds, to allow the under-voltage trip coil to reset", "5 minutes, to allow the lethal capacitive charge stored in HV cables and equipment to fully dissipate", "1 hour, to ensure the vacuum bottles in the breaker have completely cooled down"],
  ...
  },
  {
    ...
    "opts": ["77 hours of rest in any 7-day period", "48 hours of rest in any 7-day period", "84 hours of rest in any 7-day period", "56 hours of rest in any 7-day period"],
  ...
  },
  {
    ...
    "opts": ["\u00b13 months from the anniversary date", "\u00b11 month from the anniversary date", "\u00b16 months from the anniversary date", "Any time within the calendar year"],
  ...
  },
  {
    ...
    "opts": ["100% per year", "Approximately 20% per year", "10% per year", "50% per year"],
  ...
  },
  {
    ...
    "opts": ["Intermediate Survey", "Special Survey (Class Renewal Survey)", "Annual Survey", "Safety Equipment Survey"],
  ...
  },
  {
    ...
    "opts": ["At the 1-year mark", "Between the 2nd and 3rd annual survey", "Every 6 months", "Exactly at the 4-year mark"],
  ...
  },
  {
    ...
    "opts": ["Safety Equipment Certificate (SEC)", "IAPP Certificate", "Load Line Certificate", "Safety Construction Certificate (SCC)"],
  ...
  },
  {
    ...
    "opts": ["Only the navigational lights", "Only the main engine mechanics", "Only the radio equipment", "It verifies structural, machinery, and electrical construction standards"],
  ...
  },
  {
    ...
    "a": "IAPP Certificate",
    "opts": ["SCC Certificate", "SEC Certificate", "IAPP Certificate", "ISPP Certificate"],
  ...
  },
  {
    ...
    "a": "Annually",
    "opts": ["Every 5 years", "Annually", "Every 2.5 years", "Monthly"],
  ...
  },
  {
    ...
    "opts": ["Capacity Plan", "General Arrangement plan", "Piping and Instrumentation Diagram", "Approved Single-line electrical diagram"],
  ...
  },
  {
    ...
    "opts": ["SOLAS Chapter I", "SOLAS Chapter IV", "SOLAS Chapter III", "SOLAS Chapter II-1"],
  ...
  },
  {
    ...
    "opts": ["Date, temperature, and temperature-corrected values", "Photographs of the tested motor", "The names of all crew on board", "The brand of the megger used"],
  ...
  },
  {
    ...
    "a": "45 seconds",
    "opts": ["30 seconds", "10 seconds", "60 seconds", "45 seconds"],
  ...
  },
  {
    ...
    "opts": ["Voltage must recover to within \u00b15% within 5 seconds", "Voltage must recover to within \u00b11% within 0.5 seconds", "Voltage must not drop at all", "Voltage must recover to within \u00b13% of rated within 1.5 seconds"],
  ...
  },
  {
    ...
    "opts": ["All stages trip instantly", "Stage 1: 30s, Stage 2: 60s, Stage 3: 90s", "Stage 1: 1s, Stage 2: 2s, Stage 3: 3s", "Stage 1: 5s, Stage 2: 15s, Stage 3: 25s"],
  ...
  },
  {
    ...
    "opts": ["IMO (International Maritime Organization)", "IEC (International Electrotechnical Commission)", "IACS (International Association of Classification Societies)", "IEEE"],
  ...
  },
  {
    ...
    "opts": ["Relays must be bypassed for emergency use", "Settings must match the motor nameplate Full Load Amps (FLA)", "Settings must be at 200% of FLA", "Relays must trip instantly on startup"],
  ...
  },
  {
    ...
    "opts": ["Daily fuel consumption logs", "Hourly frequency deviation logs", "Weekly insulation resistance logs", "Monthly auto-start test records and annual load test records"],
  ...
  },
  {
    ...
    "opts": ["Minimum 1 M\u03a9 corrected to 40\u00b0C", "100 M\u03a9", "100 k\u03a9", "10 M\u03a9"],
  ...
  },
  {
    ...
    "opts": ["The magnetic field strength of the joints", "The rotational speed of the busbars", "All busbar joint bolts are torqued to manufacturer specification to prevent loose connections", "The physical weight of the busbars"],
  ...
  },
  {
    ...
    "opts": ["The local port state control", "The flag state telecom authority", "The classification society surveyor", "The ship's captain"],
  ...
  },
  {
    ...
    "opts": ["General Arrangement plan", "Piping diagram", "MSB arrangement drawing", "Emergency lighting plan"],
  ...
  },
  {
    ...
    "opts": ["Short circuit the main busbars", "Use the AVR test point or trimmer to raise voltage above setpoint (without load)", "Inject 440V into the control circuit", "Increase the engine speed to 120%"],
  ...
  },
  {
    ...
    "opts": ["Specific gravity, electrolyte levels, and load test results for all emergency/safety batteries", "Only the brand names of the batteries", "The physical weight of each cell", "The disposal records for old batteries only"],
  ...
  },
  {
    ...
    "opts": ["Class is suspended and the ship may not trade", "The Chief Engineer loses their license", "A small fine is issued", "The survey is pushed to the next year"],
  ...
  },
  {
    ...
    "opts": ["Class society issues passports; Flag state issues visas", "There is no difference; they are the same entity", "Flag state builds the ship; Class society operates it", "Flag state sets statutory rules; Class society verifies compliance on behalf of the flag state as a Recognized Organization"],
  ...
  },
  {
    ...
    "opts": ["All generator ACBs and feeder breakers must be OPEN", "The 24V DC supply must be connected", "Generators must be running at full load", "The bus tie breaker must be closed"],
  ...
  },
  {
    ...
    "opts": ["The fuel consumption log", "The stability booklet", "Ship's electrical load analysis / power balance calculation", "The continuous synopsis record"],
  ...
  },
  {
    ...
    "opts": ["By injecting current into the neutral CT secondary to simulate fault current above the 10-30% setting", "By physically touching a live phase to the hull", "By shorting the AVR output", "By pouring saltwater on the MSB"],
  ...
  },
  {
    ...
    "opts": ["That the ETO is preparing to sign off", "That regular maintenance and parameter logging are actively monitored by the Chief Engineer", "That the ship is out of spare parts", "That the generators have failed"],
  ...
  },
  {
    ...
    "opts": ["Hard-over (15\u00b0 to 15\u00b0) in \u226460 seconds at half speed", "Hard-over while engine is stopped", "Hard-over in \u226428 seconds at full speed", "Hard-over in 10 seconds"],
  ...
  },
  {
    ...
    "opts": ["A panel located at the forward bow of the ship", "A panel that has lost all electrical power", "A panel painted black to indicate high voltage", "No live electrical conductors or uninsulated parts are accessible from the front face during normal operation"],
  ...
  },
  {
    ...
    "opts": ["The breakers trip if someone walks past", "Without a circuit break (isolation), the panel doors cannot be opened to expose live parts", "The panel doors automatically lock at sea", "The MSB shuts down if the ECR gets too hot"],
  ...
  },
  {
    ...
    "a": "2000V AC",
    "opts": ["2000V AC", "440V AC", "5000V AC", "1000V AC"],
  ...
  },
  {
    ...
    "opts": ["Above 24V DC", "Above 12V DC", "Above 220V DC", "Above 50V DC (Safety Extra Low Voltage)"],
  ...
  },
  {
    ...
    "a": "0.6 metres",
    "opts": ["0.3 metres", "1.0 metres", "1.5 metres", "0.6 metres"],
  ...
  },
  {
    ...
    "opts": ["Minimum Class 2 mat (rated for 17,000V AC)", "Class 00 mat (rated 500V)", "Class 0 mat (rated 1000V)", "A standard anti-slip rubber mat"],
  ...
  },
  {
    ...
    "opts": ["To serve as a radio antenna ground", "To provide a low-resistance path for fault currents to safely return and operate protection devices", "To prevent static electricity from shocking the crew", "To power the ICCP system"],
  ...
  },
  {
    ...
    "opts": ["It neutralizes the fault using a capacitor", "It instantly trips the main generators", "It gives an alarm on the first earth fault without tripping the supply", "It isolates the faulty phase automatically"],
  ...
  },
  {
    ...
    "a": "25\u201350 k\u03a9",
    "opts": ["1\u20135 \u03a9", "25\u201350 k\u03a9", "1 M\u03a9", "100 M\u03a9"],
  ...
  },
  {
    ...
    "opts": ["Locks the MSB doors during rough weather", "Automatically closes when load is high", "Prevents closing the bus tie when generators on separate sections are running to avoid unsynchronized paralleling", "Prevents the emergency generator from starting"],
  ...
  },
  {
    ...
    "opts": ["To act as heat shields in case of fire", "To prevent accidental entry by non-working personnel", "To stop water from flooding the MSB", "To store logbooks and tools"],
  ...
  },
  {
    ...
    "opts": ["The door must be redesigned to open outward or a physical stop must be fitted", "The clearance rule is waived for doors", "A warning sign must be placed on the door", "The MSB must be moved forward"],
  ...
  },
  {
    ...
    "opts": ["Check that it is painted red", "Measure its exact length with a tape", "Check for cuts, holes, or oil contamination which compromise its dielectric strength", "Verify it smells like fresh rubber"],
  ...
  },
  {
    ...
    "opts": ["To keep the operators from sweating", "To remove the significant heat generated by high-current busbars and switchgear", "To supply oxygen to the generators", "To prevent explosive hydrogen gas buildup"],
  ...
  },
  {
    ...
    "opts": ["A water sprinkler nozzle", "A carbon monoxide detector", "A fixed heat or multi-sensor type detector", "A manual pull station only"],
  ...
  },
  {
    ...
    "opts": ["The generator has tripped", "The insulation is perfectly healthy", "The measuring instrument is broken", "There is a 'dead short' (solid earth fault) between one live phase and the ship's hull"],
  ...
  },
  {
    ...
    "opts": ["If the ship is in dry dock", "If the Chief Engineer is watching", "If wearing rubber gloves", "Never. All circuits must be isolated, locked out, and proven dead before access"],
  ...
  },
  {
    ...
    "opts": ["The system continues to run normally with a louder alarm", "The voltage doubles", "The neutral cable melts", "It creates a massive phase-to-phase short circuit through the hull, instantly tripping both circuit breakers"],
  ...
  },
  {
    ...
    "opts": ["It generates foam to extinguish the fire", "It prevents the arc from happening entirely", "It instantly disconnects the ship's battery", "The heavy metal barriers contain the explosive plasma and molten copper, protecting the operator in front"],
  ...
  },
  {
    ...
    "opts": ["A calibrated torque wrench", "A pneumatic impact drill", "Locktite glue", "A standard crescent wrench"],
  ...
  },
  {
    ...
    "opts": ["Internal metal partition bulkheads", "Rubber curtains", "Glass windows", "Air gaps only"],
  ...
  },
  {
    ...
    "opts": ["To act as a backup earth connection", "To prevent a person from falling against the panel in rough seas while providing a non-conductive grip", "To hang tools and cables", "For decorative purposes"],
  ...
  },
  {
    ...
    "opts": ["Excellent; the system is highly insulated from earth", "The meter is disconnected", "Dangerous; a short circuit is imminent", "Marginal; requires immediate cleaning"],
  ...
  },
  {
    ...
    "opts": ["It creates a conductive tracking path that can lead to an explosive arc flash between phases", "It causes the busbars to rust", "It makes the busbars spin faster", "It reduces the physical weight of the panel"],
  ...
  },
  {
    ...
    "opts": ["To instantly trip specific heavy consumers or fuel pumps in case of emergency", "To turn off the MSB room lights", "To stop the main propeller", "To disconnect the ICCP system"],
  ...
  },
  {
    ...
    "opts": ["To indicate where to drill holes", "To make the panel look modern", "To act as a secondary grounding wire", "To visually represent the invisible busbar layout and breaker connections behind the solid panels"],
  ...
  },
  {
    ...
    "opts": ["The ACB contains a vacuum chamber", "The ACB is welded permanently to the wall", "The ACB can only be operated remotely", "The ACB is mounted on a sliding chassis, allowing it to be physically withdrawn from the live busbars for safe maintenance"],
  ...
  },
  {
    ...
    "opts": ["A padlock on the door", "A mechanical interlock linked to the closing mechanism", "A software timer", "A high-temperature alarm"],
  ...
  },
  {
    ...
    "opts": ["It must be separated by a watertight bulkhead", "It must be placed on the bridge", "It must be inside the cargo hold", "The MSB should be placed as close as practicable to the main generators"],
  ...
  },
  {
    ...
    "opts": ["It closes the ACB remotely", "It tests the overcurrent relay", "It recharges the closing spring", "It opens the supply to the Under-Voltage Trip (UVT) coil, causing the ACB to trip immediately and safely lock out"],
  ...
  },
  {
    ...
    "opts": ["A continuous-duty electromagnetic coil", "A momentary pulse coil", "A permanent magnet", "A thermal bimetallic strip"],
  ...
  },
  {
    ...
    "opts": ["50\u201360% of rated voltage", "70\u201380% of rated voltage", "10\u201320% of rated voltage", "95\u2013100% of rated voltage"],
  ...
  },
  {
    ...
    "opts": ["To protect the busbars from being supplied with abnormally low voltage, which would cause motors to draw excessive current and stall", "To prevent reverse power flow", "To start the emergency generator", "To measure the generator frequency"],
  ...
  },
  {
    ...
    "opts": ["By shorting the main busbars with a crowbar", "By using a secondary injection test set to inject 150%, 200%, and 600% of rated current into the relay and timing the trip", "By increasing the UVT voltage", "By running the generator at double speed"],
  ...
  },
  {
    ...
    "opts": ["Internal Delay Motor Trip", "Instantaneous Direct Maximum Trip", "Inverse Definite Minimum Time", "Integrated Digital Measuring Technology"],
  ...
  },
  {
    ...
    "opts": ["There is no difference; they mean the same thing", "TEST is for AC, ISOLATED is for DC", "In TEST, control circuits remain connected for relay testing; in ISOLATED, both main and control circuits are fully disconnected", "In TEST, the main busbars are still live; in ISOLATED, they are dead"],
  ...
  },
  {
    ...
    "opts": ["To prevent severe physical injury from the mechanism snapping shut accidentally", "To cool down the contacts", "To reset the digital display", "To stop electrical sparks"],
  ...
  },
  {
    ...
    "opts": ["By physically hitting the relay with a hammer", "By using a variac or test switch to slowly reduce the voltage supplied to the coil until it trips", "By reversing the generator rotation", "By injecting high current into the CT"],
  ...
  },
  {
    ...
    "opts": ["It trips the ACB immediately with no intentional delay for massive short-circuit currents (e.g., 600-800% rated)", "It overrides all other alarms", "It starts the standby generator instantly", "It trips on slight overloads after 10 minutes"],
  ...
  },
  {
    ...
    "opts": ["Shunt trip protects against low voltage, UVT protects against high current", "Shunt trip is for DC, UVT is for AC", "Shunt trip is momentarily energized to actively push the trip latch; UVT is continuously energized and releases the latch if power fails", "They are exactly the same thing"],
  ...
  },
  {
    ...
    "opts": ["The ACB switches to emergency battery power", "The generator speeds up to 120%", "The ACB trips immediately and cannot be closed again until the coil is replaced", "The ACB stays closed permanently"],
  ...
  },
  {
    ...
    "opts": ["On the ship's outer hull", "Directly on the main copper busbars", "Inside the main engine control room console", "On the secondary control wiring block, accessible when the ACB is in the TEST position"],
  ...
  },
  {
    ...
    "opts": ["Because the surveyor needs to see the back of the panel", "Because the test set requires 440V to operate", "To allow the springs to charge", "To ensure test currents do not back-feed into live busbars or loads, which is extremely dangerous"],
  ...
  },
  {
    ...
    "opts": ["It bypasses all safety trips for emergency running", "It closes the bus tie breaker", "It turns off the MSB room lights", "It breaks the circuit to the UVT coil, instantly tripping the ACB and safely locking it out"],
  ...
  },
  {
    ...
    "opts": ["The time it takes to charge the closing spring", "The time delay from the moment the fault current is injected until the ACB mechanism physically trips", "The time the alarm bell rings", "The time it takes for the generator to slow down"],
  ...
  },
  {
    ...
    "opts": ["To warm up the ACB contacts", "To verify the operation of the instantaneous trip element for short-circuit protection", "To test the reverse power relay", "To check the under-voltage dropout"],
  ...
  },
  {
    ...
    "opts": ["It is connected to the 440V bus", "The secondary injection set takes over, feeding test current directly into the relay while isolating the actual CT", "It is grounded to the hull", "It is left open-circuited"],
  ...
  },
  {
    ...
    "opts": ["Under-Frequency Relay", "Overcurrent Relay", "Under-Voltage Relay", "Reverse Power Relay"],
  ...
  },
  {
    ...
    "opts": ["To stretch, cool, and split the electrical arc into smaller segments to extinguish it rapidly during a trip", "To measure the arc voltage", "To guide the operator's hands safely", "To store closing spring energy"],
  ...
  },
  {
    ...
    "opts": ["It stops the contacts from bouncing", "It stops water from entering the MSB", "It prevents the ACB from repeatedly attempting to close and tripping continuously if a fault is present and the close button is held", "It prevents the fuel pump from over-pressurizing"],
  ...
  },
  {
    ...
    "opts": ["The maximum short-circuit current the breaker can safely interrupt once, after which it may require replacement", "The current drawn by the UVT coil", "The normal full-load current of the generator", "The minimum current required to trip the breaker"],
  ...
  },
  {
    ...
    "opts": ["The megohm insulation resistance of the casing", "The voltage drop of the UVT coil", "The micro-ohm contact resistance across the closed main contacts", "The speed of the closing spring"],
  ...
  },
  {
    ...
    "opts": ["A high voltage reading", "A zero resistance reading", "A low insulation reading", "A high resistance reading (e.g., >100 \u00b5\u03a9), indicating a risk of overheating under heavy load"],
  ...
  },
  {
    ...
    "opts": ["They provide a backup connection if main contacts fail", "They make first and break last, taking the brunt of the destructive arc to keep the main contacts clean", "They measure the arc current", "They generate arcs for welding"],
  ...
  },
  {
    ...
    "opts": ["It will make the contacts too shiny", "It creates static electricity", "Emery particles embed in the soft silver, acting as insulators and causing rapid overheating", "It magnetizes the contacts"],
  ...
  },
  {
    ...
    "opts": ["The UVT coil drops out", "The breaker automatically closes", "A mechanical indicator flag on the front panel changes from 'DISCHARGED' to 'CHARGED'", "A loud ringing bell sounds"],
  ...
  },
  {
    ...
    "opts": ["By pushing the contacts together with a screwdriver", "By pumping the manual charging handle on the front panel until the spring latches 'CHARGED', then pressing the mechanical CLOSE button", "By applying 24V DC to the shunt trip", "It cannot be closed manually"],
  ...
  },
  {
    ...
    "opts": ["The breaker trips freely without drawing an arc", "The breaker is free to trip instantly on a fault even if the operator is forcefully holding the mechanical close button down", "It trips without needing any voltage", "The trips can be bypassed for free"],
  ...
  },
  {
    ...
    "opts": ["1\u20132% of rated generator KW", "5\u201315% of rated generator KW", "50\u201360% of rated generator KW", "100\u2013110% of rated generator KW"],
  ...
  },
  {
    ...
    "opts": ["The busbars melting from reverse voltage", "The diesel engine being motored without fuel, causing pistons and valves to seize due to lack of combustion lubrication", "The ACB exploding from overcurrent", "The generator spinning backwards and unwinding the coils"],
  ...
  },
  {
    ...
    "opts": ["To prevent nuisance tripping during synchronizing transients or sudden load swings where momentary reverse power may occur", "To allow the engine to restart automatically", "To give the ETO time to manually trip the breaker", "Because the relay takes 5 seconds to measure the power"],
  ...
  },
  {
    ...
    "opts": ["Swap the phase cables on the generator output", "Run two generators in parallel, slowly reduce fuel/governor on one until its KW drops to zero and reverses, observing the trip", "Inject a reverse current signal from a battery", "Press the 'Test' button on the MSB panel"],
  ...
  },
  {
    ...
    "opts": ["By using a relay test set to inject phase-shifted secondary current and voltage signals to simulate reverse power flow", "It cannot be tested in drydock", "By shorting the VT and CT together", "By spinning the generator backward with a crane"],
  ...
  },
  {
    ...
    "opts": ["10\u201315% above rated RPM", "50% above rated RPM", "2\u20135% above rated RPM", "25\u201330% above rated RPM"],
  ...
  },
  {
    ...
    "opts": ["Suddenly drop full load off the generator and watch it speed up", "Run unloaded in manual mode, slowly increase the governor speed setpoint above rated RPM until the mechanical fly-weight activates", "Disconnect the governor linkage while running at full load", "Inject a high frequency signal into the ECU"],
  ...
  },
  {
    ...
    "opts": ["The massive mechanical forces could cause catastrophic engine failure", "Because the propeller would fall off", "Because it is illegal under MARPOL", "Because the ship would go too fast"],
  ...
  },
  {
    ...
    "opts": ["By using the Engine Management System (EMS) simulation function to electronically trigger the over-speed signal and verify fuel shut-off", "By disconnecting the tachometer completely", "By physically overspeeding the engine in reverse", "By lifting the propeller out of the water"],
  ...
  },
  {
    ...
    "opts": ["The emergency generator starts immediately", "The AVR increases voltage to compensate", "Non-essential loads are shed to reduce demand, allowing the prime mover to recover speed and frequency without blacking out", "The generator ACB trips immediately"],
  ...
  },
  {
    ...
    "opts": ["The cooling water is too cold", "The AVR is supplying too much voltage", "The reverse power relay has failed", "The generator is severely overloaded, and the prime mover lacks the torque to maintain synchronous speed"],
  ...
  },
  {
    ...
    "a": "Stage 1: 5s, Stage 2: 15s, Stage 3: 25s",
    "opts": ["Stage 1: 1min, Stage 2: 2min, Stage 3: 3min", "All stages trip instantly at 47Hz", "Stage 1: 1s, Stage 2: 2s, Stage 3: 3s", "Stage 1: 5s, Stage 2: 15s, Stage 3: 25s"],
  ...
  },
  {
    ...
    "opts": ["Bow thruster and cargo winches", "Accommodation lighting and water heaters", "Essential safety loads like steering gear, nav lights, GMDSS, and emergency fire pumps", "Air conditioning compressors and galley ovens"],
  ...
  },
  {
    ...
    "opts": ["200% of rated voltage", "130\u2013150% of rated voltage", "110\u2013115% of rated voltage", "102\u2013105% of rated voltage"],
  ...
  },
  {
    ...
    "opts": ["The pumps spin faster to compensate", "The pumps switch to emergency battery power", "Pump motor speed drops 10%, drastically reducing cooling water flow and risking severe main engine overheating", "The pumps draw zero current"],
  ...
  },
  {
    ...
    "opts": ["Because relays cannot operate instantly", "To allow the crew to finish cooking in the galley", "To prevent nuisance shedding during the brief, massive current surges of starting large motors", "To give the alarm bell time to ring"],
  ...
  },
  {
    ...
    "opts": ["The ICCP system will shut down", "The under-frequency relay will eventually trip as the engine slows down, or the overcurrent relay will trip if motoring draws excessive current", "The MSB will explode", "The shore power will automatically connect"],
  ...
  },
  {
    ...
    "opts": ["100% of rated current", "10\u201330% of rated generator current", "It trips on voltage, not current", "1\u20132% of rated current"],
  ...
  },
  {
    ...
    "opts": ["Under-Voltage only affects DC; Under-Frequency only affects AC", "Under-Voltage causes overspeed; Under-Frequency causes reverse power", "Under-Voltage is an AVR/excitation failure; Under-Frequency is a prime mover/governor overload issue", "There is no difference; they happen simultaneously"],
  ...
  },
  {
    ...
    "opts": ["To save battery power", "To stop the diesel engine", "Because the AVR requires 440V to operate", "Tripping the ACB isolates the busbars, but tripping excitation stops the runaway generator from destroying its own internal windings with massive voltage"],
  ...
  },
  {
    ...
    "opts": ["A MARPOL Annex VI document certifying the engine's emissions meet Tier I/II/III limits based on specific electronic and mechanical settings", "A manual for fixing nitrogen leaks", "A log of all exhaust gas temperatures", "A certificate for the ICCP system"],
  ...
  },
  {
    ...
    "opts": ["Low fuel level and high ambient room temperature", "Overspeed, high bearing temperature, low lube oil pressure, and high cooling water temperature", "High exhaust smoke and low bilge level", "Radar failure and steering failure"],
  ...
  },
  {
    ...
    "opts": ["By moving the telegraph to all positions (ahead/astern) and verifying the Bridge and ECR indicators perfectly match and alarms sound on mismatch", "By testing the engine at full speed", "By sending a Morse code message to shore", "By measuring the voltage of the handle"],
  ...
  },
  {
    ...
    "opts": ["That resistance is < 1 \u03a9, ensuring the rotating propeller is electrically bonded to the hull for ICCP protection", "That the bearings are fully lubricated with thick oil", "That the shaft is not spinning", "That the shaft is generating 440V"],
  ...
  },
  {
    ...
    "opts": ["Certificates showing fuel sulphur content, retained for a minimum of 3 years for MARPOL Annex VI compliance", "Logs of battery charging, retained for 5 years", "Receipts for lubricating oil, retained for 1 year", "Records of shore power connection, retained forever"],
  ...
  },
  {
    ...
    "opts": ["By holding a blowtorch to the actual bearing", "By running the engine at 200% load", "By applying a calibrated resistance or mV signal to the automation system, simulating a hot PT100/thermocouple, and verifying the shutdown", "By draining all the oil from the engine"],
  ...
  },
  {
    ...
    "opts": ["To test the overspeed trip", "To check if oil is leaking from the governor", "To ensure the engine speed drops by the correct percentage when full load is applied, allowing stable parallel operation", "To see how fast the ship can go"],
  ...
  },
  {
    ...
    "opts": ["By pressing the physical emergency stop buttons on the Bridge/ECR and verifying the fuel solenoid valves instantly close", "By calling the Chief Engineer to turn a valve", "By tripping the main switchboard", "By dumping saltwater into the fuel tank"],
  ...
  },
  {
    ...
    "opts": ["That the turbocharger is spinning", "That the ship's speed over ground is correct", "That the wind speed is accurate", "That the electronic RPM pickups on the flywheel match the physical RPM of the shaft perfectly"],
  ...
  },
  {
    ...
    "opts": ["A temperature sensor in the scavenge air space that triggers an alarm if unburned oil/carbon ignites", "A water level sensor in the bilge", "A smoke detector on the bridge", "A UV flame detector in the funnel"],
  ...
  },
  {
    ...
    "opts": ["The voltage of the bridge lights", "The brand of the computer monitor", "The ship's internet search history", "Software version control, injection timing parameters, and electronic cylinder condition monitoring data"],
  ...
  },
  {
    ...
    "opts": ["Loss of oil pressure destroys the crankshaft and main bearings in seconds; the trip stops the engine before metal-to-metal contact occurs", "It keeps the oil from freezing", "It stops the propeller from falling off", "It prevents oil from spilling overboard"],
  ...
  },
  {
    ...
    "opts": ["Running out of heavy fuel oil", "Parameters approaching trip limits (e.g., high exhaust temp); the EMS automatically reduces RPM to shed load and prevent a full shutdown", "The captain pulling the telegraph to half-ahead", "A fault in the steering gear"],
  ...
  },
  {
    ...
    "opts": ["By lifting the engine with a crane", "By turning the AVR off and on", "By suddenly throwing a large load (like a bow thruster) onto the bus and measuring how quickly the governor stabilizes the frequency", "By checking the fuel oil density"],
  ...
  },
  {
    ...
    "opts": ["To lubricate the pistons", "To detect explosive oil vapor in the crankcase, triggering an immediate shutdown to prevent a massive crankcase explosion", "To check if the oil needs changing", "To measure exhaust emissions"],
  ...
  },
  {
    ...
    "opts": ["Verify that the shore supply voltage and frequency exactly match the ship's system (e.g., 440V, 60Hz)", "Start the ship's main engine", "Connect the massive cables as quickly as possible", "Turn on all the ship's lights"],
  ...
  },
  {
    ...
    "opts": ["A megger", "A thermal imaging camera", "A standard voltmeter", "A Phase Sequence Meter (to verify R-Y-B phase rotation matches)"],
  ...
  },
  {
    ...
    "opts": ["A longer extension cord", "A massive rectifier bridge", "A rotary or static Frequency Converter and a step-up transformer", "A galvanic isolator alone"],
  ...
  },
  {
    ...
    "opts": ["They must be in the TEST position", "They must be removed from the ship", "They must be OPEN and mechanically locked out/isolated", "They must be CLOSED to share the load"],
  ...
  },
  {
    ...
    "opts": ["It draws too much shore power", "It will electrocute the dry dock workers", "It causes the hull to rust instantly", "Running it in air causes high-voltage arcing with no electrolyte, presenting a severe fire risk and destroying the anodes"],
  ...
  },
  {
    ...
    "opts": ["It blocks low-voltage DC (stray ICCP current) but allows high-voltage AC fault currents to pass safely to earth", "It stops AC voltage from entering the ship", "It converts shore AC to ship DC", "It acts as a lightning rod"],
  ...
  },
  {
    ...
    "opts": ["On standby in MANUAL mode, ready as a backup if shore power fails", "Running constantly at full load", "Wired directly into the shore supply", "Completely dismantled for overhaul"],
  ...
  },
  {
    ...
    "opts": ["Wait 24 hours before turning on any pumps", "Progressively \u2014 start with minimal load, verify voltage/frequency stability, then add heavy loads sequentially", "Only run 24V DC equipment", "Turn everything on at once to test capacity"],
  ...
  },
  {
    ...
    "opts": ["The amount of fuel remaining", "The capacity of the ICCP system", "The current rating of the shore supply cables and the shore connection box breaker", "The size of the ship's generators"],
  ...
  },
  {
    ...
    "opts": ["Nothing, the seawater acts as the earth", "A deadly shock hazard exists because a fault on the ship will not return to the shore transformer to trip the breaker", "The ship will become heavily magnetized", "The ship's lights will flicker"],
  ...
  },
  {
    ...
    "opts": ["Directly onto the main engine", "Via the anchor chain", "At the emergency generator terminals", "At the Shore Connection Box (typically using heavy-duty IEC 60309 sockets/plugs)"],
  ...
  },
  {
    ...
    "opts": ["Call the port state control", "Nothing, it is an informal procedure", "Log the connection in the electrical logbook with date, time, voltage, frequency, and phase check results", "Update the ship's registry"],
  ...
  },
  {
    ...
    "opts": ["The dry dock is underwater", "The ship's transformer is broken", "The shore power is AC instead of DC", "The long, thick shore cables have significant electrical resistance; high current causes high voltage drop (V=IR) over the distance"],
  ...
  },
  {
    ...
    "opts": ["The shore supply must be synchronized (voltage, frequency, phase) with the running generator before momentarily closing the breaker", "It is physically impossible", "A massive battery bank", "A very fast pair of hands"],
  ...
  },
  {
    ...
    "opts": ["To signal the dry dock workers", "To automatically disconnect the ship if shore power fails, preventing the ship's motors from stalling and burning out on low voltage", "To save electricity", "To start the main engine"],
  ...
  },
  {
    ...
    "opts": ["By looking at the lightbulbs during the day", "By measuring the voltage of the main switchboard", "By simulating a main power failure and verifying that all required emergency lights illuminate from the emergency supply/batteries", "By replacing all the batteries"],
  ...
  },
  {
    ...
    "opts": ["Instantaneous movement to 10 degrees", "Hard-over (15\u00b0 to 15\u00b0) in 60 seconds", "Hard-over (35\u00b0 on one side to 30\u00b0 on the other) in \u2264 28 seconds", "360 degree rotation in 1 minute"],
  ...
  },
  {
    ...
    "opts": ["Hard-over (15\u00b0 on one side to 15\u00b0 on the other) in \u2264 60 seconds at half speed", "Hard-over (35\u00b0 to 30\u00b0) in 28 seconds", "It must steer the ship in reverse", "It operates entirely on manual hand wheels"],
  ...
  },
  {
    ...
    "opts": ["Activate detectors in each zone using test aerosol (smoke) or heat guns, and verify the correct zone alarm sounds on the main panel", "Check the voltage of the backup battery", "Press the 'Test' button on the panel only", "Light a small fire in a bucket"],
  ...
  },
  {
    ...
    "opts": ["That the radar screen turns off", "That the autopilot disengages", "That the ship stops moving if the captain sleeps", "That an unacknowledged alarm escalates correctly from the Bridge, to the Master's cabin, and then to the general crew/engineering alarm"],
  ...
  },
  {
    ...
    "opts": ["Both expire every 10 years", "Battery 1 year; HRU 1 year", "Battery typically 5 years; HRU strictly 2 years", "They never expire"],
  ...
  },
  {
    ...
    "opts": ["By pressing the Mayday button", "By throwing it in the water", "Using its self-test switch to trigger a brief transmission, which is verified on the ship's 9GHz X-band radar as a 12-dot pattern", "By measuring its physical weight"],
  ...
  },
  {
    ...
    "opts": ["That they are visible from space", "That they flash in Morse code", "Main and backup bulbs work, the backup power supply functions, and the failure alarm activates if a bulb burns out", "That they are painted the correct color"],
  ...
  },
  {
    ...
    "a": "Channel 70",
    "opts": ["Channel 16", "Channel 70", "Channel 09", "Channel 13"],
  ...
  },
  {
    ...
    "opts": ["The ship is steered in a circle", "An approved technician downloads data to verify all sensors (Radar, Audio, GPS, Engine alarms) are successfully recording to the hardened capsule", "The hard drive is wiped clean", "The capsule is dropped from the mast"],
  ...
  },
  {
    ...
    "opts": ["That it can detect submarines", "That it steers the ship automatically", "Verifying that the transmitted dynamic data (position/speed) and static data (MMSI/Ship Name) are correct and updating", "That it blocks spam messages"],
  ...
  },
  {
    ...
    "opts": ["It acts as a map of the ship", "It replaces the need for a manual", "It guarantees the worker extra pay", "It provides a formal, signed checklist proving a Task Risk Assessment was done and all safety isolations are in place before dangerous work begins"],
  ...
  },
  {
    ...
    "a": "Lock Out, Tag Out",
    "opts": ["Line Out, Test Output", "Live Operations, Trained Operators", "Leave Open, Turn Off", "Lock Out, Tag Out"],
  ...
  },
  {
    ...
    "opts": ["To provide visible, physical disconnection of the massive main copper contacts from the live busbars", "To keep the breaker warm", "To allow the springs to charge", "To clean the dust off the back"],
  ...
  },
  {
    ...
    "opts": ["The brand of the circuit breaker", "The voltage of the circuit", "The ship's destination", "Warning ('Do Not Operate'), Name of the person working, Date, and Reason for isolation"],
  ...
  },
  {
    ...
    "opts": ["Prove dead: Use an approved voltage tester to verify zero voltage exists across all phases and to earth", "Call the captain", "Sign the PTW paper", "Put on a hard hat"],
  ...
  },
  {
    ...
    "opts": ["Only as an absolute last resort (e.g., fault tracing requiring power), with a specialized PTW and stringent PPE", "For daily routine cleaning", "Whenever the ETO is in a hurry", "It is never permitted under any circumstances"],
  ...
  },
  {
    ...
    "opts": ["A full medical team", "At least two persons must be present: one working, and one standing by ready to hit the emergency stop and provide rescue", "Three engineers", "One highly trained ETO"],
  ...
  },
  {
    ...
    "opts": ["Surgical latex gloves", "Standard leather work gloves", "Minimum Class 0 (rated for 1000V AC)", "Class 00 (rated for 500V AC)"],
  ...
  },
  {
    ...
    "opts": ["ISO 9001", "Marine grade stainless", "IEC 60900 (certified 1000V insulated)", "CE marking only"],
  ...
  },
  {
    ...
    "opts": ["They violate uniform codes", "They interfere with the magnetic fields of the relays", "They reflect the MSB lights into the operator's eyes", "They bypass skin resistance (causing severe shock) and can bridge live contacts, melting into the skin instantly"],
  ...
  },
  {
    ...
    "opts": ["A wool balaclava", "A welding mask", "Standard reading glasses", "An Arc Flash rated visor or insulating face shield"],
  ...
  },
  {
    ...
    "opts": ["Because the company requires two tags for paperwork", "To remind the oiler to check the oil", "To ensure an operator doesn't start the prime mover locally while someone is working on its breaker", "To drain the fuel lines"],
  ...
  },
  {
    ...
    "opts": ["Pressing the manual 'Close' and then 'Open' buttons after the breaker is racked out and control power is removed", "Pouring oil on the spring", "Waiting 24 hours", "Hitting the breaker with a rubber mallet"],
  ...
  },
  {
    ...
    "opts": ["Who gets blamed if something breaks", "The fastest way to finish the job", "The specific hazards of the job and the required control measures (like PPE and isolations) to mitigate them", "The cost of the spare parts"],
  ...
  },
  {
    ...
    "opts": ["Before the risk assessment is done", "When the surveyor arrives", "Only after the work is complete, all tools are removed, guards are replaced, and the system is safely restored to normal operation", "As soon as the work begins"],
