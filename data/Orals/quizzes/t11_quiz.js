window.loadQuizzes("T11_PowerFactor", [
  {
    ...
    "opts": [
      "Useful power converted into mechanical work or heat",
      "Magnetising power oscillating without doing net work",
      "Total power supplied - vector sum of active (kW) and reactive (kVAR) power",
      "Mechanical shaft power from the prime mover"
    ],
  ...
  },
  {
    ...
    "opts": [
      "kW ratings fluctuate with ambient temperature",
      "kVA accounts for prime mover mechanical losses",
      "kVA defines thermal and insulation limits (current x voltage) regardless of load power factor",
      "Alternators only supply reactive power which cannot be measured in kW"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Prime mover overspeeds - reactive power reverses shaft force",
      "System voltage rises uncontrollably damaging navigation equipment",
      "Larger current needed for same kW - I2R heating losses, voltage drop, reduced generator capacity",
      "Active power oscillates causing synchronizing panel to hunt"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Long cables create parasitic capacitance making current lead voltage",
      "AVRs tuned to delay voltage waveform for stability",
      "Majority of loads are induction motors - inherently inductive - draw lagging magnetising current",
      "Electric heaters and incandescent lighting dominate load profile"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Static capacitor bank auto-switched by thyristors",
      "Heat exchanger condensing moisture to prevent winding shorts",
      "Overexcited synchronous motor running without mechanical load - generates leading kVAR to cancel lagging kVAR",
      "Active front-end rectifier limiting generator to 1.0 PF"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Capacitors consume massive active power (kW) to operate",
      "Synchronous condenser is smaller and cheaper to install",
      "Continuously variable smooth kVAR output by adjusting field current - capacitors switch in fixed blocks only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Consumed as heat in stator winding resistance",
      "Converted into useful mechanical torque",
      "Oscillates between generator and motor each half-cycle sustaining the magnetic field - not consumed as heat",
      "Leaks through hull earthing - why bonding is required"
    ],
  ...
  },
  {
    ...
    "opts": [
      "THD <= 10%; single harmonic <= 5%",
      "THD <= 3%; single harmonic <= 1%",
      "THD <= 5% total; no single harmonic > 3%",
      "No limit - only voltage must stay within +/-10% of nominal"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Decrease system frequency from 60Hz to 50Hz",
      "Install larger NER to absorb harmonic frequencies",
      "Run emergency generator in parallel to provide clean sine wave",
      "Active Front End (AFE) rectifiers, 12/24-pulse drive designs, or passive/active harmonic filters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Adjust AVR voltage trimmer on Gen B to force more active power",
      "Adjust governor droop - increase speed trimmer on Gen B or decrease on Gen A",
      "Trip Gen B and re-synchronise at higher frequency",
      "Do nothing - they will equalise naturally"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Adjust governor droop - decrease speed of Gen1",
      "Adjust AVR droop - decrease voltage trimmer on Gen1 and increase on Gen2 to balance kVAR",
      "Disconnect synchronous condenser - causing phase imbalance",
      "Turn off preferential trip relay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Forces absolute isochronous constant frequency regardless of load",
      "Automatically sheds non-essential loads at 90% rated capacity",
      "Allows slight speed/voltage drop as load increases - prevents generator hunting and ensures stable proportional load sharing",
      "Delays emergency generator start to ensure main bus is dead first"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Trips immediately on reverse power relay",
      "Stops generating kVAR and starts absorbing kVAR from busbar - acts as induction generator",
      "Generates massive leading kVAR spike driving bus voltage high",
      "kW drops to zero but continues supplying half ship kVAR"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Under-excitation relay (Loss of Field relay)",
  ...
  },
  {
    ...
    "opts": [
      "1.414 - peak voltage stress on cable insulation",
      "0.8 - standard motor design PF",
      "1.732 - phase to line voltage conversion in star",
      "1.11 - fundamental constant in transformer EMF equation (E = 4.44 x f x N x phi)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Generator at 0.7 PF has faster prime mover needing governor adjustment",
      "Generator at 0.8 PF has faulty AVR failing to produce active power",
      "0.1 PF difference will cause immediate short circuit on paralleling",
      "Generator at 0.7 PF has more inductive loads (higher kVAR demand) on its bus section"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Anti-condensation heaters accidentally left on",
      "Adjust AVR droop to shed 50% kW load",
      "Inject test signal into reverse power relay",
      "Individual phase ammeters - possible single-phase imbalance hidden by averaged 3-phase meter readings"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The cosine of the phase angle (cos phi) between voltage and current.",
      "The tangent of the phase angle (tan phi) between voltage and current.",
      "The sine of the phase angle (sin phi) between active and reactive power."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The current waveform leads the voltage waveform by exactly 90 degrees.",
      "The circuit is drawing maximum reactive power from the generator.",
      "The current and voltage waveforms are exactly in phase, representing a purely resistive load.",
      "The current waveform lags the voltage waveform by exactly 90 degrees."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The resistance of their copper windings slows down the voltage wave.",
      "Their inherent inductance delays the current, causing it to lag behind the supply voltage.",
      "They act as massive capacitors, storing electrical charge during each cycle.",
      "The physical rotation of the motor pushes the current waveform ahead of the voltage."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The electrical system is losing 30% of its power strictly as heat in the distribution cables.",
      "Only 70% of the apparent power (kVA) supplied by the generator is doing useful active work (kW).",
      "The voltage has dropped to 70% of the rated busbar voltage due to inductive loads.",
      "The ship generators are running at 70% of their maximum mechanical speed."
    ],
  ...
  },
  {
    ...
    "opts": [
      "It increases the active power output limit of the generator.",
      "It permanently dissipates as heat inside the generator core, destroying the stator.",
      "It consumes generator current capacity without doing any useful mechanical work.",
      "It buffers the generator, allowing it to handle sudden short circuits safely."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the generator thermal and insulation limits are determined by total current and voltage, regardless of the load power factor.",
      "Because kW meters are not accurate enough to determine the prime mover output.",
      "Because a kW rating would only apply if the ship had a purely inductive load.",
      "Because kVA automatically factors in the mechanical losses of the diesel engine."
    ],
  ...
  },
  {
    ...
    "a": "I times cos phi",
    "opts": [
      "I divided by cos phi",
      "I times cos phi",
      "I divided by sin phi",
      "I times sin phi"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It draws a leading current that naturally corrects the power factor of the induction motors.",
      "It stops drawing any current, effectively removing itself from the power factor calculation.",
      "It perfectly balances active and reactive power, drawing the system closer to unity.",
      "It draws a highly reactive magnetizing current, which significantly lowers the system power factor."
    ],
  ...
  },
  {
    ...
    "opts": [
      "kW squared = kVA squared + kVAR squared",
      "kVA squared = kW squared + kVAR squared",
      "kVAR squared = kW squared + kVA squared",
      "kVA = kW + kVAR"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the long cable runs on ships act as massive capacitors.",
      "Because shipboard generators are designed to only produce lagging current.",
      "Because over 70% of the ship electrical loads are induction motors, which are inherently inductive.",
      "Because maritime regulations legally prohibit the use of leading power factors."
    ],
  ...
  },
  {
    ...
    "opts": [
      "It continuously oscillates back and forth between the source and the load to maintain magnetic fields.",
      "It permanently dissipates into the environment as acoustic noise and mechanical vibration.",
      "It is the portion of power strictly converted into heat by incandescent lighting.",
      "It is the active power stored in the generator rotor for emergency overloads."
    ],
  ...
  },
  {
    ...
    "opts": [
      "It requires a larger total current to supply the same active power, drastically increasing I squared R heating losses.",
      "It forces the generator governor to over-speed the prime mover to compensate.",
      "It directly breaks down the insulation matrix of the cables via chemical decomposition.",
      "It creates intense friction inside the magnetic core of the generator, destroying the bearings."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The current vector rotates behind the voltage reference vector by the phase angle phi.",
      "The current vector is completely stationary while the voltage vector rotates.",
      "The current vector rotates ahead of the voltage reference vector by the phase angle phi.",
      "The voltage and current vectors rotate exactly parallel to each other."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The current remains the same, but voltage drops by 43%.",
      "The current increases by approximately 43%.",
      "The current increases by 70%.",
      "The current decreases by 30%."
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "P = root3 x V x I x cos phi",
      "P = root3 x V x I x sin phi",
      "P = V x I x cos phi"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The maximum active power it can safely deliver drops from 800 kW to 600 kW.",
      "There is no effect; the generator will still supply 800 kW safely.",
      "The generator can safely deliver 1000 kW because voltage is increased.",
      "The generator apparent power capacity automatically drops to 600 kVA."
    ],
  ...
  },
  {
    ...
    "opts": [
      "I = P_output / (V x PF x Efficiency)",
      "I = P_output / (3 x V x PF)",
      "I = (P_output x Efficiency) / (root3 x V x PF)",
      "I = P_output / (root3 x V x PF x Efficiency)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It decreases the current (I) but increases the resistance (R), keeping voltage drop constant.",
      "It directly increases the frequency, which causes a higher inductive voltage drop.",
      "It isolates the reactive power from the cable, thereby reducing the overall voltage drop.",
      "It increases the current (I) for the same kW load, which proportionally increases the voltage drop along the cable."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The low power factor prevents the generator from producing 440V at the source.",
      "The reactive power is converted into active power inside the cables, decreasing the voltage.",
      "The magnetizing current increases the supply frequency, which lowers the voltage.",
      "The reactive current increases the total line current (I), thereby increasing the voltage drop (I x R x L) across the supply cables."
    ],
  ...
  },
  {
    ...
    "opts": [
      "A low power factor requires the generator to supply a much larger total current (kVA) to deliver the same active power, significantly increasing I squared R (copper) heating losses in the stator windings.",
      "A low power factor causes the prime mover to overspeed, which generates excess friction and heat in the alternator bearings.",
      "A low power factor increases the magnetic friction inside the rotor, directly transferring mechanical heat to the stator windings.",
      "A low power factor introduces high-voltage spikes that break down the insulation, causing the generator to run hot."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The cables experience a decrease in current but a massive increase in voltage, stressing the insulation.",
      "The cables must carry higher total current, leading to increased I squared R heating losses and a greater voltage drop along the cable run.",
      "The cables become highly capacitive, causing them to generate reactive power and reverse the current flow.",
      "The cables physically contract due to magnetic hysteresis, leading to terminal connection failures."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The generator apparent power capacity automatically drops to 800 kVA to protect the windings.",
      "The generator can still supply 1000 kW at 0.8 PF, but it will consume 20% less fuel.",
      "The maximum useful active power is reduced to 800 kW at 0.8 PF, whereas it could supply the full 1000 kW at unity PF.",
      "The useful active power increases to 1250 kW because the reactive power acts as a magnetic booster."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The prime mover will stall immediately because it lacks the reactive torque to spin the generator.",
      "The generator will successfully supply the 1000 kW but its voltage will drop to 70% of the rated value.",
      "The generator will automatically correct the power factor to 1.0 to accommodate the active load.",
      "The generator will severely overload and trip on overcurrent because it requires 1428 kVA of total current to deliver 1000 kW at a 0.7 PF."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because a low power factor forces the transformer to step up the voltage higher than its design limit.",
      "Because the reactive power generates high-frequency harmonics that degrade the transformer oil.",
      "Because the low power factor directly increases the core magnetic flux, causing excessive eddy current losses.",
      "Because the transformer must conduct a higher apparent power (kVA) and total current to supply the same active power (kW), which increases I squared R losses in the windings."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Fuel consumption drops because the governor automatically reduces engine speed at lower power factors.",
      "Fuel consumption per kW increases because the prime mover must burn extra fuel to overcome the increased I squared R (copper) losses caused by the higher reactive current.",
      "Fuel consumption decreases because the reactive power assists the prime mover in rotating the alternator.",
      "Fuel consumption remains completely unaffected because diesel engines only react to active power (kW)."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The governor maximum speed limit is reached, triggering an overspeed trip.",
      "The alternator thermal/current limit (kVA) is reached long before the prime mover mechanical power limit (kW).",
      "The exciter minimum voltage limit is reached, causing a loss of excitation trip.",
      "The prime mover mechanical power limit (kW) is reached long before the alternator thermal limit."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The ship must pay a fine for generating harmonics that travel back into the national grid.",
      "The ship will be charged for exporting excess active power back into the shore grid.",
      "The port utility will reduce the supply voltage by 20%, forcing the ship to run its own generators.",
      "Port utility companies impose a power factor penalty surcharge because they must supply and dedicate grid capacity for the ship excess reactive power (kVAR)."
    ],
  ...
  },
  {
    ...
    "opts": [
      "It makes the voltage exceptionally stable by acting as a magnetic buffer against load fluctuations.",
      "It places a heavy demand on the generator excitation system, making it sluggish and prone to severe voltage dips and instability during sudden load changes.",
      "It causes the busbar frequency to spike dangerously, leading to overspeed trips.",
      "It forces the Automatic Voltage Regulator (AVR) to shut down completely, leaving the system in manual control."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Both generators will immediately trip on reverse power due to the lagging current.",
      "The power factor of the entire ship will automatically be corrected to unity to balance the load.",
      "One generator will automatically take all the active power (kW), while the other takes all the reactive power (kVAR).",
      "One generator will take on an excessive share of the reactive current (kVAR), causing its stator to overheat, even if the active power (kW) is shared equally."
    ],
  ...
  },
  {
    ...
    "opts": [
      "True PF only measures active power (kW), while Displacement PF only measures reactive power (kVAR).",
      "There is no difference; they are just two different names for the cosine of the phase angle.",
      "Displacement PF measures the mechanical displacement of the motor shaft, while True PF measures the electrical input.",
      "Displacement PF only accounts for the phase angle between fundamental voltage and current, while True PF also includes the degrading effects of harmonic distortion."
    ],
  ...
  },
  {
    ...
    "opts": [
      "They artificially inflate the Active Power (kW) readings, tricking the generator into under-producing.",
      "These harmonic currents increase the total RMS current drawn (Apparent Power) without adding any useful Active Power, which severely reduces the True Power Factor.",
      "They cancel out the fundamental frequency, causing the Displacement Power Factor to drop to zero.",
      "They reverse the phase angle, causing the motors to draw leading current instead of lagging current."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The low power factor causes the cable resistance to increase temporarily due to skin effect.",
      "The low power factor actively sucks voltage out of the lighting circuits to feed the motor rotor.",
      "The motor startup physically lengthens the cable due to sudden magnetic repulsion.",
      "The motor draws a massive lagging reactive current during startup, massively increasing the total line current and creating a huge voltage drop across the system impedance."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The low power factor causes the shore supply voltage to spike, triggering an overvoltage trip.",
      "The shore connection breaker is designed to instantly trip if the power factor drops below exactly 1.0.",
      "The poor power factor causes the shore frequency to drop from 60 Hz to 50 Hz, triggering an under-frequency trip.",
      "The excessive reactive current (kVAR) drawn by the ship pushes the total apparent power (kVA) and current beyond the thermal trip limit of the shore connection breaker."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The heating losses remain constant because voltage drops proportionally.",
      "The heating losses increase by exactly 25%.",
      "The heating losses increase by 125%.",
      "The heating losses increase by approximately 56%."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The apparent power requirement increases from 750 kVA to 1000 kVA.",
      "The apparent power requirement decreases from 1000 kVA to 750 kVA.",
      "The apparent power requirement increases from 480 kVA to 600 kVA.",
      "The apparent power requirement remains at 600 kVA, but the current doubles."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The ACB must be equipped with a reverse power relay specifically designed for low power factor environments.",
      "The ACB requires thicker arc chutes to handle the higher active power generated by the poor power factor.",
      "The ACB must be physically larger and have a higher current rating to safely carry the increased apparent power (kVA) required for the same active kW load.",
      "The ACB can be smaller because reactive power flows in the opposite direction and cancels out active power."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The low power factor directly increases the iron (core) losses in the generator, which consumes all the active power.",
      "The reactive power chemically breaks down the lubricating oil in the prime mover, reducing mechanical efficiency.",
      "A significant portion of the generated current does no useful work but still incurs copper (I squared R) losses in generators, transformers, and cables, wasting prime mover fuel as heat.",
      "The low power factor forces the generators to run at a lower RPM, dragging the diesel engines out of their efficient operating band."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the prime mover automatically cuts fuel to prevent the reactive power from destroying the diesel engine.",
      "Because the high reactive current demands push the stator winding temperature and the excitation system to their absolute thermal limits before the rated kW can be reached.",
      "Because the reverse power relay will instantly trip the breaker to protect the busbars from reactive feedback.",
      "Because a low power factor physically stalls the generator rotor, preventing it from turning at synchronous speed."
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are connected in parallel with the load and supply leading kVAR locally, which cancels out the lagging kVAR drawn by induction motors.",
      "They absorb excess active power during light load conditions and release it during heavy load conditions.",
      "They convert the lagging reactive power into active power, directly increasing the shaft torque of the motors.",
      "They are connected in series with the generator to boost the active power output directly into the motors."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Series connection is mathematically impossible for AC circuits operating above 50 Hz.",
      "Series connection would cause the capacitors to absorb active power rather than reactive power.",
      "Parallel connection ensures the capacitors receive the constant system voltage and do not have to carry the full load current, which would cause severe voltage regulation issues.",
      "Parallel connection ensures the capacitors automatically step down the voltage to protect the motors."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Exactly 1.0 (Unity) under all conditions",
      "0.95 to 0.99 leading",
      "0.60 to 0.75 lagging",
      "0.92 to 0.95 lagging"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is a static transformer that shifts the phase angle of the current exactly 90 degrees forward.",
      "It is an overexcited synchronous motor running freely on the busbars with absolutely no mechanical load attached to its shaft.",
      "It is a diesel-driven generator operating with its AVR switched off.",
      "It is a heavily loaded induction motor running at high slip to absorb excess reactive power."
    ],
  ...
  },
  {
    ...
    "opts": [
      "By using its built-in capacitor banks to filter out harmonic distortions from the grid.",
      "By operating in an overexcited state, it draws a leading current that supplies leading kVAR to cancel out the lagging kVAR of the induction motors.",
      "By mechanically spinning a massive flywheel, it physically pushes the voltage waveform to align with the current.",
      "By operating in an underexcited state, it absorbs active power and releases it as pure reactive power."
    ],
  ...
  },
  {
    ...
    "opts": [
      "It forces the generator to run at 92% of its maximum RPM.",
      "It decreases the active power capacity to 750 kW, allowing the prime mover to rest.",
      "It permanently reduces the generator apparent power rating from 1000 kVA to 750 kVA.",
      "It increases the available useful active power from 750 kW to 920 kW without exceeding the generator thermal current limits."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Thyristors provide an exceptionally fast, transient-free response to rapidly fluctuating reactive loads without mechanical wear.",
      "Thyristors automatically block all 3rd and 5th order harmonics from entering the main switchboard.",
      "Thyristors allow the capacitors to be wired in series with the main generators safely.",
      "Thyristors physically generate leading active power, completely replacing the ship generators."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Plain capacitor banks actively generate 5th and 7th harmonics which destroy the VFD rectifiers.",
      "Passive LC filters supply leading kVAR at the fundamental frequency while simultaneously shunting specific destructive harmonic frequencies away from the network.",
      "Passive LC filters use software algorithms to cancel harmonics, unlike hardware capacitors.",
  ...
  },
  {
    ...
    "opts": [
      "To step down the main switchboard voltage before it enters the sensitive capacitor dielectric.",
      "To prevent the capacitor bank from forming a destructive resonant circuit with the system inductance at specific harmonic frequencies.",
      "To convert the leading reactive power into active power before feeding it to the load.",
      "To deliberately slow down the discharge time of the capacitors for safety during blackout."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Read the Reactive Power (kVAR) and multiply it by the Active Power (kW).",
      "Read the total Active Power (kW) and divide it by the total Apparent Power calculated from the switchboard Voltmeter and Ammeter (root3 x V x I).",
      "Measure the frequency slip on the synchroscope and multiply by the line current.",
      "Divide the generator rated kVA by the current running kW load."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Static capacitor banks consume massive amounts of active power to maintain their charge.",
      "Static capacitor banks can only correct leading power factors, not lagging ones.",
      "Static capacitor banks only provide correction in rigid, discrete steps, whereas a synchronous condenser provides smooth, continuously variable correction.",
      "Static capacitor banks require intensive daily mechanical lubrication and bearing maintenance."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR is hardcoded from the factory to operate exclusively at 0.8 power factor.",
      "The AVR only affects active power (kW) sharing, not reactive power (kVAR).",
      "The AVR only controls the terminal voltage and the share of reactive power the generator produces; it cannot change the fundamental reactive power (kVAR) demanded by the inductive loads.",
      "Adjusting the AVR to improve power factor will immediately trip the reverse power relay."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The total line current remains exactly the same, but the voltage drops by 20%.",
      "The active current increases to replace the reactive current.",
      "The total line current drastically increases, because the capacitors add their own load to the motor load.",
      "The total line current drawn from the switchboard decreases, because the capacitors supply the motor required reactive current locally."
    ],
  ...
  },
  {
    ...
    "opts": [
      "It causes voltage instability and excessive voltage rise on the busbars, forcing the generator AVRs into unstable under-excitation.",
      "It causes the prime mover to consume excessive fuel to push the leading current.",
      "It perfectly optimizes the system, resulting in zero cable heating losses.",
      "It instantly trips the generator on reverse power because active power starts flowing backwards."
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because shipboard generators are legally prohibited by SOLAS from operating above 0.95.",
      "To provide a safety margin against accidentally entering a leading power factor state if a large inductive load suddenly trips offline.",
      "Because static capacitors cannot physically produce enough kVAR to reach 1.0.",
      "Because reaching 1.0 power factor physically stalls the prime mover due to zero magnetic slip."
    ],
  ...
  },
  {
    ...
    "opts": [
      "S = P x Q",
      "S squared = P squared + Q squared",
      "P = S + Q",
      "Q squared = S squared + P squared"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The active power (kW) drawn from the generator decreases, saving massive amounts of diesel fuel.",
      "The apparent power (kVA) drawn from the generator decreases, freeing up thermal current capacity for additional active loads.",
      "The generator maximum voltage rating increases proportionally.",
  ...
  },
  {
    ...
    "opts": [
      "A capacitor physically absorbs the magnetic flux generated by the motor and converts it into active power.",
      "A capacitor steps down the busbar voltage, reducing the motor demand for reactive current.",
      "In a capacitor, current leads the voltage by 90 degrees, directly opposing the inductor where current lags the voltage by 90 degrees.",
      "In a capacitor, the voltage and current are perfectly in phase, pulling the motor current back into phase."
    ],
  ...
  },
  {
    ...
    "opts": [
      "By observing its active power meter: if kW is positive, it generates kVAR.",
      "By observing its rotational speed: if running above synchronous speed, it generates kVAR.",
      "By checking its slip frequency: high slip means it is absorbing kVAR.",
      "By observing its field excitation: if overexcited, it generates leading kVAR; if underexcited, it absorbs leading kVAR."
    ],
  ...
  },
  {
    ...
    "opts": [
      "The square root of Active Power divided by Apparent Power",
      "The ratio of Reactive Power to Active Power",
      "The ratio of Apparent Power to Reactive Power",
      "The ratio of Active Power (KW) to Apparent Power (KVA), equivalent to cos φ"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Current leads the supply voltage due to capacitive loads",
      "Voltage lags the current due to inductive loads",
      "Current lags the supply voltage due to inductive loads",
      "Current and voltage are in phase but at a low magnitude"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Current and voltage are perfectly in phase",
      "Current lags the voltage due to inductive loads",
      "Current leads the supply voltage due to capacitive loads",
      "The generator is over-loaded"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The real power that performs useful mechanical or thermal work",
      "The total power supplied by the generator",
      "The magnetizing power in the circuit",
      "The power lost strictly due to cable resistance"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The real power doing useful work",
      "The heat lost in the generator stator",
      "The mechanical friction in the prime mover",
      "The power that oscillates between source and load to sustain magnetic fields, performing no net work"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the maximum capacity is limited by stator current (heating) and voltage (insulation), which define KVA, regardless of the load's power factor",
      "Because KW cannot be measured accurately at high voltages",
      "Because they only produce reactive power",
      "Because prime mover limits are rated in KVA"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It often drops lower (e.g., 0.7 lagging) because large motors are shut down, and lightly loaded motors draw proportionally more magnetizing current",
      "It shifts to a leading power factor",
      "It rises closer to 1.0 because the main engine is off",
      "It remains exactly 0.8 regardless of operations"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The ratio of voltage drop to current",
  ...
  },
  {
    ...
    "opts": [
      "It is derived from 4 multiplied by the sine wave Form Factor of 1.11",
      "It is derived from the Peak Factor (1.414) times Pi",
      "It is the square root of 2 multiplied by Pi",
      "It represents the number of poles in a standard generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It decreases the Form Factor below 1.0",
      "It increases the Form Factor above 1.11, which causes transformers to overheat due to higher core flux",
      "It has no effect on Form Factor",
      "It locks the Form Factor at exactly 1.414"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The equivalent DC voltage/current that would produce the same heating effect (I²R) in a resistor",
      "The speed of the frequency oscillation",
      "The average mathematical value over a full cycle",
      "The absolute highest peak the wave reaches"
    ],
  ...
  },
  {
    ...
    "opts": [
      "EMF is for DC circuits; Terminal Voltage is for AC circuits",
      "They are exactly the same concept",
      "Terminal voltage is always higher than EMF",
      "EMF is the open-circuit voltage generated; Terminal Voltage drops lower under load due to internal resistance"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The heat generated in the copper windings",
      "The need to establish and maintain the rotating magnetic field in the air gap",
      "The friction of the motor bearings",
      "The mechanical load attached to the shaft"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Current and voltage are in phase (0 degrees)",
  ...
  },
  {
    ...
    "opts": [
      "The Apparent Power (KVA) directly",
      "Both Active (KW) and Reactive (KVAR) power equally",
      "Only the Active Power (KW) and the generator's physical losses",
      "Only the Reactive Power (KVAR)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR burns fuel to create KVAR",
      "It doesn't; fuel consumption is strictly tied to KW",
      "The governor gets confused by KVAR",
      "The higher KVA current causes higher I²R (copper) heating losses in the generator, which the engine must overcome"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It generates a DC offset",
      "It builds up by drawing energy from the source, and then collapses, returning the energy to the source",
      "It reverses direction instantly creating a spark",
      "It converts into active power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A physical sag in the transmission cables due to heat",
      "The time delay before a circuit breaker trips",
      "An intentional reduction in a controlled parameter (speed or voltage) as load increases, to enable stable parallel operation",
      "The loss of excitation during a blackout"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR Droop settings",
      "The Excitation Current directly",
      "The Reverse Power Relay",
      "The Governor Droop settings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Decrease the AVR droop on the 400 KW generator",
      "Increase the AVR droop on the 250 KW generator",
      "Decrease the governor droop on the 400 KW generator",
      "Slightly increase the governor droop on the 400 KW generator (or decrease it on the 250 KW generator)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "One generator is running at a higher frequency",
      "Unequal KVAR sharing due to a mismatch in AVR Droop settings",
      "Unequal KW sharing due to Governor Droop mismatch",
      "The induction motors are malfunctioning"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Increase the AVR droop on Gen 1 (or decrease it on Gen 2)",
      "Increase the Governor droop on Gen 1",
      "Increase the AVR droop on Gen 2",
      "Decrease the AVR droop on Gen 1"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Droop % = ((Full-Load Value - No-Load Value) / Full-Load Value) × 100",
      "Droop % = (Full-Load Value / No-Load Value) × 100",
      "Droop % = (No-Load Value / Full-Load Value) × 100",
      "Droop % = ((No-Load Value - Full-Load Value) / No-Load Value) × 100"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "A straight line sloping downwards from the no-load frequency to the full-load frequency",
  ...
  },
  {
    ...
    "opts": [
      "One line must slope up while the other slopes down",
      "Their droop lines must intersect at the exact same operating frequency and load point",
      "They must have exactly 0% droop",
      "Their droop lines must be perfectly horizontal"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It automatically switches to droop mode",
      "The AVR will shut down to protect the system",
      "It is unstable; the isochronous generator will try to maintain exact frequency, fighting the other generator and eventually taking all the load or motoring",
      "They will share load perfectly equally"
    ],
  ...
  },
  {
    ...
    "opts": [
      "When running three or more generators in parallel",
      "Isochronous mode is never used on ships",
      "When synchronising with shore power",
      "When a single generator is running alone and must provide a perfectly constant frequency regardless of load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Chief Engineer adjusts the fuel racks mechanically",
      "The ETO turns the potentiometers manually every hour",
      "The PMS automatically sends raise/lower pulses to the governors to balance the loads dynamically",
      "The AVR communicates with the governor via Modbus"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Gen A (5% droop) will pick up more load",
      "Gen B (3% droop) will pick up more load",
      "They will pick up load equally",
      "Neither will pick up load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The main governor fuel actuator",
      "A reverse power relay",
      "A thermistor on the rotor",
      "A Compounding Current Transformer (Droop CT) located in one of the stator phases"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It makes the generator trip on reverse power",
      "Slight variations in excitation will cause massive circulating reactive currents between the generators",
      "It burns out the diesel engine",
      "It causes the frequency to fluctuate wildly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A multi-turn potentiometer on the governor control board or a software parameter in the digital controller",
      "The hydraulic oil pressure valve",
      "A heavy mechanical spring tensioner on the fuel rack",
  ...
  },
  {
    ...
    "opts": [
      "Active load is unequal due to governor mismatch",
      "One generator is motoring",
      "Both KW and KVAR are shared equally",
      "Active load is shared equally, but reactive load is unequal due to AVR mismatch"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The generator stops producing voltage entirely",
      "The power factor becomes perfectly unity",
      "It causes positive feedback (negative droop), making the voltage rise with load, leading to severe instability in parallel",
      "The generator switches to isochronous mode"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The generator maintains speed using battery backup",
      "The generator speed/frequency will collapse far below the designed 5% droop line",
      "The droop curve flattens out perfectly",
      "The AVR takes over speed control"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The rated speed minus 5%",
      "The speed the engine idles at before the generator is turned on",
      "The speed at which the reverse power relay trips",
      "The frequency/speed the generator naturally runs at when its ACB is open and it is supplying zero KW"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are synonymous terms describing the change in steady-state speed between no-load and full-load",
      "There is no relationship",
      "Speed droop causes tripping, speed regulation prevents it",
      "Speed droop is for AC, speed regulation is for DC"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The KVAR meters",
      "The voltage meters",
      "The KW meters of both parallel generators, making adjustments in very small increments to avoid wild load swings",
  ...
  },
  {
    ...
    "opts": [
      "Yes, to prevent the bus tie breaker from opening",
      "Yes, SOLAS requires 5% droop at all times",
      "No, but they require massive AVR droop instead",
      "No, because they are not interacting electrically; they could run in isochronous mode"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Both generators output zero KVAR",
      "The synchronizing lamps stay dark permanently",
      "The voltage fluctuates violently",
      "One generator takes a disproportionate amount of active (KW) load as total ship demand increases"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To maximize the total available capacity of the plant and prevent one machine from tripping on overcurrent while the other sits idle",
      "To keep the frequency exactly at 50Hz",
      "To prevent the ship from rolling",
      "To stop the preferential trip from working"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By using the manual governor raise/lower switches on the MSB to shift the speed setpoints until KW meters read equally",
      "By opening the bus tie breaker",
      "By turning the AVR trimmer",
      "By manually closing the throttle valves on the engine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The frequency drops to 45Hz",
      "Gen 1's Power Factor meter moves leading and its KVAR meter reverses (goes negative), showing it is absorbing reactive power",
      "Gen 2 ACB trips immediately",
      "Gen 1 KW meter drops to zero instantly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Its frequency doubles",
      "It shuts down safely",
      "Its AVR senses dropping bus voltage and heavily increases excitation, causing Gen 2 to become severely overloaded on reactive current",
      "It loses KW load and motors"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The Reverse Power Relay",
      "The Under-Frequency Relay",
      "The Under-Excitation Relay (Loss of Field Relay or Minimum Excitation Limiter)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Increase the governor speed on the faulty generator",
      "Turn off the ship's main engine",
      "Trip the healthy generator to save it",
      "Immediately trip the faulty generator's ACB manually from the switchboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the prime mover is still running and supplying Active Power (KW); only the Reactive Power (KVAR) has reversed",
      "Because the relay is too slow",
      "Because the voltage has collapsed",
  ...
  },
  {
    ...
    "opts": [
      "The power factor becomes 1.0",
      "The prime mover stalls",
      "The generator trips instantly on overcurrent",
      "The field receives pulsating half-wave DC; the generator voltage and current will hunt/oscillate rhythmically"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Gradually; the generator slowly loses ability to hold steady load sharing, with visibly swinging meters",
      "Catastrophically; an immediate explosion in the MSB",
      "Audibly; the generator emits a loud siren",
      "It shows no symptoms until blackout"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The reverse power relay trips after 5 seconds",
      "The generator continues normally but with low power factor",
      "It creates a massive circulating current in the exciter, dropping terminal voltage sharply and causing severe overheating",
      "The engine over-speeds instantly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Overcurrent Relay (OCR) on the main ACB, or under-voltage if the field collapses completely",
      "The Preferential Trip",
      "The Over-Frequency Relay",
      "The Reverse Power Relay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, the entire generator must be replaced",
      "No, it requires dry dock and removal of the rotor",
      "Yes, but the generator must be stopped, isolated, and locked out; you cannot repair them while the machine is running",
      "Yes, they can be hot-swapped while running"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Turn off the induction motors on the ship",
      "Increase the excitation of Gen 1 only",
      "Adjust the AVR droop setting of Gen 2 to shed its excess reactive load until both PFs equalize",
      "Adjust the Governor droop of Gen 1"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR is set too high",
      "Clogged ventilation air filters or blocked cooling ducts reducing airflow",
      "The reverse power relay is broken",
      "The governor droop is inverted"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A failed reverse power relay",
      "A shorted earth fault lamp",
      "The synchroscope being left ON",
      "A single-phase imbalance (one phase carrying much more current), not visible if meters only show average or a single phase"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Synchronising Lamps (e.g., Three Dark or Two Bright One Dark method)",
      "Plugging in a standard multimeter",
      "Using the Earth Fault indicator lamps",
      "Guessing by the sound of the engines"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "When one lamp is dark and two are bright",
      "When all three lamps are completely dark, indicating zero voltage difference between the incoming phases and the busbars"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "It indicates the direction of slip (FAST or SLOW) based on the rotational sequence of the brightening lamps",
      "It works even if the lamps burn out",
      "It prevents the generator from reverse motoring"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The reverse power relay trips gently",
      "The voltage merely drops for a few seconds",
      "The generator seamlessly synchronizes itself",
      "A catastrophic explosion, immense short-circuit forces, and possible twisting/breaking of the engine crankshaft"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Trip the running generator",
      "Adjust the governor speed of the incoming generator to bring the frequency very close to the bus frequency, slowing the needle down",
      "Close the breaker immediately and hope for the best",
      "Increase the AVR voltage massively"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because anti-clockwise damages the dial",
      "So it draws leading KVAR",
      "So the incoming generator is slightly faster, ensuring it immediately picks up a small active load (KW) and avoids reverse power tripping",
      "To prevent the voltage from spiking"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "It electrically blocks the ACB closing command unless the voltage, frequency, and phase angle are all within strict safe limits",
      "It measures the power factor",
      "It checks the lube oil pressure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Gen 2 slows down gracefully to 10Hz",
      "Gen 2 must suddenly supply the entire load; if it exceeds its capacity, the preferential trip activates or Gen 2 also trips, causing blackout",
      "Gen 2 automatically disconnects the crane",
      "Gen 2 reverse powers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It instantly executes Priority Load Shedding, dumping heavy non-essential consumers before the surviving generator's OCR can trip",
      "It connects shore power automatically",
      "It starts the emergency generator",
      "It injects extra fuel into the survivor"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The generator produces pure DC power",
      "Loss of excitation; the generator voltage collapses, and if in parallel, it motors and causes reactive overload on the other machine",
  ...
  },
  {
    ...
    "opts": [
      "It searches for the best radio frequency",
      "It causes continuous, rhythmic surging of fuel, making KW load swing violently back and forth between the two generators",
      "It smoothly balances the KVAR",
      "It trips the reverse power relay instantly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Isolate them and run them individually on steady load; the faulty one will show frequency/RPM fluctuations",
      "Measure the excitation voltage",
      "Feel which one is hotter",
      "Look at the KVAR meters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The under-voltage trip activates",
      "The generator acts as a massive motor, driving the dead diesel engine using power from the healthy generator, destroying the engine cylinders",
      "The ship speeds up",
      "The healthy generator simply takes over without issue"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Prime Mover Failure causes extreme high voltage",
      "Loss of Excitation shows massive negative KVAR and leading PF; Prime Mover Failure shows negative KW (Reverse Power)",
      "Loss of Excitation causes over-frequency",
      "They look identical on all meters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It causes the battery to drain",
      "It reverses the phase sequence",
      "The unbalanced ripple current induces severe heating in the rotor and stator, leading to insulation failure and winding burnout",
      "It magnetizes the ship's hull"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The frequencies are perfectly matched, but they are locked out of phase. The governor speed must be bumped slightly to make the needle rotate",
      "The voltage is too high",
      "The phase sequence is backwards"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It disconnects the synchroscope",
      "It disables droop, causing the generators to violently fight each other for load until one trips on overcurrent or reverse power",
      "It locks the ACB closed permanently",
      "It turns off the AVRs"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It forces the generator to supply high reactive current, which causes excessive I²R heating losses in cables and reduces the useful KW capacity of the generator",
      "It causes the fuel to freeze",
      "It causes the voltage to spike to 1000V",
      "It increases the speed of the induction motors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A transformer that converts leading to lagging power",
      "A massive capacitor bank used to store DC voltage",
      "A steam condenser cooled by synchronous fans",
      "An overexcited synchronous motor running freely with no mechanical load, used to generate leading KVAR and improve system power factor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It can start automatically without electricity",
      "It provides smooth, continuously variable KVAR correction by adjusting the field current, whereas capacitors are fixed blocks",
      "It is much cheaper and requires no maintenance",
      "It consumes absolutely zero real power (KW)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes, by under-exciting the field, it absorbs leading KVAR, which is useful for correcting highly capacitive loads like long empty HV cables",
      "No, it can only generate leading KVAR",
      "No, it explodes if under-excited",
      "Yes, but only if the mechanical shaft is stopped"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A battery bank used for emergency DC lighting",
      "A device that converts active power to reactive power",
      "A static charge eliminator for the hull",
      "A set of fixed industrial capacitors connected in parallel with inductive loads to provide leading reactive power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They provide fixed steps of correction; over-correcting can cause leading power factor and dangerous voltage spikes",
      "They only work on DC systems",
      "They draw immense amounts of active power (KW)",
      "They have rotating parts that wear out quickly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A lightly loaded motor has a terrible power factor (e.g., 0.3) because the constant magnetizing current dominates; heavily loaded motors have better PF (e.g., 0.85)",
      "Heavily loaded motors draw entirely reactive current",
      "A lightly loaded motor has a perfect PF of 1.0",
      "Loading has no effect on power factor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Turning off all lighting on the ship",
      "Increasing the frequency of the generators",
      "Avoiding running large motors (like cargo pumps) lightly loaded, and ensuring appropriately sized motors are used for tasks",
      "Running all standby pumps simultaneously"
    ],
  ...
  },
  {
    ...
    "opts": [
      "VFDs only run on leading power factor",
      "VFDs destroy the power factor, causing it to drop to 0.1",
      "VFDs convert all KVAR into KW",
      "VFDs with active front-end rectifiers draw near-unity (1.0) power factor from the supply grid, effectively eliminating the motor's lagging KVAR from the main bus"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes, increasing AVR voltage pushes the PF to 1.0",
      "No, adjusting the AVR only changes how reactive power is shared between generators; the total KVAR demanded by the ship's motors remains exactly the same",
      "No, the AVR only controls Active Power (KW)",
      "Yes, decreasing excitation destroys reactive power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It dissipates into the ship's hull via the grounding wire",
      "It is not consumed; it oscillates back and forth between the generator and the load every half cycle to sustain magnetic fields",
      "It is converted directly into shaft torque",
      "It is burned off as heat in the motor bearings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the shore cables will freeze",
      "Because shore power cannot generate KVAR",
      "Because low PF causes the meter to spin backward",
      "Shore utility companies charge industrial users penalties for poor power factor because they must supply and transport the wasteful KVAR current"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A software program in the VFD",
      "A type of capacitor bank",
      "A device mounted on the shaft of a slip-ring induction motor that injects EMF into the rotor to improve its power factor",
      "A massive transformer for shore power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because capacitors consume massive KW when idle",
      "To prevent the capacitors from exploding",
      "To stop the batteries from draining",
      "To prevent an over-compensated (leading) power factor, which can cause severe over-voltage and destabilize the generators"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It commands the AVR to increase voltage",
      "It uses a microprocessor to monitor the main bus PF and automatically switches individual capacitor contactors in or out to maintain a set target PF (e.g., 0.95)",
      "It manually turns off induction motors",
      "It starts the synchronous condenser motor"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The current remains exactly the same",
  ...
  },
  {
    ...
    "opts": [
      "It increases by 20%",
      "It drops by 20%",
      "It remains roughly the same (excluding minor I²R loss reductions)",
      "It drops to zero"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because they can be run overexcited to provide leading KVAR to the grid, improving the overall ship power factor, and they are highly efficient",
      "Because they do not require an electrical supply",
      "Because they are much cheaper to buy",
      "Because they start instantly without drawing high current"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The rotor is made of wood",
      "The DC excitation kills the AC field",
      "The stator magnetic field rotates at high speed instantly; the heavy rotor cannot catch up to lock in due to inertia, resulting in zero net average torque",
      "It requires a massive capacitor to fire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By applying 10,000 Volts",
      "By using amortisseur (damper) squirrel-cage windings on the rotor so it starts as an induction motor, then applying DC field near synchronous speed",
      "By manually turning the shaft",
      "By reversing the phases rapidly"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "It immediately generates 440V back into the grid",
      "It runs normally but at half speed",
      "It loses synchronism and falls out of step, causing massive current surges and violent mechanical vibrations until it trips"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To automatically disconnect non-essential loads in stages when the generator is overloaded, preventing a total blackout",
      "To automatically start the emergency generator",
      "To prioritize the cooling water pumps during startup",
      "To disconnect the shore power cable safely"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Essential safety and navigation loads (e.g., Steering gear, GMDSS, Fire pump, Nav lights)",
  ...
  },
  {
    ...
    "opts": [
      "A heavy flywheel",
      "A bimetallic strip",
      "A dashpot (an oil-filled cylinder with a piston and restricted needle valve)",
      "A quartz oscillator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The preferential trip will activate instantly",
      "All motors will run faster and explode",
      "All induction motors will run 16.6% slower, reducing pump/fan output, and transformers may overheat due to increased core flux",
      "The ship's voltage will double to 880V"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The V/f ratio increases, causing the iron core to saturate with magnetic flux, resulting in massive heat from iron losses and huge magnetizing currents",
      "The insulation breaks down chemically at 50Hz",
      "50Hz electricity has more friction",
      "The copper wire shrinks in 50Hz"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Recover within 10 seconds of blackout",
      "Maintain voltage within ±10% and never drop",
      "Maintain frequency within ±5%",
      "Maintain voltage within ±2.5% steady state, and recover to ±2.5% within 1.5 seconds of a sudden full-load change"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The high DC test voltage will permanently destroy the delicate thyristors, diodes, and capacitors inside the AVR electronics",
      "The megger will explode",
      "It will cause the alternator to start spinning",
      "The AVR will absorb the voltage and give a false 0 Ohm reading"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Reactive current always flows backward",
      "Voltage drops proportionally to current",
      "Current chooses the path of least resistance exclusively",
      "The sum of all currents entering a node (junction) must equal the sum of all currents leaving that node (ΣI_in = ΣI_out)"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The algebraic sum of all voltages (sources and drops) around any closed loop in a circuit must equal zero (ΣV = 0)",
      "Voltage increases with temperature",
      "The voltage at the end of a cable is zero"
    ],
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Reactive power maintains voltage levels. Too little kVAR → motors and transformers cannot sustain electromagnetic fields → terminal voltage falls → more current drawn → further voltage drop → cascade voltage collapse and blackout. Conversely, too much reactive power causes excessive I²R heating and over-voltage risk."
  },
  {
    "id": "T11P_224",
    "cat": "REACTIVE_POWER",
  ...
  },
  {
    "id": "T11P_225",
    "cat": "REACTIVE_POWER",
    "q": "What is the definition of Power Factor?",
    "opts": [
      "The ratio of reactive power (kVAR) to apparent power (kVA)",
      "The cosine of the angle between voltage and current; equivalently the ratio of real power (kW) to apparent power (kVA)",
      "The ratio of real power to reactive power in an AC circuit",
      "The phase difference in degrees between the current and voltage waveforms"
    ],
    "a": 1,
    "exp": "Power Factor = cos φ = Active Power (kW) / Apparent Power (kVA). Active power does real work (heat, mechanical output). Reactive power (kVAR) sustains magnetic fields. Apparent power (kVA) is the vector combination of both. A PF of 1.0 means all current does useful work; PF 0.8 means 80% of apparent current is doing useful work."
  },
  {
    "id": "T11P_226",
    "cat": "SYNCHRONOUS_CONDENSER",
  ...
  {
    "id": "T11P_227",
    "cat": "SYNCHRONOUS_MOTOR",
    "q": "What are the key differences between a synchronous motor and an induction motor?",
    "opts": [
      "Synchronous: self-starting, lagging PF only, no DC excitation. Induction: constant speed, unity PF, requires DC field",
      "Synchronous: constant speed (frequency-dependent), wide PF range, not self-starting, requires DC excitation. Induction: speed varies with load, lagging PF only, self-starting, no DC excitation",
      "Synchronous: variable speed with load, leading PF, self-starting. Induction: constant speed, lagging PF, requires DC excitation",
  ...
  },
  {
    "id": "T11P_228",
    "cat": "REACTIVE_POWER",
    "q": "What is the benefit of improving power factor closer to unity for the same real power (kW) load?",
    "opts": [
      "Generator frequency increases, improving motor efficiency",
      "Less current flows for the same kW delivered → lower I²R losses, less cable heating, better voltage regulation, generator operates within kVA limit more efficiently",
      "Reactive power increases, providing more voltage support to the network",
