window.loadQuizzes("T17_MARPOL", [
  ...
  },
  {
    ...
    "opts": [
      "Infrared absorption (optical) sensor",
      "Electrochemical cell sensor",
      "Catalytic pellistor sensor",
  ...
  },
  {
    ...
    "opts": [
      "More than 3 nautical miles, vessel at anchor acceptable",
      "More than 12 nautical miles from nearest land, vessel en route (proceeding underway)",
      "More than 50 nautical miles (same as tankers)",
      "Any distance if 15 ppm alarm is active"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Locks in last known position",
      "Opens fully to overboard discharge port by gravity",
      "Vents to engine room bilges to prevent OCM damage",
      "Defaults to recirculate - diverts all effluent back to bilge holding tank"
    ],
  ...
  },
  {
    ...
    "opts": [
      "1/10,000 of the cargo",
      "1/30,000 of the total quantity of the particular cargo",
      "1/100,000 of the ship DWT",
      "Zero - all cargo residues to shore reception only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "More than 12 nm (same as machinery space OWS)",
      "More than 50 nautical miles from nearest land",
      "More than 200 nm",
      "More than 3 nm"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "All ships ≥400 GT and all oil tankers ≥150 GT",
      "Only vessels >5,000 GT on international voyages",
      "Only vessels fitted with OWS"
    ],
  ...
  },
  {
    ...
    "opts": [
      "3.50% m/m (the old pre-2020 limit)",
      "0.50% m/m (the 'IMO 2020' global cap)",
      "0.10% m/m (ECA limit)",
      "1.00% m/m"
    ],
  ...
  },
  {
    ...
    "opts": [
      "High-temperature catalyst converts sulphur to harmless CO2",
      "Inject urea to reduce sulphur into pure nitrogen (that is for NOx)",
      "Centrifuge fuel before combustion to extract elemental sulphur",
      "Wash exhaust with seawater or alkaline solution neutralising SO2 before emission"
    ],
  ...
  },
  {
    ...
    "opts": [
      "~15% reduction (achievable via engine tuning)",
      "~50% reduction",
      "~80% reduction (requires SCR or dual-fuel engine)",
      "100% reduction (zero emission)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Exhaust Gas Cleaning System (EGCS/scrubber) - that is for SOx",
      "Diesel Particulate Filter (DPF)",
      "Oily Water Separator (OWS)",
      "Selective Catalytic Reduction (SCR) - injects urea into exhaust, catalyst converts NOx to N2 and water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "C rating for 3 years or D for 1 year",
      "D rating for 3 consecutive years OR E rating for 1 year",
      "Any rating below A requires immediate corrective action",
      "E rating for 3 consecutive years only"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Garbage Collection and Management Plan (GCMP)",
  ...
  },
  {
    ...
    "opts": [
      "Only signature guaranteeing fuel is not explosive at room temperature",
      "Exact flashpoint value to 3 decimal places regardless",
      "Statement confirming fuel cooled to 60°C before transfer",
      "Actual measured flashpoint if below 70°C OR confirmation it was measured at or above 70°C"
    ],
  ...
  },
  {
    ...
    "opts": [
      "60°C (minimum to prevent fire risk from vapour in enclosed engine spaces)",
      "70°C",
      "43°C",
      "100°C"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Complete laboratory analysis of fuel ash content",
      "Statement that fuel heated above 70°C to remove volatiles",
      "Guarantee Viscotherm calibrated for specific fuel density",
      "Supplier must provide signed declaration confirming fuel flashpoint ≥60°C before transfer begins"
    ],
  ...
  },
  {
    ...
    "opts": [
      "IMO DCS (Ship Fuel Oil Consumption Database)",
      "Global Integrated Shipping Information System (GISIS)",
      "Ship's internal ORB Part III",
      "Local PSC regional headquarters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Infrared absorption or light scattering (nephelometry) optical sensors",
      "Electrochemical conductivity probes",
      "Ultrasonic density transducers",
      "Centrifugal mass separation sensors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It defaults to the CLOSED (recirculation to bilge holding tank) position on loss of power or loss of air",
      "It defaults to the OPEN (overboard discharge) position to prevent internal flooding",
      "It locks in its last known position indefinitely",
      "It opens to the sludge tank to dump all contents"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The vessel must be outside of port limits",
      "The vessel must be more than 50 nautical miles from land",
      "The vessel must be more than 3 nautical miles from land",
      "The vessel must be more than 12 nautical miles from the nearest land and proceeding en route"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The sensor will overheat and burn out the IR lamp",
      "The sensor will become blind and give a false LOW reading, risking illegal discharge",
      "An oily film will coat the glass, blocking the light beam and causing a false HIGH reading, which permanently trips the valve to the bilge holding tank",
      "The glass will shatter under the water pressure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Chemical Separation; adding chlorine to dissolve the oil",
      "Magnetic Separation; using electromagnets to pull the oil out",
      "Gravity Separation; oily water enters a large chamber where the flow slows down, allowing lighter free oil to float to the top for collection",
      "Thermal Separation; boiling the water to leave the oil behind"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To force microscopic, emulsified oil droplets to merge (coalesce) into larger drops on a physical mesh until they are buoyant enough to float away from the water",
      "To chemically neutralize the oil into a solid powder",
      "To filter out large solid debris like rags and rust",
      "To add fresh water to dilute the oil below 15 ppm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By measuring the resistance of the solenoid coil",
      "By activating the OCM self-test or injecting a test emulsion, and visually/acoustically verifying the valve actuator moves and the flow shifts to the bilge return pipe",
      "By looking at the green LED on the main switchboard",
      "By tasting the water coming out of the overboard discharge"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It can be discharged overboard at night when outside 50 nm",
      "All bilge water must be retained onboard in the designated bilge holding tanks, and subsequently discharged to a certified port reception facility ashore",
      "It can be bypassed through the emergency fire pump if logged",
      "It must be mixed with heavy fuel oil and burned in the main engine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Baltic Sea, Black Sea, Mediterranean Sea, Red Sea, Gulfs Area, Gulf of Aden, Antarctic Area, North West European Waters, and Oman area",
      "The Pacific Ocean and the Indian Ocean",
      "Only the polar regions (Arctic and Antarctic)",
      "Any waters within 200 nm of the United States"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Standard Operating Procedure for Engine Protection",
      "Shipboard Oil Pollution Emergency Plan; a mandatory document detailing the exact procedures, contacts, and equipment to be used in the event of an oil spill",
      "System of Oil Purification and Emulsion Processing",
      "Safe Oil Pumping and Environmental Protocol"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only passenger ships and chemical tankers",
      "All ships, regardless of size or type",
      "Only oil tankers over 10,000 GT",
  ...
  },
  {
    ...
    "opts": [
      "SOPEP is an IMO code; SMPEP is an ILO code",
      "SOPEP is for the engine room; SMPEP is for the deck",
      "There is no difference; they are interchangeable terms",
      "SOPEP covers only Oil spills; SMPEP (Shipboard Marine Pollution Emergency Plan) covers both Oil AND Noxious Liquid Substances (chemicals) and is required on chemical tankers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "High-expansion foam generators and CO2 cylinders",
      "Welding equipment and steel patching plates",
      "Oil absorbent pads/booms, sawdust/granules, non-sparking scoops, heavy-duty disposal bags, protective suits, gloves, and a portable wilden/pneumatic pump",
      "Spare parts for the main engine and purifiers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It connects the main seawater cooling pump to the bilge; it is ONLY permitted to be opened during life-threatening emergency flooding to save the ship, completely bypassing the OWS",
      "It is an automated valve that drains the sludge tank",
      "It is a valve used to routinely clean the bilges into the OWS",
      "It is a sampling valve used by Port State Control"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Isolate the OCM, open the glass cell, and clean the optical windows with an approved solvent and a soft lint-free cloth to remove invisible oil films",
      "Recalibrate the zero point instantly",
      "Bypass the alarm in the software to allow pumping",
      "Replace the 3-way solenoid valve"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be installed on the vertical section of the final discharge pipe, as close to the OWS outlet as possible, to ensure a representative, fully mixed sample",
      "It must be installed after the 3-way divert valve",
      "It must be installed in the primary gravity separation chamber",
      "It must be installed at the very bottom of the holding tank"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The piping must be connected to the sewage treatment plant",
      "The piping must be made of clear plastic so the water can be seen",
      "The piping must discharge above the ship's waterline",
      "The overboard discharge piping must not have any unauthorized bypasses or hidden connections that would allow oily water to be pumped directly overboard without passing through the OWS and OCM"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is factory-sealed and never requires calibration",
      "Every time the bilge pump is started",
      "According to the manufacturer's instructions, but strictly no less than every 5 years (many require annual calibration by a certified shore technician)",
      "Every 5 years during drydock only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A 15 ppm test fluid is injected to check the alarm",
      "Pure, oil-free distilled water is flushed through the clean sensing cell, and the electronics are adjusted so the display reads exactly 0 ppm",
      "The sensor is removed and left in the open air to read 0 ppm",
      "The 3-way valve is forced into the closed position"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A certified reference solution containing exactly 15 ppm (or another known concentration) of oil is injected, and the span/gain is adjusted until the meter matches the certified value",
      "The pump is run at maximum capacity to check flow limits",
      "The internal memory of the OCM is wiped clean",
      "The sensor is bypassed using a digital simulator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Clean water mixed with minor oil drips; it is pumped through the OWS",
      "Thick, highly concentrated oil waste from fuel purifiers and tank settling; it CANNOT be pumped through the OWS and must be retained for shore disposal or burned in an approved onboard incinerator",
      "Solid metallic waste from engine wear; disposed of as garbage",
      "Chemicals used for cleaning; dumped directly overboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Soaps interfere with the 24V power supply to the sensors",
      "Soaps chemically bond oil to water, creating microscopic emulsions that the gravity and coalescing filters cannot physically separate, resulting in continuous 15 ppm alarms",
      "Soaps dissolve the plastic piping of the OWS",
      "Soaps cause the water to freeze inside the separator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To dilute the bilge water to exactly 14 ppm before discharging",
      "To test the capacity of the ship's fresh water generator",
      "To cool the infrared lamp to prevent it from burning out",
      "To flush clean water through the optical sensing cell periodically or upon shutdown, washing away oil residues and preventing permanent fouling of the glass windows"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes, provided the vessel is more than 50 nm from land",
      "NO. It is strictly prohibited. Bypassing the OCM to force the 3-way valve open is a deliberate MARPOL violation and a criminal offense",
      "Yes, if the vessel is in a severe storm and needs to empty bilges",
      "Yes, but only if the Chief Engineer authorizes it in writing"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Opening the separator tank and manually scooping out the sludge",
      "Replacing the main bilge pump impellers",
      "Routine testing of the 15 ppm alarm and 3-way divert valve, cleaning the OCM optical cell, assisting with annual sensor calibration, and ensuring the control panel wiring is intact and unmodified",
      "Signing the Oil Record Book for all daily discharges"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It means the OWS is only rated for passenger ships",
      "It means the OWS requires no electrical power to operate",
      "It allows the OWS to discharge at 30 ppm in special areas",
      "It means the OWS and OCM have passed rigorous modern testing standards, specifically proving they can successfully separate and detect heavy fuel oil and complex chemical emulsions, not just pure diesel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They must print a paper ticket every 5 minutes",
      "They take a digital photograph of the operator",
      "They transmit real-time data to the IMO headquarters via satellite",
      "They must have an internal, unalterable digital memory (data logger) that records the date, time, and alarm status of the OCM for at least 18 months, which can be reviewed by PSC"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The system will simply work 5 times faster",
      "The water will be purified to 0 ppm due to high pressure",
      "The 3-way valve will automatically reduce the pump speed",
      "The OWS will be completely overwhelmed; the fast flow will destroy the gravity separation process, emulsify the oil, and guarantee a continuous 15 ppm alarm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They measure the temperature of the water to engage the heater",
      "They detect the thickening layer of separated oil floating at the top of the tank and trigger a solenoid valve to drain this pure oil into the sludge tank",
      "They measure the 15 ppm limit before the water exits",
      "They sense if the tank is completely empty to stop the pump"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is used to record the bunkering of fresh water",
      "It is a duplicate copy of Part I kept on the bridge",
      "It records the disposal of garbage and plastics",
      "It is exclusively for Oil Tankers to record Cargo and Ballast operations (e.g., loading/unloading cargo oil, tank washing, ODME discharges)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Officer or Officers in charge of the specific operation (e.g., the Duty Engineer who ran the OWS)",
      "Only the Master of the ship",
  ...
  },
  {
    ...
    "opts": [
      "It must be mailed to the flag state immediately upon completion",
      "It must be retained onboard for a period of 3 years and be readily available for inspection at all reasonable times",
      "5 years",
      "1 year"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Washing the deck with seawater",
      "Changing the main engine fuel injectors",
      "Bunkering fuel/lube oil, discharging bilge water via OWS, transferring bilge/sludge between tanks, and incinerating sludge",
      "Discharging treated sewage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A new ORB must be started",
      "The ORB should be hidden until the OWS is fixed",
      "The exact time and nature of the failure must be formally recorded in the ORB as an exceptional event",
      "The failure is recorded only in the electrical maintenance log"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The ship's exact Latitude and Longitude at the start of the discharge, and the exact Latitude and Longitude at the stop of the discharge",
      "The distance to the nearest port",
      "The name of the officer on the bridge"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Tear the page out and start again",
      "Use correction fluid (white-out) to hide the mistake",
      "Scribble over the mistake until it is completely unreadable",
      "A single line should be struck through the error so it remains readable, and the correction written clearly next to it, accompanied by the officer's signature/initials"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is a minor non-conformity requiring a warning letter",
      "The flag state simply rewrites the book for the ship",
      "It results in a small fine deducted from the ship's budget",
      "It is a severe criminal offense leading to vessel detention, multi-million dollar fines for the company, and potential prison sentences for the Chief Engineer and Master"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be written strictly in Latin",
      "It must be written only in the language of the Flag State",
      "It can be written in any language as long as photos are provided",
      "It must be written in the working language of the crew, and for ships with an IOPP certificate, it must also include English, French, or Spanish"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, only physical paper books are legally binding",
      "Yes, provided the electronic system is formally approved by the Flag State Administration and meets strict security, unalterability, and backup standards",
      "Yes, any standard Excel spreadsheet can be used",
      "No, because electronic records cannot be signed by the Master"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The name of the truck driver delivering the fuel",
      "The electrical load of the ship during bunkering",
      "The exact temperature of the fuel during the entire voyage",
      "The date, port of bunkering, type of fuel, and the exact quantity of fuel bunkered (in tonnes or cubic meters)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, accidents are logged only in the deck logbook",
      "No, the ORB is strictly for routine operations",
      "Yes, under the 'Accidental or other exceptional discharges of oil' section, detailing the time, position, approximate quantity, and reasons for the discharge",
      "Yes, but the entry can be delayed until the ship reaches port"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The IOPP certificate dictates who signs the ORB",
      "The IOPP Certificate contains a 'Supplement' detailing the exact capacities of the ship's sludge and bilge tanks; the ORB entries must mathematically align with these certified tank capacities",
      "The ORB is used to apply for the IOPP certificate every voyage",
  ...
  },
  {
    ...
    "opts": [
      "By carrying the ORB during fire drills",
      "By signing the Master's signature if the Master is busy",
      "By rewriting the ORB neatly at the end of the month",
      "By ensuring the digital data loggers on the OCM and incinerator are perfectly calibrated, synchronized with ship's time, and providing accurate data that matches the manual ORB entries"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The date, port name, quantity transferred, identity of the receiving truck/barge, and a receipt from the receiver must be kept onboard",
      "Only the date and the amount paid to the truck driver",
      "The ship's coordinates and the weather conditions",
      "The remaining balance of the ship's budget"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To calibrate the ship's electronic level sensors",
      "To ensure the tank does not overflow and crush the hull",
      "To provide a continuous baseline of how much waste oil is generated and stored onboard, proving it is not being secretly dumped at sea between ports",
      "To calculate the ship's fuel efficiency"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, routine testing of alarms without pumping actual bilge water overboard is typically logged in the PMS or Engine Room Log, not the ORB, which strictly tracks fluid movement",
      "Yes, every push of a button on the OWS must be in the ORB",
      "Yes, but only if the test fails",
      "No, testing is completely undocumented"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Binary codes (01, 10)",
      "Numeric codes based on the volume discharged",
      "Alphabetical codes (e.g., A, B, C, D) corresponding to specific operations like bunkering, discharging bilges, or transferring sludge, ensuring standardized international formatting",
      "Color codes based on the type of oil"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The tank the sludge was taken from, the exact quantity burned, and the duration of the incineration operation (start and stop times)",
      "The name of the manufacturer of the incinerator",
      "The temperature of the incinerator flames",
  ...
  },
  {
    ...
    "opts": [
      "The Master bears zero responsibility for the engine room",
      "The Master must personally measure the tanks before signing",
      "The Master verifies that the book is being properly maintained according to regulations, though they rely on the Chief Engineer's signature for the strict technical accuracy of the volumes",
      "The Master only signs pages related to bunkering"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No entries are allowed while in a Special Area",
      "A different colored pen must be used",
      "The ORB is handed over to the local coast guard",
      "The format remains the same, but the entries will reflect that no overboard discharges occurred (or strict limits were met), proving compliance with the zero-discharge rules of the area"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Entries can be compiled at the end of every month",
      "Entries must be written before the operation begins",
      "Entries must be recorded promptly after the completion of the operation; delaying entries leads to inaccuracies and is heavily penalized by PSC",
      "Entries are only required before arriving in a US port"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only the flag state can touch the book",
      "Yes, but only if the Captain gives written permission",
      "Yes, competent authorities can request a copy of any entry, and in the event of an investigation, they have the legal authority to seize the physical book as evidence",
      "No, it is the private property of the shipping company"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "In the Deck Logbook only",
      "In the ORB Part II",
      "In the Oil Record Book Part I, as it relates to machinery space / fuel tank operations"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The crew's medical certificates",
      "The daily menus from the galley",
      "Bunker Delivery Notes (BDNs) and receipts from shore-based reception facilities for sludge or oily water disposal",
      "The ship's original blueprints"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It keeps an unalterable digital record of exactly when the OCM was running and when it alarmed; if this digital record doesn't perfectly match the manual ORB entries, the crew is caught lying",
      "It locks the ship's steering until the ORB is signed",
      "It automatically prints the ORB pages every day",
      "It sends an electric shock to the pump if bypassed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only during the class society survey",
      "Only when the tank reaches 100% capacity",
      "Typically recorded once a week, documenting the manual sounding (volume) of the sludge holding tanks to track accumulation",
      "Every hour during a sea voyage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes, the ETO can sign for the Chief Engineer if authorized",
      "No, it is illegal; only the officer actually in charge of the physical operation may sign the entry, taking personal legal responsibility for it",
      "Yes, if the Master countersigns it immediately",
      "Yes, as long as the operation was electrical in nature"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Overboard Discharge Measurement Engine; for passenger ships",
      "Oil Discharge Monitoring Equipment; mandated for all oil tankers (crude and product) above 150 GT",
      "Oceanic Data Monitoring Electronics; for research vessels",
      "Oily Deck Mitigation Equipment; for bulk carriers"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "30 litres of oil per nautical mile",
  ...
  },
  {
    ...
    "opts": [
      "1000 Litres total",
      "1% of the ship's total displacement",
      "Zero; no oil is ever allowed to be discharged",
  ...
  },
  {
    ...
    "opts": [
      "The tanker must be proceeding en route (moving through the water)",
      "The tanker must be anchored securely",
      "The tanker must be reversing",
      "The tanker must be drifting with engines stopped"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Oil Content (from the optical sensor), Flow Rate (from the discharge pipe flow meter), and Ship Speed (from the GPS/Log)",
      "Tank Temperature, Engine RPM, and Wind Speed",
      "Salinity, Viscosity, and Draft",
      "Pump Pressure, Valve Position, and Time"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It automatically slows down the ship's main engine",
      "It adds fresh water to dilute the mixture",
      "It prints a warning but continues discharging",
      "It triggers a high-level alarm and instantly closes the overboard discharge valve, stopping the flow to the sea"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The tanker is strictly prohibited from discharging any cargo ballast or tank washings at sea; all dirty water must be retained onboard for disposal at a port reception facility",
      "The tanker must sail backwards to reverse the flow",
      "The crew can manually estimate the oil content and continue pumping",
      "The tanker can discharge at 15 ppm using the engine room OWS instead"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The tank where the crew disposes of garbage",
      "A dedicated tank where dirty tank washings and oily ballast water are collected to allow the oil and water to separate by gravity before decanting the water via the ODME",
      "The main fuel oil bunker tank",
      "The tank that holds clean drinking water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A mechanical centrifuge",
      "A thermal distillation unit",
      "An optical sensor utilizing light scattering (nephelometry) or infrared absorption principles, similar to but often more complex than an engine room OCM",
      "A chemical titration probe"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To add chemicals that dissolve the oil",
      "To heat the water to boiling point",
      "To violently separate the oil from the water before measurement",
      "To aggressively churn and mix the sample so that any large oil droplets are broken down into a uniform, microscopic emulsion, ensuring the optical sensor reads the true total oil content"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Signing the Oil Record Book Part II",
      "Washing the cargo tanks with high-pressure hoses",
      "Emptying the slop tanks manually",
      "Ensuring the sample lines are clear, cleaning the optical sensor windows, verifying the GPS/Speed log signal inputs, and assisting shore techs with the mandatory annual calibration"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It has an integrated, tamper-proof printer or digital data logger that continuously prints/records the date, time, speed, oil ppm, flow rate, and valve status during the entire discharge operation",
      "It uses blockchain technology to verify the water",
      "It requires the Captain to type in a password every 5 minutes",
      "It sends an email directly to the IMO"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The system defaults to an assumed speed of 10 knots",
      "The system loses the speed input, cannot calculate Litres/nm, and immediately initiates a fail-safe shutdown of the overboard valve",
      "The pump speeds up to compensate",
      "The system switches to measuring 15 ppm limit only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, the ODME is strictly for cargo tank washings and oily ballast from the slop tanks (Annex I, Part II); machinery bilges MUST go through the 15 ppm OWS (Annex I, Part I)",
      "Yes, if the OWS is broken",
      "Yes, it is just a bigger version of the OWS",
      "Yes, but only when the ship is in port"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A process to clean the ship's anchor chain",
      "A setting that bypasses the flow meter",
      "Before and after use, clean water is flushed through the sampling lines and optical sensor to clear residual oil, preventing fouling of the glass and ensuring accurate zero-calibration",
      "A cycle that dumps the entire slop tank overboard in an emergency"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water pumped exclusively from the engine room",
      "Water inside a tank that is clean enough that, if discharged on a calm day, it would not produce visible traces of oil on the water surface (statistically usually < 15 ppm)",
      "Water that is safe to drink",
      "Water that has been boiled and distilled"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No, clean ballast can be dumped directly anytime",
      "No, the ODME is turned off to save power",
      "Only if the ship is within 12 nm of land",
      "Yes, MARPOL requires the ODME to be in operation and recording even for clean ballast discharges to provide proof of compliance, though some exemptions exist for strictly segregated ballast tanks (SBT)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water is pumped from the bottom of the slop tank. Initially clean, ppm is low. As the pump nears the oil layer, ppm rises. When ppm x flow / speed hits 30 L/nm, the ODME slams the overboard valve shut, stopping the pump or diverting to recirculation",
      "The oil is pumped out first, followed by the water",
      "The tank is boiled, and the vapor is measured",
      "Chemicals are added until the mixture turns clear"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "100 Litres total",
      "ZERO discharge. Discharge of cargo oil or oily mixtures from tankers is completely prohibited in Special Areas; the ODME overboard valve must remain locked closed",
      "Discharge is allowed if the ship is moving fast"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They will pump oil overboard to see if it stops",
      "They will weigh the slop tank",
      "They will demand to see the printed data tapes, check the ORB Part II, and may ask the ETO to perform a functional test using the system's built-in electrical simulation or test fluid to verify the overboard valve closes on alarm",
  ...
  },
  {
    ...
    "opts": [
      ...
      "To cool the oil before it reaches the sensor",
      "To detect solid metal debris",
      "To measure the exact volume of water being pumped overboard in cubic meters per hour, allowing the computer to calculate total oil quantity and the instantaneous discharge rate"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To calculate the flash point of the water",
      "To alert the port authority of the cargo's toxicity",
      "To determine the financial value of the waste",
      "Because different crude oils and refined products have vastly different optical properties (color, density); the system uses specific calibration curves for different cargo types to accurately measure the ppm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Repainting the sensor housing",
      "Replacing the entire optical unit",
      "Upgrading the ship's GPS system",
      "Using manufacturer-supplied calibration fluids (formazine or specific oil mixtures) to adjust the zero and span of the optical sensor, and verifying the flow meter and speed inputs"
    ],
  ...
  },
  {
    ...
    "opts": [
      "1/30,000 of the total quantity of the particular cargo of which the residue formed a part (Older ships pre-1979 were allowed 1/15,000)",
      "1000 cubic meters",
      "1/100 of the cargo",
      "There is no limit if the ship is fast enough"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An OWS handles 1000 tons per hour, ODME handles 1 ton per hour",
      "They are exactly the same physical machine",
      "An OWS physically separates and filters the oil out of the water. An ODME is just a massive monitoring and valve system; it doesn't filter the water, it just relies on gravity separation inside the giant slop tanks",
      "An ODME is small enough to hold in one hand"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To ensure that if the ODME fails or alarms, it can automatically shut down the massive cargo pump or slam the divert valve shut instantly to prevent thousands of gallons of oil from blasting into the ocean",
      "To ensure the pump runs faster when the water is clean",
      "To prevent the pump from drawing a vacuum",
      "To keep the cargo pump warm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "After decanting the clean water from the slop tank via the ODME, the new cargo of crude oil is loaded directly 'on top' of the remaining oily sludge, integrating the waste into the new cargo",
      "Pumping fresh water on top of the oil to sink it",
      "Loading heavy cargo on the top deck",
      "Loading garbage on top of the fuel tanks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It opens the valve wider to compensate",
      "It bypasses the speed requirement",
      "It closes the overboard valve, because discharging 30 Litres per nautical mile is mathematically impossible if the ship is not moving (zero nautical miles covered)",
      "It sounds the general alarm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Safe Engine Environmental Maintenance Protocol; Annex I",
      "Ship Energy Efficiency Management Plan; mandated under MARPOL Annex VI",
      "System for Electrical Emissions and Monitoring Performance; Annex V",
      "Standard Energy and Exhaust Management Plan; Annex IV"
    ],
  ...
  },
  {
    ...
    "opts": [
      "EEDI is a TECHNICAL design standard for new ships (how the ship is built), whereas SEEMP is an OPERATIONAL management plan for all ships (how the ship is sailed)",
      "EEDI regulates oil spills; SEEMP regulates air pollution",
      "EEDI applies to cargo; SEEMP applies to passengers",
  ...
  },
  {
    ...
    "opts": [
      "An annual operational rating system (A through E) that measures how efficiently a ship transports goods, calculated in grams of CO2 emitted per deadweight-nautical mile",
      "A tax applied by European ports on high-sulfur fuel",
      "A meter on the funnel that measures black smoke",
      "A chemical added to fuel to reduce carbon buildup"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only newly built ships after 2023",
      "All ships of 400 GT and above",
      "Only passenger ships",
      "All ships of 5,000 GT and above"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The ship is banned from entering any port",
      "The ship must develop an approved Corrective Action Plan (part of SEEMP Part III) detailing exactly how it will improve its rating to a 'C' or better"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By disabling the radar systems to save power",
      "By manually injecting oxygen into the exhaust stack",
      "By dumping heavy cargo overboard",
      "By retrofitting LED lighting, installing VFDs on large cooling pumps, optimizing power management to avoid running unnecessary generators, and maintaining Shore Power equipment"
    ],
  ...
  },
  {
    ...
    "opts": [
      "VFDs increase the water's heat capacity",
      "VFDs bypass the main switchboard entirely",
      "According to the Affinity Laws, power consumption is proportional to the cube of the speed; dropping the pump speed by just 20% cuts electrical power consumption by nearly 50%",
      "VFDs generate their own electricity from the water flow"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An annual operational rating like CII",
      "A tax on existing fuel tanks",
      "A measure of crew efficiency",
      "A one-time technical measure applied to existing ships (built before EEDI) to ensure they meet a baseline design efficiency standard, often achieved by limiting maximum engine power"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "An electronic or mechanical hard-limit installed on the main engine governor or shaft to permanently cap the maximum power output, used to comply with EEXI regulations",
      "A device that increases power during storms",
      "A system that disconnects the propeller from the engine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes, anytime the ship is behind schedule",
      "No, only a shipyard can override it",
      "No, it is a permanent weld on the engine",
      "Yes, but ONLY in a genuine navigational emergency to save the ship; breaking the tamper-proof seal or software lock must be logged, reported to authorities, and investigated"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Using seawater to wash the exhaust gases",
      "Running the ship entirely on battery power",
      "Cooling the engine block with ice",
      "Plugging the ship's electrical grid into shore-based power while berthed, allowing all auxiliary diesel generators to be shut down, eliminating local air pollution and noise in the port"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Echo Sounder",
      "The Fuel Oil Flow Meters; these digital/mass flow meters provide the exact fuel consumption data required by law to calculate the ship's carbon emissions",
      "The Wind Anemometer",
      "The Salinometer"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The garbage disposal logs",
      "It is the ship's specific 'Operational Carbon Intensity Plan'; it documents the ship's target CII for the next three years and the exact steps the crew will take to achieve that target",
      "The technical blueprints for the main engine",
      "The crew's rest hour records"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It causes the lights to burn out faster",
      "It has absolutely zero effect on fuel consumption",
      "It makes the fuel oil colder",
      "A poor (low) power factor means generators must produce excessive reactive power (kVAR), increasing total current, I²R heat losses, and causing the diesel engine to burn slightly more fuel to compensate"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A satellite system for downloading charts",
      "A mandatory global database where ships ≥5,000 GT must report their annual fuel oil consumption, distance traveled, and hours underway to the IMO for carbon tracking",
      "A database of all ship spare parts",
      "A system that tracks pirate attacks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It applies only to European-flagged ships",
      "It is a completely unrelated radar system",
      "It is an engine manufacturer's warranty system",
      "The EU Monitoring, Reporting, and Verification system is Europe's regional version of the IMO DCS; it requires ships visiting EU ports to report fuel data, but with stricter verification and publishing rules"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A certificate issued by the Flag State every year confirming that the ship successfully submitted its accurate fuel data to the IMO DCS database; it must be kept onboard for 5 years",
      "A note from the shipyard confirming the engine works",
      "A certificate proving the fuel doesn't contain water",
      "A receipt from the bunker barge"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Removing barnacles and algae drastically reduces hydrodynamic drag; the ship requires less engine power (and less fuel) to maintain the same speed, significantly improving the CII score",
      "It changes the chemical composition of the exhaust",
      "It increases the weight of the ship"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Speed Reduction (Slow Steaming); because power requirement rises with the cube of speed, sailing slightly slower burns exponentially less fuel per nautical mile",
      "Opening all the windows for better aerodynamics",
      "Loading less cargo",
      "Running all generators simultaneously"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By forcing the ship to blackout daily",
      "By overriding the governor to spin the engine faster",
      "By turning off the ship's navigation lights",
      "By preventing 'Asymmetrical Load Sharing' and stopping unnecessary standby generators; running one generator at 80% load is vastly more fuel-efficient than running two generators at 40% load each"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The ship's capacity (Deadweight Tonnage or Gross Tonnage depending on ship type) multiplied by the distance traveled in nautical miles",
      "The total weight of the crew",
      "The amount of cargo loaded multiplied by the price of fuel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It captures the immense wasted heat from the main engine exhaust and uses it to boil water into steam for ship heating, completely eliminating the need to burn heavy fuel in the auxiliary boiler while at sea",
      "It adds oxygen to the exhaust to burn off soot",
      "It acts as a giant muffler to reduce engine noise",
      "It captures smoke and turns it into solid carbon blocks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because fuel is getting cheaper",
      "To punish older ships",
      "To force continuous, progressive improvement in the shipping industry; a ship that earns a 'C' rating today will slowly slide into a 'D' rating in three years if it doesn't upgrade its efficiency",
      "To encourage ships to sail faster"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It changes the amount of fuel injected into the engine",
      "It prevents the ship from hitting rocks",
      "The Speed Log data feeds into the total 'distance traveled' calculation; if the log under-reports the distance, the ship's CII calculation will look artificially worse, potentially failing the ship",
      "It has zero impact on environmental regulations"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It helps the solar panels generate more power",
      "By using advanced meteorological data to steer around heavy storms and adverse taking currents, the ship avoids fighting massive head seas, saving significant amounts of fuel and improving the CII",
      "It allows the ship to catch rainwater for the boilers",
      "It cools the engine using cold arctic air"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It powers the propeller using batteries",
      "It cleans the exhaust gases with electricity",
      "It generates electricity using the massive, highly efficient main engine instead of smaller, less efficient auxiliary diesel engines, reducing overall fuel consumption and CO2 emissions",
      "It adds torque to the main engine shaft"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A polished, mirror-smooth propeller creates less cavitation and drag in the water, translating the engine's power into thrust far more efficiently, thereby burning less fuel",
      "It prevents the propeller from rusting and leaking oil",
      "It increases the top speed to 30 knots",
      "It makes the ship look better in drydock"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Fuel burned during nighttime is exempt",
      "No, every drop of fuel is counted strictly",
      "Only fuel burned in port is exempt",
      "Yes, fuel consumed during severe emergencies (e.g., rescuing another ship, surviving a hurricane, or pirate evasion) can be deducted from the annual total if properly documented and approved by the Flag State"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It means ordering spare parts right before they break",
      "It means delivering cargo exactly on the contract date",
      "It is an engine timing adjustment",
      "It is a port coordination strategy where a ship slows down mid-ocean to arrive exactly when its berth is ready, rather than racing at full speed only to drop anchor and wait for days outside the port"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Poor quality parts (e.g., cheap fuel injector nozzles) result in poor atomization and incomplete combustion, meaning the engine must burn more fuel to generate the same horsepower, destroying efficiency",
      "They cause the engine room to look messy",
      "They break and cause the ship to sink",
      "They lack the proper IMO certification stamps"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A taller exhaust funnel",
      "A fuel homogenizer",
      "An approved Exhaust Gas Cleaning System (EGCS), commonly known as a 'Scrubber', to wash the sulphur dioxide out of the exhaust gas before it leaves the funnel",
      "A massive catalytic converter"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Open-Loop is used in port; Closed-Loop is used at sea",
      "Open-Loop scrubs NOx; Closed-Loop scrubs SOx",
      "Open-Loop relies on air cooling; Closed-Loop relies on water cooling",
      "An Open-Loop system pumps seawater into the exhaust and dumps the acidic washwater straight back into the sea; a Closed-Loop system recirculates a chemical solution and retains the dirty sludge onboard for shore disposal"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Chemicals that destroy the Earth's ozone layer (like CFCs and HCFCs); they are historically used as refrigerant gases in the ship's air conditioning and provision refrigeration plants",
      "Chemicals used to treat boiler water",
      "Chemicals used in the fire extinguishers",
      "Chemicals in the heavy fuel oil"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The gas can be vented if the ship is more than 50 nm from land",
      "The gas can be mixed with water and pumped into the bilge",
      "The gas must be burned in the incinerator",
      "Deliberate venting or releasing of ODS into the atmosphere is strictly prohibited; all refrigerant must be recovered into certified cylinders using a recovery machine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Compressor Amperage Book",
      "The AC Temperature Log",
      "The Refrigerant Pressure Log",
      "The Ozone Depleting Substances (ODS) Record Book, logging every addition, recovery, or loss of refrigerant gas in exact kilograms"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are still the most common refrigerant used today",
      "They are banned only in European waters",
      "They are completely BANNED on all new installations since January 1, 1996",
      "They are allowed if a special fee is paid"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are completely banned and must be removed from all ships immediately",
      "New installations using HCFCs are prohibited since January 1, 2020; existing systems may continue to operate but recharging with virgin gas is heavily restricted globally",
      "They are mandated for use in new ships to replace CFCs",
  ...
  },
  {
    ...
    "opts": [
      "CFC-12",
      "Nitrogen gas",
      "Pure Ammonia gas for all cabins",
      "HFCs (Hydrofluorocarbons) like R-134a or R-404A, which have an Ozone Depletion Potential (ODP) of exactly zero"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By running the engine at 50% speed",
      "By adding water to the fuel tanks",
      "By simply burning Marine Gas Oil instead of Heavy Fuel Oil",
      "By using exhaust after-treatment technology like Selective Catalytic Reduction (SCR), Exhaust Gas Recirculation (EGR), or running on alternative fuels like LNG"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A mandatory document supplied by the engine manufacturer detailing exactly how the engine must be tuned and what parts must be used to ensure it meets its certified NOx emission limits",
      "A certificate allowing the ship to bypass ECAs",
      "A log of the daily NOx emissions",
      "A list of the fuel consumed per day"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Cardboard and paper",
      "Food waste and oily rags",
      "Sludge oil and dirty lube oil",
      "Electronic waste (E-waste), Polyvinyl chlorides (PVC), PCBs, garbage containing heavy metals, and exhaust gas cleaning system (scrubber) residues"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Engine room sludge oil, dirty lube oil, oily rags, food waste, paper, cardboard, and non-toxic cargo residues",
      "Glass and metal cans",
      "Lithium batteries and aerosol cans",
      "Noxious Liquid Substances (Annex II chemicals)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "200°C to 400°C",
      "Over 2000°C",
      "The combustion chamber must reach and maintain 850°C to 1200°C to ensure complete combustion and prevent the release of toxic, unburned soot",
      "50°C to 100°C"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A system on crude oil tankers that captures highly toxic Volatile Organic Compounds (VOCs) displaced from cargo tanks during loading, returning them ashore instead of venting them to the atmosphere",
      "A ventilation fan for the engine room",
      "An exhaust scrubber for the main engine",
  ...
  },
  {
    ...
    "opts": [
      "Maintaining the intrinsically safe Ex-rated sensors, high-level alarms, VOC detectors, and the electrically actuated vapor manifold valves on deck",
      "Pumping the cargo oil",
      "Physically hooking the heavy hoses to the shore manifold",
      "Testing the chemical composition of the VOCs in a lab"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The International Agreement on Plastic Pollution",
      "The International Air Pollution Prevention Certificate; issued by the Flag State to prove the ship complies with all MARPOL Annex VI regulations (SOx, NOx, ODS)",
      "The Independent Audit of Port Pollution",
      "The Internal Assessment of Power Production"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A statement confirming the fuel flashpoint was measured at or above 70°C, OR if it is below 70°C, the actual measured flashpoint value must be explicitly declared",
      "A statement confirming the fuel is non-flammable",
      "A statement confirming the fuel will not freeze",
      "A statement of the fuel's exact sulfur content only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Load the fuel but keep it in a special cold tank",
      "Refuse to load the fuel immediately, stop the bunkering operation, and report the supplier to the Port State and Flag State, as loading fuel below 60°C is a massive safety and MARPOL violation",
      "Mix it with heavy oil to raise the flashpoint",
      "Load it, but log the event in the Oil Record Book"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Fire Operation Notification and Reporting",
      "Fuel Oil Non-Availability Report; a formal document filed by the Master if the ship is forced to burn non-compliant high-sulphur fuel because legal low-sulphur fuel was physically unavailable at the bunkering port",
      "First Order Notification of Air Release",
      "Federal Oil and Navigation Assessment Record"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The BDN must be retained for 3 years; the physical fuel sample must be retained for at least 12 months, or until the fuel is substantially consumed, whichever is longer",
      "1 year for both",
      "5 years for both",
      "They are discarded immediately after bunkering is complete"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It measures the temperature of the funnel",
      "It measures the speed of the exhaust gas",
      "It filters the black soot out of the exhaust",
      "It continuously samples the exhaust gas leaving the funnel, using infrared or UV analyzers to mathematically prove the SOx and CO2 ratio remains below the legal MARPOL equivalent limits"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because penguins are allergic to the sulfur fumes",
      "Because the polar magnetic fields disrupt HFO combustion",
      "Because HFO freezes solid in the cold temperatures",
  ...
  },
  {
    ...
    "opts": [
      "They must shut down the main engine and drift into the zone",
      "They must speed up to cross the zone faster",
      "They must turn off the incinerator permanently",
      "They must perform a fuel changeover (from 0.5% fuel to 0.1% fuel), and precisely log the date, time, and exact GPS coordinates when the fuel system was completely flushed and running purely on compliant fuel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The fuel must be free from inorganic acid, must not include any added chemical wastes, and must not jeopardize the safety of ships or adversely affect machinery performance",
      "The fuel must be distilled directly from seawater",
      "The fuel must be blended with at least 10% bio-fuel",
      "The fuel must be dyed a specific color for identification"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The exact temperature of the exhaust stack",
      "The start time and date, the stop time, the position of the ship at start and stop, and the estimated amount of garbage/sludge incinerated in cubic meters",
      "The name of the engineer who cleaned the incinerator",
      "A photograph of the ashes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Filtering the heavy fuel oil before it enters the burner",
      "Replacing the refractory bricks inside the chamber",
      "Maintaining the safety interlocks (e.g., door lock solenoid, high temp trips, draft fan DP switches) and ensuring the burner management flame scanner (UV sensor) is clean and functional",
      "Manually adjusting the air-to-fuel ratio during operation"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The ETO is fired immediately",
      "Nothing, provided no gas was actually leaked",
      "It is a violation of MARPOL Annex VI; Port State Control can issue a deficiency or detain the vessel until the records are brought up to date and accounted for",
      "The ship is forced to replace all its air conditioning units"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because high GWP gases require 440V to compress",
      "While HFCs (like R-134a) have zero ODP (ozone depletion), they have immense GWP (thousands of times worse than CO2); upcoming environmental regulations will tax or ban high-GWP gases",
      "Because GWP determines the cooling capacity of the compressor",
      "Because high GWP gases are highly flammable and explosive"
    ],
