window.loadQuizzes("T19_Tanker", [
  {
    ...
    "opts": ["Likely during normal operation \u2014 Ex d and Ex e permitted", "Unlikely during abnormal operation \u2014 Ex n permitted", "Outside cargo hold \u2014 Ex e only permitted", "Continuous flammable atmosphere (e.g. inside cargo tanks) \u2014 only Ex ia (intrinsically safe) permitted"],
  ...
  },
  {
    ...
    "opts": ["Limits circuit energy below ignition threshold (that is Ex ia)", "Maintains inert gas overpressure to keep vapour out (that is Ex p)", "Hermetically sealed vacuum \u2014 no oxygen inside", "Contains any internal explosion; flame paths cool escaping gases below ignition temperature of surrounding atmosphere"],
  ...
  },
  {
    ...
    "opts": ["Thick cast iron enclosure for blast containment (that is Ex d)", "Operates on compressed air instead of electricity (that is Ex p purging)", "Auto-sprays halon gas if spark detected", "Zener barriers limit circuit energy below ignition threshold \u2014 even under fault conditions cannot ignite surrounding vapour"],
  ...
  },
  {
    ...
    "opts": ["Provides shore power to cargo pumps", "Creates lightning strike path to shore earthing grid", "Grounds ICCP to prevent interference with terminal cathodic protection", "Equalises electrical potential between ship and terminal \u2014 prevents incendive static spark discharge during initial cargo flow"],
  ...
  },
  {
    ...
    "opts": ["High-voltage AC pulses electrocute incoming barnacles", "Injects chlorine gas at 15 ppm into cooling pipes", "Dissolves zinc anodes creating inert gas barrier", "Electrolytically dissolves copper anodes releasing Cu2+ ions at ~2 ppb \u2014 toxic to marine larvae preventing attachment"],
  ...
  },
  {
    ...
    "opts": ["Any area where a secondary explosion hazard exists but is unlikely during normal operation", "An area where an explosive gas atmosphere is present continuously, for long periods, or frequently \u2014 e.g. inside cargo tanks", "An area where explosive gas is likely only during maintenance operations", "An area within 3 metres of cargo vents where gas may occasionally be present"],
  ...
  },
  {
    ...
    "opts": ["Unclassified \u2014 pump rooms are treated as safe spaces when ventilation is running", "Zone 1 \u2014 explosive gas atmosphere likely to occur in normal operation occasionally", "Zone 2 \u2014 explosive gas atmosphere unlikely in normal operation", "Zone 0 \u2014 explosive gas atmosphere present continuously"],
  ...
  },
  {
    ...
    "opts": ["Ex ia \u2014 Intrinsically Safe (circuit energy limited below ignition threshold)", "Ex e \u2014 Increased Safety (no sparking parts)", "Ex n \u2014 Non-sparking (Zone 2 only)", "Ex d \u2014 Flameproof enclosure"],
  ...
  },
  {
    ...
    "opts": ["There is no prohibition \u2014 standard 500V megger testing is routine on Ex ia circuits", "The megger would permanently magnetize the Zener barriers, rendering them useless", "The megger's high DC voltage (500-1000V) would inject lethal ignition energy into the Zone 0 circuit, potentially causing an explosion", "The high voltage would cause the Zener barriers to blow their fuses, disconnecting the sensor loop"],
  ...
  },
  {
    ...
    "opts": ["The enclosure withstands an internal explosion without igniting the outside atmosphere \u2014 achieved via precision flame-path gaps around mating surfaces", "The enclosure is filled with pressurized inert gas to prevent explosive gas from entering", "The enclosure is hermetically sealed so no gas can enter and reach the electrical components inside", "The enclosure is constructed from non-sparking aluminium alloy that cannot initiate an explosive reaction"],
  ...
  },
  {
    ...
    "opts": ["5 Pa (0.05 mbar) \u2014 just enough to prevent natural convection-driven vapour migration", "No pressure difference is required \u2014 natural ventilation is sufficient on modern tankers", "50 Pa (0.5 mbar) positive pressure to prevent hydrocarbon vapours from entering living spaces", "500 Pa (5 mbar) to create a strong enough barrier against cargo tank vapour concentrations"],
  ...
  },
  {
    ...
    "opts": ["5 seconds \u2014 the door must be closed almost immediately to maintain pressurisation", "There is no time limit \u2014 the double-door interlock alone provides sufficient protection", "30 minutes \u2014 long enough for cargo operations crew to pass equipment through", "60 seconds \u2014 after which audible/visual alarms activate on the bridge and ECR, and HVAC fans may auto-trip"],
  ...
  },
  {
    ...
    "opts": ["Less than 8% oxygen by volume", "Less than 2% oxygen by volume", "Less than 10% oxygen by volume", "Less than 5% oxygen by volume"],
  ...
  },
  {
    ...
    "opts": ["Paramagnetic attraction \u2014 oxygen is drawn into a magnetic field deflecting a dumbbell indicator proportionally", "Infrared absorption \u2014 O2 molecules absorb infrared light at a specific wavelength reducing detector intensity", "The Nernst equation \u2014 oxygen ions migrate through a heated zirconia crystal (600-700 deg C) creating a voltage proportional to the O2 concentration ratio", "Catalytic oxidation \u2014 oxygen burns a platinum filament, changing its resistance in proportion to O2 concentration"],
  ...
  },
  {
    ...
    "opts": ["1-2 years \u2014 the lead anode is gradually consumed by oxidation and must be replaced before full depletion", "5-7 years \u2014 replacement is only required when the cell's output voltage drops below 0.1V", "10-15 years \u2014 electrochemical cells have virtually unlimited lifespan if kept moist", "The cell is permanent \u2014 only the electrolyte gel requires replenishment annually"],
  ...
  },
  {
    ...
    "opts": ["The cargo pump efficiency is reduced by up to 15% due to the increased gas resistance in the suction line", "MARPOL Annex I will be violated, resulting in a Port State Control deficiency", "The tank atmosphere may enter the explosive range \u2014 if a static discharge or spark occurs, a catastrophic tank explosion can result", "The inert gas becomes slightly corrosive, causing minor staining of the tank coating"],
  ...
  },
  {
    ...
    "opts": ["A single interlock is sufficient \u2014 the bridge remote/local changeover switch", "All 7 interlocks must be satisfied: hydraulic oil pressure, lub oil pressure, bearing temperature, shaft seal confirmation, local/remote selector, guard removed alarm, and zero-pitch confirmation", "Only two interlocks are required by SOLAS \u2014 low oil pressure and shaft seal status", "Bow thrusters have no starting interlocks because they are considered non-essential machinery"],
  ...
  },
  {
    ...
    "opts": ["Worn carbon brushes in the DC excitation circuit causing armature voltage fluctuations that force the blades to oscillate", "Slippage of the zero-pitch feedback potentiometer dead-band inside the control drive card \u2014 corrected by recalibrating the potentiometer dead-band setting", "Air trapped in the hydraulic servo cylinder preventing stable blade positioning", "Contaminated hydraulic oil in the CPP hub causing pressure surges that physically push blades away from zero pitch"],
  ...
  },
  {
    ...
    "opts": ["Vapour pressure in the tank is at maximum immediately after loading \u2014 any disturbance through the ullage hatch releases a toxic gas cloud", "Electrostatic charge accumulated during cargo loading takes up to 30 minutes to dissipate via the cargo fluid's dielectric relaxation time constant \u2014 a metallic object bridges the gap and causes a high-energy ignition spark", "The cargo fluid temperature is still rising after loading stops \u2014 a metallic object could cause thermal shock cracking of the tank coating", "The 30-minute rule applies only to ship-shore bonding cables, not to gauging equipment"],
  ...
  },
  {
    ...
    "opts": ["The ship's cathodic protection ICCP system must be switched OFF to prevent stray current flow through the cargo hoses", "The tanker's emergency generator must be started and confirmed on standby before hose connection", "The ship-to-shore bonding cable must be connected first to equalise the potential difference between ship and terminal before any hose connection", "All accommodation air lock doors must be confirmed fully closed before the bonding cable is touched"],
  ...
  },
  {
    ...
    "opts": ["6 air changes per hour \u2014 the same standard as a battery room on a conventional ship", "At least 20 air changes per hour, confirmed by a continuous mechanical exhaust fan with airflow monitoring", "Ventilation is optional in pump rooms if fixed gas detection monitors are installed and alarmed", "2 air changes per hour \u2014 sufficient to prevent accumulation of heavier-than-air vapours near the bilge"],
  ...
  },
  {
    ...
    "opts": ["Ex d is required for pump rooms only when carrying IMDG Class 3 flammable liquid cargo", "The pump room is classified Zone 1 \u2014 cargo seal leaks mean explosive gas mixtures are likely to occur during normal pump operation", "Ex d is recommended but not mandatory \u2014 Ex e (increased safety) equipment is acceptable in pump rooms", "Pump rooms are classified Zone 0 because cargo fills the bilge during discharge operations"],
  ...
  },
  {
    ...
    "opts": ["Silence the alarm and notify the Chief Mate \u2014 gas detector false alarms are common on tankers", "Immediately stop all pump room operations, sound the emergency alarm, shut down pump room electrical equipment, and evacuate \u2014 do not enter without SCBA and EEx rated lighting", "Increase pump room ventilation to maximum and continue operations while monitoring the gas readings", "Enter the pump room alone with a portable gas detector to locate and isolate the source of the vapour"],
  ...
  },
  {
    ...
    "opts": ["MARPOL Annex II Regulation 18 \u2014 Noxious liquid substance emissions", "MARPOL Annex VI Regulation 15 \u2014 Volatile Organic Compound emissions", "MARPOL Annex I Regulation 34 \u2014 Oil discharge monitoring requirements", "MARPOL Annex VI Regulation 12 \u2014 Ozone depleting substances"],
  ...
  },
  {
    ...
    "opts": ["Standard IP65 weatherproof rating \u2014 VECS operates with inert gas providing a non-explosive atmosphere", "No Ex rating is required because VECS pipework is always under positive vapour pressure preventing air ingress", "Ex d (flameproof) or Ex e (increased safety) because the VECS manifold routes explosive hydrocarbon vapour mixtures", "Ex ia (intrinsically safe) only \u2014 VECS operates at very low power levels"],
  ...
  },
  {
    ...
    "opts": ["The Master's oral confirmation that the crew has been briefed and the emergency generator has been tested", "Agreed minimum and maximum transfer pressures, minimum and maximum transfer temperatures, and the pressure relief valve settings on both the ship's tanks and the supply terminal manifolds", "The cargo manifest showing the expected calorific value and the bill of lading for the fuel batch", "The supplier's company name, contact number, and insurance certificate number"],
  ...
  },
  {
    ...
    "opts": ["90% \u2014 the system pays out rope well before maximum tension to maintain a safety margin", "150% \u2014 only at this point does the system override the operator's set tension", "125% of the preset tension boundary \u2014 the drive clips the torque loop reference and dynamically pays out rope in a controlled manner", "200% \u2014 the mooring line must reach double the preset tension before any automatic response occurs"],
  ...
  },
  {
    ...
    "opts": ["Ex d is used in Zone 2; Ex e is used in Zone 0 applications requiring higher protection", "Ex d withstands and contains an internal explosion; Ex e has no sparking parts and relies on construction quality to prevent ignition", "Ex d is for fixed equipment only; Ex e is specifically designed for portable instruments", "Ex d uses hermetic sealing with inert gas; Ex e uses flame-path gaps to cool escaping gases"],
  ...
  },
  {
    ...
    "opts": ["It limits the maximum open-circuit voltage and short-circuit current entering the hazardous zone to safe levels below ignition thresholds under all fault conditions", "It provides galvanic isolation to prevent ICCP stray currents from corrupting the sensor signal", "It converts the DC sensor signal to a safe 24V AC signal for transmission to the PLC panel", "It amplifies the weak 4-20mA signal from the sensor to compensate for cable resistance losses"],
  ...
  },
  {
    ...
    "opts": ["Run the motor for 30 minutes off-load to verify no vibration has been introduced by disturbing the cable entries", "Verify the flame-path gap dimensions with feeler gauges and re-lubricate all mating surfaces with approved anti-corrosion grease before reassembling", "Fill the terminal box with nitrogen gas and seal it completely to create an inert atmosphere", "Paint the exterior of the terminal box with at least two coats of anti-corrosion paint rated for marine use"],
  ...
  },
  {
    ...
    "opts": ["Advisory only \u2014 IP44 boxes are permitted if the pump room has continuous gas detection monitoring", "No finding \u2014 IP44 is an internationally accepted standard for pump room equipment on tankers", "Minor observation \u2014 the inspector will note it for correction at next scheduled drydock", "Detention or deficiency \u2014 the junction box must be Ex d or Ex e certified for Zone 1; standard IP44 is only suitable for safe spaces"],
  ...
  },
  {
    ...
    "opts": ["Zone 2 \u2014 explosive gas atmosphere not likely in normal operation but possible for short periods; accepts Ex n (non-sparking) equipment", "Unclassified \u2014 beyond 3 metres from the cargo vents, no hazardous area restrictions apply", "Zone 1 \u2014 the risk is identical to the pump room because the open deck has no ventilation", "Zone 0 \u2014 the entire cargo deck must be treated as continuously hazardous regardless of distance from vents"],
  ...
  },
  {
    ...
    "opts": ["The cargo is expanding due to temperature rise during sea passage and is forced through the vent pipes into the bilge", "The ship's cathodic protection system is creating galvanic corrosion in the pump casing, causing microscopic weepage", "The bilge level sensor is malfunctioning and the reported oil is actually residual water from cargo washing", "Internal seal face wear \u2014 the lapped carbon/ceramic seal faces have worn to a point where fluid is bypassing under the seal face loading pressure"],
  ...
  },
  {
    ...
    "opts": ["To filter out hydrocarbon vapours from the flue gas to prevent re-ignition in the scrubber housing", "To remove sulphur dioxide (SO2) and particulate soot from the flue gas before it enters the cargo tanks, preventing acidic corrosion of the tank coating and cargo contamination", "To heat the cold flue gas to prevent condensation from forming inside the IG distribution piping", "To inject additional nitrogen into the flue gas to reduce its oxygen content below 5%"],
  ...
  },
  {
    ...
    "opts": ["It monitors the oxygen content of the gas flowing to the cargo deck and isolates flow if O2 exceeds 5%", "It cools the hot flue gas from the boiler before it enters the cargo distribution piping", "It filters water droplets from the inert gas to prevent liquid ingress into the cargo tanks", "It acts as a hydraulic non-return valve \u2014 a water column prevents cargo gas from back-flowing through the IG main into the engine room when IG pressure falls below deck pressure"],
  ...
  },
  {
    ...
    "opts": ["Less than 1% oxygen by volume in the tank atmosphere \u2014 achieved through inerting and gas-freeing verification", "Less than 20% oxygen \u2014 the same as normal atmospheric oxygen", "Less than 10% oxygen by volume \u2014 sufficiently below the lower explosive limit", "Less than 5% oxygen by volume \u2014 the same as the IG delivery standard"],
  ...
  },
  {
    ...
    "opts": ["Atmospheric pressure exactly \u2014 tanks are maintained at 0 Pa to avoid any structural load on the venting system", "5000 to 10000 Pa (50 to 100 mbar) \u2014 enough positive pressure to prevent all possible sea water ingress through vents", "100 to 1000 Pa (1 to 10 mbar) positive pressure \u2014 just enough to prevent air ingress without stressing the tank structure", "Slight negative pressure of minus 100 Pa \u2014 to allow natural ventilation of any residual vapours"],
  ...
  },
  {
    ...
    "opts": ["An area where explosive gas is present only in abnormal conditions", "An area where explosive dust is present", "An area where explosive gas is completely absent", "An area where an explosive gas atmosphere is present continuously, or for long periods, or frequently"],
  ...
  },
  {
    ...
    "opts": ["The interior of the cargo tanks and cargo piping", "The open deck above the cargo tanks", "The paint locker", "The cargo pump room"],
  ...
  },
  {
    ...
    "opts": ["An area where explosive gas is present continuously", "An area restricted to authorised personnel only", "An area where gas is only present if a pipe bursts", "An area where an explosive gas atmosphere is likely to occur in normal operation occasionally"],
  ...
  },
  {
    ...
    "opts": ["The interior of the cargo tanks", "The Engine Control Room", "The navigation bridge", "The Cargo Pump Room"],
  ...
  },
  {
    ...
    "opts": ["An area where an explosive gas atmosphere is not likely to occur in normal operation, and if it does, it will persist for a short period only", "An area where explosive gas is present continuously", "A completely safe area", "An area containing liquid cargo"],
  ...
  },
  {
    ...
    "a": "Zone 1",
    "opts": ["Zone 2", "Zone 1", "Safe Area", "Zone 0"],
  ...
  },
  {
    ...
    "a": "Group IIC",
    "opts": ["Group IIA", "Group IIC", "Group III", "Group IIB"],
  ...
  },
  {
    ...
    "a": "Group IIA",
    "opts": ["Group IIC", "Group I", "Group IIB", "Group IIA"],
  ...
  },
  {
    ...
    "opts": ["The maximum surface temperature of the equipment will not exceed 85\u00b0C", "The equipment is immune to freezing", "The maximum surface temperature is 450\u00b0C", "The equipment operates at 600\u00b0C"],
  ...
  },
  {
    ...
    "opts": ["Any area with forced ventilation", "Any area outside the cargo tanks", "An area where an explosive gas atmosphere is not expected to be present in quantities such as to require special precautions", "The deck area forward of the accommodation"],
  ...
  },
  {
    ...
    "opts": ["It is filled with inert gas", "It is physically separated by a gas-tight bulkhead and maintained at a positive air pressure relative to the pump room", "It uses only 24V equipment", "It has open windows for natural draft"],
  ...
  },
  {
    ...
    "opts": ["A vacuum chamber", "A ventilation duct with a high-speed fan", "A space with two gas-tight doors in series, mechanically interlocked so only one can be opened at a time", "A room filled with water"],
  ...
  },
  {
    ...
    "opts": ["The fire pumps must start", "The ship must stop its engines", "The lights must flash red", "An alarm must sound and all non-certified electrical equipment inside the airlock must automatically trip (disconnect)"],
  ...
  },
  {
    ...
    "opts": ["Lowest Emission Level", "Lowest Electrical Load", "Latent Energy Limit", "Lower Explosive Limit"],
  ...
  },
  {
    ...
    "opts": ["Upper Electrical Load", "Unrestricted Emission Limit", "Upper Explosive Limit", "Ultimate Energy Level"],
  ...
  },
  {
    ...
    "opts": ["The distance a flame can travel", "The concentration range between the LEL and UEL where the gas-air mixture will explode if ignited", "The distance from a vent to a safe area", "The maximum temperature of a fire"],
  ...
  },
  {
    ...
    "opts": ["To neutralize the smell of the oil", "To cool the cargo down", "To increase the pressure of the oil", "To reduce the oxygen content inside the tank below 8% by volume, preventing any explosion regardless of hydrocarbon concentration"],
  ...
  },
  {
    ...
    "opts": ["The room automatically floods with CO2", "A visual/audible alarm activates and cargo pumps are usually interlocked to prevent starting", "The main engine trips", "Nothing, natural draft is sufficient"],
  ...
  },
  {
    ...
    "opts": ["10 air changes per hour", "20 air changes per hour", "5 air changes per hour", "60 air changes per hour"],
  ...
  },
  {
    ...
    "opts": ["To ensure electrical sparks from the motor cannot ignite the explosive vapours being extracted", "To keep the motor cool", "To save space in the duct", "To make maintenance easier"],
  ...
  },
  {
    ...
    "a": "Zone 1",
    "opts": ["Zone 1", "Safe Area", "Zone 2", "Zone 0"],
  ...
  },
  {
    ...
    "opts": ["Safe Area", "Zone 1", "Zone 2", "Zone 0"],
  ...
  },
  {
    ...
    "opts": ["The cargo piping layout", "The electrical wiring schematic", "A plan view of the ship delineating the exact boundaries of all Zone 0, Zone 1, and Zone 2 areas", "A diagram of the fire mains"],
  ...
  },
  {
    ...
    "opts": ["Increased Safety (Ex e)", "Only Intrinsically Safe 'Ex ia' (and some specialized encapsulated equipment)", "Any Ex-rated equipment", "Flameproof (Ex d) only"],
  ...
  },
  {
    ...
    "opts": ["No, no portable electronics are ever allowed", "Yes, any commercial equipment is allowed", "Only if they are specifically certified as Intrinsically Safe for Zone 1 and carry the appropriate Ex markings", "Yes, if they are turned off first"],
  ...
  },
  {
    ...
    "opts": ["The volume of gas released, the vent velocity, and the density of the gas", "The color of the pipe", "The ship's speed", "The age of the vessel"],
  ...
  },
  {
    ...
    "opts": ["It becomes a safe area", "It remains Zone 1; hazardous areas extend in 3D volumes, not just flat lines", "It becomes Zone 0", "It becomes Zone 2"],
  ...
  },
  {
    ...
    "opts": ["Water will flood the engine room", "The pump will over-pressurize", "The motor will spin backwards", "Explosive vapours from the pump room (Zone 1) will leak into the engine room (Safe Area)"],
  ...
  },
  {
    ...
    "opts": ["Flameproof Enclosure: It contains an internal explosion and cools escaping gases so they cannot ignite the external atmosphere", "Intrinsically safe device", "Waterproof container", "Dust-proof enclosure"],
  ...
  },
  {
    ...
    "opts": ["Paint alters the microscopic gap dimensions, allowing hot flames to escape and ignite the outside atmosphere", "Paint makes it too hard to open", "Paint traps moisture inside the box", "Paint is conductive and causes short circuits"],
  ...
  },
  {
    ...
    "opts": ["Silicone sealant or RTV", "Thick marine epoxy paint", "Standard bearing grease", "A thin smear of approved non-setting, non-hardening silicone or petroleum grease"],
  ...
  },
  {
    ...
    "opts": ["It purges the box with nitrogen", "It surrounds the electronics with heavy steel", "It limits electrical energy (voltage and current) to levels far below what is required to cause an ignition spark or hot surface", "It uses only 220V AC"],
  ...
  },
  {
    ...
    "opts": ["Ex ia is flameproof, Ex ib is increased safety", "Ex ia is for AC, Ex ib is for DC", "There is no difference", "Ex ia remains safe with TWO simultaneous faults (allowed in Zone 0); Ex ib remains safe with ONE fault (allowed in Zone 1)"],
  ...
  },
  {
    ...
    "opts": ["It increases the power to the sensors", "It boosts the signal for long cables", "It acts as the safety gateway in the Safe Area, clamping voltage (Zener diodes) and limiting current (resistor) sent into the Hazardous Area", "It blocks gas from entering the conduit"],
  ...
  },
  {
    ...
    "opts": ["Equipment submerged in oil", "Equipment that produces no arcs or sparks in normal operation, upgraded with high IP protection, secure terminals, and excellent insulation", "Equipment that contains explosions", "Equipment filled with sand"],
  ...
  },
  {
    ...
    "opts": ["The cooling time required after stopping", "The maximum time the motor can survive a locked-rotor (stall) condition before its temperature exceeds the hazardous gas ignition limit", "The time it takes to reach full speed", "The total expected lifespan of the motor"],
  ...
  },
  {
    ...
    "opts": ["Potted equipment", "Protected equipment", "Powder-filled equipment", "Pressurized/Purged equipment: Uses continuous positive air pressure to keep explosive gas out of a standard enclosure"],
  ...
  },
  {
    ...
    "opts": ["A pre-purge cycle must run, changing the air volume inside the enclosure at least 5 times to flush out any leaked gas", "The box must be heated", "A vacuum must be pulled", "The main engine must be started"],
  ...
  },
  {
    ...
    "opts": ["It fills with CO2", "An alarm sounds, and power to the uncertified equipment inside must be automatically tripped (disconnected)", "The enclosure doors automatically lock", "It switches to battery power"],
  ...
  },
  {
    ...
    "opts": ["Motorized equipment", "Magnetic equipment", "Movable equipment", "Encapsulation: The sparking electrical components are completely potted (buried) in solid resin or epoxy"],
  ...
  },
  {
    ...
    "a": "Only in Zone 2",
    "opts": ["Zone 0, 1, and 2", "Only in Zone 2", "Zone 1 and 2", "Only in Safe Areas"],
  ...
  },
  {
    ...
    "opts": ["Applying grease to the threads", "Replacing a lost bolt with a standard mild steel bolt or one of incorrect length", "Tightening them with a torque wrench", "Painting the bolt heads"],
  ...
  },
  {
    ...
    "opts": ["Yes, but only on the bottom face", "Yes, if painted afterwards", "No, drilling invalidates the certification; all entries must be factory machined", "Yes, if you use a rubber grommet"],
  ...
  },
  {
    ...
    "opts": ["Any metal gland", "A rubber push-fit grommet", "A standard plastic weatherproof gland", "An ATEX/IECEx certified Ex d barrier gland, sometimes requiring epoxy compound filling depending on cable volume"],
  ...
  },
  {
    ...
    "opts": ["Washing the equipment", "Looking at it from a distance", "Opening the equipment, disconnecting power, and checking internal components, flamepaths, and terminal tightness", "Taking a thermal photograph"],
  ...
  },
  {
    ...
    "opts": ["It is exempt from class surveys", "It generates its own electricity", "Compliance with the European ATEX directive for explosive atmospheres", "It is safe to use underwater"],
  ...
  },
  {
    ...
    "a": "Light Blue",
    "opts": ["Black", "Yellow", "Red", "Light Blue"],
  ...
  },
  {
    ...
    "opts": ["To amplify the 4-20mA signal", "To make the cable waterproof", "To prevent circulating ground loop currents which could induce unsafe voltages in the hazardous area", "To save wire costs"],
  ...
  },
  {
    ...
    "opts": ["Yes, provided the plastic is anti-static and certified to withstand impacts and UV light", "Yes, any standard plastic box is fine", "No, they must be cast iron", "No, plastic melts too easily"],
  ...
  },
  {
    ...
    "opts": ["It becomes an Ex d box", "It works better due to ventilation", "Nothing, it is still safe", "It loses its required IP rating (usually IP54+), allowing water/dust to enter and cause sparks, voiding the Ex e certification"],
  ...
  },
  {
    ...
    "opts": ["No, the metal-to-metal gap is the flamepath. O-rings are only for weatherproofing (IP rating) and must not prop the gap open", "No, Ex d boxes cannot use O-rings", "Yes, the rubber stops the explosion", "Yes, it seals the gas inside"],
  ...
  },
  {
    ...
    "opts": ["The speed at which gas enters the box", "The distance a flame travels in air", "The gap between the flange faces", "The shortest distance along the surface of an insulating material between two conductive parts"],
  ...
  },
  {
    ...
    "opts": ["The shortest direct distance straight through the air between two conductive parts", "The distance along the plastic surface", "The minimum distance to the bulkhead", "The size of the cable entry hole"],
  ...
  },
  {
    ...
    "opts": ["No, Zener barriers are encapsulated for safety; the entire barrier block must be replaced", "Yes, with standard glass fuses", "Yes, but only in dry dock", "Yes, if you use silver wire"],
  ...
  },
  {
    ...
    "opts": ["Oxygen purged", "Open to atmosphere", "Oil Immersion: Electrical parts are submerged in oil so explosive gas cannot reach the sparks", "Optical isolation"],
  ...
  },
  {
    ...
    "opts": ["It provides full electrical isolation (via transformers/optocouplers), eliminating the need for a dedicated high-integrity earth connection", "It allows massive currents to pass", "It uses zinc to protect the wires", "It is only used for AC power"],
  ...
  },
  {
    ...
    "opts": ["No, it must match IIB exactly", "Yes, Group IIC is the highest standard and covers IIB, and 'ia' covers Zone 1 pump rooms", "No, 'ia' is only for safe areas", "No, T4 is not safe enough"],
  ...
  },
  {
    ...
    "opts": ["The ship's radar sweeping the deck", "The physical flow and friction of non-conductive petroleum liquids through pipes and filters", "Solar radiation on the deck", "The ICCP system"],
  ...
  },
  {
    ...
    "opts": ["Saltwater ballast", "Refined products with very low electrical conductivity (e.g., Jet fuel, Diesel, Kerosene)", "Heavy crude oil", "Liquid nitrogen"],
  ...
  },
  {
    ...
    "opts": ["It ruins the paint", "It causes too much noise", "The breaking apart of the liquid stream generates massive amounts of highly charged static mist/foam", "It causes the tank to overflow"],
  ...
  },
  {
    ...
    "opts": ["Linear velocity must not exceed 1 metre per second until the bottom piping is submerged", "100 litres per minute", "Maximum speed to load fast", "10 metres per second"],
  ...
  },
  {
    ...
    "opts": ["A mandatory waiting period (usually 30 minutes) after pumping stops, allowing the static charge in the liquid to bleed off to the grounded hull", "The time it takes the cargo to cool", "The crew's break time", "The time required to sign the permit"],
  ...
  },
  {
    ...
    "opts": ["To power the deck lighting", "To stop the ship from rusting", "To connect all metallic components to the hull, ensuring zero voltage difference exists to cause a spark", "To act as a lightning rod"],
  ...
  },
  {
    ...
    "opts": ["Greater than 1 Megaohm", "Less than 1 Ohm (< 1 \u03a9)", "Less than 100 Ohms", "Zero exactly"],
  ...
  },
  {
    ...
    "opts": ["To hold the pipes together", "To prevent theft of the pipes", "Because rubber gaskets and painted bolts can insulate the pipe sections; the strap ensures continuous conductivity", "To act as a sacrificial anode"],
  ...
  },
  {
    ...
    "opts": ["It is too heavy to lift", "It causes the cargo to freeze", "It transmits computer viruses", "If the cable breaks or is disconnected last, it can draw an explosive spark from massive ICCP stray currents"],
  ...
  },
  {
    ...
    "opts": ["To keep the cargo hot", "To prevent static electricity", "To electrically isolate the ship from the jetty, preventing low-voltage ICCP stray currents from flowing through the cargo hoses and sparking", "To filter the oil"],
  ...
  },
  {
    ...
    "opts": ["The hoses are made of pure copper", "The hose on the ship side is bonded to the ship, and the hose on the shore side is bonded to the shore; only the flange between them is insulated", "Water is sprayed on the hoses", "Static is ignored"],
  ...
  },
  {
    ...
    "opts": ["Steam jets generate massive clouds of highly charged static mist, creating an extreme explosion hazard", "It ruins the ICCP system", "The steel melts", "The steam freezes instantly"],
  ...
  },
  {
    ...
    "opts": ["To power the digital screen", "To ensure the metal tape does not act as an isolated capacitor, picking up charge and sparking against the tank hatch", "To provide a plumb bob effect", "So they don't fall in"],
  ...
  },
  {
    ...
    "opts": ["They trigger the gas alarms", "They become a walking capacitor, accumulating static charge that can spark when they touch a grounded valve handle", "They are protected from lightning", "They slip and fall"],
  ...
  },
  {
    ...
    "opts": ["IG increases static massive", "IG grounds the tank", "IG prevents static from forming", "IG does not stop static generation, but it removes the oxygen, preventing the spark from causing an explosion"],
  ...
  },
  {
    ...
    "opts": ["They are too weak", "They absorb oil", "They are highly non-conductive and can generate massive static charges when sliding or rubbing", "They interfere with radios"],
  ...
  },
  {
    ...
    "opts": ["They must be anti-static belts to prevent friction from generating high-voltage static sparks during rotation", "They must be made of pure rubber", "They must be fireproof", "They must be bulletproof"],
  ...
  },
  {
    ...
    "opts": ["Resistive sparks are caused by ICCP", "Inductive is from water, Resistive from oil", "They are exactly the same", "Inductive sparks (metal to metal) are sharp, energetic, and incendiary. Resistive discharges (liquid to metal) are diffuse and less incendiary"],
  ...
  },
  {
    ...
    "opts": ["With a micro-ohmmeter, verifying < 1 Ohm", "With a high voltage spark test", "It is not tested", "With an insulation tester (Megger), verifying resistance is greater than 1000 Ohms"],
  ...
  },
  {
    ...
    "opts": ["Sparks in the pump room", "Sparks from small electronics", "Sparks from the ICCP system", "Tiny discharges between the charged liquid surface and internal tank structures (ladders, bulkheads)"],
  ...
  },
  {
    ...
    "opts": ["It must be painted red", "It must be wrapped in plastic", "A dedicated earth bonding wire must be clamped from the pump casing to the ship's bare steel deck", "The battery must be removed"],
  ...
  },
  {
    ...
    "opts": ["Water causes short circuits in the lights", "High-pressure water jets break into fine droplets, creating a highly charged electro-static mist inside the tank", "Water reacts chemically with steel", "Water washes away the paint"],
  ...
  },
  {
    ...
    "opts": ["Values in the Mega-ohm range", "Voltage up to 500V", "Values typically in the milli-ohm or micro-ohm range to prove flawless metal-to-metal continuity", "Capacitance of the pipe"],
  ...
  },
  {
    ...
    "opts": ["No, it floats so it has no earth", "Only when the anchor is dropped", "Only if the ICCP is turned off", "Yes, the massive steel hull in contact with the infinite ocean provides an absolute zero-volt earth reference"],
  ...
  },
  {
    ...
    "opts": ["It causes the pipes to freeze", "It cancels out the static charge", "It dissolves the pipe flanges", "The presence of a second phase (water droplets in oil) massively increases the generation of static electricity"],
  ...
  },
  {
    ...
    "opts": ["Yes, they generate hydrogen gas", "No, they absorb all static", "No, they are totally safe", "Yes, if an aluminum or magnesium anode falls from the roof and strikes rusty steel, it causes an incendiary thermite spark"],
  ...
  },
  {
    ...
    "opts": ["To make the fuel burn hotter", "To increase the electrical conductivity of the fuel, allowing static charge to bleed away naturally to the pipe walls", "To change the color of the fuel", "To stop the fuel from freezing"],
  ...
  },
  {
    ...
    "opts": ["That it glows in the dark", "That the hose carries 24V power", "That the internal bonding wire of the hose is intact to bleed static, unless it is specifically designed as a non-conducting hose", "That the hose has high resistance"],
  ...
  },
  {
    ...
    "opts": ["The paint absorbs the static", "It dissipates into the air", "The fluid breaks down the paint", "Paint is highly resistive; static may accumulate unless physical metal-to-metal bonding paths (straps or unpainted bosses) are maintained"],
  ...
  },
  {
    ...
    "opts": ["The relaxation time is violated; drawing air in or inserting a tool could trigger an explosion from the un-dissipated static cloud", "The tank loses its pressure", "The diesel evaporates instantly", "The ship rolls over"],
  ...
  },
  {
    ...
    "opts": ["Marine Growth Prevention System", "Main Generator Power Supply", "Motor Gear Protection System", "Marine Galvanic Protection System"],
  ...
  },
  {
    ...
    "opts": ["Copper (Cu) and Aluminium (Al)", "Iron and Steel", "Titanium and Platinum", "Zinc and Magnesium"],
  ...
  },
  {
    ...
    "opts": ["It raises the water temperature", "It physically blocks the pipes", "It electrocutes the fish", "Electrolysis dissolves the copper, releasing toxic Cu\u00b2\u207a ions that prevent microscopic larvae from settling and attaching to pipe walls"],
  ...
  },
  {
    ...
    "opts": ["Inside the sea chests or seawater intake strainers", "On the external hull near the bow", "Inside the cargo tanks", "On the main engine block"],
  ...
  },
  {
    ...
    "a": "0.5 to 4 Amps DC",
    "opts": ["50 to 60 Amps AC", "Microamps", "0.5 to 4 Amps DC", "100 to 200 Amps DC"],
  ...
  },
  {
    ...
    "opts": ["The steel casing of the sea chest and the surrounding seawater pipework", "A dedicated titanium rod", "The shore power earth", "The hull ICCP anodes"],
  ...
  },
  {
    ...
    "opts": ["MGPS runs on a fixed, manually set current based on pump flow rate; ICCP uses automated feedback from a reference electrode", "MGPS uses massive voltages", "MGPS uses AC, ICCP uses DC", "There is no difference"],
  ...
  },
  {
    ...
    "opts": ["It cools the water", "It filters the seawater", "It kills the barnacles", "It releases ions that form a gelatinous aluminium hydroxide floc, which coats the inside of steel pipes to prevent corrosion"],
  ...
  },
  {
    ...
    "opts": ["Because the ship is connected to shore power", "Because the main engine is off", "Because deep ocean water has more barnacles", "Shallow, warm coastal waters contain the highest concentrations of marine larvae and bio-fouling organisms"],
  ...
  },
  {
    ...
    "opts": ["The copper anodes will dissolve completely long before the next scheduled dry dock, leaving the system unprotected", "The pipes will turn green", "The seawater will boil", "The ICCP system will trip"],
  ...
  },
  {
    ...
    "opts": ["The sea chest is flooded", "The water is too salty", "The AC power failed", "The anode has been completely consumed (dissolved) and the electrical path into the seawater is broken"],
  ...
  },
  {
    ...
    "opts": ["No, they must be replaced by submarines", "Yes, by emptying the ocean", "Usually no, as they are inside the flooded sea chest, though some specialized housings allow withdrawal through a gate valve", "Yes, easily from the main deck"],
  ...
  },
  {
    ...
    "opts": ["The anode generates hydrogen", "The system works perfectly", "The paint dissolves instantly", "The paint acts as an insulator, blocking current flow; no copper ions are released, and the system fails to protect the pipes"],
  ...
  },
  {
    ...
    "opts": ["It requires no electricity", "It produces zero carbon emissions", "It runs on solar power", "The 2 ppb copper output is highly localized and environmentally benign compared to dumping bulk toxic chemicals into the ocean"],
  ...
  },
  {
    ...
    "opts": ["Only in freshwater", "Yes, if the ship is made of aluminium", "Yes, it is worse than ICCP", "No, the extremely low voltage and fully enclosed internal circuit within the sea chest prevents external stray currents"],
  ...
  },
  {
    ...
    "opts": ["Cold water requires higher voltage", "The system must be turned to AC", "Current must be maxed out to stop freezing", "Bio-fouling is minimal in freezing water, so the ETO can reduce the current to save anode material"],
  ...
  },
  {
    ...
    "a": "0.5 to 5 Volts DC",
    "opts": ["220 Volts AC", "24 Volts DC", "100 Volts DC", "0.5 to 5 Volts DC"],
  ...
  },
  {
    ...
    "opts": ["The system is working perfectly", "The circuit is broken (anode depleted, cable snapped, or anode painted over)", "The water is too salty", "A dead short circuit"],
  ...
  },
  {
    ...
    "opts": ["A short circuit (the anode is physically touching the steel sea chest casing)", "Normal operation", "The controller is turned off", "The anode is depleted"],
  ...
  },
  {
    ...
    "opts": ["The engine uses copper as fuel", "It prevents rust on the outside of the engine", "If bio-fouling blocks the central seawater coolers, the main engine will overheat and trip, causing a dead ship", "It keeps the oil warm"],
  ...
  },
  {
    ...
    "opts": ["Only on passenger ships", "No, this is physically impossible", "Yes, but they must be made of plastic", "Yes, in 'Strainer-mounted' systems where the sea chest is inaccessible, anodes are placed in the massive pipe strainers"],
  ...
  },
  {
    ...
    "opts": ["An Iron (Fe) anode is used instead of Aluminium to provide the anti-corrosive protective film", "The pipes must be painted inside", "The copper anode is doubled in size", "The MGPS is not needed"],
  ...
  },
  {
    ...
    "opts": ["Yes, it works exactly the same in air", "No, powering it without seawater causes severe overheating and destroys the controller/anodes", "Yes, but only the aluminium ones", "Yes, by turning it to max"],
  ...
  },
  {
    ...
    "opts": ["Replacing the copper rods weekly", "Painting the anodes monthly", "Diving into the sea chest weekly", "Log the voltage and current daily, ensuring the current matches the number of active seawater pumps"],
  ...
  },
  {
    ...
    "opts": ["The sea chest casing becomes the anode and dissolves, while the copper rod is protected", "It works twice as well", "The controller immediately explodes", "The water turns to ice"],
  ...
  },
  {
    ...
    "opts": ["10 grams", "1 to 2 kilograms", "500 kilograms", "30 to 100 kilograms"],
  ...
  },
  {
    ...
    "opts": ["They form solid rocks in the bilge", "They are discharged overboard and rapidly dilute to harmless, natural background levels in the open ocean", "They are recovered by a filter", "They coat the propeller"],
  ...
  },
  {
    ...
    "opts": ["The main fuel valve", "A pressure relief valve", "The valve that controls the ICCP", "It is the main sea inlet valve, usually located immediately after the sea chest where MGPS treated water first enters the ship"],
  ...
  },
  {
    ...
    "opts": ["It causes the river to catch fire", "It runs normally but at 440V", "Freshwater has high electrical resistance and few marine organisms, so MGPS is largely ineffective and unnecessary", "It is 100 times more effective"],
  ...
  },
  {
    ...
    "opts": ["If one anode depletes completely and breaks the circuit, all anodes stop working", "They last twice as long", "The voltage requirement drops", "It produces double the copper"],
  ...
  },
  {
    ...
    "opts": ["It draws a massive amount of power (often 1000kW to 3000kW), requiring the Power Management System (PMS) to prepare the grid before starting", "It operates on 24V DC", "It runs continuously during the entire voyage", "It weighs over 50 tons"],
  ...
  },
  {
    ...
    "opts": ["It stops the main engine to save power", "It reduces the thruster pitch to zero permanently", "It blocks the bridge start command, forces the PMS to start another generator, and only releases the interlock when sufficient spare MW capacity is online", "It trips the galley power"],
  ...
  },
  {
    ...
    "opts": ["Capacitor start", "Battery inverter start", "Direct On Line (DOL)", "Star-Delta starting, Soft Starters, or VFDs"],
  ...
  },
  {
    ...
    "opts": ["The motor speed is varied using a VFD", "It uses compressed air to push water", "The motor spins forward and backward rapidly", "The motor runs continuously at a constant speed, and thrust is varied by hydraulically twisting the propeller blades"],
  ...
  },
  {
    ...
    "opts": ["It only operates at 100% thrust or zero", "The motor runs at constant speed and a gearbox shifts gears", "The blades are fixed; thrust direction and magnitude are controlled by a massive Variable Frequency Drive (VFD) changing motor speed and direction", "Thrust is controlled by opening and closing tunnel doors"],
  ...
  },
  {
    ...
    "opts": ["24V DC", "High Voltage (e.g., 3.3kV, 6.6kV, or 11kV)", "220V AC", "440V AC"],
  ...
  },
  {
    ...
    "opts": ["To save fuel", "To prevent the ship from turning too fast", "To prevent the stator windings from melting due to the massive I\u00b2R heat generated during repeated starting transients", "To let the hydraulic oil cool down"],
  ...
  },
  {
    ...
    "opts": ["Inside the main engine room", "On the open deck", "In a dedicated Bow Thruster room located forward, separated from hazardous cargo zones", "Submerged underwater inside the tunnel"],
  ...
  },
  {
    ...
    "opts": ["The main propulsion engine", "The emergency generator", "The ventilation fans, lubricating oil pumps, and hydraulic power pack (for CPP)", "The cargo pumps"],
  ...
  },
  {
    ...
    "opts": ["The ship blacks out", "The room fills with explosive gas", "The thruster pitch locks at 100%", "The ambient temperature skyrockets, stator winding PT100 sensors detect the heat, and the motor trips on High Temperature"],
  ...
  },
  {
    ...
    "opts": ["To prevent the hydraulic oil from freezing", "To pre-heat the bearings for smoother starts", "To warm the bow thruster room for the crew", "To keep the windings warm when stopped, preventing condensation from forming and destroying the high-voltage insulation"],
  ...
  },
  {
    ...
    "opts": ["Using a 1000V or 5000V Megger (depending on motor rating), measuring phase-to-earth with the space heater off", "Using a 24V multimeter", "By shorting the phases together", "It is never meggered because it is underwater"],
  ...
  },
  {
    ...
    "opts": ["The ship must be completely stopped", "The main motor ACB is physically prevented from closing unless the propeller blades are proven to be at exactly 0% pitch (neutral)", "The steering gear must be locked straight", "The thruster automatically goes to 100% pitch"],
  ...
  },
  {
    ...
    "opts": ["To maintain a static head of lubricating oil higher than the external sea pressure, ensuring oil leaks OUT rather than seawater leaking IN if the shaft seal fails", "To provide hydraulic power for pitch", "To cool the stator windings", "To store fuel for the thruster"],
  ...
  },
  {
    ...
    "opts": ["To save electricity", "To prevent the ship from rolling over", "Because the main engine needs all the power", "Hydrodynamic forces wash the water past the tunnel opening, making the thruster physically useless and prone to cavitation damage at high speeds"],
  ...
  },
  {
    ...
    "opts": ["If the ship's generators hit a critical overload, the PMS instantly kills the Bow Thruster breaker to save the ship from a total blackout", "The thruster sheds its blades", "The thruster drops to 50% speed", "The thruster runs on emergency power"],
  ...
  },
  {
    ...
    "opts": ["Via pneumatic air lines", "Via a 4-20mA analog signal, or a digital fieldbus network (like CAN or Profibus), linking the bridge PLC to the thruster PLC", "Via massive high-voltage cables", "Via a steel mechanical cable"],
  ...
  },
  {
    ...
    "opts": ["The ship spins in circles", "The motor catches fire", "The PLC detects the signal loss (e.g., drops below 4mA) and fails-safe to Zero Pitch (0%), stopping thrust immediately", "The thruster jams at 100% pitch"],
  ...
  },
  {
    ...
    "opts": ["The Local panel must be switched to 'Remote', and the Bridge must acknowledge and 'Take Control' via a push button", "The captain yells down the radio", "The steering gear must be turned on", "The power must be cycled off and on"],
  ...
  },
  {
    ...
    "opts": ["It turns off the bridge lights", "It slowly ramps down the VFD", "It hard-wires directly to the Under-Voltage Trip (UVT) or Shunt Trip of the main High Voltage breaker, instantly killing power to the motor", "It drops the anchor"],
  ...
  },
  {
    ...
    "opts": ["Because Ex motors are illegal on tankers", "Because the voltage is too high", "Because they are underwater", "The bow thruster room is designed as a Safe Area with positive pressure ventilation; the equipment does not need to be Ex rated"],
  ...
  },
  {
    ...
    "opts": ["It starts the fire pumps", "It indicates the ship is too heavy", "It warns the bridge that motor current is nearing the thermal trip limit, prompting the operator to reduce pitch before a total shutdown occurs", "It means the voltage is too high"],
  ...
  },
  {
    ...
    "opts": ["Low seawater temperature", "Applying 100% pitch too rapidly, or a fouled propeller (rope/nets caught in the tunnel)", "High voltage from the MSB", "A broken space heater"],
  ...
  },
  {
    ...
    "opts": ["Lubricating them with heavy grease", "Checking brush wear, ensuring adequate spring tension, and cleaning carbon dust to prevent tracking shorts", "Painting them with epoxy", "Submerging them in fresh water"],
  ...
  },
  {
    ...
    "opts": ["A solid-state controller using Thyristors (SCRs) to gradually increase voltage to the motor during startup, limiting the massive inrush current", "A small pilot motor that spins the big one", "A rubber coupling on the shaft", "A software program on the bridge"],
  ...
  },
  {
    ...
    "opts": ["To increase the speed of the motor", "To provide 24V for the lights", "To step down/match voltage and block severe high-frequency harmonic distortion generated by the VFD from polluting the ship's main grid", "To convert AC to DC"],
  ...
  },
  {
    ...
    "opts": ["The thruster spins backward at max speed", "The blades flatten out", "Nothing directly; the Bow Thruster is not designed for longitudinal stopping, it only provides transverse (sideways) thrust", "It drops into the water like an anchor"],
  ...
  },
  {
    ...
    "opts": ["It confuses the ship's radar", "It forces the hydraulic pitch pumps to work continuously and violently, leading to hydraulic overheating and accelerated mechanical wear", "It saves electricity", "It keeps the electrical motor cool"],
  ...
  },
  {
    ...
    "opts": ["The hydraulic pitch mechanism has failed or the 4-20mA control signal is lost, leaving the blades stuck at 0% pitch", "The high-voltage breaker is open", "The main motor has burned out", "The water is too deep"],
  ...
  },
  {
    ...
    "opts": ["To stop fish from entering", "To physically block large debris, ice, or mooring ropes from being sucked into the massive spinning propeller blades", "To increase the speed of the water", "To act as ICCP anodes"],
