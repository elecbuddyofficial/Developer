window.loadQuizzes("T01_Alternator", [
  ...
  },
  {
    ...
    "opts": [
      ...
      "High megger voltage would damage AVR electronic components",
      "To isolate the winding",
      "AVR is not affected"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Limits output voltage",
      "Causes terminal voltage to droop with increasing reactive current for stable parallel operation",
      "Protects AVR from overcurrent",
  ...
  },
  {
    ...
    "opts": [
      ...
      "Terminal voltage of the alternator (and sometimes reactive current for droop)",
      "Load current only",
      "Exciter output"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Generator reduces output voltage automatically",
      "AVR reduces excitation slightly as reactive current increases, enabling stable sharing of kVAR between parallel generators",
      "Frequency droop for active power",
  ...
  },
  {
    ...
    "opts": [
      "Adjusts frequency",
      "Allows fine adjustment of output voltage setpoint",
      "Controls exciter speed",
      "Sets overcurrent threshold"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Stores energy for AVR",
      "Filters out harmonics and smooths the sensed voltage signal",
      "Powers AVR electronics",
      "Provides excitation"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Generator output voltage rises rapidly, overvoltage trips, equipment potentially damaged",
      "No change - another AVR takes over",
  ...
  },
  {
    ...
    "opts": [
      ...
      "Maximum excitation current allowed - prevents overheating of field winding",
      "Minimum field current for AVR",
      "Current limit for AVR electronics"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Controls the speed of the prime mover",
      "Automatically maintains alternator terminal voltage at set value by adjusting excitation current",
      "Protects the alternator from short circuit",
      "Monitors and logs alternator performance data"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent the AVR from showing false readings on the display",
      "Megger voltage (500\u20131000V DC) can permanently damage AVR semiconductors (thyristors, transistors, capacitors)",
      "To allow manual field control during testing",
      "AVR will reverse the polarity of megger readings"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Sets the output voltage setpoint (e.g., 440V) of the alternator",
      "Controls the frequency trim",
      "Adjusts the reactive load sharing between parallel generators"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Reduces output voltage gradually under heavy load for safety",
      "Sets the reactive power (kVAR) sharing between generators running in parallel",
      "Adjusts governor response speed",
      "Controls frequency droop for kW sharing"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AVR measures current and adjusts frequency",
      "AVR senses output voltage, compares to setpoint, and adjusts field current via thyristors to maintain constant voltage",
      "AVR controls governor speed to regulate voltage",
      "AVR switches loads on/off to maintain stable voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Voltage can vary by 2.5% per second during operation",
      "From zero load to full rated load, the terminal voltage must not deviate more than \u00b12.5% from the rated value",
      "2.5% variation is acceptable during paralleling only",
      "The AVR must respond within 2.5 seconds"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Controls reactive load sharing",
      "Controls the damping of the AVR response - prevents hunting/oscillation of terminal voltage",
      "Adjusts the frequency trim via governor link"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Both machines maintain equal voltage and share kVAR equally",
      "Higher-set AVR supplies all the reactive current (kVAR) - the other machine operates near unity PF or goes capacitive",
      "Frequency difference causes one machine to trip on reverse power",
      "Both machines trip on overcurrent simultaneously"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Droop = voltage reduction on no-load for safety",
      "Droop = intentional voltage reduction as kVAR load increases; ensures stable reactive load sharing between parallel machines",
      "Droop = speed reduction when overloaded",
      "Droop = frequency compensation during load shedding"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No consequences - modern AVRs are rated for megger voltage",
      "(1) Megger voltage damages AVR semiconductors; (2) AVR back-feeds current into winding giving false (high) IR reading",
      "(1) AVR blows its fuse; (2) Megger shows zero reading",
      "(1) Field winding burns out; (2) Stator winding gets double voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A variable transformer (variac)",
      "A mechanical rheostat",
      "Thyristors (SCRs) or power transistors - phase-angle fired or PWM controlled to vary DC output to exciter field",
      "A relay that switches fixed resistors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Increase the Droop trimmer",
      "Reduce the 'Voltage Adjust' trimmer - this lowers the AVR's reference setpoint, reducing field current and output voltage",
      "Adjust the governor speed trimmer downward",
      "Increase the Stability trimmer"
    ],
  ...
  },
  {
    ...
    "opts": [
      "When terminal voltage drops below 85% - same as UV relay",
      "When field current drops too low - prevents operation in capacitive (leading PF) region which can cause loss of synchronism",
      "When load exceeds 100% rated - reduces field current",
      "When temperature exceeds Class F limit"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "No brush/slip ring maintenance, no sparking, suitable for humid environments",
      "Lower weight"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Reduced output voltage and increased ripple/vibration",
      "No effect - other diodes compensate",
      "Overcurrent trip"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No voltage output",
      "Reduced voltage",
      "Heavy field current, high voltage output, possible AVR instability",
      "Earth fault alarm"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Provides AC supply that is rectified to give DC field current for main alternator",
      "Provides cooling",
      "Acts as governor"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Check diodes, IR test windings, clean, check connections, check air gap, check bearings, test safeties",
  ...
  },
  {
    ...
    "opts": [
      "Megger 500V",
      "Multimeter on diode test function, or ohmmeter - check forward voltage drop and no reverse conduction",
      "High voltage tester",
      "Insulation tester"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AVR, Exciter, Main Alternator",
      "PMG (Permanent Magnet Generator), Main Exciter, Main Alternator",
      "Transformer, Rectifier, Generator",
      "Governor, Exciter, Alternator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Directly excites the main alternator field",
      "Provides independent, stable AC power supply to the AVR",
      "Acts as backup generator during blackout",
      "Controls the speed of the prime mover"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses fewer windings than conventional alternators",
      "No brushes or slip rings are needed to transfer current from stationary to rotating parts",
      "The stator does not use carbon brush contacts",
      "It eliminates the need for a commutator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AVR \u2192 PMG \u2192 Rotating diodes \u2192 Main field",
      "Battery \u2192 Slip rings \u2192 Field winding \u2192 Output",
      "PMG \u2192 AVR \u2192 Exciter field stator \u2192 Exciter rotor AC \u2192 Rotating diodes \u2192 Main field rotor \u2192 Main stator output",
      "Governor \u2192 AVR \u2192 Stator \u2192 Rotor \u2192 Output"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inside the AVR control panel",
      "On the stator frame near ventilation openings",
      "Mounted on the rotor shaft between the exciter armature and main field winding",
      "In a separate rectifier cabinet next to the alternator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Complete loss of voltage - machine trips immediately",
      "Output voltage drops 15\u201320% with fluctuation; unbalanced excitation causes ripple",
      "No effect - remaining diodes compensate fully",
      "Frequency drops proportionally to voltage drop"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Minor voltage fluctuation, self-corrects within minutes",
      "Generator shuts down automatically via thermal protection",
      "AC component appears in field current causing severe voltage fluctuation and field overheating",
      "Output becomes DC instead of AC"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Remove the diode cover and inspect with a torch",
      "Using a multimeter on the AC output terminals",
      "Using a stroboscope - check for discoloured, pitted or cracked diodes; also check for unbalanced output voltage",
      "Inject test voltage through the slip rings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Brushless alternators produce higher voltage",
      "No brushes means no carbon dust, no brush inspection needed, no sparking - suitable for unattended operation",
      "Brushless alternators always have higher efficiency",
      "They can operate on lower frequency for UMS operation"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Main Alternator \u2192 Exciter \u2192 PMG",
      "Governor \u2192 PMG \u2192 Main Alternator",
      "PMG \u2192 Main Exciter \u2192 Main Alternator (all on same shaft, driven by prime mover)",
      "Exciter \u2192 PMG \u2192 Main Alternator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Carries the 3-phase AC output to the main switchboard",
      "Connects to the PMG to boost its output",
      "Carries DC field current from AVR - creates the magnetic field that the rotating exciter armature cuts",
      "Acts as the regulating winding for frequency control"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Diodes produce higher voltage than slip rings",
      "Rotating diodes eliminate physical sliding contact - no brushes, no sparking, no maintenance, suitable for UMS",
      "Slip rings cannot handle AC current",
      "Diodes regulate the field current automatically"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A fuse bank rated at 3\u00d7 diode current",
      "A varistor (MOV) for surge absorption",
      "Zener diode suppressor - clamps transient overvoltages that could destroy the rectifier diodes",
      "A thermistor to limit current during starting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The diode appears to spin faster than the others",
      "Discolouration (burn marks), pitting on the diode body, or cracks on the diode casing",
      "All diodes glow red under the stroboscope",
      "The diode appears to be at a different angle than neighbours"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Complete loss of excitation - machine de-excites immediately",
      "Machine runs normally - remaining 5 diodes compensate",
      "One phase of exciter AC is not rectified \u2192 ripple in field current \u2192 pulsating terminal voltage",
      "Frequency drops by 1/6"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Disconnect the PMG and see if voltage changes",
      "Use stroboscope to freeze rotor visually (inspect diodes); measure output voltage imbalance; check for AC ripple on field supply",
      "Open the terminal box and probe with voltmeter",
      "Increase load to 100% and measure current balance"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Battery \u2192 Field winding \u2192 Stator \u2192 Output",
      "PMG AC \u2192 AVR rectifier \u2192 DC to exciter stator coil \u2192 exciter rotor cuts stator field \u2192 3-phase AC in exciter rotor \u2192 rotating diodes \u2192 DC field in main rotor \u2192 main rotor cuts stator conductors \u2192 3-phase AC output",
      "Shore supply \u2192 Transformer \u2192 Field \u2192 Output",
      "AVR \u2192 Rotating diodes \u2192 PMG \u2192 Main stator \u2192 Output"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Voltage drop under fault",
      "Speed reduction at no load",
      "Deliberate slight speed reduction with increasing load for stable load sharing",
  ...
  },
  {
    ...
    "opts": [
      "AVR of one is faulty",
      "Governor settings differ - one governor allows more fuel than the other",
  ...
  },
  {
    ...
    "opts": [
      "Governor fault",
      "AVR settings differ - one has higher excitation voltage",
      "Different frequency",
      "Earth fault"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Maximum KW it can produce",
      "Maximum apparent power it can deliver continuously without overheating",
      "Maximum current only",
  ...
  },
  {
    ...
    "opts": [
      ...
      "Dampen oscillations during load changes and assist starting",
      "Provide excitation",
      "Cool the rotor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "220V, 50Hz",
      "440V, 60Hz (common) or 440V/380V, 50Hz/60Hz depending on flag",
      "11kV, 50Hz",
      "110V, 60Hz"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Starts generator at fixed time intervals",
      "Automatically starts standby generator when connected load exceeds a set percentage of running capacity",
      "Trips generator on overload",
      "Adjusts AVR automatically"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Motor that synchronises with AVR",
      "AC motor that runs exactly at synchronous speed (NS = 120f/P), with no slip",
  ...
  },
  {
    ...
    "opts": [
      "AC voltage control",
      "Variable speed DC drive for applications like cranes, winches, and steering gear",
  ...
  },
  {
    ...
    "opts": [
      "Increase speed only",
      "Check residual magnetism, test AVR, check diodes, check exciter winding, check field connections",
  ...
  },
  {
    ...
    "opts": [
      "Connecting metal earthing strips",
      "Supplying ship's electrical power from shore supply while in port to reduce emissions",
      "Testing cold machinery",
  ...
  },
  {
    ...
    "opts": [
      "Increases kW output",
      "Increases reactive power (kVAR) output and raises PF of that machine",
      "Increases frequency",
      "Reduces voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Determines kVA rating",
      "Determines insulation class"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AVR control range",
      "Percentage change in terminal voltage from no-load to full load: (VNL\u2212VFL)/VFL \u00d7 100",
      "Voltage drop across winding",
  ...
  },
  {
    ...
    "opts": [
      "Generator on shaft of motor",
      "Generator driven by main propulsion shaft, providing power at variable frequency corrected by frequency converter",
      "Emergency generator mounted on propeller shaft",
      "Auxiliary generator only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Manual start system",
      "System that automatically starts and connects standby generator when main supply fails",
      "AVR backup system",
  ...
  },
  {
    ...
    "opts": [
      "Other generator compensates",
      "Overcurrent, reverse power, frequency relay may trip it; mechanical overspeed trip as last resort",
      "AVR controls this",
      "Nothing - the load sharing is stable"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Step up voltage for measurement",
      "Step down high currents to safe levels for metering and protection relays",
      "Provide earth fault protection directly",
  ...
  },
  {
    ...
    "opts": [
      "Reverse power relay",
      "Short circuit/overcurrent instantaneous element of ACB",
      "Undervoltage relay",
      "Earth fault relay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Lower cost",
      "Faster response time for AVR control and no rotating exciter maintenance",
  ...
  },
  {
    ...
    "opts": [
      "NS = f \u00d7 P",
      "NS = 120 \u00d7 f / P (RPM), where f=frequency in Hz, P=number of poles",
      "NS = P \u00d7 f / 60",
      "NS = 60 \u00d7 f / P"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Earth fault relay",
      "Reactive droop setting in AVR limits circulating reactive current",
      "Overcurrent relay",
      "Reverse power relay"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Transfer load to other generator(s), reduce kW to minimum, open breaker, shut down prime mover",
      "Stop engine first",
      "Trip overcurrent relay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Both mean the same",
      "Cold: off and cold; Hot: running and warm, ready to take load faster",
      "Cold: on bus at low power; Hot: on bus at full power",
      "Only cold spare used in marine practice"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only monitors power consumption",
      "Automatically manages generator start/stop, load sharing, fault response and load shedding",
      "Replaces the AVR",
      "Controls shore power only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Both are the same",
      "Salient: protruding poles (low speed, multi-pole), Cylindrical: smooth rotor (high speed, 2-4 poles)",
      "Salient is for AC, cylindrical for DC",
      "Salient used for HV, cylindrical for LV"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Check connections, clean air filters, check bearing temperatures, record insulation values",
      "Full overhaul",
      "Check only the ACB"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Voltage and phase sequence only",
      "Voltage, frequency, phase sequence and phase angle must match",
      "Only phase sequence"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Slight voltage dip only",
      "Gentle synchronisation",
      "Violent mechanical shock, possible winding damage, catastrophic failure",
      "Automatic protection trips instantly with no damage"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Indicates phase difference and relative speed between incoming and running generator",
  ...
  },
  {
    ...
    "opts": [
      "Only voltage check",
      "Voltage match, frequency match, synchroscope at 12 slowly clockwise, phase sequence verified",
      "Only frequency check",
      "Only phase sequence check"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Synchronising two running generators",
      "Closing generator onto a dead (de-energised) busbar - no synchronisation needed",
      "Backup synchronisation method",
      "Synchronising at zero speed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only the voltage difference between two generators",
      "The total load on the busbar",
      "Speed difference and phase angle difference between incoming generator and the running busbar",
      "The power factor of the incoming generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An electronic digital phase meter",
      "A galvanometer measuring voltage difference",
      "Small induction motor: stator connected to busbar, rotor connected to incoming generator, pointer mounted on rotor shaft",
      "A current transformer connected across two generators"
    ],
  ...
  },
  {
    ...
    "opts": [
      "When pointer is at 6 o'clock for safety margin",
      "When pointer stops moving completely",
      "When pointer is at 12 o'clock (in phase) and approaching from slightly before 12 (CW - just fast)",
      "When pointer is at 3 o'clock position"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The generator safely comes up to speed on the busbar",
      "A minor overcurrent trip occurs",
      "CATASTROPHIC - massive circulating current, severe mechanical shock to coupling, possible alternator winding burnout",
      "The reverse power relay trips the circuit safely"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Generator immediately synchronises perfectly",
      "On closing ACB, incoming generator takes a heavy sudden load - high current surge, may trip on overcurrent",
      "Reverse power relay trips the incoming machine",
      "Frequency of the busbar increases to match"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Nothing - generator continues at lower speed",
      "The governor automatically speeds up",
      "On closing ACB, the busbar motors the incoming generator - reverse power relay trips it",
      "The busbar frequency drops to match"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Estimate by ear - match engine speed to busbar frequency",
      "Use voltmeter across ACB contacts; close when voltage difference is minimum",
      "Dark lamp method: connect 3 lamps between corresponding phases; close ACB when ALL THREE lamps are simultaneously dark",
      "Wait for superintendent to arrive with portable synchroscope"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Check frequency only - phase sequence doesn't matter for paralleling",
      "Verify both generators have the same phase rotation sequence (R-Y-B) using a phase sequence meter",
      "Measure the voltage at all three phases",
      "Check the insulation resistance of both machines"
    ],
  ...
  },
  {
    ...
    "opts": [
      "(1) Same kVA rating, (2) Same voltage, (3) Same brand, (4) Same fuel type",
      "(1) Same voltage, (2) Same frequency, (3) Same phase sequence, (4) Phase angle difference = 0\u00b0 (in phase)",
      "(1) Same voltage, (2) Same frequency, (3) Different phase to cancel",
      "(1) Same current, (2) Same voltage, (3) Same fuel consumption"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Incoming generator is faster - reduce governor speed",
      "Incoming generator is SLOWER than busbar - increase governor setting to speed it up",
      "Phase sequence is wrong - swap two phases",
      "Voltage is too low - increase AVR setting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It doesn't matter - close at any position",
      "ACB closing takes ~80-100ms - closing just before 12 o'clock accounts for this delay so actual closing occurs at or near 12",
      "The 11 o'clock position is in-phase for 50 Hz systems",
      "The synchroscope is 30 seconds behind actual phase"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Connect one lamp across the ACB - close when it dims",
      "Three lamps connected between corresponding phases of incoming and busbar - lamps are dark when in phase, close ACB when ALL three are simultaneously dark",
      "Use flashlight to illuminate the pointer - close at 12 o'clock",
      "Three lamps connected in star - close when all equally bright"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Close when all three lamps are dark",
      "Close when all three lamps are EQUALLY BRIGHT",
      "Close when two are bright and one is dark",
      "Close when lamps stop flickering"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Close ACB immediately - it's at 12 o'clock position",
      "DO NOT close ACB - reduce governor speed until pointer barely moves CW before closing",
      "Increase AVR voltage to match busbar",
      "Close ACB and let reverse power relay trip it if wrong"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Check the nameplate - phase sequence is always R-Y-B",
      "Use a phase sequence meter (Ferraris disc type or electronic) - verify R-Y-B rotation matches existing busbar",
      "Measure voltage between phases - if equal, sequence is correct",
      "Connect the synchroscope - it will indicate wrong sequence"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AVR was not set correctly before paralleling",
      "ACB was closed with too large a speed/phase difference - incoming machine was too fast or at wrong phase angle",
      "Load was too high on the busbar for paralleling",
      "Governor was in isochronous mode - should be droop mode"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Using a micrometer",
      "Using feeler gauges at multiple points around the circumference",
      "Using a dial gauge",
  ...
  },
  {
    ...
    "opts": [
      "By adjusting AVR",
      "By shimming or adjusting bearing pedestals/end shields - requires major dismantling",
      "By adding more stator copper",
      "Not adjustable on marine alternators"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The space between stator teeth for ventilation",
      "The clearance between the rotor pole face and the inner surface of the stator bore",
      "The gap in the rectifier circuit for voltage regulation",
      "The distance between two phase windings in the stator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Nothing - air gap unevenness is normal and acceptable",
      "Voltage output becomes unbalanced between phases",
      "Unbalanced magnetic pull causes rotor vibration, bearing wear, and in severe cases rotor-stator contact",
      "Only affects power factor, no mechanical effects"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Air gap must be exactly equal all around - 0% variation allowed",
      "Air gap should be uniform within \u00b110% of the mean value around the circumference",
      "Up to \u00b125% variation is acceptable",
      "Air gap variation is not critical - only total clearance matters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "1 point per pole is sufficient",
      "4 measurement points per pole (top, bottom, left, right) - or at 90\u00b0 intervals around the full circumference",
      "16 measurements total regardless of pole count",
      "Only one measurement needed at the largest gap position"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Stator winding insulation has expanded",
      "Rotor is eccentric - likely a worn bearing causing the rotor to sag toward the smaller gap side",
      "Air gap variation is normal and requires no action",
      "Rotor has been machined incorrectly - scrap and replace"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Trips the generator breaker if the machine starts motoring (taking power from busbar)",
      "Prevents overfrequency",
      "Trips on earth fault"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Trips all loads simultaneously",
      "Sequential shedding of non-essential loads when generator is overloaded, to maintain essential services",
      "Trips the generator itself",
      "Starts standby generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only overcurrent and earth fault",
      "Reverse power, overspeed, overcurrent, earth fault, low oil pressure, high temperature",
      "Only mechanical safeties",
      "Only electrical safeties"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "One or more phases of stator winding making electrical contact with the earthed frame",
      "Short between two phases",
      "Broken field connection"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Compares voltage of two generators before paralleling",
      "Compares current entering and leaving the winding - any difference indicates an internal fault",
      "Detects frequency differences during synchronisation",
      "Monitors winding temperature balance"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Trips at 50% of rated kW",
      "Trips at any detectable reverse current",
      "Trips at 5\u201310% of rated kW in reverse direction",
      "Trips at 100% reverse power - only for severe motoring"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Instantly disconnects the most important loads",
      "Automatically sheds non-essential loads in stages when generator is persistently overloaded - before tripping the generator",
      "Trips the generator if voltage is too high",
      "Prevents any additional loads from connecting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An oil reservoir for generator bearing lubrication",
      "A pneumatic/hydraulic time-delay device - introduces time delay before shedding, allowing transient overloads to pass without unnecessary tripping",
      "A capacitor that stores energy for instantaneous relay operation",
      "A mechanical brake on the generator shaft"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Alarm 60\u00b0C, Trip 70\u00b0C",
      "Alarm 80\u00b0C, Trip 150\u00b0C",
      "Alarm at approximately 80\u00b0C, Trip at approximately 95\u00b0C",
      "Alarm 100\u00b0C, Trip 120\u00b0C"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Monitors ambient temperature in the engine room",
      "Embedded in stator winding - trips if winding temperature exceeds Class F insulation limit (155\u00b0C)",
      "Controls AVR output based on temperature",
      "Measures coolant temperature of the prime mover"
    ],
  ...
  },
  {
    ...
    "opts": [
      "100% of stator is protected in all modern ships",
      "Only the terminal box connections are protected",
      "Detects stator winding earth faults - typically 95% stator earth fault protection (5% nearest neutral is unprotected)",
      "Earth fault protection is optional on marine alternators"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Protects against reverse power - trips at 50% over",
      "Protects insulation from damage - trips at approximately 110% of rated voltage",
      "Only operates during synchronisation - no trip setting",
      "Trips at 125% for continuous protection"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Overload the generator to 110% and observe relay",
      "Short the generator terminals briefly and measure response time",
      "Secondary injection test: rack ACB to TEST position, inject calculated current into CT secondary terminals, verify relay trips at set value",
      "Simulate fault using an insulation tester connected to phase terminals"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only OCR and earth fault are mandatory",
      "OCR, Over-voltage, Under-voltage, Differential, Reverse power, Earth fault, Bearing temp (PT100), Winding temp (thermistor), Preferential trip",
      "Only voltage protection is fitted - current is monitored by AVR",
      "OCR, reverse power, and overspeed are the three mandatory ones"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It has a mechanical response spring that is the fastest actuator",
      "It operates instantaneously on any current difference between ends of the winding - does not need to wait for sustained overcurrent",
      "It is connected directly to the main busbar for fastest detection",
      "It monitors all three phases simultaneously while OCR monitors only one"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Preferential trip operates after 8 seconds and sheds loads",
      "No load shedding - motor starting overload clears within 10-second dashpot delay and preferential trip does not operate",
      "Generator trips immediately on overcurrent",
      "AVR reduces voltage to protect the generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "No - 380V is too close to threshold for relay to operate",
      "Yes - 380V is 86.4% of 440V which is close to 85% threshold; sustained drop to this level will operate the relay",
      "UV relay only operates below 50% rated voltage",
      "UV relay is disabled during fault conditions"
    ],
  ...
  },
  {
    ...
    "opts": [
      "PT100 = Pressure Temperature sensor rated for 100 bar",
      "PT100 = Platinum Resistance Thermometer with 100\u03a9 at 0\u00b0C - resistance increases linearly with temperature; connected to monitoring panel",
      "PT100 is a thermocouple that generates voltage proportional to temperature",
      "PT100 is an optical sensor that detects bearing colour change"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The remaining 5% is protected by the overcurrent relay",
      "The 5% of winding nearest the star-point (neutral) has insufficient voltage to earth to drive the earth fault relay",
      "The neutral end is earthed anyway so earth faults there are harmless",
      "The CTs cannot be installed at the star-point end due to space"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Generator automatically disconnects via overcurrent relay",
      "If prime mover fails and relay doesn't trip, generator motors (runs as induction motor), drawing heavy current from busbar, damaging engine/coupling",
      "No effect - other protections cover this",
      "Generator overspeeds if relay fails open"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Testing insulation with high voltage",
      "Applying a momentary DC voltage to restore residual magnetism in the field core",
      "Cleaning the field windings",
      "Testing AVR response"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The permanent magnetic field used in synchronous operation",
      "Small amount of magnetic flux retained in rotor core material even when field current is zero",
      "Static charge on stator windings after shutdown",
      "The minimum field current required to start voltage buildup"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only the governor has failed",
      "Residual magnetism lost, AVR fault, rotating diode failure, PMG fault, open circuit field winding, or voltmeter fault",
      "Always means the stator winding is burnt",
      "Caused by wrong phase rotation only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Apply 415V AC from shore supply to the stator terminals",
      "Bring to rated speed; connect 12\u201324V battery briefly (2\u20133 sec) to exciter field with correct polarity; check voltage builds",
      "Use megger at 500V to restore magnetism in rotor core",
      "Short circuit the AVR output terminals for 5 seconds"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Overvoltage in the stator winding",
      "Wrong polarity destroys residual magnetism; battery sparking can ignite flammable gases",
      "AVR permanent damage from battery voltage",
      "Voltmeter burning out from sudden voltage surge"
    ],
  ...
  },
  {
    ...
    "opts": [
      "If ACB is open, machine is always dead - no further check needed",
      "Only use it if it's been switched off for over 30 minutes",
      "Measure terminal voltage with an approved voltmeter before working - do not assume dead just because ACB is open",
      "Remove all three phases from the busbar simultaneously"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Excessive lubrication of bearings",
      "Large external discharge (short circuit, capacitor discharge), prolonged storage, degaussing nearby, or reverse-polarity field connection",
      "Running at low speed for long periods",
      "AVR malfunction during load shedding"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Governor has failed - speed is too low",
      "Very low residual magnetism - insufficient to bootstrap voltage buildup; flashing required",
      "Main busbar has shorted",
      "All three phases are open circuit"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Apply higher voltage battery (48V)",
      "Check polarity was correct; if polarity was wrong, re-flash with OPPOSITE polarity; if polarity correct, investigate AVR and field circuit",
      "Repeat flashing 10 times - residual builds gradually",
      "Call superintendent - machine is beyond repair"
    ],
  ...
  },
  {
    ...
    "opts": [
      "6V DC - lower risk of damage",
      "240V DC from shore supply",
      "12V or 24V DC battery - brief connection of 2-3 seconds only",
      "110V DC from emergency battery bank"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Voltage jumps instantly to exactly rated value",
      "Voltage builds progressively from low value to near-rated value as the bootstrap cycle takes effect",
      "Voltage remains at battery voltage level",
      "Voltage surges to 120% then settles"
    ],
  ...
  },
  {
    ...
    "opts": [
      "60 seconds",
      "45 seconds for cargo ships, 30 seconds for passenger ships",
      "15 seconds",
      "10 seconds"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Any three phase supply",
      "SOLAS II-1/41: maintain all services needed for normal operation and safety, survive any single failure",
      "Supply lights and navigation only",
      "Not specified in SOLAS"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Within \u00b12.5% of rated voltage from no-load to full-load",
      "Within \u00b110% during any transient condition"
    ],
  ...
  },
  {
    ...
    "opts": [
      "\u00b12.5% - same as steady state",
      "\u00b15% maximum",
      "\u00b110% of rated voltage, recovering within required time",
      "\u00b115% is acceptable for heavy loads"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It would be too cold at tank top level",
      "SOLAS specifically prohibits bottom placement for weight distribution",
      "Flooding risk, excessive vibration, poor maintenance access, inadequate cooling - all prevented by elevated placement",
      "The prime mover would overheat if placed at tank top"
    ],
  ...
  },
  {
    ...
    "opts": [
      "In a waterproof enclosure at tank top level",
      "Adjacent to the main switchboard in the ECR",
      "Above the bulkhead deck, OUTSIDE the main machinery space, in a separate compartment",
      "Any location that can be remotely started from bridge"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Main source of electrical power - requirements for generating capacity, voltage regulation, and protection against flooding",
      "Life-saving appliance electrical requirements",
      "Emergency battery requirements only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Below the bulkhead deck, adjacent to ECR",
      "Above the bulkhead deck, in a separate compartment, entirely outside the main machinery space",
      "Anywhere above the waterline",
      "In the forward machinery space only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "6 hours for all ships",
      "36 hours for passenger ships; 18 hours for cargo ships",
      "24 hours for all ships",
      "Until rescued - no time limit specified"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Exactly 3 generators - one active, one standby, one emergency",
      "At least 2 generators required; loss of any single generator must not leave essential services without power",
      "Only 1 main generator needed if emergency generator is installed",
      "4 generators minimum for ships over 10,000 GRT"
    ],
  ...
  },
  {
    ...
    "opts": [
      "At tank top level is acceptable if flood detection is fitted",
      "Above the bulkhead deck level - in practice, typically on the second or third platform above tank top",
      "Any height above bilge level",
      "Must be above the waterline mark only"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Zero ohms",
      "Greater than 1 M\u03a9 (and ideally much higher, >100 M\u03a9 for new winding)",
      "Exactly 1 \u03a9",
      "500 \u03a9"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Peak current test",
      "Ratio of 10-minute to 1-minute megger reading; PI \u2265 2 indicates good insulation",
      "Power factor test",
      "Pressure/insulation test"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Minimum 10 k\u03a9 is acceptable for marine service",
      "Minimum 100 M\u03a9 for running machines",
      "Minimum 1 M\u03a9; Polarisation Index (PI) > 2 indicates good insulation",
      "Any reading above zero is acceptable"
    ],
  ...
  },
  {
    ...
    "a": "500V DC megger",
    "opts": [
      "250V DC - to avoid damaging the insulation",
      "1000V DC - for thorough testing",
      "5000V DC - to match starting voltage",
      "500V DC megger"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Re-connect to AVR immediately to restore normal operation",
      "Discharge the winding by connecting it to earth via a resistor - capacitive charge can cause electric shock",
      "Measure AC voltage at terminals to confirm discharge",
      "No action needed - megger automatically discharges"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Just run at full load for 30 minutes",
      "Only check voltage output",
      "Visual check, IR test, phase rotation check, no-load voltage check, then gradual load test",
      "Send it back for further testing - never trust shore rewind"
    ],
  ...
  },
  {
    ...
    "opts": [
      "PI measures the alternator's power factor improvement",
      "PI = maximum current \u00f7 rated current; PI > 2 means overload capacity",
      "PI = IR at 10 minutes \u00f7 IR at 1 minute; PI > 2 = good dry insulation in good condition",
      "PI is the ratio of bearing temperature to winding temperature"
    ],
  ...
  },
  {
    ...
    "opts": [
      "PI measures the peak insulation resistance during 10 minutes",
      "PI = IR at 10 min / IR at 1 min - ratio shows whether resistance is rising (good dry insulation) or flat/falling (wet/contaminated)",
      "PI is the number of megohms per kilovolt of test voltage",
      "PI measures leakage current at rated operating voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "0.8 M\u03a9 is acceptable for wet conditions - run at 50% load",
      "Do NOT energise - 0.8 M\u03a9 is below 1 M\u03a9 minimum; investigate cause (moisture, contamination), dry out winding, retest",
      "Megger again with 1000V to get a more accurate reading",
      "Apply varnish to winding and retest immediately"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Remove megger leads - charge dissipates naturally in 10 seconds",
      "Connect a high-resistance discharge resistor from each terminal to earth first, then short to earth - never short directly",
      "Short all terminals together - no earth needed",
      "Leave for 1 hour - capacitive charge self-discharges"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only check voltage - other parameters are monitored automatically",
      "Voltage, current, frequency, power factor, bearing temperature, winding temperature, vibration, abnormal noise, AVR stability",
      "Perform IR test every watch",
      "Remove slip ring cover and inspect during running"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Megger test (IR test) all three phases to earth and between phases before energising",
      "Check fuel system and prime mover",
      "Connect to shore power and test with full load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Cool the bearings during heavy load operation",
      "Remove carbon brush dust, accumulated dirt, and moisture from air passages and winding surfaces to prevent tracking and overheating",
      "Test the ventilation fan efficiency",
      "The compressed air re-magnetises the rotor during service"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Reduces copper resistance for better conductivity",
      "Impregnates and consolidates the winding - improves insulation, thermal conductivity, moisture resistance, and mechanical strength",
      "Class F varnish is mandatory per MARPOL regulations",
      "Prevents rust on the copper conductors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Disconnect governor and let engine run freely",
      "Gradually increase speed by adjusting governor until overspeed trip activates (typically 115% of rated speed)",
      "Apply load suddenly then remove",
      "Test only in dry dock"
    ],
  ...
  },
  {
    ...
    "opts": [
      "90% of rated speed",
      "100% rated speed - at setpoint",
      "110\u2013115% of rated speed",
      "150% - only for extreme emergency"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only check by monitoring the trip in emergency - never test deliberately",
      "Apply full rated load then suddenly remove it",
      "Run off-load with ACB open, gradually increase governor speed until trip activates; note trip RPM and compare to specification",
      "Simulate by injecting a signal into the electronic governor"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Governor trip = normal speed control; Mechanical overspeed trip = emergency backup that activates at 110-115% speed to prevent destruction",
      "Mechanical trip = faster response; governor = backup",
      "Governor only controls fuel - no trip function"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To allow the machine to accelerate freely without generator load",
      "To prevent frequency surge from feeding into the main busbar and damaging other equipment and motors",
      "ACB open allows higher test speed to be reached",
      "Required to reset the mechanical trip mechanism first"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Oscillation of load between generators due to poor governor response",
      "Overloading one generator",
      "Voltage fluctuation"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Provides cross-current compensation - generators with higher load feed signal to others to increase their load",
      "Only monitors, does not control",
      "Controls both kW and kVAR automatically without droop"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Power lost as heat",
      "Non-working power stored/released by reactive elements (inductors/capacitors); produced by increasing excitation",
  ...
  },
  {
    ...
    "opts": [
      "AVR voltage setting",
      "Governor droop settings - governor controls prime mover speed and thus kW output",
  ...
  },
  {
    ...
    "opts": [
      ...
      "Load shedding relay",
      "AVR droop settings - AVR controls excitation and thus reactive current sharing",
      "Synchroscope position"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AVR settings are different",
      "Generator rotor bearing friction is different",
      "Governor droop settings differ between the two machines - one governor is more responsive than the other",
      "Prime mover fuel viscosity is different"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Governor droop on G1 needs adjustment",
      "AVR droop on G1 needs to be increased - G1 is supplying too much reactive (kVAR) current",
      "G1 has incorrect phase sequence",
      "G2 has a short circuit in field winding"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The ACB automatically reduces current to the loaded machine",
      "Governor droop: as load increases, engine speed droops \u2192 governor detects droop and increases fuel \u2192 both governors respond to the common frequency change",
      "AVR automatically reduces excitation on loaded machine",
      "Load is balanced by the busbar protection relay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Directly open ACB - remaining generator takes load automatically",
      "Gradually reduce outgoing machine's governor (kW \u2192 0) then reduce AVR (kVAR \u2192 0 or small negative) before opening ACB",
      "Increase load on remaining generator first, then trip outgoing",
      "Use preferential trip to shed the outgoing generator's load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Physical vibration of generator from unbalanced rotor",
      "Oscillation of load between generators - caused by incorrect governor droop settings or governor instability",
      "Hunting is normal during frequency transients",
      "High-frequency noise from AVR thyristors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Isochronous means governor controls frequency only - suitable for parallel operation",
      "Isochronous = maintains exactly constant speed regardless of load; two isochronous governors fight each other \u2192 no stable load sharing",
      "Isochronous mode is required for parallel operation",
      "Isochronous governors automatically equalise kW sharing"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Slip ring and brush system",
      "Static exciter only",
      "Brushless (static exciter with rotating rectifiers)",
  ...
  },
  {
    ...
    "opts": [
      "The alternator supplies its own field via rectifier",
      "External DC source supplied via slip rings",
      "The permanent magnets on the rotor",
      "A battery bank connected permanently"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AC excited, DC excited, Static excited",
      "Separately excited, Self-excited (shunt), Brushless (PMG + exciter + rotating rectifiers)",
      "Battery excited, Shore excited, Self-excited",
      "Permanent magnet, Thyristor controlled, Transformer excited"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Cannot produce stable voltage",
      "Requires slip rings and brushes for field supply - maintenance-intensive, prone to sparking",
      "Output frequency varies with load",
      "Cannot be used on ships above 5000 GRT"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Voltage stays at 90% of rated",
      "Voltage collapses completely - no external source to restore it without residual magnetism or flashing",
      "Overcurrent relay trips",
  ...
  },
  {
    ...
    "opts": [
      "440V AC - matches main busbar",
      "100\u2013200V AC, used solely to power the AVR - completely independent of main alternator output",
      "12V DC - directly feeds the field winding",
      "48V DC - powers the AVR and ship's DC systems"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes - residual magnetism in main rotor will still build voltage",
      "No - if PMG loses all magnetism, AVR has no supply and cannot excite the main field; machine won't build voltage",
      "Yes - the self-excited bypass mode activates automatically",
      "No - but the battery charger provides backup excitation"
    ],
  ...
  },
  {
    ...
    "opts": [
      "All lights off",
      "Complete loss of electrical power to the main switchboard",
      "Emergency generator fault",
      "Shore power disconnection"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Start all generators simultaneously",
      "Emergency gen starts \u2192 main engine cooling \u2192 start main gen \u2192 synchronise \u2192 restore loads in sequence",
      "Restore shore power first",
      "Wait for engineer's order"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Test the fire detection system under power failure",
      "Verify emergency generator auto-starts and supplies essential loads within 45 seconds",
      "Check battery capacity for emergency lighting only",
      "Test the preferential trip relay sequence"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Simply trip the main breaker and observe",
      "Brief staff, inform bridge, verify emergency DG ready, trip main ACBs, time DG start, verify essential loads, restore main power, reconnect in sequence",
      "Only the chief engineer performs blackout test - ETO observes",
      "Run emergency generator for 10 minutes without tripping main power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Restore all loads simultaneously to speed up recovery",
      "Largest loads first to test generator capacity",
      "Navigation/steering first, then essential safety services, then machinery systems, lastly non-essential services",
      "Non-essential loads first - leave critical loads on emergency generator longer"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Only emergency lighting - other loads connect via UPS",
      "Emergency lighting, navigation lights, steering gear (for 30 min), fire pump, VHF/GMDSS, internal communications, alarms",
      "All loads that were connected before blackout",
      "Only bridge equipment and navigation lights"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes - 52 seconds is within the 60-second allowance",
      "NO - SOLAS requires 45 seconds maximum; 52 seconds is non-compliant; deficiency must be investigated and corrected before next survey",
      "Only the Class surveyor can decide acceptability",
      "52 seconds is acceptable for ships over 10 years old"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Bridge officer must operate the emergency generator",
      "Bridge must be in a safe navigational situation - blackout test must not be conducted during confined waters, high traffic, or bad weather",
      "The engine telegraph needs to be set to 'stop'",
      "Bridge controls the test timing via alarm panel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Torque reduces proportionally to voltage: (280/440) = 63%",
      "Torque increases as motor tries harder",
      "Torque reduces proportional to voltage squared: (280/440)\u00b2 \u2248 0.40 - only ~40% of rated torque",
      "No change in torque - only speed changes"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Low excitation: AVR setpoint too low, AVR fault, PMG output low, partial field winding fault, rotating diode failure",
  ...
  },
  {
    ...
    "opts": [
      "Torque increases to compensate for lower voltage",
      "Torque \u221d V\u00b2: reduces to (380/440)\u00b2 = 0.745 \u2192 74.5% rated torque; current rises to compensate, risking thermal damage",
      "No change - motor adjusts automatically",
      "Speed drops 13.6% with no change in current"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Governor is hunting - causing current oscillation",
      "Unbalanced load between phases, or B phase stator winding partial fault, or B phase CT fault (if readings are from meters)",
      "Normal variation - alternators always have some current imbalance",
      "Reverse power on B phase due to incorrect synchronisation"
    ],
  ...
  },
  {
    ...
    "opts": [
      "External short circuit on the busbar",
      "Internal fault in the stator winding - turn-to-turn short, phase-to-earth, or phase-to-phase inside the machine",
      "Reverse power - prime mover has stalled",
      "Earth fault on connected equipment"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Governor fails and machine over-speeds",
      "Field current drops to zero - machine de-excites, loses synchronism, operates as induction generator absorbing reactive power",
      "Stator winding open circuits in all three phases",
      "Reverse power relay trips due to high load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Normal variation - phase-to-neutral voltages can differ",
      "B-phase has a partial winding fault - lower B-phase stator winding",
      "Earth fault on B phase equipment",
      "Governor hunting causing frequency variation on B phase"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Excessive lubrication causing surface erosion",
      "High current sparking from worn, misaligned or incorrect grade brushes; contamination on ring surface",
      "Normal wear - pitting is expected and acceptable",
      "Overvoltage from AVR malfunction"
    ],
  ...
  },
  {
    ...
    "opts": [
      "As tight as possible to ensure good contact",
      "10\u201350 g/cm\u00b2",
      "Typically 150\u2013200 g/cm\u00b2",
      "500\u2013800 g/cm\u00b2 for high current applications"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Machine must always be stopped before any slip ring work",
      "Remove slip ring cover and polish by hand",
      "Use fine emery cloth held in an insulated holder to lightly dress the surface - reduce load to minimum first",
      "Apply conductive paste to fill in the pits"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Brush sparking only in UMS mode",
      "Frequent brush replacement needed, excessive brush dust, sparking at slip ring, high brush temperature",
      "Brush wears faster in tropical climates - normal",
      "Rapid wear indicates wrong field current - reduce excitation"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Press with thumb - should feel firm but not hard",
      "Use a spring balance gauge - hook under the brush holder spring, read force while brush is lifted slightly off ring",
      "Measure brush current with clamp meter - infer pressure",
      "Tap brush holder - if it bounces, pressure is too low"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Megger test the slip ring to earth",
      "Check contact surface is smooth and bright; observe sparking is reduced/eliminated; monitor brush temperature for 30 min",
      "Take the machine off-load and measure field resistance",
      "Install new brushes - old brushes become contaminated from pitting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Normal - glazing is the desired patina for good contact",
      "A hard, shiny, poorly-conducting oxide/graphite film on the slip ring surface - caused by very low current density or wrong brush grade",
      "Glazing is a sign of good lubrication",
      "Glazing occurs from excessive current density"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are the same system with different starting modes",
      "Emergency battery provides instant power for <30 min; emergency generator provides sustained power for 18/36 hours after up to 45s delay",
      "Emergency generator only supplies batteries - batteries supply loads",
      "Batteries are for radio only; generator is for propulsion"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Wait for shore power - manual start is not permitted",
      "Go to emergency generator room, check fuel/oil, attempt local manual start, transfer loads manually to emergency switchboard",
      "Send distress signal - blackout is an emergency requiring rescue",
      "Use battery-only power indefinitely until auto-start problem resolved"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Weekly: visual check only; Annual: full start test",
      "Monthly: running test under load for minimum 1 hour; Annual: full blackout test verifying 45-second start",
      "Quarterly: start test; every 5 years: full blackout test",
      "Only when surveyor is onboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "kW rating cannot be calculated for alternating current",
      "kVA determines the active power output directly",
      "kVA accounts for the mechanical losses in the prime mover",
      "Generator winding heating depends on current (kVA), regardless of the load's power factor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent residual magnetism from being lost",
      "To allow high-current, high-voltage output to be taken directly without the need for slip rings",
      "Because the prime mover can only drive a DC field",
      "Because stationary conductors cannot produce a rotating magnetic field"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The armature generates DC instead of AC",
      "The permanent magnets are located on the stator instead of the rotor",
      "It takes power from the main alternator rather than the PMG",
      "The field winding is on the stator (stationary) and the armature winding is on the rotor (rotating)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AVR \u2192 PMG \u2192 Rotating rectifiers \u2192 Exciter field (rotor) \u2192 Main field (stator) \u2192 Output",
      "Exciter armature \u2192 AVR \u2192 Rotating rectifiers \u2192 PMG \u2192 Main field (rotor) \u2192 Output",
      "Rotating rectifiers \u2192 PMG \u2192 Exciter field (stator) \u2192 AVR \u2192 Main field (rotor) \u2192 Output",
      "PMG \u2192 AVR \u2192 Exciter field (stator) \u2192 Exciter armature (rotor) AC \u2192 Rotating rectifiers \u2192 DC \u2192 Main field (rotor) \u2192 Main armature (stator) \u2192 Output"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Unbalanced DC to main field causing voltage fluctuation and a 15-20% drop in output voltage",
      "AC component in the field current causing severe rotor overheating",
      "Overcurrent relay trips instantly",
      "Complete loss of alternator output voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It immediately causes a complete blackout",
      "It trips the preferential trip relay prematurely",
      "It causes the PMG to demagnetize permanently",
      "It allows reverse AC current to enter the DC field, causing severe waveform distortion and excessive heating that can burn out the winding"
    ],
  ...
  },
  {
    ...
    "opts": [
      "\u00b120% of rated voltage, recovering to within \u00b13% in not more than 1.5 seconds",
      "\u00b12.5% of rated voltage, recovering instantly",
      "\u00b15% of rated voltage, recovering to within \u00b11% in not more than 5 seconds",
      "\u00b110% of rated voltage, recovering to within \u00b12.5% in not more than 1.5 seconds"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent the AVR from automatically starting the prime mover",
      "The high DC test voltage (500V-1000V) will permanently damage the sensitive semiconductor components in the AVR",
      "To ensure the PMG retains its residual magnetism",
      "The AVR will absorb the test current and yield a reading of zero ohms"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Catastrophic circulating currents occur, causing severe mechanical shock and possible winding burnout",
      "The AVR automatically adjusts the voltage to compensate for the 180-degree phase shift",
      "The preferential trip relay sheds non-essential loads",
      "The generator seamlessly synchronizes with the busbar"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent the synchroscope from burning out",
      "To ensure the reactive power (kVAR) matches the busbar perfectly",
      "Because the 12 o'clock position represents a 180-degree phase difference",
      "To compensate for the mechanical closing time of the ACB, ensuring the incoming generator takes a slight active load and does not get motored"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Adjust the AVR droop trimmers: increase voltage on Gen 2 while decreasing Gen 1",
      "Increase the air gap on Generator 1 to reduce its output",
      "Adjust the governor speed trimmers: increase fuel to Gen 2 while decreasing fuel to Gen 1 until kW meters balance",
      "Trip Generator 2 and flash its residual magnetism"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Unequal reactive (kVAR) load sharing; adjust the AVR voltage trimmers to balance the current",
      "Loss of residual magnetism; isolate and flash Generator A",
      "Phase sequence mismatch; swap two phases on Generator B",
      "Unequal active (kW) load sharing; adjust the governor speed trimmers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "105-110% of rated current with IDMT characteristic",
      "5-10% of rated kW in the reverse direction with a 3-5 second time delay",
      "90% of maximum load capacity before shedding",
      "10-20% of rated current differential threshold"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It suppresses voltage transients during diode failure",
      "It is a magnetic interlock that prevents the ACB from closing",
      "It is a pneumatic or hydraulic time delay device that provides a specific time interval between load shedding stages",
      "It is an electronic timer used exclusively in overspeed trips"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Rack the ACB to TEST position, disconnect the CT secondary, and inject a calibrated AC current into the relay coils using a secondary injection test set",
      "Press the mechanical trip push-button on the ACB fascia panel",
      "Overload the generator by starting all major pumps simultaneously and time the trip",
      "Inject a reverse power signal into the AVR test port and wait for the breaker to open"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By injecting a high-frequency AC signal and measuring stator reluctance",
      "Using a feeler gauge inserted through stator ventilation openings at a minimum of 4 positions (12, 3, 6, 9 o'clock) for each pole",
      "Using a digital micrometer attached to the slip rings",
      "By visually inspecting the alignment marks on the prime mover coupling"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It triggers the reverse power relay due to fluctuating torque",
      "It causes unbalanced magnetic pull, leading to excessive vibration, noise, bearing wear, and potential hot spots in the stator",
      "It improves cooling efficiency but lowers the output voltage",
      "It causes the AVR to completely shut down the excitation field"
    ],
  ...
  },
  {
    ...
    "opts": [
      "100 ohms",
      "0.5 Mohms",
      "1000 Mohms absolute minimum",
      "1 Mohm, though for a new/rewound winding it should ideally be > 100 Mohms"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Disconnect the speed sensor and inject a simulated speed signal using a calibrator into the overspeed module until the relay activates",
      "Run the generator at full load and suddenly open the main ACB",
      "Short circuit the PT100 temperature sensors to force an emergency trip",
      "Manually push the fuel rack to maximum while the ACB is closed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the emergency generator cannot supply all auxiliary equipment at once",
      "To ensure the preferential trip dashpot has time to reset",
      "To prevent simultaneous starting current surges from overloading and tripping the main generator",
      "Because the AVR requires 2 minutes to stabilize the voltage output"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Run at rated speed and swap any two phases on the main terminal box",
      "Stop the machine, connect a 220V AC supply to the stator for 5 minutes, then restart",
      "Run at rated speed, connect a 12V/24V battery (positive to positive, negative to negative) to the exciter field for 2-3 seconds, then check voltage buildup",
      "Short circuit the rotating diode bridge for exactly 5 seconds while running"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It will permanently short circuit the PMG permanent magnets",
      "It will immediately burn out the stator armature windings",
      "It will cause the prime mover to run in reverse",
      "It will imprint reversed residual magnetism, preventing the generator from producing the correct voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Flash the field with reverse polarity to cancel out the magnetism",
      "Remove the carbon brushes and wait 10 minutes for natural discharge",
      "Open and lock out ACB, remove AVR supply, test with a voltage detector, and apply earth clamps to stator terminals to discharge residual charge",
      "Simply open the ACB; the machine is automatically safe"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To keep the center of gravity of the vessel as high as possible",
      "Due to high flooding risk, severe structural vibration, and SOLAS requirements for main electrical source protection",
      "Because the tank top temperature is too low for Class F insulation",
      "Because the length of cables to the main switchboard would cause excessive voltage drop"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The motor automatically operates as an induction generator",
      "The motor draws less current to protect its windings",
      "The motor's torque remains unchanged but its speed drops proportionally",
      "The motor's torque is reduced to roughly 40% of its rated value, which may cause it to stall under load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR of the idle generator boosts voltage to match the busbar",
      "The idle generator instantly starts its prime mover automatically",
      "The running generator back-feeds the idle machine, causing it to run as an induction motor until the reverse power relay trips",
      "Nothing happens because the idle generator has zero voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Apply electrical contact cleaner directly to the slip ring at full load",
      "Reduce load to minimum and carefully use fine emery cloth held in an insulated holder to smooth the pits",
      "Shut down the machine immediately and machine the slip rings in a lathe",
      "Increase brush pressure to 800 g/cm\u00b2 to grind down the pits"
    ],
  ...
  },
  {
    ...
    "opts": [
      "150\u2013200 g/cm\u00b2",
      "As tight as the spring will physically allow",
      "500-600 g/cm\u00b2",
      "10-50 g/cm\u00b2"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Alarm at ~60\u00b0C, Trip at ~75\u00b0C",
      "Alarm at ~120\u00b0C, Trip at ~155\u00b0C",
      "Alarm at ~155\u00b0C, Trip at ~180\u00b0C",
      "Alarm at ~80\u00b0C, Trip at ~95\u00b0C"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It carries the field winding and creates a rotating magnetic field",
      "It carries the 3-phase armature winding to produce output power",
      "It rectifies the AC output into DC for the ship's busbar",
      "It acts as a permanent magnet for the main output"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To avoid the need for slip rings to handle the heavy output current",
      "Because the stator rotates faster than the rotor",
      "Because DC excitation must be handled by the stationary parts",
      "To increase the frequency of the generated AC power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is an AC current that gets rectified internally by the slip rings",
      "It is a small current, making slip ring transfer much safer than transferring the main output",
      "It is a high-voltage, high-current supply requiring heavy-duty brushes",
      "It is identical in magnitude to the output current"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because generator heating depends on the current (kVA), not the active power (kW)",
      "Because kVA accounts for the mechanical efficiency of the prime mover",
      "Because power factor fluctuates too much to calculate kW",
      "Because kW can only be measured in DC circuits"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Motors operate on DC, while generators operate on AC",
      "Motors do not suffer from thermal heating due to current",
      "Motors are rated by their useful mechanical active power output (kW)",
      "Generators have a constant power factor of 1.0"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses an external DC source (like batteries or a rectifier) to supply the rotor field winding via slip rings",
      "It uses an internal PMG to excite the main stator",
      "It steps down its own output to feed the field winding",
      "It relies entirely on residual magnetism without any electrical input"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is highly susceptible to loss of residual magnetism",
      "It cannot produce a 60 Hz output",
      "It cannot be controlled by an AVR",
      "It requires slip rings and brushes, making it maintenance-intensive"
    ],
  ...
  },
  {
    ...
    "opts": [
      "From an external battery bank connected to the stator",
      "By utilizing only the residual magnetism in the rotor core",
      "From a Permanent Magnet Generator (PMG) on the shaft",
      "The generator's own output is stepped down and rectified to supply its own field via slip rings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A fully charged external battery bank",
      "Initial residual magnetism in the rotor core",
      "A rotating diode bridge",
  ...
  },
  {
    ...
    "opts": [
      "AVR, PMG, and Main Alternator",
      "PMG, Exciter, and Main Alternator",
      "Stator, Rotor, and Exciter",
      "Exciter, Rotating Rectifiers, and AVR"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It requires a separate diesel engine to drive the exciter",
      "A thyristor-controlled rectifier supplies DC directly to the field via slip rings from the stator output",
      "It uses permanent magnets exclusively to generate the main field",
      "It eliminates the need for all moving parts in the generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The AVR",
      "The prime mover (e.g., diesel engine)",
      "The stator armature"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The stator conductors begin to rotate in sync with the rotor",
      "The AVR automatically disconnects from the circuit",
      "The slip rings reverse the polarity of the DC field",
      "The rotating magnetic field cuts across the stationary stator conductors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "kW is greater than the kVA rating",
      "kW is 80% of the kVA rating",
      "kW is exactly equal to the kVA rating",
      "kVA rating becomes irrelevant"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The total current flowing in the stator",
      "The resistance of the field winding",
      "The physical speed of the rotor in RPM",
  ...
  },
  {
    ...
    "opts": [
      "It eliminates brush sparking and maintenance, making it safer for hazardous areas and highly reliable",
      "It increases the frequency of the generated voltage",
      "It allows the alternator to generate DC power directly from the stator",
      "It completely removes the need for an AVR"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The winding temperature remains the same because it depends on the kVA (current), not the power factor",
      "The winding temperature fluctuates directly with the active power (kW)",
      "The winding temperature decreases as the power factor increases",
      "The winding temperature increases as the power factor decreases"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Stator, Rotor, and Rotating Rectifier",
      "Main Exciter, Diode Wheel, and Slip Ring Assembly",
      "Automatic Voltage Regulator (AVR), Main Exciter, and Main Alternator",
      "Permanent Magnet Generator (PMG), Main Exciter, and Main Alternator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It generates an independent initial AC voltage to feed the AVR, eliminating the need for residual magnetism",
      "It acts as a dynamic brake for the prime mover during overspeed conditions",
      "It provides the final DC output for the ship's main busbar",
      "It steps down the main alternator's output voltage to power the AVR"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It produces Direct Current (DC) directly without the need for rectifiers",
      "Its armature is stationary, while its permanent magnets rotate",
      "Its field winding is stationary on the stator, and its armature winding rotates on the rotor",
      "It draws power from the main output instead of supplying power to it"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Mounted on the stationary stator frame near the cooling fan",
      "Mounted on the rotor shaft between the exciter armature and the main field",
      "Integrated into the main switchboard to rectify the final output",
      "Inside the Automatic Voltage Regulator (AVR) control cabinet"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They step down the main 440V output for safe use in the field winding",
      "They convert the DC from the AVR into AC for the exciter stator",
      "They convert the PMG output into DC to power the AVR",
      "They convert the 3-phase AC produced by the exciter armature into DC to feed the main alternator field"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AVR \u2192 PMG \u2192 Rotating Rectifiers \u2192 Exciter Field \u2192 Main Field \u2192 Exciter Armature",
      "Exciter Field \u2192 AVR \u2192 PMG \u2192 Rotating Rectifiers \u2192 Main Field \u2192 Exciter Armature",
      "Rotating Rectifiers \u2192 Exciter Armature \u2192 PMG \u2192 AVR \u2192 Main Field \u2192 Exciter Field",
      "PMG \u2192 AVR \u2192 Exciter Field \u2192 Exciter Armature \u2192 Rotating Rectifiers \u2192 Main Field"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They automatically suppress any overcurrent conditions internally",
      "They operate at a much lower voltage than conventional alternators",
      "They do not have carbon brushes, eliminating the risk of brush sparking that could ignite flammable gases",
      "They can generate power without a prime mover"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It does not produce carbon brush dust, which can mix with humidity to cause conductive tracking and shorts",
      "Its windings are made of stainless steel instead of copper",
      "The PMG acts as an internal heater to keep the windings dry",
      "The rotating rectifiers automatically absorb excess moisture"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR will short circuit, causing a complete blackout",
      "The prime mover will overspeed due to loss of magnetic load",
      "It causes unbalanced DC to the main field, resulting in an output voltage drop of 15-20% and voltage fluctuation",
      "The alternator output voltage will instantly drop to zero"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It causes the main generator breaker to physically jam closed",
      "It forces the PMG to reverse its magnetic polarity instantly",
      "It bypasses the AVR completely, leading to an immediate over-frequency trip",
      "It allows AC current to flow backward into the DC field winding, causing severe excessive heating and potential winding burnout"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR will begin 'hunting' and the output voltage will become highly unstable",
      "The AVR will shut down immediately without any alarm",
      "The AVR will output a perfectly flat DC signal with zero ripple",
      "The AVR will steadily increase voltage until the overvoltage relay trips"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inspect the rotating diode wheel using a stroboscope while the machine is running",
      "Measure the direct current of the main field using a clamp meter",
      "Perform a 500V megger test on the AVR input terminals",
      "Inject a high-frequency AC signal into the PMG"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because brushless alternators rely on the main stator's residual magnetism instead of the rotor's",
      "Because the AVR has a built-in battery to flash the field automatically",
      "Because rotating rectifiers act as capacitors to store starting charge",
      "Because the PMG uses permanent magnets to supply the AVR, completely eliminating the need for residual magnetism to build voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A governor speed sensor fault causing the actual frequency/RPM to be too low, despite the gauge reading",
      "The preferential trip dashpot being stuck in the open position",
      "The main circuit breaker being racked out to the TEST position",
      "The synchroscope needle being stuck at 6 o'clock"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A dedicated IDMT overcurrent relay is wired directly to the main rotor",
      "The AVR contains internal circuitry that limits the excitation current supplied to the exciter",
      "The preferential trip relay sheds the main field load directly",
      "A mechanical fuse is mounted on the rotating diode wheel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A Zener diode",
      "An Insulation Monitoring System (IMS) probe",
      "A Thermistor (or PT100 sensor)",
      "A pneumatic dashpot"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The main alternator would output maximum uncontrolled voltage due to lack of regulation",
      "The main exciter would automatically act as a self-excited shunt to compensate",
      "The AVR would receive no input power, and the alternator would fail to build any output voltage",
      "The AVR would switch to drawing power directly from the 24V starting batteries"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By connecting a 24V battery and watching for sparks",
      "Using a multimeter on the diode test setting; each should show ~0.6V forward and 'OL' (open loop) in reverse",
      "By measuring the RPM of the diode wheel with a tachometer",
      "By applying a 500V megger test across the diode bridge"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "High-voltage pulse-width modulated (PWM) current",
      "Direct Current (DC) only",
      "3-phase Alternating Current (AC)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It allows the generator to run without a diesel engine",
      "It allows the AVR to directly power the ship's emergency lighting",
      "It ensures the AVR has reliable power to force excitation even if a severe short circuit collapses the main busbar voltage",
      "It prevents the prime mover from overspeeding during load shedding"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A massive overvoltage condition",
      "Zero voltage output, as the main rotor will have no magnetic field to induce an EMF",
      "The frequency will drop to 50% of rated value",
      "The voltage will drop by exactly 15-20%"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The diode is perfectly healthy",
      "The diode is open-circuited",
      "The diode is functioning normally as a Zener suppressor",
      "The diode is short-circuited and must be replaced"
    ],
  ...
  },
  {
    ...
    "opts": [
      "In the Exciter Stator (stationary)",
      "In the Main Stator (stationary)",
      "In the Exciter Rotor (rotating)",
      "In the PMG Rotor (rotating)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The reverse power relay will trip immediately",
      "The bearings will overheat within minutes",
      "The alternator frequency will wildly hunt between 45Hz and 55Hz",
      "An output voltage that fluctuates and drops by 15-20%, which may not be noticeable at no-load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Measure the AC voltage output directly at the PMG terminals feeding into the AVR",
      "Perform a diode test on the rotating rectifiers with a multimeter",
      "Flash the exciter field and watch the RPM gauge",
      "Check the temperature of the Zener diode suppressor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Brushless alternators can automatically parallel themselves without a synchroscope",
      "They are the only alternators capable of providing 60 Hz power",
      "They generate their own diesel fuel internally through the PMG",
      "The lack of brushes and slip rings vastly reduces the need for frequent manual inspection, maintenance, and cleaning"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The prime mover governor speed setting",
      "The Exciter Stator field winding resistance, to ensure it is not an open circuit",
      "The Main Stator output terminals",
      "The preferential trip relay dashpot"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Within 45 seconds for Cargo ships, and within 30 seconds for Passenger ships",
      "Within 90 seconds for Cargo ships, and within 45 seconds for Passenger ships",
      "Within 30 seconds for Cargo ships, and within 15 seconds for Passenger ships",
      "Within 60 seconds for both Cargo and Passenger ships"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be located above the uppermost continuous deck (bulkhead deck) and entirely outside the main machinery space",
      "It must be located adjacent to the main switchboard inside the engine control room",
      "It must be placed at the tank top level to ensure a stable center of gravity",
      "It must be installed in the steering gear flat to provide direct power to the rudders"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Tested only when requested by Port State Control (PSC)",
      "Quarterly full blackout tests, and an annual fuel oil analysis",
      "Weekly no-load start tests, and a 5-year full load bank test",
      "Monthly running test under load for a minimum of 1 hour, and an Annual full blackout test verifying the auto-start time"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Between 105% and 110% of the rated RPM",
      "Exactly 125% of the rated RPM",
      "Between 150% and 160% of the rated RPM",
      "Between 110% and 115% of the rated RPM"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the reverse power relay will interfere with the test if the breaker is closed",
      "To prevent the resulting high frequency and high voltage from destroying connected shipboard motors and sensitive electronics on the main busbar",
      "Because the AVR requires zero excitation current to allow the RPM to rise",
      "Because the prime mover lacks the torque to reach 115% speed while loaded"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Force the fuel rack to the maximum position manually using a crowbar",
      "Short out the PT100 temperature sensors to trigger a software override",
      "Disconnect the speed pickup sensor and inject a simulated, escalating frequency signal directly into the overspeed module using a calibrator",
      "Lower the setpoint of the overspeed trip module temporarily to match the running speed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It applies a heavy mechanical disc brake directly to the rotor shaft",
      "It dumps the lubricating oil from the sump to trigger a low-oil-pressure shutdown",
      "It releases a spring-loaded mechanism that forces the fuel pump racks to the 'zero fuel' position, and sometimes closes the air intake flap",
      "It opens the exciter field breaker to remove magnetic load instantly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Allow the engine to reach 125% to see if the secondary electrical trip works",
      "Manually trip the engine immediately using the emergency stop button or manual fuel rack lever to prevent catastrophic mechanical failure",
      "Adjust the AVR droop setting to 0% to stabilize the frequency",
      "Close the main ACB to apply load and force the RPM back down"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The over-frequency relay acts on the prime mover, while the overspeed trip acts on the alternator",
      "The over-frequency relay operates at 125% speed, while the overspeed trip operates at 105%",
      "The over-frequency relay protects the electrical bus by opening the ACB, whereas the overspeed trip protects the prime mover by shutting off the fuel",
      "They are identical devices with different names depending on the manufacturer"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Generator 2's AVR will automatically shut down its excitation field",
      "Generator 2 will automatically increase its own fuel rack to match Generator 1",
      "Generator 2 will become motored by Generator 1, causing Generator 2's Reverse Power Relay to trip and open its ACB",
      "Generator 2's overspeed trip will activate in sympathy with Generator 1"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By using a calibrated spring balance hooked under the pressure finger, pulling it just enough to release the brush, and reading the scale",
      "By observing the magnitude of sparking at full load",
      "By pressing down on the brush with a thumb and estimating the resistance",
      "By measuring the physical length of the uncompressed spring with calipers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "High frequency AC ripple from a failed PMG",
      "Electrical sparking (arcing) underneath the brush due to insufficient spring pressure, bouncing, or wrong brush grade",
      "Over-tightening of the main shaft bearings",
      "Chemical corrosion from marine salt air"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By reversing the polarity of the excitation field to burn off the pits",
      "By tightening the brush spring to maximum pressure to grind it smooth",
      "By applying fine emery cloth mounted on a rigid, electrically insulated block against the slip ring",
      "By spraying electrical contact cleaner directly onto the spinning ring"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To burn off the anti-corrosion coating applied at the factory",
      "To shape the bottom of the brush to match the exact curvature of the slip ring, preventing point-contact arcing",
      "To magnetize the carbon so it adheres to the copper better",
      "To ensure the brush absorbs enough humidity to conduct properly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Carbon dust acts as a thermal insulator, preventing the rotor from cooling",
      "Carbon dust is highly conductive; if it accumulates on windings, it creates tracking paths that lead to fatal phase-to-earth or phase-to-phase short circuits",
      "Carbon dust chemically reacts with class F varnish to produce flammable gas",
      "Carbon dust degrades the structural integrity of the copper slip rings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To allow cooling air to flow more easily between the holders",
      "To prevent electromagnetic interference between adjacent brushes",
      "To ensure even wear across the entire face of the slip ring and prevent deep grooves from forming",
      "To separate the positive and negative excitation currents"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The brushes should be replaced with a harder grade of carbon to grind the ring flat",
      "The slip ring voltage should be increased by 10% to push current across the gaps",
      "The grooves should be filled with conductive silver solder and filed flat",
      "The rotor must be removed and the slip rings turned (machined) on a lathe to restore a perfectly flat and concentric surface"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Yes, as long as the spring pressure is reduced by 50% to compensate",
      "No, a harder grade will mechanically grind away the copper slip ring, causing irreversible damage to the expensive rotor",
      "No, harder brushes cannot conduct DC current, only AC current",
      "Yes, harder brushes are better because they last longer and reduce maintenance"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The motor automatically trips on under-frequency protection",
      "The motor acts as a generator and feeds reactive power back to the bus",
      "The motor continues to run at normal torque but its speed drops by 30%",
      "The motor's torque output drops to roughly 50%, causing it to stall, which leads to massive overcurrent draw and severe winding overheating"
    ],
  ...
  },
  {
    ...
    "opts": [
      "In the excitation system; there is unequal reactive load (kVAR) sharing due to improperly set AVR voltage trimmers or a faulty AVR",
      "In the fuel system; the prime mover governors are not sharing active load",
      "In the synchroscope; the breaker was closed at the wrong phase angle",
      "In the mechanical coupling; the poles are slipping on Gen 2"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The main switchboard overcurrent relay is set too low",
      "Clogged stator ventilation slots or a heavily fouled generator air cooler preventing heat dissipation",
      "The AVR is supplying too much reactive power to the busbar",
      "The lubricating oil pressure has dropped below 1.5 bar"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Governor hunting causes wide fluctuations on the kW (Active Power) and Frequency meters; AVR hunting causes fluctuations on the Voltmeter and kVAR (Reactive Power) meters",
      "Governor hunting affects the Voltmeter; AVR hunting affects the Frequency meter",
      "There is no difference; both cause identical symptoms on all meters simultaneously",
      "Governor hunting only occurs during synchronization; AVR hunting only occurs during blackout recovery"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because a dead generator has infinite resistance until it reaches 60Hz",
      "Because the preferential trip dashpot absorbs the massive electrical shock",
      "Because the AVR instantly senses the reverse flow and blocks the thyristors",
      "Because the stator windings have high inductive reactance; instead of a short circuit, they act like an induction motor stator and draw heavy starting current to turn the rotor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A seized generator rotor bearing",
      "A broken AVR thyristor causing loss of excitation",
      "A failed turbocharger bearing causing overspeed",
      "A blocked fuel filter, empty day tank, or governor actuator failure causing total loss of engine power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An open circuit (broken wire) inside the winding",
      "A phase-to-phase short circuit between two different windings",
      "A complete breakdown of insulation between the copper coils and the iron stator core (Dead Earth Fault)",
      "A turn-to-turn short circuit within the same coil"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The alternator continues normally, but the load is limited to exactly 66% capacity",
      "The frequency immediately drops by 33% (e.g., 60Hz to 40Hz)",
      "Single-phasing: the output voltage becomes severely unbalanced, and connected 3-phase motors will draw excessive current on the remaining two phases, risking burnout",
      "The alternator immediately generates DC power instead of AC power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The rotating diodes have failed closed, causing a phantom earth fault",
      "The megger tester is broken and needs battery replacement",
      "The alternator itself is healthy; the earth fault is located somewhere out on the ship's distribution network that was connected to the busbar",
      "The AVR is masking the internal fault while the machine is stopped"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It steps down its own stator output to feed the rotor",
      "The DC excitation power for the rotor field is supplied entirely from an independent external source, such as battery banks or a separate DC generator",
      "It uses an internal PMG mounted on the same shaft",
      "It relies purely on permanent magnets located in the stator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses the PMG to inject 220V directly into the stator",
      "It requires a manual push-button 'flash' every single time it starts",
      "It relies entirely on the faint residual magnetism in the rotor core to induce a tiny voltage, which is then fed back to strengthen the field in a loop",
      "It uses an internal battery inside the AVR to jumpstart the process"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Static excitation uses a PMG, while brushless relies on residual magnetism",
      "There is no physical difference; they are just two names for the same system",
      "Static excitation relies on slip rings and carbon brushes to transfer DC to the rotor, whereas brushless excitation transfers power magnetically via an exciter and rectifies it internally on the spinning shaft",
      "Static excitation produces AC in the rotor, while brushless produces DC in the stator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It allows the generator to run safely underwater if flooded",
      "Static excitation has an incredibly fast dynamic response time to sudden load changes because it forces DC directly into the main field without the delay of a middleman exciter",
      "It generates zero electrical noise or harmonic distortion",
      "It completely eliminates the need for maintenance"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because it draws power from the switchboard to drive the diesel engine",
      "Because it spins counter-clockwise to the main alternator",
      "Because its DC magnetic field is held stationary on the stator, while its 3-phase AC armature rotates on the rotor shaft",
      "Because it steps down voltage instead of generating it"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The self-excited alternator automatically disconnects its own exciter field",
      "The PMG utilizes a mechanical fuse, while self-excited relies on software",
      "A short circuit drops the busbar voltage to near zero, which starves the self-excited AVR of power, causing the magnetic field to collapse before protective relays can trip",
      "A short circuit causes the self-excited machine to overspeed uncontrollably"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It requires the use of slip rings and carbon brushes to transfer the DC excitation current to the spinning rotor, necessitating regular maintenance",
      "It is incapable of operating in parallel with other generators",
      "It relies entirely on residual magnetism, making black starts impossible",
      "It has a very slow dynamic response to transient load changes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They prevented reverse power from motoring the prime mover",
      "They synchronized the phase angle of the incoming machine",
      "They injected an excitation current directly proportional to the load current, providing a crude but robust automatic voltage boost under heavy load",
      "They stepped down the 440V main output to 24V for the control circuitry"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The vessel must be safely at anchor or open sea with no nearby traffic, and explicit permission must be obtained from the Master/Bridge",
      "The main engines must be running at full ahead on heavy fuel oil",
      "The emergency generator must already be running and paralleled with the main bus",
      "The ship's fire alarms must be physically disabled"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The Under-Voltage (UV) Relay",
      "The Over-Current Relay (OCR)",
      "The Preferential Trip Relay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The synchroscope is hardwired to lock out the emergency breaker",
      "The emergency generator outputs 60Hz while the main outputs 50Hz",
      "An electrical and mechanical interlock between the Emergency Generator breaker and the Main Bus-Tie breaker on the emergency switchboard",
      "The reverse power relay on the emergency generator is set to zero seconds"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is closed directly onto the 'dead bus' without needing synchronization, as there is no existing voltage or frequency to match",
      "It is connected via a variable frequency drive to slowly ramp up the bus voltage",
      "It must be synchronized with the emergency generator using the synchroscope",
      "It must wait for the emergency generator to physically disconnect before it can generate voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent the massive, simultaneous starting currents of multiple large induction motors from overloading and tripping the newly connected main generator",
      "To give the crew time to manually bleed air from the fuel lines",
      "To ensure the lubricating oil has enough time to heat up",
      "Because the AVR requires 2 minutes to stabilize its reference voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Galley Ovens and HVAC systems",
      "Main Engine Lubricating Oil (LO) Pumps and Steering Gear"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By manually pressing the physical trip button on the running Main Generator's ACB, or using a test switch that simulates an under-voltage fault",
      "By shorting the main busbar with an earth strap",
      "By forcing the AVR into maximum droop",
      "By shutting off the fuel supply to the running prime mover"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It remains paralleled with the main generator to provide active load support",
      "Its breaker automatically opens, and the prime mover runs for a few minutes on no-load to cool down before stopping",
      "It stops instantaneously to save fuel",
      "It acts as a synchronous condenser to correct the power factor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The prime mover's mechanical overspeed trip latch",
      "The Preferential Trip (Load Shedding) relays and non-essential breakers that were tripped during the event",
      "The PMG's magnetic polarity",
      "The AVR internal reference voltage"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To provide emergency cooling to the piston crowns",
      "To purge the cylinders of exhaust gas",
      "To use compressed air to spin the main alternator",
      "They do not; air compressors may start to replenish receivers, but main engine start valves are controlled by the maneuvering system, not blackout automation"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Long feeler gauges inserted through the stator ventilation slots",
      "A vernier caliper"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Measurements should not deviate by more than \u00b110% from the average mean value",
      "Measurements should only be within \u00b150% of the manufacturer's maximum limit",
      "Measurements must be exactly identical with 0% deviation",
      "Measurements can deviate up to \u00b125% before action is required"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Two points: Top and Bottom",
      "One point at the top only",
      "Four points: Top (12 o'clock), Bottom (6 o'clock), Left (9 o'clock), and Right (3 o'clock)",
      "Eight points at 45-degree intervals"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The prime mover coupling is misaligned horizontally",
      "The rotor poles have expanded due to centrifugal force",
      "The stator frame has warped upward due to heat",
      "The main rotor bearings are worn out, causing the rotor shaft to drop"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Reverse motoring of the prime mover",
      "A complete loss of residual magnetism",
      "Unbalanced Magnetic Pull (UMP), which pulls the rotor toward the smallest gap, exponentially increasing bearing wear and vibration",
      "High frequency harmonic distortion in the stator output"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The slip rings will wear down to the bare shaft",
      "The alternator will simply stop producing voltage",
      "The spinning rotor poles will physically scrape and crash into the stationary stator core, destroying the windings and the machine",
      "The AVR will overheat and catch fire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To align the cooling fan blades with the stator slots",
      "To lubricate the bearings before inserting the gauges",
      "To generate a small voltage for the feeler gauge sensor",
      "To measure the gap on all individual rotor poles, as one specific pole may be loose or deformed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It forces the machine to generate DC instead of AC",
      "It prevents Unbalanced Magnetic Pull entirely",
      "It increases the machine's stability and reduces harmonic distortion, but requires significantly more field excitation current to push the flux across the gap",
      "It reduces stability but drastically lowers the required excitation current"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The magnetic field compresses the rotor, increasing the air gap",
      "The air gap remains perfectly static under all conditions",
      "The stator frame shrinks, increasing the air gap",
      "Centrifugal force expands the rotor slightly, and thermal expansion of the hot rotor poles further reduces the air gap"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A sudden drop in voltage during motor starting",
      "A deliberate, proportional decrease in prime mover speed (frequency) as active load (kW) increases",
      "An unintended loss of fuel pressure at high loads",
      "The physical sagging of the generator rotor due to gravity"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A failure of the AVR thyristors under heavy load",
      "A deliberate, proportional decrease in terminal voltage as reactive load (kVAR) increases",
      "A drop in frequency when reactive load drops",
      "The voltage drop across the rotating diode wheel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They will slowly drift out of phase until a short circuit occurs",
      "They will share load perfectly and maintain exactly 60Hz and 440V",
      "They will aggressively fight to maintain exact frequency/voltage, causing violent load swings (hunting) and eventual tripping",
      "They will automatically shut down the less efficient prime mover"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Increase the AVR voltage on Gen 2 while decreasing it on Gen 1",
      "Gradually increase the governor speed control of Gen 2 while simultaneously decreasing the governor speed control of Gen 1 until Gen 1 reads near 0 kW",
      "Open Gen 1's breaker immediately, and Gen 2 will automatically take the load",
      "Trip the Preferential Trip relay to shed load before opening the breaker"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are sharing both Active (kW) and Reactive (kVAR) loads perfectly",
      "They are about to trip on reverse power",
      "kW is shared perfectly, kVAR is shared poorly",
      "kW is shared poorly, kVAR is shared perfectly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Do nothing; the load sharing lines will correct it automatically within 5 minutes",
      "Open the bus-tie breaker to separate the switchboards",
      "Adjust the governor controls: Increase the speed setting of Gen 2 and decrease the speed setting of Gen 1",
      "Adjust the AVR controls: Increase voltage on Gen 2 and decrease on Gen 1"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Adjust the AVR controls: Increase the voltage setting on Gen 2 and decrease the voltage setting on Gen 1 until Ammeters match",
      "Check the engine fuel filters on Gen 2",
      "Synchronize the phase angles using the synchroscope",
      "Adjust the governor controls: Increase the speed setting on Gen 2"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The other generator will automatically share its fuel via cross-over valves",
      "It will overspeed dramatically due to loss of load",
      "Its kW drops to zero and goes negative; the other generator will back-feed it, turning it into a motor until the Reverse Power Relay trips its breaker",
      "Its AVR shuts down, and it instantly disconnects from the bus"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To transfer active kW power between the diesel engines",
      "To physically lock the rotors in phase mechanically",
      "To allow the AVRs to communicate their reactive load status, enabling perfect kVAR sharing without needing significant voltage droop",
      "To synchronize the speed of the prime movers before the breaker closes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Currents must be equal, kW must be equal, and Power Factors must match",
      "Phase sequence must be R-B-Y, Amps must be zero, and Voltage must be 440V",
      "Voltages must be equal, Frequencies must be equal (incoming slightly higher), and Phase Angles must match (synchroscope at 12 o'clock)",
      "Speeds must be identical, Excitations must be identical, and Air Gaps must be identical"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Wasted reactive currents that flow purely between the generators (not to the ship's load) caused by unequal excitation/voltage settings",
      "Active power currents that transfer physical torque between the engines",
      "Currents that cool the stator windings by circulating through the air gap",
      "Currents generated by the PMG to power the AVR"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A condition where the main engine has failed but generators are running; power must be restored within 10 minutes",
      "A condition where only the emergency generator is running; power must be restored within 18 hours",
      "A condition where all machinery and electrical power is completely dead (no steam, no compressed air, no batteries); power must be restored within 30 minutes",
      "A total blackout condition that requires external tug assistance for recovery"
    ],
  ...
  },
  {
    ...
    "opts": [
      "There must be at least two main generating sets, capable of supplying all essential services even if any one generating set is stopped",
      "There is no set number, provided the total kW meets the ship's maximum demand",
      "There must be at least one main generator and one emergency generator",
      "There must be at least three main generating sets of equal capacity"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "It must be powered by a dedicated UPS without any interruption",
      "Manually, within 2 minutes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "\u00b12.5% of rated frequency, recovering to within \u00b11% in 1.5 seconds",
      "\u00b15% of rated frequency, recovering to within \u00b12.5% in 3 seconds",
      "\u00b120% of rated frequency, recovering to within \u00b15% in 10 seconds",
      "\u00b110% of rated frequency, recovering to within \u00b15% in not more than 5 seconds"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Unlimited starts provided the emergency switchboard is live",
      "3 consecutive starts from a single dedicated battery bank",
      "1 automatic start and 1 manual crank start",
      "At least 3 consecutive starts from the primary source, and 3 consecutive starts from a second independent source (total of 6) within 30 minutes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Rolling up to 15 degrees and pitching up to 15 degrees",
      "Rolling up to 22.5 degrees and pitching up to 10 degrees",
      "Rolling up to 45 degrees and pitching up to 22.5 degrees",
      "Rolling up to 10 degrees and pitching up to 5 degrees"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be located in the same space as the emergency generator and used ONLY for starting the emergency generator",
      "It must be a lead-acid type with a capacity of at least 500 Ah",
      "It can be shared with the ship's general 24V DC emergency lighting system",
      "It must be located on the bridge to ensure safety from engine room fires"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The emergency generator takes the full load permanently",
      "The main engine must automatically shut down to prevent damage",
      "The duty engineer is given a 3-minute alarm delay to manually start the standby generator",
      "The standby generator must automatically start, synchronize (if necessary), connect to the busbar, and sequentially restart essential pumps within 45 seconds"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Emergency cables must run exclusively through the double bottom tanks",
      "They must be bundled together in armored conduits for maximum physical protection",
      "They must be routed completely separately and kept as far apart as practical to prevent a single fire from destroying both power systems",
      "They must share the same cable trays but be separated by a grounded metal divider"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be located in the emergency generator room",
      "It must be located in a completely different fire zone from the generators",
      "It must be located on the navigation bridge for easy access by the deck officers",
      "It must be located as near as is practicable to the main generators and within the same main fire zone"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must have an Inverse Definite Minimum Time (IDMT) characteristic and protect the generator against sustained overloads and short circuits",
      "It must solely protect the busbar, not the generator windings",
      "It must be physically linked to the fuel rack to shut down the engine on overload",
      "It must be set to trip instantaneously the moment the rated current is exceeded by 1 Amp"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Cargo winches, bow thruster, and ballast pumps",
      "Main engine lubricating oil pumps and jacket water pumps",
      "Emergency lighting, steering gear, fire pumps, navigation lights, internal communications, and general alarm systems",
      "Air conditioning compressors, galley ovens, and purifiers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR must lower the voltage to reduce the power consumed by non-essential loads",
      "They must be automatically disconnected (load shed) by a Preferential Trip relay to prevent the generator from tripping and causing a blackout",
      "They are transferred instantly to the emergency switchboard",
      "The crew must manually turn them off within 5 minutes of an alarm sounding"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The stray magnetic field that interferes with ship navigation",
      "The static electrical charge built up on the slip rings",
      "The small amount of magnetic flux that naturally remains in the iron core of the rotor after the excitation current has been switched off",
      "The permanent magnetic field generated by the PMG"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It keeps the rotor mechanically balanced at high speeds",
      "It provides the necessary braking torque during shutdown",
      "Because it induces the small initial voltage (5-10V) required to power the AVR and 'bootstrap' the main excitation field when the machine starts",
      "It prevents the rotating diodes from overheating"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Running the generator continuously at 100% full load",
      "Using the wrong grade of carbon brushes on the slip rings",
      "Frequent testing of the overspeed trip mechanism",
      "Prolonged idleness (months without running), severe mechanical shock, excessive heat, or a massive short circuit"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The voltage builds to 440V but fluctuates wildly",
      "The prime mover fails to reach rated speed and stalls",
      "The generator outputs 440V but the frequency is stuck at 0Hz",
      "The prime mover runs at exactly rated speed (e.g., 60Hz), but the voltmeter on the switchboard reads exactly 0 Volts"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The 220V AC lighting circuit",
      "A 500V DC Megger",
      "A 12V or 24V DC battery",
      "A secondary Permanent Magnet Generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To ensure the rotating rectifiers are spinning fast enough to act as capacitors",
      "Because stationary flashing will instantly melt the iron core",
      "To provide centrifugal cooling for the field windings",
      "So that the moment the magnetism is restored, the machine immediately induces voltage and the AVR takes over to sustain the field"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The battery polarity does not matter as long as it is DC",
      "Positive must go to the Negative field terminal to cancel the demagnetization",
      "Positive must go to the Positive field terminal, and Negative to the Negative terminal; reverse polarity will imprint reversed magnetism",
      "The polarity must be rapidly switched back and forth to 'shake' the domains"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Until the alternator reaches its full rated load",
      "Only for 2 to 3 seconds; it must be removed immediately once voltage begins to build",
      "It must be permanently installed as a backup excitation source",
      "For a minimum of 5 minutes to ensure deep magnetization"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AVR must be set to maximum boost",
      "The AVR must be temporarily short-circuited",
      "Nothing, the AVR manages the flashing process automatically",
      "The AVR must be completely disconnected from the field circuit to prevent the battery voltage from damaging its semiconductor components"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To the Exciter Stator Field terminals (usually marked F1 and F2, or F+ and F-)",
      "Directly to the rotating diode wheel",
      "To the main stator output terminals (R, Y, B)",
      "To the main rotor slip rings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The PMG constantly injects AC into the main core while stopped",
      "The PMG acts as an internal battery charger for the AVR",
      "The PMG has physical permanent magnets that guarantee an independent power supply to the AVR, eliminating the need for residual magnetism in the main core",
      "The PMG uses a mechanical slip clutch to maintain field strength"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The rotating diodes are short-circuited",
      "Total loss of residual magnetism; there is no flux to generate even the initial few volts",
      "The AVR is faulty and needs replacement",
      "The over-voltage relay has tripped"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Residual magnetism is present (causing the 12V), but the AVR or excitation circuit is faulty and failing to 'bootstrap' the voltage up to 440V",
      "The generator is perfectly healthy; 12V is the standard standby voltage",
      "Loss of residual magnetism; the 12V is just induction from the prime mover",
      "The governor speed is too low"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The prime mover was spinning too fast",
      "The main circuit breaker was left closed",
      "The battery used did not have enough Amp-Hours",
      "The AVR is faulty, or there is a break (open circuit) in the excitation wiring preventing the self-sustaining loop"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A clamp meter",
      "A standard digital multimeter set to Ohms",
      "A Megger (Megohmmeter), typically using 500V DC for standard 440V systems",
      "An oscilloscope"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Connect one lead to the AVR and the other to the main switchboard",
      "Connect one megger lead to the stator terminal (e.g., U, V, or W) and the other lead to the bare metal earth of the generator casing",
      "Connect one lead to the rotor shaft and the other to the slip ring",
      "Connect one lead to Phase U and the other to Phase V"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because PI uses AC voltage instead of DC voltage to prevent damage",
      "Because PI physically removes moisture by heating the windings",
      "Because PI tests the magnetic polarization of the rotor core",
      "Because PI tests the ratio of the 10-minute reading to the 1-minute reading, revealing whether the insulation is genuinely dry (PI > 2) or contaminated/wet (PI < 1), independent of temperature"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Heating too rapidly can cause trapped moisture inside the insulation to boil into steam, expanding and physically rupturing the varnish",
      "The heaters might reverse the residual magnetism",
      "The space heaters draw too much power from the emergency bus",
      "The heat will cause the copper windings to melt"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Wash the windings with high-pressure fresh water and detergent",
      "Blast the windings with high-pressure compressed air",
      "Vacuum the loose dust, then gently wipe with lint-free rags soaked in an approved, non-conductive, quick-drying electro-cleaner",
      "Scrub the windings aggressively with a wire brush"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To magnetize the iron core",
      "To permanently bond the rotor to the stator",
      "To melt the copper wire into a solid block",
      "To drive off the solvents and cure the resin, creating a hard, moisture-resistant, and mechanically solid protective shell"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are lifetime lubricated and never need replacement",
      "They are only replaced when the PT100 sensor triggers an alarm",
      "They must be replaced strictly according to the manufacturer's specified running hours (e.g., every 20,000 hours), regardless of how they look or sound",
      "They are replaced whenever the air gap increases by 1 mm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Thermal imaging of the stator frame",
      "Using a stroboscope on the cooling fan",
      "Vibration Analysis (taking readings of velocity and acceleration at the bearing housings)",
      "Megger testing the slip rings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inserting a 'slipper' (a piece of thick leather, presspan, or rigid plastic) into the bottom of the stator to physically shield the windings from being struck by the heavy rotor",
      "Applying 24V DC to the stator to magnetically repel the rotor",
      "Freezing the rotor with liquid nitrogen so it shrinks",
      "Coating the rotor completely in grease"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inductance; it creates a massive AC kickback voltage",
      "Capacitance; the winding acts like a giant capacitor and stores the 500V DC charge, creating a lethal shock hazard",
      "Resistance; the winding retains extreme heat from the test",
      "Residual Magnetism; it will instantly attract metal tools"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By shorting the phases directly to ground with a heavy screwdriver",
      "By waiting exactly 60 seconds for the charge to evaporate",
      "By connecting the AVR, which absorbs the shock",
      "First use a high-resistance discharge probe to bleed the voltage slowly without arcing, then apply solid earth clamps"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By manually turning the flywheel with a high-speed drill",
      "By disconnecting the magnetic pick-up unit (MPU) and connecting a frequency calibrator/signal generator to inject an AC sine wave of increasing frequency",
      "By shorting the MPU terminals rapidly with a jumper wire",
      "By applying varying DC voltage to the fuel actuator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Normal wear leaves the ring bright bare copper; sparking turns it green with oxidation",
      "There is no visual difference; it can only be measured with a micrometer",
      "Normal wear produces deep silver grooves; sparking produces a completely flat surface",
      "Normal wear produces a smooth, polished chocolate-brown patina; sparking produces a blackened, rough, pitted, or grooved surface"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Silicon carbide is highly conductive and causes short circuits",
      "Silicon carbide chemically reacts with copper to form explosive gases",
      "Silicon carbide particles are extremely hard; they break off and embed themselves in the soft copper, which then aggressively grinds away the carbon brushes",
  ...
  },
  {
    ...
    "opts": [
      "Loose connections allow moisture to enter the copper strands",
      "Loose connections cause the frequency to fluctuate",
      "Loose connections cause high resistance, which leads to intense localized heating (I\u00b2R losses) that can melt the terminals and start a fire",
      "Loose connections cause reverse power trips"
    ],
  ...
  {
    "q": "What happens if the sensing circuit of an AVR is accidentally opened while the alternator is running on load?",
    "a": "The AVR detects zero voltage and drives the excitation to maximum, causing severe overvoltage.",
    "opts": [
      "The AVR detects zero voltage and drives the excitation to maximum, causing severe overvoltage.",
      "The alternator immediately trips on under-voltage.",
      "The prime mover shuts down due to load rejection.",
      "The excitation drops to zero and the alternator loses output."
    ],
    "exp": "If the sensing line breaks, the AVR interprets this as a massive voltage drop. It responds by forcing maximum field current, leading to a dangerous overvoltage condition until the overvoltage protection relay trips.",
    "cat": "AVR",
    "id": "T01_Alternators_427",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the typical voltage regulation limit for a marine alternator under steady-state conditions per classification societies?",
    "a": "+/- 2.5% of rated voltage",
    "opts": [
      "+/- 1.0% of rated voltage",
      "+/- 2.5% of rated voltage",
      "+/- 5.0% of rated voltage",
      "+/- 10% of rated voltage"
    ],
    "exp": "Under steady-state load conditions, marine classification societies (like DNV, ABS) require the AVR to maintain the terminal voltage within +/- 2.5% of the rated voltage.",
    "cat": "AVR",
    "id": "T01_Alternators_428",
    "topic": "T01_Alternators"
  },
  {
    "q": "How does the AVR respond during a sudden application of a large inductive load, such as starting a bow thruster?",
    "a": "It rapidly increases excitation to compensate for the severe transient voltage dip.",
    "opts": [
      "It rapidly decreases excitation to prevent overspeed.",
      "It trips the preferential load circuit instantly.",
      "It rapidly increases excitation to compensate for the severe transient voltage dip.",
      "It relies on the governor to increase voltage."
    ],
    "exp": "Starting a large motor draws a heavy lagging current that demagnetises the alternator field (armature reaction), causing a voltage dip. The AVR detects this and instantly boosts excitation (field forcing) to restore voltage.",
    "cat": "AVR",
    "id": "T01_Alternators_429",
    "topic": "T01_Alternators"
  },
  {
    "q": "What component inside a modern solid-state AVR controls the exact amount of DC excitation current sent to the exciter stator?",
    "a": "A controlled thyristor (SCR) bridge or IGBT switching circuit",
    "opts": [
      "A motorized variable rheostat",
      "A magnetic amplifier (mag-amp)",
      "A controlled thyristor (SCR) bridge or IGBT switching circuit",
      "A heavy-duty carbon pile resistor"
    ],
    "exp": "Modern AVRs use power electronics, typically a thyristor bridge or IGBTs, which rapidly switch to chop or phase-angle control the AC supply, rectifying it into the precise DC current required by the exciter field.",
    "cat": "AVR",
    "id": "T01_Alternators_430",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the purpose of the 'volts per hertz' (V/Hz) limiter function in a marine alternator AVR?",
    "a": "To reduce excitation voltage proportionally if frequency drops, preventing magnetic saturation of the alternator core.",
    "opts": [
      "To increase voltage when the prime mover overspeeds.",
      "To automatically adjust the governor speed settings.",
      "To reduce excitation voltage proportionally if frequency drops, preventing magnetic saturation of the alternator core.",
      "To maintain exactly 440V even if the engine stalls."
    ],
    "exp": "If engine speed (frequency) drops significantly, maintaining full voltage would cause excessive magnetic flux (Phi = V/f). The V/Hz limiter drops the voltage reference to prevent core saturation and overheating.",
    "cat": "AVR",
    "id": "T01_Alternators_431",
    "topic": "T01_Alternators"
  },
  {
    "q": "What happens if two alternators are synchronized exactly 180 degrees out of phase?",
    "a": "A massive short circuit occurs, inducing extreme mechanical stress and potentially destroying the alternators.",
    "opts": [
      "They will instantly share the load equally.",
      "One alternator will run as a synchronous motor without damage.",
      "A massive short circuit occurs, inducing extreme mechanical stress and potentially destroying the alternators.",
      "The synchroscope will simply spin faster."
    ],
    "exp": "Closing the breaker out of phase creates a voltage difference equal to double the system voltage. This causes a massive circulating fault current, resulting in extreme electro-dynamic forces that can sheer the shaft or destroy windings.",
    "cat": "SY",
    "id": "T01_Alternators_432",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is the incoming alternator's frequency set slightly higher (e.g., 60.2 Hz) than the busbar frequency (60.0 Hz) before synchronizing?",
    "a": "So the incoming alternator picks up a small active load immediately upon closing the breaker.",
    "opts": [
      "To prevent the reverse power relay from tripping the busbar.",
      "So the incoming alternator picks up a small active load immediately upon closing the breaker.",
      "To ensure the synchroscope rotates anti-clockwise.",
      "To compensate for the voltage drop across the breaker."
    ],
    "exp": "Running slightly fast ensures the synchroscope rotates slowly in the 'FAST' direction. When the breaker closes, the higher speed translates into the incoming machine taking a positive kilowatt load, avoiding a reverse power trip.",
    "cat": "SY",
    "id": "T01_Alternators_433",
    "topic": "T01_Alternators"
  },
  {
    "q": "During synchronization, if the synchroscope pointer is rotating very rapidly, what does this indicate?",
    "a": "A large difference in frequency between the incoming alternator and the busbar.",
    "opts": [
      "A large difference in voltage.",
      "A large difference in frequency between the incoming alternator and the busbar.",
      "The phase sequence is incorrect.",
      "The power factor of the system is extremely low."
    ],
    "exp": "The speed of the synchroscope pointer's rotation is directly proportional to the difference in frequency (slip frequency) between the two sources. A fast rotation means the governor speed must be adjusted.",
    "cat": "SY",
    "id": "T01_Alternators_434",
    "topic": "T01_Alternators"
  },
  {
    "q": "In the 'three dark lamp' method of synchronization, when is the exact moment to close the breaker?",
    "a": "When all three lamps are completely dark, indicating zero voltage difference.",
    "opts": [
      "When all three lamps are at their brightest.",
      "When two lamps are bright and one is dark.",
      "When all three lamps are completely dark, indicating zero voltage difference.",
      "When the lamps are flashing rapidly."
    ],
    "exp": "In the 'dark' method, the lamps are connected across the same phases. When the voltages are exactly in phase and equal in magnitude, the potential difference across each lamp is zero, making them dark.",
    "cat": "SY",
    "id": "T01_Alternators_435",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the function of the 'Check Synchronizing Relay' (Sync Check Relay)?",
    "a": "It electrically prevents the breaker from closing unless voltage, frequency, and phase angle are within safe limits.",
    "opts": [
      "It automatically adjusts the governor speed to match the busbar.",
      "It electrically prevents the breaker from closing unless voltage, frequency, and phase angle are within safe limits.",
      "It tests the synchroscope lamps for blown bulbs.",
      "It trips the breaker if the generator runs in reverse power."
    ],
    "exp": "Even if an operator manually presses the 'Close' button at the wrong time, the Sync Check Relay acts as a vital safety interlock, blocking the closing signal if conditions aren't perfect.",
    "cat": "SY",
    "id": "T01_Alternators_436",
    "topic": "T01_Alternators"
  },
  {
    "q": "If you are synchronising using a digital synchroscope, at what position should you initiate the breaker closing command?",
    "a": "Just before the 12 o'clock position (e.g., 11 o'clock) to account for the breaker's mechanical closing time.",
    "opts": [
      "Exactly at 12 o'clock.",
      "Just before the 12 o'clock position (e.g., 11 o'clock) to account for the breaker's mechanical closing time.",
      "At 6 o'clock.",
      "When the pointer is stationary at 3 o'clock."
    ],
    "exp": "Circuit breakers have a mechanical operating time (usually 50-100 milliseconds). Initiating the close slightly before 12 o'clock ensures the contacts physically touch exactly at the 12 o'clock (0 degree) phase coincidence.",
    "cat": "SY",
    "id": "T01_Alternators_437",
    "topic": "T01_Alternators"
  },
  {
    "q": "When synchronising, the incoming voltage is matched to the busbar voltage using which control?",
    "a": "The Automatic Voltage Regulator (AVR) trimmer.",
    "opts": [
      "The prime mover governor.",
      "The Automatic Voltage Regulator (AVR) trimmer.",
      "The main switchboard bus-tie.",
      "The preferential trip relay."
    ],
    "exp": "Voltage is controlled by excitation. The operator uses the AVR voltage trimmer switch on the panel to adjust the incoming alternator's field current until its voltage perfectly matches the busbar.",
    "cat": "SY",
    "id": "T01_Alternators_438",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the typical consequence of a significantly unequal air gap around the circumference of an alternator?",
    "a": "Unbalanced magnetic pull (UMP) causing severe vibration and rapid bearing wear.",
    "opts": [
      "Decreased frequency output.",
      "Reversal of the phase sequence.",
      "Unbalanced magnetic pull (UMP) causing severe vibration and rapid bearing wear.",
      "The alternator will output DC instead of AC."
    ],
    "exp": "An unequal air gap means the magnetic flux is stronger on one side. This creates a massive Unbalanced Magnetic Pull that physically bends the rotor, causing extreme vibration and destroying the bearings.",
    "cat": "AG",
    "id": "T01_Alternators_439",
    "topic": "T01_Alternators"
  },
  {
    "q": "If the air gap of an alternator is found to be smaller at the bottom than at the top, what is the most likely cause?",
    "a": "Wear of the rotor shaft bearings.",
    "opts": [
      "A short-circuited stator coil.",
      "Wear of the rotor shaft bearings.",
      "Loss of residual magnetism.",
      "Over-excitation from the AVR."
    ],
    "exp": "Gravity pulls the heavy rotor down. If the main bearings wear out, the rotor physically drops, decreasing the air gap at the bottom and increasing it at the top.",
    "cat": "AG",
    "id": "T01_Alternators_440",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is the air gap of a synchronous alternator generally larger than that of an induction motor of similar size?",
    "a": "To increase the short-circuit ratio (SCR) and improve voltage stability under sudden load changes.",
    "opts": [
      "To allow more cooling air to pass through.",
      "To increase the short-circuit ratio (SCR) and improve voltage stability under sudden load changes.",
      "To reduce the amount of copper needed in the stator.",
      "To allow the rotor to spin faster."
    ],
    "exp": "A larger air gap increases magnetic reluctance, requiring more field current. This stiffens the magnetic field, improving voltage regulation and stability (a higher Short Circuit Ratio) when heavy loads are applied.",
    "cat": "AG",
    "id": "T01_Alternators_441",
    "topic": "T01_Alternators"
  },
  {
    "q": "How often should the alternator air gap be measured and recorded on a commercial vessel?",
    "a": "During major overhauls or whenever bearing wear is suspected, typically annually or during dry dock.",
    "opts": [
      "Every day before starting the engine.",
      "During major overhauls or whenever bearing wear is suspected, typically annually or during dry dock.",
      "Only when the alternator fails completely.",
      "Once every 10 years."
    ],
    "exp": "Air gap checks are a standard part of major preventative maintenance to monitor bearing condition and prevent catastrophic stator-rotor rubbing.",
    "cat": "AG",
    "id": "T01_Alternators_442",
    "topic": "T01_Alternators"
  },
  {
    "q": "When measuring the air gap with a feeler gauge, at how many positions around the circumference should readings be taken?",
    "a": "At least four equidistant points (Top, Bottom, Port, Starboard).",
    "opts": [
      "Only at the top.",
      "At least four equidistant points (Top, Bottom, Port, Starboard).",
      "Only at the bottom where wear is expected.",
      "At two points, 180 degrees apart."
    ],
    "exp": "Taking measurements at four equidistant points (0, 90, 180, 270 degrees) allows engineers to calculate the exact eccentricity and determine if the rotor is sitting perfectly central.",
    "cat": "AG",
    "id": "T01_Alternators_443",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the primary danger if the air gap reduces to zero while the alternator is running?",
    "a": "The rotor will physically rub against the stator, causing a catastrophic mechanical and electrical failure.",
    "opts": [
      "The alternator will simply stop generating voltage.",
      "The AVR will safely trip the breaker.",
      "The rotor will physically rub against the stator, causing a catastrophic mechanical and electrical failure.",
      "The frequency will increase uncontrollably."
    ],
    "exp": "A 'stator rub' is catastrophic. The friction melts the steel laminations, destroys the winding insulation, causes massive short circuits, and usually requires a complete rebuild of the alternator.",
    "cat": "AG",
    "id": "T01_Alternators_444",
    "topic": "T01_Alternators"
  },
  {
    "q": "What specialized tool can be used to measure the air gap on very large alternators without dismantling?",
    "a": "A long, non-magnetic feeler gauge (often brass or plastic).",
    "opts": [
      "A standard steel tape measure.",
      "A long, non-magnetic feeler gauge (often brass or plastic).",
      "A laser thermometer.",
      "A digital multimeter."
    ],
    "exp": "Non-magnetic feeler gauges are preferred to prevent the gauge from being attracted to residual magnetism in the core, which could give false 'snagging' feelings or leave metallic debris.",
    "cat": "AG",
    "id": "T01_Alternators_445",
    "topic": "T01_Alternators"
  },
  {
    "q": "If the maximum air gap reading is 3.2mm and the minimum is 2.8mm, what is the average air gap?",
    "a": "3.0 mm",
    "opts": [
      "3.2 mm",
      "2.8 mm",
    ...
    "exp": "The average is simply (3.2 + 2.8) / 2 = 3.0 mm. However, the 0.4mm difference indicates significant eccentricity that must be investigated.",
    "cat": "AG",
    "id": "T01_Alternators_446",
    "topic": "T01_Alternators"
  },
  {
    "q": "In high-speed turbo-alternators, how does the air gap design differ from low-speed diesel alternators?",
    "a": "Turbo-alternators generally have a much larger air gap to handle severe electro-dynamic forces and improve cooling.",
    "opts": [
      "Turbo-alternators have a much smaller air gap to increase efficiency.",
      "Turbo-alternators generally have a much larger air gap to handle severe electro-dynamic forces and improve cooling.",
      "They do not have an air gap.",
      "The air gap is filled with insulating oil."
    ],
    "exp": "High-speed cylindrical rotors in turbo-alternators face massive centrifugal forces and severe transient fault forces. A larger air gap 'stiffens' the machine electrically and provides space for high-velocity cooling air.",
    "cat": "AG",
    "id": "T01_Alternators_447",
    "topic": "T01_Alternators"
  },
  {
    "q": "What happens to the required excitation current if an alternator is rewound and the air gap is accidentally increased?",
    "a": "The required excitation current will increase to push the flux across the wider gap.",
    "opts": [
      "The required excitation current will decrease.",
      "The required excitation current will remain exactly the same.",
      "The required excitation current will increase to push the flux across the wider gap.",
      "The alternator will no longer require an AVR."
    ],
    "exp": "Air has a much higher magnetic reluctance than steel. A wider air gap means the exciter must supply more DC field current (more ampere-turns) to maintain the same magnetic flux density in the core.",
    "cat": "AG",
    "id": "T01_Alternators_448",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the typical time delay setting for a marine reverse power relay?",
    "a": "2 to 10 seconds, depending on the prime mover type.",
    "opts": [
      "Instantaneous (0 seconds).",
      "2 to 10 seconds, depending on the prime mover type.",
      "30 to 60 seconds.",
      "5 minutes."
    ],
    "exp": "A short time delay prevents nuisance tripping during transient load swings or synchronization bumps. Diesel engines usually have a 2-5 second delay, while steam turbines might have a 5-10 second delay.",
    "cat": "PR",
    "id": "T01_Alternators_449",
    "topic": "T01_Alternators"
  },
  {
    "q": "At what percentage of the alternator's rated power does a reverse power relay typically trip for a diesel generator?",
    "a": "Between 2% and 6% of rated power.",
    "opts": [
      "Between 50% and 60% of rated power.",
      "Between 2% and 6% of rated power.",
      "At exactly 0%.",
      "Between 15% and 20% of rated power."
    ],
    "exp": "A diesel engine requires very little power to be motored (turned by the alternator) when its fuel fails, usually around 2% to 6% of the alternator's rating. The relay must be sensitive enough to detect this.",
    "cat": "PR",
    "id": "T01_Alternators_450",
    "topic": "T01_Alternators"
  },
  {
    "q": "Which protection relay prevents a healthy running generator from being dragged down by a severe overload on the main busbar?",
    "a": "The Preferential Trip (Load Shedding) relay.",
    "opts": [
      "The Reverse Power relay.",
      "The Under-voltage relay.",
      "The Preferential Trip (Load Shedding) relay.",
      "The Excitation Loss relay."
    ],
    "exp": "When the generator load reaches a critical level (e.g., 95-105%), the preferential trip relay sequentially disconnects non-essential loads (like AC compressors or galley heaters) to prevent the generator from tripping entirely.",
    "cat": "PR",
    "id": "T01_Alternators_451",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the purpose of the Under-Voltage (UV) release coil fitted to the alternator circuit breaker?",
    "a": "To trip the breaker if voltage drops dangerously low, and to prevent the breaker from closing onto a dead busbar without power.",
    "opts": [
      "To measure the voltage for the MSB meters.",
      "To trip the breaker if voltage drops dangerously low, and to prevent the breaker from closing onto a dead busbar without power.",
      "To increase the excitation current.",
      "To supply power to the synchroscope."
    ],
    "exp": "The UV coil holds the breaker mechanism closed. If voltage falls (usually below 70-50%), the coil loses magnetic pull, and springs physically trip the breaker to protect motors from low-voltage stalling.",
    "cat": "PR",
    "id": "T01_Alternators_452",
    "topic": "T01_Alternators"
  },
  {
    "q": "According to SOLAS, how many hours of continuous operation must the emergency generator fuel tank support on a cargo ship?",
    "a": "At least 18 hours.",
    "opts": [
      "At least 6 hours.",
      "At least 12 hours.",
    ...
    "exp": "SOLAS Chapter II-1, Regulation 43 requires that cargo ships have an emergency source of electrical power capable of supplying essential services for a minimum of 18 hours.",
    "cat": "SOL",
    "id": "T01_Alternators_453",
    "topic": "T01_Alternators"
  },
  {
    "q": "Under SOLAS regulations, where must the emergency generator and its switchboard be located?",
    "a": "Above the uppermost continuous deck, outside the machinery casing, and aft of the collision bulkhead.",
    "opts": [
      "In the main engine room, next to the main switchboard.",
      "At the very bottom of the ship for stability.",
      "Above the uppermost continuous deck, outside the machinery casing, and aft of the collision bulkhead.",
      "In the engine control room."
    ],
    "exp": "To ensure survival during a catastrophic event (flooding or fire in the main engine room), SOLAS requires the emergency power source to be physically isolated and located high up in the ship's superstructure.",
    "cat": "SOL",
    "id": "T01_Alternators_454",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the primary function of the overspeed trip on a marine diesel alternator?",
    "a": "To instantly shut off the fuel supply if the engine exceeds its safe maximum RPM, preventing mechanical disintegration.",
    "opts": [
      "To open the main circuit breaker.",
      "To increase the cooling water flow.",
      "To instantly shut off the fuel supply if the engine exceeds its safe maximum RPM, preventing mechanical disintegration.",
      "To reduce the alternator voltage."
    ],
    "exp": "An overspeed event (like a sudden loss of all electrical load) causes the engine RPM to spike. The overspeed trip physically cuts the fuel rack to zero to prevent the flywheel and rotor from flying apart due to centrifugal force.",
    "cat": "OS",
    "id": "T01_Alternators_455",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the regulatory setting (as per Classification Societies) for the overspeed trip of a diesel generator?",
    "a": "115% of the rated synchronous speed.",
    "opts": [
      "105% of the rated synchronous speed.",
      "115% of the rated synchronous speed.",
      "150% of the rated synchronous speed.",
      "200% of the rated synchronous speed."
    ],
    "exp": "Classification societies (like Lloyd's Register) mandate that the overspeed protection must activate and shut down the prime mover before the speed exceeds 115% of the normal rated RPM.",
    "cat": "OS",
    "id": "T01_Alternators_456",
    "topic": "T01_Alternators"
  },
  {
    "q": "If a 60Hz, 4-pole alternator runs at 1800 RPM, at what exact RPM should the overspeed trip activate?",
    "a": "2070 RPM",
    "opts": [
      "1800 RPM",
      "1950 RPM",
    ...
    "exp": "The trip is set at 115%. Therefore, 1800 RPM x 1.15 = 2070 RPM.",
    "cat": "OS",
    "id": "T01_Alternators_457",
    "topic": "T01_Alternators"
  },
  {
    "q": "How is a mechanical overspeed trip typically constructed?",
    "a": "It uses spring-loaded flyweights on the rotating shaft that fly outward due to centrifugal force when speed is excessive.",
    "opts": [
      "It uses a digital frequency meter.",
      "It uses spring-loaded flyweights on the rotating shaft that fly outward due to centrifugal force when speed is excessive.",
      "It measures the exhaust gas temperature.",
      "It relies on the main AVR to measure voltage."
    ],
    "exp": "The most reliable overspeed trips are purely mechanical. Centrifugal force pushes the flyweights out against spring tension. At 115% speed, they extend far enough to strike a lever that trips the fuel rack.",
    "cat": "OS",
    "id": "T01_Alternators_458",
    "topic": "T01_Alternators"
  },
  {
    "q": "What must the ETO/Engineer do after a mechanical overspeed trip has activated before the engine can be restarted?",
    "a": "Manually reset the local mechanical trip lever on the engine.",
    "opts": [
      "Simply press the 'Start' button on the MSB.",
      "Change the lubricating oil.",
      "Manually reset the local mechanical trip lever on the engine.",
      "Replace the overspeed fuses."
    ],
    "exp": "Because an overspeed is a critical life-safety fault, the trip mechanism locks out mechanically. An engineer must physically go to the engine, investigate, and manually reset the trip latch before restarting.",
    "cat": "OS",
    "id": "T01_Alternators_459",
    "topic": "T01_Alternators"
  },
  {
    "q": "During routine testing, how is the overspeed trip tested without actually overspeeding the engine?",
    "a": "By using a special test lever to manually overcome the spring tension while running at rated speed.",
    "opts": [
      "By short-circuiting the alternator.",
      "By bypassing the governor completely.",
      "By using a special test lever to manually overcome the spring tension while running at rated speed.",
      "It is impossible; the engine must always be overspeeded to test."
    ],
    "exp": "Most marine engines have a manual trip test lever. Pressing this lever adds mechanical force to the flyweights, simulating centrifugal force, causing the trip to activate at normal running speed to verify the fuel cut-off mechanism.",
    "cat": "OS",
    "id": "T01_Alternators_460",
    "topic": "T01_Alternators"
  },
  {
    "q": "What happens to the alternator circuit breaker when the overspeed trip activates?",
    "a": "The breaker trips automatically due to the activation of the reverse power relay or under-frequency/under-voltage protection as the engine stops.",
    "opts": [
      "It remains closed and powers the busbar.",
      "The breaker trips automatically due to the activation of the reverse power relay or under-frequency/under-voltage protection as the engine stops.",
      "It increases its current rating.",
      "The breaker is physically destroyed."
    ],
    "exp": "When fuel is cut, the engine loses power and acts as a drag on the busbar (if running in parallel), which trips the Reverse Power relay. If running alone, the decaying voltage/frequency will trigger the Under-Voltage trip.",
    "cat": "OS",
    "id": "T01_Alternators_461",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is an electronic overspeed trip often fitted in addition to the mechanical trip on modern vessels?",
    "a": "To provide redundancy and allow for easier, safer testing via the engine control system.",
    "opts": [
      "To replace the governor.",
      "To control the AVR voltage.",
      "To provide redundancy and allow for easier, safer testing via the engine control system.",
      "To increase the engine's horsepower."
    ],
    "exp": "Electronic trips use magnetic pickup sensors measuring flywheel teeth. They provide a highly accurate, redundant safety layer and can often be tested electronically by injecting a frequency signal without risking actual engine overspeed.",
    "cat": "OS",
    "id": "T01_Alternators_462",
    "topic": "T01_Alternators"
  },
  {
    "q": "Can a faulty governor cause an overspeed trip?",
    "a": "Yes, if the governor linkage jams in the 'full fuel' position when the electrical load is suddenly removed.",
    "opts": [
      "No, governors only prevent underspeed.",
      "Yes, if the governor linkage jams in the 'full fuel' position when the electrical load is suddenly removed.",
      "No, the AVR controls the speed.",
      "Yes, but only if the alternator is operating at 50Hz."
    ],
    "exp": "If the main circuit breaker trips under heavy load (load rejection), the engine suddenly has no resistance. A healthy governor instantly cuts fuel. A jammed governor will leave fuel at maximum, causing immediate, dangerous overspeed.",
    "cat": "OS",
    "id": "T01_Alternators_463",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the difference between a load rejection test and an overspeed trip test?",
    "a": "Load rejection tests the governor's ability to maintain speed within limits; overspeed tests the ultimate safety shutdown.",
    "opts": [
      "They are the exact same test.",
      "Load rejection tests the AVR; overspeed tests the breaker.",
      "Load rejection tests the governor's ability to maintain speed within limits; overspeed tests the ultimate safety shutdown.",
      "Overspeed tests are only done in dry dock."
    ],
    "exp": "During a load rejection (100% to 0% load), the governor must catch the speed spike (usually keeping it below 110%) and settle back to 100%. If the governor fails, the overspeed trip acts as the final safety net at 115%.",
    "cat": "OS",
    "id": "T01_Alternators_464",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why must the overspeed trip mechanism operate independently of the normal governor?",
    "a": "So that a failure in the governor linkage or hydraulics does not prevent the overspeed safety shutdown.",
    "opts": [
      "To save manufacturing costs.",
      "Because they operate at different voltages.",
      "So that a failure in the governor linkage or hydraulics does not prevent the overspeed safety shutdown.",
      "To make it easier to synchronize."
    ],
    "exp": "SOLAS and Class rules mandate independent shutdown mechanisms. The overspeed trip operates a separate shut-off valve or physically forces the fuel racks to zero, bypassing the governor entirely.",
    "cat": "OS",
    "id": "T01_Alternators_465",
    "topic": "T01_Alternators"
  },
  {
    "q": "How does an electronic overspeed sensor (magnetic pickup) measure engine RPM?",
    "a": "It detects the passing teeth of the engine flywheel and generates a pulsed frequency signal proportional to speed.",
    "opts": [
      "It measures the exhaust gas velocity.",
      "It detects the passing teeth of the engine flywheel and generates a pulsed frequency signal proportional to speed.",
      "It measures the voltage output of the AVR.",
      "It uses a laser aimed at the propeller shaft."
    ],
    "exp": "A magnetic pickup (MPU) sits near the flywheel ring gear. Each passing steel tooth changes the magnetic field, inducing an AC voltage pulse. The control unit counts these pulses per second to calculate exact RPM.",
    "cat": "OS",
    "id": "T01_Alternators_466",
    "topic": "T01_Alternators"
  },
  {
    "q": "If an alternator is operating alone (single running) and the overspeed trip activates, what happens to the ship's power?",
    "a": "The ship experiences a complete blackout.",
    "opts": [
      "The emergency generator shares the load.",
      "The ship experiences a complete blackout.",
      "The batteries take over seamlessly.",
      "The voltage simply drops to 220V."
    ],
    "exp": "Because the single source of power has been shut down violently, the main busbar loses all voltage, resulting in a total blackout. The emergency generator will then auto-start after a brief delay.",
    "cat": "OS",
    "id": "T01_Alternators_467",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the typical output waveform of a magnetic pickup unit (MPU) used for overspeed sensing?",
    "a": "An AC sine wave whose frequency and amplitude increase with engine speed.",
    "opts": [
      "A constant 24V DC signal.",
      "A 4-20mA analog current loop.",
      "An AC sine wave whose frequency and amplitude increase with engine speed.",
      "A digital Modbus signal."
    ],
    "exp": "As the flywheel teeth pass the permanent magnet in the MPU, they generate an alternating current. Faster speed means teeth pass faster, increasing both the frequency (Hz) and the induced voltage magnitude.",
    "cat": "OS",
    "id": "T01_Alternators_468",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is it strictly prohibited to bypass an overspeed trip for continuous operation?",
    "a": "It removes the only protection against catastrophic mechanical failure and flywheel explosion.",
    "opts": [
      "It causes the AVR to burn out.",
      "It will drain the starting batteries.",
      "It removes the only protection against catastrophic mechanical failure and flywheel explosion.",
      "It violates MARPOL regulations."
    ],
    "exp": "Bypassing an overspeed trip puts the entire vessel and crew in severe danger. If the engine loses load, it will accelerate infinitely until the internal components literally tear themselves apart from centrifugal forces.",
    "cat": "OS",
    "id": "T01_Alternators_469",
    "topic": "T01_Alternators"
  },
  {
    "q": "During an actual overspeed event, what visual or audible indications occur on the Main Switchboard?",
    "a": "The frequency meter spikes, the breaker trips, and a specific 'Overspeed Trip' or 'Prime Mover Shutdown' alarm sounds.",
    "opts": [
      "Only the voltage meter drops.",
      "A 'Reverse Power' alarm is always the first indication.",
      "The frequency meter spikes, the breaker trips, and a specific 'Overspeed Trip' or 'Prime Mover Shutdown' alarm sounds.",
      "There are no indications on the MSB."
    ],
    "exp": "Before the breaker trips, the frequency meter on the MSB will briefly spike high. The automation system receives the trip signal from the engine and activates the designated overspeed alarms.",
    "cat": "OS",
    "id": "T01_Alternators_470",
    "topic": "T01_Alternators"
  },
  {
    "q": "What determines how active power (kW) is shared between two parallel alternators?",
    "a": "The speed droop settings of their respective prime mover governors.",
    "opts": [
      "The voltage settings on the AVRs.",
      "The speed droop settings of their respective prime mover governors.",
      "The size of their excitation currents.",
      "The physical size of the alternators."
    ],
    "exp": "Active power (kW) is purely a function of mechanical energy input. The governors must be adjusted to supply more or less fuel, which dictates how the kW load is shared across the busbar.",
    "cat": "LS",
    "id": "T01_Alternators_471",
    "topic": "T01_Alternators"
  },
  {
    "q": "What determines how reactive power (kVAR) is shared between two parallel alternators?",
    "a": "The excitation levels controlled by their respective Automatic Voltage Regulators (AVRs).",
    "opts": [
      "The speed droop settings of the governors.",
      "The amount of fuel injected into the engines.",
      "The excitation levels controlled by their respective Automatic Voltage Regulators (AVRs).",
      "The number of poles in the alternator."
    ],
    "exp": "Reactive power (kVAR) does no real work; it is the magnetizing power. It is shared by adjusting the AVR voltage trimmers. Increasing excitation on one machine makes it take on more reactive load.",
    "cat": "LS",
    "id": "T01_Alternators_472",
    "topic": "T01_Alternators"
  },
  {
    "q": "If two alternators are running in parallel and you increase the excitation on Generator 1, what happens?",
    "a": "Generator 1 takes on more reactive load (kVAR) and its power factor becomes more lagging.",
    "opts": [
      "Generator 1 takes on more active load (kW).",
      "Generator 1 takes on more reactive load (kVAR) and its power factor becomes more lagging.",
      "Generator 1 speeds up.",
      "Generator 2 trips on reverse power."
    ],
    "exp": "Raising the voltage setpoint via the AVR forces Generator 1 to supply more of the system's reactive current. The active load (kW) remains unchanged because fuel input hasn't changed.",
    "cat": "LS",
    "id": "T01_Alternators_473",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is 'isochronous' load sharing?",
    "a": "An electronic control mode where parallel generators share the load perfectly while maintaining exactly constant frequency (0% droop).",
    "opts": [
      "A mechanical mode that drops frequency as load increases.",
      "An electronic control mode where parallel generators share the load perfectly while maintaining exactly constant frequency (0% droop).",
      "A mode used only for emergency generators.",
      "A method of sharing reactive power only."
    ],
    "exp": "Modern power management systems (PMS) use electronic governors in isochronous mode. They continuously adjust fuel racks to share kW equally without letting the system frequency drop from exactly 50Hz or 60Hz.",
    "cat": "LS",
    "id": "T01_Alternators_474",
    "topic": "T01_Alternators"
  },
  {
    "q": "In a brushless excitation system, how is the DC field current transferred to the spinning main rotor?",
    "a": "Via a rotating rectifier assembly (diode bridge) mounted directly on the rotor shaft.",
    "opts": [
      "Through carbon brushes riding on slip rings.",
      "Through a high-voltage rotary transformer.",
      "Via a rotating rectifier assembly (diode bridge) mounted directly on the rotor shaft.",
      "By direct permanent magnets on the stator."
    ],
    "exp": "The exciter generates AC on the rotor. Instead of using slip rings to bring this out, a diode bridge is mounted on the shaft itself to rectify the AC into DC, feeding it directly to the main rotor poles.",
    "cat": "EX",
    "id": "T01_Alternators_475",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the function of the PMG (Permanent Magnet Generator) in a modern alternator's excitation system?",
    "a": "It provides a robust, independent, and isolated power supply to the AVR.",
    "opts": [
      "It charges the starting batteries.",
      "It provides a robust, independent, and isolated power supply to the AVR.",
      "It drives the cooling fan.",
      "It creates the main magnetic field for the stator."
    ],
    "exp": "A PMG sits on the end of the shaft. Its permanent magnets generate a reliable AC voltage that powers the AVR. This ensures the AVR always has power to force excitation, even during a massive short-circuit fault on the main busbar.",
    "cat": "EX",
    "id": "T01_Alternators_476",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is a PMG-excited alternator vastly superior at clearing short-circuit faults compared to a self-excited alternator?",
    "a": "The PMG maintains AVR power during the fault voltage dip, allowing the alternator to sustain high short-circuit current to trip the breaker.",
    "opts": [
      "The PMG absorbs the fault current safely.",
      "The PMG maintains AVR power during the fault voltage dip, allowing the alternator to sustain high short-circuit current to trip the breaker.",
      "The PMG automatically opens the main breaker.",
      "A PMG prevents short circuits from happening."
    ],
    "exp": "A self-excited AVR gets its power from the main output terminals. During a short circuit, terminal voltage drops to near zero, so the AVR loses power and excitation collapses. A PMG guarantees power to the AVR, sustaining fault current until the protection trips.",
    "cat": "EX",
    "id": "T01_Alternators_477",
    "topic": "T01_Alternators"
  },
  {
    "q": "If one diode in the rotating rectifier assembly fails and becomes open-circuit, what is the typical symptom?",
    "a": "Increased excitation current required from the AVR to maintain voltage, and slight rotor vibration.",
    "opts": [
      "Immediate loss of all voltage.",
      "Increased excitation current required from the AVR to maintain voltage, and slight rotor vibration.",
      "The frequency will drop significantly.",
      "The reverse power relay will trip."
    ],
    "exp": "An open diode reduces the efficiency of the 3-phase rectification. The AVR compensates by driving the exciter harder. The unbalanced magnetic field in the exciter rotor can also cause abnormal vibrations.",
    "cat": "EX",
    "id": "T01_Alternators_478",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the purpose of the surge suppressor (varistor) fitted across the rotating diode bridge?",
    "a": "To protect the diodes from high-voltage transient spikes induced by switching or faults.",
    "opts": [
      "To filter out harmonics for the MSB.",
      "To act as a backup diode.",
      "To protect the diodes from high-voltage transient spikes induced by switching or faults.",
      "To monitor the temperature of the rotor."
    ],
    "exp": "When a heavy load is switched or a fault clears, massive voltage spikes (transients) can be induced backward into the rotor. The varistor clamps these spikes, saving the sensitive silicon diodes from destruction.",
    "cat": "EX",
    "id": "T01_Alternators_479",
    "topic": "T01_Alternators"
  },
  {
    "q": "How can you test the rotating diodes on a brushless alternator?",
    "a": "The alternator must be stopped, and each diode tested individually using a multimeter on the diode test setting.",
    "opts": [
      "By measuring the output voltage while running.",
      "By checking the AVR output current.",
      "The alternator must be stopped, and each diode tested individually using a multimeter on the diode test setting.",
      "By using a megger at 1000V."
    ],
    "exp": "Because the diodes are on the spinning shaft, you cannot test them while running. You must stop the machine, open the exciter cover, lift one leg of each diode (to avoid parallel circuits), and test forward/reverse bias.",
    "cat": "EX",
    "id": "T01_Alternators_480",
    "topic": "T01_Alternators"
  },
  {
    "q": "What are the components of a 'self-excited' (shunt-excited) alternator system without a PMG?",
    "a": "The AVR takes its power directly from the alternator's main stator output terminals.",
    "opts": [
      "The AVR uses a separate DC battery bank.",
      "The AVR takes its power directly from the alternator's main stator output terminals.",
      "The AVR is powered by a small wind turbine.",
      "There is no AVR; voltage regulates naturally."
    ],
    "exp": "In self-excitation, the alternator relies on residual magnetism to build up initial voltage. Once running, the AVR taps off the main 440V output, steps it down, rectifies it, and feeds it to the exciter field.",
    "cat": "EX",
    "id": "T01_Alternators_481",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is 'field flashing' sometimes necessary on self-excited alternators?",
    "a": "To restore lost residual magnetism in the exciter core so the alternator can build up voltage on start-up.",
    "opts": [
      "To clean the slip rings.",
      "To clear a short circuit on the busbar.",
      "To restore lost residual magnetism in the exciter core so the alternator can build up voltage on start-up.",
      "To synchronize the alternator faster."
    ],
    "exp": "If the alternator sits idle for months or suffers a severe short circuit, it may lose its residual magnetism. Without it, the AVR has no initial voltage to work with. Flashing applies a brief DC battery voltage to the exciter field to 'jump-start' the magnetism.",
    "cat": "EX",
    "id": "T01_Alternators_482",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the typical output of the AVR sent to the exciter stator field?",
    "a": "A controlled, pulsating DC voltage.",
    "opts": [
      "A high voltage AC sine wave.",
      "A controlled, pulsating DC voltage.",
      "A 4-20mA analog signal.",
      "A constant 440V AC."
    ],
    "exp": "The AVR rectifies the AC supply and chops it (using thyristors) to produce a variable DC output. This DC creates the stationary magnetic field in the exciter.",
    "cat": "EX",
    "id": "T01_Alternators_483",
    "topic": "T01_Alternators"
  },
  {
    "q": "In a brushless alternator, the exciter stator produces a _______ field, and the exciter rotor produces _______ current.",
    "a": "Stationary DC / AC",
    "opts": [
      "Rotating AC / DC",
      "Stationary DC / AC",
    ...
    "exp": "The AVR feeds DC to the exciter stator, creating a stationary magnetic field. The exciter rotor spins through this field, generating AC, which is then rectified on the shaft by diodes.",
    "cat": "EX",
    "id": "T01_Alternators_484",
    "topic": "T01_Alternators"
  },
  {
    "q": "What does a 'diode failure monitor' relay detect on large brushless alternators?",
    "a": "Ripple in the exciter stator current caused by a blown rotating diode.",
    "opts": [
      "Low battery voltage.",
      "Excessive RPM.",
      "Ripple in the exciter stator current caused by a blown rotating diode.",
      "High temperature in the main stator."
    ],
    "exp": "When a rotating diode shorts or opens, the rectified DC on the rotor becomes uneven. This uneven magnetic field reflects back and induces a distinct AC ripple on top of the DC in the exciter stator, which the monitor detects.",
    "cat": "EX",
    "id": "T01_Alternators_485",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is a short-circuited rotating diode more dangerous than an open-circuited one?",
    "a": "It effectively short-circuits the exciter rotor, causing massive overload, rapid overheating, and potential exciter destruction.",
    "opts": [
      "It causes the voltage to spike to 1000V.",
      "It reverses the polarity of the alternator.",
      "It effectively short-circuits the exciter rotor, causing massive overload, rapid overheating, and potential exciter destruction.",
      "It makes the generator run backward."
    ],
    "exp": "An open diode just reduces efficiency. A shorted diode creates a dead short across the exciter armature phases. The AVR drives max excitation trying to build voltage, rapidly burning out the exciter windings.",
    "cat": "EX",
    "id": "T01_Alternators_486",
    "topic": "T01_Alternators"
  },
  {
    "q": "What happens during a blackout regarding the main engine cooling and lubrication?",
    "a": "All electrically driven pumps stop, risking severe overheating and bearing damage if not restored quickly.",
    "opts": [
      "They switch to pneumatic power automatically.",
      "They are maintained by the emergency generator.",
      "All electrically driven pumps stop, risking severe overheating and bearing damage if not restored quickly.",
      "The main engine safely cools down by natural convection."
    ],
    "exp": "The immediate danger of a blackout at sea is the loss of main engine Lube Oil (LO) and Jacket Cooling Water (JCW) pumps. Rapid restoration of power is critical to prevent the main engine from seizing.",
    "cat": "BT",
    "id": "T01_Alternators_487",
    "topic": "T01_Alternators"
  },
  {
    "q": "Upon a total blackout, what is the expected maximum time for the Emergency Generator to auto-start and come on load?",
    "a": "45 seconds",
    "opts": [
      "15 seconds",
      "45 seconds",
    ...
    "exp": "SOLAS regulations strictly mandate that the emergency generator must automatically start, reach rated voltage and frequency, and close its breaker to supply the emergency switchboard within 45 seconds.",
    "cat": "BT",
    "id": "T01_Alternators_488",
    "topic": "T01_Alternators"
  },
  {
    "q": "After power is restored to the main switchboard following a blackout, what is the 'Sequential Starting' system?",
    "a": "An automation system that restarts heavy machinery (like pumps) one by one with time delays to prevent overloading the generator.",
    "opts": [
      "A system that starts all generators at the same time.",
      "An automation system that restarts heavy machinery (like pumps) one by one with time delays to prevent overloading the generator.",
      "A manual procedure for closing breakers.",
      "A system that turns on emergency lighting."
    ],
    "exp": "If all pumps tried to start simultaneously when power returned, the massive combined starting current (inrush) would instantly trip the generator again. Sequential starting adds staggered timers (e.g., LO pump at 5s, JCW at 15s).",
    "cat": "BT",
    "id": "T01_Alternators_489",
    "topic": "T01_Alternators"
  },
  {
    "q": "If the main generators fail to auto-start during a blackout, how does the engineer restore power manually?",
    "a": "Start a generator locally or from the ECR, ensure voltage/frequency are stable, and manually close the main breaker.",
    "opts": [
      "Connect the emergency generator to the main switchboard.",
      "Start a generator locally or from the ECR, ensure voltage/frequency are stable, and manually close the main breaker.",
      "Wait for the shore power connection.",
      "Bypass the AVR and force excitation."
    ],
    "exp": "Manual intervention requires going to the generator panel, starting the prime mover, verifying the AVR has built up 440V at 60Hz, and pressing the manual 'Close' button for that generator's main circuit breaker.",
    "cat": "BT",
    "id": "T01_Alternators_490",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the function of the 'Bus-Tie' breaker connecting the Emergency Switchboard (ESB) to the Main Switchboard (MSB)?",
    "a": "It normally supplies the ESB from the MSB, but opens automatically during a blackout to isolate the ESB.",
    "opts": [
      "It allows the emergency generator to power the entire ship.",
      "It normally supplies the ESB from the MSB, but opens automatically during a blackout to isolate the ESB.",
      "It provides shore power to the MSB.",
      "It keeps the emergency generator running constantly."
    ],
    "exp": "Under normal conditions, the MSB powers the ESB through the interconnector (bus-tie). When the MSB loses power, this breaker trips to prevent the small emergency generator from trying to power the entire dead ship.",
    "cat": "BT",
    "id": "T01_Alternators_491",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why do essential pumps have a 'Low Voltage Release' (LVR) instead of a 'Low Voltage Protection' (LVP) circuit?",
    "a": "So they can automatically restart as soon as the sequential starting system restores power.",
    "opts": [
      "To prevent them from drawing too much current.",
      "So they can automatically restart as soon as the sequential starting system restores power.",
      "Because they operate at lower voltages.",
      "To require manual restarting by an engineer."
    ],
    "exp": "LVR (Low Voltage Release) contactors drop out during a blackout but their control switch remains 'ON'. When power returns, they are ready to be automatically restarted by the sequential timers. LVP requires manual resetting.",
    "cat": "BT",
    "id": "T01_Alternators_492",
    "topic": "T01_Alternators"
  },
  {
    "q": "During a blackout, how is emergency lighting and critical communication powered before the emergency generator starts?",
    "a": "By the 24V DC Transitional Source of Power (Emergency Batteries).",
    "opts": [
      "By small hand-crank generators.",
      "By the 24V DC Transitional Source of Power (Emergency Batteries).",
      "By residual magnetism in the MSB.",
      "By compressed air."
    ],
    "exp": "The 45 seconds before the emergency generator takes the load can be critical. A transitional battery bank instantly supplies uninterrupted DC power to emergency lights, GMDSS, and critical alarms.",
    "cat": "BT",
    "id": "T01_Alternators_493",
    "topic": "T01_Alternators"
  },
  {
    "q": "How do you synchronize the main generator to the emergency generator to restore the normal MSB to ESB feed?",
    "a": "You do not. You restore the MSB, then momentarily blackout the ESB to close the interconnector, or use an auto-sync return feature if fitted.",
    "opts": [
      "By using the synchroscope on the ESB.",
      "You do not. You restore the MSB, then momentarily blackout the ESB to close the interconnector, or use an auto-sync return feature if fitted.",
      "By manually pushing both breakers closed.",
      "By lowering the main generator voltage."
    ],
    "exp": "On most standard ships, the emergency generator is not designed to run in parallel with the main grid. To restore normal configuration, the emergency generator breaker is tripped, and the MSB-to-ESB tie breaker is closed.",
    "cat": "BT",
    "id": "T01_Alternators_494",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the very first action an engineer on watch should take upon hearing the blackout alarm?",
    "a": "Ensure the Emergency Generator has started and is supplying the ESB.",
    "opts": [
      "Run to the engine room and start the main engine.",
      "Ensure the Emergency Generator has started and is supplying the ESB.",
      "Call the Captain on the bridge.",
      "Reset all the breakers on the MSB."
    ],
    "exp": "Without the ESB, you have no steering, no emergency lights, and no automation power. Verifying the emergency generator is the critical first step before attempting to restore the main plant.",
    "cat": "BT",
    "id": "T01_Alternators_495",
    "topic": "T01_Alternators"
  },
  {
    "q": "If a massive short-circuit on the MSB caused the blackout, what must be done before restarting generators?",
    "a": "Isolate the faulty section of the switchboard to prevent tripping the next generator you start.",
    "opts": [
      "Immediately start all three generators.",
      "Connect the emergency generator to the MSB.",
      "Isolate the faulty section of the switchboard to prevent tripping the next generator you start.",
      "Increase the AVR voltage setting."
    ],
    "exp": "Closing a generator onto a dead busbar that has a solid short circuit will instantly trip the generator again and could cause severe damage or a fire. The fault must be isolated first.",
    "cat": "BT",
    "id": "T01_Alternators_496",
    "topic": "T01_Alternators"
  },
  {
    "q": "An alternator is running normally, but suddenly the kW load drops to zero while kVAR remains high. What is the fault?",
    "a": "The prime mover (diesel engine) has lost its fuel supply or tripped.",
    "opts": [
      "The AVR has failed.",
      "The rotating diodes have blown.",
      "The prime mover (diesel engine) has lost its fuel supply or tripped.",
      "The main breaker has opened."
    ],
    "exp": "Active power (kW) comes entirely from the engine's mechanical power. If kW drops to zero (or goes negative), the engine is no longer driving the alternator. Reactive power (kVAR) remains if the AVR is still providing excitation.",
    "cat": "FT",
    "id": "T01_Alternators_497",
    "topic": "T01_Alternators"
  },
  {
    "q": "Two alternators are in parallel. Generator 1 has 500kW and 100kVAR. Generator 2 has 500kW and 400kVAR. How do you balance the load?",
    "a": "Increase excitation (raise AVR voltage) on Gen 1, and decrease it on Gen 2.",
    "opts": [
      "Increase fuel to Gen 1.",
      "Increase excitation (raise AVR voltage) on Gen 1, and decrease it on Gen 2.",
      "Decrease fuel to Gen 2.",
      "Trip Gen 2's breaker."
    ],
    "exp": "The active load (kW) is already perfectly balanced at 500kW each. The reactive load (kVAR) is unbalanced. Adjusting the AVR voltage trimmers will shift the kVAR sharing without affecting the kW.",
    "cat": "FT",
    "id": "T01_Alternators_498",
    "topic": "T01_Alternators"
  },
  {
    "q": "What happens if a generator is mistakenly closed onto a live busbar without being synchronized?",
    "a": "A catastrophic phase-to-phase short circuit occurs, causing massive mechanical shock and breaker tripping.",
    "opts": [
      "The generator smoothly takes the load.",
      "The AVR automatically adjusts the phase angle.",
      "A catastrophic phase-to-phase short circuit occurs, causing massive mechanical shock and breaker tripping.",
      "Only the reverse power relay trips."
    ],
    "exp": "Closing out of phase means connecting two differing voltage waveforms. The voltage difference drives a massive circulating current, essentially acting as a dead short circuit, exerting immense torque on the engine shaft.",
    "cat": "FT",
    "id": "T01_Alternators_499",
    "topic": "T01_Alternators"
  },
  {
    "q": "The main generator breaker trips on 'Overcurrent'. What is the most likely cause?",
    "a": "A severe overload on the busbar, or a short circuit in the distribution network.",
    "opts": [
      "The engine ran out of fuel.",
      "The AVR voltage is set too low.",
      "A severe overload on the busbar, or a short circuit in the distribution network.",
      "The governor speed is too high."
    ],
    "exp": "Overcurrent protection (OCR) monitors the amps drawn from the stator. It trips if the ship's load exceeds the generator's rating for too long, or instantly if there is a massive short circuit.",
    "cat": "FT",
    "id": "T01_Alternators_500",
    "topic": "T01_Alternators"
  },
  {
    "q": "During operation, the alternator stator winding temperature alarm sounds. What is a common mechanical cause?",
    "a": "Clogged cooling air filters or a failed alternator cooling fan.",
    "opts": [
      "Low fuel pressure.",
      "A blown rotating diode.",
      "Clogged cooling air filters or a failed alternator cooling fan.",
      "Excessive residual magnetism."
    ],
    "exp": "Marine alternators are typically air-cooled. Dust, oil mist, or debris blocking the ventilation louvers restricts airflow, causing the I2R heat in the copper windings to build up rapidly.",
    "cat": "FT",
    "id": "T01_Alternators_501",
    "topic": "T01_Alternators"
  },
  {
    "q": "If the excitation is completely lost while an alternator is running in parallel, what happens?",
    "a": "It loses synchronism, acts as an induction generator, draws massive reactive current from the bus, and trips on overcurrent or loss-of-field.",
    "opts": [
      "It continues to share kW normally.",
      "It shuts down the prime mover.",
      "It loses synchronism, acts as an induction generator, draws massive reactive current from the bus, and trips on overcurrent or loss-of-field.",
      "It provides only 220V."
    ],
    "exp": "Without a magnetic field, the rotor cannot hold its magnetic lock with the stator. It accelerates above synchronous speed and draws heavy magnetising current from the healthy generators, threatening the whole grid.",
    "cat": "FT",
    "id": "T01_Alternators_502",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the function of the 'Under-Frequency' trip on an alternator?",
    "a": "To protect connected electric motors from drawing excessive current and overheating due to low frequency.",
    "opts": [
      "To prevent the alternator from overspeeding.",
      "To protect connected electric motors from drawing excessive current and overheating due to low frequency.",
      "To increase the AVR excitation.",
      "To start the standby generator."
    ],
    "exp": "Motor inductive reactance is proportional to frequency (Xl = 2*pi*f*L). If frequency drops, reactance drops, and motors draw huge currents. The under-frequency relay trips the main breaker to save the ship's motors.",
    "cat": "FT",
    "id": "T01_Alternators_503",
    "topic": "T01_Alternators"
  },
  {
    "q": "An alternator is vibrating excessively. Electrical parameters are normal. What is a likely cause?",
    "a": "Mechanical misalignment with the prime mover or a worn bearing.",
    "opts": [
      "A short-circuited stator.",
      "Mechanical misalignment with the prime mover or a worn bearing.",
      "A faulty AVR.",
      "Incorrect phase sequence."
    ],
    "exp": "If electrical parameters (voltage, current, power factor) are steady and balanced across all three phases, the vibration is almost certainly mechanical: bearing wear, coupling misalignment, or loose foundation bolts.",
    "cat": "FT",
    "id": "T01_Alternators_504",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why would an alternator fail to build up voltage upon starting?",
    "a": "Loss of residual magnetism, a blown fuse in the AVR circuit, or a faulty rotating diode.",
    "opts": [
      "The governor is set too high.",
      "Loss of residual magnetism, a blown fuse in the AVR circuit, or a faulty rotating diode.",
      "The preferential trip is active.",
      "The bus-tie breaker is open."
    ],
    "exp": "Voltage build-up relies on residual magnetism creating a tiny initial voltage, which the AVR uses to feed the exciter. If magnetism is gone, or the AVR path is broken, the voltage stays near zero.",
    "cat": "FT",
    "id": "T01_Alternators_505",
    "topic": "T01_Alternators"
  },
  {
    "q": "If the ship experiences severe voltage fluctuations (hunting) while in parallel, what should you check first?",
    "a": "The AVR stability adjustments (Gain and Damping) or loose connections in the voltage sensing lines.",
    "opts": [
      "The fuel filters on the engines.",
      "The AVR stability adjustments (Gain and Damping) or loose connections in the voltage sensing lines.",
      "The reverse power relay settings.",
      "The main air compressor starting circuit."
    ],
    "exp": "Voltage hunting is usually an unstable AVR loop. The AVR over-corrects a minor voltage change, creating a continuous oscillation. Adjusting the PID (Proportional-Integral-Derivative) stability pots on the AVR cures this.",
    "cat": "FT",
    "id": "T01_Alternators_506",
    "topic": "T01_Alternators"
  },
  {
    "q": "A diesel generator trips on 'Reverse Power'. What mechanical failure on the engine could cause this?",
    "a": "A clogged fuel filter, faulty fuel pump, or sticking governor linkage.",
    "opts": [
      "A blown cylinder head gasket.",
      "A clogged fuel filter, faulty fuel pump, or sticking governor linkage.",
      "A broken cooling water pump.",
      "A faulty AVR."
    ],
    "exp": "Reverse power happens when the engine stops pushing the alternator and instead gets dragged by it. Any mechanical issue that starves the engine of fuel (clogged filters, pump failure) will cause this.",
    "cat": "FT",
    "id": "T01_Alternators_507",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is 'single phasing' in an alternator context?",
    "a": "An open circuit in one of the three stator phase windings or main output cables.",
    "opts": [
      "Running only one generator at a time.",
      "An open circuit in one of the three stator phase windings or main output cables.",
      "The failure of the exciter rotor.",
      "Synchronising on only one phase."
    ],
    "exp": "If a cable lug burns off or a winding breaks, the alternator tries to supply 3-phase power through only 2 intact phases. This causes severe unbalance, vibration, and massive overheating in the remaining phases.",
    "cat": "FT",
    "id": "T01_Alternators_508",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the primary function of slip rings on an older, non-brushless alternator?",
    "a": "To transfer DC excitation current from the stationary AVR to the rotating main field winding.",
    "opts": [
      "To transfer AC power out to the switchboard.",
      "To transfer DC excitation current from the stationary AVR to the rotating main field winding.",
      "To act as a mechanical brake.",
      "To measure the RPM of the shaft."
    ],
    "exp": "Before brushless exciters, DC from the AVR was fed directly into the spinning rotor via stationary carbon brushes pressing against smooth copper or steel slip rings on the shaft.",
    "cat": "SR",
    "id": "T01_Alternators_509",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why do slip rings require regular maintenance compared to brushless systems?",
    "a": "The carbon brushes constantly wear down, producing conductive dust and requiring physical replacement.",
    "opts": [
      "They consume a lot of lubricating oil.",
      "The carbon brushes constantly wear down, producing conductive dust and requiring physical replacement.",
      "They operate at 6.6kV.",
      "They need to be magnetized manually."
    ],
    "exp": "The mechanical friction between the brush and the ring wears the carbon away. This dust can coat windings and cause insulation failure if not vacuumed, and the brushes themselves wear too short to make good contact.",
    "cat": "SR",
    "id": "T01_Alternators_510",
    "topic": "T01_Alternators"
  },
  {
    "q": "What causes 'sparking' or 'arcing' at the slip ring brushes?",
    "a": "Poor brush contact due to low spring pressure, worn brushes, or an uneven (grooved) slip ring surface.",
    "opts": [
      "Excessive voltage from the MSB.",
      "Poor brush contact due to low spring pressure, worn brushes, or an uneven (grooved) slip ring surface.",
      "The alternator running exactly at 60Hz.",
      "Too much lubrication on the rings."
    ],
    "exp": "If a brush bounces or doesn't press firmly, the DC current jumps the microscopic air gap, creating an arc. This intense heat pits the slip ring and rapidly destroys the brush.",
    "cat": "SR",
    "id": "T01_Alternators_511",
    "topic": "T01_Alternators"
  },
  {
    "q": "What should be done if a slip ring becomes deeply grooved or pitted?",
    "a": "It must be machined smooth (skimmed) on a lathe or using a special grinding block in situ.",
    "opts": [
      "Apply thick grease to fill the grooves.",
      "It must be machined smooth (skimmed) on a lathe or using a special grinding block in situ.",
      "Replace the AVR.",
      "Reverse the polarity of the DC current."
    ],
    "exp": "A damaged surface acts like a file, destroying new brushes instantly and causing severe sparking. Skimming restores a perfectly smooth, cylindrical surface for uniform brush contact.",
    "cat": "SR",
    "id": "T01_Alternators_512",
    "topic": "T01_Alternators"
  },
  {
    "q": "How is brush spring pressure typically checked?",
    "a": "Using a small specialized spring tension scale to ensure it matches the manufacturer's spec (e.g., 1.5 - 2.5 kg/cm2).",
    "opts": [
      "By pushing it with a finger.",
      "Using a small specialized spring tension scale to ensure it matches the manufacturer's spec (e.g., 1.5 - 2.5 kg/cm2).",
      "By measuring the voltage drop.",
      "By weighing the carbon brush."
    ],
    "exp": "Correct pressure is critical. Too much pressure causes rapid mechanical wear; too little causes bouncing and destructive electrical arcing. A tension scale provides an accurate measurement.",
    "cat": "SR",
    "id": "T01_Alternators_513",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is it important that carbon brushes slide freely in their holders?",
    "a": "So the spring can constantly push the brush down to maintain contact as the carbon wears away.",
    "opts": [
      "To allow cooling air to pass.",
      "So the spring can constantly push the brush down to maintain contact as the carbon wears away.",
      "To prevent the slip ring from spinning too fast.",
      "To allow them to act as a fuse."
    ],
    "exp": "If carbon dust mixes with humidity or oil, it forms a sticky paste that jams the brush in the holder. The brush wears down slightly, loses contact with the ring, and massive sparking ensues.",
    "cat": "SR",
    "id": "T01_Alternators_514",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the typical visual appearance of a healthy slip ring surface?",
    "a": "A uniform, highly polished, dark glossy brown or black film (patina).",
    "opts": [
      "Bright, shiny, bare copper.",
      "A uniform, highly polished, dark glossy brown or black film (patina).",
      "Rough and deeply scored.",
      "Covered in a thick layer of soot."
    ],
    "exp": "The 'patina' is a microscopic film of copper oxide, carbon, and moisture. It acts as a vital dry lubricant, reducing friction and wear while providing excellent electrical conductivity.",
    "cat": "SR",
    "id": "T01_Alternators_515",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why should you never mix different grades (hard vs soft) of carbon brushes on the same slip ring?",
    "a": "They have different electrical resistances and wear rates, causing unequal current sharing and localized overheating.",
    "opts": [
      "It looks unprofessional.",
      "They have different electrical resistances and wear rates, causing unequal current sharing and localized overheating.",
      "The AVR will not be able to read the voltage.",
      "It causes the alternator to run in reverse."
    ],
    "exp": "Current takes the path of least resistance. A softer brush might take 90% of the field current, instantly overheating and burning, while the hard brush takes almost nothing but damages the ring mechanically.",
    "cat": "SR",
    "id": "T01_Alternators_516",
    "topic": "T01_Alternators"
  },
  {
    "q": "When replacing a new carbon brush, what must be done before putting the alternator back on load?",
    "a": "'Bedding in' the brush using fine glass paper to match the exact curvature of the slip ring.",
    "opts": [
      "Soaking the brush in oil.",
      "'Bedding in' the brush using fine glass paper to match the exact curvature of the slip ring.",
      "Filing the brush flat.",
      "Megger testing the brush."
    ],
    "exp": "A new brush has a flat end. If run immediately, it only touches the ring at a tiny point, causing massive current density and sparking. 'Bedding' sands the brush face to match the ring's curve.",
    "cat": "SR",
    "id": "T01_Alternators_517",
    "topic": "T01_Alternators"
  },
  {
    "q": "What material is typically used to clean carbon dust from the slip ring area?",
    "a": "A specialized electro-cleaner solvent and a vacuum cleaner. Never use compressed air.",
    "opts": [
      "Water and soap.",
      "A specialized electro-cleaner solvent and a vacuum cleaner. Never use compressed air.",
      "High-pressure compressed air.",
      "Diesel fuel."
    ],
    "exp": "Blowing with compressed air forces the highly conductive carbon dust deep into the stator windings, causing catastrophic insulation failure. Always vacuum the dust away.",
    "cat": "SR",
    "id": "T01_Alternators_518",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is 'ghosting' on a slip ring?",
    "a": "Faint, shadowy imprints of the brush face on the ring, usually caused by standing idle with vibration or electrolytic action.",
    "opts": [
      "A software error in the AVR.",
      "Faint, shadowy imprints of the brush face on the ring, usually caused by standing idle with vibration or electrolytic action.",
      "Sparks that are invisible to the naked eye.",
      "A sign of a perfect patina."
    ],
    "exp": "When a machine sits idle, the hull vibrations cause the brushes to micro-rub the ring in one spot. This alters the surface resistance, causing pulsing current and further uneven wear when restarted.",
    "cat": "SR",
    "id": "T01_Alternators_519",
    "topic": "T01_Alternators"
  },
  {
    "q": "In an emergency, if a brush breaks and you have no exact spares, what is the temporary fix?",
    "a": "Sand down a larger brush of a similar grade to fit the holder, ensuring it slides freely.",
    "opts": [
      "Wrap copper wire around the slip ring.",
      "Sand down a larger brush of a similar grade to fit the holder, ensuring it slides freely.",
      "Run the alternator without excitation.",
      "Use a piece of wood."
    ],
    "exp": "While highly unadvisable for long-term use, an ETO can carefully file a slightly larger carbon brush to the correct dimensions so that it slides smoothly in the brass holder to restore critical power.",
    "cat": "SR",
    "id": "T01_Alternators_520",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the primary purpose of the Emergency Generator on a vessel?",
    "a": "To supply power to essential life-safety, navigation, and communication equipment if the main power completely fails.",
    "opts": [
      "To power the cargo cranes in port.",
      "To supply power to essential life-safety, navigation, and communication equipment if the main power completely fails.",
      "To act as a backup for the air conditioning.",
      "To provide extra power during heavy weather."
    ],
    "exp": "The emergency generator is a strictly regulated, independent power source designed solely to keep the ship safe, steerable, and able to call for help during a catastrophic blackout.",
    "cat": "EM",
    "id": "T01_Alternators_521",
    "topic": "T01_Alternators"
  },
  {
    "q": "Under SOLAS, how quickly must the emergency generator restore power to the Emergency Switchboard automatically?",
    "a": "Within 45 seconds.",
    "opts": [
    ...
    "exp": "The system must detect the blackout, crank the engine, start it, build up voltage and frequency, and close the breaker automatically within 45 seconds.",
    "cat": "EM",
    "id": "T01_Alternators_522",
    "topic": "T01_Alternators"
  },
  {
    "q": "Where must the emergency generator room be located?",
    "a": "Above the uppermost continuous deck, outside the main machinery space, and aft of the collision bulkhead.",
    "opts": [
      "In the lowest part of the engine room.",
      "Above the uppermost continuous deck, outside the main machinery space, and aft of the collision bulkhead.",
      "On the bridge.",
      "Inside the main switchboard room."
    ],
    "exp": "This isolation ensures that a catastrophic fire, explosion, or flooding event in the main engine room does not also destroy the emergency power source.",
    "cat": "EM",
    "id": "T01_Alternators_523",
    "topic": "T01_Alternators"
  },
  {
    "q": "What type of cooling system is typically used for the emergency generator?",
    "a": "An independent, self-contained air radiator system.",
    "opts": [
      "Seawater cooling from the main sea chest.",
      "An independent, self-contained air radiator system.",
      "Cooling from the main engine jacket water.",
      "Liquid nitrogen."
    ],
    "exp": "The emergency generator cannot rely on any main engine room systems (like central cooling pumps or sea chests). It must have its own radiator and engine-driven fan.",
    "cat": "EM",
    "id": "T01_Alternators_524",
    "topic": "T01_Alternators"
  },
  {
    "q": "SOLAS requires how many independent methods of starting the emergency generator?",
    "a": "At least two independent methods (e.g., primary battery and secondary hydraulic/spring/pneumatic starter).",
    "opts": [
      "Only one automated method.",
      "At least two independent methods (e.g., primary battery and secondary hydraulic/spring/pneumatic starter).",
      "Three methods.",
      "Only manual hand-cranking."
    ],
    "exp": "To ensure absolute reliability, if the primary starting batteries fail, a completely independent secondary system (like a pre-charged hydraulic accumulator or mechanical spring-starter) must be available.",
    "cat": "EM",
    "id": "T01_Alternators_525",
    "topic": "T01_Alternators"
  },
  {
    "q": "What equipment is typically powered by the Transitional Source of Power (Emergency Batteries) during the 45-second blackout window?",
    "a": "Emergency lighting, GMDSS radio, fire alarms, and vital steering gear control.",
    "opts": [
      "The main engine lube oil pumps.",
      "Emergency lighting, GMDSS radio, fire alarms, and vital steering gear control.",
      "The galley ovens.",
      "The bow thruster."
    ],
    "exp": "The batteries bridge the gap before the generator starts. They cannot power heavy motors, but they supply vital low-draw DC loads to prevent panic and maintain communication.",
    "cat": "EM",
    "id": "T01_Alternators_526",
    "topic": "T01_Alternators"
  },
  {
    "q": "How is the Emergency Switchboard (ESB) normally supplied with power when the ship is healthy?",
    "a": "Through the bus-tie interconnector directly from the Main Switchboard (MSB).",
    "opts": [
      "By running the emergency generator constantly.",
      "Through the bus-tie interconnector directly from the Main Switchboard (MSB).",
      "From the shore power connection only.",
      "From the emergency batteries via an inverter."
    ],
    "exp": "Running the small emergency generator 24/7 is inefficient and causes wear. Normally, the heavy MSB feeds the ESB via a tie-breaker. This breaker trips automatically upon blackout.",
    "cat": "EM",
    "id": "T01_Alternators_527",
    "topic": "T01_Alternators"
  },
  {
    "q": "Can the emergency generator be used to power the Main Switchboard (MSB) in port?",
    "a": "Generally yes, via a 'feedback' arrangement, but only during maintenance or dry dock when the ship is not at sea.",
    "opts": [
      "Yes, it is the preferred way to run the ship at sea.",
      "Generally yes, via a 'feedback' arrangement, but only during maintenance or dry dock when the ship is not at sea.",
      "No, it is physically impossible.",
      "Yes, but only to power the cargo pumps."
    ],
    "exp": "Some ships allow reverse feeding the MSB (or parts of it) from the ESB to run basic lighting and tools during a dead-ship dry dock. Interlocks prevent doing this when main generators are running.",
    "cat": "EM",
    "id": "T01_Alternators_528",
    "topic": "T01_Alternators"
  },
  {
    "q": "What happens if the emergency generator fails to start after the first cranking attempt?",
    "a": "The control logic will pause and automatically attempt to crank it again (usually up to 3 or 6 attempts total).",
    "opts": [
      "It triggers the CO2 system.",
      "The control logic will pause and automatically attempt to crank it again (usually up to 3 or 6 attempts total).",
      "It permanently locks out.",
      "It sounds the abandon ship alarm."
    ],
    "exp": "Auto-start logic includes multiple cranking cycles (e.g., 5 seconds crank, 5 seconds rest) to give the engine the best chance of firing before exhausting the starter battery.",
    "cat": "EM",
    "id": "T01_Alternators_529",
    "topic": "T01_Alternators"
  },
  {
    "q": "How often must the emergency generator be tested on load?",
    "a": "Typically weekly or monthly, as per the ship's Planned Maintenance System and flag state rules.",
    "opts": [
      "Only during the annual class survey.",
      "Typically weekly or monthly, as per the ship's Planned Maintenance System and flag state rules.",
      "Every day.",
      "Only when a real blackout occurs."
    ],
    "exp": "Regular on-load testing ensures the engine can actually take the rated load without stalling, validates the auto-start logic, and burns off carbon buildup in the diesel engine.",
    "cat": "EM",
    "id": "T01_Alternators_530",
    "topic": "T01_Alternators"
  },
  {
    "q": "What must be done to the emergency generator starting batteries?",
    "a": "They must be maintained fully charged by an automatic trickle charger powered from the ESB.",
    "opts": [
      "They must be discharged completely every week.",
      "They must be maintained fully charged by an automatic trickle charger powered from the ESB.",
      "They must be kept in the main engine room.",
      "They must be replaced every 6 months."
    ],
    "exp": "The starting batteries are the lifeline. The dedicated charger keeps them at 100% capacity. If the charger fails, an alarm is triggered.",
    "cat": "EM",
    "id": "T01_Alternators_531",
    "topic": "T01_Alternators"
  },
  {
    "q": "According to SOLAS, for a passenger ship, how long must the emergency generator fuel last?",
    "a": "At least 36 hours.",
    "opts": [
      "18 hours.",
      "At least 36 hours.",
    ...
    "exp": "Passenger ships carry a much higher life-safety risk and take longer to evacuate or rescue, so SOLAS mandates double the fuel capacity (36 hours) compared to cargo ships (18 hours).",
    "cat": "EM",
    "id": "T01_Alternators_532",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the purpose of the 'Dead Ship' starting capability?",
    "a": "To start the emergency generator manually even if absolutely every electrical battery and system on the ship is completely dead.",
    "opts": [
      "To start the main engine from the bridge.",
      "To start the emergency generator manually even if absolutely every electrical battery and system on the ship is completely dead.",
      "To sink the ship intentionally.",
      "To activate the EPIRB."
    ],
    "exp": "This is why secondary starting methods exist. A hydraulic hand pump allows an engineer to manually build pressure to turn a hydraulic starter motor, entirely independent of electricity.",
    "cat": "EM",
    "id": "T01_Alternators_533",
    "topic": "T01_Alternators"
  },
  {
    "q": "During a blackout, why does the Emergency Air Compressor start automatically?",
    "a": "To replenish the starting air receivers so the main diesel generators can be restarted.",
    "opts": [
      "To power pneumatic hand tools.",
      "To replenish the starting air receivers so the main diesel generators can be restarted.",
      "To blow the ship's whistle.",
      "To inflate the life rafts."
    ],
    "exp": "Main engines and main generators require compressed air to start. If the air bottles are empty during a blackout, the small emergency compressor (powered by the ESB) is the only way to get air to recover the ship.",
    "cat": "EM",
    "id": "T01_Alternators_534",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why is it important to ensure the emergency generator room louvers (air vents) open automatically?",
    "a": "To supply massive amounts of combustion air for the engine and cooling air for the radiator.",
    "opts": [
      "To let sunlight in.",
      "To supply massive amounts of combustion air for the engine and cooling air for the radiator.",
      "To vent exhaust gases.",
      "To allow crew members to escape."
    ],
    "exp": "A running diesel engine consumes huge volumes of air. If the automatic louvers fail to open, the room creates a vacuum, starving the engine of oxygen and causing the radiator to severely overheat.",
    "cat": "EM",
    "id": "T01_Alternators_535",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is the 'Auto-Start Relay' monitoring to determine if a blackout has occurred?",
    "a": "The voltage of the Main Switchboard (MSB) or the bus-tie interconnector.",
    "opts": [
      "The fuel level in the main engine.",
      "The voltage of the Main Switchboard (MSB) or the bus-tie interconnector.",
      "The speed of the ship.",
      "The temperature of the sea water."
    ],
    "exp": "An under-voltage relay constantly monitors the main busbar. If the voltage drops below a threshold (e.g., 50%) for a few seconds, it initiates the emergency generator start sequence.",
    "cat": "EM",
    "id": "T01_Alternators_536",
    "topic": "T01_Alternators"
  },
  {
    "q": "What prevents the Emergency Generator from trying to power the dead Main Switchboard during a blackout?",
    "a": "Electrical and mechanical interlocks on the bus-tie breaker ensure it trips before the emergency generator breaker closes.",
    "opts": [
      "A software firewall.",
      "Electrical and mechanical interlocks on the bus-tie breaker ensure it trips before the emergency generator breaker closes.",
      "The emergency generator is too small to reach the MSB.",
      "The crew must manually cut the cables."
    ],
    "exp": "Interlocks make it physically and electrically impossible for the ESB breaker and the MSB-to-ESB tie breaker to be closed at the same time during auto-operation, preventing catastrophic overloading.",
    "cat": "EM",
    "id": "T01_Alternators_537",
    "topic": "T01_Alternators"
  },
  {
    "q": "What is a 'Simulated Blackout Test'?",
    "a": "A routine test where the sensing voltage to the auto-start relay is deliberately interrupted to verify the entire 45-second auto-start and load sequence.",
    "opts": [
      "Turning off all lights on the ship.",
      "A routine test where the sensing voltage to the auto-start relay is deliberately interrupted to verify the entire 45-second auto-start and load sequence.",
      "Testing the batteries with a multimeter.",
      "Starting the generator manually."
    ],
    "exp": "By removing a test fuse in the sensing circuit, the automation 'thinks' a blackout occurred. The surveyor watches to ensure the bus-tie opens, the generator starts, and the breaker closes within 45s.",
    "cat": "EM",
    "id": "T01_Alternators_538",
    "topic": "T01_Alternators"
  },
  {
    "q": "Why does the emergency generator diesel engine often not have a complex cooling water system with sea water heat exchangers?",
    "a": "To keep it completely independent of the ship's sea water systems, ensuring it works even if the ship is dry or pumps fail.",
    "opts": [
      "Because sea water causes corrosion.",
      "To keep it completely independent of the ship's sea water systems, ensuring it works even if the ship is dry or pumps fail.",
      "Because it runs so efficiently it doesn't need cooling.",
      "To save space."
    ],
    "exp": "Absolute independence is key. An air-cooled radiator system only requires ambient air, so it works perfectly even if the ship's sea chests are blocked or the vessel is in dry dock.",
    "cat": "EM",
    "id": "T01_Alternators_539",
    "topic": "T01_Alternators"
  },
  {
    "q": "Does the emergency generator have a preferential trip (load shedding) system?",
    "a": "No, because all loads on the Emergency Switchboard are considered essential for survival.",
    "opts": [
      "Yes, it sheds lighting first.",
      "No, because all loads on the Emergency Switchboard are considered essential for survival.",
      "Yes, to protect the generator.",
      "Only on passenger ships."
    ],
    "exp": "Unlike the MSB, the ESB only supplies absolute necessities (steering, fire pumps, comms). You cannot 'shed' these loads in an emergency, so the generator is sized to handle all of them simultaneously.",
    "cat": "EM",
    "id": "T01_Alternators_540",
    "topic": "T01_Alternators"
  },
  {
    "q": "If the emergency generator is running and supplying the ESB, what happens when main power is restored to the MSB?",
    "a": "The emergency generator continues to supply the ESB until an engineer manually restores the bus-tie and shuts down the emergency generator.",
    "opts": [
      "It instantly shuts down and the bus-tie closes.",
      "The emergency generator continues to supply the ESB until an engineer manually restores the bus-tie and shuts down the emergency generator.",
      "The emergency generator automatically synchronizes with the MSB.",
      "The main generator trips."
    ],
    "exp": "For safety, returning to normal power is usually a manual operation. The engineer ensures the MSB is stable, trips the ESB breaker, closes the tie-breaker, and lets the emergency engine undergo a cool-down cycle.",
    "cat": "EM",
    "id": "T01_Alternators_541",
    "topic": "T01_Alternators"
  },
  {
    "q": "What kind of fuel is typically used in the emergency generator tank?",
    "a": "Marine Gas Oil (MGO) or Marine Diesel Oil (MDO), never Heavy Fuel Oil (HFO).",
    "opts": [
      "Heavy Fuel Oil (HFO).",
      "Marine Gas Oil (MGO) or Marine Diesel Oil (MDO), never Heavy Fuel Oil (HFO).",
      "Aviation Fuel.",
      "Lubricating Oil."
    ],
    "exp": "HFO requires heating and purification to flow and burn. In a dead-ship situation, there are no heaters. MGO is a light distillate that flows and ignites instantly from a cold start.",
    "cat": "EM",
    "id": "T01_Alternators_542",
    "topic": "T01_Alternators"
  }
]);