window.loadQuizzes("T16_SOLAS", [
  {
    ...
    "opts": ["\u00b15.0%", "\u00b110.0%", "\u00b12.5% of rated voltage", "\u00b11.5%"],
  ...
  },
  {
    ...
    "opts": ["\u00b110% dip, recovery within 5.0 seconds", "\u00b120% transient dip, recovering to \u00b13% within 1.5 seconds", "\u00b115% dip, recovery within 3.0 seconds", "\u00b130% dip, recovery within 1.0 second"],
  ...
  },
  {
    ...
    "opts": ["Below waterline for adequate cooling water pressure", "Inside ER enclosed in A-60 fire boundary", "Adjacent to bridge on navigating deck", "Above the uppermost continuous bulkhead deck and outside the main machinery space"],
  ...
  },
  {
    ...
    "a": "45 seconds",
    "opts": ["30 seconds", "45 seconds", "60 seconds", "90 seconds"],
  ...
  },
  {
    ...
    "a": "30 seconds",
    "opts": ["30 seconds", "45 seconds", "60 seconds", "15 seconds"],
  ...
  },
  {
    ...
    "opts": ["18 hours continuous at full emergency load", "36 hours continuous", "12 hours continuous", "24 hours continuous"],
  ...
  },
  {
    ...
    "opts": ["18 hours", "36 hours continuous at full emergency load", "48 hours", "72 hours"],
  ...
  },
  {
    ...
    "opts": ["Supercapacitor preventing voltage dips during bow thruster starting (5 seconds)", "Standby diesel running 18 hours if emergency generator fails", "UPS powering entire main switchboard for 1 hour", "Battery supplying essential lighting and communications for 30 minutes while emergency generator starts"],
  ...
  },
  {
    ...
    "opts": ["Flame retardant - self-extinguishes to prevent flame spread (circuit may fail)", "Halogen-free - emits zero toxic smoke when melted", "Heavily armoured - withstands direct mechanical impact", "Fire resistant - maintains circuit integrity during a fire (minimum 3 hours at 750\u00b0C)"],
  ...
  },
  {
    ...
    "opts": ["1 hour at 1000\u00b0C", "3 hours at 750\u00b0C while maintaining electrical circuit integrity", "30 minutes at 500\u00b0C", "12 hours at 200\u00b0C"],
  ...
  },
  {
    ...
    "opts": ["SOLAS II-2/10 - fire protection standards for crane hydraulics", "SOLAS III/20 - LSA requirements for crane safety nets", "SOLAS V/19 - navigation equipment for crane operators", "SOLAS II-1/3-13 - first mandatory global standard for shipboard cranes, winches and lifting appliances"],
  ...
  },
  {
    ...
    "opts": ["100% SWL", "125% of Safe Working Load (SWL) witnessed by class surveyor", "110% SWL", "150% SWL"],
  ...
  },
  {
    ...
    "opts": ["Maximum Breaking Strength (MBS)", "Ultimate tensile stress limit", "Date of last 5-year class renewal survey", "Safe Working Load (SWL) - permanently and legibly marked"],
  ...
  },
  {
    ...
    "opts": ["15 minutes for firefighting support", "30 minutes for enclosed space entry", "10 minutes of breathable air strictly for emergency escape only", "45 minutes for damage control work"],
  ...
  },
  {
    ...
    "opts": ["Entering enclosed spaces for routine inspections", "Fighting small electrical fires in engine room", "Backup medical oxygen for injured crew", "Escaping from a hazardous atmosphere to a safe area - NOT for firefighting or enclosed space entry"],
  ...
  },
  {
    ...
    "opts": ["Chapter II-2 (Fire Protection)", "Chapter III (Life-Saving Appliances)", "Chapter V (Safety of Navigation)", "Chapter II-1, Part D (Electrical Installations)"],
  ...
  },
  {
    ...
    "opts": ["Steering motors cannot catch fire due to Class H insulation", "Tripping causes hydraulic oil to boil and explode", "Emergency generator cannot handle sudden steering motor trips", "Losing steering during critical manoeuvring is more dangerous than burning out the steering motor"],
  ...
  },
  {
    ...
    "a": "3 to 12 minutes",
    "opts": ["1 to 5 minutes", "3 to 12 minutes", "10 to 20 minutes", "15 to 30 minutes"],
  ...
  },
  {
    ...
    "opts": ["Main generators restart and synchronise within 2 minutes", "Transitional battery powers full MSB for 10 minutes", "Vessel auto-anchors if power not restored in 5 minutes", "Emergency generator auto-starts and supplies emergency switchboard within 45 seconds of main power loss"],
  ...
  },
  {
    ...
    "opts": ["All ships >500 GT must install inclinometer connected to ECDIS", "Only passenger ships require inclinometer for stability monitoring", "Tankers only - to detect cargo shift during loading", "Containerships and bulk carriers \u22653000 GT must carry electronic inclinometer connected to VDR"],
  ...
  },
  {
    ...
    "opts": ["ISO 9001 (Quality Assurance)", "IEC 60079 (Explosion Proof)", "IEC 60332 (Flame Retardant)", "IEC 60331 (Fire Resistant)"],
  ...
  },
  {
    ...
    "opts": ["They must be completely Fire Resistant (IEC 60331)", "They must be painted with red intumescent paint", "They must be wrapped in asbestos insulation", "They must be Flame Retardant (IEC 60332) to ensure they do not propagate a flame along the cable run"],
  ...
  },
  {
    ...
    "opts": ["A fast-acting glass fuse must be installed to prevent hull magnetization", "An isolation switch must be fitted to allow megger testing", "No fuse, switch, or circuit breaker shall be fitted in any earthed conductor to ensure the hull earth connection is continuously maintained", "It must be protected by a 10-amp dedicated MCB"],
  ...
  },
  {
    ...
    "opts": ["They must be run exclusively inside the fuel oil double bottom tanks for cooling", "Where practicable, they must be routed clear of high fire risk areas (like galleys, laundries, and category A machinery spaces) to prevent a single fire from destroying them", "They must be routed through the center of the engine room for easiest maintenance access", "They must be bundled tightly with standard lighting cables to save space"],
  ...
  },
  {
    ...
    "a": "IEC 60079",
    "opts": ["IEC 60079", "MARPOL Annex VI", "IEC 60331", "IEC 60332"],
  ...
  },
  {
    ...
    "opts": ["Standard PVC releases highly toxic, dense, and corrosive smoke (Hydrogen Chloride) when burned, which is lethal in enclosed ship compartments", "Standard PVC cannot carry 60Hz alternating current", "Standard PVC is too heavy and affects the ship's stability", "Standard PVC dissolves when exposed to marine salt air"],
  ...
  },
  {
    ...
    "opts": ["It must be insulated from the ship's hull using rubber grommets", "It is only required to be earthed if the voltage exceeds 1000V", "All metal sheathing and armor must be electrically continuous and effectively earthed to the ship's hull at both ends (except for certain specific control signals)", "It must be removed before the cable is pulled through a bulkhead"],
  ...
  },
  {
    ...
    "opts": ["They must run through the same cable tray for neatness", "They must be taped together inside the same conduit", "They must both be routed through the engine casing", "They must be separated as widely as is practicable throughout their entire length to avoid simultaneous damage"],
  ...
  },
  {
    ...
    "opts": ["The hole can be filled with standard silicone sealant or expanding foam", "The bulkhead must be reinforced with extra steel plates", "The penetration must be sealed with a class-approved transit system (like Roxtec or MCT) to maintain the fire, smoke, and watertight integrity of the bulkhead", "The cable must be stripped of its armor at the penetration point"],
  ...
  },
  {
    ...
    "opts": ["Cables can be soldered as long as the area is ventilated", "Cable joints are strictly prohibited in hazardous areas unless absolutely necessary for repair, and even then, must be executed using specially approved, flameproof resin jointing kits", "Joints are allowed provided they are marked with red paint", "Standard wire nuts wrapped in electrical tape are acceptable"],
  ...
  },
  {
    ...
    "opts": ["Only circuits over 100 amps require protection", "Fuses are illegal on modern ships; only PLCs can limit current", "Every circuit must be protected by a fuse or circuit breaker of an appropriate rating, sized to clear short circuits before cable insulation damage occurs", "Overcurrent protection is optional if the cable is Fire Resistant"],
  ...
  },
  {
    ...
    "opts": ["They must have a special low-temperature outer sheath (e.g., EPR or specialized PVC) that will not crack or become brittle when flexed at sub-zero temperatures", "They are exempt from all SOLAS fire ratings", "They must be routed through the center of the room to avoid touching walls", "They must be wrapped in thermal heating tape"],
  ...
  },
  {
    ...
    "opts": ["Cables operating at different voltage levels should be routed in separate trays or separated by physical barriers to prevent high-voltage shorts into low-voltage systems and minimize EMI", "They must be twisted together to cancel out magnetic fields", "They can share the same tray if the 24V cable is painted yellow", "There are no separation rules if they are both flame retardant"],
  ...
  },
  {
    ...
    "opts": ["Cables must be glued to the bulkheads using marine epoxy", "Cables must be left loose so they can stretch when the ship bends", "Cables should hang freely from the deckhead to improve air cooling", "Cables must be effectively supported and secured (e.g., with stainless steel or UV-resistant nylon ties on trays) to prevent chafing and fatigue from ship vibration"],
  ...
  },
  {
    ...
    "opts": ["Used for emergency lighting; they must be run in completely different rooms", "Never; single core AC cables are strictly banned by SOLAS", "Used for bow thrusters; they must be separated by at least 1 meter", "Used for very high currents; all three phases must be bundled together in a trefoil (cloverleaf) formation to cancel out their massive individual magnetic fields"],
  ...
  },
  {
    ...
    "opts": ["The cable must be replaced with a wireless transmitter", "The cable must be cut and fitted with a slip-ring connector", "An expansion loop (a physical slack coil of cable) must be provided to absorb the stretching and compression of the hull without snapping the copper conductors", "The cable must be pulled as tight as possible to brace the joint"],
  ...
  },
  {
    ...
    "opts": ["The cable emits a high-pitched buzzing sound", "A low Insulation Resistance (IR) value, measured in Mega-Ohms using a 500V or 1000V Megger during routine survey checks", "The cable outer sheath changes color from black to grey", "The cable feels physically colder than ambient temperature"],
  ...
  },
  {
    ...
    "opts": ["Not exceeding 110V AC", "Not exceeding 50V AC or DC; typically 24V is used for hand lamps to eliminate the risk of lethal electrocution", "Not exceeding 12V AC", "Not exceeding 220V AC"],
  ...
  },
  {
    ...
    "opts": ["It ensures the cable can survive 1000\u00b0C for 3 hours while functioning", "It proves the cable is completely indestructible by fire", "It ensures that if a localized flame is applied to the cable, it will self-extinguish shortly after the external flame is removed, stopping the spread of fire", "It guarantees the cable releases zero toxic smoke"],
  ...
  },
  {
    ...
    "opts": ["The maximum safe current capacity of each cable is reduced (derated) because the bundle traps heat, preventing normal air cooling", "The frequency of the alternating current is reduced", "The cables are given a lower fire resistance classification", "The voltage of the cables drops due to magnetic interference"],
  ...
  },
  {
    ...
    "opts": ["Cross-linked polyethylene (XLPE)", "Asbestos-based insulation", "Polyvinyl chloride (PVC)", "Ethylene propylene rubber (EPR)"],
  ...
  },
  {
    ...
    "opts": ["The voltage increases slightly at the bend", "The cable generates excess harmonic distortion", "The cable functions better by creating a magnetic choke point", "The outer sheath cracks, the steel armor deforms, and the internal copper conductors can stretch or snap, severely degrading the cable's electrical and watertight integrity"],
  ...
  },
  {
    ...
    "opts": ["A logbook of how many meters of cable are onboard", "A list of the manufacturer warranties for the cables", "A record of the voltage drops across the ship's length", "A mandatory documented record tracking every single fire-sealed cable penetration (Multi-Cable Transit) on the ship, ensuring they are intact and pass survey inspections"],
  ...
  },
  {
    ...
    "opts": ["To keep the cables cool from the sea spray", "To prevent electromagnetic interference with the main engine", "To reduce the voltage drop from the emergency generator", "Because if the main engine room catches fire, the flames would burn the cable, disabling the emergency pump located in the bow just when it is needed most"],
  ...
  },
  {
    ...
    "opts": ["The voltage will double due to the saltwater's conductivity", "UV radiation will instantly melt the copper", "The cable will begin to generate static electricity", "Saltwater ingress; capillary action will suck the saltwater hundreds of meters down the inside of the cable, corroding the copper to green dust and causing dead shorts inside control panels"],
  ...
  },
  {
    ...
    "opts": ["It acts as a backup neutral conductor", "It conducts heat away from the copper core", "It provides crucial mechanical protection against physical impacts, crushing, and chafing, and acts as an earthed shield against electrical faults", "It prevents the cable from stretching when pulled"],
  ...
  },
  {
    ...
    "opts": ["Yes, they must be painted to match the bulkhead color for aesthetics", "Yes, but only with white paint", "Generally discouraged and often prohibited for specific cables; heavy paint can hide thermal damage, degrade the outer sheath chemically, and make cable identification codes illegible", "Yes, paint adds an extra layer of fire resistance"],
  ...
  },
  {
    ...
    "opts": ["The new cable must carry 220V to ensure a strong signal", "The new cable must be wrapped in lead foil", "The exact type, capacitance, and inductance ratings of the original cable must be perfectly matched, as the intrinsically safe safety barrier relies on these specific cable properties to prevent sparks", "Any cable is fine as long as it is thicker than the original"],
  ...
  },
  {
    ...
    "opts": ["It emits a pleasant-smelling gas when overheated to warn the crew", "It contains no copper, making it significantly lighter", "It contains no halogens (like chlorine or fluorine); when it burns, it does not release toxic, acidic gases that would blind and suffocate evacuating passengers and destroy electronics", "It is completely immune to catching fire under any circumstance"],
  ...
  },
  {
    ...
    "opts": ["To prevent the VFD from overheating the data cables", "To prevent Electromagnetic Interference (EMI); the high-frequency switching noise of the VFD can easily induce false voltages in the data cables, corrupting network communication", "Because the 24V cables will draw power from the VFD cables wirelessly", "Because SOLAS bans DC and AC cables from being in the same room"],
  ...
  },
  {
    ...
    "opts": ["All engine room cranes must be upgraded to fully automated robotic systems", "All deck cranes must be removed from cargo ships", "Lifting appliances and anchor handling winches are brought directly under SOLAS statutory regulation; defects can now result in PSC detention via the Safety Construction Certificate", "Cranes can only be operated by specialized shore personnel"],
  ...
  },
  {
    ...
    "opts": ["100% of the SWL", "150% of the SWL", "125% of the Safe Working Load (SWL)", "200% of the SWL"],
  ...
  },
  {
    ...
    "opts": ["The name of the shipyard that built the crane", "The date of the last oil change painted on the boom", "A QR code linking to the manufacturer's website", "A permanent, highly visible marking of its Safe Working Load (SWL) in tonnes, clearly legible from the operator's control position"],
  ...
  },
  {
    ...
    "opts": ["The crane must display a clear, permanent load chart showing the specific SWL at each distinct operating radius", "It must be marked with the lowest possible weight to be safe", "It must be marked with the absolute maximum weight it can lift at its shortest radius", "It only needs a digital load readout; physical markings are banned"],
  ...
  },
  {
    ...
    "opts": ["The Hoist Overload limit switch (or load cell system), which automatically cuts power to the 'Hoist UP' contactor if the load exceeds the SWL", "The Thermal Overload Relay on the motor", "The Anemometer (wind speed sensor)", "The Slack Rope switch"],
  ...
  },
  {
    ...
    "opts": ["Yes, it covers all lifting appliances used onboard, including Engine Room overhead cranes, which must be load tested and permanently marked with their SWL", "Only if the engine room crane is capable of lifting over 10 tonnes", "No, engine room cranes are exempt if they are manually operated", "No, it strictly applies only to cargo cranes on the weather deck"],
  ...
  },
  {
    ...
    "opts": ["It prevents the crane from slewing more than 360 degrees", "It cuts power to the 'Hoist UP' contactor just before the massive hook block physically smashes into the top sheaves of the boom (Two-Blocking)", "It automatically stops the hook when it touches the deck", "It prevents the load from swaying in high winds"],
  ...
  },
  {
    ...
    "opts": ["It stops the drum from paying out more wire when only 3-5 wraps are left, preventing the wire from completely detaching from the drum clamp and falling", "It prevents the crane from lowering loads heavier than the SWL", "It engages the mechanical brake permanently when the load is set down", "It stops the motor when the hook touches the water"],
  ...
  },
  {
    ...
    "opts": ["It detects that the wire has lost tension (e.g., the load hit the deck) and immediately cuts the 'Hoist DOWN' circuit to prevent the wire from spooling off the drum and tangling (bird-nesting)", "It triggers the general ship alarm", "It drops the load instantly to prevent the crane from tipping", "It increases the motor speed to tighten the rope"],
  ...
  },
  {
    ...
    "opts": ["The brake drops the load slowly to the ground using a hydraulic dampener", "The brake is heavily spring-applied (held ON by physical force) and electrically released; any power failure causes the brake to clamp shut instantly and hold the load", "The brake uses a magnetic field to physically push the pads against the rotor", "The brake relies on a battery backup to engage during a blackout"],
  ...
  },
  {
    ...
    "opts": ["The magnetic coil may lack the strength to pull the armature across the wide gap; the brake will fail to release, causing the motor to stall, overheat, and trip on overload", "The magnetic field will permanently magnetize the motor shaft", "The brake will engage too quickly, snapping the wire rope", "The crane will automatically run at double speed"],
  ...
  },
  {
    ...
    "opts": ["A photograph of the crane lifting a container", "A valid Register of Lifting Appliances and Cargo Handling Gear, containing the certificates of the 5-yearly dynamic proof load tests and annual inspections", "A receipt of purchase for the crane's wire ropes", "A signed letter from the Chief Engineer stating the crane works"],
  ...
  },
  {
    ...
    "opts": ["It detects explosive gases venting from the cargo holds", "It cools the main hoist motor during heavy lifting", "It continuously measures wind speed; if the wind exceeds the safe operational limit (e.g., 20 m/s), it sounds an alarm and electronically disables further crane operations to prevent tipping", "It measures the angle of the ship's heel during loading"],
  ...
  },
  {
    ...
    "opts": ["It uses the mechanical EM brake to grind the load to a halt", "It vents compressed air to cool the VFD cabinet", "It reverses the phases instantly to stop the motor", "Using a Dynamic Braking Resistor (DBR) or regenerative unit; the motor acts as a generator, and the VFD dumps the electrical energy into massive resistor banks as heat to slow the load"],
  ...
  },
  {
    ...
    "opts": ["The hydraulic fluid will boil and burst the hoses", "The crane's Power Limit system (or hydraulic cross-sensing) will automatically scale back the speed of both functions to prevent stalling the main electric drive motor", "The crane will instantly trip and engage the EM brakes", "The crane will execute the hoist first, then slew second"],
  ...
  },
  {
    ...
    "opts": ["It ensures the crane cabin stays perfectly level when the ship rolls", "It pumps hydraulic oil between tanks to balance the crane's weight", "It automatically pays out or heaves in the hoist wire as the jib moves up or down, ensuring the heavy load travels perfectly horizontally without crashing into the deck or swinging wildly", "It automatically adjusts the ship's ballast system"],
  ...
  },
  {
    ...
    "opts": ["They are explicitly exempt from all SOLAS regulations", "They must be operable remotely from the company headquarters ashore", "They are now treated as statutory lifting appliances; they must be load-tested, SWL marked, and integrated into the ship's formal certification scheme", "They must be replaced with completely hydraulic systems"],
  ...
  },
  {
    ...
    "opts": ["They must drive the crane physically along the deck tracks while loaded", "They must merely lift the weight 10 centimeters off the deck for 5 seconds", "They must hoist the 125% test weight, slew it through its full operational arc, luff the jib to minimum and maximum radius, and demonstrate that the brakes can halt and hold the load mid-air", "They must lift the weight and immediately drop it into the sea"],
  ...
  },
  {
    ...
    "opts": ["A switch that forces the crane to return to its parking station", "An alarm that rings on the bridge continuously", "A switch that turns on the emergency lighting", "A door limit switch that cuts the main power contactor to the crane if the door is open, preventing someone from walking onto the high crane tracks while it is moving"],
  ...
  },
  {
    ...
    "opts": ["The SWL of the crane must be permanently reduced by 10%", "The entire crane must undergo a 125% proof load test immediately", "The wire must be painted bright yellow for visibility", "The new wire rope must come with a valid manufacturer's test certificate, and the appliance should be operationally tested before being returned to service"],
  ...
  },
  {
    ...
    "opts": ["It uses radar to prevent the crane from hitting shore-based structures", "It uses sensors (encoders or limit switches) to track the position of adjacent crane jibs; if they swing too close to each other, it automatically stops the slewing motion to prevent a mid-air collision", "It prevents the load from swaying into the ship's own funnel", "It tracks the movement of tugboats alongside the ship"],
  ...
  },
  {
    ...
    "opts": ["The surveyor will simply make a note in the logbook", "The surveyor will manually lower the SWL limit by 50%", "The crane will be red-tagged (prohibited from use) and it may trigger a deficiency on the ship's Safety Construction Certificate, potentially detaining the vessel until repaired", "The surveyor will fine the ETO personally"],
  ...
  },
  {
    ...
    "opts": ["By shorting the 4-20mA wires together to simulate maximum weight", "By guessing the weight of a container and turning a screw until it trips", "By relying solely on the factory default settings", "By hoisting a known, certified test weight (e.g., 100% and 110% of SWL) and adjusting the amplifier or PLC software parameters until the system trips accurately at the overload point"],
  ...
  },
  {
    ...
    "opts": ["Because they are large electromagnets; if the air gap is too large, the coil draws massive 'pull-in' current for too long, overheating and melting the internal insulation", "Because they operate on low-voltage 24V DC", "Because they are physically hit by the swinging load", "Because sea spray chemically reacts with the copper winding"],
  ...
  },
  {
    ...
    "opts": ["The crane's Phase Failure Relay will instantly detect the imbalance and trip the main contactor, protecting the massive hoist and slew motors from single-phasing and burning out", "The VFD will generate its own third phase artificially", "The EM brake will release permanently", "The crane will operate perfectly but at 66% speed"],
  ...
  },
  {
    ...
    "opts": ["It hard-cuts the control power to the main line contactor; all motors instantly lose power, and all EM brakes slam shut simultaneously, freezing the crane in place", "It sounds the ship's general alarm and drops the anchor", "It sends an email to the port authority requesting assistance", "It gently lowers the load to the deck before shutting down"],
  ...
  },
  {
    ...
    "opts": ["They must hook the emergency generator directly to the EM brake", "They wait for a shore crane to come and lift it off", "Most cranes have a 'Manual Brake Release' lever or hydraulic hand-pump mechanism; the operator carefully uses this to manually lift the brake pads, allowing gravity to slowly lower the load to the deck", "They must cut the wire rope with an oxy-acetylene torch"],
  ...
  },
  {
    ...
    "opts": ["Fill the slip ring housing with heavy grease", "Paint the slip rings with an anti-corrosive coating", "Inspect the carbon brushes for wear, check spring tension, and ensure the copper/brass slip rings are clean, smooth, and free of heavy grooving or carbon dust buildup", "Megger test the slip rings at 5000V DC"],
  ...
  },
  {
    ...
    "opts": ["It is frequently submerged in seawater", "It is made of low-quality aluminum instead of copper", "It is subjected to constant twisting, torsion, and physical stress every time the crane slews; over time, this fatigue can snap the internal copper conductors or damage the insulation", "It gets too hot from the sun"],
  ...
  },
  {
    ...
    "opts": ["A printout of the PLC's software code", "A PMS logbook entry confirming that the ETO physically drove the crane to its extreme limits (up/down, left/right) to prove that the switches reliably cut the power before mechanical collision occurred", "A certificate from the factory where the switches were built", "A receipt showing new switches were purchased"],
  ...
  },
  {
    ...
    "opts": ["The Cargo Ship Safety Equipment Certificate (SEC) and the Safety Construction Certificate (SCC)", "The International Ship Security Certificate (ISSC)", "The Maritime Labour Certificate (MLC)", "The Bill of Lading"],
  ...
  },
  {
    ...
    "opts": ["The crew's internet usage logs", "The daily temperature logs of the main engine exhaust", "Insulation Resistance (Megger) logs for all major motors and generators, Emergency Generator test logs, battery specific gravity/load test logs, and the general Planned Maintenance System (PMS) records", "The radar target tracking history logs"],
  ...
  },
  {
    ...
    "opts": ["Turn on all the ship's pumps at the same time until the breaker trips naturally", "Use a multimeter to measure the resistance of the breaker contacts", "Rack out the ACB to the 'Test' position, connect a secondary injection test kit to the CT terminals, and inject high currents (e.g., 150%, 200%, 600% of rated) to verify the relay trips at the exact time shown on its IDMT curve", "Press the red 'TRIP' button on the front of the panel"],
  ...
  },
  {
    ...
    "opts": ["Virtually instantaneous (typically less than 0.1 seconds), as this represents a massive dead short-circuit fault", "It should never trip at 600%; it should just sound an alarm", "5 minutes", "15 to 20 seconds"],
  ...
  },
  {
    ...
    "opts": ["Within \u00b11% of rated voltage", "Within \u00b110% of rated voltage", "Within \u00b12.5% of the rated voltage for all load conditions from no-load to full load", "Within \u00b15% of rated voltage"],
  ...
  },
  {
    ...
    "opts": ["When a massive load is suddenly switched on or off, the voltage must recover to within \u00b13% of the rated voltage within 1.5 seconds (commonly cited as 2 seconds in orals)", "The voltage must never drop at all; it must be held perfectly flat", "The generator must trip instantly to protect the load", "The voltage must recover within 10 seconds"],
  ...
  },
  {
    ...
    "opts": ["By manually turning off the AVR switch", "By throwing a bucket of water on the generator casing", "By running the generator at a steady load, then suddenly 'Throwing-On' a massive load (like a massive cooling pump started Direct-On-Line) while monitoring the voltage dip and recovery time on a fast-acting meter or oscilloscope", "By shorting out the main busbars"],
  ...
  },
  {
    ...
    "opts": ["\u00b110% of rated frequency", "\u00b11% of rated frequency", "\u00b15% of the rated frequency (e.g., \u00b13 Hz on a 60Hz system)", "Frequency is allowed to drift freely depending on the load"],
  ...
  },
  {
    ...
    "opts": ["It must be capable of putting the rudder from 35\u00b0 on one side to 30\u00b0 on the other side in not more than 28 seconds, with the ship at its deepest draught and maximum ahead service speed", "It must turn the rudder 90 degrees in 10 seconds", "It must automatically steer the ship to the nearest port if abandoned", "It must be capable of holding the rudder steady during a hurricane"],
  ...
  },
  {
    ...
    "opts": ["It depends entirely on the ship's length, not GT", "At least two independent power units; if one fails, the other must be capable of maintaining steering capability immediately", "One massive unit is sufficient", "Four small units connected in series"],
  ...
  },
  {
    ...
    "opts": ["The bridge must steer using a manual hand-crank", "The standby unit must automatically start and come online within 45 seconds to restore steering pressure", "The rudder locks in place permanently", "The ship drops anchor automatically"],
  ...
  },
  {
    ...
    "opts": ["It only needs to be tested if the captain suspects a fault", "Within 12 hours before departure, the entire steering gear must be checked and tested, including full movement from bridge/local control, changeover between units, and all alarms", "It must be tested while the ship is moving at 5 knots", "It must be tested once a month"],
  ...
  },
  {
    ...
    "opts": ["Warning Indication for Dangerous Atmospheric Substances; SOLAS Chapter VII", "Water Ingress Detection and Alarm System; mandated by SOLAS Chapter XII (Additional Safety Measures for Bulk Carriers)", "Weather Indicator and Data Alert System; SOLAS Chapter V", "Wired Internal Distress Alarm System; SOLAS Chapter IV"],
  ...
  },
  {
    ...
    "opts": ["Floating freely on top of the cargo", "Embedded in the outer hull plating", "At the very top of the hatch coaming", "They must be positioned to trigger alarms when the water level reaches 0.5 meters above the inner bottom, and a second alarm at no less than 15% of the hold depth (max 2 meters)"],
  ...
  },
  {
    ...
    "opts": ["Inside the ship's funnel", "In the Master's cabin and the galley", "Inside the main engine lube oil sump", "In any ballast tank forward of the collision bulkhead (Forepeak tank) and any dry/void space extending forward of the foremost cargo hold"],
  ...
  },
  {
    ...
    "opts": ["Magnetic float switches in heavy protective cages, or electrochemical conductivity probes that detect when seawater bridges the gap between two electrodes", "Acoustic sonar pingers", "Thermal cameras that look for cold water", "Optical lasers that measure the distance to the floor"],
  ...
  },
  {
    ...
    "opts": ["A hand-cranked generator located on the bridge", "A battery bank capable of automatically supplying emergency lighting, navigation lights, and internal comms for a minimum of 30 minutes during the time the emergency generator is starting up", "A dedicated solar panel array", "A massive supercapacitor that runs the main engine for 1 minute"],
  ...
  },
  {
    ...
    "opts": ["Ask the captain if his cabin lights are on", "Wait 45 seconds and see if the lights turn off", "Measure the voltage of the main switchboard", "Trip the main breaker; immediately verify that specific emergency lights (often marked with a red dot) and the bridge console stay illuminated by the batteries BEFORE the emergency generator starts"],
  ...
  },
  {
    ...
    "opts": ["A test to prove that if the running generator becomes overloaded, the switchboard automatically sheds (turns off) non-essential loads (like AC or galley ovens) in a timed sequence to save the generator from blacking out", "A test to see which generator starts fastest", "A test of the crew's preference for emergency lighting", "A test that forces the ship to steer in a circle"],
  ...
  },
  {
    ...
    "opts": ["It acts as a battery charger for the main engine", "It prevents a running generator from acting as an electric motor if its diesel engine fails, by tripping the breaker when power flows backward from the live busbar into the generator", "It reverses the flow of electricity to clear short circuits", "It prevents the ship from moving backward"],
  ...
  },
  {
    ...
    "opts": ["By shorting the main busbar to ground", "While two generators are running in parallel, the ETO slowly reduces the fuel/speed governor setting of the test generator until it stops taking load and begins drawing power (motoring); the relay should trip at around 5-10% reverse power", "By applying 440V directly to the rotor", "By swapping two phases of the generator"],
  ...
  },
  {
    ...
    "opts": ["It must be heated to 40\u00b0C at all times", "The room must be treated as a hazardous explosive area due to hydrogen gas generation; all electrical fittings (lights, fans) must be Ex-certified (explosion-proof)", "No electrical equipment is allowed inside the room whatsoever", "It must be flooded with CO2 permanently"],
  ...
  },
  {
    ...
    "opts": ["Earth faults are ignored on ships to maintain power", "A device must be installed (Earth Fault Indicator or Relay) to continuously monitor the insulation level to earth and give a visible and audible alarm if the insulation resistance drops to a dangerously low value", "The system must instantly trip the main generator if an earth fault occurs", "The system must route all earth faults into a battery bank"],
  ...
  },
  {
    ...
    "opts": ["A graph showing the voltage fluctuations over the last year", "An approved document proving that the ship's generators have the mathematical capacity to supply all maximum combined loads during various operational states (At Sea, Maneuvering, Cargo Operations)", "A log of the daily fuel consumed by the generators", "A list of the spare parts available for the switchboard"],
  ...
  },
  {
    ...
    "opts": ["Measure the brightness of the lights in lumens", "Check that the lights are visible from outer space", "Ensure the lights can strobe to send Morse code", "Verify all primary lights work, manually test the changeover switch to the backup bulbs/circuits, and prove that if a bulb burns out, the 'Failure Alarm' on the bridge panel immediately sounds"],
  ...
  },
  {
    ...
    "opts": ["It must be supplied by two alternative circuits, one from the main switchboard and one directly from the emergency switchboard, with a changeover switch located on the bridge", "It must be powered by small AA batteries", "It must be wired directly to the ship's propeller shaft generator", "It is only powered by the emergency generator"],
  ...
  },
  {
    ...
    "opts": ["An anti-condensation space heater; this 220V heater must turn ON automatically when the motor stops to keep the windings dry and maintain insulation resistance", "A permanent silica-gel dehumidifier packet", "A waterproof tarp thrown over the motor", "A small drain hole drilled into the stator casing"],
  ...
  },
  {
    ...
    "opts": ["By manually pressing the OFF button on the generator", "By turning off the lights in the switchboard room", "By isolating the control voltage to the UVT coil while the breaker is closed; the breaker should instantly snap open (trip) to protect the bus from a low-voltage condition", "By increasing the voltage to 500V to see if it trips"],
  ...
  },
  {
    ...
    "opts": ["Test the panel's connection to the ship's Wi-Fi network", "Test multiple individual smoke/heat detectors across different zones using test aerosol/heat to prove the panel correctly identifies the zone, sounds the alarms, and can successfully be reset", "Disconnect all the detectors to see if the ship sinks", "Burn a piece of paper directly under the main panel"],
  ...
  },
  {
    ...
    "opts": ["Records proving the ETO conducts daily, weekly, and monthly tests, specifically checking the voltage and specific gravity of the dedicated 24V GMDSS radio battery bank, and proving it can handle the load", "The passwords to the ship's satellite internet", "The receipt for purchasing the VHF radios", "A list of all the radio stations the captain has spoken to"],
  ...
  },
  {
    ...
    "opts": ["To regulate the wages and working hours of seafarers", "To provide armed guards for vessels in pirate waters", "To ensure safety at sea, prevention of human injury or loss of life, and avoidance of damage to the environment and to property", "To maximize the commercial profitability of shipping companies"],
  ...
  },
  {
    ...
    "opts": ["Details of Construction; issued to the shipyard", "Declaration of Cargo; issued to the ship's Master", "Directive of Crewing; issued to the manning agency", "Document of Compliance; it is issued to the shipping COMPANY ashore by the flag state, proving their Safety Management System meets international standards"],
  ...
  },
  {
    ...
    "opts": ["Ship Manning Certificate; issued to the crewing manager", "System Maintenance Code; issued to the Chief Engineer", "Structural Maritime Certificate; issued by the shipyard", "Safety Management Certificate; it is issued to the individual SHIP after an onboard audit proves the crew is successfully implementing the company's SMS"],
  ...
  },
  {
    ...
    "opts": ["5 years, subject to annual verification audits (for DOC) and intermediate audits (for SMC)", "Lifetime validity as long as the ship doesn't sink", "10 years, with no intermediate checks", "1 year, requiring complete renewal annually"],
  ...
  },
  {
    ...
    "opts": ["The person responsible for buying spare parts for the engine room", "A lawyer who defends the company in court", "A shore-based person providing a direct link between the ship's crew and the highest level of company management, responsible for monitoring the safety and pollution prevention aspects of the ship", "The port agent who arranges pilotage and tugboats"],
  ...
  },
  {
    ...
    "opts": ["There is no legal difference; both result in instant detention", "A Non-Conformity applies to paperwork; a Major Non-Conformity applies to machinery", "A Non-Conformity is a failure to comply with an SMS rule requiring eventual correction; a Major Non-Conformity poses a serious, immediate threat to life/ship/environment and requires immediate corrective action, often resulting in certificate suspension", "A Non-Conformity is a verbal warning; a Major Non-Conformity is a $10,000 fine"],
  ...
  },
  {
    ...
    "opts": ["The International Ship Pollution Standards; it governs oil spills", "The International Safety Plan for Ships; it replaces the ISM code", "The Internal Ship Power System; it regulates electrical generators", "The International Ship and Port Facility Security Code; it establishes a framework to detect and deter security threats, terrorism, and piracy"],
  ...
  },
  {
    ...
    "opts": ["NORMAL: The minimum appropriate protective security measures shall be maintained at all times", "OFF: The ship is in a completely safe port with no security needed", "EXCEPTIONAL: An attack is imminent, requiring lockdown", "HEIGHTENED: A specific threat is likely, requiring extra guards"],
  ...
  },
  {
    ...
    "opts": ["PIRACY: The crew is issued weapons to fight off attackers", "EXCEPTIONAL: A security incident is probable or imminent; maximum security measures are enacted, the ship may be locked down, and non-essential personnel are evacuated or confined", "HEIGHTENED: Extra patrols are added, but cargo continues", "NORMAL: Standard operations continue"],
  ...
  },
  {
    ...
    "opts": ["Searching passenger luggage for contraband", "Standing armed guard at the gangway", "Providing medical care to wounded security personnel", "Maintaining the CCTV systems, ensuring electronic access control (keypads/card readers) to restricted areas works, and testing the Ship Security Alert System (SSAS) and communication networks"],
  ...
  },
  {
    ...
    "opts": ["Ship Security Alert System; pressing the hidden button sends a silent distress signal via satellite directly to the flag state and shipping company, indicating the ship is under attack (piracy/terrorism)", "Sonar Security Acoustic System; it blasts noise underwater to deter divers", "Ship Safety Alarm System; it rings loud bells throughout the ship", "Satellite Steering Action System; it allows the company to drive the ship remotely"],
  ...
  },
  {
    ...
    "opts": ["Created by the WHO, it dictates the exact diet of seafarers", "Created by the UN, it bans the transport of slaves", "Created by the ILO (International Labour Organization), it is the 'Seafarers' Bill of Rights' establishing minimum standards for working conditions, wages, accommodation, and medical care", "Created by the IMO, it regulates the size of lifeboats"],
  ...
  },
  {
    ...
    "opts": ["Rest hours are entirely up to the discretion of the Captain", "A minimum of 10 hours of rest in any 24-hour period, and 77 hours in any 7-day period; the daily rest can be divided into no more than two periods, one of which must be at least 6 hours long", "A minimum of 8 hours of rest in 24 hours, and 40 hours a week", "A minimum of 12 hours of rest every single day without exception"],
  ...
  },
  {
    ...
    "opts": ["It formally recognized the ETO as a certified officer rank under STCW Chapter III (Table A-III/6), creating mandatory global training and certification standards for marine electrical officers", "It abolished the ETO rank, merging it with the Chief Engineer", "It restricted ETOs to only working on passenger ships", "It removed the requirement for ETOs to understand high voltage"],
  ...
  },
  {
    ...
    "opts": ["A space with limited openings for entry/exit, inadequate natural ventilation, and not designed for continuous worker occupancy (e.g., cargo holds, ballast tanks, duct keels)", "The engine control room (ECR)", "Only spaces that store toxic chemicals", "Any room with a locking door"],
  ...
  },
  {
    ...
    "opts": ["Between 19.5% and 23.5% (Normal air is 20.9%)", "Between 10% and 15%", "Between 50% and 60%", "Exactly 100%"],
  ...
  },
  {
    ...
    "opts": ["A deadly gas that smells like rotten eggs (but quickly paralyzes the sense of smell); the Threshold Limit Value (TLV) is incredibly low, typically 1 to 5 ppm", "A sweet-smelling gas used for refrigeration; limit is 1000 ppm", "A heavy gas that turns into acid; limit is 500 ppm", "An invisible gas that causes uncontrollable laughing; limit is 50 ppm"],
  ...
  },
  {
    ...
    "opts": ["A regulation governing the taxation of cargo in Asian ports", "An international convention for the Safe and Environmentally Sound Recycling of Ships, ensuring end-of-life vessels do not pose risks to human health or the environment when scrapped", "A treaty establishing the rules for rescuing refugees at sea", "A treaty banning the transport of illegal wildlife"],
  ...
  },
  {
    ...
    "opts": ["A living document listing the location and quantities of all hazardous materials onboard (e.g., asbestos, PCBs in old capacitors, mercury in fluorescent tubes, TBT paint)", "A list of all the dangerous weapons carried by the anti-piracy guards", "A record of all the crew members with contagious diseases", "A logbook of all the fuel oil consumed during the voyage"],
  ...
  },
  {
    ...
    "opts": ["A measure of how much black smoke comes out of the funnel", "An operational rating system (A through E) that measures how efficiently a ship transports goods, calculated in grams of CO2 emitted per cargo-carrying capacity and nautical mile", "A technical score measuring the physical horsepower of the engine", "A tax applied to ships entering European ports"],
  ...
  },
  {
    ...
    "opts": ["By turning off the ship's navigation radars at night", "By dumping waste oil overboard to lighten the ship", "By overriding the governor to make the engine run faster", "By optimizing power management (avoiding running unnecessary generators), retrofitting LED lighting, installing VFDs on large cooling pumps, and maintaining Shore Power (Cold Ironing) equipment"],
  ...
  },
  {
    ...
    "opts": ["A one-time technical measure of a ship's inherent design efficiency; many ships comply by installing a verifiable 'Shaft Power Limitation' (ShaPoLi) or Engine Power Limitation (EPL) system", "A rating of how much electricity the crew uses in their cabins", "A test of the emergency generator's fuel efficiency", "A daily report of the ship's fuel consumption"],
  ...
  },
  {
    ...
    "opts": ["A massive gyroscope to stabilize the ship", "A drone to inspect the outside of the hull", "An Electronic Inclinometer, which must provide real-time roll angle data to the bridge and actively record this data into the Voyage Data Recorder (VDR)", "A laser system to measure the height of the waves"],
  ...
  },
  {
    ...
    "opts": ["Ships must abandon the voyage and return to the loading port", "Ships must stop and fish the containers out of the water", "Ships MUST immediately report any containers lost overboard to the nearest coastal state, detailing the position, number of containers, and if Dangerous Goods (IMDG) were involved", "Ships must pay a $1M fine immediately via satellite transfer"],
  ...
  },
  {
    ...
    "opts": ["Reprogram the autopilot to avoid the area", "Shut down the main engine to prevent the propeller from hitting a box", "Ensure all GMDSS communication equipment is working to broadcast the danger message, and IMMEDIATELY activate the Voyage Data Recorder (VDR) 'Save/Preserve' function to lock in the roll data and ship track", "Turn on all the floodlights to look for the boxes"],
  ...
  },
  {
    ...
    "opts": ["The Master or Chief Engineer's authority to intentionally bypass a safety shutdown (e.g., overriding a main engine trip to avoid crashing the ship), accepting mechanical damage to maintain navigational control", "The ETO's ability to change passwords on the alarm computer", "The Port State Control officer's right to detain the ship", "The automatic system bypassing human commands"],
  ...
  },
  {
    ...
    "opts": ["It requires a signed letter from the company CEO", "It must be done secretly so Port State Control doesn't find out", "It must only be done using a laptop connected to the internet", "It must be explicitly authorized by the C/E or Master, logged in the official override register, accompanied by increased manual monitoring, and cancelled the moment the emergency is resolved"],
  ...
  },
  {
    ...
    "opts": ["They must pass a physical fitness test every month", "They must build a working electric motor from scratch to prove their skills", "They must complete formal refresher/revalidation training every 5 years to demonstrate ongoing competency and keep up with changing technology and safety rules", "They never have to renew it; it is valid for life"],
  ...
  },
  {
    ...
    "opts": ["Safety (SOLAS), Security (ISPS), Environmental Protection (MARPOL), and Rule of Law/Efficiency (STCW/FAL)", "Speed, Cargo, Profit, and Navigation", "Piracy, Pollution, Personnel, and Ports", "Engineering, Deck, Catering, and Management"],
  ...
  },
  {
    ...
    "opts": ["A digital recording of the main engine's RPM over the last year", "A record of all the ports the ship has visited in its lifetime", "A logbook where the crew writes down their daily tasks", "An onboard document providing a continuous, unalterable history of the ship (its flag, owner, ISM company, and class society), designed to prevent owners from hiding the ship's history by constantly changing flags"],
  ...
  },
  {
    ...
    "opts": ["In the very bottom of the engine room to keep it cool", "Inside the cargo control room", "Directly next to the main switchboard for easy wiring", "Above the uppermost continuous deck, outside the main machinery space, and readily accessible from the open deck"],
  ...
  },
  {
    ...
    "opts": ["It must run for 36 hours", "It must run for 6 hours", "It must run indefinitely by pulling fuel from the main bunker tanks", "It must have a dedicated fuel tank with sufficient capacity to run the generator at full emergency load for a minimum of 18 hours"],
  ...
  },
  {
    ...
    "opts": ["Minimum of 12 hours at full load", "Minimum of 72 hours at full load", "Minimum of 36 hours at full load", "Minimum of 18 hours at full load"],
  ...
  },
  {
    ...
    "opts": ["It must automatically start and assume the full emergency electrical load within 45 seconds of the failure of the main electrical supply", "It must start within 10 seconds", "It must start within 5 minutes", "It must start within 2 minutes"],
  ...
  },
  {
    ...
    "opts": ["It must provide 10 consecutive starting attempts", "It relies entirely on a hand-crank", "It must be capable of providing at least 3 consecutive automatic starting attempts", "It must provide 1 continuous crank for 60 seconds"],
  ...
  },
  {
    ...
    "opts": ["The crew must use jumper cables from the main engine", "A second, completely independent means of starting must be provided (e.g., a secondary battery bank, a hydraulic accumulator hand-pump, or a spring starter) capable of 3 more starts within 30 minutes", "The generator can be started by pushing it down a ramp", "The ship must drop anchor and wait for a tug"],
  ...
  },
  {
    ...
    "opts": ["Emergency fire pump and steering gear", "Emergency lighting in the engine room and stairwells", "Main engine lubricating oil pumps and heavy fuel oil purifiers", "Navigation lights and GMDSS radio equipment"],
  ...
  },
  {
    ...
    "opts": ["Increase the ship's load to 100% to simulate a heavy blackout", "Inform the Bridge/Master, warn the crew, reduce the ship's electrical load to a minimum, and place all standby main generators into MANUAL mode so they do not auto-start and interfere with the test", "Turn off the emergency generator battery charger and drain the fuel tank", "Disconnect the transitional 24V batteries"],
  ...
  },
  {
    ...
    "opts": ["By manually opening (tripping) the Air Circuit Breaker (ACB) of the running main generator at the Main Switchboard, instantly killing the 440V main busbar", "By shutting off the fuel to the main engine", "By pressing the test button on the Emergency Switchboard", "By throwing the main electrical disconnect on the bridge"],
  ...
  },
  {
    ...
    "opts": ["The main generator continues to spin slowly, providing dim lighting", "The 'Transitional Source of Emergency Power' (a 24V DC battery bank) automatically clicks on instantly, powering specific LED/halogen emergency lights for a minimum of 30 minutes", "Glow-in-the-dark paint illuminates the entire ship", "They must rely on personal flashlights"],
  ...
  },
  {
    ...
    "opts": ["A catastrophic scenario where the main power is dead, the emergency generator is dead, and absolutely ALL stored energy (like starting air bottles and batteries) is completely depleted", "A ship that has been officially scrapped at a shipyard", "A situation where the ship's main engine is stopped in port", "A normal blackout where the emergency generator starts correctly"],
  ...
  },
  {
    ...
    "opts": ["Start the Emergency Generator using its secondary/manual starting method (e.g., hand-pumped hydraulics), as it is the only machine on the ship with its own independent, isolated starting energy", "Open the starting air valve to the main engine", "Manually crank the main engine with the turning gear", "Light a fire in the boiler to generate steam pressure"],
  ...
  },
  {
    ...
    "opts": ["The captain holds the only key to the breaker", "The emergency generator rotates in the opposite direction", "The emergency generator produces 50Hz, while the main produces 60Hz", "An electrical and mechanical interlock on the Emergency Switchboard tie-breaker prevents the Emergency Generator breaker from closing if the main bus-tie is energized"],
  ...
  },
  {
    ...
    "opts": ["It should never be tested to save its fuel for a real emergency", "Only once a year during the class survey", "A short operational/no-load test weekly, and a full load test (transferring the actual ship's emergency loads) monthly", "Daily before the captain wakes up"],
  ...
  },
  {
    ...
    "opts": ["It automatically pumps its remaining fuel back to the main tank", "It instantly seizes and requires a manual reset", "It runs in parallel with the main generator permanently", "The tie-breaker closes, the emergency breaker automatically trips open (transferring the load seamlessly back to the main board), and the emergency diesel runs for a few minutes to cool down before auto-stopping"],
  ...
  },
  {
    ...
    "opts": ["To increase the pressure of the fuel entering the engine", "To eliminate any reliance on electric fuel booster pumps; if the ship is completely dead, gravity guarantees fuel will reach the injection pump to start the engine", "To prevent water from mixing with the fuel", "To comply with MARPOL environmental regulations"],
  ...
  },
  {
    ...
    "opts": ["The Power Management System (PMS) begins a 'Sequential Restart'; it automatically starts massive pumps (like sea water and lube oil) one by one with 5-10 second delays between each to prevent massive overlapping starting currents from crashing the generator again", "It drops the emergency generator into the sea", "It instantly starts the main propulsion engine", "It waits for the ETO to manually press start on every single pump"],
  ...
  },
  {
    ...
    "opts": ["Essential main engine support systems (Main Lube Oil, Jacket Cooling Water, Sea Water Cooling) and Steering Gear to ensure the ship can maneuver and the engine doesn't melt", "Fresh water generators and sewage treatment plants", "Air conditioning compressors and galley ovens", "Cargo hold ventilation fans"],
  ...
  },
  {
    ...
    "opts": ["They intentionally trip the main engine to save fuel", "They trip the emergency generator to protect it from over-voltage", "They disconnect the shore power cables", "They automatically and intentionally trip (disconnect) non-essential electrical loads (like AC and deck cranes) in stages to reduce the burden on the generator and prevent a total blackout"],
  ...
  },
  {
    ...
    "opts": ["The captain must steer using a manual wheel on the bridge", "The entire blackout recovery (start standby gen, close breaker, sequential restart of pumps) must happen flawlessly and automatically without human intervention, while sounding alarms in the engineers' cabins", "The ship just drifts until the engineers wake up and fix it", "The emergency generator takes over propulsion automatically"],
  ...
  },
  {
    ...
    "opts": ["It makes the room too heavy, affecting stability", "It introduces a massive fire hazard into the ultimate safe haven of the ship, and loose gear could block access to the generator during a frantic blackout scenario", "The paint fumes will cause the generator to run too fast", "The surveyor needs the space to sit down during inspections"],
  ...
  },
  {
    ...
    "opts": ["The transitional batteries are overcharged", "The selector switch on the control panel was accidentally left in 'MANUAL' or 'OFF' instead of 'AUTO' after a previous maintenance job", "The ship is sailing through a magnetic storm", "The main engine governor is jammed"],
  ...
  },
  {
    ...
    "opts": ["It makes the generator run extremely efficiently", "It causes 'Wet Stacking' or carbon buildup; unburned fuel and oil bake onto the exhaust valves and turbocharger because the engine isn't hot enough to burn them off properly", "It drains the starting batteries completely", "It causes the copper windings in the alternator to melt"],
  ...
  },
  {
    ...
    "opts": ["To blow out the carbon from the exhaust stack", "To ensure no water or oil has accumulated in the cylinders; turning the engine with fluid inside (which is incompressible) will cause a massive hydraulic lock, bending the connecting rods and destroying the engine", "To let fresh oxygen into the engine for a better fire", "To check the color of the fuel burning inside"],
  ...
  },
  {
    ...
    "opts": ["It is a massive compressor used to run the ship's horn", "It is a tiny, often hand-startable or emergency-powered compressor used solely to fill a small, dedicated starting air bottle to start the FIRST main auxiliary diesel generator", "It pumps breathable air into the engine control room", "It is used to inflate the life rafts during abandon ship"],
  ...
  },
  {
    ...
    "opts": ["The jacket water 'Block Heater', which keeps the engine metal warm (~40\u00b0C) so the diesel fuel will easily ignite under compression when cranking", "The electric stove in the galley", "The accommodation central heating system", "The heavy fuel oil steam heater"],
  ...
  },
  {
    ...
    "opts": ["The generator will instantly stall and trip; a generator must be started unloaded and brought to 60Hz before closing the breaker and subsequently applying loads", "The AVR will automatically compensate by tripling the voltage", "It will smoothly pick up the load and run perfectly", "The busbar will instantly magnetize the hull"],
  ...
  },
  {
    ...
    "opts": ["A device that reverses the polarity of the battery charger", "A safety relay that prevents a generator from acting as an electric motor (drawing power from the busbar to spin a dead diesel engine) by tripping its breaker if power flows the wrong way", "A system that pumps fuel out of the engine back to the tank", "A switch that allows the ship to drive backward"],
  ...
  },
  {
    ...
    "opts": ["By pushing the emergency stop button on both engines simultaneously", "With two generators in parallel, slowly reduce the governor speed setting (throttle down the fuel) of the test generator until its kW drops below zero; the relay should trip at around 5-10% reverse load", "By shorting the main busbar to ground with a heavy wire", "By swapping the L1 and L2 cables on the generator output"],
  ...
  },
  {
    ...
    "opts": ["It connects the ship to shore power", "It splits the massive switchboard into two independent halves; if one half has a dead short or is burning, the tie breaker isolates it, allowing the surviving half to be safely powered by a remaining generator", "It permanently ties all the generators together so they cannot be separated", "It physically ties the massive copper busbars to the steel hull to prevent vibration"],
