window.loadQuizzes("T09_ShipMachinery", [
  {
    ...
    "opts": [
      "Photoelectric light extinction (opacity) where mist droplets scatter and absorb a light beam",
      "Chemical detection using a pellistor sensor to measure hydrocarbon limits",
      "Ionisation chamber detection using Americium-241",
      "Infrared thermal imaging detecting hot spots on crankcase walls"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Zero in vacuum; span by injecting actual hot oil mist from engine",
      "Zero uses 4mA electrical signal; span uses 20mA via loop calibrator",
      "Zero calibration with clean dry air to set 0.00 mg/L; span calibration with certified gas of known concentration",
      "Zero uses inert gas; span relies on ambient engine room air"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Hot surfaces + residual oil mist + introduced oxygen = crankcase explosion risk",
      "Engine must complete 20 more revolution cycles to purge the mist naturally",
      "Classification rules require exactly 20 minutes before any inspection"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Cold HFO is circulated back to settling tank",
      "FD fan runs for 3-5 air changes in the furnace volume to remove accumulated unburnt fuel vapours",
      "High-pressure steam injected into burner nozzle to clear carbon",
      "Ignition transformer sparks for 10 seconds without fuel to warm UV scanner"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Pitch causes hydraulic oil cavitation in hub",
      "Starting with pitch applied = full hydrodynamic load = sustained 6-8× starting current = generator overload",
  ...
  },
  {
    ...
    "opts": [
      "1-Emergency gen confirmed → 2-Cooling pumps → 3-Lube oil pumps → 4-Starting air compressors → 5-Auxiliary boiler → 6-Purifiers → 7-Main generator start → 8-Main engine preparation",
      "1-Start main engine immediately using emergency air supply → 2-Emergency generator → 3-All loads simultaneously",
      "1-Radio bridge → 2-Emergency steering → 3-Main generator → 4-Engine room equipment in any order",
      "1-Anchor immediately → 2-Call for assistance → 3-Wait for main power to restore automatically"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The lube oil pressure switch is only used during start-up to confirm pressure has built up before firing the engine",
      "The lube oil low-pressure switch shuts down the diesel generator if lube oil pressure falls below approximately 1.5-2.0 bar (150-200 kPa) to prevent catastrophic bearing damage from oil starvation",
      "The pressure switch monitors filter differential pressure and triggers a filter bypass valve when blockage is detected",
      "The lube oil pressure switch activates the auxiliary lube oil pump to maintain pressure during manoeuvring when the main engine-driven pump is slow"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An explosion caused by excessive combustion pressure bleeding past worn piston rings into the crankcase space",
      "An explosion inside the crankcase caused by ignition of oil mist. Protected by: (1) mist detector alarm that shuts down the engine, and (2) crankcase relief valves that open to release pressure while preventing air re-entry",
      "An explosion caused by overheating of the flywheel bearing that ignites leaked fuel in the aft crankcase",
      "An explosion caused by water contamination in the fuel injectors creating hydraulic pressure spikes inside the crankcase"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It provides a baseline clean-air optical measurement to compensate for lamp aging and sensor drift",
      "It cools the sampled crankcase gases before they reach the photocell",
      "It provides a constant flow of calibration gas to the measuring chamber",
      "It chemically neutralises the oil mist before it is exhausted to the atmosphere"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inject CO2 directly into the crankcase while the engine is still running",
      "Reduce engine load immediately, and wait a minimum of 20 minutes after stopping before opening any crankcase doors",
      "Reset the alarm and restart the engine to see if the fault clears itself",
      "Open the crankcase doors immediately to ventilate the explosive gases"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Engines with a power output of 1000 kW and above, OR a cylinder bore of 200 mm and above",
      "Only two-stroke slow-speed main propulsion engines",
      "Engines with a power output of 2250 kW and above, OR a cylinder bore of 300 mm and above",
      "All marine diesel engines regardless of size"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Zero calibration using a multimeter, followed by Span calibration using an optical lux meter",
      "Zero calibration by completely blocking the light beam, followed by Span calibration using ambient engine room air",
      "Zero calibration using clean, dry instrument air, followed by Span calibration using certified calibration gas",
      "Zero calibration using exhaust gas, followed by Span calibration using fresh lubricating oil"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A temperature controller cannot react fast enough to changes in engine load",
      "Viscosity controllers consume less electrical power than temperature controllers",
      "Different grades of HFO require different temperatures to reach the ideal injection viscosity (10-14 cSt); a viscosity controller automatically adapts to any fuel grade",
      "Temperature controllers are not approved for use in hazardous marine environments"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The physical temperature of the fuel as it passes over the spindle",
      "The electrical current (torque) required by the constant-speed motor to drive the spindle through the flowing fuel",
      "The speed (RPM) of a free-spinning turbine wheel inside the fuel pipe",
      "The pressure drop across a fixed capillary restriction"
    ],
  ...
  },
  {
    ...
    "opts": [
      "PI (Proportional-Integral) control; Derivative action is excluded because it would amplify mechanical pump noise and cause the steam valve to hunt erratically",
      "PID (Proportional-Integral-Derivative) control; for the fastest possible response to temperature spikes",
      "P (Proportional) control only; because integral action causes dangerous overheating",
      "ON/OFF control; because the steam valve can only be fully open or fully closed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is a backup lubrication reservoir for critical bearings",
      "It measures the viscosity of lubricating oil in real-time",
      "It acts as a rapid-discharge accumulator to snap valves closed instantly",
      "It is a hydraulic or pneumatic damping device that introduces a controlled time delay by forcing fluid through a calibrated orifice"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It physically locks the fuel rack in place until the engine temperature stabilizes",
      "It injects extra fuel directly into the cylinders during sudden load drops",
      "It slows down the movement of the fuel rack actuator, preventing the governor from over-correcting and causing speed oscillations",
      "It filters out air bubbles from the heavy fuel oil supply"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses electronic timers to calculate the exact inverse mathematical curve",
      "It reverses the polarity of the trip coil depending on the magnitude of the fault",
      "It physically blocks the trip lever until the temperature of the oil reaches boiling point",
      "A massive short-circuit force easily overcomes the oil resistance for a fast trip, while a small overload force pushes the oil slowly, creating a long time delay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An overload condition must instantly trip the motor to prevent a fire in the steering gear flat",
      "An overload condition must automatically switch the system to the emergency 24V battery supply",
      "An overload condition must trigger an ALARM ONLY on the bridge and engine room, and MUST NOT automatically trip the motor",
      "An overload condition must automatically start the emergency generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because steering gear motors are the only motors on board that operate on High Voltage",
      "Because it ensures the motor runs at exactly 60Hz to comply with SOLAS timing rules",
  ...
  },
  {
    ...
    "opts": [
      "The rudder responds too slowly to commands, missing the required SOLAS 28-second timing",
      "The steering pump motor draws pulsing current, causing the main generator to hunt",
      "The rudder physically locks at hard-over and refuses to return to midships",
      "The rudder oscillates continuously back and forth across the demanded angle without stopping, usually caused by a failure in the follow-up feedback linkage (hunting gear)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Switch the steering control to Non-Follow-Up (NFU) mode; if the rudder stabilizes and responds correctly, the fault is isolated to the follow-up feedback path",
      "Trip the main steering motor breaker and wait for the standby pump to auto-start",
      "Manually open the hydraulic bypass valve on the ram cylinders",
      "Increase the proportional gain on the autopilot to force the rudder to stop"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be capable of turning the vessel 360 degrees in less than 5 minutes at half speed",
      "It must be capable of putting the rudder from 35° on one side to 30° on the other side in not more than 28 seconds, while at maximum ahead service speed",
      "It must auto-start the standby pump within 45 seconds if the primary pump fails",
      "It must be capable of moving from hard-port to hard-starboard in 15 seconds while stationary"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It allows the Forced Draft (FD) fan motor to warm up slowly before full load is applied",
      "It raises the steam pressure slowly to prevent thermal shock to the boiler shell",
      "It forces several air changes through the furnace to clear out any accumulated unburnt fuel vapour from previous failed starts, preventing a catastrophic furnace explosion",
      "It pre-heats the heavy fuel oil in the burner nozzle to ensure proper atomisation"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The BMS increases the Forced Draft fan speed to provide more oxygen to the fire",
      "The BMS immediately closes the main fuel valve and initiates a flame failure LOCKOUT, which requires manual investigation and reset",
  ...
  },
  {
    ...
    "opts": [
      "UV scanners are the only sensors capable of penetrating thick black fuel smoke",
      "UV scanners operate on 24V DC, which makes them immune to shipboard power fluctuations",
      "UV scanners are significantly cheaper and easier to calibrate than IR sensors",
      "UV scanners only detect the specific UV radiation emitted by the chemical reaction of an active flame, preventing false positive signals from glowing red-hot refractory bricks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The BMS must be rebooted by cycling the main power breaker",
      "The boiler must be completely blown down and refilled with fresh feedwater",
      "An engineer must manually reset the High Steam Pressure switch/relay; it will not auto-reset",
      "The boiler will restart automatically as soon as the pressure drops below the low-pressure setpoint"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An oxygen analyser mounted in the exhaust uptake",
      "A UV scanner monitoring the brightness of the flame",
      "A Differential Pressure (DP) switch or airflow switch mounted across the FD fan outlet",
      "A thermistor monitoring the temperature of the FD fan motor bearings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It cleans the oil by vibrating the bowl at high frequencies; trips are caused by dirty oil",
      "It ensures the bowl is spinning fast enough to separate water; trips are caused by low voltage",
      "It monitors the frequency of the incoming AC supply; trips are caused by generator hunting",
      "It trips the purifier motor on excessive vibration; common causes include uneven sludge build-up (unbalanced bowl), worn bearings, or worn friction clutch pads"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Phase imbalance in the electric motor",
      "Slipping of the magnetic clutch",
  ...
  },
  {
    ...
    "opts": [
      "Friction brakes generate intense heat and potential sparks, which poses a severe fire/explosion hazard in an environment saturated with hot oil mist",
      "Mechanical brakes are too expensive to maintain under SOLAS rules",
      "Friction brakes would cause the bowl to spin in reverse, destroying the bearings",
      "The sudden stop would cause the sludge to harden and block the discharge ports"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The emergency generator is not in standby mode",
      "The steering gear motors are currently running",
      "The ship's speed is over 15 knots",
      "Insufficient running generator capacity on the main switchboard (Power Management System block)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Propeller pitch must be at exactly ZERO, adequate vessel draft/immersion must be confirmed, and control must be assigned to the active station",
      "The anchor windlass must be secured, and the main engine must be stopped",
      "The thruster tunnel doors must be verified open via limit switches",
      "The rudder must be amidships, and the vessel must be making zero forward way"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is 'Fail-Safe': Heavy springs physically apply the brake pads to hold the load. Applying electrical power to the electromagnet pulls the springs back, releasing the brake",
      "It uses an electromagnet to physically push the brake pads against the spinning rotor",
      "It uses hydraulic fluid controlled by an electric solenoid to squeeze the brake discs",
      "It generates a reverse magnetic field to slow the motor down dynamically without brake pads"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The motor will spin 10% faster to compensate for the lost braking force",
      "The brake will release too quickly, dropping the load instantly",
      "The electromagnet will draw zero current, triggering a low-voltage alarm",
      "The magnetic coil will not have enough strength to pull the armature across the larger gap, meaning the brake will drag or completely fail to release, causing motor overload"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Perform the 5-yearly 125% proof load test independently and sign the certificates",
      "Weld structural reinforcements to the crane jib if micro-cracks are detected",
      "Ensure electrical systems are maintained, verify Safe Working Load (SWL) markings are clearly legible at control stations, and guarantee the hoist overload limit switches are properly calibrated and functional",
      "Operate the crane during all cargo operations to ensure smooth electrical performance"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It prevents the crane from slewing too fast; it uses a centrifugal governor",
      "It prevents lifting loads beyond the SWL, which could capsize the crane or snap the wire; it uses a load cell (strain gauge) to measure tension and cuts power to the 'Hoist UP' contactor if the limit is breached",
      "It prevents the motor from overheating; it uses a thermistor embedded in the stator",
      "It prevents the crane hook from hitting the jib sheave; it uses a mechanical trip arm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Both cut-outs reset automatically to ensure continuous cooling of provisions",
      "The HP cut-out auto-resets after 5 minutes, while the LP cut-out must be manually reset",
      "The HP cut-out requires a software reboot, while the LP cut-out is purely mechanical",
      "The HP cut-out MUST be manually reset by an engineer, while the LP cut-out typically resets automatically once pressure normalises"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It measures the difference between the high-pressure gas and low-pressure gas, tripping if the compressor valves fail",
      "It trips the compressor if the lubricating oil temperature gets too hot compared to the ambient air",
      "It measures the difference between crankcase pressure and oil pump discharge pressure; if the difference (actual oil pressure) drops too low for too long, it trips the compressor to prevent bearing failure",
      "It ensures the oil level in the sight glass matches the required setpoint"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To allow the refrigerant gas to fully evaporate before the oil pump engages",
      "To give the engineer time to manually prime the oil system",
      "To ensure the motor star-delta starter has completed its transition",
      "To allow the oil pump time to build up adequate pressure when the compressor first starts, preventing nuisance tripping"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Start the emergency generator, then use emergency power to run the emergency air compressor to fill the starting air bottles",
      "Use the compressed air cylinder located in the emergency lifeboat",
      "Open the cross-connection from the control air system to the main starting air receivers",
      "Manually crank the main air compressors using the turning gear"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Check the UV scanner lens for soot, verify ignition transformer output voltage, check the fuel solenoid valve with 24V, and check the BMS output signal",
      "Adjust the mechanical fuel pump pressure and replace the burner nozzle",
      "Bypass the purge timer in the BMS to force an immediate restart",
      "Check the feedwater pump motor insulation and inspect the boiler tubes for leaks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses a mechanical centrifugal flyweight attached directly to the compressor shaft",
      "It uses a magnetic pickup sensor that detects changes in magnetic flux as the teeth of a ferromagnetic wheel (phonic wheel) on the shaft pass by",
      "It measures the exhaust gas flow rate and mathematically calculates the RPM",
      "It uses an optical laser that bounces off a reflective mirror painted on the turbine blades"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It regulates refrigerant flow into the evaporator to maintain a constant superheat temperature at the evaporator outlet",
      "It limits the high pressure discharge from the compressor to prevent pipe rupture",
      "It automatically drains oil from the oil separator back to the crankcase",
      "It controls the flow of seawater through the condenser to maintain a stable head pressure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Bypass the LO pressure switch and continue running until port arrival",
      "Hit the emergency stop button immediately to save the bearings",
      "Do NOT immediately stop the engine; inform the C/E and bridge, then check the local mechanical LO pressure gauge to confirm the alarm is genuine",
  ...
  },
  {
    ...
    "opts": [
      "Slack rope safety and Anemometer cut-out",
      "Electromagnetic brake and limit switches",
      "Motor overload relay and Emergency stop button",
      "Joystick pendant control and VFD overcurrent trip"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Short circuit the tachometer sensor to simulate a high-frequency input",
      "Disconnect the generator from the busbar and suddenly push the fuel rack to 100%",
      "With the engine running at governed speed, manually lift the overspeed trip lever and confirm the engine shuts down",
      "Slowly reduce the governor speed setpoint until the engine stalls"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Combustion gases will condense on the cylinder liner, forming sulphuric acid which causes severe cold corrosion",
      "The fresh water generator will over-produce, flooding the distillate tanks",
      "The engine will suffer from vapor lock in the fuel injection pumps",
      "The engine lube oil will overheat because the cooler cannot reject heat"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Close both valves simultaneously and puncture the sensor diaphragm",
      "Open the process isolation valve fully, then close the equalising valve",
      "Close the process isolation valve to stop live pressure, then open the equalising bypass valve to safely vent residual pressure before connecting the test gauge",
      "Remove the sensor while the compressor is running, allowing oil to flush the lines"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To provide an emergency source of cooling water if the sea chests are blocked",
      "To inject chemical dispersants into the bilge holding tank",
      "For routine daily pumping of the bilges through the Oily Water Separator (OWS)",
  ...
  },
  {
    ...
    "opts": [
      "It injects oxygen into the exhaust to burn off residual carbon particles",
      "It cools the internal microprocessors, which would otherwise melt at exhaust temperatures",
      "It blows clean air across the optical windows to prevent exhaust soot from depositing on the lenses, which would otherwise cause false high opacity readings",
      "It spins a small internal turbine to generate power for the sensor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be disconnected from the main switchboard and wired to the emergency generator",
      "It must be set to MANUAL or turned OFF, as the system requires the hull to be submerged in conductive seawater to function properly",
      "The reference electrodes must be coated in insulating paint",
      "It must be turned up to maximum voltage to protect the hull from the drydock blocks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is used to spray fire-retardant foam over the exterior of the hull",
      "It powers the pneumatic winch used to lower the lifeboat from the davits",
      "It inflates the self-righting airbags if the lifeboat capsizes",
      "It provides a positive-pressure breathing air supply for the occupants for a minimum of 10 minutes, allowing escape through a surface oil fire"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By changing the tap connections on the external rotor resistance bank to switch more or less resistance into the rotor circuit",
      "By manually adjusting the swash plate angle on the hydraulic pump",
      "By altering the voltage output of the main switchboard AVR",
      "By reprogramming the max frequency parameter on the VFD keypad"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Crane defects, lack of load testing, or missing SWL markings are now statutory violations that directly impact the Safety Construction Certificate, allowing Port State Control to detain the ship",
      "The ETO is personally fined for any missing SWL markings",
      "Crane defects only apply to cargo cranes; engine room overhead cranes are exempt",
      "Crane defects only result in a minor note from the Classification Society and do not affect sailing"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The standby unit starts and comes online automatically within 45 seconds",
      "The bridge receives a general alarm, but the standby unit must be started manually",
      "The emergency generator immediately starts to provide power to the remaining unit",
      "The rudder hydraulically locks in its current position until a manual reset is performed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "From the emergency generator room using a manual override switch",
      "From a local control position in the steering gear room, completely independent of the bridge",
      "From the ship's office using a portable remote control unit",
      "From the Engine Control Room (ECR) via a dedicated emergency joystick"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Forced Draft fan speed is continuously adjusted while the fuel valve remains completely open",
      "The Burner Management System (BMS) hands control to a modulating controller that shifts the burner between high and low fire",
      "The BMS repeatedly turns the main fuel valve fully ON and OFF to maintain the average pressure",
      "The pilot burner is automatically re-ignited to boost pressure when demand is high"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It stops the motor immediately if heavy fuel oil enters the water line",
      "It detects separation quality and controls the timing of the desludging (ejection) cycle",
      "It ensures that pure fresh water is fed to the motor bearings for cooling",
      "It measures the temperature of the outgoing sludge to prevent fires"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To lubricate the friction clutch pads during the long run-up time",
      "To prevent the process liquid (hot oil) from reaching and damaging the motor and spindle bearings",
      "To dilute the heavy fuel oil and reduce its viscosity before separation",
      "To provide hydraulic pressure to open the sludge ejection ports"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The upper limit switch (prevents over-haul) and the lower limit switch (prevents over-pay-out)",
      "The load cell calibration setting and the manual clutch lever",
      "The motor overload relay and the phase failure relay",
      "The emergency stop button and the hydraulic bypass valve"
    ],
  ...
  },
  {
    ...
    "opts": [
      "In genuine navigational emergencies (like collision avoidance), though the action must be logged and reported to the Chief Engineer",
      "Only during pilotage operations when the engine load is below 30%",
      "Anytime the ship is behind schedule, provided the override does not exceed 10 minutes",
      "The bridge can never override a slow-down; only an emergency shutdown can be overridden"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The main engine load interlock blocks the jacket cooling water flow",
      "Chemical dosing pumps inject anti-scaling agents into the distillate line",
      "An automatic divert valve opens to reject the contaminated water overboard instead of routing it to the fresh water tank",
      "The vacuum pump motor is immediately tripped to stop evaporation"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because high temperatures cause the AC electrodes to polarize rapidly",
      "Because the electrical conductivity of water naturally increases by approximately 2% for every 1°C increase in temperature",
      "Because the distilled water flash point changes with ambient engine room temperatures",
      "Because salt naturally precipitates out of solution below 35°C, giving false zero readings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Disabling the fire detection system to prevent false alarms during maneuvering",
      "Testing the bow thruster from the local emergency control panel",
      "Starting the standby generator and synchronizing it to the main busbar",
      "Making an official entry in the engine room log with the time and name of the watchkeeper, and informing the bridge"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Inject grease into the grounding slip ring to prevent saltwater corrosion",
      "Replace the sacrificial zinc anodes attached to the external grounding strap",
      "Measure the stator winding insulation resistance and log the micro-ohm values",
      "Inspect the carbon brush condition and spring pressure, replace the brush if worn below 50% length, and clean the slip ring surface on the propeller shaft"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The emergency generator must be locked out to prevent auto-starting",
      "The ship's main switchboard must be placed in split-bus mode",
      "The entire bridge navigation console must be disconnected from the UPS",
      "The radar scanner motor must be isolated and antenna discharge devices put in place"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It relies on the pressure from the lifeboat's internal fresh water drinking tanks",
      "An engine-driven centrifugal pump draws seawater through a hull sea cock and distributes it through spray nozzles",
      "It utilizes a hand-cranked displacement pump operated by the crew",
      "It uses the compressed air from the breathing bottles to atomize seawater stored in the bilge"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A purely Mechanical (Centrifugal / Flyball) governor",
      "An Electronic (PID-based) governor",
      "A Pneumatic proportional controller",
      "A Hydraulic-Mechanical (Woodward type) governor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Always via an auto-transformer starting at 30% pitch to prevent motor stall",
      "Direct On-Line (DOL) at maximum pitch to ensure the motor syncs with the water flow",
      "Direct On-Line (DOL) at exactly zero pitch, then the pitch is applied gradually; large units may also use a soft-starter or VFD",
      "Using a slip ring rotor resistance starter while the blades are fully feathered"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Normal resistance is 0 ohms; a tripped state shows exactly 1 MΩ",
      "Normal resistance is >3k ohms; a tripped state shows a dead short (0 ohms)",
      "Normal resistance fluctuates with voltage; a tripped state locks at exactly 4–20mA",
      "Normal resistance is typically 100–200 ohms; a tripped (overheated) state shows a very high resistance, usually >3k ohms"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It keeps the engine jacket water at 50–60°C while the engine is stopped, preventing thermal shock and cold corrosion during startup",
      "It sterilises the fresh water to prevent biological growth in the cooling passages",
      "It boils the water to generate low-pressure steam for the heavy fuel oil heaters",
      "It automatically evaporates excess water to maintain the correct system pressure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Pump motor sustained overcurrent",
      "Hydraulic oil high temperature",
      "Hydraulic oil high pressure (relief valve operation combined with an electrical limit)",
      "Motor phase failure (loss of one phase)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Direct Variable Frequency Drive (VFD) governor",
      "Hydraulic-Mechanical (e.g., Woodward type) governor",
      "Pneumatic-Proportional governor",
      "Purely Mechanical (Centrifugal/Flyball) governor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Switch the steering control to Non-Follow-Up (NFU), manually move the tiller to regain control, identify and reset the trip, and investigate the feedback linkage",
      "Immediately switch off both main steering motors and engage the emergency generator",
      "Override the hydraulic bypass valves manually using a wrench in the steering flat",
      "Reboot the autopilot console on the bridge, which automatically clears all steering alarms"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Short circuit the main switchboard busbars to safely drain all residual capacitance",
      "Bypass all Thermal Overload Relays (OLRs) to prevent nuisance tripping on shore power",
      "Remove all carbon brushes from the alternators to prevent shipyard dust contamination",
      "Take baseline Insulation Resistance (Megger) readings to compare against post-drydock readings, ensuring no damage occurred during shipyard work"
    ],
  ...
  },
  {
    ...
    "opts": [
      "When the slip ring begins to show a chocolate-brown patina",
      "When it loses its silver coating",
      "When it is worn below 50% of its original length",
      "When it is worn below 10% of its original length"
    ],
  ...
  },
  {
    ...
    "opts": [
      "40 Litres/minute per person for a minimum of 10 minutes",
      "100 Litres/minute per person for a minimum of 30 minutes",
      "500 Litres total for the entire lifeboat regardless of passenger capacity",
      "10 Litres/minute per person for a minimum of 5 minutes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Every 10 years, tested to the point of destructive failure",
      "Annually, tested at 2.0 times the maximum working pressure",
      "Every 5 years, tested at 1.5 times the maximum working pressure",
      "Every 5 years, tested at exactly the maximum working pressure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "You change the tap connections on the external rotor resistance bank",
      "The speed is fixed at two distinct steps (High and Low) determined by the pole configurations; it cannot be variably adjusted beyond selecting those two speeds on the pendant",
      "You adjust the maximum frequency parameter on the crane's VFD keypad",
      "You adjust the swash plate angle on the hydraulic power pack"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To manually operate the cross-flooding valves using emergency hand wheels during cargo loading",
      "To physically sound the ballast tanks and calculate the vessel's metacentric height (GM)",
      "To dose the ballast water with approved anti-corrosion chemicals",
      "To maintain the electrical transfer pump motor, valve actuators, and the inclinometer (heel angle sensor) input signals to the control panel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The crane must be marked with a single, average SWL painted only on the tip of the jib",
      "The crane's SWL is recorded only in the digital PMS; physical markings are no longer required",
      "The crane must display a clearly readable load chart showing the Safe Working Load (SWL) at each specific radius, visible directly from the operator's control position",
      "The SWL must be permanently etched into the hook block, overriding any other limits"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It requires a crew member to manually wipe the lens with a dark cloth before every reading",
      "It mathematically subtracts the engine RPM from the photocell output",
      "It frequently auto-zeros itself against a 'clean air reference' baseline to mathematically compensate for optical drift",
      "It automatically increases the voltage to the halogen lamp by 5% every day"
    ],
  ...
  },
  {
    ...
    "opts": [
      "LEL is 10 mg/L; alarm is at 9 mg/L",
      "LEL is 2.5 mg/L; alarm is at 0.5 mg/L",
      "LEL is 100 mg/L; alarm is at 50 mg/L",
      "LEL is approx 50 mg/L; the alarm is set at 2.5 mg/L, providing a 20x safety margin"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A slight negative pressure (vacuum) to prevent mist leakage into the engine room",
      "Highly pressurized to 2.5 bar",
      "Exactly equal to atmospheric pressure",
      "Pressurized using inert inert gas (nitrogen)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The crankcase extraction fan would stop working",
      "The system would generate false high mist alarms as the halogen lamp ages and dims over time",
      "The system would fail to detect any oil mist at all",
      "The measuring tube would fill with calibration gas"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It continuously and sequentially draws gas from each individual crankcase unit one by one to isolate the location of the fault",
      "It mixes all crankcase gases together for a single average reading",
      "It physically rotates the photocell to point at different cylinders",
      "It injects clean air into the crankcase to dilute the mist"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Siemens and ABB",
      "Graviner and Dräger",
      "Alfa Laval and Westfalia",
      "Woodward and Regulateurs Europa"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Bypass the fuel heater and run the engine on cold HFO",
      "Switch to manual temperature control and set the steam valve using the temperature-viscosity chart for the current bunker grade",
      "Shut down the main engine immediately",
      "Switch the engine over to Marine Gas Oil (MGO) permanently"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Recalibrate the 4-20mA span to match the new fuel density",
      "None; if left in AUTO, the controller automatically adapts to maintain 10-14 cSt regardless of the new fuel's temperature requirements",
      "Manually change the PI parameters to account for the new sulfur content",
      "Purge the capillary tube with compressed air before use"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because Derivative control only works for pressure, not viscosity",
      "Because it violates class rules for hazardous area equipment",
      "Because the heating process is too fast for Derivative control to catch",
      "Fuel pumps create mechanical pressure ripples; Derivative action would react to these rapid ripples, causing the steam valve to hunt violently"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The precise adjustment of the dashpot orifice that provides the fastest possible speed correction without causing any overshoot or hunting",
      "Closing the dashpot completely to lock the fuel rack",
      "Opening the dashpot fully to allow instantaneous fuel delivery",
      "The point at which the engine shuts down due to low oil pressure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The engine responds extremely slowly, allowing frequency to drop dangerously low",
      "The dashpot oil boils and creates cavitation",
      "The engine responds very quickly to load changes but continuously overshoots and undershoots the target speed (hunting)",
      "The fuel rack becomes physically jammed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The governor linkages physically snap",
      "The engine responds sluggishly to load changes, causing prolonged frequency drops before slowly recovering",
      "The engine overspeeds violently",
      "The engine alternates between 50Hz and 60Hz rapidly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By changing the type of oil inside to a heavier grade",
      "By altering the electrical voltage to the solenoid",
      "By adjusting the tension on the main return spring",
      "By turning a variable needle valve to change the size of the internal orifice"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The oil heats up and thins out, triggering a thermal bimetallic strip",
      "It uses an electronic timer to delay the signal proportionally",
      "It forces the breaker contacts to open in exactly 0.1 seconds regardless of fault size",
  ...
  },
  {
    ...
    "opts": [
      "It cools the hydraulic oil by varying the fan speed",
      "It manually locks the rudder in place during heavy weather",
      "It pumps the hydraulic oil into the RAM cylinders",
      "It provides continuous electrical feedback of the actual rudder angle to the bridge indicator and the autopilot hunting gear"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It limits the hydraulic pressure to exactly 43 bar",
      "It routes fluid to four different rudders using three separate pumps",
      "It mixes 4 parts oil with 3 parts air for smoother operation",
      "It directs high-pressure fluid to the Port RAM, the Starboard RAM, or blocks flow completely (center position) to hold the rudder steady"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The valve will default to hard-over Port",
      "The valve will not shift when a Port command is given, and the rudder will simply not move to Port",
      "The hydraulic pump will dead-head and explode",
      "The control fuse will blow, disabling Starboard steering as well"
    ],
  ...
  },
  {
    ...
    "opts": [
      "During sea trials only",
      "While moving astern at 5 knots",
      "At the deepest seagoing draught and running at maximum ahead service speed",
      "While stationary in calm water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The motor runs backward, causing a 'Port' helm command to physically turn the rudder to 'Starboard', creating a severe navigation hazard",
      "The motor instantly trips the overload relay",
      "The motor runs at exactly half speed",
      "The hydraulic fluid cavitates and destroys the pump"
    ],
  ...
  },
  {
    ...
    "opts": [
      "NFU mode mechanically drops a locking pin into the rudder stock",
      "NFU mode completely electrically bypasses the faulty hunting gear/feedback linkage, allowing direct manual control of the solenoid valves",
      "NFU mode resets the hydraulic pressure relief valves",
      "NFU mode engages the backup emergency generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Hydraulic oil low level and Hydraulic oil high temperature",
      "Motor overcurrent and Rudder hunting",
      "Hydraulic oil high pressure and Phase failure",
      "Solenoid short circuit and Hydraulic block"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Isolate the main switchboard and power cycle the autopilot",
      "Reverse the motor phases to force the lock open",
      "Bleed air from the hydraulic RAMs and restart the pumps",
      "Switch to NFU, move the tiller manually to regain control, identify/fix the hunting cause, reset the trip, and return to FU mode"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Draining and replacing the hydraulic fluid",
      "A 125% SWL hydraulic pressure test",
      "A full dead-ship blackout recovery test",
      "Full movement test of both power units, changeover test between units, emergency power test, and communication check to steering gear room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "If the steering gear is successfully switched to the emergency generator",
      "If the motor exceeds its rated Full Load Current (FLC)",
      "If the hydraulic oil temperature exceeds 60°C",
      "If the steering motor runs continuously for an abnormal time (e.g., >30 seconds), indicating the rudder is failing to reach the demanded position"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The pilot valve opens, no flame is detected by the UV scanner within 10 seconds, the pilot valve closes, and the BMS enters a flame failure lockout",
      "It stops the Forced Draft fan to preserve heat",
      "It switches to the backup diesel generator",
      "It automatically bypasses the pilot and opens the main heavy fuel oil valve"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The burner trips immediately without delay",
      "The boiler conducts an emergency blowdown",
      "The main steam stop valve automatically closes",
      "An ALARM sounds to warn the operator, but the burner continues firing"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The safety relief valves lifting prematurely",
      "The heavy fuel oil solidifying in the burner nozzle",
      "Water carryover (priming) into the steam lines, which can destroy steam turbine blades or cause water hammer in pipes",
      "The furnace crown melting due to over-cooling"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Sensors (PT100, pressure transmitters), solenoid valves, ignition transformer, FD fan motor, and the Burner Management System (BMS) PLC",
      "Tuning the air/fuel ratio using combustion gas analyzers",
      "Replacing leaking water tubes and patching refractory brickwork",
      "Overhauling the mechanical feed water pump impellers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Chief/Second Engineer (Mechanical issue: poor atomisation, dirty nozzle, or incorrect air/fuel mechanical linkage)",
      "The ETO (Electrical issue: faulty UV scanner)",
      "The Master (Navigational issue: incorrect ship speed)",
      "The Oiler (Cleaning issue: dirty sight glass)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Check the physical color; it turns bright red when tripped",
      "Measure its resistance with a multimeter; a healthy thermistor is 100-200 ohms, while an overheated one will read several kilo-ohms (>3kΩ)",
      "Check the voltage across it; a healthy thermistor shows 440V",
      "Bypass it with a jumper wire to see if the motor starts faster"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Increase FD fan to maximum, open fuel valve to burn off sludge, then stop",
      "Modulate to low fire, close main fuel valve, initiate post-purge with FD fan to clear residual vapour, then stop fan",
      "Close main fuel valve instantly, stop FD fan instantly, sound alarm",
      "Open blowdown valve, close fuel valve, stop feed water pump"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A tachometer on the FD fan shaft",
      "An ammeter on the FD fan motor starter",
      "A Differential Pressure (DP) switch or an airflow flap switch mounted in the air duct",
      "The UV flame scanner"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Incomplete combustion (afterburning in the uptake) or severe soot buildup on the heat transfer tubes",
      "The boiler is producing exceptionally high-quality dry steam",
      "The feedwater is too cold, causing the fire to burn hotter",
      "The UV scanner is misaligned"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Grind down the brake pads to make them completely flat",
      "Increase the voltage to the brake coil to 440V to pull across the larger gap",
      "Add shims or adjust the armature stop nuts to reduce the gap back to 0.4 mm, ensuring the magnet can successfully pull the armature",
      "Replace the entire motor because the rotor shaft has shrunk"
    ],
  ...
  },
  {
    ...
    "opts": [
      "0.1 to 1 ohm (near short circuit)",
      "10 to 50 Mega-ohms",
      "Exactly 4-20 milliamps",
      "20 to 200 ohms, depending on the specific coil size and voltage rating"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The crane automatically switches to regenerative braking mode",
      "The brake releases permanently, dropping the load into the sea",
      "The coil overheats and blows its control fuse, the brake instantly clamps shut, and the hoisting motor overloads trying to turn against the locked brake",
      "The VFD increases frequency to compensate for the short circuit"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It measures wind speed and automatically disables crane operation if the wind exceeds the safe structural limit (e.g., 20 m/s)",
      "It calculates the weight of the load based on atmospheric pressure",
      "It monitors the swing of the load and automatically dampens it",
      "It measures humidity to prevent the wire ropes from rusting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A mechanical or electrical synchronization that automatically pays out or heaves in the hoist wire to keep the load at a perfectly constant height while the jib moves up or down",
      "A hydraulic system that levels the cargo inside a container",
      "A safety feature that prevents the crane from tipping over on a sloping deck",
      "The process of ensuring the crane cabin is perfectly horizontal"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By using certified test weights or a hydraulic pull-test insertion rig to apply exactly 100% and 110% of the SWL, and verifying the load cell triggers the cut-out",
      "By hoisting the ship's anchor until the crane tips slightly",
      "By pushing the 'Test' button on the VFD keypad",
      "By short-circuiting the load cell wires to simulate an infinite load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It cuts the control circuit to the 'Hoist UP' contactor, preventing further lifting, but keeps the 'Hoist DOWN' circuit active so the load can be safely lowered",
      "It automatically reverses the hoist motor to drop the load instantly",
      "It engages the emergency generator to provide extra lifting power",
      "It cuts all power to the crane entirely, freezing the load in mid-air"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The crane is downgraded to 50% capacity legally",
      "The officer simply writes a warning note in the ship's log",
      "It is a statutory SOLAS deficiency that can result in an immediate detention of the vessel until the markings are restored",
      "Nothing, provided the digital load chart in the software is readable"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Less than 50% of its rated current",
      "Exactly equal to its Full Load Current",
      "Approximately 6 to 8 times its rated Full Load Current for a few seconds",
      "15 to 20 times its rated Full Load Current"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent static electricity from igniting hydraulic fluid",
      "To power the rotating pitch-control hydraulics",
      "To provide a low-resistance path to the hull for induced magnetic currents, preventing those currents from discharging across and pitting the expensive bearings",
      "To act as an RPM sensor for the bridge indicator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The generator would suffer reverse power due to lack of load",
      "The noise of the thruster in air exceeds SOLAS acoustic limits",
      "The hydraulic pitch mechanism requires water pressure to move the blades",
      "If the tunnel is above water, the propeller spins in air; lacking water resistance, the motor will dangerously overspeed, and the dry seals will burn up"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A gearbox mechanically shifts between forward and reverse gears",
      "The VFD constantly alters the motor RPM and changes phase sequence to reverse",
      "The motor is repeatedly started and stopped, and reversed using contactors",
      "The motor runs continuously at a constant speed in one direction; thrust magnitude and direction are controlled purely by hydraulically twisting the propeller blades (pitch)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The 'Thermal Memory' function, which tracks heat buildup and locks out a restart until the motor windings have safely cooled down",
  ...
  },
  {
    ...
    "opts": [
      "Optical smoke detectors in the thruster room",
      "Ultrasonic thickness gauges on the tunnel walls",
      "Vibration sensors (accelerometers) mounted on the drive and non-drive end bearings",
      "Salinometers inside the hydraulic oil tank"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The motor will attempt to start against the massive resistance of the water, drawing sustained starting current (6-8x FLC) for a long period, causing an overcurrent trip or total ship blackout",
      "The thruster will simply push the ship twice as fast",
      "The propeller blades will snap off due to cavitation",
      "The motor will instantly reverse its phase sequence"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Lube oil is highly conductive and drains power from the stator",
      "Lube oil purifiers use direct-drive gears instead of flat belts",
      "Lube oil purifiers generally have larger, heavier bowls to handle higher throughput and thicker, colder oil, requiring more power to accelerate and maintain speed",
      "Lube oil purifiers must spin at 50,000 RPM, which requires massive horsepower"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It measures the volume of operating water in the hydraulic reservoir",
      "It measures the dielectric constant (conductivity/capacitance) of the fluid discharging from the water outlet to distinguish between water and oil",
      "It monitors the temperature of the cooling water jacket",
      "It checks for bacterial growth in the fresh water seal"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Typically 1 to 2 mm from the passing gear teeth or target metal",
      "It must be in direct physical contact with the shaft",
      "0.1 mm",
      "10 to 15 mm"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "1000 mm/s",
      "50 to 60 mm/s",
      "Approximately 10 to 12 mm/s vibration velocity"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The proximity sensor will burn out",
      "The purifier will separate oil 50% faster",
      "The bowl assembly will shift slightly at high speed, causing massive imbalance and an immediate vibration trip",
      "The motor will draw zero current"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The water transducer permanently short-circuits",
      "Sludge builds up too rapidly and asymmetrically before the timer initiates an ejection cycle, leading to bowl imbalance and a vibration trip",
      "The oil is purified to a much higher standard",
      "The electric motor acts as a generator and feeds power back"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It operates perfectly but uses 10% more electricity",
      "It pulls a deep vacuum, sucking air and moisture through any leaks, and runs continuously without cool return gas, causing the motor to overheat and burn out",
      "It converts the remaining lubricating oil into solid carbon blocks",
      "The condenser freezes solid and shatters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The system will automatically switch to air-cooling mode",
      "The discharge pressure will skyrocket until the mechanical Pressure Relief Valve (PRV) blows, venting the entire expensive refrigerant charge into the atmosphere",
      "The compressor will simply slow down until water is restored",
      "The evaporator will frost over completely"
    ],
  ...
  },
  {
    ...
    "opts": [
      "MARPOL Annex VI regulations ban Chlorofluorocarbons (CFCs) and strictly limit Hydrochlorofluorocarbons (HCFCs) due to their severe Ozone Depletion Potential (ODP)",
      "They corrode copper piping twice as fast as modern refrigerants",
      "They are highly flammable and caused several engine room fires",
      "They do not absorb heat well in tropical climates"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By looking at the frost on the pipes and hitting the valve with a hammer",
      "By adding more refrigerant oil until the compressor sounds quiet",
      "By setting the TEV screw fully closed and backing it off exactly one turn",
      "By measuring the suction line temperature and pressure, calculating the actual superheat, and turning the TEV adjustment screw to achieve the target 4-6°C superheat"
    ],
  ...
  },
  {
    ...
    "opts": [
      "4 to 6°C above the saturation temperature",
      "0°C exactly",
      "-5°C below the saturation temperature",
      "15 to 20°C above the saturation temperature"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An overcharge of refrigerant gas",
      "A low refrigerant charge (leak), a heavily iced/blocked evaporator coil, or a Thermostatic Expansion Valve (TEV) that is stuck closed",
      "A broken cooling fan on the condenser unit",
      "A fouled condenser or high seawater temperatures"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An explosive guillotine that cuts the rope",
      "A secondary diesel engine that takes over the load",
      "A mechanical friction slip clutch between the motor and the drum, which physically slips at a preset torque limit to prevent the rope from snapping",
      "A heavy anchor dropped directly into the water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By counting the number of times the drum revolves per minute",
      "By measuring the temperature of the friction brake pads",
      "By visually estimating the sag in the rope from the bridge",
      "Directly via a strain-gauge load cell on the mooring fairlead, or indirectly by measuring the exact electrical torque current drawn by the motor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Auto-Tension mode will trigger the ship's general alarm",
      "The winch will violently haul the ship back to the dock, destroying the bollards",
  ...
  },
  {
    ...
    "opts": [
      "A Direct-On-Line squirrel cage motor",
      "The Ward-Leonard system (AC motor driving a DC generator to control a DC winch motor)",
      "A simple Star-Delta starter",
  ...
  },
  {
    ...
    "opts": [
      "An IGBT Variable Speed Drive (VSD) operating in specialized 'Torque Control' mode",
      "A standard Soft-Starter",
      "A mechanical belt-and-pulley CVT",
      "A pneumatic air-driven motor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It prevents the winch from lifting loads lighter than 1 tonne",
      "It limits the minimum voltage the VFD can supply to the motor",
      "It prevents the hook from smashing into the deck",
      "It stops the motor from paying out any more rope when there are only a few wraps left on the drum, preventing the rope from completely detaching and falling overboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It forces the winch to heave at maximum speed during emergencies",
      "It prevents 'over-haul', stopping the motor from heaving in too far and snapping the wire or smashing the hook block into the jib sheave",
      "It limits the maximum torque the motor can output",
  ...
  },
  {
    ...
    "opts": [
      "The AVR automatically disconnects the field until the RPM stabilizes",
      "The reverse power relay forces the load to shed",
      "The generator seamlessly picks up the load and runs normally",
      "You cannot start an engine 'on load'; the massive instantaneous torque demand would stall the engine, drop the voltage, and trip the breaker immediately"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A fouled/blocked scavenge air cooler (water side or air side), or a dangerous fire burning inside the scavenge space",
      "An overspeeding turbocharger and low exhaust gas pressure",
      "A high seawater temperature and a broken governor",
      "A failed fuel injector and a broken piston ring"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A faulty, dripping fuel injector on Cylinder 3, or a burned/leaking exhaust valve on Cylinder 3",
      "A failure of the main Jacket Cooling Water pump",
      "A massive failure of the turbocharger bearings",
      "A complete loss of fuel supply from the day tank"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Localized boiling (nucleate boiling) occurs inside the cylinder head cooling passages, creating steam pockets (hot spots) that lead to rapid thermal cracking of the metal",
      "The engine will run so efficiently that it overspeeds the governor",
      "The fresh water generator will freeze up due to over-evaporation",
      "The lubricating oil will mix with the water and form an emulsion"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To add specific corrosion inhibitors (like nitrite/molybdate) that coat the inside of the liners, preventing pitting and galvanic corrosion in the water passages",
      "To add salt to the water to lower its freezing point",
      "To add heavy fuel oil to lubricate the water pump bearings",
      "To inject chlorine to kill marine growth and barnacles"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Never; the chemicals are lifetime-sealed inside the engine",
      "Tested annually by an external class surveyor only",
      "Tested monthly using a dedicated chemical test kit, with results and any top-up amounts recorded in the official ship's chemical log",
      "Tested daily using the salinity meter and logged in the deck log"
    ],
  ...
  },
  {
    ...
    "opts": [
      "At low loads, the ship is usually in port where FWG operation is legally banned",
      "At low loads, the FWG pulls too much electricity from the shaft generator",
  ...
  },
  {
    ...
    "opts": [
      "The ETO shorts out the main switchboard to see if the blackout alarm sounds",
      "The ETO calls the company shore office to confirm satellite telemetry is working",
      "The ETO writes 'Tested OK' in the logbook without physical verification",
      "The ETO performs a walk-around, triggering test buttons to ensure audible and visual alarms correctly activate on the bridge, the C/E's cabin, and the duty mess"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the shipyard crane will magnetically attach to the hull",
      "Because the system requires conductive seawater to complete the circuit; in dry air, the system will output maximum voltage trying to achieve protection, risking equipment damage and shock",
      "Because it will interfere with the shipyard's Wi-Fi network",
      "Because the ICCP system emits toxic gases when exposed to air"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Remove the transducers completely and store them in the bridge",
      "Inspect the physical hull fitting, ensure the transducer face is clear of thick antifouling paint, check the zinc anodes on the frame, and inspect the internal deck cable glands for leaks",
      "Use a hammer to tap test the acoustic resonance of the crystals",
      "Coat the transducer faces with heavy grease to protect them from drydock dust"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Leave them alone; they never need replacing as long as the ICCP is working",
      "Inspect all zinc/aluminium anodes and formally record their condition; any anode worn below 50% of its original mass must be cut off and renewed",
      "Measure the voltage of each anode and connect them to the main battery",
      "Paint over all anodes to protect them for another 5 years"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Disable the system entirely to prevent false alarms from shipyard welding",
      "Prepare a comprehensive detector map, physically apply smoke/heat to every single detector on the ship, and witness the panel response alongside the surveyor",
      "Press the 'Lamp Test' button on the panel and print a certificate",
      "Only test the detectors in the Master's cabin and the engine room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The ship must be completely stopped and anchored",
      "Chief Engineer's signature and a pair of rubber gloves",
      "A written letter to the company and a specialized scaffolding tower",
      "Master's signature, verified wind speed <10 knots, a dedicated buddy/standby person on deck, and a full-body harness with twin lanyards"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Tools must be painted bright orange for visibility",
      "Only wooden or plastic tools are allowed near the radar",
      "Tools must be thrown down to the deck when finished rather than carried",
      "Absolutely all tools must be secured with individual lanyards to the ETO's belt or secured inside zipped tool bags to prevent deadly dropped objects"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It can be refilled using any high-pressure air line in the engine room",
      "It MUST only be recharged using a certified Class E 'Breathing Air' compressor; using standard ship's workshop air risks deadly oil mist and carbon monoxide contamination",
      "It can only be refilled by blowing exhaust gas through a carbon filter",
      "It must be filled with pure 100% Oxygen to maximize survival time"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It automatically extinguishes fires inside the engine compartment of the lifeboat",
      "It sprays chemical dispersants onto the burning oil slick to clear a path",
      "It is a water spray fire protection system that draws seawater from the hull and continuously sprays it over the entire outer surface of the closed lifeboat to cool it while escaping a fire",
      "It washes salt off the windows so the coxswain can see clearly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It activates automatically the moment the lifeboat touches the water",
      "The coxswain manually opens a dedicated control valve inside the lifeboat after the engine is started and the sea cock is open",
      "It is triggered remotely from the ship's bridge before launching",
      "It requires a crew member to climb on the roof and pull a ripcord"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Close the process isolation valve to stop live oil pressure from the compressor from reaching the sensor",
      "Unscrew the sensor completely from the manifold with a wrench",
      "Open the equalising bypass valve to vent oil onto the deck",
      "Connect the laptop to the DCS and delete the old calibration file"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Plus or minus 2% of the full-scale range",
      "Plus or minus 10% of the full-scale range",
      "0% error is strictly required; any deviation means instant rejection",
      "As long as it reads above zero, it is acceptable"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is a tiny, 10mm brass valve attached to the Oily Water Separator",
      "It is painted entirely bright pink and located on the ceiling",
      "It is a massive valve connected to the main cooling pump suction, clearly labeled 'EMERGENCY BILGE SUCTION', and is physically sealed or wired shut with a breakable tag",
      "It has no handle and can only be opened using a special computer command"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Disconnect them from the main switchboard and wire them to the emergency generator",
      "Megger test the stators with 5000V to ensure they are dry",
      "Grease all the wire ropes and paint the drums",
      "Test run each motor, apply and release the EM brakes, and explicitly verify control functions from BOTH the local pendant and the remote operator station"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It measures the ultrasonic acoustic resonance of the fuel pipe",
      "A spinning disc creates torque in the fluid, which is measured by a load cell",
      "A constant-flow gear pump forces fuel through a fixed capillary tube; the pressure drop (differential pressure) across the tube is directly proportional to the fluid's viscosity",
      "It measures the time taken for a steel ball to fall through a tube of hot fuel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the viscotherm motor will overspeed in the thinner fluid",
      "Because MGO chemically reacts with steam, forming explosive hydrogen gas",
      "Because heating MGO causes it to expand and burst the fuel lines",
      "MGO has a naturally low viscosity (2-6 cSt); if heated, its viscosity drops below 2 cSt, causing catastrophic loss of lubrication and seizure in the fuel injection pumps"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses a centrifuge to separate heavy sludge before the injectors",
      "It injects water into the fuel to reduce NOx emissions",
      "It mathematically calculates the exact fuel consumption for the Chief Engineer",
      "It dampens pressure pulsations from the booster pumps and safely mixes the hot return fuel from the engine with the incoming colder fuel from the service tank"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The fuel will burn too quickly, causing pre-ignition and engine knocking",
      "The engine will instantly overspeed due to the denser fuel",
      "The fuel injectors will physically shatter under the pressure",
      "The fuel droplets will be too large to burn completely in the available time, resulting in severe afterburning, high exhaust temperatures, and heavy black smoke"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A bypass steam valve automatically takes over using a mechanical thermostat",
      "The engine is run purely on cold HFO until maintenance is complete",
      "The boiler is temporarily shut down to stop all steam production",
      "The steam valve controller is switched to MANUAL mode, and the engineer manually adjusts the output (e.g., to 60%) while monitoring the fuel thermometer"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "A thermal overload relay or internal thermistor to protect it if the spindle jams in cold, solidified fuel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The steam valve will react very sluggishly, taking hours to correct the temperature",
      "The controller will switch to Derivative mode",
      "The steam valve will stop moving entirely",
      "The steam valve will react very aggressively to small changes in viscosity, which can cause severe temperature overshoot and hunting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It limits the maximum speed the steam valve can open",
      "It continuously accumulates any steady-state error over time and forces the steam valve to move until the viscosity is exactly at the setpoint (zero offset)",
      "It predicts future viscosity changes based on fuel pressure",
      "It ignores small ripples caused by the fuel booster pumps"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Rapid heating causes the viscotherm motor to spin backwards",
      "Rapid heating causes 'thermal cracking', breaking the fuel into lighter gases and heavy carbon sludge which fouls the heater tubes",
      "Rapid heating reduces the sulfur content illegally",
      "Rapid heating causes the steam pipes to freeze"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The valve will rapidly oscillate open and closed",
      "The valve is 'Fail Open', so it will open completely, boiling the fuel",
      "The valve is 'Fail Last', freezing in its current position forever",
      "The valve is 'Fail Close', so it will shut completely, stopping all steam; fuel viscosity will rise, triggering a high-viscosity alarm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Megger the 4-20mA signal wires with 1000V DC",
      "Replace the steam control valve diaphragm",
      "Verify the 4-20mA loop integrity, check cable terminations for vibration damage, and perform a zero/span calibration check if the reading is drifting",
      "Drain and replace the silicone fluid in the motor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The steam supply is physically blocked, the heater tubes are heavily fouled with carbon, or the steam trap is malfunctioning and waterlogging the heater",
      "The controller's Integral action is set too fast",
      "The Viscotherm setpoint is set too high",
      "The fuel is actually Marine Gas Oil (MGO)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The thin fuel will cause the engine to run backwards",
      "The thin fuel lacks lubricity, leading to severe scuffing and seizure of the fuel pump plungers and injector needles",
      "The thin fuel will freeze in the pipes",
      "The thin fuel will extinguish the combustion flame"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It cannot be bypassed; the main engine must be stopped",
      "By electrically shorting out the 4-20mA signal",
      "By opening the manual fuel bypass valve and closing the inlet/outlet isolation valves on the viscometer block",
      "By turning off the booster pumps to stop fuel flow"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The steam valve will automatically switch to Derivative control",
      "The DP reading will lock at 20mA to indicate a fault",
      "The viscosity reading remains accurate due to internal mathematical compensation",
      "The viscosity reading will be completely inaccurate, as the DP relies on a strictly constant flow rate to represent viscosity correctly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The sensor will overheat from the ambient engine room air",
      "The 4-20mA signal will lose voltage due to wire resistance",
      "It introduces a massive 'transport delay' (dead time) into the control loop, causing the controller to react too late and hunt continuously",
      "The fuel will become too clean before reaching the sensor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Flash point is the temperature at which the Viscotherm motor burns out",
      "Flash point is the lowest temperature at which the fuel produces combustible vapor; heating HFO above its flash point to reach viscosity creates a severe explosion hazard in the tanks/pipes",
      "Flash point is the point where the fuel solidifies",
      "Flash point is the exact temperature where viscosity reaches 0 cSt"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A chart showing the pressure drop across the fuel filters",
      "A map of the electrical wiring for the Viscotherm controller",
      "A log of the engine's RPM against fuel consumption",
      "A graphical line showing exactly what temperature a specific bunker fuel must be heated to in order to achieve the ideal 14 cSt injection viscosity"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It improves the mixing of the fuel, providing a better reading",
      "It can cause excessive wear on the delicate spindle bearings and induce noisy, fluctuating torque signals, destabilizing the control loop",
      "It causes the steam valve to permanently lock open",
      "It generates a static electrical charge that blows the 4-20mA fuse"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It will automatically switch to a wireless Bluetooth connection",
      "It will rise to 24mA, opening the steam valve 100%",
      "It will drop to 0mA, triggering a 'Sensor Break / Loop Fault' alarm and usually forcing the steam valve to its fail-safe closed position",
      "It will hold the last known good value indefinitely"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A system that tracks the exact location of a fuel leak using thermal cameras",
      "Steam or electrical heating lines wrapped around the fuel pipes to maintain fuel temperature and viscosity when the engine is stopped, preventing the fuel from solidifying",
      "A system that cools the pipes using seawater to prevent fires",
      "A method of burning off waste fuel in the exhaust stack"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is highly flammable and acts as a backup fuel",
      "It evaporates quickly, leaving the dashpot completely clean",
      "Silicone oil has an extremely stable viscosity-temperature coefficient, meaning its thickness (and the resulting time delay) doesn't change drastically when the engine room gets hot",
      "It is highly conductive and improves the electrical contact"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It relies entirely on magnetic repulsion",
      "It creates instantaneous trips with zero delay",
      "It uses air drawn through a needle valve into a bellows/chamber to create the delay, rather than pushing oil",
      "It uses high-pressure steam instead of air"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It blocks all movement to lock the breaker closed permanently",
      "It closes during the upward (trip) stroke to force oil through the tiny orifice for a slow delay, but opens wide on the downward stroke so the relay resets instantly",
      "It allows oil to leak out slowly to indicate maintenance is required",
      "It acts as a pressure relief valve to prevent the dashpot from exploding"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It instantly sheds all load the millisecond a fault is detected",
      "It provides a 5 to 15-second time delay, ensuring that harmless, brief starting currents from large motors do not accidentally trigger the shedding of ship's loads",
      "It increases the voltage output to compensate for the heavy load",
      "It mechanically disconnects the generator from the busbar"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A completely blocked orifice",
      "Low oil level or using an oil with a viscosity that is far too thin",
  ...
  },
  {
    ...
    "opts": [
      "A high ambient engine room temperature",
      "An empty oil cylinder",
      "Dirt or sludge completely blocking the needle valve orifice, or using an oil that is far too thick",
      "A worn check valve"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By turning the compensating needle valve fully open to let trapped dirt flush through, then carefully resetting it to the exact original position",
      "By replacing the silicone oil with fresh heavy fuel oil",
      "By pumping compressed air directly into the oil reservoir",
      "By removing the governor completely and boiling it in water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It means the governor only uses electronics; hydraulic dashpots are illegal",
      "It refers to a governor that shares load by shifting phase angles",
      "It means the engine runs at variable speeds; the dashpot is disabled entirely",
      "Isochronous means 0% droop (maintaining exactly 60Hz at all loads); this is highly unstable in parallel, requiring perfect dashpot tuning to prevent violent hunting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To increase the speed at which the contacts close",
      "To prevent 'Contact Bounce', which causes severe electrical arcing and welding of the silver contacts when they slam shut",
      "To generate a magnetic field that blows out the arc",
      "To lubricate the copper busbars"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It converts the mechanical strike into pneumatic air pressure",
      "It delays the electrical signal from reaching the VFD by 10 seconds",
      "It amplifies the striking force to ensure a good connection",
      "It dampens the impact of the heavy striker arm hitting the switch, protecting the delicate internal electrical contacts from mechanical shattering"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It works perfectly but with a 50% slower response time",
      "The engine automatically trips on overspeed",
      "It converts to pneumatic operation automatically",
      "It is completely lost; the governor will hunt uncontrollably or fail to control fuel altogether because the hydraulic servo relies on that oil"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The accumulator cools the oil before it enters the dashpot",
      "The accumulator stores electricity, the dashpot stores oil",
      "The accumulator stores pressurized oil to supply the servo for fast movements, while the dashpot regulates and dampens that movement for stability"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A flat horizontal line representing a fixed 5-second delay",
      "An asymptotic inverse curve, where high current yields near-zero time, and low current approaches infinity without tripping",
      "A stepped square-wave curve",
  ...
  },
  {
    ...
    "opts": [
      "Electronic relays offer perfect, drift-free precision, adjustable curve shapes, and are completely immune to the oil leaks and dirt clogs that plague mechanical dashpots",
      "Electronic relays are totally immune to lightning strikes",
      "Mechanical dashpots are banned by MARPOL environmental rules",
      "Electronic relays can generate their own 440V power"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It closes the needle valve, restricting airflow and INCREASING the time delay",
      "It physically shortens the stroke of the piston",
      "It increases the voltage to the relay coil",
      "It opens the valve, decreasing the time delay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An On-Delay restricts fluid entering the chamber when energized, while an Off-Delay restricts fluid escaping the chamber when de-energized",
      "An On-Delay uses oil, while an Off-Delay uses compressed air",
      "An On-Delay is painted green, an Off-Delay is painted red",
  ...
  },
  {
    ...
    "opts": [
      "The oil will spray out of the adjustment screw",
      "The timer will operate once, but will never reset to its starting position, permanently holding the delayed contacts closed",
      "The timer will trip instantly with zero delay",
      "The timer will violently oscillate open and closed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Exactly 7.5 seconds (half the set time)",
      "It will never trip, as short circuits are handled by fuses",
      "Exactly 15 seconds, as the timer is absolute",
      "It will likely trip almost instantly; the massive magnetic force of a short circuit will easily rip the piston through the oil, overriding the 15-second overload setting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Viscous damping resistance increases with speed (fast movements are heavily resisted), whereas friction damping is relatively constant regardless of speed",
      "Viscous damping uses dry metal plates; friction damping uses oil",
      "Viscous damping is only used in extremely cold climates",
  ...
  },
  {
    ...
    "opts": [
      "Air causes the oil to freeze at low temperatures",
      "The air will short out the internal electrical contacts",
      "Air improves the damping effect by adding a pneumatic cushion",
      "Air is highly compressible; the dashpot loses its rigid resistance, causing a 'spongy' response and resulting in erratic engine hunting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent unauthorized crew members from adjusting the screw",
      "Because magnetic fields only work vertically",
      "To ensure the fluid remains settled at the bottom around the piston and orifice, and to allow any trapped air bubbles to safely vent to the top",
      "To save horizontal space in the switchboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Monthly; requires injecting high-pressure steam to clean the valves",
      "Never; they are sealed for the lifetime of the ship",
      "Daily; requires complete oil change and filter replacement",
      "Checked during the 5-yearly drydock survey; involves removing the cup, checking/topping up the specific silicone oil, cleaning the orifice, and verifying the trip times via secondary injection"
    ],
  ...
  },
  {
    ...
    "opts": [
      "AC can travel much further distances through the engine room wiring",
      "AC is inherently safer if a crew member touches the water",
      "DC causes electrolysis, which covers the electrodes in insulating gas bubbles (polarization) and strips the metal, destroying the reading accuracy; AC prevents this",
      "DC voltage is too weak to penetrate distilled water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "35,000 ppm",
      "Typically 2 to 10 ppm, depending on the boiler pressure rating",
      "500 to 1000 ppm",
      "100 to 200 ppm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "100 ppm; exceeding this sounds the general ship alarm",
      "Typically 5 ppm; exceeding this causes the divert valve to reject the water overboard",
      "1000 ppm; exceeding this dumps the fresh water tank",
      "50 ppm; exceeding this shuts down the main engine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "De-energized = Valve freezes in its last position",
      "De-energized = Flow to Fresh Water Tank. Energized = Dump Overboard",
      "De-energized (power loss) = Dump Overboard/Bilge. Energized = Flow to Fresh Water Tank",
      "De-energized = Flow redirects back into the sea chest"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To increase the commercial value of the instrument",
      "Because they are the only metals capable of conducting AC current",
      "These noble metals are highly resistant to oxidation and chemical corrosion, ensuring the surface resistance remains perfectly constant for accurate readings",
      "To act as a catalyst for breaking down oil molecules in the water"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A thermistor or RTD (PT100) temperature sensor for automatic temperature compensation",
      "A small heating element to boil the sample",
      "A magnetic stirrer to agitate the water",
  ...
  },
  {
    ...
    "opts": [
      "Burn off the impurities using a blowtorch",
      "Gently wash with a soft brush and a mild acid (or specified solvent) to remove scale; NEVER use sandpaper, emery cloth, or abrasive files",
      "Boil the electrodes in pure caustic soda for 10 minutes",
      "Scrub vigorously with a wire brush and apply electrical contact grease"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Air is a perfect insulator; bubbles displacing water between the electrodes will cause a falsely LOW conductivity (ppm) reading",
      "Air is highly conductive; it will cause a falsely HIGH conductivity reading and trip the divert valve",
      "The bubbles will implode, shattering the glass housing of the sensor",
      "The salinometer will automatically switch to a voltage-measurement mode"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Installed completely horizontally at the lowest point in the bilge",
      "Installed vertically in a U-bend or an upward-flowing section of pipe so that air naturally flows past it and does not accumulate in the sensor housing",
      "Installed inside the boiler furnace to burn off any oxygen",
      "Installed directly on the suction side of a high-speed pump"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Oil acts as a semiconductor, causing wild fluctuations from 0 to 1000 ppm",
      "The oil magnifies the signal, causing a false HIGH reading",
      "Oil is an insulator; the coating blocks the electrical current, causing a dangerously false LOW salinity reading",
      "The salinometer detects the hydrocarbon and sounds a fire alarm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To ensure the water is completely boiled before it is discharged",
      "To allow the freshwater pump to build up maximum pressure",
      "To give the crew time to taste the water before it is dumped",
      "To prevent the heavy solenoid valve from rapidly chattering (opening and closing violently) if the salinity is hovering exactly around the 5 ppm setpoint"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Remove the sensor, clean it, immerse it completely in a beaker of lab-grade pure distilled water, and adjust the zero potentiometer until the display reads exactly 0 ppm",
      "Short the two electrodes with a screwdriver and adjust the dial",
      "Leave the sensor in the empty, dry pipe and press the zero button",
      "Immerse the sensor in fresh seawater and set it to 35,000 ppm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Turn the span dial to the maximum physical limit of the screw",
      "Connect the sensor to a 220V wall outlet to test maximum voltage",
      "Fill the beaker with heavy fuel oil and set the span to 100%",
      "Immerse the clean sensor in a certified standard NaCl calibration solution (e.g., 10 ppm) and adjust the span potentiometer until the display exactly matches the solution's certificate"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By connecting a 9V battery across the sensor input",
      "By disconnecting the sensor wires and connecting a precision test resistor across the terminals; the manual provides a chart mapping specific resistance values to specific ppm displays",
      "By licking two fingers and touching the terminals",
      "By bridging the terminals with a solid copper wire to read infinity"
    ],
  ...
  },
  {
    ...
    "opts": [
      "35,000 ppm (or 35 parts per thousand)",
      "1,000,000 ppm",
      "1,000 ppm",
      "5 ppm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Fast flow generates static electricity that blows the internal fuses",
      "Stagnant water reverses the polarity of the AC supply",
      "The friction of fast water heats up the electrodes past 100°C",
      "Extremely high velocities can cause turbulence and cavitation (bubbles), while stagnant water allows rust and dirt to settle on the electrodes, both causing inaccurate readings"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A broken cable between the sensor and the panel, a completely dry pipe (no water), or severe coating/polarization on the electrodes",
      "The sensor is operating perfectly (Optimal Level)",
  ...
  },
  {
    ...
    "opts": [
      "The divert valve solenoid is burned out",
      "A short circuit in the sensor wiring, or heavy conductive metallic sludge bridging the two electrodes",
      "The temperature compensation thermistor is reading too cold",
      "The AC supply frequency is too high"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The water temperature being over 100°C",
      "The divert valve failing in the dump position",
      "An OPEN circuit (broken wire), a dry sensor housing, or oil coating the electrodes, all of which block current flow, mimicking zero conductivity",
      "A dead short circuit in the wiring"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The meter reads exactly 0 ppm and accepts the water",
      "The meter shuts down completely to protect its screen",
      "The AC power supply reverses into DC",
      "The resistance drops to zero, the current maximizes, and the meter pins at maximum ppm (e.g., 9999 ppm), immediately triggering the dump valve"
    ],
  ...
  },
  {
    ...
    "opts": [
      "As an indirect safety check; since oil is an insulator, a sudden massive drop in conductivity might indicate a slug of pure oil is passing the sensor",
      "It measures the temperature of the oil to ensure it doesn't freeze",
      "It replaces the 15 ppm Oil Content Monitor legally",
      "It reacts chemically with the oil to form a conductive salt"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Greasing the external linkage with heavy molybdenum grease",
      "Dismantling and cleaning the internal diaphragm, pilot port, and plunger to prevent scale build-up from causing the valve to stick",
      "Painting the valve casing with anti-corrosive paint",
      "Rewinding the copper coil every 6 months"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By pressing the 'Test' or 'Simulate Alarm' button on the panel, then physically verifying that water flows out the dump line and stops flowing into the FW tank line",
      "By checking the ship's draft marks to see if weight is lost",
      "By looking at the LED light on top of the solenoid coil",
      "By tasting the water in the FW tank the next day"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The AC frequency is set too high",
      "Turbulence or air/vapor bubbles passing through the sensor chamber, or a loose electrical connection vibrating on the sensor head",
      "The divert valve is opening too slowly",
      "A perfectly normal response to the Earth's magnetic field"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To allow the cable to carry high-voltage AC current safely",
      "To satisfy aesthetic Class society color-coding rules",
      "To prevent the cable from physically rusting in the humid engine room",
      "To protect the sensitive low-voltage micro-current signal from Electromagnetic Interference (EMI) generated by massive nearby power cables and VFDs"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Grounded at ONE end only (usually inside the main control panel) to prevent 'Earth Loops' that would introduce noise into the signal",
      "It must never be grounded; it should be left floating",
      "Grounded directly to the negative terminal of the ship's battery",
      "Grounded at both the sensor end and the panel end"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Neither is correct; boiler water cannot exceed 0.1 ppm physically",
      "Both are correct; they measure two completely different types of salt",
      "The salinometer is correct; chemical tests are notoriously inaccurate on ships",
      "The chemical test is correct; the salinometer is likely giving a false low reading due to oil fouling, scaled electrodes, or a broken temperature compensation circuit"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The thermostat opens → the Liquid Line Solenoid valve closes → the compressor keeps running, sucking the remaining gas out of the evaporator → suction pressure drops → the LP switch trips and stops the compressor",
      "The thermostat turns off the compressor directly → the solenoid valve closes slowly",
      "The TEV reverses flow, pushing gas back into the receiver",
      "The HP switch forces the compressor to push all gas into the condenser, then shuts down"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The thermostat sends a 440V signal directly to the compressor contactor",
      "The thermostat detects a warm room → opens the liquid solenoid → warm gas flows into the evaporator, raising suction pressure → the LP switch detects the rising pressure and automatically restarts the compressor",
      "The timer relay turns the compressor on every 15 minutes regardless of temperature",
      "The HP switch detects low pressure in the condenser and orders a restart"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It sterilizes the oil to prevent bacterial breakdown of the CFCs",
      "It keeps the lubricating oil warm while the compressor is OFF, preventing liquid refrigerant from migrating and dissolving into the cold oil, which would cause severe foaming and bearing failure on startup",
      "It warms the engine room to keep the crew comfortable",
      "It boils the refrigerant to increase the discharge pressure during winter"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is controlled purely by a manual switch located on the bridge",
      "It is wired through a Normally Open (NO) contact; it only runs when the compressor is running",
      "It is wired directly to the main busbar and runs 24/7 forever",
      "It is wired through a Normally Closed (NC) auxiliary contact on the compressor starter; it turns ON when the compressor stops, and turns OFF when the compressor is running"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The compressor pumps down and stops → Evaporator fans STOP → Electric defrost heaters turn ON to melt the ice → Timer or temp switch ends the cycle → Heaters OFF → Compressor and fans restart",
      "The room door is automatically cracked open to let warm air in",
      "Compressor runs at 150% speed to generate hot gas → Evaporator fans run in reverse",
      "Solenoid valve opens fully to flood the evaporator with hot seawater"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the fans would draw too much current and trip the main breaker",
      "Because the fan motors are not rated for temperatures above 0°C",
      "To trap the heat within the evaporator fins to melt the ice quickly, and to prevent blowing warm air throughout the cold room, which would spoil the cargo",
      "To prevent the fan blades from striking the expanding ice blocks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A reverse-power relay on the main switchboard",
      "A float switch that detects the melted water dripping",
      "A high-temperature limit switch (Klixon or thermostat) physically attached to the heater elements that forcefully cuts power if they exceed a safe temperature",
      "A fusible link that melts and drops the entire evaporator to the floor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The compressor runs backwards for a short period to clear blockages",
      "The compressor rapidly turns ON and OFF repeatedly in short intervals (e.g., every 30 seconds), causing massive electrical strain, overheating, and starter wear",
      "The refrigerant completely bypasses the evaporator, shorting the cycle",
      "The compressor runs on only two phases of electricity"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An 'Anti-Recycle Timer' (or time-delay relay) that forces the compressor to remain OFF for a minimum safe period (e.g., 3 to 5 minutes) before allowing a restart",
      "A massive capacitor bank to absorb the start currents",
      "A secondary standby compressor that alternates every 10 seconds",
      "A heavy-duty mechanical brake"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They use a VFD to slow down individual cylinders",
      "The solenoids dump excess refrigerant overboard to reduce pressure",
      "They physically detach the pistons from the crankshaft",
      "Electric solenoids open bypass valves on specific cylinders, rendering them mechanically useless; this allows a 4-cylinder compressor to run efficiently at 25%, 50%, 75%, or 100% capacity to match the cooling load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To push out any trapped liquid refrigerant into the condenser",
      "To minimize the mechanical torque required to turn the crankshaft, allowing the motor to accelerate rapidly and keeping the high starting current (inrush) as brief as possible",
      "To ensure the star-delta timer completes its cycle",
      "To prevent the lubricating oil from foaming"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The frequency will drop to 50Hz",
      "The power factor will instantly shift to 1.0 (Unity)",
      "A massive, violent spike in motor current as the pistons try to compress an incompressible liquid, usually causing an instantaneous trip of the Thermal Overload Relay or Main Breaker",
      "The motor will spin significantly faster, dropping the current to near zero"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It injects water directly into the hot refrigerant gas",
      "It proves that cooling water is flowing through the condenser; if water fails, it prevents the compressor from starting or trips it to avoid a dangerous High Pressure (HP) spike",
      "It ensures the water is salty enough to absorb heat",
      "It adds chemicals to the water to prevent marine growth"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because Class 10 is for 110V and Class 20 is for 220V",
      "A compressor is a heavy-starting load; it requires a slower 'Class 20' relay to allow the longer 15-20 second starting current surge without nuisance tripping, unlike a fast 'Class 10' pump relay",
      "Because Class 10 is for positive temperatures and Class 20 is for freezing temperatures",
      "Because Class 20 is completely fireproof"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Operational controls use triple-thick lines",
      "Safety controls are always connected to the negative DC wire",
      "Safety controls are drawn in red ink",
      "Safety controls are hardwired in series directly with the main contactor coil (breaking power unconditionally), while operational controls often pass through PLCs or timers first"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The contacts inside the main motor contactor have welded shut, or the room thermostat contacts are stuck in the 'closed/calling for cool' position",
      "The Low Pressure (LP) switch is set too high",
      "The compressor has lost its entire oil charge",
      "The defrost heater is wired in reverse"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because hermetic motors run on DC power only",
      "Because the aluminum casing blocks all electrical current",
      "Because the megger will permanently magnetize the compressor valves",
      "The windings are submerged in refrigerant gas and oil; under vacuum, the high voltage can easily arc across the terminals, destroying the motor and chemically breaking down the refrigerant into deadly acids"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It injects hot gas into the lubricating oil to clean it",
      "It vents excess hot gas up the funnel to prevent explosions",
      "It routes hot, high-pressure discharge gas directly back into the low-pressure suction line to artificially keep the suction pressure up during low-load conditions, preventing the compressor from tripping on the LP switch",
      "It bypasses the compressor entirely to cool the room using only seawater"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "The electrical timer is broken and needs replacing",
      "The electrical time-delay circuit is working perfectly, but the mechanical oil pump is genuinely failing to build pressure, or the crankcase oil level is completely empty",
      "The main power supply is dropping below 440V"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To spin the propeller slowly to clear seaweed before full power is applied",
      "To warm up the motor windings before applying full voltage",
      "To trickle-charge the ship's 24V emergency batteries",
      "To slowly charge the massive DC-link capacitors; without it, throwing the main breaker would cause a colossal inrush current that would instantly explode the rectifier diodes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "220V DC",
      "Exactly 440V DC",
      "Approximately 600V DC (calculated as AC RMS Voltage × 1.35 or √2)",
      "Over 1000V DC"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the main VFD outputs DC, and the fan requires AC",
      "To satisfy SOLAS redundancy requirements for steering equipment",
      "Because the main VFD varies the frequency/speed; if the main motor runs slowly, an attached fan would spin slowly and fail to cool the motor. A separate supply ensures 100% cooling air at all speeds",
      "To prevent harmonic distortion from the fan motor entering the VFD"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The main VFD is blocked from starting until a contactor or airflow switch proves that the independent cooling fan is running at full speed",
      "The cooling fan is only allowed to start if the ambient temperature exceeds 40°C",
      "The VFD must reach 100% output before the cooling fan is allowed to start",
      "The cooling fan must run in reverse for 10 seconds before the VFD starts"
    ],
  ...
  },
  {
    ...
    "opts": [
      "VFDs chop the AC wave into sharp DC pulses, injecting severe 5th and 7th harmonic distortions back into the ship's grid, which can overheat generators and destroy sensitive electronics",
      "To smooth the physical water flow through the tunnel",
      "To absorb lightning strikes hitting the ship's mast",
      "To filter out mechanical noise from the propeller cavitating"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It warms the lubricating oil in the lower gearbox",
      "It prevents the carbon earthing brushes from freezing to the slip ring",
      "It turns on automatically when the motor stops to keep the stator windings slightly warmer than the ambient tunnel air, preventing humid sea air from condensing into water on the high-voltage copper",
      "It melts ice off the propeller blades before starting in Arctic waters"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The Master's cabin has ultimate override authority via a joystick",
      "Only one station can be active at a time; taking control requires acknowledging a 'Take-Over' button, which locks out the other stations to prevent conflicting commands",
      "All stations are active simultaneously; the thruster averages out the commands",
      "Control automatically shifts to whichever joystick is pushed the hardest"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By calculating the difference in water pressure on either side of the tunnel",
      "Via an underwater optical camera pointing at the blades",
      "Via an LVDT (Linear Variable Differential Transformer) or rotary potentiometer mechanically linked to the hydraulic servo pitch-actuator rod",
      "By measuring the RPM of the main electric motor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The motor automatically increases speed to force the blades into position",
      "The main switchboard trips the generator to prevent an explosion",
      "The system triggers a 'Pitch Tracking / Command Mismatch' alarm, warning the bridge that the thruster is failing to execute the ordered maneuver, often due to a hydraulic failure",
      "The thruster automatically reverts to zero pitch and shuts down"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "To measure the sulfur content of the fuel for MARPOL compliance",
      "To dynamically heat Heavy Fuel Oil (HFO) to achieve and maintain a specific injection viscosity (usually 10-14 cSt) for optimal atomization",
      "To remove water and sludge from the fuel via centrifugal force"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because different HFO grades require completely different temperatures to reach 14 cSt; a viscosity controller adapts automatically to any fuel grade",
      "Because temperature controllers are not intrinsically safe",
      "Because a viscosity controller also measures the fuel's flash point",
      "Because temperature controllers cannot operate pneumatic steam valves"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The engine will run efficiently but consume more cooling water",
      "The fuel droplets are too large, leading to poor atomization, delayed burning (afterburning), high exhaust temperatures, and heavy black smoke",
      "The engine will overspeed uncontrollably",
      "The fuel pump plungers will seize due to lack of lubrication"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The fuel will freeze inside the capillary tube",
      "The fuel will extinguish the combustion flame",
      "The steam valve will permanently weld open",
      "The fuel becomes too thin to lubricate the high-pressure fuel injection pumps, leading to rapid plunger scuffing, seizure, and total engine failure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It drops a steel ball through a cylinder of fuel and measures the time it takes to fall",
      "It measures the torque required to spin a flat disc in the fuel",
      "It measures the electrical resistance of the fuel across two platinum plates",
      "A constant-flow gear pump pushes fuel through a narrow tube; the differential pressure across this tube is directly proportional to the fluid's viscosity"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A constant-speed synchronous motor spins a spindle in the fuel; the electrical torque (current) required to maintain that speed represents the fluid's drag/viscosity",
      "It uses ultrasonic waves to detect the density of the rotating fuel",
      "It measures the pressure drop across a rotating gear pump",
      "It measures the heat generated by friction as a disc spins in the fuel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Fail-Last; it locks in its current position to maintain stability",
      "Fail-Close (Air-to-Open); if instrument air or power is lost, a spring forces the valve shut to prevent boiling the fuel",
      "Fail-Open (Air-to-Close); to ensure the engine always has hot fuel",
      "Fail-Bypass; it dumps the steam overboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Derivative action violates intrinsically safe zone rules",
      "Derivative action causes the integral windup to stall the processor",
      "Derivative action is only used for pressure control, not temperature",
      "Derivative action reacts to the rate of change; mechanical pressure ripples from the fuel pumps would cause the controller to hunt and the steam valve to oscillate wildly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It continuously sums up the steady-state error (Offset) over time, slowly nudging the steam valve until the actual viscosity exactly matches the setpoint",
      "It predicts sudden drops in engine load",
      "It limits the maximum speed the steam valve can open",
      "It provides the initial aggressive reaction to a temperature drop"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent Thermal Cracking of the fuel, which bakes heavy carbon onto the heater tubes, severely degrading their heat transfer efficiency",
      "To prevent the steam pipes from freezing",
      "To prevent the Viscotherm motor from spinning backward",
      "To prevent the fuel flash point from dropping below 60°C"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A method of pre-heating the combustion air",
      "Steam or electric heating lines wrapped around the fuel pipes under the insulation to keep the HFO liquid when the engine is stopped",
      "A diagnostic system that traces electrical shorts in the sensor wiring",
      "The radiant heat given off by the main engine block"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Leave it in AUTO; it will automatically cool the MGO",
      "Switch it to manual, completely close the steam valve, and allow the fuel system to cool down slowly before introducing the thin MGO",
      "Increase the setpoint to 20 cSt to accommodate the MGO",
      "Bypass the fuel filters entirely"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A log of the daily fuel consumption",
      "A map of the electrical wiring for the 4-20mA loop",
      "A graphical chart used to determine the exact manual temperature target required to achieve 14 cSt for a specific bunker fuel grade",
      "The theoretical maximum pressure of the fuel booster pumps"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To ensure the fuel is fully atomized before measurement",
      "Because the mixing column chemically removes sulfur",
      "To measure the exact final viscosity of the blended, heated fuel right before it enters the high-pressure injection pumps",
      "To protect the sensor from the cold temperatures of the service tank"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The PLC automatically switches to the backup 0-10V system",
      "The steam valve locks in its last known position indefinitely",
      "The PLC assumes the fuel is extremely thick and opens the steam valve 100%",
      "The PLC detects 0mA, triggers a 'Sensor Fault' alarm, and usually defaults the steam valve to the fail-safe closed position"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The engine running at a perfectly constant load",
      "A broken capillary tube",
      "A sluggish, sticking pneumatic steam control valve or a malfunctioning steam trap waterlogging the heater",
      "Using a 4-20mA signal cable with too much shielding"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The sensor wires suffer from extreme voltage drop",
      "The fuel pressure drops below the required injection pressure",
      "The fuel cools down completely before reaching the engine",
      "The controller reacts to old data; it changes the steam valve but doesn't see the result for several seconds, leading to massive over-correction and hunting"
    ],
  ...
  },
  {
    ...
    "opts": [
      "An automated steam purge valve",
      "The main generator's reverse power relay",
      "A dedicated thermal overload relay or an internal thermistor that trips the motor supply",
      "A heavy-duty mechanical slip clutch"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Heating fuel above its flash point turns it into a solid",
      "Heating fuel above its flash point inside an unpressurized tank or leaking pipe creates a massive risk of vapor explosion",
      "It determines the sulfur emissions of the fuel",
      "Flash point is the temperature at which the fuel stops lubricating"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It automatically dumps the hot fuel back to the settling tank",
      "It injects cold seawater into the mixing column",
      "The fuel flow drops drastically, so the PI controller rapidly throttles back the steam valve to prevent a massive temperature overshoot in the stagnant fuel",
      "It completely closes the steam valve and waits for a manual reset"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Stop the booster pumps momentarily while swapping the sensor",
      "Switch the controller to Manual, open the sensor bypass valve, close the sensor isolation valves, drain the block, and remove the sensor",
      "Electrically short the 4-20mA loop to freeze the steam valve, then remove the sensor",
      "Switch the controller to MGO mode, which automatically isolates the sensor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A mechanical pressure relief valve set to 10 bar",
      "A temperature compensation thermistor",
      "A high-precision, constant-speed gear pump that forces an exactly constant flow rate of fuel through the capillary tube",
      "A variable frequency drive on the booster pump"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Bridge the terminals to see if the panel reads 100%",
      "Measure the resistance of the steam valve solenoid coil",
      "Disconnect the sensor and use a loop calibrator to inject 4mA (should read 0 cSt) and 20mA (should read max scale cSt)",
      "Connect a 220V Megger to the signal terminals"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The fuel booster pumps running too fast",
      "A blocked steam supply line, a fouled heat exchanger (coked tubes), or a malfunctioning steam trap",
      "A broken 4-20mA sensor wire",
      "A faulty I-to-P (Current to Pneumatic) transducer"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By varying the voltage to a magnetic solenoid coil",
      "By modulating the frequency of a small VFD",
      "By using a heavy-duty electric servo motor directly attached to the valve stem",
      "By using an I-to-P (Current to Pneumatic) transducer that converts a 4-20mA control signal into a proportional 3-15 psi air pressure signal"
    ],
  ...
  },
  {
    ...
    "opts": [
      "When the steam valve physically jams fully open due to rust",
      "When a large, sustained error causes the Integral action to accumulate a massive correction value, causing the valve to overshoot drastically when the condition finally normalizes",
      "When the gear pump winds up too much pressure and blows a seal",
      "When the proportional band is set to 0%"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Proportional control always leaves a 'Steady-State Error' (Offset); it will stabilize the temperature, but it will never perfectly reach the 14 cSt setpoint",
      "It requires a digital signal rather than 4-20mA",
      "It cannot handle Fail-Close valves",
      "It reacts too violently to pressure ripples"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It will run backward, reversing the fuel flow",
      "The motor will stall or draw excessive current, tripping its thermal overload relay and triggering a system fault alarm",
      "It will run at 66% speed, giving a falsely low viscosity reading",
      "The Viscotherm will automatically switch to capillary mode"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To distribute reactive power evenly between parallel generators",
      "To control the starting air pressure during cranking",
      "To automatically adjust the fuel supply to maintain a constant engine speed (frequency) under varying electrical load conditions",
  ...
  },
  {
    ...
    "opts": [
      ...
      "A deliberate, proportional decrease in engine speed (frequency) as the active load (kW) increases, essential for stable parallel operation",
      "The physical sagging of the fuel rack linkage due to wear",
      "A mechanical failure of the flyweights causing the engine to stall"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It means the engine operates at variable speeds for maximum fuel efficiency",
      "It means 0% Droop; the governor maintains exactly the same speed (e.g., 60Hz) from no-load to full-load",
      "It means the governor relies entirely on pneumatic air pressure",
      "It means the governor is manually controlled via the synchroscope"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They will both overspeed uncontrollably",
      "They will fight to maintain exactly 60Hz; the slightest measurement error will cause one to take all the load while the other drops its load, leading to violent hunting and reverse power trips",
      "The alternators will generate excessive 3rd harmonic distortion",
      "The synchroscope will spin continuously, preventing breaker closure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Using a digital Magnetic Pickup Unit (MPU) on the flywheel",
      "By monitoring the exhaust gas temperature",
      "By measuring the frequency of the main alternator output",
      "Using rotating centrifugal flyweights driven by the engine camshaft; as speed increases, the weights fly outward, lifting a pilot valve against a spring"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Pneumatic air pressure from the starting air receivers",
      "The centrifugal force of the flyweights directly",
      "High-pressure oil generated by an internal gear pump pushing against a hydraulic servo-piston"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It spins the flyweights before the engine is started",
      "It is a small, reversible electric motor mounted on the governor that adjusts the speed setpoint spring tension, allowing remote speed control from the main switchboard",
      "It generates the reference voltage for the AVR",
      "It physically forces the generator rotors to align during paralleling"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Using a Magnetic Pickup Unit (MPU) that generates an AC frequency pulse every time a gear tooth on the flywheel passes it",
      "Using a radar sensor pointing at the crankshaft",
      "Using centrifugal flyweights embedded with microchips",
      "By measuring the 4-20mA output of the main alternator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The controller switches to monitoring the alternator frequency",
      "The controller locks the fuel rack in its last known position",
      "The controller detects 0 RPM, assumes a massive sensor failure, and instantly commands the fuel actuator to 0% (Shutdown) to prevent a runaway overspeed",
      "The controller assumes 0 RPM and pushes the fuel rack to 100% to try and start the engine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It generates the magnetic pulses for the speed sensor",
      "It converts the electrical command signal from the PID controller into physical mechanical force to move the fuel rack",
      "It cools the lubricating oil inside the hydraulic sump",
      "It synchronizes the incoming AC waveforms on the switchboard"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The droop percentage for parallel load sharing",
      "The immediate, aggressive reaction to a speed error; higher gain causes a faster fuel rack response but can lead to overshoot and hunting if set too high",
      "The maximum speed limit of the engine",
      "The time delay before the governor reacts to a fault"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It eliminates the steady-state error (offset) by slowly adjusting the fuel until the speed returns exactly to the setpoint (e.g., 60.00 Hz)",
      "It acts as a mechanical dashpot for the fuel actuator",
      "It determines the droop droop curve during parallel operation",
      "It reacts strictly to the rate at which the load is changing"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It provides the initial massive fuel boost during a blackout start",
      "It reacts to the *rate of change* of the speed error, providing a 'braking' effect to slow the fuel rack down as it approaches the target, preventing overshoot",
      "It calculates the exact active power (kW) being consumed",
      "It overrides the mechanical overspeed trip"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To share reactive power (kVAR) evenly without using the AVR",
      "To physically lock the fuel racks of both engines together",
      "To prevent reverse power by isolating the generators from the busbar",
      "To allow the governors to run in Isochronous mode (0% droop) while perfectly sharing the active kW load by electronically communicating their load data to each other"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A setting that drops the generator off the bus if load exceeds 100%",
      "A mechanical brake on the flywheel",
      "A control that limits the voltage output of the AVR",
      "A physical or software limit that prevents the fuel rack from opening past a certain point, protecting the engine from massive overloads and high exhaust temperatures"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because unlike mechanical governors, the electronic controller and actuator require immediate electrical power to open the fuel rack before the engine has generated any AC voltage",
      "Because the MPU sensor requires 24V DC to generate a magnetic field",
      "Because 24V DC is required to flash the alternator's residual magnetism",
      "Because SOLAS bans the use of AC power in starting circuits"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The physical dead-space inside the hydraulic dashpot",
      "The gap between the MPU sensor and the flywheel teeth",
      "A tiny, intentional range of speed fluctuation where the governor makes zero correction, preventing the actuator from wearing out due to constant micro-adjustments",
      "The RPM zone below starting speed where the engine stalls"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The generator voltage will drop to zero",
      "Sluggish response to load changes, or continuous erratic hunting, due to the pilot valve and dashpot sticking or foaming",
      "The engine will instantly overspeed",
      "The electric synchronizing motor will burn out"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Measure the DC resistance; it must read exactly zero ohms",
      "Use a megger at 500V to check insulation to ground",
      "Connect a 24V DC battery and look for a spark",
      "Disconnect the MPU, set a multimeter to AC mV, and pass a metal tool (like a screwdriver) quickly back and forth across the sensor tip to generate a pulse reading"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The pulses become too high in voltage, blowing the governor's input fuse",
      "The governor will read exactly half the actual engine speed",
      "The engine will physically strike the sensor, destroying it",
      "The magnetic flux change is too weak to induce a sufficient voltage pulse; the governor will fail to read the speed and will trigger a sensor failure shutdown"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To provide a fail-safe backup; if one sensor fails, the governor seamlessly switches to the second sensor without shutting down the vital generator",
      "One is for speed control, the other generates power for the AVR",
      "One controls the active power, the other controls reactive power",
      "To average out the readings for extreme mathematical precision"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The electronic controller will immediately reboot",
      "The MPU signal will drop to zero",
      "The actuator will generate severe harmonic interference",
      "The actuator control current will spike abnormally high as the PID controller tries to force the jammed linkage, potentially causing the actuator to overheat or trip on overcurrent"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It drains water from the fuel before cranking",
      "It limits the pressure of the booster pumps to 5 bar",
      "It artificially restricts the maximum fuel rack opening during the cranking phase to prevent massive plumes of unburnt black smoke and destructive thermal shock to the cold engine",
      "It ensures the fuel tank has enough capacity before allowing a start"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Physically climbing on the engine to check for vibration",
      "Gradually increasing the load 1 kW at a time over an hour",
      "Stepping down the voltage on the AVR to see if the governor compensates",
      "Applying and removing a large, instantaneous electrical load (e.g., 30-50%) to the generator to observe the governor's dynamic response, overshoot, and settling time"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The synchroscope was left switched on",
      "The PMG on the second generator has lost magnetism",
      "The AVR droop setting was adjusted incorrectly",
      "The electronic load-sharing communication line (the parallel wires connecting the modules) has broken, or one module has failed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It sets the maximum overspeed trip limit",
      "It mechanically alters the feedback linkage to the pilot valve, causing the setpoint to drop slightly as the fuel rack opens, enabling stable parallel load sharing",
      "It drains excess oil from the dashpot to speed up response time",
      "It manually overrides the governor to shut down the engine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Generator 2 will take all the load, causing it to slow down by 4%",
      "They will share the load perfectly 50/50",
      "Generator 1 (0% droop) will take the entire new load to keep the frequency perfectly flat, while Generator 2's load remains unchanged",
      "Both generators will trip on reverse power immediately"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the oil cools the main engine bearings",
      "Because the sight glass also indicates the fuel pressure",
      "Because a low oil level introduces air into the hydraulic servo and dashpot, causing spongy action, erratic hunting, and eventual complete loss of engine speed control",
      "Because the oil is highly flammable and indicates a fire risk"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Replace the entire governor unit, as it is factory-sealed",
      "Reload the specific PID tuning parameters from the ship's backup documentation using a laptop or the governor keypad, and perform a tuning run to verify stability",
      "Run the engine at 110% speed to force the governor to auto-calibrate",
      "Switch the main switchboard to 'Manual Excitation' mode"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A heavy internal spring constantly pulls the linkage toward the 'Zero Fuel' position; if electrical control power is lost, the spring slams the fuel rack shut, stopping the engine",
      "The spring pushes the rack to 100% fuel to ensure the ship doesn't lose power",
      "The spring generates its own electricity to keep the governor alive",
      "The spring locks the rack in its last known position"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A condition where the emergency generator is running the entire ship",
      "A condition where the ship is physically sunk or grounded",
      "A condition where the main engine has failed, but the generators are running",
      "A condition under which the main propulsion plant, boilers, and auxiliaries are not in operation due to the absence of power, and all stored energy (air/batteries) is depleted"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A blackout only happens in port; a dead ship only happens at sea",
      "A blackout is a loss of voltage on the main busbar, but starting air and batteries are still fully charged. A dead ship means ALL stored energy is also gone",
      "There is no difference; they are legally identical terms",
      "A blackout affects the lights; a dead ship affects the steering"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Start the main engine directly using the emergency generator",
      "Power up the heavy fuel oil purifiers",
      "Use the emergency switchboard power to start the Emergency Air Compressor to slowly fill the dedicated starting air receiver",
      "Turn on the ship's air conditioning to cool the automation racks"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent harmonic distortion from entering the main grid",
      "So that it can be operated when the main switchboard is completely dead, enabling the crew to generate starting air during a Dead Ship condition",
      "Because it runs on 24V DC power",
      "Because the main switchboard is legally forbidden from powering compressors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By using jumper cables connected to the bridge GMDSS batteries",
      "It cannot be started; the ship must wait for a tugboat",
      "By using a small steam turbine driven by residual boiler heat",
      "SOLAS requires a second, independent starting method; this is typically a hydraulic hand-pump starter or a purely mechanical spring-starter"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must be synchronized carefully with the emergency generator using the synchroscope",
      "It is closed directly onto the 'Dead Bus'; no synchronization is needed because there is no existing voltage or frequency on the busbar to match",
      "It must be closed using a special DC injection pulse to magnetize the busbars",
      "It is closed automatically by the Reverse Power relay"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They must be started in reverse order, beginning with the smallest pumps",
      "They must be started sequentially with time delays between each start to prevent massive overlapping inrush currents from tripping the generator on overload",
      "They must remain off until the Main Engine is running at 50% load",
      "They must all be started simultaneously via a 'Group Start' button to restore cooling instantly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The synchroscope is permanently locked out",
      "An electrical and mechanical interlock prevents the Emergency Generator ACB and the Main Bus-Tie breaker from being closed at the same time",
      "The emergency generator lacks an AVR, making paralleling impossible",
      "The emergency generator uses 50Hz, while the main uses 60Hz"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To comply with MARPOL regulations regarding fuel spillages",
      "Because the emergency generator runs exclusively on heavy fuel oil",
      "To prevent water from mixing with the fuel",
      "To ensure fuel flows to the engine without relying on any electrical booster or transfer pumps, guaranteeing it can start during a total power failure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The trace heating is run off the 24V batteries to melt the HFO",
      "A blowtorch is used to heat the fuel pipes manually",
      "The generator must be switched to Marine Gas Oil (MGO), which remains fluid without steam heating, allowing the engine to start and run",
      "The engine is cranked on air friction until it generates enough heat to melt the oil"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They switch to a mechanical pneumatic display",
      "They shut down immediately to save power",
      "They are powered directly by the main engine turning gear",
      "They remain fully powered for a minimum of 30 minutes by an Uninterruptible Power Supply (UPS) battery bank to allow engineers to monitor the recovery"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Start the Main Lubricating Oil pumps and ensure pressure is established to protect the massive bearings",
      "Engage the turning gear to spin the engine at high speed",
      "Turn on the engine room ventilation fans to maximum",
      "Start the heavy fuel oil purifiers"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It sends an automatic distress signal to the company headquarters",
      "It bypasses all safeties and fires every engine simultaneously",
      "It detects the dead bus, issues a start command to the standby generator, verifies voltage, closes the breaker, and triggers the step-by-step sequential restart of essential pumps",
      "It locks out all generators and waits for the Chief Engineer's password"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Running a generator under load without verified cooling water circulation will cause it to overheat and trip within minutes, plunging the ship back into a blackout",
      "To ensure the fresh water generator starts making water",
      "To prevent the cooling water from freezing in the pipes",
      "To provide hydraulic pressure to the governor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It splits the switchboard into two halves; if a dead short caused the blackout, opening the tie breaker isolates the fault, allowing half the board to be safely energized",
      "It physically locks the breakers to prevent vibration",
      "It ties the emergency generator to the main generator for extra power",
      "It ties the main generator directly to the propeller shaft"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Via the 24V DC Transitional Emergency Lighting system, which turns on instantly from a dedicated battery bank when AC power fails",
      "By manually lighting kerosene lanterns",
      "By opening the skylights and working during the daytime",
      "By using chemical glow sticks mounted on the bulkheads"
    ],
  ...
  },
  {
    ...
    "opts": [
      "36 hours for a Passenger vessel, and 18 hours for a Cargo vessel",
      "12 hours for both",
      "72 hours for a Passenger vessel, and 48 hours for a Cargo vessel",
      "2 hours for a Passenger vessel, and 1 hour for a Cargo vessel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the main receivers operate at 300 bar, while the emergency compressor only outputs 10 bar",
      "Because the emergency air compressor produces toxic gases that would corrode the main valves",
      "The Emergency Air Compressor has a tiny capacity; it would take hours/days to fill the massive main receivers. It is only designed to fill the small auxiliary bottle to start one generator",
      "It is perfectly fine and standard practice to fill the main receivers this way"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The main fuel injectors must be removed and cleaned",
      "The engine must be injected with ether to ensure instant combustion",
      "The engine must be pre-lubricated, pre-heated with steam/electric heaters (to ~60°C), and turned over with the turning gear with indicator cocks open to clear any fluids from the cylinders",
      "The turbochargers must be spun up to 5000 RPM using compressed air"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A software timer in the Power Management System",
      "The main switchboard undervoltage relay",
      "A centrifugal switch on the flywheel",
      "A mechanical limit switch on the turning gear lever physically breaks the start-control circuit when the gear is engaged"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Because the massive starting current (inrush) causes a severe transient voltage drop on the busbar, which can cause the motor's own Undervoltage (UV) relay or contactor coil to drop out",
      "Because the motor rotates backwards during the first 3 seconds",
      "Because the generator frequency spikes to 70Hz",
      "Because the AVR automatically disconnects heavy loads to protect the generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By shorting the main busbars together with a heavy cable",
      "It is impossible to test without a genuine total blackout",
      "By pressing the emergency stop buttons on all engines simultaneously",
      "By using the simulation/test mode built into the Power Management System (PMS), or by safely isolating the voltage sensing fuses for the PMS to mimic 0V on the bus"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It automatically connects the shore power cables",
      "It deliberately trips the main engine to prevent thermal shock",
      "It ensures that non-essential loads (like AC and galleys) remain disconnected or shed, reserving all available generator power to start the massive essential pumps",
      "It trips the emergency generator to save fuel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Tested daily before the Master signs the logbook",
      "Tested once a year during drydock",
      "Tested only when Port State Control requests it",
      "Tested manually or automatically at least once a week, and subjected to a full load test every month"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It automatically switches to motor mode to spin the propeller",
      "It takes over the duties of the emergency generator",
      "It instantly disconnects from the busbar; a shaft generator relies on the main engine rotating at a specific speed, which ceases during a blackout",
      "It acts as a massive battery to sustain the busbar for 5 minutes"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It relies purely on gravity to close",
      "Fail-Close; a heavy spring keeps it shut. Control air pressure is required to push it open against the spring to admit 30-bar starting air",
      "Fail-Last; it stays wherever it was when power was lost",
      "Fail-Open; it defaults to open to guarantee an engine start"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Water accumulation reduces the air volume capacity and causes internal corrosion; injecting a slug of liquid water into the engine cylinders during starting can cause catastrophic hydraulic lock",
      "Water mixes with the air and creates explosive hydrogen gas",
      "Water lowers the pressure of the air below 10 bar",
      "Water causes the air compressor to run backwards"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The emergency generator is producing too much voltage",
      "The battery terminals are short-circuited and about to explode",
      "It is perfectly normal; the batteries were deeply discharged during the blackout while powering emergency lighting and automation, and are now in the 'Bulk Charge' phase",
      "The charger's internal thyristors have failed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Underwater Mooring System; the ship can anchor using submerged buoys",
      "Universal Maintenance Schedule; a digital planned maintenance system",
      "Unmanned Machinery Space; the ship is certified to operate safely with no engineering crew present in the engine room for specified periods (usually at night)",
      "Unrestricted Maritime Sailing; the ship can navigate in any ice condition"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To instantly relay critical engine room alarms to the bridge, the public spaces (mess rooms), and the specific cabin of the Duty Engineer",
      "To increase the volume of the engine room sirens to 120 decibels",
      "To send an email to the company superintendent ashore",
      "To extend the time delay before the main engine shuts down"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It ensures the safety of an engineer entering the engine room alone; they must reset a timer every ~15 minutes, otherwise a general alarm sounds to indicate they may be injured or unconscious",
      "It automatically seals the watertight doors if smoke is detected",
      "It monitors the ship's hull for breaches using water sensors",
      "It sounds when the ship's main engine completely stops"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Manually blowing down the boiler glass twice",
      "A comprehensive physical patrol/round of the engine room to check for leaks, strange noises, fire hazards, and secure loose gear",
      "Shutting off all ventilation fans to save power",
      "Turning off the main switchboard and switching to batteries"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It selects whether the ship runs on HFO or MGO",
      "It shifts control of the steering gear from the bridge to the engine room",
      "It chooses which generator will act as the standby unit",
      "It dictates which specific engineer's cabin will receive the UMS alarms for that particular night/watch"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It must automatically release CO2 into the engine room instantly upon detecting smoke",
      "It must rapidly detect fire in any part of the machinery space, sound an audible and visual alarm distinct from any other system, and indicate the exact location on the bridge and in the cabins",
      "It only needs to monitor the area directly above the main engine",
      "It must automatically steer the ship into the wind to blow smoke away"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The system triggers the ship's abandon-ship protocol",
      "The system automatically shuts down the main engine to prevent damage",
      "The system automatically escalates the alarm, sounding the General Engineers' Alarm to wake up the Chief Engineer and all other engineering staff",
  ...
  },
  {
    ...
    "opts": [
      ...
      "The duty engineer has 15 minutes to manually reach the engine room and restore power",
      "The emergency generator takes over propulsion duties",
      "The automation system must automatically detect the blackout, start the standby generator, synchronize (if needed), close the breaker, and sequentially restart all essential pumps within 45 seconds"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They are mechanically linked to the main engine shaft",
      "If the running pump loses pressure, the standby pump must automatically start and assume the load without human intervention",
      "They must be manually tested by the duty engineer every 4 hours",
      "They must run simultaneously with the main pumps at 50% capacity"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To capture high-pressure fuel spray if the inner pipe bursts, draining it safely into an alarm tank instead of spraying atomized fuel onto hot exhaust pipes and causing a massive fire",
      "To prevent the fuel from freezing in cold climates",
      "To electrically insulate the fuel from the engine grounding",
      "To provide structural support to the engine block"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Turn off the alarm system completely",
      "Press the emergency stop on the Dead Man alarm",
      "Stop the main engine and restart it manually",
      "The watchkeeping engineers enter the engine room, conduct a full patrol, transfer control from the Bridge to the ECR, and log the exact time the ER becomes 'Manned'"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A voice-synthesizer that reads the alarm text over the PA system",
      "Alarms must be prioritized; a 'General Machinery Alarm' (yellow/amber) for non-critical faults, and distinct 'Slowdown' or 'Shutdown' alarms (red) for severe engine threats",
      "A separate digital readout for every single engine sensor",
      "Only one master alarm bell for all faults"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It forces the main engine into reverse instantly",
      "In a severe navigational emergency (e.g., imminent collision), the bridge can activate an override switch that forcefully blocks the automation from shutting down the main engine, intentionally sacrificing the engine to save the ship",
      "It bypasses the ship's fire alarms to prevent panic",
      "It allows the bridge to steer the ship from the engine room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "That it runs on diesel fuel",
      "That it can provide 440V to the bow thruster",
      "That the batteries are healthy, free of corrosion, and possess sufficient capacity to power the alarm and monitoring systems for at least 30 minutes during a total blackout",
      "That the UPS connects directly to the ship's internet"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The vessel instantly loses its UMS status; engineers must immediately begin standing continuous 24-hour physical watches in the engine room until it is repaired",
      "The CO2 system is placed on automatic release mode",
      "The duty engineer simply checks the engine room every 4 hours instead",
      "The ship must anchor immediately at sea"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To record the crew's working hours automatically",
      "To provide entertainment for the off-duty crew",
      "To allow the bridge or duty engineer to visually monitor critical areas (like the main engine top, purifiers, or switchboard) remotely without physically entering the space",
      "To detect minor temperature fluctuations using thermal imaging"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Measuring the exact salt content of the bilge water",
      "Flooding the bilges to extinguish fires",
      "Pumping oil directly overboard without filtering",
      "Detecting high water levels in the engine room bilges and triggering an alarm; on some ships, it may also automatically start the bilge pump to discharge through the OWS"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent the alarms from logging in the VDR (Voyage Data Recorder)",
      "To save money on wiring and display lights",
      "To simplify information for the navigating officers; instead of 500 individual technical alarms, they see grouped summaries like 'Power Failure', 'Steering Fault', or 'Propulsion Fault'",
      "Because the bridge panel is not legally required to work"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It engages the emergency steering gear",
      "It allows the navigating officer to manually trigger the alarm system in the Duty Engineer's cabin to request immediate technical assistance",
      "It automatically starts the standby generator",
      "It shuts down the main engine from the bridge"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It routinely trips the main breaker to test the emergency generator",
      "It forces the ship to run on only one generator at all times to save fuel",
      "If the ship's load increases to the point where the running generator is >85% loaded, the PMS automatically starts and parallels a standby generator before an overload occurs",
      "It automatically turns off the air conditioning during dinner time"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Ignore it; false alarms are part of ship life",
      "Cut the wire to the siren to silence the entire panel",
      "Turn off the UMS system entirely",
      "Log the defect, inform the C/E, and 'Inhibit' or 'Block' that specific channel in the software, ensuring a physical gauge or alternative method is monitored until repairs are made"
    ],
  ...
  },
  {
    ...
    "opts": [
      "They must communicate strictly via VHF radio",
      "Communication is only required when the ship is in port",
      "They use a pneumatic tube system to send written notes",
      "There must be at least two independent means of communication, one of which must be a reliable, hardwired direct voice link (like a sound-powered phone or direct intercom)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It splits the engine room into exactly four zones",
      "It requires a fire to cross a physical line painted on the deck before alarming",
      "It requires TWO independent smoke/heat detectors to trigger simultaneously before activating automatic fire suppression (like water mist), preventing a single faulty sensor from causing massive water damage",
      "It automatically cross-connects the fire pumps to the ballast system"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The fuel is too hot, boiling the water away",
      "The fresh water generator is producing too much water",
      "The exhaust gas boiler is over-pressurized",
      "A cracked cylinder liner or blown O-ring, causing the cooling water to leak internally directly into the engine's combustion chamber or crankcase"
    ],
  ...
  },
  {
    ...
    "opts": [
      "When it is time for coffee break",
      "When the ship is safely moored alongside",
      "When transferring fuel between identical tanks",
      "When the Duty Engineer enters the engine room, finds a fault they cannot handle alone, and requires the immediate assistance of the rest of the engineering team"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It forces the generators to run at 120% capacity",
      "It automatically overrides the steering gear and switches to autopilot",
      "It allows the computer to override the Chief Engineer's manual commands",
      "It allows the Master or Chief Engineer to intentionally block the computer from shutting down the main engine for non-catastrophic faults, accepting engine damage to maintain navigational control of the vessel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By using extremely long steel cables connecting the bridge to the engine room",
      "By using voice commands to a robotic assistant",
      "Via a mimic screen on the computer (HMI) that sends digital commands to a PLC, which energizes electro-hydraulic or electro-pneumatic solenoid valves located physically on the massive piping valves",
      "By manually walking to the valve and turning a giant handwheel"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The engine will run permanently at full speed",
      "The ship will automatically drop anchor",
      "All remote monitoring, automatic standby starts, and alarm routing will fail; the crew must instantly establish a continuous manual watch in the engine room, and revert to reading physical gauges",
      "The emergency generator will power the PLC back up instantly"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Flame detectors instantly 'see' the intense radiation of an open fire, responding in milliseconds, whereas smoke detectors require smoke to physically drift up and fill the chamber, which is too slow for explosive fuel fires",
      "Flame detectors also measure the temperature of the cooling water",
      "Flame detectors are much cheaper to install",
      "Smoke detectors are illegal in the engine room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is a normal daily task and requires no special protocol",
      "Send an email to the manufacturer for a software unlock code",
      "Turn off the Dead Man alarm first",
      "Obtain explicit authorization from the Chief Engineer, record the bypass in the official logbook, physically tag the panel, and NEVER leave the engine room until the bypass is removed and normal logic restored"
    ],
  ...
  },
  {
    ...
    "opts": [
      "There is no difference; they both actuate the same pneumatic valve",
      "A Slow-Down is manually triggered by the bridge; a Shut-Down is triggered by the ECR",
      "A Slow-Down automatically drops the engine RPM to a safe idling speed to prevent damage while maintaining steering control; a Shut-Down instantly cuts all fuel, stopping the engine completely",
      "A Slow-Down cuts fuel to half the cylinders; a Shut-Down cuts air to all cylinders"
    ],
  ...
  },
  {
    ...
    "opts": [
      "High Exhaust Gas Temperature, Low Starting Air Pressure, and High Bilge Level",
      "Jacket Water High Temperature, Scavenge Air High Temperature, and Low Fuel Level",
      "Loss of GPS signal, Radar failure, and Gyrocompass error",
      "Main Lube Oil Low-Low Pressure, Thrust Bearing High Temperature, and Overspeed"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It spins the turbocharger at high speeds; if it fails, the engine loses air",
      "It absorbs the massive forward push of the propeller and transfers it to the ship's hull; if it overheats and fails, the propeller shaft will push through the engine block, destroying it",
      "It absorbs the vertical vibrations of the pistons",
      "It generates the electrical power for the shaft generator"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Shut down the engine immediately and open the crankcase doors",
      "Switch the fuel supply to MGO and increase the RPM",
      "Instantly press the Override button to bring the speed back up to Full Ahead",
      "Acknowledge the alarm, manually verify the high temperature, investigate the cooling water system (pumps/valves), and DO NOT override the slowdown unless the ship is in immediate navigational peril"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The lube oil sump catches fire; triggers the OMD alarm",
      "Accumulated oily sludge ignites inside the scavenge air manifold; it triggers a 'High Scavenge Air Temperature' alarm on the specific cylinder involved",
      "The fuel injectors catch fire on top of the engine; triggers a general fire alarm",
      "The exhaust gas boiler catches fire; triggers a high funnel temp alarm"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Open the scavenge doors and spray it with a high-pressure water hose",
      "Increase the engine speed to blow the fire out the exhaust stack",
      "Slow down/Stop the engine, cut off the fuel to the affected cylinder, and activate the fixed fire extinguishing system (steam smothering or CO2) injected directly into the scavenge manifold",
      "Run the turning gear rapidly to deprive the fire of oxygen"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The exhaust gas is too cold, causing acid condensation",
      "The computer calculates the average exhaust temperature of all cylinders; if one specific cylinder is significantly hotter or colder than that average (e.g., ±50°C), it triggers the deviation alarm",
      "The funnel is smoking too heavily due to poor fuel",
      "The turbocharger is spinning too fast, generating excess heat"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses a microswitch to physically break the starting air control circuit; the engine absolutely cannot receive starting air if the turning gear is mechanically engaged with the flywheel",
      "It automatically turns the engine slowly to cool it down after stopping",
      "It locks the propeller shaft in place while the ship is in drydock",
      "It engages the emergency generator if the main engine stalls"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It triggers if the ship deviates from its programmed GPS course",
      "It sounds a loud, continuous alarm on the bridge and ECR if the Bridge telegraph commands 'Ahead', but the engine actually starts rotating 'Astern' (or vice versa)",
      "It sounds if the steering gear reaches the physical hard-over limit",
      "It alarms if the ETO wires the turning gear backwards"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Pneumatic air cylinders shift the camshaft axially, sliding a different set of 'Astern' fuel and exhaust cams under the follower rollers, altering the engine's mechanical timing",
      "By electrically reversing the phase sequence of the main generator",
      "By using a massive mechanical reduction gearbox to shift into reverse gear",
      "By injecting fuel at the bottom of the piston stroke instead of the top"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It uses electronic spark plugs to ignite the heavy fuel oil",
      "It uses massive electric motors to turn the propeller instead of diesel combustion",
      "It runs exclusively on hydrogen fuel cells",
      "It completely eliminates the heavy mechanical camshaft; fuel injection and exhaust valve actuation are handled purely by high-pressure hydraulics controlled precisely by electronic computers (PLCs)"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It monitors the temperature of the main bearings",
      "It detects explosive oil mist in the crankcase",
      "It measures the torque being applied to the propeller",
      "It provides the computer with the absolute, microscopic angular position of the crankshaft (e.g., 0.1 degree accuracy), allowing the software to perfectly time the fuel injection without a mechanical camshaft"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It automatically turns on the galley ovens to increase electrical load",
      "It artificially restricts how fast the engine speed/load can be increased (e.g., capping it at +1 RPM per minute), preventing severe thermal cracking of the cold cylinder liners and heads",
      "It forces the engine to run at maximum speed to burn off carbon",
      "It limits the cargo weight the ship is allowed to load"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It automatically greases the external crane bearings",
      "It sprays cooling oil onto the underside of the piston crown",
      "It filters the main sump oil to 5 microns",
      "It electronically injects precisely timed, microscopic amounts of highly alkaline lubricating oil directly onto the cylinder liner exactly as the piston rings pass by, reducing wear and oil consumption"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The turbocharger will stall and cause black smoke",
      "The air compressors will explode due to overpressure",
      "The engine will run entirely on compressed air, wasting fuel",
      "The engine may fail to crank fast enough to achieve the compression heat required to ignite the diesel fuel, resulting in a failed start"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It sends an urgent email to the technical superintendent ashore",
      "It drops the ship's anchors automatically",
      "It slowly ramps the engine down over a period of 5 minutes to prevent thermal shock",
      "It completely bypasses all computers, PLCs, and normal logic, hard-wiring directly to a pneumatic or solenoid 'dump valve' that instantly cuts all fuel to the main engine"
    ],
  ...
  },
  {
    ...
    "opts": [
      "When the engine burns more fuel than the telegraph calculation predicted",
      "When the telegraph loses its connection to the internet",
      "When the ship physically sails off the charted course",
      "When the Bridge moves the telegraph lever to a new command (e.g., Half Ahead), but the Engine Control Room lever has not been moved to match and acknowledge the command"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Using a small blast of starting air to slowly rotate the engine ~1 revolution with indicator cocks open, ensuring no water/oil is trapped in the cylinders that could cause a hydraulic lock",
      "Spinning the turbocharger manually to clear out exhaust soot",
      "Rotating the engine backward to test the reversing pneumatic valves",
      "Running the engine on pure diesel oil to clean the injectors"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It routes air to the turbocharger to spin it up before the engine fires",
      "Driven by the camshaft, it routes pilot air sequentially to the individual starting valves on each cylinder exactly when that piston reaches slightly past Top Dead Center",
      "It provides compressed air to the ship's horn automatically during fog",
      "It mixes high-pressure air directly with the heavy fuel oil to improve atomization"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A small 24V DC solenoid valve opens, which allows pilot air pressure to flow and physically push open the massive, heavy-duty main starting air valve",
      "A 440V massive electric motor attached to the valve stem",
      "A thermal bimetallic strip heats up and bends the valve open",
      "A piezoelectric crystal expands when voltage is applied"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A 'Starting Air Line Explosion'; hot combustion gases blast backward through the stuck valve into the compressed air piping, mixing with oil vapor and detonating the pipe network",
      "The engine will instantly reverse direction and run backward",
      "The air compressor will run continuously until it burns out",
      "The cylinder will freeze due to the expanding compressed air"
    ],
  ...
  },
  {
    ...
    "opts": [
      "A bursting disc or flame arrestor mounted on the manifold, designed to blow out and safely vent the explosive pressure into the open engine room before the steel pipes shatter",
      "A chemical foam injector that floods the air pipe instantly",
      "A massive check valve that slams shut and stops the engine",
      "A heavy-duty spring that clamps the air compressor shut"
    ],
  ...
  },
  {
    ...
    "opts": [
      "It is pushed open by high-pressure hydraulic oil (actuated by a cam or electronic solenoid) and forced closed by an 'Air Spring' (pneumatic pressure)",
      "It is opened by the force of the exhaust gases pushing against it",
  ...
  },
  {
    ...
    "opts": [
      "The distance between the connecting rod and the crankcase wall",
      "The microscopic physical gap between the top of the piston and the cylinder head when the piston is at absolute Top Dead Center (TDC)",
      "The acceptable amount of play in the thrust bearing before it trips",
      "The air gap required for the Magnetic Pickup Unit sensor"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The intense heat of the exhaust gases (350°C+) can overheat the dry finned tubes, potentially igniting soot deposits and causing a catastrophic metal fire (iron fire) inside the funnel",
      "The engine will run perfectly normally, but fuel consumption will increase",
      "The exhaust gas will condense into sulfuric acid, rusting the funnel instantly",
      "The turbocharger will lose pressure and stall"
    ],
  ...
  },
  {
    ...
    "opts": [
      "To prevent heavy fuel oil from dripping onto the crew walking below",
      "Because the massive pressure (600+ bar) in the injection pipes can create a highly atomized, invisible fuel mist if a crack occurs; this mist is hyper-explosive if it touches a hot exhaust manifold",
      "To ensure the ship is not over-billed by the bunker barge",
      "Because small leaks reduce the top speed of the ship by 10%"
    ],
  ...
  },
  {
    ...
    "opts": [
      "The oil mist will condense and heavily lubricate the upper cylinders",
      "The engine will safely stall as the oil pressure drops to zero",
      "The crankcase extraction fan will safely suck the explosion out of the funnel",
      "The failing bearing acts as an ignition source; the oil mist reaches its Lower Explosive Limit (LEL) and detonates, blowing the massive crankcase doors off and destroying the engine room"
    ],
  ...
  },
  {
    ...
    "opts": [
      "Spring-loaded 'Crankcase Relief Valves' on the doors that snap open to vent the explosive pressure wave safely, then instantly slam shut to prevent fresh oxygen from rushing back in and causing a secondary explosion",
      "Explosive bolts that entirely detach the doors into the engine room",
      "A water-mist system built into the door hinges",
      "Heavy lead weights that prevent the doors from ever opening under any pressure"
    ],
  ...
  },
  {
    ...
    "opts": [
      "By accessing the junction box on the side of the engine, disconnecting the 3-wire PT100 sensor, and measuring its resistance with a multimeter (should read approx 100 ohms at 0°C, and ~120-130 ohms at running temps)",
      "By looking at the color of the paint on the bearing casing",
      "By injecting high-pressure steam into the crankcase",
      "By short-circuiting the wires and seeing if the engine shuts down"
    ],
  ...
  },
  {
    ...
    "opts": [
      "From the emergency generator room using a laptop",
      "From the 'Local Control Station' physically attached to the engine, using mechanical levers to actuate starting air, reversing pneumatics, and fuel rack position directly, completely bypassing the automation",
      "From the Bridge using the emergency joystick",
      "By physically pushing the piston rods with a massive pry bar"
    ],
  ...
  {
    "q": "A marine boiler uses 3-element feedwater control. What are the three process variables it measures?",
    "a": "Steam drum water level, steam flow rate out of the boiler, and feedwater flow rate into the boiler",
    "opts": [
      "Steam drum water level, steam flow rate out of the boiler, and feedwater flow rate into the boiler",
      "Drum pressure, flue gas temperature, and feedwater temperature",
      "Burner fuel flow, furnace temperature, and drum pressure",
      "Feedwater conductivity, drum level, and salinity"
    ],
    "exp": "3-element control uses three inputs: drum level (DP transmitter on drum), steam flow (orifice on steam line), and feedwater flow (orifice on feed line). The controller matches feedwater flow to steam demand while correcting for any drum level error. This eliminates false level readings caused by swell and shrink.",
    "cat": "BLR",
    "id": "T09S_453"
  },
  {
  ...
  {
    "q": "What is the MARPOL Annex I limit for overboard discharge of bilge water from the machinery space?",
    "a": "Less than 15 parts per million (ppm) oil content",
    "opts": [
      "Less than 15 parts per million (ppm) oil content",
      "Less than 100 ppm",
      "Less than 5 ppm",
      "Less than 50 ppm as long as the ship is more than 3 nautical miles offshore"
    ],
    "exp": "MARPOL Annex I Regulation 14 sets the discharge standard at <15 ppm for machinery space bilge water outside special areas. The Oil Content Monitor (OCM) must continuously verify compliance; if it reads ≥15 ppm, the 3-way valve automatically diverts discharge to the bilge holding tank.",
    "cat": "OWS",
    "id": "T09S_455"
  },
  {
    "q": "Inside the 15ppm Oil Content Monitor, how does the sensor actually measure the oil concentration in the sample water?",
    "a": "A light source shines through the water sample; oil droplets scatter light at 90° to the beam; a photodetector measures this scattered light intensity and converts it to a ppm reading (nephelometric principle)",
    "opts": [
      "A light source shines through the water sample; oil droplets scatter light at 90° to the beam; a photodetector measures this scattered light intensity and converts it to a ppm reading (nephelometric principle)",
      "A chemical reagent changes colour in proportion to oil concentration and a colorimeter reads the shade",
  ...
  {
    "q": "Why must an air compressor always be started on no-load (unloaded start), and what component achieves this?",
    "a": "Starting under pressure overloads the motor with high starting torque on top of inrush current, risking burnout; an unloader bypass solenoid valve opens the discharge to atmosphere before starting, removing all back-pressure so the motor runs up freely",
    "opts": [
      "Starting under pressure overloads the motor with high starting torque on top of inrush current, risking burnout; an unloader bypass solenoid valve opens the discharge to atmosphere before starting, removing all back-pressure so the motor runs up freely",
      "Compressed air is needed first to provide sealing oil pressure to the bearings before the motor can start",
  ...
  {
    "q": "Per standard practice and class requirements, what are the maximum running time limits for a main air compressor when charging starting air bottles?",
    "a": "Maximum 1 hour total running time per bottle fill cycle, with no single compressor running continuously for more than 30 minutes; drains must be blown before and after each run",
    "opts": [
  ...
  {
    "q": "In a Direct Expansion (DX) refrigeration system, what device controls refrigerant flow into the evaporator, and what is its operating principle?",
    "a": "A Thermostatic Expansion Valve (TEV); its bulb senses superheat at the evaporator outlet and opens/closes the valve to maintain 4–6°C of superheat, ensuring no liquid refrigerant returns to the compressor",
    "opts": [
      "A Thermostatic Expansion Valve (TEV); its bulb senses superheat at the evaporator outlet and opens/closes the valve to maintain 4–6°C of superheat, ensuring no liquid refrigerant returns to the compressor",
      "A float valve that maintains a constant liquid level flooding the evaporator tubes",
      "A fixed orifice that admits refrigerant at a constant rate regardless of load",
      "A solenoid valve controlled by the room thermostat on-off signal"
    ],
    "exp": "The TEV bulb is strapped to the suction line at the evaporator outlet. If superheat is too high (dry coil, not enough refrigerant), the bulb pressure opens the valve wider. If superheat drops toward 0°C (liquid carry-over risk), the valve closes. This keeps the evaporator 95-100% filled with boiling liquid for maximum heat transfer without flooding the compressor.",
    "cat": "REF",
    "id": "T09S_459"
  },
  {
    "q": "What is the fundamental operating difference between a flooded evaporator and a dry expansion (DX) evaporator in a refrigeration system?",
    "a": "In a flooded evaporator the refrigerant completely fills the tubes as a liquid bath (controlled by a float valve) and exits as a wet vapour mix; in DX the refrigerant enters as a liquid-vapour mix and exits as dry superheated vapour (controlled by a TEV)",
    "opts": [
      "In a flooded evaporator the refrigerant completely fills the tubes as a liquid bath (controlled by a float valve) and exits as a wet vapour mix; in DX the refrigerant enters as a liquid-vapour mix and exits as dry superheated vapour (controlled by a TEV)",
      "Flooded evaporators use water as the secondary coolant while DX evaporators cool air directly",
      "Flooded evaporators have no compressor; they use gravity to circulate refrigerant",
      "DX evaporators are only used for cargo holds; flooded evaporators are only used for air conditioning"
    ],
    "exp": "The flooded design keeps 100% of the tube surface wetted with boiling liquid, giving very high heat transfer efficiency but requiring a large refrigerant charge and an oil separator (oil accumulates in the flooded shell). DX uses a small charge and no separator but leaves the last section of coil as superheated vapour, slightly reducing efficiency.",
    "cat": "REF",
    "id": "T09S_460"
  },
  {
  ...
  },
  {
    ...
    "exp": "This is a hard interlock wired into the motor control circuit. The fan's current transformer or duct airflow switch provides a permissive signal to the pump starters' control circuits. If the fan is off (no permissive), the pump start buttons are dead. This ensures vapour accumulation cannot occur while large electrical sparking equipment (pump motors, starters) is energised in the space.",
    "cat": "SAFETY",
    "id": "T09S_464"
  }
